...
import { AddTextPrinterForMessage, AddTextPrinterWithCallbackForMessage, AnimateSprites, BuildOamBuffer, ClearWindowTilemap, FEMALE, FadeOutBGM, FillBgTilemapBufferRect_Palette0, FreeAllWindowBuffers, InitBgFromTemplate, InitSpriteAffineAnim, IsMysteryGiftEnabled, IsTextPrinterActive, JOY_NEW, LZ77UnCompVram, LoadMessageBoxGfx, MALE, Menu_GetCursorPos, PALETTES_BG, PlayBGM, RtcGetErrorStatus, RunTasks, RunTextPrinters, RunTextPrintersAndIsPrinter0Active, SpriteCallbackDummy, StringExpandPlaceholders, UpdatePaletteFade, WININ_WIN0_OBJ, WINOUT_WIN01_CLR, WINOUT_WIN01_OBJ, gMain, gPlttBufferUnfaded, gSaveFileStatus, gStringVar4, sTextColor_Headers } from '../harness/runtime/decomp-globals';
