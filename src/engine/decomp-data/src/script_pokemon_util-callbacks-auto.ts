...
// Source : src/script_pokemon_util.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: script_pokemon_util.c → CB2_ReturnFromChooseHalfParty */
export const CB2_ReturnFromChooseHalfParty: CB2Callback = (rt) => {
...
/** Source: script_pokemon_util.c → CB2_ReturnFromChooseBattleFrontierParty */
export const CB2_ReturnFromChooseBattleFrontierParty: CB2Callback = (rt) => {
  switch (gSelectedOrderFromParty[0])
      {
      case 0:
          gSpecialVar_Result = false;
