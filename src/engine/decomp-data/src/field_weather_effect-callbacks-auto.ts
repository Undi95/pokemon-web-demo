...
// Source : src/field_weather_effect.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: field_weather_effect.c → Task_DoAbnormalWeather */
export const Task_DoAbnormalWeather: TaskCallback = (task, rt) => {
