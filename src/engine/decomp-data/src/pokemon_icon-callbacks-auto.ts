...
// Source : src/pokemon_icon.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: pokemon_icon.c → SpriteCB_MonIcon */
export const SpriteCB_MonIcon: SpriteCallback = (sprite, rt) => {
