...
// Source : src/field_effect_helpers.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: field_effect_helpers.c → SpriteCB_UnderwaterSurfBlob */
export const SpriteCB_UnderwaterSurfBlob: SpriteCallback = (sprite, rt) => {
  let blobSprite: any = _gs(rt, sprite.data[0]);
