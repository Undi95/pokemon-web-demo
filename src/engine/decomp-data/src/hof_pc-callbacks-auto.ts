...
// Source : src/hof_pc.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: hof_pc.c → Task_WaitForPaletteFade */
export const Task_WaitForPaletteFade: TaskCallback = (task, rt) => {
