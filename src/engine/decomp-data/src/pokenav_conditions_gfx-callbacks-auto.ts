...
// Source : src/pokenav_conditions_gfx.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: pokenav_conditions_gfx.c → SpriteCB_PartyPokeball */
export const SpriteCB_PartyPokeball: SpriteCallback = (sprite, rt) => {
