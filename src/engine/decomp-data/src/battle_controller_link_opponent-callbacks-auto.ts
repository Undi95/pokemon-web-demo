...
// Source : src/battle_controller_link_opponent.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_controller_link_opponent.c → SpriteCB_FreeOpponentSprite */
export const SpriteCB_FreeOpponentSprite: SpriteCallback = (sprite, rt) => {
  FreeTrainerFrontPicPalette(rt.gba.oam[sprite.oamIndex].affineParam);
      FreeSpriteOamMatrix(sprite);
      rt.DestroySprite(sprite.spriteId);
};

/** Source: battle_controller_link_opponent.c → Task_StartSendOutAnim */
