...
// Source : src/player_pc.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: player_pc.c → Task_ItemStorage_Deposit */
export const Task_ItemStorage_Deposit: TaskCallback = (task, rt) => {
...
/** Source: player_pc.c → CB2_PlayerPCExitBagMenu */
export const CB2_PlayerPCExitBagMenu: CB2Callback = (rt) => {
