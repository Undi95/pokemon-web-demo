...
// Source : src/battle_anim_smokescreen.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_anim_smokescreen.c → SpriteCB_SmokescreenImpactMain */
export const SpriteCB_SmokescreenImpactMain: SpriteCallback = (sprite, rt) => {
  if (sprite.data[0] == 0)
      {
...
/** Source: battle_anim_smokescreen.c → SpriteCB_SmokescreenImpact */
export const SpriteCB_SmokescreenImpact: SpriteCallback = (sprite, rt) => {
  if (sprite.animEnded)
      {
          _gs(rt, sprite.data[0]).data[0]--;
          rt.DestroySprite(sprite.spriteId);
      }
};
