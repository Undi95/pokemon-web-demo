...
// Source : src/battle_pike.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_pike.c → Task_DoStatusInflictionScreenFlash */
export const Task_DoStatusInflictionScreenFlash: TaskCallback = (task, rt) => {
