...
// Source : src/battle_script_commands.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_script_commands.c → SpriteCB_MonIconOnLvlUpBanner */
export const SpriteCB_MonIconOnLvlUpBanner: SpriteCallback = (sprite, rt) => {
