...
// Source : src/mon_markings.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: mon_markings.c (failed: empty bodyC) */
export const SpriteCB_Dummy: SpriteCallback = (_sprite, _rt) => { /* TODO empty bodyC */ };

/** Source: mon_markings.c → SpriteCB_Marking */
export const SpriteCB_Marking: SpriteCallback = (sprite, rt) => {
  if (sMenu.markingsArray[sprite.data[0]])
          rt.StartSpriteAnim(sprite.spriteId, 2 * sprite.data[0] + 1);  
      else
          rt.StartSpriteAnim(sprite.spriteId, 2 * sprite.data[0]);
};

/** Source: mon_markings.c → SpriteCB_Cursor */
