...
// Source : src/union_room_player_avatar.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: union_room_player_avatar.c → Task_AnimateUnionRoomPlayers */
export const Task_AnimateUnionRoomPlayers: TaskCallback = (task, rt) => {
