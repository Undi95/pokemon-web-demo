...
// Source : src/contest_painting.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: contest_painting.c → CB2_ContestPainting */
export const CB2_ContestPainting: CB2Callback = (rt) => {
  ShowContestPainting();
};

/** Source: contest_painting.c → CB2_HoldContestPainting */
export const CB2_HoldContestPainting: CB2Callback = (rt) => {
  HoldContestPainting();
      RunTextPrinters();
      UpdatePaletteFade();
};
