...
// Source : src/battle_tower.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_tower.c → Task_StartBattleAfterTransition */
export const Task_StartBattleAfterTransition: TaskCallback = (task, rt) => {
