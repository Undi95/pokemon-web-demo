  ...
  const data = task.data;
      ...
      case 2:
          if (--data[6] == 0)
          {
              ...
              data[0]++;
              CreateKyogreBubbleSprites_Body(0);
              CreateKyogreBubbleSprites_Fins(rt);
          }
          break;
      case 3:
          if (--data[6] == 0)
...
export const MainCB2_EndIntro = (rt) => {
