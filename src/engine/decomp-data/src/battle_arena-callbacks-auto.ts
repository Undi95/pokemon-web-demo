...
// Source : src/battle_arena.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
const JUDGMENT_STATE_FINISHED = 8;
...
/** Source: battle_arena.c → SpriteCB_JudgmentIcon */
export const SpriteCB_JudgmentIcon: SpriteCallback = (sprite, rt) => {
