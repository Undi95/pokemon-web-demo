...
// Source : src/pokenav_ribbons_summary.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: pokenav_ribbons_summary.c → SpriteCB_MonSpriteSlide */
export const SpriteCB_MonSpriteSlide: SpriteCallback = (sprite, rt) => {
  if (sprite.data[2] != 0)
      {
          sprite.data[2]--;
...
/** Source: pokenav_ribbons_summary.c → SpriteCB_WaitForRibbonAnimation */
export const SpriteCB_WaitForRibbonAnimation: SpriteCallback = (sprite, rt) => {
