...
// Stats: ops=321, bytes=2013, labels=48, unknownOps=0, unresolvedSymbols=32
...
export const STATS = { ops: 321, bytes: 2013, labels: 48, unknownOps: 0, unresolvedSymbols: 32 } as const;
