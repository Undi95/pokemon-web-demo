...
// Stats: ops=106, bytes=579, labels=19, unknownOps=0, unresolvedSymbols=15
...
export const STATS = { ops: 106, bytes: 579, labels: 19, unknownOps: 0, unresolvedSymbols: 15 } as const;
