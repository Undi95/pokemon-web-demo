...
// Stats: ops=126, bytes=1181, labels=26, unknownOps=0, unresolvedSymbols=31
...
export const STATS = { ops: 126, bytes: 1181, labels: 26, unknownOps: 0, unresolvedSymbols: 31 } as const;
