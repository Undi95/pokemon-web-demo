...
// Stats: ops=114, bytes=785, labels=24, unknownOps=0, unresolvedSymbols=25
...
export const STATS = { ops: 114, bytes: 785, labels: 24, unknownOps: 0, unresolvedSymbols: 25 } as const;
