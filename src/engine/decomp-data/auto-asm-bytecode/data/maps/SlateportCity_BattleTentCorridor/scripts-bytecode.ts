...
// Stats: ops=109, bytes=982, labels=21, unknownOps=0, unresolvedSymbols=25
...
export const STATS = { ops: 109, bytes: 982, labels: 21, unknownOps: 0, unresolvedSymbols: 25 } as const;
