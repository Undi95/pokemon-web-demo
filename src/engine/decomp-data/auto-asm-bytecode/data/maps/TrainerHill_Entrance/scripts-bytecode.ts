...
// Stats: ops=176, bytes=1249, labels=42, unknownOps=0, unresolvedSymbols=39
...
export const STATS = { ops: 176, bytes: 1249, labels: 42, unknownOps: 0, unresolvedSymbols: 39 } as const;
