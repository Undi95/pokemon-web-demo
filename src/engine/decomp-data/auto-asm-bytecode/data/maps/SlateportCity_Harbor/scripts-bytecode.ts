...
// Stats: ops=279, bytes=1887, labels=50, unknownOps=0, unresolvedSymbols=51
...
export const STATS = { ops: 279, bytes: 1887, labels: 50, unknownOps: 0, unresolvedSymbols: 51 } as const;
