...
// Stats: ops=231, bytes=1209, labels=42, unknownOps=0, unresolvedSymbols=24
...
export const STATS = { ops: 231, bytes: 1209, labels: 42, unknownOps: 0, unresolvedSymbols: 24 } as const;
