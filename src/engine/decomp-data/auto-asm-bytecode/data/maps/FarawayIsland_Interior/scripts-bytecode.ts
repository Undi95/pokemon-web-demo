...
// Stats: ops=134, bytes=772, labels=24, unknownOps=0, unresolvedSymbols=16
...
export const STATS = { ops: 134, bytes: 772, labels: 24, unknownOps: 0, unresolvedSymbols: 16 } as const;
