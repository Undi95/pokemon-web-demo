...
// Stats: ops=188, bytes=1491, labels=36, unknownOps=0, unresolvedSymbols=36
...
export const STATS = { ops: 188, bytes: 1491, labels: 36, unknownOps: 0, unresolvedSymbols: 36 } as const;
