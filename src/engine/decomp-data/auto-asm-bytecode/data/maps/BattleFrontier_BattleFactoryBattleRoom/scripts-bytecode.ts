...
// Stats: ops=179, bytes=1663, labels=32, unknownOps=0, unresolvedSymbols=36
...
export const STATS = { ops: 179, bytes: 1663, labels: 32, unknownOps: 0, unresolvedSymbols: 36 } as const;
