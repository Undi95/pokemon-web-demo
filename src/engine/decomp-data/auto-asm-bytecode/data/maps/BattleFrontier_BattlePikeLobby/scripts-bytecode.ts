...
// Stats: ops=195, bytes=1688, labels=36, unknownOps=0, unresolvedSymbols=44
...
export const STATS = { ops: 195, bytes: 1688, labels: 36, unknownOps: 0, unresolvedSymbols: 44 } as const;
