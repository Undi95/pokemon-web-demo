...
// Stats: ops=325, bytes=3150, labels=56, unknownOps=0, unresolvedSymbols=46
...
export const STATS = { ops: 325, bytes: 3150, labels: 56, unknownOps: 0, unresolvedSymbols: 46 } as const;
