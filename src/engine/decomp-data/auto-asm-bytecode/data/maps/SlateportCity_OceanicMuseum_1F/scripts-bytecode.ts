...
// Stats: ops=147, bytes=801, labels=38, unknownOps=0, unresolvedSymbols=32
...
export const STATS = { ops: 147, bytes: 801, labels: 38, unknownOps: 0, unresolvedSymbols: 32 } as const;
