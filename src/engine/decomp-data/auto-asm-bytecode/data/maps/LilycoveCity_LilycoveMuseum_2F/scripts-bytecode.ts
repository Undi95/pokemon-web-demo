...
// Stats: ops=147, bytes=919, labels=34, unknownOps=0, unresolvedSymbols=26
...
export const STATS = { ops: 147, bytes: 919, labels: 34, unknownOps: 0, unresolvedSymbols: 26 } as const;
