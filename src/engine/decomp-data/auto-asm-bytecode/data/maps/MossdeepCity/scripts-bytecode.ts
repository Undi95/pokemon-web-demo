...
// Stats: ops=236, bytes=837, labels=34, unknownOps=0, unresolvedSymbols=33
...
export const STATS = { ops: 236, bytes: 837, labels: 34, unknownOps: 0, unresolvedSymbols: 33 } as const;
