...
// Stats: ops=194, bytes=1370, labels=37, unknownOps=0, unresolvedSymbols=29
...
export const STATS = { ops: 194, bytes: 1370, labels: 37, unknownOps: 0, unresolvedSymbols: 29 } as const;
