...
// Stats: ops=58, bytes=268, labels=12, unknownOps=0, unresolvedSymbols=8
...
export const STATS = { ops: 58, bytes: 268, labels: 12, unknownOps: 0, unresolvedSymbols: 8 } as const;
