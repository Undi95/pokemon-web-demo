...
// Stats: ops=183, bytes=966, labels=33, unknownOps=0, unresolvedSymbols=27
...
export const STATS = { ops: 183, bytes: 966, labels: 33, unknownOps: 0, unresolvedSymbols: 27 } as const;
