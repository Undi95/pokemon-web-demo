...
// Stats: ops=191, bytes=1120, labels=41, unknownOps=0, unresolvedSymbols=31
...
export const STATS = { ops: 191, bytes: 1120, labels: 41, unknownOps: 0, unresolvedSymbols: 31 } as const;
