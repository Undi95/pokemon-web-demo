...
// Stats: ops=207, bytes=1107, labels=37, unknownOps=0, unresolvedSymbols=20
...
export const STATS = { ops: 207, bytes: 1107, labels: 37, unknownOps: 0, unresolvedSymbols: 20 } as const;
