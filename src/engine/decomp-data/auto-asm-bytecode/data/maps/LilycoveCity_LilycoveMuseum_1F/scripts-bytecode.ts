...
// Stats: ops=97, bytes=638, labels=31, unknownOps=0, unresolvedSymbols=32
...
export const STATS = { ops: 97, bytes: 638, labels: 31, unknownOps: 0, unresolvedSymbols: 32 } as const;
