...
// Stats: ops=181, bytes=1305, labels=36, unknownOps=0, unresolvedSymbols=37
...
export const STATS = { ops: 181, bytes: 1305, labels: 36, unknownOps: 0, unresolvedSymbols: 37 } as const;
