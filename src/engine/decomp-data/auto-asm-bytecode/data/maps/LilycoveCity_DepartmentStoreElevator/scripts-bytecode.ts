...
// Stats: ops=89, bytes=877, labels=16, unknownOps=0, unresolvedSymbols=21
...
export const STATS = { ops: 89, bytes: 877, labels: 16, unknownOps: 0, unresolvedSymbols: 21 } as const;
