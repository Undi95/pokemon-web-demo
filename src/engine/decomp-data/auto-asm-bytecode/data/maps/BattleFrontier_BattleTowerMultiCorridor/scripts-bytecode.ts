...
// Stats: ops=121, bytes=662, labels=20, unknownOps=0, unresolvedSymbols=14
...
export const STATS = { ops: 121, bytes: 662, labels: 20, unknownOps: 0, unresolvedSymbols: 14 } as const;
