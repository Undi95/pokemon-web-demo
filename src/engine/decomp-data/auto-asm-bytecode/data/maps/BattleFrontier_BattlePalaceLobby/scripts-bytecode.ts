...
// Stats: ops=259, bytes=2256, labels=58, unknownOps=0, unresolvedSymbols=55
...
export const STATS = { ops: 259, bytes: 2256, labels: 58, unknownOps: 0, unresolvedSymbols: 55 } as const;
