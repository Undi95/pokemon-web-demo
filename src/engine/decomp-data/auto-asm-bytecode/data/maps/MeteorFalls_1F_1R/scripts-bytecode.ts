...
// Stats: ops=194, bytes=889, labels=19, unknownOps=0, unresolvedSymbols=25
...
export const STATS = { ops: 194, bytes: 889, labels: 19, unknownOps: 0, unresolvedSymbols: 25 } as const;
