...
// Stats: ops=166, bytes=1080, labels=26, unknownOps=0, unresolvedSymbols=32
...
export const STATS = { ops: 166, bytes: 1080, labels: 26, unknownOps: 0, unresolvedSymbols: 32 } as const;
