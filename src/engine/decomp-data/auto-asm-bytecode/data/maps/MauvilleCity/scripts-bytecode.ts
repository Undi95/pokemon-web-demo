...
// Stats: ops=353, bytes=1814, labels=53, unknownOps=0, unresolvedSymbols=45
...
export const STATS = { ops: 353, bytes: 1814, labels: 53, unknownOps: 0, unresolvedSymbols: 45 } as const;
