...
// Stats: ops=146, bytes=757, labels=27, unknownOps=0, unresolvedSymbols=25
...
export const STATS = { ops: 146, bytes: 757, labels: 27, unknownOps: 0, unresolvedSymbols: 25 } as const;
