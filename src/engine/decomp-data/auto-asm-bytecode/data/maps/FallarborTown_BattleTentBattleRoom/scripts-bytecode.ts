...
// Stats: ops=169, bytes=1364, labels=31, unknownOps=0, unresolvedSymbols=27
...
export const STATS = { ops: 169, bytes: 1364, labels: 31, unknownOps: 0, unresolvedSymbols: 27 } as const;
