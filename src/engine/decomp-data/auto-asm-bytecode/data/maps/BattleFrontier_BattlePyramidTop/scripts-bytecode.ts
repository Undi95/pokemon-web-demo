...
// Stats: ops=160, bytes=1349, labels=29, unknownOps=0, unresolvedSymbols=38
...
export const STATS = { ops: 160, bytes: 1349, labels: 29, unknownOps: 0, unresolvedSymbols: 38 } as const;
