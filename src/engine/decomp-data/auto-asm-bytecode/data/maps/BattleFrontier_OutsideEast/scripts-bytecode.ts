...
// Stats: ops=149, bytes=603, labels=41, unknownOps=0, unresolvedSymbols=41
...
export const STATS = { ops: 149, bytes: 603, labels: 41, unknownOps: 0, unresolvedSymbols: 41 } as const;
