...
// Stats: ops=92, bytes=526, labels=19, unknownOps=0, unresolvedSymbols=13
...
export const STATS = { ops: 92, bytes: 526, labels: 19, unknownOps: 0, unresolvedSymbols: 13 } as const;
