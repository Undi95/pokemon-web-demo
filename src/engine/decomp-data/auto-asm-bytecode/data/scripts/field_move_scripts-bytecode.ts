...
// Stats: ops=155, bytes=825, labels=47, unknownOps=0, unresolvedSymbols=9
...
export const STATS = { ops: 155, bytes: 825, labels: 47, unknownOps: 0, unresolvedSymbols: 9 } as const;
