...
export const TASKS = {
  ...
  "Task_LinkContest_CommunicateMonsEm": {
    callsTo: ["IsLinkTaskFinished","LinkContest_GetBlockReceivedFromAllPlayers","LinkContest_SendBlock","LinkContest_TryLinkStandby","StripPlayerAndMonNamesForLinkContest","SwitchTaskToFollowupFunc","memcpy"],
    dataReads: ["data[0]","data[12]"],
    dataWrites: ["data[0]","data[12]"],
  ...
  "Task_LinkContest_CommunicateRngEm": {
    callsTo: ["GetMultiplayerId","IsLinkTaskFinished","LinkContest_GetBlockReceived","LinkContest_SendBlock","LinkContest_TryLinkStandby","SwitchTaskToFollowupFunc","memcpy"],
    dataReads: ["data[0]","data[12]"],
    dataWrites: ["data[0]","data[12]"],
    terminalMarkers: ["SwitchTaskToFollowupFunc"],
    lineCount: 31,
    bodyC: "if (!LinkContest_TryLinkStandby(&gTasks[taskId].data[12]))\n        return;\n\n    switch (gTasks[taskId].data[0])\n    {\n    default:\n        gTasks[taskId].data[0] = 0;\n        gTasks[taskId].data[12] = 0;\n        SwitchTaskToFollowupFunc(taskId);\n        break;\n    case 0:\n        if (GetMultiplayerId() == 0)\n        {\n             \n            if (!IsLinkTaskFinished())\n                return;\n\n            if (LinkContest_SendBlock(&gRngValue, sizeof(gRngValue)) == 1)\n                gTasks[taskId].data[0]++;\n        }\n        else\n        {\n             \n            gTasks[taskId].data[0]++;\n        }\n        break;\n    case 1:\n         \n        if (LinkContest_GetBlockReceived(0))\n        {\n            memcpy(&gRngValue, gBlockRecvBuffer[0], sizeof(gRngValue));\n            memcpy(&gContestRngValue, gBlockRecvBuffer[0], sizeof(gContestRngValue));\n            gTasks[taskId].data[0]++;\n        }\n        break;\n    }",
  },
  "Task_LinkContest_CommunicateLeaderIdsEm": {
    callsTo: ["IsLinkTaskFinished","LinkContest_GetBlockReceivedFromAllPlayers","LinkContest_SendBlock","LinkContest_TryLinkStandby","SwitchTaskToFollowupFunc"],
    dataReads: ["data[0]","data[12]"],
    dataWrites: ["data[0]","data[12]"],
    terminalMarkers: ["SwitchTaskToFollowupFunc"],
    lineCount: 32,
  ...
  "Task_LinkContest_CommunicateCategoryEm": {
    callsTo: ["IsLinkTaskFinished","LinkContest_GetBlockReceivedFromAllPlayers","LinkContest_SendBlock","LinkContest_TryLinkStandby","SwitchTaskToFollowupFunc"],
    dataReads: ["data[0]","data[12]","tCategory"],
    dataWrites: ["data[0]","data[12]"],
    terminalMarkers: ["SwitchTaskToFollowupFunc"],
    lineCount: 32,
  ...
  "Task_LinkContest_CommunicateAIMonsEm": {
    callsTo: ["GetMultiplayerId","IsLinkTaskFinished","LinkContest_GetBlockReceived","LinkContest_SendBlock","LinkContest_TryLinkStandby","StripPlayerAndMonNamesForLinkContest","SwitchTaskToFollowupFunc","memcpy"],
    dataReads: ["data[0]","data[12]"],
    dataWrites: ["data[0]","data[12]"],
    terminalMarkers: ["SwitchTaskToFollowupFunc"],
    lineCount: 33,
