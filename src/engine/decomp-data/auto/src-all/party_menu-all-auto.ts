...
const {
  ...
  AdjustFriendship, Alloc, AllocPartyMenuBg, AllocPartyMenuBgGfx,
  AllocZeroed, AnimatePartySlot, AnimateSelectedPartyIcon, AnimateSprites,
  AnyStorageMonWithMove, AppendToList, BG_PLTT_ID, BeginEvolutionScene,
  BeginNormalPaletteFade, BlendPalettes, BlitBitmapToPartyWindow, BlitBitmapToWindow,
  BufferBagFullCantTakeItemMessage, BufferBattlePartyOrder, BufferBattlePartyOrderBySide, BufferMonStatsToTaskData,
  BuildOamBuffer, CB2_WriteMailToGiveMon, CalculatePlayerPartyCount, CanLearnTutorMove,
  CanMonLearnTMHM, CanMonLearnTMTutor, CanRegisterMonForTradingBoard, CanSpinTradeMon,
  CancelParticipationPrompt, ChangeBgX, CheckBattleEntriesAndGetMessage, CheckIfItemIsTMHMOrEvolutionStone,
  CheckPartyPokerus, ChooseMonForSoftboiled, CleanupOverworldWindowsAndTilemaps, ClearMail,
  ClearScheduledBgCopiesToVram, ClearSelectedPartyOrder, ClearStdWindowAndFrameToTransparent, ClearWindowTilemap,
  ConvertIntToDecimalStringN, ConvertInternationalPlayerName, CopyItemName, CopyRectToBgTilemapBufferRect,
  CopyToBgTilemapBufferRect_ChangePalette, CopyToBufferFromBgTilemap, CopyWindowToVram, CpuCopy16,
  CreateCancelConfirmPokeballSprites, CreateCancelConfirmWindows, CreateHeldItemSpriteForTrade, CreateLevelUpStatsWindow,
  CreateMonIcon, CreatePartyMonHeldItemSprite, CreatePartyMonHeldItemSpriteParameterized, CreatePartyMonIconSprite,
  CreatePartyMonIconSpriteParameterized, CreatePartyMonPokeballSprite, CreatePartyMonPokeballSpriteParameterized, CreatePartyMonSprites,
  CreatePartyMonSpritesLoop, CreatePartyMonStatusSprite, CreatePartyMonStatusSpriteParameterized, CreatePokeballButtonSprite,
  CreateSelectionWindow, CreateSmallPokeballButtonSprite, CreateSprite, CreateTask,
  CreateYesNoMenu, CurrentBattlePyramidLocation, CursorCb_Cancel1, DeactivateAllTextPrinters,
  DestroyTask, DisplayAlreadyHoldingItemSwitchMessage, DisplayCancelChooseMonYesNo, DisplayCantUseFlashMessage,
  DisplayCantUseSurfMessage, DisplayFieldMoveExitAreaMessage, DisplayGaveHeldItemMessage, DisplayItemMustBeRemovedFirstMessage,
  DisplayLearnMoveMessage, DisplayLearnMoveMessageAndClose, DisplayLevelUpStatsPg1, DisplayLevelUpStatsPg2,
  DisplayMonLearnedMove, DisplayMonNeedsToReplaceMove, DisplayPartyMenuForgotMoveMessage, DisplayPartyMenuMessage,
  DisplayPartyMenuStdMessage, DisplayPartyPokemonBarDetail, DisplayPartyPokemonData, DisplayPartyPokemonDataForBattlePyramidHeldItem,
  DisplayPartyPokemonDataForChooseHalf, DisplayPartyPokemonDataForContest, DisplayPartyPokemonDataForMoveTutorOrEvolutionItem, DisplayPartyPokemonDataForMultiBattle,
  DisplayPartyPokemonDataForRelearner, DisplayPartyPokemonDataForWirelessMinigame, DisplayPartyPokemonDataToTeachMove, DisplayPartyPokemonDescriptionData,
  DisplayPartyPokemonDescriptionText, DisplayPartyPokemonGender, DisplayPartyPokemonGenderNidoranCheck, DisplayPartyPokemonHP,
  DisplayPartyPokemonHPBar, DisplayPartyPokemonHPBarCheck, DisplayPartyPokemonHPCheck, DisplayPartyPokemonLevel,
  DisplayPartyPokemonLevelCheck, DisplayPartyPokemonMaxHP, DisplayPartyPokemonMaxHPCheck, DisplayPartyPokemonNickname,
  DisplaySelectionWindow, DisplaySwitchedHeldItemMessage, DisplayTookHeldItemMessage, DoEasyChatScreen,
  DoScheduledBgTilemapCopiesToVram, DrawCancelConfirmButtons, DrawEmptySlot, DrawLevelUpWindowPg1,
  DrawLevelUpWindowPg2, DrawStdFrameWithCustomTileAndPalette, ExecuteTableBasedItemEffect, ExecuteTableBasedItemEffect_,
  ExitPartyMenu, FadeInFromBlack, FadeScreen, FieldEffectStart,
  FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FillWindowPixelRect,
  FinishTwoMonAction, FlagGet, Free, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreePartyPointers, FuncIsActiveTask, GetAilmentFromStatus,
  GetBattleEntryEligibility, GetBattleEntryLevelCap, GetBattlerAtPosition, GetBattlerSide,
  GetContestEntryEligibility, GetCurrentPartySlotPtr, GetCursorSelectionMonId, GetEvolutionTargetSpecies,
  GetFacilityCancelString, GetFieldMoveMonSpecies, GetFontAttribute, GetHPBarLevel,
  GetHostRfuGameData, GetItemEffectType, GetLRKeysPressedAndHeld, GetMapNameGeneric,
  GetMaxBattleEntries, GetMedicineItemEffectMessage, GetMenuCursorDimensionByFont, GetMinBattleEntries,
  GetMonAilment, GetMonData, GetMonGender, GetMonNickname,
  GetMoveSlotToReplace, GetNewSlotDoubleLayout, GetNumberOfRelearnableMoves, GetOverworldTextboxPalettePtr,
  GetPartyBoxPaletteFlags, GetPartyIdFromBattlePartyId, GetPartyIdFromBattleSlot, GetPartyLayoutFromBattleType,
  GetPartyMenuActionsType, GetPartyMenuActionsTypeInBattle, GetPartyMenuBgTile, GetPartyMenuPalBufferPtr,
  GetPartySlotEntryStatus, GetPlayerFlankId, GetPlayerTextSpeedDelay, GetPocketByItemId,
  GetScaledHPFraction, GetStringCenterAlignXOffset, GetTrainerPartnerName, GetTutorMove,
  GetUnionRoomTradeMessageId, GetWindowAttribute, GetXYCoordsOneStepInFrontOfPlayer, GiveItemOrMailToSelectedMon,
  GiveItemToMon, GiveItemToSelectedMon, GiveMailToMon, GiveMailToMonByItemId,
  GiveMoveToMon, GoToBagMenu, GoToBattlePyramidBagMenu, HandleBattleLowHpMusicChange,
  HandleChooseMonCancel, HandleChooseMonSelection, HasPartySlotAlreadyBeenSelected, ITEM_HAS_EFFECT,
  InBattlePike, InMultiPartnerRoom, InUnionRoom, InitBgsFromTemplates,
  InitMenuInUpperLeftCorner, InitMenuInUpperLeftCornerNormal, InitPartyMenu, InitPartyMenuBoxes,
  InitPartyMenuWindows, InitWindows, IsDma3ManagerBusyWithBgCopy, IsDoubleBattle,
  IsFanfareTaskInactive, IsHPRecoveryItem, IsItemFlute, IsMonAllowedInDodrioBerryPicking,
  ...
  IsWeatherNotFadingIn, ItemEffectToMonEv, ItemEffectToStatString, ItemIdToBattleMoveId,
  ItemIsMail, JOY_NEW, LOAD_PARTY_BOX_PAL, LZDecompressWram,
  LoadBgTiles, LoadCompressedPalette, LoadCompressedSpritePalette, LoadCompressedSpriteSheet,
  LoadHeldItemIcons, LoadMonIconPalettes, LoadOam, LoadPalette,
  LoadPartyBoxPalette, LoadPartyMenuAilmentGfx, LoadPartyMenuPokeballGfx, LoadSpritePalette,
  LoadSpriteSheet, LoadUserWindowBorderGfx, LockPlayerFieldControls, MAP_GROUP,
  MAP_NUM, MapGridGetMetatileBehaviorAt, MenuHelpers_IsLinkActive, MenuHelpers_ShouldWaitForLinkRecv,
  Menu_GetCursorPos, Menu_ProcessInput, Menu_ProcessInputNoWrapAround_other, Menu_ProcessInputNoWrapClearOnChoose,
  MetatileBehavior_IsWaterfall, MonKnowsMove, MonTryLearningNewMove, MoveAndBufferPartySlot,
  MoveCursorToConfirm, MoveMultiPartyMenuBoxSprite, MovePartyMenuBoxSprites, NotUsingHPEVItemOnShedinja,
  Overworld_GetMapHeaderByGroupAndId, Overworld_MapTypeAllowsTeleportAndFly, PIXEL_FILL, PLTT_ID,
  PLTT_SIZEOF, PartyBoxPal_ParnterOrDisqualifiedInArena, PartyHasMonWithSurf, PartyMenuButtonHandler,
  PartyMenuDisplayYesNoMenu, PartyMenuModifyHP, PartyMenuRemoveWindow, PartyMenuStartSpriteAnim,
  PartyMenuTryEvolution, PartyPaletteBufferCopy, PlayFanfare, PlayFanfareByFanfareNum,
  PlaySE, PrintMessage, ProcessMenuInput_other, ProcessSpriteCopyRequests,
  PutWindowTilemap, ReadMail, RemoveBagItem, RemoveItemToGiveFromBag,
  RemoveLevelUpStatsWindow, RemoveMonPPBonus, RemovePCItem, RemoveWindow,
  RenderPartyMenuBox, RenderPartyMenuBoxes, ResetAllBgsCoordinates, ResetBgsAndClearDma3BusyFlags,
  ResetHPTaskData, ResetPaletteFade, ResetPartyMenu, ResetSpriteData,
  ResetTasks, ResetVramOamAndBgCntRegs, ReshowBattleScreenDummy, ReturnGiveItemToBagOrPC,
  ReturnToUseOnWhichMon, RunTasks, RunTextPrintersRetIsActive, ScanlineEffect_Stop,
  ScheduleBgCopyTilemapToVram, ScriptContext_Enable, SetBgTilemapBuffer, SetBgTilemapPalette,
  SetGpuReg, SetMainCallback2, SetMonData, SetMonMoveSlot,
  SetMonPreventsSwitchingString, SetPartyHPBarSprite, SetPartyIdAtBattleSlot, SetPartyMonAilmentGfx,
  SetPartyMonFieldSelectionActions, SetPartyMonSelectionActions, SetPartyMonsAllowedInMinigame, SetSelectedMoveForPPItem,
  SetTaskFuncWithFollowupFunc, SetVBlankCallback, SetVBlankHBlankCallbacksToNull, SetWindowTemplateFields,
  ShiftMoveSlot, ShouldUseChooseMonText, ShowBg, ShowMoveSelectWindow,
  ShowOrHideHeldItemSprite, ShowPartyMenu, ShowPokemonSummaryScreen, ShowSelectMovePokemonSummaryScreen,
  SlideMultiPartyMenuBoxSpritesOneStep, SlidePartyMenuBoxOneStep, SlidePartyMenuBoxSpritesOneStep, StartSpriteAnim,
  StopLearningMovePrompt, StringAppend, StringCompare, StringCopy,
  StringExpandPlaceholders, StringGet_Nickname, SwapPartyPokemon, SwitchMenuBoxSprites,
  SwitchPartyMon, SwitchPartyMonSlots, SwitchSelectedMons, SwitchTaskToFollowupFunc,
  TakeMailFromMon, TakeMailFromMonAndSave, Task_ClosePartyMenu, Task_LearnedMove,
  Task_ReturnToChooseMonAfterText, Task_TryCreateSelectionWindow, Task_TryLearningNextMove, Task_TryUseSoftboiledOnPartyMon,
  TestPlayerAvatarFlags, TransferPlttBuffer, TryEnterMonForMinigame, TryGiveItemOrMailToSelectedMon,
  TryGiveMailToSelectedMon, TryMovePartySlot, TrySetDiveWarp, TrySwitchInPokemon,
  TryTakeMonItem, TryTutorSelectedMon, TryUsePPItem, UnlockPlayerFieldControls,
  UpdateCurrentPartySelection, UpdateHPBar, UpdateMonDisplayInfoAfterRareCandy, UpdateMonIconFrame,
  UpdatePaletteFade, UpdatePartyMonAilmentGfx, UpdatePartyMonHPBar, UpdatePartyMonHeldItemSprite,
  UpdatePartySelectionDoubleLayout, UpdatePartySelectionSingleLayout, UpdatePartyToBattleOrder, UpdatePartyToFieldOrder,
  UseSacredAsh, VarGet, WaitFanfare,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
