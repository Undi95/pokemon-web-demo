...
const {
  ...
  CreateYesNoMenu, CurrentBattlePyramidLocation, DeactivateAllTextPrinters, DestroyTask,
  DoEasyChatScreen, DoScheduledBgTilemapCopiesToVram, DrawLevelUpWindowPg1, DrawLevelUpWindowPg2,
  DrawStdFrameWithCustomTileAndPalette, ExecuteTableBasedItemEffect, FadeInFromBlack, FadeScreen,
  FieldEffectStart, FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  FillWindowPixelRect, FlagGet, Free, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FuncIsActiveTask, GetBattlerAtPosition, GetBattlerSide,
  GetContestEntryEligibility, GetCurrentPartySlotPtr, GetEvolutionTargetSpecies, GetFacilityCancelString,
  GetFontAttribute, GetHPBarLevel, GetHostRfuGameData, GetLRKeysPressedAndHeld,
  GetMapNameGeneric, GetMenuCursorDimensionByFont, GetMonData, GetMonGender,
  GetMonNickname, GetMoveSlotToReplace, GetNumberOfRelearnableMoves, GetOverworldTextboxPalettePtr,
  GetPartyMenuBgTile, GetPartyMenuPalBufferPtr, GetPlayerFlankId, GetPlayerTextSpeedDelay,
  GetPocketByItemId, GetScaledHPFraction, GetStringCenterAlignXOffset, GetTrainerPartnerName,
  GetUnionRoomTradeMessageId, GetWindowAttribute, GetXYCoordsOneStepInFrontOfPlayer, GiveMailToMon,
  GiveMailToMonByItemId, GiveMoveToMon, GoToBagMenu, GoToBattlePyramidBagMenu,
  HandleBattleLowHpMusicChange, ITEM_HAS_EFFECT, InBattlePike, InMultiPartnerRoom,
  InUnionRoom, InitBgsFromTemplates, InitMenuInUpperLeftCorner, InitMenuInUpperLeftCornerNormal,
  InitWindows, IsDma3ManagerBusyWithBgCopy, IsDoubleBattle, IsFanfareTaskInactive,
  IsPlayerFacingSurfableFishableWater, IsPlayerSurfingNorth, IsSpeciesAllowedInPokemonJump, IsWeatherNotFadingIn,
  ...
  MetatileBehavior_IsWaterfall, MonTryLearningNewMove, Overworld_GetMapHeaderByGroupAndId, Overworld_MapTypeAllowsTeleportAndFly,
  PIXEL_FILL, PLTT_ID, PLTT_SIZEOF, PartyHasMonWithSurf,
  PlayFanfare, PlayFanfareByFanfareNum, PlaySE, ProcessMenuInput_other,
  ProcessSpriteCopyRequests, PutWindowTilemap, ReadMail, RemoveBagItem,
  ...
  ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram, ScriptContext_Enable, SetBgTilemapBuffer,
  SetBgTilemapPalette, SetGpuReg, SetMainCallback2, SetMonData,
  SetMonMoveSlot, SetMonPreventsSwitchingString, SetPartyHPBarSprite, SetTaskFuncWithFollowupFunc,
  SetVBlankCallback, SetVBlankHBlankCallbacksToNull, SetWindowTemplateFields, ShowBg,
  ShowPokemonSummaryScreen, ShowSelectMovePokemonSummaryScreen, StartSpriteAnim, StringAppend,
  StringCompare, StringCopy, StringExpandPlaceholders, StringGet_Nickname,
  SwitchTaskToFollowupFunc, TakeMailFromMon, TakeMailFromMonAndSave, Task_TryUseSoftboiledOnPartyMon,
  TestPlayerAvatarFlags, TransferPlttBuffer, TrySetDiveWarp, UnlockPlayerFieldControls,
  UpdateMonIconFrame, UpdatePaletteFade, VarGet, WaitFanfare,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
