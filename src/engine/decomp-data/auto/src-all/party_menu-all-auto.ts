...
export function InitPartyMenu(...args: any[]): any {
  let i: any = null;
...
export function Task_ExitPartyMenu(...args: any[]): any {
...
export function PartyPaletteBufferCopy(...args: any[]): any {
  let offset = PLTT_ID(palNum);
...
export function InitPartyMenuBoxes(...args: any[]): any {
  let i: any = null;
...
export function RenderPartyMenuBox(...args: any[]): any {
...
export function DisplayPartyPokemonData(...args: any[]): any {
...
export function DisplayPartyPokemonDescriptionData(...args: any[]): any {
...
export function DisplayPartyPokemonDataForChooseHalf(...args: any[]): any {
  let i: any = null;
      let mon: any = gPlayerParty[slot];
      let order = gSelectedOrderFromParty;
...
export function DisplayPartyPokemonDataForContest(...args: any[]): any {
...
export function DisplayPartyPokemonDataForRelearner(...args: any[]): any {
...
export function DisplayPartyPokemonDataForWirelessMinigame(...args: any[]): any {
...
export function DisplayPartyPokemonDataForBattlePyramidHeldItem(...args: any[]): any {
...
export function DisplayPartyPokemonDataForMoveTutorOrEvolutionItem(...args: any[]): any {
...
export function DisplayPartyPokemonDataToTeachMove(...args: any[]): any {
...
export function DisplayPartyPokemonDataForMultiBattle(...args: any[]): any {
  let menuBox: any = sPartyMenuBoxes[slot];
      let actualSlot = slot - MULTI_PARTY_SIZE;
...
export function CreatePartyMonSprites(...args: any[]): any {
...
export function AnimatePartySlot(...args: any[]): any {
...
export function GetPartyBoxPaletteFlags(...args: any[]): any {
  let palFlags = 0;
...
export function PartyBoxPal_ParnterOrDisqualifiedInArena(...args: any[]): any {
...
export function SwapPartyPokemon(...args: any[]): any {
  let temp: any = Alloc(sizeof(struct Pokemon));
...
export function Task_ClosePartyMenu(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_ClosePartyMenuAndSetCB2;
}

/** static void Task_ClosePartyMenuAndSetCB2(u8 taskId) */
export function Task_ClosePartyMenuAndSetCB2(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_HandleChooseMonInput(...args: any[]): any {
...
export function HandleChooseMonSelection(...args: any[]): any {
...
export function IsSelectedMonNotEgg(...args: any[]): any {
...
export function HandleChooseMonCancel(...args: any[]): any {
  switch (gPartyMenu.action)
      {
...
export function DisplayCancelChooseMonYesNo(...args: any[]): any {
  let stringPtr = NULL;
...
export function Task_CancelChooseMonYesNo(...args: any[]): any {
...
export function Task_HandleCancelChooseMonYesNoInput(...args: any[]): any {
...
export function PartyMenuButtonHandler(...args: any[]): any {
...
export function UpdateCurrentPartySelection(...args: any[]): any {
  let newSlotId = *slotPtr;
      let layout = gPartyMenu.layout;
...
export function UpdatePartySelectionSingleLayout(...args: any[]): any {
  switch (movementDir)
      {
      case MENU_DIR_UP:
          if (*slotPtr == 0)
...
export function UpdatePartySelectionDoubleLayout(...args: any[]): any {
...
export function GetNewSlotDoubleLayout(...args: any[]): any {
  while (TRUE)
      {
          slotId += movementDir;
...
export function DisplayPartyMenuMessage(...args: any[]): any {
  let taskId: any = null;
...
export function Task_PrintAndWaitForText(...args: any[]): any {
...
export function Task_WaitForLinkAndReturnToChooseMon(...args: any[]): any {
...
export function Task_ReturnToChooseMonAfterText(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          ClearStdWindowAndFrameToTransparent(WIN_MSG, FALSE);
          ClearWindowTilemap(WIN_MSG);
...
export function DisplayGaveHeldItemMessage(...args: any[]): any {
...
export function DisplayTookHeldItemMessage(...args: any[]): any {
  GetMonNickname(mon, gStringVar1);
      CopyItemName(item, gStringVar2);
...
export function DisplayAlreadyHoldingItemSwitchMessage(...args: any[]): any {
  GetMonNickname(mon, gStringVar1);
      CopyItemName(item, gStringVar2);
...
export function DisplaySwitchedHeldItemMessage(...args: any[]): any {
...
export function TryTakeMonItem(...args: any[]): any {
...
export function BufferBagFullCantTakeItemMessage(...args: any[]): any {
  StringExpandPlaceholders(gStringVar4, gText_BagFullCouldNotRemoveItem);
}

/** static void Task_PartyMenuModifyHP(u8 taskId) */
export function Task_PartyMenuModifyHP(...args: any[]): any {
...
export function PartyMenuModifyHP(...args: any[]): any {
  let mon: any = gPlayerParty[slot];
      let data = gTasks[taskId].data;
...
export function ResetHPTaskData(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function GetAilmentFromStatus(...args: any[]): any {
...
export function GetMonAilment(...args: any[]): any {
...
export function IsMonAllowedInPokemonJump(...args: any[]): any {
...
export function IsMonAllowedInDodrioBerryPicking(...args: any[]): any {
...
export function IsMonAllowedInMinigame(...args: any[]): any {
...
export function TryEnterMonForMinigame(...args: any[]): any {
  if (IsMonAllowedInMinigame(slot) == TRUE)
      {
          PlaySE(SE_SELECT);
...
export function CancelParticipationPrompt(...args: any[]): any {
...
export function Task_CancelParticipationYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleCancelParticipationYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:
          gSpecialVar_0x8004 = PARTY_SIZE + 1;
...
export function CanMonLearnTMTutor(...args: any[]): any {
  let move: any = null;
...
export function GetTutorMove(...args: any[]): any {
  return gTutorMoves[tutor];
}

/** static bool8 CanLearnTutorMove(u16 species, u8 tutor) */
export function CanLearnTutorMove(...args: any[]): any {
...
export function InitPartyMenuWindows(...args: any[]): any {
  let i: any = null;
...
export function CreateCancelConfirmWindows(...args: any[]): any {
...
export function BlitBitmapToPartyWindow(...args: any[]): any {
  let pixels = AllocZeroed(height * width * 32);
      let i, j;
...
export function BlitBitmapToPartyWindow_LeftColumn(...args: any[]): any {
  if (width == 0 && height == 0)
      {
          width = 10;
          height = 7;
...
export function BlitBitmapToPartyWindow_RightColumn(...args: any[]): any {
  if (width == 0 && height == 0)
      {
          width = 18;
          height = 3;
...
export function DrawEmptySlot(...args: any[]): any {
...
export function LoadPartyBoxPalette(...args: any[]): any {
  let palOffset = BG_PLTT_ID(GetWindowAttribute(menuBox.windowId, WINDOW_PALETTE_NUM));
...
export function DisplayPartyPokemonBarDetail(...args: any[]): any {
...
export function DisplayPartyPokemonNickname(...args: any[]): any {
  const nickname: any[] = [];
...
export function DisplayPartyPokemonLevelCheck(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
      {
          let ailment = GetMonAilment(mon);
...
export function DisplayPartyPokemonLevel(...args: any[]): any {
...
export function DisplayPartyPokemonGenderNidoranCheck(...args: any[]): any {
  const nickname: any[] = [];
...
export function DisplayPartyPokemonGender(...args: any[]): any {
  let palOffset = BG_PLTT_ID(GetWindowAttribute(menuBox.windowId, WINDOW_PALETTE_NUM));
...
export function DisplayPartyPokemonHPCheck(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
      {
          if (c != 0)
...
export function DisplayPartyPokemonHP(...args: any[]): any {
  let strOut = ConvertIntToDecimalStringN(gStringVar1, hp, STR_CONV_MODE_RIGHT_ALIGN, 3);
...
export function DisplayPartyPokemonMaxHPCheck(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
      {
          if (c != 0)
...
export function DisplayPartyPokemonMaxHP(...args: any[]): any {
...
export function DisplayPartyPokemonHPBarCheck(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
...
export function DisplayPartyPokemonHPBar(...args: any[]): any {
  let palOffset = BG_PLTT_ID(GetWindowAttribute(menuBox.windowId, WINDOW_PALETTE_NUM));
...
export function DisplayPartyPokemonDescriptionText(...args: any[]): any {
  if (c)
      {
          let width = ((menuBox.infoRects.descTextLeft % 8) + menuBox.infoRects.descTextWidth + 7) / 8;
          let height = ((menuBox.infoRects.descTextTop % 8) + menuBox.infoRects.descTextHeight + 7) / 8;
...
export function PartyMenuRemoveWindow(...args: any[]): any {
  if (*ptr != WINDOW_NONE)
      {
...
export function DisplayPartyMenuStdMessage(...args: any[]): any {
  let windowPtr = sPartyMenuInternal.windowId[1];
...
export function DisplaySelectionWindow(...args: any[]): any {
  let window: any = null;
      ...
      {
          let fontColorsId = (sPartyMenuInternal.actions[i] >= MENU_FIELD_MOVES) ? 4 : 3;
...
export function SetPartyMonSelectionActions(...args: any[]): any {
  let i: any = null;
...
export function SetPartyMonFieldSelectionActions(...args: any[]): any {
  let i, j;
...
export function GetPartyMenuActionsType(...args: any[]): any {
...
export function CreateSelectionWindow(...args: any[]): any {
...
export function Task_TryCreateSelectionWindow(...args: any[]): any {
...
export function Task_HandleSelectionMenuInput(...args: any[]): any {
  if (!gPaletteFade.active && MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
          let input: any = null;
          let data = gTasks[taskId].data;
...
export function CursorCb_Summary(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function CursorCb_Switch(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function SwitchSelectedMons(...args: any[]): any {
  let data = gTasks[taskId].data;
      const windowIds: any[] = [];
...
export function TryMovePartySlot(...args: any[]): any {
  if (x + width < 0)
          return FALSE;
      if (x > 31)
          return FALSE;
...
export function MoveAndBufferPartySlot(...args: any[]): any {
...
export function MovePartyMenuBoxSprites(...args: any[]): any {
...
export function SlidePartyMenuBoxSpritesOneStep(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function SlidePartyMenuBoxOneStep(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_SlideSelectedSlotsOffscreen(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_SlideSelectedSlotsOnscreen(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function SwitchMenuBoxSprites(...args: any[]): any {
  let spriteIdBuffer = *spriteIdPtr1;
...
export function FinishTwoMonAction(...args: any[]): any {
  PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
...
export function CursorCb_Cancel1(...args: any[]): any {
  PlaySE(SE_SELECT);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
...
export function CursorCb_Item(...args: any[]): any {
  PlaySE(SE_SELECT);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
...
export function CursorCb_Give(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function Task_GiveHoldItem(...args: any[]): any {
  let item: any = null;
...
export function Task_SwitchHoldItemsPrompt(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_SwitchItemsYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleSwitchItemsYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:  
          RemoveBagItem(gSpecialVar_ItemId, 1);
...
export function Task_WriteMailToGiveMonAfterText(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
...
export function Task_DisplayGaveMailFromPartyMessage(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          if (sPartyMenuItemId == ITEM_NONE)
...
export function Task_UpdateHeldItemSprite(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function CursorCb_TakeItem(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let item = GetMonData(mon, MON_DATA_HELD_ITEM);
...
export function CursorCb_Toss(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let item = GetMonData(mon, MON_DATA_HELD_ITEM);
...
export function Task_TossHeldItemYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleTossHeldItemYesNoInput(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function Task_TossHeldItem(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function CursorCb_Mail(...args: any[]): any {
  PlaySE(SE_SELECT);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
...
export function CursorCb_Read(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function CursorCb_TakeMail(...args: any[]): any {
  PlaySE(SE_SELECT);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
...
export function Task_SendMailToPCYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleSendMailToPCYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:  
...
export function Task_LoseMailMessageYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleLoseMailMessageYesNoInput(...args: any[]): any {
  let item: any = null;
...
export function CursorCb_Cancel2(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function CursorCb_SendMon(...args: any[]): any {
  PlaySE(SE_SELECT);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
...
export function CursorCb_Enter(...args: any[]): any {
...
export function CursorCb_NoEntry(...args: any[]): any {
  let maxBattlers: any = null;
      let i, j;
...
export function CursorCb_Store(...args: any[]): any {
  PlaySE(SE_SELECT);
      Task_ClosePartyMenu(taskId);
}

/** static void CursorCb_Register(u8 taskId) */
export function CursorCb_Register(...args: any[]): any {
  let species2 = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_SPECIES_OR_EGG);
      let species = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_SPECIES);
      let isModernFatefulEncounter = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_MODERN_FATEFUL_ENCOUNTER);
...
export function CursorCb_Trade1(...args: any[]): any {
  let species2 = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_SPECIES_OR_EGG);
      let species = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_SPECIES);
      let isModernFatefulEncounter = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_MODERN_FATEFUL_ENCOUNTER);
      let stringId = GetUnionRoomTradeMessageId(*GetHostRfuGameData(), gRfuPartnerCompatibilityData, species2, gUnionRoomOfferedSpecies, gUnionRoomRequestedMonType, species, isModernFatefulEncounter);
...
export function CursorCb_Trade2(...args: any[]): any {
  PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[1]);
...
export function Task_SpinTradeYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleSpinTradeYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:
          Task_ClosePartyMenu(taskId);
...
export function CursorCb_FieldMove(...args: any[]): any {
  let fieldMove = sPartyMenuInternal.actions[Menu_GetCursorPos()] - MENU_FIELD_MOVES;
...
export function DisplayFieldMoveExitAreaMessage(...args: any[]): any {
  DisplayPartyMenuMessage(gStringVar4, TRUE);
      gTasks[taskId].func = Task_FieldMoveExitAreaYesNo;
}

/** static void Task_FieldMoveExitAreaYesNo(u8 taskId) */
export function Task_FieldMoveExitAreaYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleFieldMoveExitAreaYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:
          gPartyMenu.exitCallback = CB2_ReturnToField;
...
export function Task_FieldMoveWaitForFade(...args: any[]): any {
...
export function Task_CancelAfterAorBPress(...args: any[]): any {
...
export function CreatePartyMonIconSprite(...args: any[]): any {
  let handleDeoxys = TRUE;
...
export function CreatePartyMonIconSpriteParameterized(...args: any[]): any {
  if (species != SPECIES_NONE)
      {
...
export function UpdateHPBar(...args: any[]): any {
  switch (GetHPBarLevel(hp, maxhp))
      {
      case HP_BAR_FULL:
...
export function UpdatePartyMonHPBar(...args: any[]): any {
...
export function AnimateSelectedPartyIcon(...args: any[]): any {
...
export function SpriteCB_BouncePartyMonIcon(...args: any[]): any {
...
export function SpriteCB_UpdatePartyMonIcon(...args: any[]): any {
  UpdateMonIconFrame(sprite);
}

/** static void CreatePartyMonHeldItemSprite(struct Pokemon *mon, struct PartyMenuBox *menuBox) */
export function CreatePartyMonHeldItemSprite(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
      {
...
export function CreatePartyMonHeldItemSpriteParameterized(...args: any[]): any {
  if (species != SPECIES_NONE)
      {
          menuBox.itemSpriteId = CreateSprite(sSpriteTemplate_HeldItem, menuBox.spriteCoords[2], menuBox.spriteCoords[3], 0);
...
export function UpdatePartyMonHeldItemSprite(...args: any[]): any {
...
export function ShowOrHideHeldItemSprite(...args: any[]): any {
  if (item == ITEM_NONE)
      {
...
export function DrawHeldItemIconsForTrade(...args: any[]): any {
  let i: any = null;
      let item: any = null;
...
export function CreateHeldItemSpriteForTrade(...args: any[]): any {
  let subpriority = gSprites[spriteId].subpriority;
      let newSpriteId = CreateSprite(sSpriteTemplate_HeldItem, 250, 170, subpriority - 1);
...
export function SpriteCB_HeldItem(...args: any[]): any {
...
export function CreatePartyMonPokeballSprite(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
...
export function CreatePartyMonPokeballSpriteParameterized(...args: any[]): any {
  if (species != SPECIES_NONE)
      {
          menuBox.pokeballSpriteId = CreateSprite(sSpriteTemplate_MenuPokeball, menuBox.spriteCoords[6], menuBox.spriteCoords[7], 8);
...
export function CreatePokeballButtonSprite(...args: any[]): any {
  let spriteId = CreateSprite(sSpriteTemplate_MenuPokeball, x, y, 8);
...
export function CreatePartyMonStatusSprite(...args: any[]): any {
  if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
      {
...
export function CreatePartyMonStatusSpriteParameterized(...args: any[]): any {
  if (species != SPECIES_NONE)
      {
          menuBox.statusSpriteId = CreateSprite(sSpriteTemplate_StatusIcons, menuBox.spriteCoords[4], menuBox.spriteCoords[5], 0);
...
export function SetPartyMonAilmentGfx(...args: any[]): any {
...
export function UpdatePartyMonAilmentGfx(...args: any[]): any {
  switch (status)
      {
      case AILMENT_NONE:
      case AILMENT_PKRS:
...
export function Task_SetSacredAshCB(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          if (gPartyMenu.menuType == PARTY_MENU_TYPE_IN_BATTLE)
              sPartyMenuInternal.exitCallback = CB2_SetUpExitToBattleScreen;
...
export function IsHPRecoveryItem(...args: any[]): any {
  let effect: any = null;
...
export function GetMedicineItemEffectMessage(...args: any[]): any {
...
export function NotUsingHPEVItemOnShedinja(...args: any[]): any {
...
export function IsItemFlute(...args: any[]): any {
...
export function ExecuteTableBasedItemEffect_(...args: any[]): any {
  if (gMain.inBattle)
...
export function ItemUseCB_Medicine(...args: any[]): any {
  let hp = 0;
      let mon: any = gPlayerParty[gPartyMenu.slotId];
      let item = gSpecialVar_ItemId;
...
export function Task_DisplayHPRestoredMessage(...args: any[]): any {
  GetMonNickname(gPlayerParty[gPartyMenu.slotId], gStringVar1);
...
export function Task_ClosePartyMenuAfterText(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
...
export function ItemUseCB_ReduceEV(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let item = gSpecialVar_ItemId;
      let effectType = GetItemEffectType(item);
      let friendship = GetMonData(mon, MON_DATA_FRIENDSHIP);
      let ev = ItemEffectToMonEv(mon, effectType);
      let cannotUseEffect = ExecuteTableBasedItemEffect_(gPartyMenu.slotId, item, 0);
      let newFriendship = GetMonData(mon, MON_DATA_FRIENDSHIP);
      let newEv = ItemEffectToMonEv(mon, effectType);
...
export function ItemEffectToMonEv(...args: any[]): any {
  switch (effectType)
      {
      case ITEM_EFFECT_HP_EV:
...
export function ItemEffectToStatString(...args: any[]): any {
  switch (effectType)
      {
      case ITEM_EFFECT_HP_EV:
...
export function ShowMoveSelectWindow(...args: any[]): any {
  let i: any = null;
      let moveCount = 0;
      let fontId = FONT_NORMAL;
      let windowId = DisplaySelectionWindow(SELECTWINDOW_MOVES);
      let move: any = null;
...
export function Task_HandleWhichMoveInput(...args: any[]): any {
...
export function ItemUseCB_PPRecovery(...args: any[]): any {
  let effect: any = null;
      let item = gSpecialVar_ItemId;
...
export function SetSelectedMoveForPPItem(...args: any[]): any {
  PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
...
export function ReturnToUseOnWhichMon(...args: any[]): any {
  gTasks[taskId].func = Task_HandleChooseMonInput;
      sPartyMenuInternal.exitCallback = NULL;
      PartyMenuRemoveWindow(sPartyMenuInternal.windowId[0]);
...
export function TryUsePPItem(...args: any[]): any {
  let move = MOVE_NONE;
      let moveSlot = gPartyMenu.data1;
      let item = gSpecialVar_ItemId;
...
export function ItemUseCB_PPUp(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function ItemIdToBattleMoveId(...args: any[]): any {
  let tmNumber = item - ITEM_TM01;
      return sTMHMMoves[tmNumber];
}

/** bool8 IsMoveHm(u16 move) */
export function IsMoveHm(...args: any[]): any {
  let i: any = null;
...
export function MonKnowsMove(...args: any[]): any {
  let i: any = null;
...
export function DisplayLearnMoveMessage(...args: any[]): any {
...
export function DisplayLearnMoveMessageAndClose(...args: any[]): any {
  DisplayLearnMoveMessage(str);
      gTasks[taskId].func = Task_ClosePartyMenuAfterText;
}

/** void ItemUseCB_TMHM(u8 taskId, TaskFunc task) */
export function ItemUseCB_TMHM(...args: any[]): any {
  let mon: any = null;
      let move: any = null;
      let item: any = null;
...
export function Task_LearnedMove(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function Task_DoLearnedMoveFanfareAfterText(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
...
export function Task_LearnNextMoveOrClosePartyMenu(...args: any[]): any {
...
export function Task_ReplaceMoveYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleReplaceMoveYesNoInput(...args: any[]): any {
  switch (Menu_ProcessInputNoWrapClearOnChoose())
      {
      case 0:
...
export function Task_ShowSummaryScreenToForgetMove(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
...
export function Task_ReturnToPartyMenuWhileLearningMove(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function DisplayPartyMenuForgotMoveMessage(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let move = GetMonData(mon, MON_DATA_MOVE1 + GetMoveSlotToReplace());
...
export function Task_PartyMenuReplaceMove(...args: any[]): any {
  let mon: any = null;
      let move: any = null;
...
export function StopLearningMovePrompt(...args: any[]): any {
...
export function Task_StopLearningMoveYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleStopLearningMoveYesNoInput(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
...
export function Task_TryLearningNextMoveAfterText(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
          Task_TryLearningNextMove(taskId);
}

/** void ItemUseCB_RareCandy(u8 taskId, TaskFunc task) */
export function ItemUseCB_RareCandy(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let ptr: any = sPartyMenuInternal;
      let arrayPtr = ptr.data;
      let itemPtr = gSpecialVar_ItemId;
...
export function UpdateMonDisplayInfoAfterRareCandy(...args: any[]): any {
...
export function Task_DisplayLevelUpStatsPg1(...args: any[]): any {
...
export function Task_DisplayLevelUpStatsPg2(...args: any[]): any {
  if ((JOY_NEW(A_BUTTON)) || (JOY_NEW(B_BUTTON)))
      {
          PlaySE(SE_SELECT);
...
export function DisplayLevelUpStatsPg1(...args: any[]): any {
  let arrayPtr = sPartyMenuInternal.data;
...
export function DisplayLevelUpStatsPg2(...args: any[]): any {
  let arrayPtr = sPartyMenuInternal.data;
...
export function Task_TryLearnNewMoves(...args: any[]): any {
...
export function Task_TryLearningNextMove(...args: any[]): any {
...
export function PartyMenuTryEvolution(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let targetSpecies = GetEvolutionTargetSpecies(mon, EVO_MODE_NORMAL, ITEM_NONE);
...
export function DisplayMonNeedsToReplaceMove(...args: any[]): any {
  GetMonNickname(gPlayerParty[gPartyMenu.slotId], gStringVar1);
...
export function DisplayMonLearnedMove(...args: any[]): any {
  GetMonNickname(gPlayerParty[gPartyMenu.slotId], gStringVar1);
      StringCopy(gStringVar2, gMoveNames[move]);
      StringExpandPlaceholders(gStringVar4, gText_PkmnLearnedMove3);
      DisplayPartyMenuMessage(gStringVar4, TRUE);
...
export function BufferMonStatsToTaskData(...args: any[]): any {
...
export function ItemUseCB_SacredAsh(...args: any[]): any {
...
export function UseSacredAsh(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let hp: any = null;
...
export function Task_SacredAshLoop(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
...
export function Task_SacredAshDisplayHPRestored(...args: any[]): any {
  GetMonNickname(gPlayerParty[gPartyMenu.slotId], gStringVar1);
      StringExpandPlaceholders(gStringVar4, gText_PkmnHPRestoredByVar2);
      DisplayPartyMenuMessage(gStringVar4, FALSE);
      ScheduleBgCopyTilemapToVram(2);
...
export function ItemUseCB_EvolutionStone(...args: any[]): any {
  PlaySE(SE_SELECT);
      gCB2_AfterEvolution = gPartyMenu.exitCallback;
      if (ExecuteTableBasedItemEffect_(gPartyMenu.slotId, gSpecialVar_ItemId, 0))
      {
...
export function GetItemEffectType(...args: any[]): any {
...
export function TryTutorSelectedMon(...args: any[]): any {
  let mon: any = null;
      let move: any = null;
...
export function TryGiveItemOrMailToSelectedMon(...args: any[]): any {
  sPartyMenuItemId = GetMonData(gPlayerParty[gPartyMenu.slotId], MON_DATA_HELD_ITEM);
      if (sPartyMenuItemId == ITEM_NONE)
      {
...
export function GiveItemOrMailToSelectedMon(...args: any[]): any {
...
export function GiveItemToSelectedMon(...args: any[]): any {
  let item: any = null;
...
export function Task_UpdateHeldItemSpriteAndClosePartyMenu(...args: any[]): any {
...
export function Task_DisplayGaveMailFromBagMessage(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          if (sPartyMenuItemId != ITEM_NONE)
...
export function Task_SwitchItemsFromBagYesNo(...args: any[]): any {
  if (IsPartyMenuTextPrinterActive() != TRUE)
      {
          PartyMenuDisplayYesNoMenu();
...
export function Task_HandleSwitchItemsFromBagYesNoInput(...args: any[]): any {
  let item: any = null;
...
export function DisplayItemMustBeRemovedFirstMessage(...args: any[]): any {
...
export function RemoveItemToGiveFromBag(...args: any[]): any {
...
export function ReturnGiveItemToBagOrPC(...args: any[]): any {
...
export function TryGiveMailToSelectedMon(...args: any[]): any {
  let mon: any = gPlayerParty[gPartyMenu.slotId];
      let mail: any = null;
...
export function InitChooseHalfPartyForBattle(...args: any[]): any {
  ClearSelectedPartyOrder();
...
export function GetPartySlotEntryStatus(...args: any[]): any {
...
export function GetBattleEntryEligibility(...args: any[]): any {
  let i = 0;
...
export function CheckBattleEntriesAndGetMessage(): any {
  let maxBattlers: any = null;
      ...
      let party: any = gPlayerParty;
      let minBattlers = GetMinBattleEntries();
      let order = gSelectedOrderFromParty;
      ...
      for (i = 0; i < maxBattlers - 1; i++)
      {
          let species = GetMonData(party[order[i] - 1], MON_DATA_SPECIES);
          let item = GetMonData(party[order[i] - 1], MON_DATA_HELD_ITEM);
...
export function HasPartySlotAlreadyBeenSelected(...args: any[]): any {
  let i: any = null;
...
export function Task_ValidateChosenHalfParty(...args: any[]): any {
...
export function Task_ContinueChoosingHalfParty(...args: any[]): any {
  if ((JOY_NEW(A_BUTTON)) || (JOY_NEW(B_BUTTON)))
      {
          PlaySE(SE_SELECT);
          DisplayPartyMenuStdMessage(PARTY_MSG_CHOOSE_MON);
...
export function ChooseMonForTradingBoard(...args: any[]): any {
...
export function OpenPartyMenuInBattle(...args: any[]): any {
...
export function GetPartyMenuActionsTypeInBattle(...args: any[]): any {
...
export function TrySwitchInPokemon(): any {
  let slot = GetCursorSelectionMonId();
      ...
      {
          let currBattler = gBattlerInMenuId;
...
export function BufferBattlePartyOrder(...args: any[]): any {
  const partyIds: any[] = [];
      let i, j;
...
export function BufferBattlePartyCurrentOrderBySide(...args: any[]): any {
...
export function BufferBattlePartyOrderBySide(...args: any[]): any {
...
export function SwitchPartyOrderLinkMulti(...args: any[]): any {
  const partyIds: any[] = [];
      let tempSlot = 0;
      let i, j;
...
export function GetPartyIdFromBattleSlot(...args: any[]): any {
  let modResult = slot & 1;
      let retVal: any = null;
...
export function SetPartyIdAtBattleSlot(...args: any[]): any {
  let modResult = slot & 1;
...
export function SwitchPartyMonSlots(...args: any[]): any {
  let partyId = GetPartyIdFromBattleSlot(slot);
      SetPartyIdAtBattleSlot(slot, GetPartyIdFromBattleSlot(slot2));
      SetPartyIdAtBattleSlot(slot2, partyId);
}

/** u8 GetPartyIdFromBattlePartyId(u8 battlePartyId) */
export function GetPartyIdFromBattlePartyId(...args: any[]): any {
  let i, j;
...
export function UpdatePartyToBattleOrder(): any {
  let partyBuffer: any = Alloc(sizeof(gPlayerParty));
      let i: any = null;
...
export function Task_InitMultiPartnerPartySlideIn(...args: any[]): any {
...
export function Task_MultiPartnerPartySlideIn(...args: any[]): any {
  let data = gTasks[taskId].data;
      let i: any = null;
...
export function Task_WaitAfterMultiPartnerPartySlideIn(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MoveMultiPartyMenuBoxSprite(...args: any[]): any {
  if (x >= 0)
          gSprites[spriteId].x2 = x;
}

/** static void SlideMultiPartyMenuBoxSpritesOneStep(u8 taskId) */
export function SlideMultiPartyMenuBoxSpritesOneStep(...args: any[]): any {
  let data = gTasks[taskId].data;
      let i: any = null;
...
export function Task_PartyMenuWaitForFade(...args: any[]): any {
...
export function Task_ChooseContestMon(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_ChoosePartyMon(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          CleanupOverworldWindowsAndTilemaps();
...
export function Task_ChooseMonForMoveRelearner(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          CleanupOverworldWindowsAndTilemaps();
...
export function Task_BattlePyramidChooseMonHeldItems(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          CleanupOverworldWindowsAndTilemaps();
...
export function ShiftMoveSlot(...args: any[]): any {
  let move1 = GetMonData(mon, MON_DATA_MOVE1 + slotTo);
      let move0 = GetMonData(mon, MON_DATA_MOVE1 + slotFrom);
      let pp1 = GetMonData(mon, MON_DATA_PP1 + slotTo);
      let pp0 = GetMonData(mon, MON_DATA_PP1 + slotFrom);
      let ppBonuses = GetMonData(mon, MON_DATA_PP_BONUSES);
      let ppBonusMask1 = gPPUpGetMask[slotTo];
      let ppBonusMove1 = (ppBonuses & ppBonusMask1) >> (slotTo * 2);
      let ppBonusMask2 = gPPUpGetMask[slotFrom];
      let ppBonusMove2 = (ppBonuses & ppBonusMask2) >> (slotFrom * 2);
