...
export function SoundTask_FireBlast(...args: any[]): any {
...
export function SoundTask_FireBlast_Step1(...args: any[]): any {
  let pan = gTasks[taskId].data[2];
      let panIncrement = gTasks[taskId].data[4];
...
export function SoundTask_FireBlast_Step2(...args: any[]): any {
...
export function SoundTask_LoopSEAdjustPanning(...args: any[]): any {
  let songId = gBattleAnimArgs[0];
      let targetPan = gBattleAnimArgs[2];
      let panIncrement = gBattleAnimArgs[3];
      let r10 = gBattleAnimArgs[4];
      let r7 = gBattleAnimArgs[5];
      let r9 = gBattleAnimArgs[6];
      let sourcePan = BattleAnimAdjustPanning(gBattleAnimArgs[1]);
...
export function SoundTask_LoopSEAdjustPanning_Step(...args: any[]): any {
...
export function SoundTask_PlayCryHighPitch(...args: any[]): any {
  let species = 0;
      let pan = BattleAnimAdjustPanning(SOUND_PAN_ATTACKER);
      if (IsContest())
      {
...
export function SoundTask_PlayDoubleCry(...args: any[]): any {
  let species = 0;
      let pan = BattleAnimAdjustPanning(SOUND_PAN_ATTACKER);
      if (IsContest())
      {
...
export function SoundTask_PlayDoubleCry_Step(...args: any[]): any {
  let species = gTasks[taskId].data[1];
      let pan = gTasks[taskId].data[2];
...
export function SoundTask_WaitForCry(...args: any[]): any {
  if (gTasks[taskId].data[9] < 2)
      {
          gTasks[taskId].data[9]++;
      }
...
export function SoundTask_PlayCryWithEcho(...args: any[]): any {
...
export function SoundTask_PlayCryWithEcho_Step(...args: any[]): any {
  let species = gTasks[taskId].tSpecies;
      let pan = gTasks[taskId].tPan;
...
export function SoundTask_PlaySE1WithPanning(...args: any[]): any {
  let songId = gBattleAnimArgs[0];
      let pan = BattleAnimAdjustPanning(gBattleAnimArgs[1]);
...
export function SoundTask_PlaySE2WithPanning(...args: any[]): any {
  let songId = gBattleAnimArgs[0];
      let pan = BattleAnimAdjustPanning(gBattleAnimArgs[1]);
...
export function SoundTask_AdjustPanningVar(...args: any[]): any {
  let targetPan = gBattleAnimArgs[1];
      let panIncrement = gBattleAnimArgs[2];
      let r9 = gBattleAnimArgs[3];
      let sourcePan = BattleAnimAdjustPanning(gBattleAnimArgs[0]);
...
export function SoundTask_AdjustPanningVar_Step(...args: any[]): any {
  let panIncrement = gTasks[taskId].data[3];
