...
export function JumpIfMoveFailed(...args: any[]): any {
  let BS_ptr = gBattlescriptCurrInstr + adder;
...
export function JumpIfMoveAffectedByProtect(...args: any[]): any {
  let affected = FALSE;
      if (DEFENDER_IS_PROTECTED)
      {
          gMoveResultFlags |= MOVE_RESULT_MISSED;
...
export function AccuracyCalcHelper(...args: any[]): any {
...
export function Cmd_accuracycheck(): any {
  let move = T2_READ_16(gBattlescriptCurrInstr + 5);
      ...
      else
      {
          ...
          {
              let acc = gBattleMons[gBattlerAttacker].statStages[STAT_ACC];
              buff = acc;
          }
          else
          {
...
export function AI_CalcDmg(...args: any[]): any {
  let sideStatus = gSideStatuses[GET_BATTLER_SIDE(defender)];
...
export function ModulateDmgByType(...args: any[]): any {
...
export function ModulateDmgByType2(...args: any[]): any {
  gBattleMoveDamage = gBattleMoveDamage * multiplier / 10;
      if (gBattleMoveDamage == 0 && multiplier != 0)
          gBattleMoveDamage = 1;
...
export function TypeCalc(...args: any[]): any {
  let i = 0;
      let flags = 0;
      let moveType: any = null;
...
export function AI_TypeCalc(...args: any[]): any {
  let i = 0;
      let flags = 0;
      let type1 = gSpeciesInfo[targetSpecies].types[0], type2 = gSpeciesInfo[targetSpecies].types[1];
      let moveType: any = null;
  ...
  if (gBattleControllerExecFlags)
      ...
      if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
      {
          ...
          else
          {
              ...
              let currDmg = gBattleMoveDamage;
              let maxPossibleDmgValue = 10000;  
...
export function Cmd_printstring(): any {
  if (gBattleControllerExecFlags == 0)
      {
          let var = T2_READ_16(gBattlescriptCurrInstr + 1);
  ...
  if (gBattleControllerExecFlags == 0)
      {
          ...
          {
              let toWait = T2_READ_16(gBattlescriptCurrInstr + 1);
...
export function Cmd_printfromtable(): any {
  if (gBattleControllerExecFlags == 0)
      {
          let ptr = (const u16 *) T1_READ_PTR(gBattlescriptCurrInstr + 1);
...
export function GetBattlerTurnOrderNum(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < gBattlersCount; i++)
      {
...
export function SetMoveEffect(...args: any[]): any {
      ...
      if (gBattleCommunication[MOVE_EFFECT_BYTE] <= PRIMARY_STATUS_MOVE_EFFECT)
      {
          ...
          if (statusChanged == TRUE)
          {
              ...
              if (gBattleCommunication[MOVE_EFFECT_BYTE] == MOVE_EFFECT_POISON
               ...
               {
                  let synchronizeEffect = gBattleStruct.synchronizeMoveEffect;
              ...
              case MOVE_EFFECT_STEAL_ITEM:
                  {
                      ...
                      {
                          let changedItem = gBattleStruct.changedItems[gBattlerAttacker];
  ...
  let BS_ptr: any = null;
      ...
      else
      {
           ...
           && gBattleMons[gActiveBattler].hp == 0)
          {
              ...
              {
                  let moveIndex = *(gBattleStruct.chosenMovePositions + gBattlerAttacker);
...
export function Cmd_jumpifstatus(): any {
  let battler = GetBattlerForBattleScript(gBattlescriptCurrInstr[1]);
      let flags = T2_READ_32(gBattlescriptCurrInstr + 2);
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 6);
...
export function Cmd_jumpifability(): any {
  let battler: any = null;
      let ability = gBattlescriptCurrInstr[2];
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 3);
...
export function Cmd_jumpifstat(): any {
  let ret = 0;
      let battler = GetBattlerForBattleScript(gBattlescriptCurrInstr[1]);
      let value = gBattleMons[battler].statStages[gBattlescriptCurrInstr[3]];
...
export function Cmd_jumpiftype(): any {
  let battler = GetBattlerForBattleScript(gBattlescriptCurrInstr[1]);
      let type = gBattlescriptCurrInstr[2];
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 3);
...
export function Cmd_getexp(): any {
  let item: any = null;
      ...
      let sentIn: any = null;
      let viaExpShare = 0;
      let exp = gBattleStruct.expValue;
...
export function Cmd_jumpifbyte(): any {
  let caseID = gBattlescriptCurrInstr[1];
      let memByte = T2_READ_PTR(gBattlescriptCurrInstr + 2);
      let value = gBattlescriptCurrInstr[6];
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 7);
...
export function Cmd_jumpifhalfword(): any {
  let caseID = gBattlescriptCurrInstr[1];
      let memHword = T2_READ_PTR(gBattlescriptCurrInstr + 2);
      let value = T2_READ_16(gBattlescriptCurrInstr + 6);
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 8);
...
export function Cmd_jumpifword(): any {
  let caseID = gBattlescriptCurrInstr[1];
      let memWord = T2_READ_PTR(gBattlescriptCurrInstr + 2);
      let value = T1_READ_32(gBattlescriptCurrInstr + 6);
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 10);
...
export function Cmd_jumpifarrayequal(): any {
  let mem1 = T2_READ_PTR(gBattlescriptCurrInstr + 1);
      let mem2 = T2_READ_PTR(gBattlescriptCurrInstr + 5);
      let size = gBattlescriptCurrInstr[9];
      let jumpPtr = T2_READ_PTR(gBattlescriptCurrInstr + 10);
...
export function Cmd_setbyte(): any {
  let memByte = T2_READ_PTR(gBattlescriptCurrInstr + 1);
...
export function Cmd_copyarray(): any {
  let dest = T2_READ_PTR(gBattlescriptCurrInstr + 1);
      let src = T2_READ_PTR(gBattlescriptCurrInstr + 5);
      let size = gBattlescriptCurrInstr[9];
...
export function Cmd_copyarraywithindex(): any {
  let dest = T2_READ_PTR(gBattlescriptCurrInstr + 1);
      let src = T2_READ_PTR(gBattlescriptCurrInstr + 5);
      let index = T2_READ_PTR(gBattlescriptCurrInstr + 9);
      let size = gBattlescriptCurrInstr[13];
...
export function Cmd_orhalfword(): any {
  let memHword = T2_READ_PTR(gBattlescriptCurrInstr + 1);
      let val = T2_READ_16(gBattlescriptCurrInstr + 5);
...
export function Cmd_orword(): any {
  let memWord = T2_READ_PTR(gBattlescriptCurrInstr + 1);
      let val = T2_READ_32(gBattlescriptCurrInstr + 5);
...
export function Cmd_pause(): any {
  if (gBattleControllerExecFlags == 0)
      {
          let value = T2_READ_16(gBattlescriptCurrInstr + 1);
  ...
  let i: any = null;
      ...
      do
      {
          ...
          case MOVEEND_CHANGED_ITEMS:  
              for (i = 0; i < gBattlersCount; i++)
              {
                  let changedItem = gBattleStruct.changedItems[i];
          ...
          case MOVEEND_NEXT_TARGET:  
              ...
              {
                  let battler = GetBattlerAtPosition(BATTLE_PARTNER(GetBattlerPosition(gBattlerTarget)));
...
export function Cmd_typecalc2(): any {
  let flags = 0;
      let i = 0;
      let moveType = gBattleMoves[gCurrentMove].type;
...
export function ChooseMonToSendOut(...args: any[]): any {
  ...
  let i: any = null;
      ...
      else
      {
              ...
              && !ItemBattleEffects(ITEMEFFECT_ON_SWITCH_IN, gActiveBattler, FALSE))
          {
              ...
              for (i = 0; i < gBattlersCount; i++)
              {
                  let hpOnSwitchout = gBattleStruct.hpOnSwitchout[GetBattlerSide(i)];
                  *hpOnSwitchout = gBattleMons[i].hp;
              }

              if (gBattlescriptCurrInstr[1] == BS_FAINTED_LINK_MULTIPLE_1)
              {
                  let hitmarkerFaintBits = gHitMarker >> 28;
...
export function Cmd_handlelearnnewmove(): any {
  let learnedMovePtr = T1_READ_PTR(gBattlescriptCurrInstr + 1);
      let nothingToLearnPtr = T1_READ_PTR(gBattlescriptCurrInstr + 5);

      let learnMove = MonTryLearningNewMove(gPlayerParty[gBattleStruct.expGetterMonId], gBattlescriptCurrInstr[9]);
...
export function Cmd_yesnoboxlearnmove(): any {
  gActiveBattler = 0;
      ...
      case 4:
          if (!gPaletteFade.active && gMain.callback2 == BattleMainCB2)
          {
              let movePosition = GetMoveSlotToReplace();
              ...
              {
                  let move = GetMonData(gPlayerParty[gBattleStruct.expGetterMonId], MON_DATA_MOVE1 + movePosition);
                  if (IsHMMove2(move))
                  {
...
export function GetTrainerMoneyToGive(...args: any[]): any {
  let i = 0;
      let lastMonLevel = 0;
...
export function Cmd_getmoneyreward(): any {
  let moneyReward = GetTrainerMoneyToGive(gTrainerBattleOpponent_A);
      if (gBattleTypeFlags & BATTLE_TYPE_TWO_OPPONENTS)
...
export function PutMonIconOnLvlUpBanner(): any {
  let spriteId: any = null;
      ...
      let species = GetMonData(gPlayerParty[gBattleStruct.expGetterMonId], MON_DATA_SPECIES);
      let personality = GetMonData(gPlayerParty[gBattleStruct.expGetterMonId], MON_DATA_PERSONALITY);

      let iconPtr = GetMonIconPtr(species, personality, 1);
...
export function SpriteCB_MonIconOnLvlUpBanner(...args: any[]): any {
...
export function Cmd_setprotectlike(): any {
  let notLastTurn = TRUE;
      let lastMove = gLastResultingMoves[gBattlerAttacker];
...
export function Cmd_jumpifnexttargetvalid(): any {
  let jumpPtr = T1_READ_PTR(gBattlescriptCurrInstr + 1);
...
export function Cmd_tryhealhalfhealth(): any {
  let failPtr = T1_READ_PTR(gBattlescriptCurrInstr + 1);
...
export function Cmd_trysetrest(): any {
  let failJump = T1_READ_PTR(gBattlescriptCurrInstr + 1);
...
export function UproarWakeUpCheck(...args: any[]): any {
  let i: any = null;
...
export function ChangeStatBuffs(...args: any[]): any {
  let certain = FALSE;
...
export function Cmd_statbuffchange(): any {
  let jumpPtr = T1_READ_PTR(gBattlescriptCurrInstr + 2);
...
export function Cmd_givepaydaymoney(): any {
  if (!(gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK)) && gPaydayMoney != 0)
      {
          let bonusMoney = gPaydayMoney * gBattleStruct.moneyMultiplier;
...
export function Cmd_setsubstitute(): any {
  let hp = gBattleMons[gBattlerAttacker].maxHP / 4;
...
export function IsMoveUncopyableByMimic(...args: any[]): any {
  let i: any = null;
...
export function Cmd_counterdamagecalculator(): any {
  let sideAttacker = GetBattlerSide(gBattlerAttacker);
      let sideTarget = GetBattlerSide(gProtectStructs[gBattlerAttacker].physicalBattlerId);
...
export function Cmd_mirrorcoatdamagecalculator(): any {
  let sideAttacker = GetBattlerSide(gBattlerAttacker);
      let sideTarget = GetBattlerSide(gProtectStructs[gBattlerAttacker].specialBattlerId);
...
export function Cmd_painsplitdmgcalc(): any {
  if (!(gBattleMons[gBattlerTarget].status2 & STATUS2_SUBSTITUTE))
      {
          let hpDiff = (gBattleMons[gBattlerAttacker].hp + gBattleMons[gBattlerTarget].hp) / 2;
          let painSplitHp = gBattleMoveDamage = gBattleMons[gBattlerTarget].hp - hpDiff;
          let storeLoc = (void *)(gBattleScripting.painSplitHp);
...
export function IsTwoTurnsMove(...args: any[]): any {
...
export function IsInvalidForSleepTalkOrAssist(...args: any[]): any {
  if (move == MOVE_NONE
...
export function AttacksThisTurn(...args: any[]): any {
...
export function TrySetDestinyBondToHappen(): any {
  let sideAttacker = GetBattlerSide(gBattlerAttacker);
      let sideTarget = GetBattlerSide(gBattlerTarget);
...
export function Cmd_remaininghptopower(): any {
  let i: any = null;
      let hpFraction = GetScaledHPFraction(gBattleMons[gBattlerAttacker].hp, gBattleMons[gBattlerAttacker].maxHP, 48);
...
export function Cmd_healpartystatus(): any {
  let zero = 0;
      ...
      if (gCurrentMove == MOVE_HEAL_BELL)
      {
          ...
          for (i = 0; i < PARTY_SIZE; i++)
          {
              let species = GetMonData(party[i], MON_DATA_SPECIES_OR_EGG);
              let abilityNum = GetMonData(party[i], MON_DATA_ABILITY_NUM);
...
export function Cmd_trysetspikes(): any {
  let targetSide = BATTLE_OPPOSITE(GetBattlerSide(gBattlerAttacker));
...
export function Cmd_maxattackhalvehp(): any {
  let halfHp = gBattleMons[gBattlerAttacker].maxHP / 2;
...
export function Cmd_hiddenpowercalc(): any {
  let powerBits = ((gBattleMons[gBattlerAttacker].hpIV & 2) >> 1)
      ...
      let typeBits = ((gBattleMons[gBattlerAttacker].hpIV & 1) << 0)
...
export function Cmd_trydobeatup(): any {
  let party: any = null;
      ...
      {
          let beforeLoop = gBattleCommunication[0];
...
export function Cmd_scaledamagebyhealthratio(): any {
  if (gDynamicBasePower == 0)
      {
          let power = gBattleMoves[gCurrentMove].power;
...
export function Cmd_tryswapabilities(): any {
  if ((gBattleMons[gBattlerAttacker].ability == ABILITY_NONE
      ...
      {
          let abilityAtk = gBattleMons[gBattlerAttacker].ability;
          gBattleMons[gBattlerAttacker].ability = gBattleMons[gBattlerTarget].ability;
...
export function Cmd_assistattackselect(): any {
  let chooseableMovesNo = 0;
      let party: any = null;
      let monId, moveIndex;
      let validMoves = gBattleStruct.assistPossibleMoves;
      ...
      for (monId = 0; monId < PARTY_SIZE; monId++)
      {
          ...
          {
              let i = 0;
              let move = GetMonData(party[monId], MON_DATA_MOVE1 + moveIndex);
      ...
      else
      {
          for (i = 0; i < PARTY_SIZE; i++)
          {
                  ...
                  && (Random() % 10) == 0)
              {
                  let j: any = null;
                  let rand = Random() % 100;
                  let lvlDivBy10 = (GetMonData(gPlayerParty[i], MON_DATA_LEVEL) - 1) / 10;
                  if (lvlDivBy10 > 9)
                      lvlDivBy10 = 9;
...
export function Cmd_removelightscreenreflect(): any {
  let opposingSide = BATTLE_OPPOSITE(GetBattlerSide(gBattlerAttacker));
...
export function Cmd_trysetcaughtmondexflags(): any {
  let species = GetMonData(gEnemyParty[0], MON_DATA_SPECIES, NULL);
      let personality = GetMonData(gEnemyParty[0], MON_DATA_PERSONALITY, NULL);
...
export function HandleBattleWindow(...args: any[]): any {
  let destY, destX;
      let var = 0;
...
export function BattleCreateYesNoCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = 1;
      src[1] = 2;
...
export function BattleDestroyYesNoCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = 0x1016;
      src[1] = 0x1016;
