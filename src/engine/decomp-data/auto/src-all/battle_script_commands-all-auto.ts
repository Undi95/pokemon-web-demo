...
const {
  ARRAY_COUNT, AbilityBattleEffects, AccuracyCalcHelper, AddMoney,
  AddTextPrinter, AdjustFriendship, AdjustFriendshipOnBattleFaint, ApplyRandomDmgMultiplier,
  AtkCanceler_UnableToUseMove, AttacksThisTurn, BATTLE_OPPOSITE, BATTLE_PARTNER,
  BG_PLTT_ID, BattleArena_AddSkillPoints, BattleArena_InitPoints, BattleArena_ShowJudgmentWindow,
  BattleCreateYesNoCursorAt, BattleDestroyYesNoCursorAt, BattlePalace_TryEscapeStatus, BattlePutTextOnWindow,
  BattleScriptPop, BattleScriptPush, BattleScriptPushCursor, BattleScriptPushCursorAndCallback,
  BattleStopLowHpSound, BattleStringExpandPlaceholdersToDisplayedString, BeginFastPaletteFade, BeginNormalPaletteFade,
  BtlController_EmitBallThrowAnim, BtlController_EmitBattleAnimation, BtlController_EmitCantSwitch, BtlController_EmitChoosePokemon,
  BtlController_EmitDrawPartyStatusSummary, BtlController_EmitEndLinkBattle, BtlController_EmitExpUpdate, BtlController_EmitFaintAnimation,
  BtlController_EmitFaintingCry, BtlController_EmitGetMonData, BtlController_EmitHealthBarUpdate, BtlController_EmitHidePartyStatusSummary,
  BtlController_EmitHitAnimation, BtlController_EmitLinkStandbyMsg, BtlController_EmitMoveAnimation, BtlController_EmitPlayFanfareOrBGM,
  BtlController_EmitPlaySE, BtlController_EmitPrintSelectionString, BtlController_EmitResetActionMoveSelection, BtlController_EmitReturnMonToBall,
  BtlController_EmitSetMonData, BtlController_EmitSpriteInvisibility, BtlController_EmitStatusAnimation, BtlController_EmitStatusIconUpdate,
  BtlController_EmitSwitchInAnim, BtlController_EmitTrainerSlide, BtlController_EmitTrainerSlideBack, BtlController_EmitYesNoBox,
  BufferMoveToLearnIntoBattleTextBuff2, CalculateBaseDamage, CalculatePlayerPartyCount, CancelMultiTurnMoves,
  CastformDataTypeChange, ChangeStatBuffs, CheckMoveLimitations, CheckWonderGuardAndLevitate,
  ChooseMonToSendOut, ClearWindowTilemap, ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram,
  CopyToBgTilemapBufferRect_ChangePalette, CopyToWindowPixelBuffer, CopyWindowToVram, CountAliveMonsInBattle,
  CreateSprite, CurrentBattlePyramidLocation, DestroySprite, DisplayCaughtMonDexPage,
  DoNamingScreen, DrawArenaRefereeTextBox, DrawLevelUpBannerText, DrawLevelUpWindow1,
  DrawLevelUpWindow2, DrawLevelUpWindowPg1, DrawLevelUpWindowPg2, EraseArenaRefereeTextBox,
  ...
  GetBattlerSide, GetBattlerTurnOrderNum, GetBoxNamePtr, GetCurrentMapType,
  ...
  GetTrainerMoneyToGive, GetValidMonIconPalettePtr, GiveMonToPlayer, GiveMoveToBattleMon,
  HITMARKER_FAINTED, HITMARKER_FAINTED2, HandleBattleWindow, HandleLowHpMusicChange,
  HandleSetPokedexFlag, HasNoMonsToSwitch, IS_BATTLER_OF_TYPE, IS_ITEM_MAIL,
  IS_TYPE_PHYSICAL, InBattlePike, IncrementGameStat, InitBattleBgsVideo,
  InitLevelUpBanner, IsCryFinished, IsDma3ManagerBusyWithBgCopy, IsHMMove2,
  IsInvalidForSleepTalkOrAssist, IsMonDisobedient, IsMonGettingExpSentOut, IsMoveUncopyableByMimic,
  IsMultiBattle, IsRunningFromBattleImpossible, IsTextPrinterActive, IsTradedMon,
  IsTwoTurnsMove, ItemBattleEffects, JOY_NEW, JumpIfMoveAffectedByProtect,
  JumpIfMoveFailed, LoadBattleTextboxAndBackground, LoadPalette, LoadSpritePalette,
  LoadSpriteSheet, MOD, MOVE_IS_PERMANENT, MarkBattlerForControllerExec,
  ModulateDmgByType, ModulateDmgByType2, MonGainEVs, MonTryLearningNewMove,
  MoveValuesCleanUp, PREPARE_ABILITY_BUFFER, PREPARE_BYTE_NUMBER_BUFFER, PREPARE_HWORD_NUMBER_BUFFER,
  PREPARE_ITEM_BUFFER, PREPARE_MON_NICK_BUFFER, PREPARE_MON_NICK_WITH_PREFIX_BUFFER, PREPARE_MOVE_BUFFER,
  ...
  PrepareStringBattle, PressurePPLose, PressurePPLoseOnUsingImprison, PressurePPLoseOnUsingPerishSong,
  PutMonIconOnLvlUpBanner, PutWindowTilemap, Random, RecordAbilityBattle,
  RecordItemEffectBattle, RecordedBattle_SetBattlerAction, RemoveBattleMonPPBonus, RemoveMonPPBonus,
  ResetSentPokesToOpponentValue, SAFE_DIV, SET_BATTLER_TYPE, SET_STAT_BUFF_VALUE,
  STATUS1_SLEEP_TURN, STATUS2_BIDE_TURN, STATUS2_CONFUSION_TURN, STATUS2_INFATUATED_WITH,
  STATUS2_LOCK_CONFUSE_TURN, STATUS2_UPROAR_TURN, STATUS2_WRAPPED_TURN, STATUS3_ALWAYS_HITS_TURN,
  STATUS3_YAWN_TURN, SetBattleMonMoveSlot, SetBgAttribute, SetMonData,
  SetMonMoveSlot, SetMoveEffect, SetVBlankCallback, ShouldShowBoxWasFullMessage,
  ShowBg, ShowSelectMovePokemonSummaryScreen, SlideInLevelUpBanner, SlideOutLevelUpBanner,
  ...
  T2_READ_32, T2_READ_PTR, TYPE_EFFECT_ATK_TYPE, TYPE_EFFECT_DEF_TYPE,
  TYPE_EFFECT_MULTIPLIER, TryDoForceSwitchOut, TryRunFromBattle, TrySetDestinyBondToHappen,
  UpdateSentPokesToOpponentValue, UproarWakeUpCheck, VarGet, WasUnableToUseMove,
