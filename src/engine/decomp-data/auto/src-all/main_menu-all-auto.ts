...
const {
  ...
  BLDCNT_EFFECT_BLEND, BLDCNT_EFFECT_DARKEN, BLDCNT_TGT1_OBJ, BLDCNT_TGT2_BG1,
  ...
  DoNamingScreen, EnableInterrupts, FALSE, FacilityClassToPicIndex,
  ...
  GetStringRightAlignXOffset, GetWindowAttribute, GetWindowFrameTilesPal, HideBg,
  InitBgFromTemplate, InitBgsFromTemplates, InitMenuInUpperLeftCornerNormal, InitSpriteAffineAnim,
  InitWindows, IsMysteryGiftEnabled, IsNationalPokedexEnabled, IsTextPrinterActive,
  IsWirelessAdapterConnected, JOY_NEW, LZ77UnCompVram, LoadBgTiles,
  LoadMessageBoxGfx, LoadOam, LoadPalette, MENU_WIN_VCOORDS,
  Menu_GetCursorPos, Menu_ProcessInputNoWrap, Menu_ProcessInputNoWrapClearOnChoose, NULL,
  PALETTES_ALL, PALETTES_BG, PIXEL_FILL, PLTT_SIZE,
  PLTT_SIZEOF, PLTT_SIZE_4BPP, PlayBGM, PlaySE,
  PrintMenuTable, ProcessSpriteCopyRequests, PutWindowTilemap, REG_OFFSET_BG0CNT,
  ...
  RemoveScrollIndicatorArrowPair, ResetAllPicSprites, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade,
  ResetSpriteData, ResetTasks, RtcGetErrorStatus, RunTasks,
  RunTextPrinters, RunTextPrintersAndIsPrinter0Active, STR_CONV_MODE_LEADING_ZEROS, STR_CONV_MODE_LEFT_ALIGN,
  ST_OAM_AFFINE_NORMAL, ST_OAM_AFFINE_OFF, ST_OAM_OBJ_BLEND, ST_OAM_OBJ_NORMAL,
  ScanlineEffect_Stop, SetGpuReg, SetMainCallback2, SetVBlankCallback,
  ShowBg, StartSpriteAffineAnim, StringExpandPlaceholders, TRUE,
