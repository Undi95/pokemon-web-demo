...
export function Task_UpdateFlashingCircleImpacts(...args: any[]): any {
...
export function AnimFlashingCircleImpact(...args: any[]): any {
  if (sprite.data[6] == 0)
      {
...
export function AnimFlashingCircleImpact_Step(...args: any[]): any {
...
export function AnimTask_FrozenIceCube(...args: any[]): any {
  let x = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2) - 32;
      let y = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET) - 36;
...
export function AnimTask_FrozenIceCube_Step1(...args: any[]): any {
...
export function AnimTask_FrozenIceCube_Step2(...args: any[]): any {
  let palIndex = IndexOfSpritePaletteTag(ANIM_TAG_ICE_CUBE);
...
export function AnimTask_FrozenIceCube_Step3(...args: any[]): any {
  gTasks[taskId].data[1]--;
...
export function AnimTask_FrozenIceCube_Step4(...args: any[]): any {
  gTasks[taskId].data[1]++;
      if (gTasks[taskId].data[1] == 37)
      {
          let spriteId = gTasks[taskId].data[15];
...
export function AnimTask_StatsChange(...args: any[]): any {
  let goesDown = FALSE;
      let animStatId = 0;
      let sharply = FALSE;
...
export function LaunchStatusAnimation(...args: any[]): any {
  let taskId: any = null;
...
export function Task_DoStatusAnimation(...args: any[]): any {
  gAnimScriptCallback();
