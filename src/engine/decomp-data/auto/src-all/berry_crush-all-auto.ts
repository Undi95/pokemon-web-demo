...
const {
  ...
  CreateWirelessStatusIndicatorSprite, DecompressAndCopyTileDataToVram, DestroySprite, DestroyTask,
  DestroyWirelessStatusIndicatorSprite, DigitObjUtil_CreatePrinter, DigitObjUtil_DeletePrinter, DigitObjUtil_Free,
  DigitObjUtil_HideOrShow, DigitObjUtil_Init, DigitObjUtil_PrintNumOn, DisplayYesNoMenuDefaultYes,
  DrawDialogueFrame, DrawStdFrameWithCustomTileAndPalette, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset,
  DynamicPlaceholderTextUtil_SetPlaceholderPtr, ERROR_EXIT, FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0,
  ...
  Menu_ProcessInputNoWrapClearOnChoose, PIXEL_FILL, PlayNewMapMusic, PlaySE,
  ProcessSpriteCopyRequests, PutWindowTilemap, Q_24_8, Q_24_8_TO_INT,
  Q_8_8, Random, RemoveBagItem, RemoveWindow,
  ...
  RunTextPrinters, SWAP, ScanlineEffect_Stop, ScriptContext_Enable,
  ...
  SetVBlankCallback, ShowBg, Sin, StartMinigameCountdown,
  StartSpriteAffineAnim, StartSpriteAnim, StringAppend, StringCopy,
  StringExpandPlaceholders, TransferPlttBuffer, UnlockPlayerFieldControls, UnsetBgTilemapBuffer,
