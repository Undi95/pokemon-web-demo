...
const {
  ...
  FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, FuncIsActiveTask, GetBerryPowder,
  GetBlockReceivedStatus, GetLinkPlayerCount, GetMultiplayerId, GetStringRightAlignXOffset,
  GetStringWidth, GetWindowAttribute, GiveBerryPowder, HasAtLeastOneBerry,
  HideBg, IncrementGameStat, InitBgsFromTemplates, InitStandardTextBoxWindows,
  InitTextBoxGfxAndPrinters, IsLinkTaskFinished, IsMinigameCountdownRunning, IsTextPrinterActive,
  JOY_HELD, JOY_NEW, LZ77UnCompWram, LoadCompressedSpriteSheet,
  LoadOam, LoadPalette, LoadSpritePalettes, LoadUserWindowBorderGfx_,
  LoadWirelessStatusIndicatorSpriteGfx, LockPlayerFieldControls, MathUtil_Div16Shift, MathUtil_Div32,
  MathUtil_Mul16, MathUtil_Mul16Shift, MathUtil_Mul32, Menu_ProcessInputNoWrapClearOnChoose,
