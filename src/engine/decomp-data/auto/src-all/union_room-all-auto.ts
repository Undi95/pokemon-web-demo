...
//
// Total : 111 functions extracted from src/union_room.c.
//
// IMPORTANT :
...
const {
  ...
  ArePlayerDataDifferent, ArePlayerFieldControlsLocked, ArePlayersDifferent, AskToJoinRfuGroup,
  BG_PLTT_ID, BeginNormalPaletteFade, BlitMenuInfoIcon, BuildOamBuffer,
  CB2_StartCreateTradeMenu, ChooseMonForTradingBoard, CleanupOverworldWindowsAndTilemaps, ClearIncomingPlayerList,
  ClearRfuPlayerList, ClearStdWindowAndFrame, ClearWindowTilemap, ConvPartnerUnameAndGetWhetherMetAlready,
  ConvertIntToDecimalStringN, ConvertInternationalString, CopyAndTranslatePlayerName, CopyBgTilemapBufferToVram,
  CopyEasyChatWord, CopyHostRfuGameDataAndUsername, CopyPlayerListFromBuffer, CopyPlayerListToBuffer,
  CopyTrainerCardData, CopyWindowToVram, CreateTask, CreateTask_ListenForCompatiblePartners,
  CreateTask_ListenForWonderDistributor, CreateTask_RfuReconnectWithParent, CreateTask_RunScriptAndFadeToActivity, CreateTask_SearchForChildOrParent,
  CreateTask_StartActivity, CreateTradeBoardWindow, CreateTrainerCardInBuffer, CreateUnionRoomPlayerSprites,
  CreateWirelessStatusIndicatorSprite, DeleteTradeBoardWindow, DestroyListMenuTask, DestroyTask,
  DestroyUnionRoomPlayerObjects, DestroyUnionRoomPlayerSprites, DestroyWirelessStatusIndicatorSprite, DisplayYesNoMenuDefaultYes,
  DoMysteryGiftYesNo, DrawDialogueFrame, DrawStdWindowFrame, DynamicPlaceholderTextUtil_ExpandPlaceholders,
  DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr, EnterUnionRoomChat, EraseYesNoWindow,
  ...
  GROUP_MIN2, GetActivePartnersInfo, GetAwaitingCommunicationText, GetBlockReceivedStatus,
  GetChatLeaderActionRequestMessage, GetCursorSelectionMonId, GetGroupLeaderSentAnOKMessage, GetGroupListTextColor,
  GetHostRfuGameData, GetIndexOfNthTradeBoardOffer, GetLinkPlayerCount, GetLinkPlayerCountAsBitFlags,
  GetLinkPlayerInfoFlags, GetMonData, GetMultiplayerId, GetMysteryGiftBaseBlock,
  GetNewIncomingPlayerId, GetNewLeaderCandidate, GetOtherPlayersInfoFlags, GetPartyMenuType,
  GetPartyPositionOfRegisteredMon, GetResponseIdx_InviteToURoomActivity, GetStringRightAlignXOffset, GetURoomActivityRejectMsg,
  GetURoomActivityStartMsg, GetUnionRoomPlayerGender, GetUnionRoomTrainerClass, GetWonderCardFlagID,
  GetXYCoordsOneStepInFrontOfPlayer, GetYouAskedToJoinGroupPleaseWaitMessage, GetYouDeclinedTheOfferMessage, HandleCancelActivity,
  HandleContactFromOtherPlayer, HandlePlayerListUpdate, HandleUnionRoomPlayerRefresh, HasAtLeastTwoMonsOfLevel30OrLower,
  HasTrainerLeftPartnersList, HasWonderCardOrNewsByLinkGroup, HealPlayerParty, InUnionRoom,
  IncrementGameStat, InitChooseHalfPartyForBattle, InitUnionRoomPlayerObjects, InitializeRfuLinkManager_EnterUnionRoom,
  InitializeRfuLinkManager_JoinGroup, InitializeRfuLinkManager_LinkLeader, Intl_GetListMenuWidth, IsActivityWithVariableGroupSize,
  IsLinkTaskFinished, IsPartnerActivityAcceptable, IsPlayerFacingTradingBoard, IsRequestedTradeInPlayerParty,
  IsRfuCommunicatingWithAllChildren, IsTryingToTradeAcrossVersionTooSoon, IsUnionRoomListenTaskActive, JOY_NEW,
  JoinGroup_EnableScriptContexts, LINK_GROUP_CAPACITY, LeaderPrunePlayerList, LeaderUpdateGroupMembership,
  Leader_DestroyResources, Leader_GetAcceptNewMemberPrompt, Leader_SetStateIfMemberListChanged, LinkRfu_CreateConnectionAsParent,
  LinkRfu_Shutdown, LinkRfu_StopManagerAndFinalizeSlots, LinkRfu_StopManagerBeforeEnteringChat, ListMenuHandler_AllItemsAvailable,
  ListMenuInit, ListMenuLoadStdPalAt, ListMenu_ProcessInput, LmanAcceptSlotFlagIsNotZero,
  LoadMessageBoxAndBorderGfx, LoadPlayerBag, LoadWirelessStatusIndicatorSpriteGfx, LockPlayerFieldControls,
  MAP_GROUP, MAP_NUM, MG_AddMessageTextPrinter, MG_DrawTextBorder,
  Menu_ProcessInputNoWrapClearOnChoose, MysteryGift_DisableStats, MysteryGift_TryEnableStatsByFlagId, OpenLink,
  PIXEL_FILL, PlayBattleBGM, PlaySE, PlayerHasMetTrainerBefore,
  PollPartnerYesNoResponse, PrintGroupCandidateOnWindow, PrintGroupMemberOnWindow, PrintMysteryGiftMenuMessage,
  PrintNumPlayersWaitingForMsg, PrintOnTextbox, PrintPlayerNameAndIdOnWindow, PrintUnionRoomText,
  PutWindowTilemap, Random, ReadAsU16, ReceiveUnionRoomActivityPacket,
  RedrawListMenu, RegisterTradeMon, RegisterTradeMonAndGetIsEgg, RemoveWindow,
  RequestDisconnectSlotByTrainerNameAndId, ResetBlockReceivedFlags, ResetHostRfuGameData, ResetUnionRoomTrade,
  RfuGetStatus, RfuHasErrored, RfuSetIgnoreError, RfuSetStatus,
  RfuTryDisconnectLeavingChildren, Rfu_DisconnectPlayerById, Rfu_GetCompatiblePlayerData, Rfu_GetWonderDistributorPlayerData,
  Rfu_SendPacket, RunTasks, RunTextPrinters, RunTextPrintersAndIsPrinter0Active,
  SaveLinkTrainerNames, SavePlayerParty, ScheduleFieldMessageAndExit, ScheduleFieldMessageWithFollowupState,
  ScheduleUnionRoomPlayerRefresh, ScriptContext_Enable, ScriptContext_IsEnabled, SendBlock,
  SendBlockRequest, SendLeaveGroupNotice, SendRfuStatusToPartner, SetCableClubWarp,
  SetCloseLinkCallback, SetDynamicWarpWithCoords, SetHostRfuGameData, SetHostRfuWonderFlags,
  SetLinkStandbyCallback, SetMainCallback2, SetTilesAroundUnionRoomPlayersPassable, SetTradeBoardRegisteredMonInfo,
  SetWarpDestination, SetWirelessCommType1, ShowTrainerCardInLink, StartBerryCrush,
  StartDodrioBerryPicking, StartPokemonJump, StartScriptInteraction, StopUnionRoomLinkManager,
  StringAppend, StringCopy, StringCopy_PlayerName, StringExpandPlaceholders,
  TradeBoardMenuHandler, TradeBoardPrintItemInfo, TrainerCard_GenerateCardForLinkPlayer, TryAddIncomingPlayerToList,
  TryConnectToUnionRoomParent, TryInteractWithUnionRoomMember, UR_ClearBg0, UR_PrintFieldMessage,
  UR_RunTextPrinters, UnionRoomGetPlayerInteractionResponse, UnionRoomHandleYesNo, UnionRoom_UnlockPlayerAndChatPartner,
  UnlockPlayerFieldControls, UpdateGameData_GroupLockedIn, UpdateGameData_SetActivity, UpdatePaletteFade,
  UpdateUnionRoomMemberFacing, VarSet, ViewURoomPartnerTrainerCard, WaitRfuState,
  WaitSendRfuStatusToPartner, WarpForCableClubActivity, WarpForWirelessMinigame, WarpIntoMap,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
...
export function TryBecomeLinkLeader(): any {
  let taskId: any = null;
      let data: any = null;

      taskId = CreateTask(Task_TryBecomeLinkLeader, 0);
      sWirelessLinkMain.leader = data = (gTasks[taskId].data);
      sLeader = data;
...
export function Task_TryBecomeLinkLeader(taskId: any): any {
  let id, val;
...
export function Leader_DestroyResources(data: any): any {
...
export function ItemPrintFunc_PossibleGroupMembers(windowId: any, id: any, y: any): any {
  let data: any = sWirelessLinkMain.leader;
      let colorIdx: any = UR_COLOR_DEFAULT;
...
export function LeaderPrunePlayerList(list: any): any {
  let data: any = sWirelessLinkMain.leader;
      let copiedCount: any = null;
      let i: any = null;
...
export function TryJoinLinkGroup(): any {
  let taskId: any = null;
      let data: any = null;

      taskId = CreateTask(Task_TryJoinLinkGroup, 0);
      sWirelessLinkMain.group = data = (gTasks[taskId].data);
      sGroup = data;
...
export function Task_TryJoinLinkGroup(taskId: any): any {
  let id: any = null;
...
export function AskToJoinRfuGroup(data: any, id: any): any {
  data.leaderId = id;
      LoadWirelessStatusIndicatorSpriteGfx();
      CreateWirelessStatusIndicatorSprite(0, 0);
      RedrawListMenu(data.listTaskId);
...
export function CreateTask_ListenToWireless(): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_ListenToWireless(taskId: any): any {
  let data: any = sWirelessLinkMain.group;
...
export function IsPartnerActivityAcceptable(activity: any, linkGroup: any): any {
  if (linkGroup == 0xFF)
          return TRUE;
      if (linkGroup < ARRAY_COUNT(sAcceptedActivityIds))
      {
          let bytes: any = sAcceptedActivityIds[linkGroup];
...
export function ListMenuItemPrintFunc_UnionRoomGroups(windowId: any, id: any, y: any): any {
  let data: any = sWirelessLinkMain.group;
      let colorId: any = GetGroupListTextColor(data, id);

      PrintGroupMemberOnWindow(windowId, 8, y,data.playerList.players[id], colorId, id);
}

/** static u8 GetNewLeaderCandidate(void) */
export function GetNewLeaderCandidate(): any {
  let data: any = sWirelessLinkMain.group;
      let ret: any = 0;
      let i: any = null;
      let id: any = null;
...
export function Task_CreateTradeMenu(taskId: any): any {
  CB2_StartCreateTradeMenu();
      DestroyTask(taskId);
}

/** u8 CreateTask_CreateTradeMenu(void) */
export function CreateTask_CreateTradeMenu(): any {
  let taskId: any = CreateTask(Task_CreateTradeMenu, 0);

      return taskId;
}

/** static void Task_StartUnionRoomTrade(u8 taskId) */
export function Task_StartUnionRoomTrade(taskId: any): any {
  let monId: any = GetPartyPositionOfRegisteredMon(sUnionRoomTrade, GetMultiplayerId());
...
export function Task_ExchangeCards(taskId: any): any {
  switch (gTasks[taskId].data[0])
      {
      case 0:
...
export function CB2_ShowCard(): any {
  switch (gMain.state)
      {
      case 0:
...
export function StartUnionRoomBattle(battleFlags: any): any {
  HealPlayerParty();
      SavePlayerParty();
      LoadPlayerBag();
...
export function CB2_TransitionToCableClub(): any {
  switch (gMain.state)
      {
      case 0:
          CreateTask(Task_ExchangeCards, 5);
...
export function CreateTrainerCardInBuffer(dest: any, setWonderCard: any): any {
  let card: any = dest;
...
export function Task_StartActivity(taskId: any): any {
  MysteryGift_DisableStats();
      switch (gPlayerCurrActivity)
      {
      case ACTIVITY_BATTLE_SINGLE:
...
export function Task_RunScriptAndFadeToActivity(taskId: any): any {
  let data: any = gTasks[taskId].data;
      let sendBuff: any = (gBlockSendBuffer);
...
export function CreateTask_RunScriptAndFadeToActivity(): any {
  CreateTask(Task_RunScriptAndFadeToActivity, 0);
}

/** static void CreateTask_StartActivity(void) */
export function CreateTask_StartActivity(): any {
  let taskId: any = CreateTask(Task_StartActivity, 0);
      gTasks[taskId].data[0] = 0;
}

/** void CreateTask_SendMysteryGift(u32 activity) */
export function CreateTask_SendMysteryGift(activity: any): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_SendMysteryGift(taskId: any): any {
  let data: any = sWirelessLinkMain.leader;
...
export function CreateTask_LinkMysteryGiftWithFriend(activity: any): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_CardOrNewsWithFriend(taskId: any): any {
  let id: any = null;
      let listWinTemplate, playerNameWinTemplate;
      let data: any = sWirelessLinkMain.group;
...
export function CreateTask_LinkMysteryGiftOverWireless(activity: any): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_CardOrNewsOverWireless(taskId: any): any {
  let id: any = null;
      let winTemplate: any = null;
      let data: any = sWirelessLinkMain.group;
...
export function RunUnionRoom(): any {
  let uroom: any = null;
...
export function ReadAsU16(ptr: any): any {
  return (ptr[1] << 8) | (ptr[0]);
}

/** static void ScheduleFieldMessageWithFollowupState(u32 nextState, const u8 *src) */
export function ScheduleFieldMessageWithFollowupState(nextState: any, src: any): any {
...
export function ScheduleFieldMessageAndExit(src: any): any {
  let uroom: any = sWirelessLinkMain.uRoom;
  ...
  let id: any = 0;
      ...
      case UR_STATE_TRADE_SELECT_MON:
          if (PrintOnTextbox(uroom.textState, sText_WhichMonWillYouOffer))
          {
              ...
              memcpy(gRfuPartnerCompatibilityData,uroom.playerList.players[taskData[1]].rfu.data.compatibility, 0);
...
export function HandleContactFromOtherPlayer(uroom: any): any {
  if (uroom.recvActivityRequest[0] != 0)
      {
          let id: any = GetChatLeaderActionRequestMessage(gStringVar4, gLinkPlayers[1].gender,uroom.recvActivityRequest[0], uroom);
          if (id == 0)  
          {
              return TRUE;
          }
...
export function HandlePlayerListUpdate(): any {
  let i: any = null;
      let j: any = null;
      let data: any = sWirelessLinkMain.uRoom;
...
export function Task_SearchForChildOrParent(taskId: any): any {
  let i, j;
      let rfu: any = null;
...
export function CreateTask_SearchForChildOrParent(parentList: any, childList: any, linkGroup: any): any {
  let taskId: any = CreateTask(Task_SearchForChildOrParent, 0);
      let data: any = gTasks[taskId].data;
      data[0] = parentList;
      data[1] = childList;
...
export function Task_ListenForCompatiblePartners(taskId: any): any {
  let i, j;
      let list: any = gTasks[taskId].data;
...
export function Task_ListenForWonderDistributor(taskId: any): any {
  let i: any = null;
      let list: any = gTasks[taskId].data;
...
export function CreateTask_ListenForCompatiblePartners(list: any, linkGroup: any): any {
  let taskId: any = CreateTask(Task_ListenForCompatiblePartners, 0);
      let oldList: any = gTasks[taskId].data;
      oldList[0] = list;
...
export function CreateTask_ListenForWonderDistributor(list: any, linkGroup: any): any {
  let taskId: any = CreateTask(Task_ListenForWonderDistributor, 0);
      let oldList: any = gTasks[taskId].data;
      oldList[0] = list;
      gTasks[taskId].data[2] = linkGroup;
      return taskId;
...
export function UR_PrintFieldMessage(src: any): any {
...
export function UR_RunTextPrinters(): any {
...
export function PrintOnTextbox(textState: any, str: any): any {
  switch (textState)
      {
      case 0:
          LoadMessageBoxAndBorderGfx();
...
export function UnionRoomHandleYesNo(state: any, noDraw: any): any {
  let input: any = null;
...
export function CreateTradeBoardWindow(template: any): any {
...
export function DeleteTradeBoardWindow(windowId: any): any {
...
export function ListMenuHandler_AllItemsAvailable(state: any, windowId: any, listMenuId: any, winTemplate: any, menuTemplate: any): any {
  let maxWidth, input;
      let winTemplateCopy: any = null;
...
export function TradeBoardMenuHandler(state: any, mainWindowId: any, listMenuId: any, headerWindowId: any, winTemplate: any, menuTemplate: any, list: any): any {
  let input: any = null;
      let idx: any = null;
...
export function UR_ClearBg0(): any {
  FillBgTilemapBufferRect(0, 0, 0, 0, 32, 32, 0);
      CopyBgTilemapBufferToVram(0);
}

/** static void JoinGroup_EnableScriptContexts(void) */
export function JoinGroup_EnableScriptContexts(): any {
  ScriptContext_Enable();
}

/** static void PrintUnionRoomText(u8 windowId, u8 fontId, const u8 *str, u8 x, u8 y, u8 colorIdx) */
export function PrintUnionRoomText(windowId: any, fontId: any, str: any, x: any, y: any, colorIdx: any): any {
...
export function ClearRfuPlayerList(players: any, count: any): any {
  let i: any = null;
...
export function ArePlayersDifferent(player1: any, player2: any): any {
  let i: any = null;
...
export function ArePlayerDataDifferent(player1: any, player2: any): any {
  let i: any = null;
...
export function GetNewIncomingPlayerId(player: any, incomingPlayer: any): any {
  let result: any = 0xFF;  
      let i: any = null;
...
export function TryAddIncomingPlayerToList(players: any, incomingPlayer: any, max: any): any {
  let i: any = null;
...
export function IsPlayerFacingTradingBoard(): any {
  let x, y;
...
export function UnionRoomGetPlayerInteractionResponse(list: any, overrideGender: any, playerIdx: any, playerGender: any): any {
  let metBefore: any = null;

      let player: any =list.players[playerIdx];
...
export function TradeBoardListMenuItemPrintFunc(windowId: any, itemId: any, y: any): any {
...
export function GetIndexOfNthTradeBoardOffer(players: any, n: any): any {
  let i: any = null;
      let j: any = 0;
...
export function GetUnionRoomPlayerGender(playerIdx: any, list: any): any {
...
export function GetURoomActivityStartMsg(dst: any, acitivty: any): any {
  let mpId: any = GetMultiplayerId();
      let gender: any = gLinkPlayers[mpId ^ 1].gender;
...
export function InUnionRoom(): any {
...
export function HasAtLeastTwoMonsOfLevel30OrLower(): any {
  let i: any = null;
      let count: any = 0;
...
export function ResetUnionRoomTrade(trade: any): any {
...
export function Script_ResetUnionRoomTrade(): any {
  ResetUnionRoomTrade(sUnionRoomTrade);
}

/** static bool32 RegisterTradeMonAndGetIsEgg(u32 monId, struct UnionRoomTrade *trade) */
export function RegisterTradeMonAndGetIsEgg(monId: any, trade: any): any {
...
export function RegisterTradeMon(monId: any, trade: any): any {
...
export function GetPartyPositionOfRegisteredMon(trade: any, multiplayerId: any): any {
  let response: any = 0;
      let species: any = null;
      let personality: any = null;
      let cur_personality: any = null;
      let cur_species: any = null;
      let i: any = null;
...
export function HandleCancelActivity(setData: any): any {
  UR_ClearBg0();
      UnlockPlayerFieldControls();
...
export function StartScriptInteraction(): any {
...
export function ViewURoomPartnerTrainerCard(unused: any, data: any, isParent: any): any {
  let trainerCard: any =gTrainerCards[GetMultiplayerId() ^ 1];
      let i: any = null;
      let n: any = null;
...
export function CopyAndTranslatePlayerName(dest: any, player: any): any {
  StringCopy_PlayerName(dest, player.rfu.name);
      ConvertInternationalString(dest, player.rfu.data.compatibility.language);
}

// ─── callsTo manifest (= 244 unique callees) ───────────────────────
// (Sorted alphabetically. Used for helper bridge detection.)
export const __callsTo__: ReadonlyArray<string> = ["ARRAY_COUNT","AddTextPrinter","AddTextPrinterForMessage_2","AddTextPrinterWithCustomSpeedForMessage","AddWindow","AllocZeroed","AnimateSprites","AreBattleTowerLinkSpeciesSame","ArePlayerDataDifferent","ArePlayerFieldControlsLocked","ArePlayersDifferent","AskToJoinRfuGroup","BG_PLTT_ID","BeginNormalPaletteFade","BlitMenuInfoIcon","BuildOamBuffer","CB2_StartCreateTradeMenu","ChooseMonForTradingBoard","CleanupOverworldWindowsAndTilemaps","ClearIncomingPlayerList","ClearRfuPlayerList","ClearStdWindowAndFrame","ClearWindowTilemap","ConvPartnerUnameAndGetWhetherMetAlready","ConvertIntToDecimalStringN","ConvertInternationalString","CopyAndTranslatePlayerName","CopyBgTilemapBufferToVram","CopyEasyChatWord","CopyHostRfuGameDataAndUsername","CopyPlayerListFromBuffer","CopyPlayerListToBuffer","CopyTrainerCardData","CopyWindowToVram","CreateTask","CreateTask_ListenForCompatiblePartners","CreateTask_ListenForWonderDistributor","CreateTask_RfuReconnectWithParent","CreateTask_RunScriptAndFadeToActivity","CreateTask_SearchForChildOrParent","CreateTask_StartActivity","CreateTradeBoardWindow","CreateTrainerCardInBuffer","CreateUnionRoomPlayerSprites","CreateWirelessStatusIndicatorSprite","DeleteTradeBoardWindow","DestroyListMenuTask","DestroyTask","DestroyUnionRoomPlayerObjects","DestroyUnionRoomPlayerSprites","DestroyWirelessStatusIndicatorSprite","DisplayYesNoMenuDefaultYes","DoMysteryGiftYesNo","DrawDialogueFrame","DrawStdWindowFrame","DynamicPlaceholderTextUtil_ExpandPlaceholders","DynamicPlaceholderTextUtil_Reset","DynamicPlaceholderTextUtil_SetPlaceholderPtr","EnterUnionRoomChat","EraseYesNoWindow","FadeScreen","FillBgTilemapBufferRect","FillWindowPixelBuffer","Free","FreezeObjects_WaitForPlayer","FuncIsActiveTask","GROUP_MAX","GROUP_MIN","GROUP_MIN2","GetActivePartnersInfo","GetAwaitingCommunicationText","GetBlockReceivedStatus","GetChatLeaderActionRequestMessage","GetCursorSelectionMonId","GetGroupLeaderSentAnOKMessage","GetGroupListTextColor","GetHostRfuGameData","GetIndexOfNthTradeBoardOffer","GetLinkPlayerCount","GetLinkPlayerCountAsBitFlags","GetLinkPlayerInfoFlags","GetMonData","GetMultiplayerId","GetMysteryGiftBaseBlock","GetNewIncomingPlayerId","GetNewLeaderCandidate","GetOtherPlayersInfoFlags","GetPartyMenuType","GetPartyPositionOfRegisteredMon","GetResponseIdx_InviteToURoomActivity","GetStringRightAlignXOffset","GetURoomActivityRejectMsg","GetURoomActivityStartMsg","GetUnionRoomPlayerGender","GetUnionRoomTrainerClass","GetWonderCardFlagID","GetXYCoordsOneStepInFrontOfPlayer","GetYouAskedToJoinGroupPleaseWaitMessage","GetYouDeclinedTheOfferMessage","HandleCancelActivity","HandleContactFromOtherPlayer","HandlePlayerListUpdate","HandleUnionRoomPlayerRefresh","HasAtLeastTwoMonsOfLevel30OrLower","HasTrainerLeftPartnersList","HasWonderCardOrNewsByLinkGroup","HealPlayerParty","InUnionRoom","IncrementGameStat","InitChooseHalfPartyForBattle","InitUnionRoomPlayerObjects","InitializeRfuLinkManager_EnterUnionRoom","InitializeRfuLinkManager_JoinGroup","InitializeRfuLinkManager_LinkLeader","Intl_GetListMenuWidth","IsActivityWithVariableGroupSize","IsLinkTaskFinished","IsPartnerActivityAcceptable","IsPlayerFacingTradingBoard","IsRequestedTradeInPlayerParty","IsRfuCommunicatingWithAllChildren","IsTryingToTradeAcrossVersionTooSoon","IsUnionRoomListenTaskActive","JOY_NEW","JoinGroup_EnableScriptContexts","LINK_GROUP_CAPACITY","LeaderPrunePlayerList","LeaderUpdateGroupMembership","Leader_DestroyResources","Leader_GetAcceptNewMemberPrompt","Leader_SetStateIfMemberListChanged","LinkRfu_CreateConnectionAsParent","LinkRfu_Shutdown","LinkRfu_StopManagerAndFinalizeSlots","LinkRfu_StopManagerBeforeEnteringChat","ListMenuHandler_AllItemsAvailable","ListMenuInit","ListMenuLoadStdPalAt","ListMenu_ProcessInput","LmanAcceptSlotFlagIsNotZero","LoadMessageBoxAndBorderGfx","LoadPlayerBag","LoadWirelessStatusIndicatorSpriteGfx","LockPlayerFieldControls","MAP_GROUP","MAP_NUM","MG_AddMessageTextPrinter","MG_DrawTextBorder","Menu_ProcessInputNoWrapClearOnChoose","MysteryGift_DisableStats","MysteryGift_TryEnableStatsByFlagId","OpenLink","PIXEL_FILL","PlayBattleBGM","PlaySE","PlayerHasMetTrainerBefore","PollPartnerYesNoResponse","PrintGroupCandidateOnWindow","PrintGroupMemberOnWindow","PrintMysteryGiftMenuMessage","PrintNumPlayersWaitingForMsg","PrintOnTextbox","PrintPlayerNameAndIdOnWindow","PrintUnionRoomText","PutWindowTilemap","Random","ReadAsU16","ReceiveUnionRoomActivityPacket","RedrawListMenu","RegisterTradeMon","RegisterTradeMonAndGetIsEgg","RemoveWindow","RequestDisconnectSlotByTrainerNameAndId","ResetBlockReceivedFlags","ResetHostRfuGameData","ResetUnionRoomTrade","RfuGetStatus","RfuHasErrored","RfuSetIgnoreError","RfuSetStatus","RfuTryDisconnectLeavingChildren","Rfu_DisconnectPlayerById","Rfu_GetCompatiblePlayerData","Rfu_GetWonderDistributorPlayerData","Rfu_SendPacket","RunTasks","RunTextPrinters","RunTextPrintersAndIsPrinter0Active","SaveLinkTrainerNames","SavePlayerParty","ScheduleFieldMessageAndExit","ScheduleFieldMessageWithFollowupState","ScheduleUnionRoomPlayerRefresh","ScriptContext_Enable","ScriptContext_IsEnabled","SendBlock","SendBlockRequest","SendLeaveGroupNotice","SendRfuStatusToPartner","SetCableClubWarp","SetCloseLinkCallback","SetDynamicWarpWithCoords","SetHostRfuGameData","SetHostRfuWonderFlags","SetLinkStandbyCallback","SetMainCallback2","SetTilesAroundUnionRoomPlayersPassable","SetTradeBoardRegisteredMonInfo","SetWarpDestination","SetWirelessCommType1","ShowTrainerCardInLink","StartBerryCrush","StartDodrioBerryPicking","StartPokemonJump","StartScriptInteraction","StopUnionRoomLinkManager","StringAppend","StringCopy","StringCopy_PlayerName","StringExpandPlaceholders","TradeBoardMenuHandler","TradeBoardPrintItemInfo","TrainerCard_GenerateCardForLinkPlayer","TryAddIncomingPlayerToList","TryConnectToUnionRoomParent","TryInteractWithUnionRoomMember","UR_ClearBg0","UR_PrintFieldMessage","UR_RunTextPrinters","UnionRoomGetPlayerInteractionResponse","UnionRoomHandleYesNo","UnionRoom_UnlockPlayerAndChatPartner","UnlockPlayerFieldControls","UpdateGameData_GroupLockedIn","UpdateGameData_SetActivity","UpdatePaletteFade","UpdateUnionRoomMemberFacing","VarSet","ViewURoomPartnerTrainerCard","WaitRfuState","WaitSendRfuStatusToPartner","WarpForCableClubActivity","WarpForWirelessMinigame","WarpIntoMap"];

// ─── Failed transpiles (1) ───────────────────────────────
// ItemPrintFunc_EmptyList : empty body