...
const {
  ...
  DynamicPlaceholderTextUtil_SetPlaceholderPtr, EnterUnionRoomChat, EraseYesNoWindow, FadeScreen,
  FillBgTilemapBufferRect, FillWindowPixelBuffer, Free, FreezeObjects_WaitForPlayer,
  FuncIsActiveTask, GROUP_MAX, GROUP_MIN, GROUP_MIN2,
  GetBlockReceivedStatus, GetCursorSelectionMonId, GetHostRfuGameData, GetLinkPlayerCount,
  GetLinkPlayerCountAsBitFlags, GetLinkPlayerInfoFlags, GetMonData, GetMultiplayerId,
  GetMysteryGiftBaseBlock, GetOtherPlayersInfoFlags, GetPartyMenuType, GetStringRightAlignXOffset,
  GetUnionRoomTrainerClass, GetWonderCardFlagID, GetXYCoordsOneStepInFrontOfPlayer, HandleUnionRoomPlayerRefresh,
  HasTrainerLeftPartnersList, HealPlayerParty, IncrementGameStat, InitChooseHalfPartyForBattle,
  InitUnionRoomPlayerObjects, InitializeRfuLinkManager_EnterUnionRoom, InitializeRfuLinkManager_JoinGroup, InitializeRfuLinkManager_LinkLeader,
  Intl_GetListMenuWidth, IsLinkTaskFinished, IsRfuCommunicatingWithAllChildren, IsUnionRoomListenTaskActive,
  JOY_NEW, LINK_GROUP_CAPACITY, LinkRfu_CreateConnectionAsParent, LinkRfu_Shutdown,
  LinkRfu_StopManagerAndFinalizeSlots, LinkRfu_StopManagerBeforeEnteringChat, ListMenuInit, ListMenuLoadStdPalAt,
  ListMenu_ProcessInput, LmanAcceptSlotFlagIsNotZero, LoadMessageBoxAndBorderGfx, LoadPlayerBag,
  LoadWirelessStatusIndicatorSpriteGfx, LockPlayerFieldControls, MAP_GROUP, MAP_NUM,
  MG_AddMessageTextPrinter, MG_DrawTextBorder, Menu_ProcessInputNoWrapClearOnChoose, MysteryGift_DisableStats,
  MysteryGift_TryEnableStatsByFlagId, OpenLink, PIXEL_FILL, PlayBattleBGM,
  ...
  RunTextPrinters, RunTextPrintersAndIsPrinter0Active, SaveLinkTrainerNames, SavePlayerParty,
  ...
  StartDodrioBerryPicking, StartPokemonJump, StopUnionRoomLinkManager, StringAppend,
  StringCopy, StringCopy_PlayerName, StringExpandPlaceholders, TrainerCard_GenerateCardForLinkPlayer,
  ...
  VarSet, WaitRfuState, WaitSendRfuStatusToPartner, WarpIntoMap,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
