...
const {
  ...
  MAP_NUM, MG_AddMessageTextPrinter, MG_DrawTextBorder, Menu_ProcessInputNoWrapClearOnChoose,
  MysteryGift_DisableStats, MysteryGift_TryEnableStatsByFlagId, NULL, OpenLink,
  PALETTES_ALL, PIXEL_FILL, PlayBattleBGM, PlaySE,
  PlayerHasMetTrainerBefore, PrintMysteryGiftMenuMessage, PutWindowTilemap, Random,
  RedrawListMenu, RemoveWindow, RequestDisconnectSlotByTrainerNameAndId, ResetBlockReceivedFlags,
  ResetHostRfuGameData, RfuGetStatus, RfuHasErrored, RfuSetIgnoreError,
  RfuSetStatus, RfuTryDisconnectLeavingChildren, Rfu_DisconnectPlayerById, Rfu_GetCompatiblePlayerData,
  Rfu_GetWonderDistributorPlayerData, Rfu_SendPacket, RunTasks, RunTextPrinters,
  RunTextPrintersAndIsPrinter0Active, STR_CONV_MODE_LEADING_ZEROS, STR_CONV_MODE_LEFT_ALIGN, STR_CONV_MODE_RIGHT_ALIGN,
  SaveLinkTrainerNames, SavePlayerParty, ScheduleUnionRoomPlayerRefresh, ScriptContext_Enable,
  ScriptContext_IsEnabled, SendBlock, SendBlockRequest, SendLeaveGroupNotice,
  SendRfuStatusToPartner, SetCableClubWarp, SetCloseLinkCallback, SetDynamicWarpWithCoords,
  SetHostRfuGameData, SetHostRfuWonderFlags, SetLinkStandbyCallback, SetMainCallback2,
  SetTilesAroundUnionRoomPlayersPassable, SetTradeBoardRegisteredMonInfo, SetWarpDestination, SetWirelessCommType1,
  ShowTrainerCardInLink, StartBerryCrush, StartDodrioBerryPicking, StartPokemonJump,
  StopUnionRoomLinkManager, StringAppend, StringCopy, StringCopy_PlayerName,
