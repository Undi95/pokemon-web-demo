...
export function PrintNumPlayersWaitingForMsg(...args: any[]): any {
...
export function PrintPlayerNameAndIdOnWindow(...args: any[]): any {
  const text: any[] = [];
      let txtPtr: any = null;
...
export function GetAwaitingCommunicationText(...args: any[]): any {
  switch (activity)
      {
...
export function IsActivityWithVariableGroupSize(...args: any[]): any {
  switch (activity)
      {
      case ACTIVITY_POKEMON_JUMP:
      case ACTIVITY_BERRY_CRUSH:
...
export function Task_TryBecomeLinkLeader(...args: any[]): any {
  let id, val;
...
export function Leader_DestroyResources(...args: any[]): any {
...
export function Leader_GetAcceptNewMemberPrompt(...args: any[]): any {
  switch (activity)
      {
      case ACTIVITY_BATTLE_SINGLE:
      case ACTIVITY_BATTLE_DOUBLE:
...
export function GetYouDeclinedTheOfferMessage(...args: any[]): any {
  switch (activity)
      {
...
export function GetYouAskedToJoinGroupPleaseWaitMessage(...args: any[]): any {
  switch (activity)
      {
      case ACTIVITY_BATTLE_SINGLE:
      case ACTIVITY_BATTLE_DOUBLE:
...
export function GetGroupLeaderSentAnOKMessage(...args: any[]): any {
  switch (activity)
      {
      case ACTIVITY_BATTLE_SINGLE:
      case ACTIVITY_BATTLE_DOUBLE:
...
export function Leader_SetStateIfMemberListChanged(...args: any[]): any {
...
export function ItemPrintFunc_PossibleGroupMembers(...args: any[]): any {
  let data: any = sWirelessLinkMain.leader;
      let colorIdx = UR_COLOR_DEFAULT;
...
export function LeaderUpdateGroupMembership(...args: any[]): any {
  let data: any = sWirelessLinkMain.leader;
      let ret = UNION_ROOM_SPAWN_NONE;
      let i: any = null;
      let id: any = null;

      for (i = 1; i < MAX_RFU_PLAYERS; i++)
      {
          let var = data.playerList.players[i].groupScheduledAnim;
...
export function LeaderPrunePlayerList(...args: any[]): any {
  let data: any = sWirelessLinkMain.leader;
...
export function Task_TryJoinLinkGroup(...args: any[]): any {
  let id: any = null;
...
export function IsTryingToTradeAcrossVersionTooSoon(...args: any[]): any {
...
export function AskToJoinRfuGroup(...args: any[]): any {
  data.leaderId = id;
      LoadWirelessStatusIndicatorSpriteGfx();
      CreateWirelessStatusIndicatorSprite(0, 0);
      RedrawListMenu(data.listTaskId);
...
export function Task_ListenToWireless(...args: any[]): any {
  let data: any = sWirelessLinkMain.group;
...
export function IsPartnerActivityAcceptable(...args: any[]): any {
  if (linkGroup == 0xFF)
          return TRUE;
      if (linkGroup < ARRAY_COUNT(sAcceptedActivityIds))
      if (linkGroup <= ARRAY_COUNT(sAcceptedActivityIds))
      {
          let bytes = sAcceptedActivityIds[linkGroup];
...
export function GetGroupListTextColor(...args: any[]): any {
...
export function ListMenuItemPrintFunc_UnionRoomGroups(...args: any[]): any {
  let data: any = sWirelessLinkMain.group;
      let colorId = GetGroupListTextColor(data, id);
...
export function Task_CreateTradeMenu(...args: any[]): any {
...
export function CreateTask_CreateTradeMenu(): any {
  let taskId = CreateTask(Task_CreateTradeMenu, 0);

      return taskId;
}

/** static void Task_StartUnionRoomTrade(u8 taskId) */
export function Task_StartUnionRoomTrade(...args: any[]): any {
...
export function Task_ExchangeCards(...args: any[]): any {
  switch (gTasks[taskId].data[0])
      {
      case 0:
...
export function StartUnionRoomBattle(...args: any[]): any {
  HealPlayerParty();
      SavePlayerParty();
      LoadPlayerBag();
...
export function WarpForWirelessMinigame(...args: any[]): any {
...
export function WarpForCableClubActivity(...args: any[]): any {
...
export function CreateTrainerCardInBuffer(...args: any[]): any {
  let card: any = dest;
...
export function Task_StartActivity(...args: any[]): any {
  MysteryGift_DisableStats();
      switch (gPlayerCurrActivity)
      {
      case ACTIVITY_BATTLE_SINGLE:
...
export function Task_RunScriptAndFadeToActivity(...args: any[]): any {
  let data = gTasks[taskId].data;
      let sendBuff = (u16 *)(gBlockSendBuffer);
...
export function CreateTask_StartActivity(): any {
  let taskId = CreateTask(Task_StartActivity, 0);
      gTasks[taskId].data[0] = 0;
}

/** void CreateTask_SendMysteryGift(u32 activity) */
export function CreateTask_SendMysteryGift(...args: any[]): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_SendMysteryGift(...args: any[]): any {
  let data: any = sWirelessLinkMain.leader;
...
export function CreateTask_LinkMysteryGiftWithFriend(...args: any[]): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_CardOrNewsWithFriend(...args: any[]): any {
  let id: any = null;
...
export function CreateTask_LinkMysteryGiftOverWireless(...args: any[]): any {
  let taskId: any = null;
      let data: any = null;
...
export function Task_CardOrNewsOverWireless(...args: any[]): any {
  let id: any = null;
      let winTemplate: any = null;
      let data: any = sWirelessLinkMain.group;
...
export function ReadAsU16(...args: any[]): any {
  return (ptr[1] << 8) | (ptr[0]);
}

/** static void ScheduleFieldMessageWithFollowupState(u32 nextState, const u8 *src) */
export function ScheduleFieldMessageWithFollowupState(...args: any[]): any {
...
export function ScheduleFieldMessageAndExit(...args: any[]): any {
  let uroom: any = sWirelessLinkMain.uRoom;
...
export function CopyPlayerListToBuffer(...args: any[]): any {
...
export function CopyPlayerListFromBuffer(...args: any[]): any {
...
export function Task_RunUnionRoom(...args: any[]): any {
  let id = 0;
      let input = 0;
      let playerGender = MALE;
      let uroom: any = sWirelessLinkMain.uRoom;
      let taskData = gTasks[taskId].data;
...
export function ReceiveUnionRoomActivityPacket(...args: any[]): any {
...
export function HandleContactFromOtherPlayer(...args: any[]): any {
  if (uroom.recvActivityRequest[0] != 0)
      {
          let id = GetChatLeaderActionRequestMessage(gStringVar4, gLinkPlayers[1].gender, uroom.recvActivityRequest[0], uroom);
          if (id == 0)  
          {
              return TRUE;
          }
...
export function Task_InitUnionRoom(...args: any[]): any {
  let i: any = null;
      const text: any[] = [];
...
export function Task_SearchForChildOrParent(...args: any[]): any {
  let i, j;
      let rfu: any = null;
      let list: any = (void *) gTasks[taskId].data;
...
export function CreateTask_SearchForChildOrParent(...args: any[]): any {
  let taskId = CreateTask(Task_SearchForChildOrParent, 0);
      let data: any = (void *)gTasks[taskId].data;
      data[0] = parentList;
      data[1] = childList;
...
export function Task_ListenForCompatiblePartners(...args: any[]): any {
  let i, j;
      let list: any = (void *) gTasks[taskId].data;
...
export function HasWonderCardOrNewsByLinkGroup(...args: any[]): any {
...
export function Task_ListenForWonderDistributor(...args: any[]): any {
  let i: any = null;
      let list: any = (void *) gTasks[taskId].data;
...
export function CreateTask_ListenForCompatiblePartners(...args: any[]): any {
  let taskId = CreateTask(Task_ListenForCompatiblePartners, 0);
      let oldList: any = (void *) gTasks[taskId].data;
      oldList[0] = list;
...
export function CreateTask_ListenForWonderDistributor(...args: any[]): any {
  let taskId = CreateTask(Task_ListenForWonderDistributor, 0);
      let oldList: any = (void *) gTasks[taskId].data;
      oldList[0] = list;
      gTasks[taskId].data[2] = linkGroup;
      return taskId;
...
export function UR_PrintFieldMessage(...args: any[]): any {
...
export function PrintOnTextbox(...args: any[]): any {
  switch (*textState)
      {
      case 0:
          LoadMessageBoxAndBorderGfx();
...
export function UnionRoomHandleYesNo(...args: any[]): any {
  let input: any = null;
...
export function CreateTradeBoardWindow(...args: any[]): any {
  let windowId = AddWindow(template);
...
export function DeleteTradeBoardWindow(...args: any[]): any {
...
export function ListMenuHandler_AllItemsAvailable(...args: any[]): any {
  let maxWidth, input;
...
export function TradeBoardMenuHandler(...args: any[]): any {
  let input: any = null;
      let idx: any = null;
...
export function PrintUnionRoomText(...args: any[]): any {
...
export function ClearRfuPlayerList(...args: any[]): any {
  let i: any = null;
...
export function ClearIncomingPlayerList(...args: any[]): any {
  let i: any = null;
...
export function ArePlayersDifferent(...args: any[]): any {
  let i: any = null;
...
export function ArePlayerDataDifferent(...args: any[]): any {
  let i: any = null;
...
export function GetNewIncomingPlayerId(...args: any[]): any {
  let result = 0xFF;  
      let i: any = null;
...
export function TryAddIncomingPlayerToList(...args: any[]): any {
  let i: any = null;
...
export function PrintGroupMemberOnWindow(...args: any[]): any {
...
export function PrintGroupCandidateOnWindow(...args: any[]): any {
  const trainerId: any[] = [];
...
export function GetResponseIdx_InviteToURoomActivity(...args: any[]): any {
  switch (activity)
      {
      case ACTIVITY_CHAT:
          return 1;
...
export function ConvPartnerUnameAndGetWhetherMetAlready(...args: any[]): any {
  const name: any[] = [];
...
export function UnionRoomGetPlayerInteractionResponse(...args: any[]): any {
...
export function TradeBoardPrintItemInfo(...args: any[]): any {
  const levelStr: any[] = [];
      let species = data.tradeSpecies;
      let type = data.tradeType;
      let level = data.tradeLevel;
...
export function TradeBoardListMenuItemPrintFunc(...args: any[]): any {
...
export function GetIndexOfNthTradeBoardOffer(...args: any[]): any {
  let i: any = null;
      let j = 0;
...
export function GetURoomActivityRejectMsg(...args: any[]): any {
  switch (acitivty)
      {
      case ACTIVITY_BATTLE_SINGLE | IN_UNION_ROOM:
...
export function GetURoomActivityStartMsg(...args: any[]): any {
  let mpId = GetMultiplayerId();
      let gender = gLinkPlayers[mpId ^ 1].gender;
...
export function GetChatLeaderActionRequestMessage(...args: any[]): any {
  let result = 0;
...
export function PollPartnerYesNoResponse(...args: any[]): any {
  if (gRecvCmds[0][1] != 0)
      {
...
export function ResetUnionRoomTrade(...args: any[]): any {
...
export function RegisterTradeMonAndGetIsEgg(...args: any[]): any {
...
export function RegisterTradeMon(...args: any[]): any {
...
export function GetPartyPositionOfRegisteredMon(...args: any[]): any {
  let response = 0;
...
export function HandleCancelActivity(...args: any[]): any {
  UR_ClearBg0();
      UnlockPlayerFieldControls();
...
export function GetActivePartnersInfo(...args: any[]): any {
  let retVal = PINFO_ACTIVE_FLAG;
      let i: any = null;
...
export function ViewURoomPartnerTrainerCard(...args: any[]): any {
...
export function CopyAndTranslatePlayerName(...args: any[]): any {
