...
export function SpriteCB_Pokeball(...args: any[]): any {
...
export function CB2_InitSelectScreen(): any {
  let taskId: any = null;
      ...
      case 1:
          ...
          sSelectMonPicBgTilesetBuffer = AllocZeroed(sizeof(gFrontierFactoryMenu_Gfx));  
...
export function Select_UpdateBallCursorPosition(...args: any[]): any {
...
export function Select_UpdateMenuCursorPosition(...args: any[]): any {
  if (direction > 0)  
      {
...
export function Select_UpdateYesNoCursorPosition(...args: any[]): any {
  if (direction > 0)  
      {
...
export function Select_HandleMonSelectionChange(): any {
  let i, paletteNum;
      let cursorPos = sFactorySelectScreen.cursorPos;
...
export function Select_SetBallSpritePaletteNum(...args: any[]): any {
  let palNum: any = null;
...
export function Select_Task_OpenSummaryScreen(...args: any[]): any {
  let i: any = null;
...
export function Select_Task_Exit(...args: any[]): any {
...
export function Select_Task_HandleYesNo(...args: any[]): any {
  if (sFactorySelectScreen.monPicAnimating == TRUE)
          return;
...
export function Select_Task_HandleMenu(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
...
export function Select_Task_HandleChooseMons(...args: any[]): any {
  if (sFactorySelectScreen.monPicAnimating == TRUE)
          return;
...
export function CreateFrontierFactorySelectableMons(...args: any[]): any {
  u8 i, j = 0;
      let ivs = 0;
      let level = 0;
      let friendship = 0;
      ...
      let challengeNum = gSaveBlock2Ptr.frontier.factoryWinStreaks[battleMode][lvlMode] / 7;
      let rentalRank = 0;
      ...
      for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
      {
          let monId = gSaveBlock2Ptr.frontier.rentalMons[i].monId;
...
export function CreateSlateportTentSelectableMons(...args: any[]): any {
  let i, j;
      let ivs = 0;
...
export function Select_ErasePopupMenu(...args: any[]): any {
  gSprites[sFactorySelectScreen.menuCursor1SpriteId].invisible = TRUE;
      gSprites[sFactorySelectScreen.menuCursor2SpriteId].invisible = TRUE;
...
export function Select_PrintMonSpecies(): any {
  let species: any = null;
      let x: any = null;
      let monId = sFactorySelectScreen.cursorPos;
...
export function Select_PrintMenuOptions(): any {
  let selectedId = sFactorySelectScreen.mons[sFactorySelectScreen.cursorPos].selectedId;
...
export function Select_OptionRentDeselect(): any {
  let selectedId = sFactorySelectScreen.mons[sFactorySelectScreen.cursorPos].selectedId;
      let monId = sFactorySelectScreen.mons[sFactorySelectScreen.cursorPos].monId;
...
export function Select_CreateMonSprite(): any {
  let monId = sFactorySelectScreen.cursorPos;
      ...
      let otId = GetMonData(mon, MON_DATA_OT_ID, NULL);
...
export function Select_SetMonPicAnimating(...args: any[]): any {
...
export function SpriteCB_OpenChosenMonPics(...args: any[]): any {
  let taskId: any = null;
...
export function SpriteCB_CloseChosenMonPics(...args: any[]): any {
  if (sprite.affineAnimEnded
          && gSprites[sFactorySelectScreen.monPics[0].bgSpriteId].affineAnimEnded
          && gSprites[sFactorySelectScreen.monPics[2].bgSpriteId].affineAnimEnded)
      {
...
export function Select_Task_OpenChosenMonPics(...args: any[]): any {
...
export function Select_Task_CloseChosenMonPics(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.tState)
      {
      case 0:
...
export function Select_SetWinRegs(...args: any[]): any {
  SetGpuRegBits(REG_OFFSET_DISPCNT, DISPCNT_WIN0_ON);
...
export function Select_AreSpeciesValid(...args: any[]): any {
  let i, j;
      let species = gFacilityTrainerMons[monId].species;
      let selectState = sFactorySelectScreen.selectingMonsState;
...
export function Select_Task_FadeSpeciesName(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case FADESTATE_INIT:
...
export function Swap_Task_OpenSummaryScreen(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case STATE_SUMMARY_FADE:
          BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
...
export function Swap_Task_Exit(...args: any[]): any {
...
export function Swap_Task_HandleYesNo(...args: any[]): any {
  let loPtr, hiPtr;
...
export function Swap_HandleQuitSwappingResponse(...args: any[]): any {
...
export function Swap_AskQuitSwapping(...args: any[]): any {
...
export function Swap_HandleAcceptMonResponse(...args: any[]): any {
...
export function Swap_AskAcceptMon(...args: any[]): any {
  if (gTasks[taskId].tState == 0)
      {
...
export function Swap_Task_HandleMenu(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case STATE_MENU_INIT:
...
export function Swap_Task_HandleChooseMons(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case STATE_CHOOSE_MONS_INIT:
          if (!gPaletteFade.active)
...
export function Swap_Task_FadeSpeciesName(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case FADESTATE_INIT:
...
export function Swap_Task_FadeOutSpeciesName(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
          sFactorySwapScreen.fadeSpeciesNameCoeffDelay = 0;
...
export function Swap_Task_SlideCycleBalls(...args: any[]): any {
  let i: any = null;
      let lastX: any = null;
      ...
      case 1:
          ...
          for (i = FRONTIER_PARTY_SIZE - 1; i >= 0; i--)
          {
              ...
              {
                  let posX = lastX - gSprites[sFactorySwapScreen.ballSpriteIds[i]].x;
...
export function Swap_Task_SlideButtonOnOffScreen(...args: any[]): any {
  let i, j;
      let posX = 0;
      let deltaX = gTasks[taskId].tXIncrement;
...
export function Swap_Task_ScreenInfoTransitionOut(...args: any[]): any {
...
export function Swap_Task_ScreenInfoTransitionIn(...args: any[]): any {
  let slideTaskId: any = null;
      let hiPtr, loPtr;
      if (sFactorySwapScreen.monPicAnimating == TRUE)
          return;
...
export function Swap_Task_SwitchPartyScreen(...args: any[]): any {
  let i: any = null;
      if (sFactorySwapScreen.monPicAnimating == TRUE)
          return;
...
export function CB2_InitSwapScreen(): any {
  let taskId: any = null;
      ...
      case 1:
          ...
          sSwapMonPicBgTilesetBuffer = AllocZeroed(sizeof(gFrontierFactoryMenu_Gfx));  
...
export function Swap_HandleActionCursorChange(...args: any[]): any {
...
export function Swap_UpdateBallCursorPosition(...args: any[]): any {
  let cursorPos: any = null;
      PlaySE(SE_SELECT);
      if (direction > 0)  
      {
...
export function Swap_UpdateActionCursorPosition(...args: any[]): any {
  let cursorPos: any = null;
      PlaySE(SE_SELECT);
      if (direction > 0)  
      {
...
export function Swap_UpdateYesNoCursorPosition(...args: any[]): any {
  if (direction > 0)  
      {
...
export function Swap_UpdateMenuCursorPosition(...args: any[]): any {
  PlaySE(SE_SELECT);
      if (direction > 0)  
      {
...
export function Swap_HighlightActionButton(...args: any[]): any {
  let i: any = null;
...
export function Swap_ErasePopupMenu(...args: any[]): any {
  gSprites[sFactorySwapScreen.menuCursor1SpriteId].invisible = TRUE;
      gSprites[sFactorySwapScreen.menuCursor2SpriteId].invisible = TRUE;
      FillWindowPixelBuffer(windowId, PIXEL_FILL(0));
      CopyWindowToVram(windowId, COPYWIN_GFX);
...
export function Swap_PrintMonSpecies(): any {
  let species: any = null;
      ...
      {
          let monId = sFactorySwapScreen.cursorPos;
          if (!sFactorySwapScreen.inEnemyScreen)
...
export function Swap_PrintOnInfoWindow(...args: any[]): any {
...
export function Swap_PrintActionString(...args: any[]): any {
  let x = GetStringRightAlignXOffset(FONT_SMALL, str, 70);
...
export function Swap_PrintOneActionString(...args: any[]): any {
  switch (which)
      {
      case 0:
          if (sFactorySwapScreen.inEnemyScreen == TRUE)
...
export function Swap_InitActions(...args: any[]): any {
  if (sFactorySwapScreen.fromSummaryScreen != TRUE)
      {
          switch (id)
          {
...
export function Swap_RunMenuOptionFunc(...args: any[]): any {
...
export function Swap_OptionSwap(...args: any[]): any {
  CloseMonPic(sFactorySwapScreen.monPic, sFactorySwapScreen.monPicAnimating, TRUE);
...
export function Swap_OptionSummary(...args: any[]): any {
  gTasks[taskId].tState = STATE_SUMMARY_FADE;
      gTasks[taskId].func = Swap_Task_OpenSummaryScreen;
}

/** static void Swap_OptionRechoose(u8 taskId) */
export function Swap_OptionRechoose(...args: any[]): any {
  CloseMonPic(sFactorySwapScreen.monPic, sFactorySwapScreen.monPicAnimating, TRUE);
      Swap_ErasePopupMenu(SWAP_WIN_OPTIONS);
      gTasks[taskId].tState = 0;
      gTasks[taskId].tFollowUpTaskPtrHi = (u32)(Swap_Task_HandleChooseMons) >> 16;
...
export function Swap_RunActionFunc(...args: any[]): any {
...
export function Swap_ActionCancel(...args: any[]): any {
  gTasks[taskId].tFollowUpTaskPtrHi = (u32)(Swap_AskQuitSwapping) >> 16;
      gTasks[taskId].tFollowUpTaskPtrLo = (u32)(Swap_AskQuitSwapping);
      gTasks[taskId].tState = 0;
      gTasks[taskId].tFollowUpTaskState = 0;
...
export function Swap_ActionPkmnForSwap(...args: any[]): any {
...
export function Swap_ActionMon(...args: any[]): any {
  if (!sFactorySwapScreen.inEnemyScreen)
      {
...
export function OpenMonPic(...args: any[]): any {
...
export function CloseMonPic(...args: any[]): any {
  let taskId: any = null;
...
export function HideMonPic(...args: any[]): any {
  FreeAndDestroyMonPicSprite(pic.monSpriteId);
...
export function Swap_TaskCantHaveSameMons(...args: any[]): any {
  if (sFactorySwapScreen.monPicAnimating == TRUE)
          return;
...
export function Swap_AlreadyHasSameSpecies(...args: any[]): any {
  let i: any = null;
      let species = GetMonData(gEnemyParty[monId], MON_DATA_SPECIES, NULL);
...
export function SpriteCB_OpenMonPic(...args: any[]): any {
  let taskId: any = null;
...
export function SpriteCB_CloseMonPic(...args: any[]): any {
  if (sprite.affineAnimEnded)
      {
          FreeOamMatrix(sprite.oam.matrixNum);
...
export function Task_OpenMonPic(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.tState)
      {
      case 0:
...
export function Task_CloseMonPic(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.tState)
      {
      case 0:
