...
const {
  ...
  DeactivateAllTextPrinters, DestroySprite, DestroyTask, FALSE,
  FREE_AND_SET_NULL, FillWindowPixelBuffer, FreeAllSpritePalettes, FreeAllWindowBuffers,
  FreeAndDestroyMonPicSprite, FreeOamMatrix, FuncIsActiveTask, GetBoxMonData,
  GetFactoryMonFixedIV, GetMonData, GetNumPastRentalsRank, GetStringRightAlignXOffset,
  HideBg, IndexOfSpritePaletteTag, InitBgsFromTemplates, InitWindows,
  JOY_NEW, JOY_REPEAT, LoadBgTilemap, LoadBgTiles,
  LoadCompressedSpriteSheet, LoadOam, LoadPalette, LoadSpritePalettes,
  LoadSpriteSheets, NULL, PALETTES_ALL, PIXEL_FILL,
  PLTT_SIZEOF, PLTT_SIZE_4BPP, PlaySE, ProcessSpriteCopyRequests,
  ...
  StartSpriteAnimIfDifferent, StringCopy, T1_READ_32, TRUE,
  TRY_FREE_AND_SET_NULL, TransferPlttBuffer, UpdatePaletteFade, VRAM_SIZE,
  VarGet, WIN_RANGE,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
