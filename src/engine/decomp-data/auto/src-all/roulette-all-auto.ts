...
const {
  ...
  BeginHardwarePaletteFade, BeginNormalPaletteFade, BuildOamBuffer, ClearStdWindowAndFrame,
  ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer, CopyWindowToVram,
  Cos2, CreateSprite, CreateTask, DeactivateAllTextPrinters,
  DecompressAndCopyTileDataToVram, DestroySprite, DestroyTask, DisplayYesNoMenuDefaultYes,
  DmaCopy16, DmaFill16, DoYesNoFuncWithChoice, DrawStdWindowFrame,
  EnableInterrupts, FREE_AND_SET_NULL, FillTilemapRect, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreeOamMatrix, FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible,
  GET_COL, GET_COL_IDX, GET_MIN_BET_ID, GET_ROW,
  GET_ROW_IDX, GetCoins, GetGameStat, GetMonData,
  HideCoinsWindow, IncrementDailyRouletteUses, InitBgsFromTemplates, InitTextBoxGfxAndPrinters,
  InitWindows, IsFanfareTaskInactive, IsSEPlaying, JOY_NEW,
  LZ77UnCompWram, LandBall, LoadCompressedSpriteSheet, LoadOam,
  LoadPalette, LoadSpritePalettes, LoadSpriteSheet, LockPlayerFieldControls,
  PLTT_ID, PlayCry_Normal, PlayFanfare, PlaySE,
  PrintCoinsString, ProcessSpriteCopyRequests, Random, ResetAllBgsCoordinates,
  ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData, ResetTasks,
  ResetTempTileDataBuffers, ResetVramOamAndBgCntRegs, RouletteFlash_Add, RouletteFlash_Enable,
  RouletteFlash_Reset, RouletteFlash_Run, RouletteFlash_Stop, RtcCalcLocalTime,
  RunTasks, S16TOPOSFLOAT, ScanlineEffect_Stop, SetBgAttribute,
  ...
  StringExpandPlaceholders, TransferPlttBuffer, TryPutFindThatGamerOnAir, UnlockPlayerFieldControls,
