...
const {
  ...
  BeginHardwarePaletteFade, BeginNormalPaletteFade, BuildOamBuffer, CanMoveSelectionInDir,
  ClearStdWindowAndFrame, ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer,
  CopyWindowToVram, Cos2, CreateGridBallSprites, CreateGridSprites,
  CreateInterfaceSprites, CreateShroomishSprite, CreateSprite, CreateTaillowSprite,
  CreateTask, CreateWheelBallSprites, CreateWheelCenterSprite, CreateWheelIconSprite,
  CreateWheelIconSprites, DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram, DestroySprite,
  DestroyTask, DisplayYesNoMenuDefaultYes, DmaCopy16, DmaFill16,
  DoYesNoFuncWithChoice, DrawGridBackground, DrawStdWindowFrame, EnableInterrupts,
  ExitRoulette, FREE_AND_SET_NULL, FillTilemapRect, FlashSelectionOnWheel,
  FreeAllSpritePalettes, FreeAllWindowBuffers, FreeOamMatrix, FreeRoulette,
  FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, GET_COL, GET_COL_IDX,
  GET_MIN_BET_ID, GET_ROW, GET_ROW_IDX, GetBallDistanceToSlotMidpoint,
  GetCoins, GetGameStat, GetMonData, GetMultiplier,
  GetMultiplierAnimId, GetRandomForBallTravelDistance, HideCoinsWindow, HideWheelBalls,
  IncrementDailyRouletteUses, InitBgsFromTemplates, InitRouletteBgAndWindows, InitRouletteTableData,
  InitTextBoxGfxAndPrinters, InitWindows, IsFanfareTaskInactive, IsHitInBetSelection,
  IsSEPlaying, JOY_NEW, LZ77UnCompWram, LandBall,
  LoadCompressedSpriteSheet, LoadOam, LoadOrFreeMiscSpritePalettesAndSheets, LoadPalette,
  LoadSpritePalettes, LoadSpriteSheet, LockPlayerFieldControls, PLTT_ID,
  PlayCry_Normal, PlayFanfare, PlaySE, PrintCoinsString,
  ProcessBetGridInput, ProcessSpriteCopyRequests, Random, RecordHit,
  ResetAllBgsCoordinates, ResetBallDataForNewSpin, ResetBgsAndClearDma3BusyFlags, ResetHits,
  ...
  S16TOPOSFLOAT, ScanlineEffect_Stop, SetBallCounterNumLeft, SetBallStuck,
  SetBgAttribute, SetBgTilemapBuffer, SetCoins, SetCreditDigits,
  SetGameStat, SetGpuReg, SetMainCallback2, SetMultiplierSprite,
  SetTilemapRect, SetVBlankCallback, SetVBlankHBlankCallbacksToNull, ShowBg,
  ShowCoinsWindow, ShowHideGridBalls, ShowHideGridIcons, ShowHideWinSlotCursor,
  Sin2, StartSpriteAnim, StartTaskAfterDelayOrInput, StringExpandPlaceholders,
  TransferPlttBuffer, TryPutFindThatGamerOnAir, UnlockPlayerFieldControls, UnsetBgTilemapBuffer,
  UpdateBallPos, UpdateBallRelativeWheelAngle, UpdateGridSelection, UpdateGridSelectionRect,
  UpdatePaletteFade, UpdateSlotBelowBall, UpdateWheelPosition,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
