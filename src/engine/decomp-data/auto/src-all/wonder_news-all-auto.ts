...
export function WonderNews_SetReward(...args: any[]): any {
...
export function WonderNews_IncrementStepCounter(): any {
  let stepCounter = GetVarPointer(VAR_WONDER_NEWS_STEP_COUNTER);
      let data: any = GetSavedWonderNewsMetadata();
...
export function GetRewardItem(...args: any[]): any {
  let itemId: any = null;
      data.newsType = WONDER_NEWS_NONE;
...
export function ResetSentRewardCounter(...args: any[]): any {
  data.sentRewardCounter = 0;
}

/** static void IncrementSentRewardCounter(struct WonderNewsMetadata *data) */
export function IncrementSentRewardCounter(...args: any[]): any {
...
export function IncrementRewardCounter(...args: any[]): any {
  data.rewardCounter++;
...
export function GetRewardType(...args: any[]): any {
  if (data.rewardCounter == MAX_REWARD)
