...
const {
  ...
  CurrentBattlePyramidLocation, DestroySprite, DestroyTask, FREE_AND_SET_NULL,
  ...
  MAP_NUM, MapGridGetCollisionAt, MapGridGetElevationAt, MapGridGetMetatileBehaviorAt,
  ...
  MetatileBehavior_IsShortGrass, MetatileBehavior_IsTallGrass, OBJ_PLTT_ID, ObjectEventIsFarawayIslandMew,
  ...
  TestPlayerAvatarFlags, UpdateRevealDisguise, VarGetObjectEventGraphicsId,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
