...
const {
  ARRAY_COUNT, AcroWheelieFaceDirection, Alloc, AllocZeroed,
  AnimateSpriteInFigure8, AreElevationsCompatible, CalcCenterToCornerVec, CameraObjectReset,
  CameraObject_UpdateMove, CanCameraMoveInDirection, ChangeSpriteAffineAnimIfDifferent, ClearAllObjectEvents,
  ClearLinkPlayerObjectEvents, ClearObjectEvent, ClearObjectEventMovement, ClearPlayerAvatarInfo,
  CopyObjectGraphicsInfoToSpriteTemplate, CopyObjectGraphicsInfoToSpriteTemplate_WithMovementType, CreateLevitateMovementTask, CreateReflectionEffectSprites,
  CreateSprite, CreateSpriteAtEnd, CreateTask, CreateWarpArrowSprite,
  CurrentBattlePyramidLocation, DestroyLevitateMovementTask, DestroySprite, DestroyTask,
  DoFigure8Anim, DoFlaggedGroundEffects, DoGroundEffects_OnBeginStep, DoGroundEffects_OnFinishStep,
  DoGroundEffects_OnSpawn, DoJumpAnim, DoJumpAnimStep, DoJumpInPlaceAnim,
  DoJumpSpecialAnim, DoJumpSpecialAnimStep, DoRippleFieldEffect, DoShadowFieldEffect,
  DoesObjectCollideWithObjectAt, ElevationToPriority, FREE_AND_SET_NULL, FaceDirection,
  FieldEffectStart, FilterOutStepOnPuddleGroundEffectIfJumping, FindCameraSprite, FindLockedObjectEventIndex,
  FindObjectEventPaletteIndexByTag, FindTallGrassFieldEffectSpriteId, FlagGet, FlagSet,
  Free, FreeAllSpritePalettes, FreeAndReserveObjectSpritePalettes, FreeOamMatrix,
  FreezeObjectEvent, GetAcroEndWheelieDirectionAnimNum, GetAcroUnusedActionDirectionAnimNum, GetAcroWheelieDirectionAnimNum,
  GetAcroWheeliePedalDirectionAnimNum, GetAllGroundEffectFlags_OnBeginStep, GetAllGroundEffectFlags_OnFinishStep, GetAllGroundEffectFlags_OnSpawn,
  GetAvailableObjectEventId, GetBaseTemplateForObjectEvent, GetBerryTypeByBerryTreeId, GetCollisionAtCoords,
  GetCollisionInDirection, GetCopyDirection, GetDirectionToFace, GetFaceDirectionAnimNum,
  GetFaceDirectionMovementAction, GetFigure8XOffset, GetFigure8YOffset, GetGroundEffectFlags_HotSprings,
  GetGroundEffectFlags_JumpLanding, GetGroundEffectFlags_LongGrassOnBeginStep, GetGroundEffectFlags_LongGrassOnSpawn, GetGroundEffectFlags_Puddle,
  GetGroundEffectFlags_Reflection, GetGroundEffectFlags_Ripple, GetGroundEffectFlags_SandHeap, GetGroundEffectFlags_Seaweed,
  GetGroundEffectFlags_ShallowFlowingWater, GetGroundEffectFlags_ShortGrass, GetGroundEffectFlags_TallGrassOnBeginStep, GetGroundEffectFlags_TallGrassOnSpawn,
  GetGroundEffectFlags_Tracks, GetJump2MovementAction, GetJumpInPlaceMovementAction, GetJumpMovementAction,
  GetJumpSpecialDirectionAnimNum, GetJumpY, GetLimitedVectorDirection_SouthNorth, GetLimitedVectorDirection_WestEast,
  GetMapBorderIdAt, GetMapCoordsFromSpritePos, GetMewMoveDirection, GetMoveDirectionAnimNum,
  GetMoveDirectionFastAnimNum, GetMoveDirectionFasterAnimNum, GetNumBattlePyramidObjectEvents, GetObjectEventFlagIdByLocalIdAndMap,
  GetObjectEventFlagIdByObjectEventId, GetObjectEventGraphicsInfo, GetObjectEventIdByLocalId, GetObjectEventIdByLocalIdAndMap,
  GetObjectEventIdByLocalIdAndMapInternal, GetObjectEventIdByXY, GetObjectEventMovingCameraOffset, GetObjectEventTemplateByLocalIdAndMap,
  GetOppositeDirection, GetPlayerAvatarGenderByGraphicsId, GetPlayerDirectionForCopy, GetPlayerFacingDirection,
  GetPlayerMovementDirection, GetRunningDirectionAnimNum, GetSlideMovementAction, GetStageByBerryTreeId,
  GetStepAnimTable, GetVectorDirection, GetVirtualObjectSpriteId, GetWalkFastMovementAction,
  GetWalkFasterMovementAction, GetWalkInPlaceFastMovementAction, GetWalkInPlaceFasterMovementAction, GetWalkInPlaceNormalMovementAction,
  GetWalkInPlaceSlowMovementAction, GetWalkNormalMovementAction, GroundEffect_SpawnOnTallGrass, ITEM_TO_BERRY,
  InTrainerHill, IndexOfSpritePaletteTag, InitAcroEndWheelie, InitAcroPopWheelie,
  InitAcroWheelieJump, InitAcroWheelieMove, InitFigure8Anim, InitJump,
  InitJumpRegular, InitJumpSpecial, InitMoveInPlace, InitMovementDelay,
  InitMovementNormal, InitNpcForMovement, InitNpcForWalkSlow, InitObjectEventStateFromTemplate,
  InitObjectPriorityByElevation, InitSpriteAffineAnim, InitSpriteForFigure8Anim, InitWalkSlow,
  IsCoordOutsideObjectEventMovementRange, IsElevationMismatchAt, IsMetatileDirectionallyImpassable, LoadObjectEventPalette,
  LoadPalette, LoadPlayerObjectReflectionPalette, LoadSpecialObjectReflectionPalette, LoadSpritePalette,
  LoadSpritePaletteIfTagExists, LoadWordFromTwoHalfwords, MAP_GROUP, MAP_NUM,
  MakeSpriteTemplateFromObjectEventTemplate, MapGridGetCollisionAt, MapGridGetElevationAt, MapGridGetMetatileBehaviorAt,
  MetatileBehavior_HasRipples, MetatileBehavior_IsDeepSand, MetatileBehavior_IsFootprints, MetatileBehavior_IsHotSprings,
  MetatileBehavior_IsIce, MetatileBehavior_IsLongGrass, MetatileBehavior_IsPacifidlogLog, MetatileBehavior_IsPuddle,
  MetatileBehavior_IsReflective, MetatileBehavior_IsSandOrDeepSand, MetatileBehavior_IsSeaweed, MetatileBehavior_IsShallowFlowingWater,
  MetatileBehavior_IsShortGrass, MetatileBehavior_IsTallGrass, MoveCoords, MoveCoordsInDirection,
  MoveNextDirectionInSequence, MoveObjectEventToMapCoords, MoveUnionRoomObjectDown, MoveUnionRoomObjectUp,
  MovementAction_AcroEndWheelieMoveDown_Step1, MovementAction_AcroEndWheelieMoveLeft_Step1, MovementAction_AcroEndWheelieMoveRight_Step1, MovementAction_AcroEndWheelieMoveUp_Step1,
  MovementAction_AcroPopWheelieMoveDown_Step1, MovementAction_AcroPopWheelieMoveLeft_Step1, MovementAction_AcroPopWheelieMoveRight_Step1, MovementAction_AcroPopWheelieMoveUp_Step1,
  MovementAction_AcroWheelieHopDown_Step1, MovementAction_AcroWheelieHopFaceDown_Step1, MovementAction_AcroWheelieHopFaceLeft_Step1, MovementAction_AcroWheelieHopFaceRight_Step1,
  MovementAction_AcroWheelieHopFaceUp_Step1, MovementAction_AcroWheelieHopLeft_Step1, MovementAction_AcroWheelieHopRight_Step1, MovementAction_AcroWheelieHopUp_Step1,
  MovementAction_AcroWheelieJumpDown_Step1, MovementAction_AcroWheelieJumpLeft_Step1, MovementAction_AcroWheelieJumpRight_Step1, MovementAction_AcroWheelieJumpUp_Step1,
  MovementAction_AcroWheelieMoveDown_Step1, MovementAction_AcroWheelieMoveLeft_Step1, MovementAction_AcroWheelieMoveRight_Step1, MovementAction_AcroWheelieMoveUp_Step1,
  MovementAction_Delay_Step1, MovementAction_Figure8_Step1, MovementAction_Jump2Down_Step1, MovementAction_Jump2Left_Step1,
  MovementAction_Jump2Right_Step1, MovementAction_Jump2Up_Step1, MovementAction_JumpDown_Step1, MovementAction_JumpInPlaceDownUp_Step1,
  MovementAction_JumpInPlaceDown_Step1, MovementAction_JumpInPlaceLeftRight_Step1, MovementAction_JumpInPlaceLeft_Step1, MovementAction_JumpInPlaceRightLeft_Step1,
  MovementAction_JumpInPlaceRight_Step1, MovementAction_JumpInPlaceUpDown_Step1, MovementAction_JumpInPlaceUp_Step1, MovementAction_JumpLeft_Step1,
  MovementAction_JumpRight_Step1, MovementAction_JumpSpecialDown_Step1, MovementAction_JumpSpecialLeft_Step1, MovementAction_JumpSpecialRight_Step1,
  MovementAction_JumpSpecialUp_Step1, MovementAction_JumpUp_Step1, MovementAction_PlayerRunDown_Step1, MovementAction_PlayerRunLeft_Step1,
  MovementAction_PlayerRunRight_Step1, MovementAction_PlayerRunUp_Step1, MovementAction_RevealTrainer_Step1, MovementAction_RideWaterCurrentDown_Step1,
  MovementAction_RideWaterCurrentLeft_Step1, MovementAction_RideWaterCurrentRight_Step1, MovementAction_RideWaterCurrentUp_Step1, MovementAction_SlideDown_Step1,
  MovementAction_SlideLeft_Step1, MovementAction_SlideRight_Step1, MovementAction_SlideUp_Step1, MovementAction_WalkDownAffine_Step1,
  MovementAction_WalkDownStartAffine_Step1, MovementAction_WalkFastDown_Step1, MovementAction_WalkFastLeft_Step1, MovementAction_WalkFastRight_Step1,
  MovementAction_WalkFastUp_Step1, MovementAction_WalkFasterDown_Step1, MovementAction_WalkFasterLeft_Step1, MovementAction_WalkFasterRight_Step1,
  MovementAction_WalkFasterUp_Step1, MovementAction_WalkInPlaceSlow_Step1, MovementAction_WalkInPlace_Step1, MovementAction_WalkLeftAffine_Step1,
  MovementAction_WalkNormalDiagonalDownLeft_Step1, MovementAction_WalkNormalDiagonalDownRight_Step1, MovementAction_WalkNormalDiagonalUpLeft_Step1, MovementAction_WalkNormalDiagonalUpRight_Step1,
  MovementAction_WalkNormalDown_Step1, MovementAction_WalkNormalLeft_Step1, MovementAction_WalkNormalRight_Step1, MovementAction_WalkNormalUp_Step1,
  MovementAction_WalkRightAffine_Step1, MovementAction_WalkSlowDiagonalDownLeft_Step1, MovementAction_WalkSlowDiagonalDownRight_Step1, MovementAction_WalkSlowDiagonalUpLeft_Step1,
  MovementAction_WalkSlowDiagonalUpRight_Step1, MovementAction_WalkSlowDown_Step1, MovementAction_WalkSlowLeft_Step1, MovementAction_WalkSlowRight_Step1,
  MovementAction_WalkSlowUp_Step1, NpcTakeStep, OBJ_PLTT_ID, ObjectEventCheckHeldMovementStatus,
  ObjectEventClearHeldMovement, ObjectEventClearHeldMovementIfActive, ObjectEventDoesElevationMatch, ObjectEventExecHeldMovementAction,
  ObjectEventExecSingleMovementAction, ObjectEventGetLocalIdAndMap, ObjectEventGetNearbyReflectionType, ObjectEventIsFarawayIslandMew,
  ObjectEventIsHeldMovementActive, ObjectEventIsMovementOverridden, ObjectEventIsTrainerAndCloseToPlayer, ObjectEventMoveDestCoords,
  ObjectEventSetGraphicsId, ObjectEventSetHeldMovement, ObjectEventSetSingleMovement, ObjectEventTurn,
  ObjectEventUpdateElevation, ObjectEventUpdateMetatileBehaviors, ObjectEventUpdateSubpriority, OverrideObjectEventTemplateScript,
  OverrideTemplateCoordsForObjectEvent, PatchObjectPalette, PatchObjectPaletteRange, PlayerGetCopyableMovement,
  PlayerGetDestCoords, RETURN_REFLECTION_TYPE_AT, Random, RemoveObjectEvent,
  RemoveObjectEventIfOutsideView, RemoveObjectEventInternal, RemoveObjectEventsOutsideView, ResetObjectEventFldEffData,
  SeekSpriteAnim, SetAndStartSpriteAnim, SetBerryTreeGraphics, SetBuriedTrainerMovement,
  SetJumpSpriteData, SetMovementDelay, SetObjectEventCoords, SetObjectEventDirection,
  SetObjectEventDynamicGraphicsId, SetObjectEventSpriteOamTableForLongGrass, SetObjectSubpriorityByElevation, SetPlayerAvatarExtraStateTransition,
  SetPlayerAvatarObjectEventIdAndObjectId, SetSpriteDataForNormalStep, SetSpritePosToMapCoords, SetSpritePosToOffsetMapCoords,
  SetStepAnim, SetStepAnimHandleAlternation, SetSubspriteTables, SetUpReflection,
  SetWalkSlowSpriteData, ShiftObjectEventCoords, ShiftStillObjectEventCoords, ShouldMewShakeGrass,
  SpawnObjectEventOnReturnToField, SpawnSpecialObjectEvent, SpriteAnimEnded, StartFieldEffectForObjectEvent,
  StartRevealDisguise, StartRunningAnim, StartSpriteAffineAnim, StartSpriteAffineAnimIfDifferent,
  StartSpriteAnim, StartSpriteAnimIfDifferent, StartSpriteAnimInDirection, Step1,
  StoreWordInTwoHalfwords, TestPlayerAvatarFlags, TryEnableObjectEventAnim, TryGetObjectEventIdByLocalIdAndMap,
  TryGetTrainerEncounterDirection, TrySetupObjectEventSprite, TrySpawnObjectEventTemplate, TrySpawnObjectEvents,
  UnfreezeObjectEvent, UpdateJumpAnim, UpdateMovementNormal, UpdateObjectEventCoordsForCameraUpdate,
  UpdateObjectEventCurrentMovement, UpdateObjectEventElevationAndPriority, UpdateObjectEventOffscreen, UpdateObjectEventSpriteAnimPause,
  UpdateObjectEventSpriteInvisibility, UpdateObjectEventSpriteVisibility, UpdateObjectEventVisibility, UpdateRevealDisguise,
  UpdateWalkSlow, UpdateWalkSlowAnim, VarGetObjectEventGraphicsId, VirtualObject_UpdateAnim,
  WaitForMovementDelay, _PatchObjectPalette,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
