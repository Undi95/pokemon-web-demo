...
const {
  ...
  InTrainerHill, IndexOfSpritePaletteTag, InitSpriteAffineAnim, LoadPalette,
  LoadSpritePalette, LoadWordFromTwoHalfwords, MAP_GROUP, MAP_NUM,
  MapGridGetCollisionAt, MapGridGetElevationAt, MapGridGetMetatileBehaviorAt, MetatileBehavior_HasRipples,
  MetatileBehavior_IsDeepSand, MetatileBehavior_IsFootprints, MetatileBehavior_IsHotSprings, MetatileBehavior_IsIce,
  MetatileBehavior_IsJumpEast, MetatileBehavior_IsJumpNorth, MetatileBehavior_IsJumpSouth, MetatileBehavior_IsJumpWest,
  MetatileBehavior_IsLongGrass, MetatileBehavior_IsPacifidlogLog, MetatileBehavior_IsPuddle, MetatileBehavior_IsReflective,
  MetatileBehavior_IsSandOrDeepSand, MetatileBehavior_IsSeaweed, MetatileBehavior_IsShallowFlowingWater, MetatileBehavior_IsShortGrass,
  MetatileBehavior_IsTallGrass, NULL, OBJ_PLTT_ID, ObjectEventIsFarawayIslandMew,
  ...
  TRUE, TestPlayerAvatarFlags, UpdateRevealDisguise, VarGetObjectEventGraphicsId,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
