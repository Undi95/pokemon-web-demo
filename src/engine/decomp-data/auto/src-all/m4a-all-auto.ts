...
export function MidiKeyToFreq(...args: any[]): any {
  let val1: any = null;
      let val2: any = null;
...
export function MPlayContinue(...args: any[]): any {
...
export function MPlayFadeOut(...args: any[]): any {
  if (mplayInfo.ident == ID_NUMBER)
      {
          mplayInfo.ident++;
...
export function m4aSoundInit(): any {
  let i: any = null;
      ...
      CpuCopy32((void *)(SoundMainRAM & ~1), SoundMainRAM_Buffer, sizeof(SoundMainRAM_Buffer));
...
export function m4aSongNumStart(...args: any[]): any {
...
export function m4aSongNumStartOrChange(...args: any[]): any {
  let mplayTable: any = gMPlayTable;
      let songTable: any = gSongTable;
      let song: any = songTable[n];
      let mplay: any = mplayTable[song.ms];
...
export function m4aSongNumStop(...args: any[]): any {
  let mplayTable: any = gMPlayTable;
      let songTable: any = gSongTable;
      let song: any = songTable[n];
      let mplay: any = mplayTable[song.ms];
...
export function m4aMPlayContinue(...args: any[]): any {
...
export function m4aMPlayFadeOut(...args: any[]): any {
  MPlayFadeOut(mplayInfo, speed);
}

/** void m4aMPlayFadeOutTemporarily(struct MusicPlayerInfo *mplayInfo, u16 speed) */
export function m4aMPlayFadeOutTemporarily(...args: any[]): any {
  if (mplayInfo.ident == ID_NUMBER)
      {
          mplayInfo.ident++;
          mplayInfo.fadeOC = speed;
...
export function m4aMPlayFadeIn(...args: any[]): any {
  if (mplayInfo.ident == ID_NUMBER)
      {
          mplayInfo.ident++;
          mplayInfo.fadeOC = speed;
...
export function m4aMPlayImmInit(...args: any[]): any {
...
export function MPlayExtender(...args: any[]): any {
...
export function ClearChain(...args: any[]): any {
...
export function Clear64byte(...args: any[]): any {
...
export function SoundInit(...args: any[]): any {
  soundInfo.ident = 0;
...
export function SampleFreqSet(...args: any[]): any {
...
export function m4aSoundMode(...args: any[]): any {
  let soundInfo: any = SOUND_INFO_PTR;
      let temp: any = null;
...
export function SoundClear(): any {
  let soundInfo: any = SOUND_INFO_PTR;
      ...
      while (i > 0)
      {
          (chan).statusFlags = 0;
          i--;
          chan = (void *)(chan + sizeof(struct SoundChannel));
      }
      ...
      if (chan)
      {
          ...
          while (i <= 4)
          {
              ...
              (chan).statusFlags = 0;
              i++;
              chan = (void *)(chan + sizeof(struct CgbChannel));
          }
      }
...
export function MPlayOpen(...args: any[]): any {
  let soundInfo: any = null;
...
export function MPlayStart(...args: any[]): any {
  let i: any = null;
      let unk_B: any = null;
      let track: any = null;
...
export function m4aMPlayStop(...args: any[]): any {
  let i: any = null;
      let track: any = null;
...
export function FadeOutBody(...args: any[]): any {
  let i: any = null;
      let track: any = null;
      let fadeOV: any = null;
...
export function TrkVolPitSet(...args: any[]): any {
  if (track.flags & MPT_FLG_VOLSET)
      ...
      {
          let bend = track.bend * track.bendRange;
          let x = (track.tune + bend)
                * 4
                + (track.keyShift << 8)
                + (track.keyShiftX << 8)
                + track.pitX;
...
export function MidiKeyToCgbFreq(...args: any[]): any {
  if (chanNum == 4)
      {
          if (key <= 20)
          {
...
export function CgbOscOff(...args: any[]): any {
  switch (chanNum)
      {
      case 1:
          REG_NR12 = 8;
...
export function CgbPan(...args: any[]): any {
...
export function CgbModVol(...args: any[]): any {
  let soundInfo: any = SOUND_INFO_PTR;
  ...
  let ch: any = null;
      ...
      envelope_complete:
          ...
          if (channels.modify & CGB_CHANNEL_MO_PIT)
          {
              ...
              {
                  let dac_pwm_rate = REG_SOUNDBIAS_H;
...
export function m4aMPlayTempoControl(...args: any[]): any {
  if (mplayInfo.ident == ID_NUMBER)
      {
          mplayInfo.ident++;
...
export function m4aMPlayVolumeControl(...args: any[]): any {
  let i: any = null;
      let bit: any = null;
      let track: any = null;
...
export function m4aMPlayPitchControl(...args: any[]): any {
  let i: any = null;
      let bit: any = null;
      let track: any = null;
...
export function m4aMPlayPanpotControl(...args: any[]): any {
  let i: any = null;
      let bit: any = null;
      let track: any = null;
...
export function ClearModM(...args: any[]): any {
  track.lfoSpeedC = 0;
      track.modM = 0;
...
export function m4aMPlayModDepthSet(...args: any[]): any {
  let i: any = null;
      let bit: any = null;
      let track: any = null;
...
export function m4aMPlayLFOSpeedSet(...args: any[]): any {
  let i: any = null;
      let bit: any = null;
      let track: any = null;
...
export function ply_memacc(...args: any[]): any {
  let op: any = null;
      let addr: any = null;
      let data: any = null;
...
export function ply_xcmd(...args: any[]): any {
  let n = *track.cmdPtr;
      track.cmdPtr++;
...
export function ply_xxx(...args: any[]): any {
  gMPlayJumpTable[0](mplayInfo, track);
}

/** void ply_xwave(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xwave(...args: any[]): any {
  let wav: any = null;
      wav = 0;
...
export function ply_xtype(...args: any[]): any {
  track.tone.type = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xatta(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xatta(...args: any[]): any {
  track.tone.attack = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xdeca(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xdeca(...args: any[]): any {
  track.tone.decay = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xsust(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xsust(...args: any[]): any {
  track.tone.sustain = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xrele(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xrele(...args: any[]): any {
  track.tone.release = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xiecv(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xiecv(...args: any[]): any {
  track.pseudoEchoVolume = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xiecl(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xiecl(...args: any[]): any {
  track.pseudoEchoLength = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xleng(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xleng(...args: any[]): any {
  track.tone.length = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xswee(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xswee(...args: any[]): any {
  track.tone.pan_sweep = *track.cmdPtr;
      track.cmdPtr++;
}

/** void ply_xwait(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *track) */
export function ply_xwait(...args: any[]): any {
  let len: any = null;
      len = 0;
...
export function ply_xcmd_0D(...args: any[]): any {
  let unk: any = null;
      unk = 0;
...
export function SetPokemonCryVolume(...args: any[]): any {
  gPokemonCrySong.volumeValue = val & 0x7F;
}

/** void SetPokemonCryPanpot(s8 val) */
export function SetPokemonCryPanpot(...args: any[]): any {
  gPokemonCrySong.panValue = (val + C_V) & 0x7F;
}

/** void SetPokemonCryPitch(s16 val) */
export function SetPokemonCryPitch(...args: any[]): any {
  let b = val + 0x80;
      let a = gPokemonCrySong.tuneValue2 - gPokemonCrySong.tuneValue;
...
export function SetPokemonCryLength(...args: any[]): any {
  gPokemonCrySong.length = val;
}

/** void SetPokemonCryRelease(u8 val) */
export function SetPokemonCryRelease(...args: any[]): any {
  gPokemonCrySong.releaseValue = val;
}

/** void SetPokemonCryProgress(u32 val) */
export function SetPokemonCryProgress(...args: any[]): any {
  gPokemonCrySong.unkCmd0DParam = val;
}

/** bool32 IsPokemonCryPlaying(struct MusicPlayerInfo *mplayInfo) */
export function IsPokemonCryPlaying(...args: any[]): any {
  let track: any = mplayInfo.tracks;
...
export function SetPokemonCryChorus(...args: any[]): any {
  if (val)
      {
...
export function SetPokemonCryStereo(...args: any[]): any {
  let soundInfo: any = SOUND_INFO_PTR;
...
export function SetPokemonCryPriority(...args: any[]): any {
