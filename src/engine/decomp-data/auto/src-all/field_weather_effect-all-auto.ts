...
export function UpdateCloudSprite(...args: any[]): any {
...
export function UpdateDroughtBlend(...args: any[]): any {
...
export function StartRainSpriteFall(...args: any[]): any {
  let rand: any = null;
...
export function UpdateRainSprite(...args: any[]): any {
  if (sprite.tState == 0)
      {
...
export function WaitRainSprite(...args: any[]): any {
  if (sprite.tCounter == 0)
      {
          StartRainSpriteFall(sprite);
...
export function InitRainSpriteMovement(...args: any[]): any {
  let numFallingFrames = sRainSpriteFallingDurations[gWeatherPtr.isDownpour][0];
      let numAdvanceRng = val / (sRainSpriteFallingDurations[gWeatherPtr.isDownpour][1] + numFallingFrames);
...
export function CreateSnowflakeSprite(): any {
  let spriteId = CreateSpriteAtEnd(sSnowflakeSpriteTemplate, 0, 0, 78);
      if (spriteId == MAX_SPRITES)
          return FALSE;
...
export function InitSnowflakeSpriteMovement(...args: any[]): any {
  let rand: any = null;
      let x = ((sprite.tSnowflakeId * 5) & 7) * 30 + (Random() % 30);
...
export function WaitSnowflakeSprite(...args: any[]): any {
...
export function UpdateSnowflakeSprite(...args: any[]): any {
  let x: any = null;
      let y: any = null;
...
export function EnqueueThunder(...args: any[]): any {
...
export function FogHorizontalSpriteCallback(...args: any[]): any {
...
export function CreateFogHorizontalSprites(): any {
  let i: any = null;
      ...
      {
          let fogHorizontalSpriteSheet: any = [
...
export function UpdateAshSprite(...args: any[]): any {
...
export function UpdateFogDiagonalSprite(...args: any[]): any {
...
export function UpdateSandstormSprite(...args: any[]): any {
...
export function WaitSandSwirlSpriteEntrance(...args: any[]): any {
...
export function UpdateSandstormSwirlSprite(...args: any[]): any {
  let x, y;
...
export function CreateBubbleSprite(...args: any[]): any {
  let x = sBubbleStartCoords[coordsIndex][0];
      let y = sBubbleStartCoords[coordsIndex][1] - gSpriteCoordOffsetY;
      let spriteId = CreateSpriteAtEnd(sBubbleSpriteTemplate, x, y, 0);
      if (spriteId != MAX_SPRITES)
      {
...
export function UpdateBubbleSprite(...args: any[]): any {
...
export function Task_DoAbnormalWeather(...args: any[]): any {
...
export function CreateAbnormalWeatherTask(): any {
  let taskId = CreateTask(Task_DoAbnormalWeather, 0);
      let data = gTasks[taskId].data;
...
export function SetSavedWeather(...args: any[]): any {
  let oldWeather = gSaveBlock1Ptr.weather;
...
export function SetWeather(...args: any[]): any {
  SetSavedWeather(weather);
      SetNextWeather(GetSavedWeather());
}

/** void SetWeather_Unused(u32 weather) */
export function SetWeather_Unused(...args: any[]): any {
  SetSavedWeather(weather);
...
export function TranslateWeatherNum(...args: any[]): any {
  switch (weather)
      {
...
export function UpdateWeatherPerDay(...args: any[]): any {
...
export function UpdateRainCounter(...args: any[]): any {
