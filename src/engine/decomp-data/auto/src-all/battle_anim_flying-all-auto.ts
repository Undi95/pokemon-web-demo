...
export function AnimEllipticalGust_Step(sprite: any): any {
...
export function AnimTask_AnimateGustTornadoPalette_Step(taskId: any): any {
  let data2: any = null;
      let temp: any = null;
      let i, base;
...
export function AnimGustToTarget_Step(sprite: any): any {
...
export function AnimFlyBallUp(sprite: any): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
...
export function AnimFlyBallUp_Step(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
      }
...
export function AnimFlyBallAttack_Step(sprite: any): any {
  sprite.data[0] = 1;
...
export function DestroyAnimSpriteAfterTimer(sprite: any): any {
  if (sprite.data[0]-- <= 0)
      {
...
export function AnimFallingFeather(sprite: any): any {
  let battler, matrixNum, sinIndex;
      ...
      MEM_WRITE(data.unkC, gBattleAnimArgs[5]);
...
export function AnimFallingFeather_Step(sprite: any): any {
...
export function AnimUnusedBubbleThrow(sprite: any): any {
...
export function AnimWhirlwindLine(sprite: any): any {
  let offset: any = null;
      let mult: any = null;
...
export function AnimWhirlwindLine_Step(sprite: any): any {
...
export function AnimTask_DrillPeckHitSplats(task: any): any {
...
export function AnimBounceBallShrink(sprite: any): any {
...
export function AnimBounceBallLand(sprite: any): any {
  switch (sprite.data[0])
      {
      case 0:
...
export function AnimDiveBall(sprite: any): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
      sprite.data[0] = gBattleAnimArgs[2];
      sprite.data[1] = gBattleAnimArgs[3];
...
export function AnimDiveBall_Step1(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
      }
...
export function AnimDiveBall_Step2(sprite: any): any {
  sprite.y2 += sprite.data[2] >> 8;
...
export function AnimDiveWaterSplash(sprite: any): any {
...
export function AnimSprayWaterDroplet(sprite: any): any {
  let v1: any = 0x1ff & Random2();
      let v2: any = 0x7f & Random2();
...
export function AnimSprayWaterDroplet_Step(sprite: any): any {
  if (sprite.data[2] == 0)
      {
...
export function AnimUnusedFlashingLight(sprite: any): any {
  sprite.data[6] = 0;
      sprite.data[7] = 64;
...
export function AnimUnusedFlashingLight_Step(sprite: any): any {
  switch (sprite.data[0])
      {
      case 0:
          if (++sprite.data[1] > 8)
...
export function AnimSkyAttackBird(sprite: any): any {
  let rotation: any = null;
      let posx: any = sprite.x;
      let posy: any = sprite.y;
...
export function AnimSkyAttackBird_Step(sprite: any): any {
