...
export function PokenavCallback_Init_MonRibbonList(): any {
  let list: any = AllocSubstruct(POKENAV_SUBSTRUCT_RIBBONS_MON_LIST, sizeof(struct Pokenav_RibbonsMonList));
      if (list == NULL)
          return FALSE;
...
export function HandleRibbonsMonListInput_WaitListInit(...args: any[]): any {
...
export function HandleRibbonsMonListInput(...args: any[]): any {
...
export function RibbonsMonMenu_ReturnToMainMenu(...args: any[]): any {
  return POKENAV_MAIN_MENU_CURSOR_ON_RIBBONS;
}

/** static u32 RibbonsMonMenu_ToSummaryScreen(struct Pokenav_RibbonsMonList *list) */
export function RibbonsMonMenu_ToSummaryScreen(...args: any[]): any {
...
export function GetMonRibbonListLoopTaskFunc(...args: any[]): any {
  return sMonRibbonListLoopTaskFuncs[state](state);
}

/** static u32 BuildPartyMonRibbonList(s32 state) */
export function BuildPartyMonRibbonList(...args: any[]): any {
  let i: any = null;
      let item: any = null;
      let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_LIST);
...
export function InitBoxMonRibbonList(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_LIST);
      list.monId = 0;
      list.boxId = 0;
      return LT_INC_AND_CONTINUE;
...
export function BuildBoxMonRibbonList(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_LIST);
...
export function OpenRibbonsMonList(): any {
  let menu: any = AllocSubstruct(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU, sizeof(struct Pokenav_RibbonsMonMenu));
      if (menu == NULL)
          return FALSE;
...
export function CreateRibbonsMonListLoopedTask(...args: any[]): any {
...
export function LoopedTask_OpenRibbonsMonList(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU);
      switch (state)
      {
      case 0:
...
export function LoopedTask_RibbonsListMoveCursorUp(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU);
      switch (state)
      {
      case 0:
...
export function LoopedTask_RibbonsListMoveCursorDown(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU);
      switch (state)
      {
      case 0:
...
export function LoopedTask_RibbonsListMovePageUp(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU);
      switch (state)
      {
      case 0:
...
export function LoopedTask_RibbonsListMovePageDown(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_RIBBONS_MON_MENU);
      switch (state)
      {
      case 0:
...
export function LoopedTask_RibbonsListReturnToMainMenu(...args: any[]): any {
  switch (state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function LoopedTask_RibbonsListOpenSummary(...args: any[]): any {
  switch (state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function AddRibbonsMonListWindow(...args: any[]): any {
...
export function UpdateIndexNumberDisplay(...args: any[]): any {
...
export function DrawListIndexNumber(...args: any[]): any {
  const strbuf: any[] = [];
      let x: any = null;
...
export function BufferRibbonMonInfoText(...args: any[]): any {
  let gender: any = null;
      let level: any = null;
      let s: any = null;
