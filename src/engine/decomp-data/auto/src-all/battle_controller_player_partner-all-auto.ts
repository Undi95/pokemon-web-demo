...
export function Task_GiveExpToMon(...args: any[]): any {
  let monId = (u8)(gTasks[taskId].tExpTask_monId);
      let battler = gTasks[taskId].tExpTask_bank;
...
export function CopyPlayerPartnerMonData(...args: any[]): any {
...
export function SetPlayerPartnerMonData(...args: any[]): any {
...
export function PlayerPartnerHandleChoosePokemon(): any {
  let chosenMonId = GetMostSuitableMonToSwitchInto();

      if (chosenMonId == PARTY_SIZE)  
      {
          let playerMonIdentity = GetBattlerAtPosition(B_POSITION_PLAYER_LEFT);
          let selfIdentity = GetBattlerAtPosition(B_POSITION_PLAYER_RIGHT);
