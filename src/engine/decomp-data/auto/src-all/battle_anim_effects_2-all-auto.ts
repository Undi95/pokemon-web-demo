...
export function AnimCirclingFinger(...args: any[]): any {
...
export function AnimBouncingMusicNote(...args: any[]): any {
...
export function AnimBouncingMusicNote_Step(...args: any[]): any {
...
export function AnimVibrateBattlerBack_Step(...args: any[]): any {
  let temp: any = null;
...
export function AnimVibrateBattlerBack(...args: any[]): any {
...
export function AnimMovingClamp(...args: any[]): any {
...
export function AnimMovingClamp_Step(...args: any[]): any {
...
export function AnimMovingClamp_End(...args: any[]): any {
  if (sprite.data[5] == 0)
          DestroyAnimSprite(sprite);
      else
          sprite.data[5]--;
...
export function AnimTask_Withdraw(...args: any[]): any {
...
export function AnimTask_Withdraw_Step(...args: any[]): any {
  let spriteId = gBattlerSpriteIds[gBattleAnimAttacker];
...
export function AnimKinesisZapEnergy(...args: any[]): any {
  SetSpriteCoordsToAnimAttackerCoords(sprite);
      if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
          sprite.x -= gBattleAnimArgs[0];
      else
...
export function AnimSwordsDanceBlade(...args: any[]): any {
...
export function AnimSwordsDanceBlade_Step(...args: any[]): any {
  sprite.data[0] = 6;
      sprite.data[2] = sprite.x;
...
export function AnimSonicBoomProjectile(...args: any[]): any {
...
export function AnimAirWaveProjectile_Step2(...args: any[]): any {
  if (sprite.data[0]-- <= 0)
      {
...
export function AnimAirWaveProjectile_Step1(...args: any[]): any {
  let task: any = gTasks[sprite.data[7]];
      ...
      if (1 & task.data[8])
          sprite.y2 = (sprite.data[2] / 256u) * -1;
      else
          sprite.y2 = sprite.data[2] / 256u;
...
export function AnimAirWaveProjectile(...args: any[]): any {
  let a: any = null;
      let b: any = null;
      let c: any = null;
...
export function AirCutterProjectileStep2(...args: any[]): any {
  if (gTasks[taskId].data[1] == 0)
          DestroyAnimVisualTask(taskId);
}

/** static void AirCutterProjectileStep1(u8 taskId) */
export function AirCutterProjectileStep1(...args: any[]): any {
...
export function AnimTask_AirCutterProjectile(...args: any[]): any {
  let attackerY = 0;
      let attackerX = 0;
      let targetX = 0;
      let targetY = 0;
      ...
      if (gBattleAnimArgs[4] & 0x80)
      {
          ...
          {
              let var = GetBattlerSpriteSubpriority(gBattleAnimTarget) + (gBattleAnimArgs[4] - 64);
              gTasks[taskId].data[2] = var;
          }
          else
          {
              let var = GetBattlerSpriteSubpriority(gBattleAnimTarget) - gBattleAnimArgs[4];
              gTasks[taskId].data[2] = var;
          }
      }
      else
...
export function AnimVoidLines(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, FALSE);
...
export function AnimVoidLines_Step(...args: any[]): any {
  let id, val;
      let i: any = null;
...
export function AnimCoinThrow(...args: any[]): any {
  let r6: any = null;
      let r7: any = null;
      let var: any = null;
...
export function AnimFallingCoin(...args: any[]): any {
  sprite.data[2] = -16;
      sprite.y += 8;
...
export function AnimFallingCoin_Step(...args: any[]): any {
  sprite.data[0] += 0x80;
...
export function AnimBulletSeed(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
      sprite.data[0] = 20;
...
export function AnimBulletSeed_Step1(...args: any[]): any {
  let i: any = null;
      let rand: any = null;
      let ptr: any = null;
...
export function AnimBulletSeed_Step2(...args: any[]): any {
...
export function AnimRazorWindTornado(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, FALSE);
      if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
          sprite.y += 16;
...
export function AnimViceGripPincer(...args: any[]): any {
  let startXOffset = 32;
      let startYOffset = -32;
      let endXOffset = 16;
      let endYOffset = -16;
...
export function AnimViceGripPincer_Step(...args: any[]): any {
  if (sprite.animEnded)
          DestroyAnimSprite(sprite);
}

/** static void AnimGuillotinePincer(struct Sprite *sprite) */
export function AnimGuillotinePincer(...args: any[]): any {
  let startXOffset = 32;
      let startYOffset = -32;
      let endXOffset = 16;
      let endYOffset = -16;
...
export function AnimGuillotinePincer_Step1(...args: any[]): any {
...
export function AnimGuillotinePincer_Step2(...args: any[]): any {
  if (sprite.data[3])
      {
          sprite.x2 = -sprite.x2;
          sprite.y2 = -sprite.y2;
...
export function AnimGuillotinePincer_Step3(...args: any[]): any {
  if (AnimTranslateLinear(sprite))
          DestroyAnimSprite(sprite);
}

/** void AnimTask_GrowAndGrayscale(u8 taskId) */
export function AnimTask_GrowAndGrayscale(...args: any[]): any {
...
export function AnimTask_GrowAndGrayscale_Step(...args: any[]): any {
...
export function AnimTask_Minimize(...args: any[]): any {
...
export function AnimTask_Minimize_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.data[1])
      {
      case 0:
...
export function CreateMinimizeSprite(...args: any[]): any {
  let matrixNum: any = null;
      let spriteId = CloneBattlerSpriteWithBlend(ANIM_ATTACKER);
      if (spriteId >= 0)
      {
...
export function ClonedMinizeSprite_Step(...args: any[]): any {
  if (--sprite.data[0] == 0)
      {
...
export function AnimTask_Splash(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_Splash_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.data[1])
      {
      case 0:
...
export function AnimTask_GrowAndShrink(...args: any[]): any {
  let task: any = gTasks[taskId];
      let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
...
export function AnimTask_GrowAndShrink_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      if (!RunAffineAnimFromTaskData(task))
          DestroyAnimVisualTask(taskId);
}
...
export function AnimBreathPuff(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
      {
...
export function AnimAngerMark(...args: any[]): any {
  let battler: any = null;
      if (!gBattleAnimArgs[0])
          battler = gBattleAnimAttacker;
      else
...
export function AnimTask_ThrashMoveMonHorizontal(...args: any[]): any {
  let task: any = gTasks[taskId];
      let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
      task.data[0] = spriteId;
      task.data[1] = 0;
...
export function AnimTask_ThrashMoveMonHorizontal_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      if (!RunAffineAnimFromTaskData(task))
          DestroyAnimVisualTask(taskId);
}
...
export function AnimTask_ThrashMoveMonVertical(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_ThrashMoveMonVertical_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      if (++task.data[7] > 2)
      {
          task.data[7] = 0;
...
export function AnimTask_SketchDrawMon(...args: any[]): any {
  let task: any = gTasks[taskId];
      let params: any = null;
...
export function AnimTask_SketchDrawMon_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimPencil(...args: any[]): any {
...
export function AnimPencil_Step(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
          if (++sprite.data[2] > 1)
...
export function AnimBlendThinRing(...args: any[]): any {
  let battler = 0;
      let x = 0;
      let y = 0;
      let r4: any = null;
...
export function AnimHyperVoiceRing_WaitEnd(...args: any[]): any {
  if (AnimTranslateLinear(sprite))
      {
...
export function AnimHyperVoiceRing(...args: any[]): any {
  let startX = 0;
      let startY = 0;
      let x = 0;
      let y = 0;
...
export function AnimUproarRing(...args: any[]): any {
...
export function AnimSoftBoiledEgg(...args: any[]): any {
  let r1: any = null;
      InitSpritePosToAnimAttacker(sprite, FALSE);
...
export function AnimSoftBoiledEgg_Step1(...args: any[]): any {
  let add: any = null;
...
export function AnimSoftBoiledEgg_Step2(...args: any[]): any {
  if (sprite.data[0]++ > 19)
      {
...
export function AnimSoftBoiledEgg_Step3(...args: any[]): any {
...
export function AnimSoftBoiledEgg_Step3_Callback1(...args: any[]): any {
  sprite.y2 -= 2;
      if (++sprite.data[0] == 9)
      {
          sprite.data[0] = 16;
...
export function AnimSoftBoiledEgg_Step3_Callback2(...args: any[]): any {
...
export function AnimSoftBoiledEgg_Step4(...args: any[]): any {
...
export function AnimSoftBoiledEgg_Step4_Callback(...args: any[]): any {
...
export function AnimTask_AttackerStretchAndDisappear(...args: any[]): any {
  let task: any = gTasks[taskId];
      let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
      task.data[0] = spriteId;
...
export function AnimTask_AttackerStretchAndDisappear_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      if (!RunAffineAnimFromTaskData(task))
      {
          gSprites[task.data[0]].y2 = 0;
...
export function AnimTask_ExtremeSpeedImpact(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[0] = 0;
      task.data[1] = 0;
      task.data[2] = 0;
...
export function AnimTask_ExtremeSpeedImpact_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_ExtremeSpeedMonReappear(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[0] = 0;
      task.data[1] = 0;
      task.data[2] = 0;
...
export function AnimTask_ExtremeSpeedMonReappear_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_SpeedDust(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[0] = 0;
      task.data[1] = 4;
      task.data[2] = 0;
...
export function AnimTask_SpeedDust_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.data[8])
      {
      case 0:
...
export function AnimSpeedDust(...args: any[]): any {
...
export function AnimTask_LoadMusicNotesPals(...args: any[]): any {
  let i: any = null;
...
export function AnimTask_FreeMusicNotesPals(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < NUM_MUSIC_NOTE_PAL_TAGS; i++)
...
export function SetMusicNotePalette(...args: any[]): any {
  let tile = (b & 1) ? 32 : 0;
...
export function AnimHealBellMusicNote(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, FALSE);
      if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
          gBattleAnimArgs[2] = -gBattleAnimArgs[2];
...
export function AnimMagentaHeart(...args: any[]): any {
  if (++sprite.data[0] == 1)
          InitSpritePosToAnimAttacker(sprite, FALSE);
...
export function AnimTask_FakeOut(...args: any[]): any {
  let win0h = IsContest() ? 152 : DISPLAY_WIDTH;
      let win0v = 0;
...
export function AnimTask_FakeOut_Step1(...args: any[]): any {
...
export function AnimTask_FakeOut_Step2(...args: any[]): any {
...
export function AnimTask_StretchTargetUp(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(ANIM_TARGET);
      if (++gTasks[taskId].data[0] == 1)
      {
...
export function AnimTask_StretchAttackerUp(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
      if (++gTasks[taskId].data[0] == 1)
      {
...
export function AnimRedHeartProjectile(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
      sprite.data[0] = 95;
      sprite.data[1] = sprite.x;
      sprite.data[2] = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2);
...
export function AnimRedHeartProjectile_Step(...args: any[]): any {
  if (!AnimTranslateLinear(sprite))
      {
...
export function AnimParticleBurst(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
...
export function AnimRedHeartRising(...args: any[]): any {
  sprite.x = gBattleAnimArgs[0];
...
export function AnimRedHeartRising_Step(...args: any[]): any {
  let y: any = null;
...
export function AnimTask_HeartsBackground(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_HeartsBackground_Step(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_ScaryFace(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_ScaryFace_Step(...args: any[]): any {
  let animBg: any = null;
...
export function AnimOrbitFast(...args: any[]): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
      sprite.affineAnimPaused = 1;
      sprite.data[0] = gBattleAnimArgs[0];
...
export function AnimOrbitFast_Step(...args: any[]): any {
...
export function AnimOrbitScatter(...args: any[]): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimOrbitScatter_Step(...args: any[]): any {
...
export function AnimSpitUpOrb_Step(...args: any[]): any {
  sprite.x2 += sprite.data[0];
      sprite.y2 += sprite.data[1];
...
export function AnimSpitUpOrb(...args: any[]): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
      sprite.data[0] = Sin(gBattleAnimArgs[0], 10);
      sprite.data[1] = Cos(gBattleAnimArgs[0], 7);
...
export function AnimEyeSparkle_Step(...args: any[]): any {
  if (sprite.animEnded)
          DestroyAnimSprite(sprite);
}

/** static void AnimEyeSparkle(struct Sprite *sprite) */
export function AnimEyeSparkle(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
      sprite.callback = AnimEyeSparkle_Step;
}

/** static void AnimAngel(struct Sprite *sprite) */
export function AnimAngel(...args: any[]): any {
  let var0: any = null;
      if (!sprite.data[0])
      {
          sprite.x += gBattleAnimArgs[0];
...
export function AnimPinkHeart_Step(...args: any[]): any {
  sprite.data[5]++;
...
export function AnimPinkHeart(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          sprite.data[1] = gBattleAnimArgs[0];
          sprite.data[2] = gBattleAnimArgs[1];
...
export function AnimDevil(...args: any[]): any {
  if (sprite.data[3] == 0)
      {
          sprite.x += gBattleAnimArgs[0];
          sprite.y += gBattleAnimArgs[1];
...
export function AnimFurySwipes(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          sprite.x += gBattleAnimArgs[0];
          sprite.y += gBattleAnimArgs[1];
...
export function AnimMovementWaves(...args: any[]): any {
  if (!gBattleAnimArgs[2])
      {
          DestroyAnimSprite(sprite);
      }
...
export function AnimMovementWaves_Step(...args: any[]): any {
  if (sprite.animEnded)
      {
          if (--sprite.data[0])
              StartSpriteAnim(sprite, sprite.data[1]);
...
export function AnimTask_UproarDistortion(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[0]);
...
export function AnimTask_UproarDistortion_Step(...args: any[]): any {
  if (!RunAffineAnimFromTaskData(gTasks[taskId]))
          DestroyAnimVisualTask(taskId);
}

/** static void AnimJaggedMusicNote(struct Sprite *sprite) */
export function AnimJaggedMusicNote(...args: any[]): any {
  let battler = !gBattleAnimArgs[0] ? gBattleAnimAttacker : gBattleAnimTarget;
...
export function AnimJaggedMusicNote_Step(...args: any[]): any {
...
export function AnimPerishSongMusicNote2(...args: any[]): any {
  if (!sprite.data[0])
      {
...
export function AnimPerishSongMusicNote(...args: any[]): any {
  let index: any = null;
      let var2: any = null;
...
export function AnimPerishSongMusicNote_Step1(...args: any[]): any {
  if (++sprite.data[0] > 10)
      {
          sprite.data[0] = 0;
...
export function AnimPerishSongMusicNote_Step2(...args: any[]): any {
...
export function AnimGuardRing(...args: any[]): any {
...
export function AnimTask_IsFuryCutterHitRight(...args: any[]): any {
  gBattleAnimArgs[ARG_RET_ID] = gAnimDisableStructPtr.furyCutterCounter & 1;
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_GetFuryCutterHitCount(u8 taskId) */
export function AnimTask_GetFuryCutterHitCount(...args: any[]): any {
