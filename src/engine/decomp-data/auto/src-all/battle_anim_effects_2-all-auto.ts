...
const {
  ...
  DestroySpriteWithActiveSheet, FALSE, FREE_AND_SET_NULL, FreeOamMatrix,
  FreeSpriteOamMatrix, FreeSpritePaletteByTag, GET_BATTLER_SIDE2, GetAnimBattlerSpriteId,
  ...
  IndexOfSpritePaletteTag, InitAnimLinearTranslation, InitSpritePosToAnimAttacker, IsBattlerSpriteVisible,
  IsContest, IsDoubleBattle, LZDecompressWram, LoadCompressedPalette,
  LoadPalette, MathUtil_Inv16, MathUtil_Mul16, OBJ_PLTT_ID,
  PLTT_SIZE_4BPP, PlaySE12WithPanning, PrepareAffineAnimInTaskData, PrepareBattlerSpriteForRotScale,
  Q_8_8, REG_OFFSET_BG1HOFS, REG_OFFSET_BG1VOFS, REG_OFFSET_BLDALPHA,
  REG_OFFSET_BLDCNT, REG_OFFSET_BLDY, REG_OFFSET_WIN0H, REG_OFFSET_WIN0V,
  REG_OFFSET_WININ, REG_OFFSET_WINOUT, Random2, ResetSpriteRotScale,
  RunAffineAnimFromTaskData, ST_OAM_AFFINE_DOUBLE, ST_OAM_AFFINE_NORMAL, ST_OAM_OBJ_BLEND,
  ST_OAM_OBJ_NORMAL, ScanlineEffect_SetParams, SeekSpriteAnim, SetAnimBgAttribute,
  ...
  SetGpuReg, SetGrayscaleOrOriginalPalette, SetSpriteCoordsToAnimAttackerCoords, SetSpriteNextToMonHead,
  SetSpritePrimaryCoordsFromSecondaryCoords, SetSpriteRotScale, Sin, StartSpriteAffineAnim,
  StartSpriteAnim, StoreSpriteCallbackInData6, TRUE, TrySetSpriteRotScale,
