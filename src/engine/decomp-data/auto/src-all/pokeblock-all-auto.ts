...
export function OpenPokeblockCase(...args: any[]): any {
...
export function PrintOnPokeblockWindow(...args: any[]): any {
...
export function DrawPokeblockMenuTitleText(): any {
  let i: any = null;
      ...
      let itemName = GetItemName(ITEM_POKEBLOCK_CASE);
...
export function PutPokeblockListMenuString(...args: any[]): any {
  let pkblock: any = gSaveBlock1Ptr.pokeblocks[pkblId];
      let txtPtr = StringCopy(dst, gPokeblockNames[pkblock.color]);
...
export function MovePokeblockMenuCursor(...args: any[]): any {
  if (onInit != TRUE)
      {
          PlaySE(SE_SELECT);
...
export function DrawPokeblockInfo(...args: any[]): any {
  let i: any = null;
...
export function DrawPokeblockMenuHighlight(...args: any[]): any {
...
export function SwapPokeblockMenuItems(...args: any[]): any {
  let i, count;
...
export function CreatePokeblockCaseSprite(...args: any[]): any {
...
export function SpriteCB_ShakePokeblockCase(...args: any[]): any {
  if (sprite.sState > 1)
          sprite.sState = 0;
...
export function FadePaletteAndSetTaskToClosePokeblockCase(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_FreeDataAndExitPokeblockCase;
}

/** static void Task_FreeDataAndExitPokeblockCase(u8 taskId) */
export function Task_FreeDataAndExitPokeblockCase(...args: any[]): any {
...
export function Task_HandlePokeblockMenuInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandlePokeblocksSwapInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function UpdatePokeblockSwapMenu(...args: any[]): any {
  let i: any = null;
      let data = gTasks[taskId].data;
      let swappedFromId = sSavedPokeblockData.scrollOffset + sSavedPokeblockData.selectedRow;
...
export function ShowPokeblockActionsWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandlePokeblockActionsInput(...args: any[]): any {
  let itemId: any = null;
...
export function PokeblockAction_UseOnField(...args: any[]): any {
...
export function PokeblockAction_Toss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function CreateTossPokeblockYesNoMenu(...args: any[]): any {
...
export function TossedPokeblockMessage(...args: any[]): any {
...
export function TossPokeblock(...args: any[]): any {
...
export function CloseTossPokeblockWindow(...args: any[]): any {
...
export function PokeblockAction_UseInBattle(...args: any[]): any {
  let nature = GetNature(gEnemyParty[0]);
      let gain = PokeblockGetGain(nature, gSaveBlock1Ptr.pokeblocks[gSpecialVar_ItemId]);
...
export function PokeblockAction_UseOnPokeblockFeeder(...args: any[]): any {
...
export function PokeblockAction_GiveToContestLady(...args: any[]): any {
...
export function PokeblockAction_Cancel(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ClearPokeblock(...args: any[]): any {
...
export function GetHighestPokeblocksFlavorLevel(...args: any[]): any {
  let i: any = null;
      let maxFlavor = GetPokeblockData(pokeblock, PBLOCK_SPICY);

      for (i = PBLOCK_SPICY; i < FLAVOR_COUNT; i++)
      {
          let currFlavor = GetPokeblockData(pokeblock, PBLOCK_SPICY + i);
...
export function GetPokeblocksFeel(...args: any[]): any {
  let feel = GetPokeblockData(pokeblock, PBLOCK_FEEL);
...
export function AddPokeblock(...args: any[]): any {
  let slot = GetFirstFreePokeblockSlot();
...
export function TryClearPokeblock(...args: any[]): any {
...
export function GetPokeblockData(...args: any[]): any {
...
export function PokeblockGetGain(...args: any[]): any {
  let flavor: any = null;
...
export function PokeblockCopyName(...args: any[]): any {
  let color = GetPokeblockData(pokeblock, PBLOCK_COLOR);
      StringCopy(dest, gPokeblockNames[color]);
}

/** bool8 CopyMonFavoritePokeblockName(u8 nature, u8 *dest) */
export function CopyMonFavoritePokeblockName(...args: any[]): any {
  let i: any = null;
...
export function GetPokeblocksFlavor(...args: any[]): any {
  let bestFlavor = 0;
      let i: any = null;
