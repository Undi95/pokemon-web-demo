...
export function UpdateMirageTowerPulseBlend(...args: any[]): any {
...
export function PlayerDescendMirageTower(...args: any[]): any {
...
export function StartScreenShake(...args: any[]): any {
  let taskId = CreateTask(DoScreenShake, 9);
...
export function DoScreenShake(...args: any[]): any {
  let data: any = null;
...
export function IncrementCeilingCrumbleFinishedCount(): any {
  let taskId = FindTaskIdByFunc(WaitCeilingCrumble);
      if (taskId != TASK_NONE)
...
export function WaitCeilingCrumble(...args: any[]): any {
...
export function FinishCeilingCrumbleTask(...args: any[]): any {
...
export function SpriteCB_CeilingCrumble(...args: any[]): any {
  sprite.sYOffset += 2;
...
export function UpdateBgShake(...args: any[]): any {
...
export function InitMirageTowerShake(...args: any[]): any {
  let zero: any = null;
...
export function DoMirageTowerDisintegration(...args: any[]): any {
  let bgShakeTaskId, j;
      let i: any = null;
      let index: any = null;
...
export function Task_FossilFallAndSink(...args: any[]): any {
  let i: any = null;
      let buffer: any = null;
...
export function SpriteCB_FallingFossil(...args: any[]): any {
...
export function UpdateDisintegrationEffect(...args: any[]): any {
