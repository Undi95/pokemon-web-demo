...
const {
  Alloc, AssignSpriteAnimsTable, BlitBitmapRectToWindow, CpuCopy32,
  CreateMonPicSprite, CreatePicSprite, CreatePicSprite_HandleDeoxys, CreateSprite,
  CreateTrainerCardSprite, DecompressPic, DecompressPicFromTable, DecompressPic_HandleDeoxys,
  DestroySprite, Free, FreeAndDestroyPicSpriteInternal, FreeSpritePaletteByTag,
  ...
  LoadCompressedPalette, LoadCompressedSpritePalette, LoadPicPaletteBySlot, LoadPicPaletteByTagOrSlot,
  LoadSpecialPokePic, LoadSpecialPokePic_DontHandleDeoxys, OBJ_PLTT_ID, PLTT_ID,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
