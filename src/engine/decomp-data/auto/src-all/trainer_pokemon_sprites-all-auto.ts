...
export function DecompressPic(...args: any[]): any {
  if (!isTrainer)
      {
          let species = picId;
          if (isFrontPic)
...
export function DecompressPic_HandleDeoxys(...args: any[]): any {
...
export function LoadPicPaletteByTagOrSlot(...args: any[]): any {
  if (!isTrainer)
      {
...
export function LoadPicPaletteBySlot(...args: any[]): any {
  if (!isTrainer)
...
export function AssignSpriteAnimsTable(...args: any[]): any {
  if (!isTrainer)
...
export function CreatePicSprite(...args: any[]): any {
  let i: any = null;
...
export function CreatePicSprite_HandleDeoxys(...args: any[]): any {
...
export function CreateMonPicSprite_Affine(...args: any[]): any {
  let framePics: any = null;
      let images: any = null;
      let j: any = null;
      let i: any = null;
...
export function FreeAndDestroyPicSpriteInternal(...args: any[]): any {
  let i: any = null;
      let framePics: any = null;
      let images: any = null;
...
export function LoadPicSpriteInWindow(...args: any[]): any {
...
export function CreateTrainerCardSprite(...args: any[]): any {
  let framePics: any = null;
...
export function CreateMonPicSprite(...args: any[]): any {
...
export function CreateMonPicSprite_HandleDeoxys(...args: any[]): any {
  return CreateMonPicSprite(species, otId, personality, isFrontPic, x, y, paletteSlot, paletteTag, FALSE);
}

/** u16 FreeAndDestroyMonPicSprite(u16 spriteId) */
export function FreeAndDestroyMonPicSprite(...args: any[]): any {
...
export function CreateTrainerCardMonIconSprite(...args: any[]): any {
...
export function CreateTrainerPicSprite(...args: any[]): any {
  return CreatePicSprite_HandleDeoxys(species, 0, 0, isFrontPic, x, y, paletteSlot, paletteTag, TRUE);
}

/** u16 FreeAndDestroyTrainerPicSprite(u16 spriteId) */
export function FreeAndDestroyTrainerPicSprite(...args: any[]): any {
  return FreeAndDestroyPicSpriteInternal(spriteId);
}

/** u16 CreateTrainerCardTrainerPicSprite(u16 species, bool8 isFrontPic, u16 destX, u16 destY, u8 paletteSlot, u8 windowId) */
export function CreateTrainerCardTrainerPicSprite(...args: any[]): any {
  return CreateTrainerCardSprite(species, 0, 0, isFrontPic, destX, destY, paletteSlot, windowId, TRUE);
}

/** u16 PlayerGenderToFrontTrainerPicId_Debug(u8 gender, bool8 getClass) */
export function PlayerGenderToFrontTrainerPicId_Debug(...args: any[]): any {
  if (getClass == TRUE)
      {
          if (gender != MALE)
