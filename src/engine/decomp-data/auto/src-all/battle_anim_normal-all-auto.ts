...
export function AnimConfusionDuck(...args: any[]): any {
...
export function AnimConfusionDuck_Step(...args: any[]): any {
...
export function AnimSimplePaletteBlend(...args: any[]): any {
  CMD_ARGS(selector, delay, initialBlendY, targetBlendY, color);

      let selectedPalettes = UnpackSelectedBattlePalettes(cmd.selector);
...
export function UnpackSelectedBattlePalettes(...args: any[]): any {
  let battleBackground = selector & 1;
      let attacker = (selector >> 1) & 1;
      let target = (selector >> 2) & 1;
      let attackerPartner = (selector >> 3) & 1;
      let targetPartner = (selector >> 4) & 1;
      let anim1 = (selector >> 5) & 1;
      let anim2 = (selector >> 6) & 1;
...
export function AnimSimplePaletteBlend_Step(...args: any[]): any {
  if (!gPaletteFade.active)
          DestroyAnimSprite(sprite);
}

/** static void AnimComplexPaletteBlend(struct Sprite *sprite) */
export function AnimComplexPaletteBlend(...args: any[]): any {
...
export function AnimComplexPaletteBlend_Step1(...args: any[]): any {
  let selectedPalettes: any = null;
...
export function AnimComplexPaletteBlend_Step2(...args: any[]): any {
  let selectedPalettes: any = null;
...
export function AnimCirclingSparkle(...args: any[]): any {
  CMD_ARGS(x, y);
...
export function AnimTask_BlendColorCycle(...args: any[]): any {
...
export function BlendColorCycle(...args: any[]): any {
  let selectedPalettes = UnpackSelectedBattlePalettes(gTasks[taskId].tPalSelector);
...
export function AnimTask_BlendColorCycleLoop(...args: any[]): any {
...
export function AnimTask_BlendColorCycleExclude(...args: any[]): any {
...
export function BlendColorCycleExclude(...args: any[]): any {
  let selectedPalettes = (gTasks[taskId].tPalSelectorHi << 16) | gTasks[taskId].tPalSelectorLo;
      BeginNormalPaletteFade(
          selectedPalettes,
          gTasks[taskId].tDelay,
          startBlendAmount,
...
export function AnimTask_BlendColorCycleExcludeLoop(...args: any[]): any {
  let startBlendAmount, targetBlendAmount;
      if (!gPaletteFade.active)
      {
          if (gTasks[taskId].tNumBlends > 0)
...
export function AnimTask_BlendColorCycleByTag(...args: any[]): any {
...
export function BlendColorCycleByTag(...args: any[]): any {
  let paletteIndex = IndexOfSpritePaletteTag(gTasks[taskId].tPalTag);
      BeginNormalPaletteFade(
          1 << (paletteIndex + 16),
          gTasks[taskId].tDelay,
          startBlendAmount,
...
export function AnimTask_BlendColorCycleByTagLoop(...args: any[]): any {
  let startBlendAmount, targetBlendAmount;
      if (!gPaletteFade.active)
      {
          if (gTasks[taskId].tNumBlends > 0)
...
export function AnimTask_FlashAnimTagWithColor(...args: any[]): any {
...
export function AnimTask_FlashAnimTagWithColor_Step1(...args: any[]): any {
  let selectedPalettes: any = null;
...
export function AnimTask_FlashAnimTagWithColor_Step2(...args: any[]): any {
  let selectedPalettes: any = null;
...
export function AnimTask_InvertScreenColor(...args: any[]): any {
  CMD_ARGS(flagsScenery, flagsAttacker, flagsTarget);

      let selectedPalettes = 0;
      let attackerBattler = gBattleAnimAttacker;
      let targetBattler = gBattleAnimTarget;
...
export function AnimTask_TintPalettes(...args: any[]): any {
...
export function AnimShakeMonOrBattlePlatforms(...args: any[]): any {
...
export function AnimShakeMonOrBattlePlatforms_Step(...args: any[]): any {
  let i: any = null;
...
export function AnimTask_ShakeBattlePlatforms(...args: any[]): any {
...
export function AnimTask_ShakeBattlePlatforms_Step(...args: any[]): any {
  if (gTasks[taskId].tTimer == 0)
      {
...
export function AnimHitSplatBasic(...args: any[]): any {
...
export function AnimHitSplatPersistent(...args: any[]): any {
...
export function AnimHitSplatHandleInvert(...args: any[]): any {
  CMD_ARGS(x, y, relativeTo, animation);
...
export function AnimHitSplatRandom(...args: any[]): any {
...
export function AnimHitSplatOnMonEdge(...args: any[]): any {
...
export function AnimCrossImpact(...args: any[]): any {
...
export function AnimFlashingHitSplat(...args: any[]): any {
  CMD_ARGS(x, y, relativeTo, animation);
...
export function AnimFlashingHitSplat_Step(...args: any[]): any {
  sprite.invisible ^= 1;
      if (sprite.data[0]++ > 12)
          DestroyAnimSprite(sprite);
}
