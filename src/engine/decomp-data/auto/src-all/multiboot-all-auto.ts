...
const {
  MultiBoot, MultiBootCheckComplete, MultiBootHandShake, MultiBootInit,
  MultiBootSend, MultiBootStartProbe, MultiBootWaitCycles, MultiBootWaitSendDone,
  REG_SIOMULTI,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
...
export function MultiBootMain(mp: any): any {
  let i: any = null;
      let j: any = null;
      let k: any = null;
...
export function MultiBootSend(mp: any, data: any): any {
  let i: any = null;
...
export function MultiBootStartProbe(mp: any): any {
  if (mp.probe_count != 0)
      {
          MultiBootInit(mp);
          return;
...
export function MultiBootStartMaster(mp: any, srcp: any, length: any, palette_color: any, palette_speed: any): any {
  let i: any = 0;
...
export function MultiBootCheckComplete(mp: any): any {
...
export function MultiBootHandShake(mp: any): any {
  let i, j;
...
export function MultiBootWaitCycles(cycles: any): any {
  asm_unified("\
      mov  r2, pc\n\
      lsrs r2, 24\n\
      movs r1, 12\n\
...
export function MultiBootWaitSendDone(): any {
  let i: any = null;
...
export const __callsTo__: ReadonlyArray<string> = ["MultiBoot","MultiBootCheckComplete","MultiBootHandShake","MultiBootInit","MultiBootSend","MultiBootStartProbe","MultiBootWaitCycles","MultiBootWaitSendDone","REG_SIOMULTI"];
