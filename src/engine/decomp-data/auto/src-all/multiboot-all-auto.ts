...
export function MultiBootInit(...args: any[]): any {
  mp.client_bit = 0;
      mp.probe_count = 0;
      mp.response_bit = 0;
...
export function MultiBootMain(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let k: any = null;
...
export function MultiBootSend(...args: any[]): any {
  let i: any = null;
...
export function MultiBootStartProbe(...args: any[]): any {
  if (mp.probe_count != 0)
      {
          MultiBootInit(mp);
          return;
...
export function MultiBootStartMaster(...args: any[]): any {
  let i = 0;
...
export function MultiBootCheckComplete(...args: any[]): any {
...
export function MultiBootHandShake(...args: any[]): any {
  let i, j;
...
export function MultiBootWaitCycles(...args: any[]): any {
  asm_unified("\
      mov  r2, pc\n\
      lsrs r2, 24\n\
      movs r1, 12\n\
