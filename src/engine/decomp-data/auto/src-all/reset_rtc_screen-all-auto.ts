...
export function SpriteCB_Cursor_UpOrRight(...args: any[]): any {
  let state = gTasks[sprite.sTaskId].tSelection;
...
export function SpriteCB_Cursor_Down(...args: any[]): any {
  let state = gTasks[sprite.sTaskId].tSelection;
      if (state != sprite.sState)
      {
          sprite.sState = state;
...
export function CreateCursor(...args: any[]): any {
...
export function HideChooseTimeWindow(...args: any[]): any {
...
export function PrintTime(...args: any[]): any {
  let dest = gStringVar4;
...
export function ShowChooseTimeWindow(...args: any[]): any {
...
export function MoveTimeUpDown(...args: any[]): any {
  if (keys & DPAD_DOWN)
      {
          *val -= 1;
          if (*val < minVal)
...
export function Task_ResetRtc_SetFinished(...args: any[]): any {
  gTasks[taskId].tFinished = TRUE;
}

/** static void Task_ResetRtc_Exit(u8 taskId) */
export function Task_ResetRtc_Exit(...args: any[]): any {
...
export function Task_ResetRtc_HandleInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ResetRtc_Init(...args: any[]): any {
  let data = gTasks[taskId].data;
      tFinished = FALSE;
...
export function Task_ShowResetRtcPrompt(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ResetRtcScreen(...args: any[]): any {
  let data = gTasks[taskId].data;
