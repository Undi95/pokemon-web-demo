...
const {
  ARRAY_COUNT, BufferContestLadyCategoryAndMonName, BufferItemName, BufferQuizAuthorName,
  BufferQuizAuthorNameAndCheckIfLady, ContestLadySavePlayerNameIfHighSheen, ConvertInternationalString, CopyEasyChatWord,
  DoesFavorLadyLikeItem, FavorLadyBufferPrizeName, FavorLadyOpenBagMenu, FavorLadyPickFavorAndBestItem,
  GetFavorLadyRequest, GetItemName, GetLilycoveLadyId, GetNumAcceptedItems,
  GetPlayerNameLength, InitLilycoveContestLady, InitLilycoveFavorLady, InitLilycoveQuizLady,
  IsEasyChatAnswerUnlocked, IsQuizTrainerIdNotPlayer, OpenPokeblockCase, QuizLadyOpenBagMenu,
  QuizLadyPickQuestion, Random, RemoveBagItem, ResetContestLadyContestData,
  ResetContestLadyForRecordMix, ResetFavorLadyForRecordMix, ResetQuizLadyForRecordMix, ScriptContext_Enable,
  SetFavorLadyPlayerName, ShowEasyChatScreen, StringCompare, StringCopy,
  StringCopy_Nickname, StringCopy_PlayerName, VarSet,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
