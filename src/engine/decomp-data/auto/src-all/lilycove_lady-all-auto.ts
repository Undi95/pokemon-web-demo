...
export function InitLilycoveLady(): any {
  let id = ((gSaveBlock2Ptr.playerTrainerId[1] << 8) | gSaveBlock2Ptr.playerTrainerId[0]);
      id %= 6;
      id >>= 1;
      switch (id)
      {
...
export function InitLilycoveLadyRandomly(): any {
  let lady = Random() % LILYCOVE_LADY_COUNT;
...
export function GetNumAcceptedItems(...args: any[]): any {
...
export function BufferItemName(...args: any[]): any {
...
export function SetFavorLadyPlayerName(...args: any[]): any {
...
export function DoesFavorLadyLikeItem(...args: any[]): any {
  let numItems: any = null;
      let i: any = null;
...
export function FavorLadyBufferPrizeName(...args: any[]): any {
...
export function BufferQuizAuthorName(): any {
  let authorNameId: any = null;
      ...
      else
      {
          ...
          {
              let name = sQuizLadyPtr.playerName;
              for (i = 0; i < nameLen; i++)
              {
...
export function GetPlayerNameLength(...args: any[]): any {
  let len: any = null;
      let ptr: any = null;
...
export function QuizLadyClearQuestionForRecordMix(...args: any[]): any {
  let i: any = null;
...
export function ContestLadySavePlayerNameIfHighSheen(...args: any[]): any {
  sContestLadyPtr = gSaveBlock1Ptr.lilycoveLady.contest;
...
export function GivePokeblockToContestLady(...args: any[]): any {
  let sheen = 0;
...
export function BufferContestLadyCategoryAndMonName(...args: any[]): any {
  sContestLadyPtr = gSaveBlock1Ptr.lilycoveLady.contest;
...
export function BufferContestLadyMonName(...args: any[]): any {
  sContestLadyPtr = gSaveBlock1Ptr.lilycoveLady.contest;
...
export function BufferContestLadyPlayerName(...args: any[]): any {
  sContestLadyPtr = gSaveBlock1Ptr.lilycoveLady.contest;
      StringCopy(dest, sContestLadyPtr.playerName);
}

/** void BufferContestLadyLanguage(u8 *dest) */
export function BufferContestLadyLanguage(...args: any[]): any {
  sContestLadyPtr = gSaveBlock1Ptr.lilycoveLady.contest;
      *dest = sContestLadyPtr.language;
}

/** void BufferContestName(u8 *dest, u8 category) */
export function BufferContestName(...args: any[]): any {
