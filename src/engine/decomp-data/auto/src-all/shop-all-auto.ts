...
export function CreateShopMenu(...args: any[]): any {
...
export function SetShopMenuCallback(...args: any[]): any {
  sMartInfo.callback = callback;
}

/** static void SetShopItemsForSale(const u16 *items) */
export function SetShopItemsForSale(...args: any[]): any {
  let i = 0;
...
export function Task_ShopMenu(...args: any[]): any {
...
export function Task_HandleShopMenuBuy(...args: any[]): any {
...
export function Task_HandleShopMenuSell(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleShopMenuQuit(...args: any[]): any {
...
export function Task_GoToBuyOrSellMenu(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (!gPaletteFade.active)
      {
          DestroyTask(taskId);
          SetMainCallback2((MainCallback)(tCallbackHi << 16 | tCallbackLo));
      }
}
...
export function Task_ReturnToShopMenu(...args: any[]): any {
...
export function ShowShopMenuAfterExitingBuyOrSellMenu(...args: any[]): any {
...
export function BuyMenuSetListEntry(...args: any[]): any {
...
export function BuyMenuPrintItemDescriptionAndShowItemIcon(...args: any[]): any {
...
export function BuyMenuPrintPriceInList(...args: any[]): any {
  let x: any = null;
...
export function BuyMenuPrintCursor(...args: any[]): any {
  let y = ListMenuGetYCoordForPrintingArrowCursor(scrollIndicatorsTaskId);
      BuyMenuPrint(WIN_ITEM_LIST, gText_SelectorArrow2, 0, y, 0, colorSet);
}

/** static void BuyMenuAddItemIcon(u16 item, u8 iconSlot) */
export function BuyMenuAddItemIcon(...args: any[]): any {
  let spriteId: any = null;
      let spriteIdPtr = sShopData.itemSpriteIds[iconSlot];
...
export function BuyMenuRemoveItemIcon(...args: any[]): any {
  let spriteIdPtr = sShopData.itemSpriteIds[iconSlot];
      if (*spriteIdPtr == SPRITE_NONE)
          return;
...
export function BuyMenuDrawMapMetatile(...args: any[]): any {
  let offset1 = x * 2;
      let offset2 = y * 64;
...
export function BuyMenuDrawMapMetatileLayer(...args: any[]): any {
...
export function BuyMenuCollectObjectEventData(): any {
  let facingX: any = null;
      ...
      for (y = 0; y < 5; y++)
      {
          for (x = 0; x < 7; x++)
          {
              let objEventId = GetObjectEventIdByXY(facingX - 4 + x, facingY - 2 + y);
...
export function BuyMenuCheckIfObjectEventOverlapsMenuBg(...args: any[]): any {
...
export function BuyMenuCopyMenuBgToBg1TilemapBuffer(): any {
  let i: any = null;
      let dest = sShopData.tilemapBuffers[1];
      let src = sShopData.tilemapBuffers[0];
...
export function BuyMenuCheckForOverlapWithMenuBg(...args: any[]): any {
  let metatile = sShopData.tilemapBuffers[0];
      let offset1 = x * 2;
      let offset2 = y * 64;
...
export function Task_BuyMenu(...args: any[]): any {
  let data = gTasks[taskId].data;

      if (!gPaletteFade.active)
      {
          let itemId = ListMenu_ProcessInput(tListTaskId);
...
export function Task_BuyHowManyDialogueInit(...args: any[]): any {
  let data = gTasks[taskId].data;

      let quantityInBag = CountTotalItemQuantityInBag(tItemId);
...
export function Task_BuyHowManyDialogueHandleInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function BuyMenuSubtractMoney(...args: any[]): any {
...
export function Task_ReturnToItemListAfterItemPurchase(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ReturnToItemListAfterDecorationPurchase(...args: any[]): any {
  if (JOY_NEW(A_BUTTON | B_BUTTON))
      {
          PlaySE(SE_SELECT);
          BuyMenuReturnToItemList(taskId);
...
export function BuyMenuReturnToItemList(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function BuyMenuPrintItemQuantityAndPrice(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ExitBuyMenu(...args: any[]): any {
  gFieldCallback = MapPostLoadHook_ReturnToShopMenu;
...
export function Task_ExitBuyMenu(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function RecordItemPurchase(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function CreatePokemartMenu(...args: any[]): any {
...
export function CreateDecorationShop1Menu(...args: any[]): any {
...
export function CreateDecorationShop2Menu(...args: any[]): any {
