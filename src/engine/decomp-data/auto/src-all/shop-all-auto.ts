...
const {
  ...
  DecorationAdd, DestroySprite, DestroyTask, DisplayItemMessageOnField,
  DisplayMessageAndContinueTask, DoScheduledBgTilemapCopiesToVram, DrawStdFrameWithCustomTileAndPalette, FALSE,
  FadeInFromBlack, FadeScreen, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, FreeSpritePaletteByTag,
  FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, GetItemDescription, GetItemPocket,
  GetItemPrice, GetMaxWidthInMenuTable, GetMoney, GetObjectEventGraphicsInfo,
  GetObjectEventIdByXY, GetPlayerTextSpeedDelay, GetStringRightAlignXOffset, GetXYCoordsOneStepInFrontOfPlayer,
  IncrementGameStat, InitBgsFromTemplates, InitMenuInUpperLeftCornerNormal, InitWindows,
  IsEnoughMoney, IsPokeNewsActive, IsWeatherNotFadingIn, ItemIdToBattleMoveId,
