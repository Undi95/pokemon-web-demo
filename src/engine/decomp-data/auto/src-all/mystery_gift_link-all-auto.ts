...
export function MysteryGiftLink_InitSend(...args: any[]): any {
  link.state = 0;
...
export function MysteryGiftLink_InitRecv(...args: any[]): any {
  link.state = 0;
...
export function MGL_ReceiveBlock(...args: any[]): any {
  memcpy(dest, gBlockRecvBuffer[playerId], size);
}

/** static bool32 MGL_HasReceived(u32 playerId) */
export function MGL_HasReceived(...args: any[]): any {
...
export function MGL_ResetReceived(...args: any[]): any {
  ResetBlockReceivedFlag(playerId);
}

/** static bool32 MGL_Receive(struct MysteryGiftLink *link) */
export function MGL_Receive(...args: any[]): any {
  let header: any = null;
      ...
      case 1:
          if (MGL_HasReceived(link.recvPlayerId))
          {
              let blocksize = link.recvCounter * 252;
...
export function MGL_Send(...args: any[]): any {
  let header: any = null;
