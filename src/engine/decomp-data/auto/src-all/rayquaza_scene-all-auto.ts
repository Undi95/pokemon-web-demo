...
export function DoRayquazaScene(...args: any[]): any {
...
export function Task_EndAfterFadeScreen(...args: any[]): any {
...
export function Task_SetNextAnim(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_HandleDuoFightPre(...args: any[]): any {
...
export function SpriteCB_DuoFightPre_Groudon(...args: any[]): any {
...
export function SpriteCB_DuoFightPre_Kyogre(...args: any[]): any {
  let data = sprite.data;
      data[5]++;
      data[5] &= 0x1F;
...
export function Task_DuoFightAnim(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_DuoFight_AnimateClouds(...args: any[]): any {
  let i: any = null;
      let data = gTasks[taskId].data;
...
export function Task_HandleDuoFight(...args: any[]): any {
  let data = gTasks[taskId].data;
      DuoFight_AnimateRain();
      if (!gPaletteFade.active)
      {
...
export function DuoFight_PanOffScene(...args: any[]): any {
  let bgY: any = null;
      let data = gTasks[taskId].data;
...
export function DuoFightEnd(...args: any[]): any {
...
export function Task_DuoFightEnd(...args: any[]): any {
  let data = gTasks[taskId].data;
      DuoFight_AnimateRain();
      if (!gPaletteFade.active)
      {
...
export function SpriteCB_DuoFight_Groudon(...args: any[]): any {
  let data = sprite.data;
      data[5]++;
      data[5] &= 0xF;
...
export function DuoFight_SlideGroudonDown(...args: any[]): any {
  let data = sprite.data;
...
export function SpriteCB_DuoFight_Kyogre(...args: any[]): any {
  let data = sprite.data;
      data[5]++;
      data[5] &= 0xF;
...
export function DuoFight_SlideKyogreDown(...args: any[]): any {
  let data = sprite.data;
      if (sprite.y <= DISPLAY_HEIGHT)
      {
          sprite.y += 8;
...
export function Task_RayTakesFlightAnim(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleRayTakesFlight(...args: any[]): any {
  let data = gTasks[taskId].data;
      switch (tState)
      {
      case 0:
...
export function Task_RayTakesFlightEnd(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          SetVBlankCallback(NULL);
          ResetSpriteData();
...
export function Task_TakesFlight_CreateSmoke(...args: any[]): any {
  let data = gTasks[taskId].data;
      if ((tTimer & 3) == 0)
      {
          let spriteId = CreateSprite(sSpriteTemplate_TakesFlight_Smoke,
...
export function SpriteCB_TakesFlight_Smoke(...args: any[]): any {
  if (sprite.sTimer == 0)
      {
          sprite.x2 = 0;
          sprite.y2 = 0;
...
export function HBlankCB_RayDescends(): any {
  let vcount = GetGpuReg(REG_OFFSET_VCOUNT);
...
export function Task_RayDescendsAnim(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleRayDescends(...args: any[]): any {
  let data = gTasks[taskId].data;
      switch (tState)
      {
      case 0:
...
export function Task_RayDescendsEnd(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          SetVBlankCallback(NULL);
...
export function CreateDescendsRayquazaSprite(): any {
  let spriteId = CreateSprite(sSpriteTemplate_Descends_Rayquaza, 160, 0, 0);
      let data = gSprites[spriteId].data;
...
export function SpriteCB_Descends_Rayquaza(...args: any[]): any {
  let data = sprite.data;
      let frame = sTimer;
...
export function Task_RayChargesAnim(...args: any[]): any {
  let data = gTasks[taskId].data;
      InitChargesSceneBgs();
      LoadChargesSceneGfx();
...
export function Task_HandleRayCharges(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_RayCharges_ShakeRayquaza(...args: any[]): any {
  let data = gTasks[taskId].data;
      if ((tTimer & 3) == 0)
      {
...
export function Task_RayCharges_FlyOffscreen(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (tState == 0)
      {
...
export function Task_RayChargesEnd(...args: any[]): any {
  let data = gTasks[taskId].data;
      RayCharges_AnimateBg();
      if (!gPaletteFade.active)
      {
...
export function Task_RayChasesAwayAnim(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleRayChasesAway(...args: any[]): any {
  let data = gTasks[taskId].data;
      switch (tState)
      {
      case 0:
...
export function Task_ChasesAway_AnimateBg(...args: any[]): any {
  let data = gTasks[taskId].data;
      if ((tTimer & 0xF) == 0)
      {
...
export function Task_RayChasesAwayEnd(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (!gPaletteFade.active)
      {
          StopMapMusic();
...
export function ChasesAway_CreateTrioSprites(...args: any[]): any {
...
export function ChasesAway_PushDuoBack(...args: any[]): any {
...
export function SpriteCB_ChasesAway_DuoRingPush(...args: any[]): any {
...
export function ChasesAway_GroudonStartLeave(...args: any[]): any {
  let taskData = gTasks[taskId].data;
...
export function SpriteCB_ChasesAway_GroudonLeave(...args: any[]): any {
  switch (sprite.animCmdIndex)
      {
      case 0:
      case 2:
...
export function ChasesAway_KyogreStartLeave(...args: any[]): any {
  s16 *taskData, *spriteData;
...
export function SpriteCB_ChasesAway_KyogreLeave(...args: any[]): any {
...
export function SpriteCB_ChasesAway_Rayquaza(...args: any[]): any {
  let frame = sprite.sTimer;
      if (frame <= 64)
      {
          sprite.y2 += 2;
...
export function SpriteCB_ChasesAway_RayquazaFloat(...args: any[]): any {
...
export function ChasesAway_SetRayquazaAnim(...args: any[]): any {
  let tail: any = gSprites[body.sTailSpriteId];
...
export function Task_ChasesAway_AnimateRing(...args: any[]): any {
  let data = gTasks[taskId].data;
      switch (tState)
      {
      case 0:
