...
const {
  ...
  CreateSprite, CreateTask, CreateYesNoMenu, DISPCNT_OBJ_1D_MAP,
  DISPCNT_OBJ_ON, DISPCNT_WIN0_ON, DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap,
  ...
  FALSE, FadeScreen, FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0,
  FillWindowPixelBuffer, FillWindowPixelRect, FlagGet, FlagSet,
  FreeAllSpritePalettes, FreeAllWindowBuffers, GetBgTilemapBuffer, GetBgY,
  GetCurrentPhrase, GetEasyChatWord, GetEasyChatWordGroupName, GetNationalPokedexCount,
  GetQuestionnaireWordsPtr, GetSetPokedexFlag, GetStringCenterAlignXOffset, GetStringWidth,
  GetTitleText, GetWordTaskArg, HideBg, InitBgsFromTemplates,
  InitWindows, IsDma3ManagerBusyWithBgCopy, IsNationalPokedexEnabled, IsOverworldLinkActive,
