...
const {
  ARRAY_COUNT, AddMainScreenButtonWindow, AddPhraseWindow, AddTextPrinterParameterized,
  ...
  BufferCurrentPhraseToStringVar2, BufferFrameTilemap, BufferLowerWindowFrame, BuildOamBuffer,
  CanPhraseFitInXRowsYCols, CanScrollDown, CanScrollUp, ChangeBgX,
  ChangeBgY, CleanupOverworldWindowsAndTilemaps, ClearUnusedField, ClearWordSelectWindow,
  CloseKeyboard, ClosePrompt, ClosePromptAfterDeleteAll, CloseWordSelect,
  ConvertEasyChatWordsToString, CopyBgTilemapBufferToVram, CopyEasyChatWord, CopyEasyChatWordPadded,
  CopyToBgTilemapBuffer, CopyToBgTilemapBufferRect, CopyWindowToVram, CpuCopy16,
  CpuFastFill, CreateEasyChatYesNoMenu, CreateMainCursorSprite, CreateObjectGraphicsSprite,
  CreateRectangleCursorSprites, CreateScrollIndicatorSprites, CreateSideWindowSprites, CreateSprite,
  CreateStartSelectButtonSprites, CreateTask, CreateWordSelectCursorSprite, CreateYesNoMenu,
  DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap, DeleteSelectedWord, DestroyRectangleCursorSprites,
  DestroySideWindowSprites, DestroySprite, DestroyWordSelectCursorSprite, DidPhraseChange,
  DidPlayerInputABerryMasterWifePhrase, DidPlayerInputMysteryGiftPhrase, DoDeleteAllButton, DoEasyChatScreen,
  DoQuizButton, DoQuizQuestionEasyChatScreen, DrawLowerWindow, DrawLowerWindowFrame,
  DrawTextBorderOuter, DummyWordCheck, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset,
  DynamicPlaceholderTextUtil_SetPlaceholderPtr, EC_GROUP, EC_INDEX, EC_WORD,
  EasyChatIsNationalPokedexEnabled, EasyChat_GetNumWordsInGroup, EnterQuizLadyScreen, EraseWordSelectRows,
  ExitEasyChatScreen, ExitKeyboardToMainScreen, FadeScreen, FillBgTilemapBufferRect,
  FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FillWindowPixelRect, FlagGet,
  FlagSet, FooterHasFourOptions, FooterHasFourOptions_, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreeEasyChatScreenControl, FreeEasyChatScreenStruct, FreeEasyChatScreenWordData,
  GetBgTilemapBuffer, GetBgY, GetCurrentPhrase, GetDisplayedPersonType,
  GetEachChatScreenTemplateId, GetEasyChatBackupState, GetEasyChatCompleted, GetEasyChatConfirmDeletionText,
  GetEasyChatConfirmExitText, GetEasyChatConfirmText, GetEasyChatInstructionsText, GetEasyChatScreenFrameId,
  GetEasyChatScreenType, GetEasyChatWord, GetEasyChatWordGroupName, GetEasyChatWordStringLength,
  GetFooterIndex, GetFooterOptionXOffset, GetInAlphabetMode, GetKeyboardCursorColAndRow,
  GetKeyboardScrollOffset, GetLastAlphabetColumn, GetLowerWindowScrollOffset, GetMainCursorColumn,
  GetMainCursorRow, GetNationalPokedexCount, GetNumColumns, GetNumRows,
  GetNumTrendySayingsUnlocked, GetNumUnlockedEasyChatGroups, GetNumWordsInSelectedGroup, GetQuestionnaireWordsPtr,
  GetQuizLadyScreenByFuncId, GetQuizTitle, GetRandomEasyChatWordFromGroup, GetRandomEasyChatWordFromUnlockedGroup,
  GetRandomUnlockedEasyChatPokemon, GetSelectedAlphabetGroupId, GetSelectedGroupIndex, GetSelectedWordIndex,
  GetSetPokedexFlag, GetStringCenterAlignXOffset, GetStringWidth, GetTitleText,
  GetUnlockedEasyChatGroupId, GetWordFromSelectedGroup, GetWordIndexToReplace, GetWordSelectColAndRow,
  GetWordSelectLastRow, GetWordSelectScrollOffset, GetWordTaskArg, GroupNamesScrollDown,
  GroupNamesScrollUp, HandleEasyChatInput, HandleEasyChatInput_ConfirmLyricsYesNo, HandleEasyChatInput_ConfirmWordsYesNo,
  HandleEasyChatInput_DeleteAllYesNo, HandleEasyChatInput_ExitPrompt, HandleEasyChatInput_Keyboard, HandleEasyChatInput_MainScreenButtons,
  HandleEasyChatInput_Phrase, HandleEasyChatInput_QuizQuestion, HandleEasyChatInput_StartConfirmLyrics, HandleEasyChatInput_WaitForMsg,
  HandleEasyChatInput_WordSelect, HideBg, HideModeWindow, HideScrollIndicators,
  HideStartSelectButtons, InitBgsFromTemplates, InitEasyChatBgs, InitEasyChatScreen,
  InitEasyChatScreenControl, InitEasyChatScreenControl_, InitEasyChatScreenStruct, InitEasyChatScreenWordData,
  InitLowerWindowAnim, InitLowerWindowScroll, InitLowerWindowText, InitWindows,
  InitializeEasyChatWordArray, IsCurrentFrame2x5, IsCurrentPhraseEmpty, IsCurrentPhraseFull,
  IsDma3ManagerBusyWithBgCopy, IsEasyChatGroupUnlocked, IsEasyChatGroupUnlocked2, IsEasyChatIndexAndGroupUnlocked,
  IsEasyChatWordInvalid, IsEasyChatWordUnlocked, IsFuncIdForQuizLadyScreen, IsModeWindowAnimActive,
  IsNationalPokedexEnabled, IsOverworldLinkActive, IsPhraseDifferentThanPlayerInput, IsQuizAnswerEmpty,
  IsQuizQuestionEmpty, IsRestrictedWordSpecies, IsSelectedKeyboardIndexInvalid, IsSelectedWordIndexInvalid,
  IsTrendySayingUnlocked, JOY_NEW, JOY_REPEAT, LoadCompressedSpriteSheet,
  LoadEasyChatGfx, LoadEasyChatPalettes, LoadEasyChatScreen, LoadOam,
  LoadPalette, LoadSpritePalettes, LoadSpriteSheets, LoadUserWindowBorderGfx,
  Menu_ProcessInputNoWrapClearOnChoose, MoveKeyboardCursor, MoveKeyboardCursor_Alphabet, MoveKeyboardCursor_ButtonWindow,
  MoveKeyboardCursor_GroupNames, MoveWordSelectCursor, OpenKeyboard, OpenWordSelect,
  PIXEL_FILL, PlaySE, PrintCurrentPhrase, PrintEasyChatStdMessage,
  PrintEasyChatText, PrintEasyChatTextWithColors, PrintInitialInstructions, PrintInitialWordSelectText,
  PrintKeyboardAlphabet, PrintKeyboardGroupNames, PrintKeyboardText, PrintTitle,
  PrintWordSelectNextRowDown, PrintWordSelectNextRowUp, PrintWordSelectRowsPageDown, PrintWordSelectRowsPageUp,
  PrintWordSelectText, ProcessSpriteCopyRequests, PutWindowTilemap, Random,
  ReduceToValidKeyboardColumn, ReduceToValidWordSelectColumn, ReprintPhrase, ResetBgsAndClearDma3BusyFlags,
  ResetCurrentPhrase, ResetCurrentPhraseToSaved, ResetLowerWindowScroll, ResetPaletteFade,
  ResetSpriteData, ResetTasks, ReturnToKeyboard, RunEasyChatFunction,
  RunTasks, SaveCurrentPhrase, SelectKeyboardGroup, SelectNewWord,
  SetBgTilemapBuffer, SetGpuReg, SetKeyboardCursorInButtonWindow, SetKeyboardCursorToLastColumn,
  SetMainCallback2, SetMainCursorPos, SetModeWindowToTransition, SetRectangleCursorPos_AlphabetMode,
  SetRectangleCursorPos_GroupMode, SetScrollIndicatorXPos, SetSelectedWord, SetSelectedWordGroup,
  SetSelectedWordGroup_AlphabetMode, SetSelectedWordGroup_GroupMode, SetSpecialEasyChatResult, SetUnlockedEasyChatGroups,
  SetUnlockedWordsByAlphabet, SetVBlankCallback, SetWindowDimensions, SetWordSelectCursorPos,
  SetWordTaskArg, ShowBg, ShowCantDeleteLyricsMsg, ShowCantExitMsg,
  ShowCombineTwoWordsMsg, ShowConfirmDeleteAllPrompt, ShowConfirmExitPrompt, ShowConfirmLyricsPrompt,
  ShowConfirmPrompt, ShowCreateQuizMsg, ShowFieldAutoScrollMessage, ShowSelectAnswerMsg,
  ShowSideWindow, ShowSongTooShortMsg, SpeciesToNationalPokedexNum, StartConfirmExitPrompt,
  StartEasyChatFunction, StartEasyChatScreen, StartMainCursorAnim, StartSpriteAnim,
  ...
  TryAddInterviewObjectEvents, TryConfirmWords, TrySetTrendyPhrase, UnlockTrendySaying,
  UpdateKeyboardCursor, UpdateLowerWindowAnim, UpdateLowerWindowScroll, UpdateMainCursor,
  UpdateMainCursorOnButtons, UpdateModeWindowAnim, UpdatePaletteFade, UpdateRectangleCursorPos,
  UpdateScrollIndicatorsVisibility, UpdateStartSelectButtonsVisibility, UpdateWordSelectCursor, UpdateWordSelectCursorPos,
  WIN_RANGE, WordSelectPageScrollDown, WordSelectPageScrollUp, WordSelectScrollDown,
  WordSelectScrollUp, WriteColorChangeControlCode,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
