...
const {
  ...
  Alloc, AnimateSprites, BG_PLTT_ID, BeginNormalPaletteFade,
  BlendPalettes, BuildOamBuffer, ChangeBgX, ChangeBgY,
  CleanupOverworldWindowsAndTilemaps, ConvertEasyChatWordsToString, CopyBgTilemapBufferToVram, CopyEasyChatWord,
  CopyEasyChatWordPadded, CopyToBgTilemapBuffer, CopyToBgTilemapBufferRect, CopyWindowToVram,
  CpuCopy16, CpuFastFill, CreateObjectGraphicsSprite, CreateSprite,
  CreateTask, CreateYesNoMenu, DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap,
  DestroySprite, DrawTextBorderOuter, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset,
  ...
  FillWindowPixelRect, FlagGet, FlagSet, FreeAllSpritePalettes,
  FreeAllWindowBuffers, GetBgTilemapBuffer, GetBgY, GetCurrentPhrase,
  GetEasyChatWord, GetEasyChatWordGroupName, GetNationalPokedexCount, GetQuestionnaireWordsPtr,
  GetSetPokedexFlag, GetStringCenterAlignXOffset, GetStringWidth, GetTitleText,
  GetWordTaskArg, HideBg, InitBgsFromTemplates, InitWindows,
  IsDma3ManagerBusyWithBgCopy, IsNationalPokedexEnabled, IsOverworldLinkActive, JOY_NEW,
  JOY_REPEAT, LoadCompressedSpriteSheet, LoadOam, LoadPalette,
  LoadSpritePalettes, LoadSpriteSheets, LoadUserWindowBorderGfx, Menu_ProcessInputNoWrapClearOnChoose,
  PIXEL_FILL, PlaySE, ProcessSpriteCopyRequests, PutWindowTilemap,
  Random, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData,
  ResetTasks, RunTasks, SetBgTilemapBuffer, SetGpuReg,
  ...
  StringLength, TRY_FREE_AND_SET_NULL, TVShowConvertInternationalString, TransferPlttBuffer,
  TrySetTrendyPhrase, UpdatePaletteFade, WIN_RANGE, WriteColorChangeControlCode,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
