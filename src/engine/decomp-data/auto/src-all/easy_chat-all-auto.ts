...
export function DoEasyChatScreen(...args: any[]): any {
  let taskId: any = null;
...
export function Task_EasyChatScreen(...args: any[]): any {
  let funcId: any = null;
      let data: any = null;
...
export function InitEasyChatScreen(...args: any[]): any {
  let data: any = null;
...
export function ExitEasyChatScreen(...args: any[]): any {
...
export function GetQuizLadyScreenByFuncId(...args: any[]): any {
  let i: any = null;
...
export function IsFuncIdForQuizLadyScreen(...args: any[]): any {
  return GetQuizLadyScreenByFuncId(funcId) == -1 ? FALSE : TRUE;
}

/** static void EnterQuizLadyScreen(u16 funcId) */
export function EnterQuizLadyScreen(...args: any[]): any {
  let i: any = null;
...
export function InitEasyChatScreenStruct(...args: any[]): any {
...
export function HandleEasyChatInput_MainScreenButtons(): any {
  do
      ...
      if (sEasyChatScreen.mainCursorRow == sEasyChatScreenTemplates[sEasyChatScreen.templateId].numRows)
      {
          let numFooterColumns = FooterHasFourOptions() ? 4 : 3;
          if (sEasyChatScreen.mainCursorColumn < 0)
...
export function SelectKeyboardGroup(): any {
  let numWords: any = null;
      ...
      {
          let groupId = GetUnlockedEasyChatGroupId(GetSelectedGroupIndex());
...
export function SelectNewWord(): any {
  let easyChatWord = GetWordFromSelectedGroup(GetSelectedWordIndex());
...
export function SetSelectedWord(...args: any[]): any {
  let index = GetWordIndexToReplace();
...
export function MoveKeyboardCursor(...args: any[]): any {
  if (sEasyChatScreen.keyboardColumn != -1)
      {
          if (!sEasyChatScreen.inAlphabetMode)
...
export function MoveKeyboardCursor_GroupNames(...args: any[]): any {
  switch (input)
      {
      case INPUT_UP:
...
export function MoveKeyboardCursor_Alphabet(...args: any[]): any {
  switch (input)
      {
      case INPUT_UP:
...
export function MoveKeyboardCursor_ButtonWindow(...args: any[]): any {
  switch (input)
      {
      case INPUT_UP:
          if (sEasyChatScreen.keyboardRow)
...
export function MoveWordSelectCursor(...args: any[]): any {
  let funcId: any = null;
      switch (input)
      {
      case INPUT_UP:
...
export function GetSelectedAlphabetGroupId(): any {
  let column = sEasyChatScreen.keyboardColumn < NUM_ALPHABET_COLUMNS ? sEasyChatScreen.keyboardColumn : 0;
      let row = sEasyChatScreen.keyboardRow < NUM_ALPHABET_ROWS ? sEasyChatScreen.keyboardRow : 0;
...
export function GetLastAlphabetColumn(...args: any[]): any {
  switch (row)
      {
      case 0:
      default:
...
export function GetEasyChatInstructionsText(...args: any[]): any {
...
export function GetEasyChatConfirmText(...args: any[]): any {
...
export function GetEasyChatConfirmExitText(...args: any[]): any {
  switch (sEasyChatScreen.type)
      {
      case EASY_CHAT_TYPE_MAIL:
...
export function GetWordSelectColAndRow(...args: any[]): any {
...
export function IsPhraseDifferentThanPlayerInput(...args: any[]): any {
  let i: any = null;
...
export function GetEachChatScreenTemplateId(...args: any[]): any {
  let i: any = null;
...
export function GetQuizTitle(...args: any[]): any {
  const name: any[] = [];
...
export function DummyWordCheck(...args: any[]): any {
  return FALSE;
}
...
export function StartEasyChatFunction(...args: any[]): any {
...
export function UpdateMainCursorOnButtons(): any {
  let xOffset = GetFooterOptionXOffset(GetMainCursorColumn());
...
export function WordSelectPageScrollDown(): any {
  switch (sScreenControl.funcState)
      ...
      case 1:
          if (!IsDma3ManagerBusyWithBgCopy())
          {
              let scrollChange = GetWordSelectScrollOffset() - GetLowerWindowScrollOffset();
...
export function PrintEasyChatText(...args: any[]): any {
...
export function PrintEasyChatTextWithColors(...args: any[]): any {
  const color: any[] = [];
      color[0] = bg;
      color[1] = fg;
      color[2] = shadow;
...
export function PrintEasyChatStdMessage(...args: any[]): any {
  let text2 = NULL;
      let text1 = NULL;
      switch (msgId)
      {
...
export function CreateEasyChatYesNoMenu(...args: any[]): any {
...
export function BufferFrameTilemap(...args: any[]): any {
  let frameId: any = null;
      let right, bottom;
      let x, y;
...
export function InitLowerWindowText(...args: any[]): any {
...
export function PrintKeyboardGroupNames(): any {
  let i: any = null;
      ...
      while (1)
      {
          for (x = 0; x < 2; x++)
          {
              let groupId = GetUnlockedEasyChatGroupId(i++);
...
export function PrintWordSelectNextRowDown(): any {
  let wordScroll = GetWordSelectScrollOffset() + NUM_WORD_SELECT_ROWS - 1;
...
export function PrintWordSelectNextRowUp(): any {
  let wordScroll = GetWordSelectScrollOffset();
      EraseWordSelectRows(wordScroll, 1);
      PrintWordSelectText(wordScroll, 1);
}
...
export function PrintWordSelectRowsPageDown(): any {
  let wordScroll = GetWordSelectScrollOffset();
      ...
      let maxRows = GetWordSelectLastRow() + 1;
      if (maxScroll > maxRows)
          maxScroll = maxRows;

      if (wordScroll < maxScroll)
      {
          let numRows = maxScroll - wordScroll;
...
export function PrintWordSelectRowsPageUp(): any {
  let wordScroll = GetWordSelectScrollOffset();
      let windowScroll = GetLowerWindowScrollOffset();
      if (wordScroll < windowScroll)
      {
          let numRows = windowScroll - wordScroll;
          EraseWordSelectRows(wordScroll, numRows);
          PrintWordSelectText(wordScroll, numRows);
      }
}
...
export function PrintWordSelectText(...args: any[]): any {
  let i, j;
...
export function EraseWordSelectRows(...args: any[]): any {
  let y: any = null;
      let var0: any = null;
      let var1: any = null;
      let var2: any = null;
...
export function InitLowerWindowAnim(...args: any[]): any {
  switch (winAnimType)
      {
...
export function DrawLowerWindowFrame(...args: any[]): any {
...
export function BufferLowerWindowFrame(...args: any[]): any {
  let tilemap: any = null;
      let right: any = null;
      let bottom: any = null;
      let x, y;
...
export function InitLowerWindowScroll(...args: any[]): any {
  let bgY: any = null;
...
export function SetWindowDimensions(...args: any[]): any {
  let horizontalDimensions = WIN_RANGE(left, left + width);
      let verticalDimensions = WIN_RANGE(top, top + height);
...
export function CreateMainCursorSprite(): any {
  let frameId = GetEasyChatScreenFrameId();
      let x = sPhraseFrameDimensions[frameId].left * 8 + 13;
      let y = sPhraseFrameDimensions[frameId].top * 8 + 8;
      let spriteId = CreateSprite(sSpriteTemplate_TriangleCursor, x, y, 2);
...
export function SetMainCursorPos(...args: any[]): any {
...
export function SetRectangleCursorPos_GroupMode(...args: any[]): any {
  if (column != -1)
      {
...
export function SetRectangleCursorPos_AlphabetMode(...args: any[]): any {
  let anim: any = null;
      let x, y;
...
export function CreateWordSelectCursorSprite(): any {
  let spriteId = CreateSprite(sSpriteTemplate_TriangleCursor, 0, 0, 4);
...
export function SpriteCB_WordSelectCursor(...args: any[]): any {
  if (++sprite.sDelayTimer > 2)
      {
          sprite.sDelayTimer = 0;
          if (++sprite.x2 > 0)
...
export function SetWordSelectCursorPos(...args: any[]): any {
...
export function SetScrollIndicatorXPos(...args: any[]): any {
  if (!inWordSelect)
      {
...
export function GetFooterOptionXOffset(...args: any[]): any {
  let footerIndex = GetFooterIndex();
...
export function AddMainScreenButtonWindow(): any {
  let i: any = null;
      ...
      {
          let str = sFooterTextOptions[footerIndex][i];
          if (str)
          {
              let x = sFooterOptionXOffsets[footerIndex][i];
...
export function IsEasyChatGroupUnlocked(...args: any[]): any {
  switch (groupId)
      {
...
export function EasyChat_GetNumWordsInGroup(...args: any[]): any {
...
export function IsEasyChatWordInvalid(...args: any[]): any {
  let i: any = null;
...
export function IsBardWordInvalid(...args: any[]): any {
  let numWordsInGroup: any = null;
      let groupId = EC_GROUP(easyChatWord);
      let index = EC_INDEX(easyChatWord);
      if (groupId >= EC_NUM_GROUPS)
          return TRUE;
...
export function GetEasyChatWordStringLength(...args: any[]): any {
  if (easyChatWord == EC_EMPTY_WORD)
          return 0;
...
export function CanPhraseFitInXRowsYCols(...args: any[]): any {
  let i, j;
...
export function GetRandomEasyChatWordFromGroup(...args: any[]): any {
...
export function GetRandomEasyChatWordFromUnlockedGroup(...args: any[]): any {
  if (!IsEasyChatGroupUnlocked(groupId))
...
export function UnlockRandomTrendySaying(): any {
  let i: any = null;
      ...
      let numUnlocked = GetNumTrendySayingsUnlocked();
...
export function GetRandomUnlockedEasyChatPokemon(): any {
  let i: any = null;
      ...
      for (i = 0; i < numWords; i++)
      {
          let dexNum = SpeciesToNationalPokedexNum(*species);
...
export function GetUnlockedEasyChatGroupId(...args: any[]): any {
...
export function SetSelectedWordGroup(...args: any[]): any {
  if (!inAlphabetMode)
...
export function GetWordFromSelectedGroup(...args: any[]): any {
...
export function SetSelectedWordGroup_GroupMode(...args: any[]): any {
  let i: any = null;
      let totalWords: any = null;
      let list: any = null;
      let wordInfo: any = null;
      let numWords = gEasyChatGroups[groupId].numWords;
      ...
      else
      {
          ...
          for (i = 0, totalWords = 0; i < numWords; i++)
          {
              let alphabeticalOrder = wordInfo[i].alphabeticalOrder;
...
export function SetSelectedWordGroup_AlphabetMode(...args: any[]): any {
  let i: any = null;
      let totalWords: any = null;
...
export function IsEasyChatGroupUnlocked2(...args: any[]): any {
  let i: any = null;
...
export function IsEasyChatIndexAndGroupUnlocked(...args: any[]): any {
  switch (groupId)
      {
      case EC_GROUP_POKEMON:
...
export function IsRestrictedWordSpecies(...args: any[]): any {
  let i: any = null;
...
export function IsEasyChatWordUnlocked(...args: any[]): any {
  let groupId = EC_GROUP(easyChatWord);
      let index = EC_INDEX(easyChatWord);
...
export function InitializeEasyChatWordArray(...args: any[]): any {
  let i: any = null;
...
export function InitQuestionnaireWords(): any {
  let i: any = null;
      let words = GetQuestionnaireWordsPtr();
      for (i = 0; i < NUM_QUESTIONNAIRE_WORDS; i++)
          words[i] = EC_EMPTY_WORD;
}

/** bool32 IsEasyChatAnswerUnlocked(int easyChatWord) */
export function IsEasyChatAnswerUnlocked(...args: any[]): any {
  let groupId = EC_GROUP(easyChatWord);
      let mask = EC_MASK_GROUP;
      let index = EC_INDEX(easyChatWord);
