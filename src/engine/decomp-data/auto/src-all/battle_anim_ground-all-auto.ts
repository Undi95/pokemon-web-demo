...
export function AnimBonemerangProjectile(...args: any[]): any {
...
export function AnimBonemerangProjectile_Step(...args: any[]): any {
...
export function AnimBonemerangProjectile_End(...args: any[]): any {
  if (TranslateAnimHorizontalArc(sprite))
          DestroyAnimSprite(sprite);
}

/** static void AnimBoneHitProjectile(struct Sprite *sprite) */
export function AnimBoneHitProjectile(...args: any[]): any {
...
export function AnimDirtScatter(...args: any[]): any {
...
export function AnimMudSportDirt(...args: any[]): any {
  sprite.oam.tileNum++;
...
export function AnimMudSportDirtRising(...args: any[]): any {
  if (++sprite.data[1] > 1)
      {
          sprite.data[1] = 0;
...
export function AnimMudSportDirtFalling(...args: any[]): any {
...
export function AnimTask_DigDownMovement(...args: any[]): any {
...
export function AnimTask_DigBounceMovement(...args: any[]): any {
  let y: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_DigEndBounceMovementSetInvisible(...args: any[]): any {
...
export function AnimTask_DigUpMovement(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_DigSetVisibleUnderground(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_DigRiseUpFromHole(...args: any[]): any {
  let var0: any = null;
      let task: any = gTasks[taskId];
...
export function SetDigScanlineEffect(...args: any[]): any {
  let bgX: any = null;
...
export function AnimDirtPlumeParticle(...args: any[]): any {
...
export function AnimDirtPlumeParticle_Step(...args: any[]): any {
  if (TranslateAnimHorizontalArc(sprite))
          DestroyAnimSprite(sprite);
}

/** static void AnimDigDirtMound(struct Sprite *sprite) */
export function AnimDigDirtMound(...args: any[]): any {
  let battler: any = null;
...
export function AnimTask_HorizontalShake(...args: any[]): any {
  let i: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_ShakePlatforms(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_ShakeBattlers(...args: any[]): any {
  let i: any = null;
      let task: any = gTasks[taskId];
...
export function SetBattlersXOffsetForShake(...args: any[]): any {
  let i: any = null;
      let xOffset: any = null;
...
export function AnimTask_IsPowerOver99(...args: any[]): any {
  gBattleAnimArgs[15] = gAnimMovePower > 99;
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_PositionFissureBgOnBattler(u8 taskId) */
export function AnimTask_PositionFissureBgOnBattler(...args: any[]): any {
  let newTask: any = null;
      let battler = (gBattleAnimArgs[0] & ANIM_TARGET) ? gBattleAnimTarget : gBattleAnimAttacker;
...
export function WaitForFissureCompletion(...args: any[]): any {
  let task: any = gTasks[taskId];
