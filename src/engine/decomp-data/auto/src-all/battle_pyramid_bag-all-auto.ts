...
const {
  ...
  CreateSwapLineSprites, CreateTask, CreateYesNoMenuWithCallbacks, DISPCNT_OBJ_1D_MAP,
  DISPCNT_OBJ_ON, DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram, DestroyListMenuTask,
  DestroySprite, DestroyTask, DisplayMessageAndContinueTask, DoScheduledBgTilemapCopiesToVram,
  DrawStdFrameWithCustomTileAndPalette, FALSE, FadeScreen, FillWindowPixelBuffer,
  ...
  GetItemBattleFunc, GetItemBattleUsage, GetItemDescription, GetItemFieldFunc,
  GetItemImportance, GetItemPocket, GetLRKeysPressed, GetMenuCursorDimensionByFont,
  GetMonData, GetPlayerTextSpeedDelay, GetStringCenterAlignXOffset, GetStringRightAlignXOffset,
  ITEM_TO_BERRY, InitBgsFromTemplates, InitMenuActionGrid, InitMenuInUpperLeftCornerNormal,
  InitWindows, IsWritingMailAllowed, ItemIsMail, JOY_NEW,
  ...
  LoadSpritePalette, LoadUserWindowBorderGfx, LockPlayerFieldControls, MenuHelpers_IsLinkActive,
  MenuHelpers_ShouldWaitForLinkRecv, Menu_GetCursorPos, Menu_ProcessInputNoWrap, NULL,
  PALETTES_ALL, PIXEL_FILL, PLTT_ID, PLTT_SIZE_4BPP,
  PlaySE, PrintMenuActionGrid, PrintMenuActionTexts, ProcessSpriteCopyRequests,
  PutWindowTilemap, REG_OFFSET_BLDCNT, RemovePyramidBagItem, RemoveScrollIndicatorArrowPair,
  ...
  SWAP, ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram, SetBgTilemapBuffer,
