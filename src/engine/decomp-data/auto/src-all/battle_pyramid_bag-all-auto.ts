...
export function Task_ChooseItemsToTossFromPyramidBag(...args: any[]): any {
...
export function GoToBattlePyramidBagMenu(...args: any[]): any {
...
export function SetBagItemsListTemplate(): any {
  let i: any = null;
      let itemIds = gSaveBlock2Ptr.frontier.pyramidBag.itemId[gSaveBlock2Ptr.frontier.lvlMode];
...
export function CopyBagItemName(...args: any[]): any {
...
export function BagCursorMoved(...args: any[]): any {
  if (onInit != TRUE)
      {
          PlaySE(SE_SELECT);
          ShakePyramidBag();
...
export function CreatePyramidBagInputTask(): any {
  let taskId = CreateTask(Task_HandlePyramidBagInput, 0);
...
export function SwapItems(...args: any[]): any {
  let temp: any = null;
      let itemIds = gSaveBlock2Ptr.frontier.pyramidBag.itemId[gSaveBlock2Ptr.frontier.lvlMode];
      let quantities = gSaveBlock2Ptr.frontier.pyramidBag.quantity[gSaveBlock2Ptr.frontier.lvlMode];
...
export function MovePyramidBagItemSlotInList(...args: any[]): any {
  let itemIds = gSaveBlock2Ptr.frontier.pyramidBag.itemId[gSaveBlock2Ptr.frontier.lvlMode];
      let quantities = gSaveBlock2Ptr.frontier.pyramidBag.quantity[gSaveBlock2Ptr.frontier.lvlMode];
      ...
      {
          let i: any = null;
          let firstSlotItemId = itemIds[from];
          let firstSlotQuantity = quantities[from];
...
export function PrintSelectorArrow(...args: any[]): any {
  let y = ListMenuGetYCoordForPrintingArrowCursor(listMenuTaskId);
      PrintSelectorArrowAtPos(y, colorId);
}

/** static void PrintSelectorArrowAtPos(u8 y, u8 colorId) */
export function PrintSelectorArrowAtPos(...args: any[]): any {
...
export function CloseBattlePyramidBag(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_ClosePyramidBag;
}

/** static void Task_ClosePyramidBag(u8 taskId) */
export function Task_ClosePyramidBag(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (!gPaletteFade.active)
      {
...
export function Task_HandlePyramidBagInput(...args: any[]): any {
  let data = gTasks[taskId].data;
      ...
      {
          let listId = ListMenu_ProcessInput(tListTaskId);
          ListMenuGetScrollAndRow(tListTaskId, gPyramidBagMenuState.scrollPosition, gPyramidBagMenuState.cursorPosition);
          switch (listId)
          {
...
export function PrintMenuActionText_SingleRow(...args: any[]): any {
...
export function PrintMenuActionText_MultiRow(...args: any[]): any {
...
export function HandleMenuActionInput_SingleRow(...args: any[]): any {
  if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
          let id = Menu_ProcessInputNoWrap();
          switch (id)
          {
...
export function HandleMenuActionInput_2x2(...args: any[]): any {
  if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
          let id = Menu_GetCursorPos();
          if (JOY_NEW(DPAD_UP))
          {
...
export function IsValidMenuAction(...args: any[]): any {
  if (actionTableId < 0)
          return FALSE;
...
export function BagAction_UseOnField(...args: any[]): any {
  let pocketId = GetItemPocket(gSpecialVar_ItemId);
...
export function BagAction_Cancel(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function SetTaskToMainPyramidBagInputHandler(...args: any[]): any {
  AddScrollArrows();
      gTasks[taskId].func = Task_HandlePyramidBagInput;
}

/** static void BagAction_Toss(u8 taskId) */
export function BagAction_Toss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function AskConfirmToss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DontTossItem(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function UpdateNumToToss(...args: any[]): any {
  let x: any = null;
...
export function TossItem(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_TossItem(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function BagAction_Give(...args: any[]): any {
  CloseMenuActionWindow();
...
export function ShowCantHoldMessage(...args: any[]): any {
  CopyItemName(gSpecialVar_ItemId, gStringVar1);
...
export function Task_WaitCloseErrorMessage(...args: any[]): any {
  if (JOY_NEW(A_BUTTON))
      {
          PlaySE(SE_SELECT);
...
export function Task_CloseBattlePyramidBagMessage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function TryCloseBagToGiveItem(...args: any[]): any {
...
export function BagAction_UseInBattle(...args: any[]): any {
...
export function Task_BeginItemSwap(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ItemSwapHandleInput(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
          if (JOY_NEW(SELECT_BUTTON))
...
export function PerformItemSwap(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollOffset = gPyramidBagMenuState.scrollPosition;
      let selectedRow = gPyramidBagMenuState.cursorPosition;
      let swapPos = *scrollOffset + *selectedRow;
...
export function TryStoreHeldItemsInPyramidBag(): any {
  let i: any = null;
      ...
      let newItems = Alloc(PYRAMID_BAG_ITEMS_COUNT * sizeof(*newItems));
      let newQuantities = Alloc(PYRAMID_BAG_ITEMS_COUNT * sizeof(*newQuantities));
...
export function PyramidBagPrint(...args: any[]): any {
...
export function PyramidBagPrint_Quantity(...args: any[]): any {
...
export function DrawTossNumberWindow(...args: any[]): any {
  DrawStdFrameWithCustomTileAndPalette(windowId, FALSE, 1, 0xE);
      ScheduleBgCopyTilemapToVram(1);
}

/** static u8 OpenMenuActionWindowById(u8 windowArrayId) */
export function OpenMenuActionWindowById(...args: any[]): any {
  let windowId = gPyramidBagMenu.windowIds[windowArrayId];
...
export function CloseMenuActionWindowById(...args: any[]): any {
  let windowId = gPyramidBagMenu.windowIds[windowArrayId];
      if (*windowId != WINDOW_NONE)
      {
...
export function CreatePyramidBagYesNo(...args: any[]): any {
...
export function DisplayItemMessageInBattlePyramid(...args: any[]): any {
...
export function FreeItemIconSprite(...args: any[]): any {
  let spriteId = gPyramidBagMenu.spriteIds[spriteArrId];
...
export function LoadPyramidBagPalette(): any {
  let spritePalette: any = null;
      let palPtr = Alloc(2 * PLTT_SIZE_4BPP);
...
export function CreatePyramidBagSprite(): any {
  let spriteId = gPyramidBagMenu.spriteIds[PBAG_SPRITE_BAG];
...
export function SpriteCB_BagWaitForShake(...args: any[]): any {
  if (sprite.affineAnimEnded)
      {
...
export function ShowItemIcon(...args: any[]): any {
  let itemSpriteId: any = null;
      let spriteId = gPyramidBagMenu.spriteIds[isAlt + PBAG_SPRITE_ITEM_ICON];
      if (*spriteId == SPRITE_NONE)
      {
...
export function FreeItemIconSpriteByAltId(...args: any[]): any {
...
export function SetSwapLineInvisibility(...args: any[]): any {
...
export function UpdateSwapLinePos(...args: any[]): any {
