...
const {
  ARRAY_COUNT, AddBagItem, AddItemIconSprite, AddScrollArrows,
  ...
  AskConfirmToss, BG_PLTT_ID, BeginNormalPaletteFade, BlendPalettes,
  BuildOamBuffer, CancelItemSwap, ChangeMenuGridCursorPosition, CleanupOverworldWindowsAndTilemaps,
  ...
  CreatePyramidBagInputTask, CreatePyramidBagSprite, CreatePyramidBagYesNo, CreateSprite,
  CreateSwapLine, CreateSwapLineSprites, CreateTask, CreateYesNoMenuWithCallbacks,
  DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram, DestroyListMenuTask, DestroySprite,
  DestroyTask, DisplayItemMessageInBattlePyramid, DisplayMessageAndContinueTask, DoScheduledBgTilemapCopiesToVram,
  DontTossItem, DrawStdFrameWithCustomTileAndPalette, DrawTossNumberWindow, FadeScreen,
  FillWindowPixelBuffer, FillWindowPixelRect, Free, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreeItemIconSprite, FreeItemIconSpriteByAltId, FreeSpriteOamMatrix,
  FreeSpritePaletteByTag, FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, GetItemBattleFunc,
  GetItemBattleUsage, GetItemDescription, GetItemFieldFunc, GetItemImportance,
  GetItemPocket, GetLRKeysPressed, GetMenuCursorDimensionByFont, GetMonData,
  GetPlayerTextSpeedDelay, GetStringCenterAlignXOffset, GetStringRightAlignXOffset, GoToBattlePyramidBagMenu,
  ITEM_TO_BERRY, InitBgsFromTemplates, InitMenuActionGrid, InitMenuInUpperLeftCornerNormal,
  InitPyramidBagBgs, InitPyramidBagScroll, InitPyramidBagWindows, InitWindows,
  IsValidMenuAction, IsWritingMailAllowed, ItemIsMail, JOY_NEW,
  LZDecompressWram, ListMenuGetScrollAndRow, ListMenuGetYCoordForPrintingArrowCursor, ListMenuInit,
  ListMenuSetTemplateField, ListMenu_ProcessInput, LoadCompressedPalette, LoadCompressedSpriteSheet,
  LoadListMenuSwapLineGfx, LoadMessageBoxGfx, LoadOam, LoadPalette,
  LoadPyramidBagGfx, LoadPyramidBagMenu, LoadPyramidBagPalette, LoadSpritePalette,
  LoadUserWindowBorderGfx, LockPlayerFieldControls, MenuHelpers_IsLinkActive, MenuHelpers_ShouldWaitForLinkRecv,
  Menu_GetCursorPos, Menu_ProcessInputNoWrap, MovePyramidBagItemSlotInList, OpenContextMenu,
  OpenMenuActionWindowById, PIXEL_FILL, PLTT_ID, PerformItemSwap,
  PlaySE, PrintItemDescription, PrintMenuActionGrid, PrintMenuActionText_MultiRow,
  PrintMenuActionText_SingleRow, PrintMenuActionTexts, PrintSelectorArrow, PrintSelectorArrowAtPos,
  ProcessSpriteCopyRequests, PutWindowTilemap, PyramidBagPrint, PyramidBagPrint_Quantity,
  RemovePyramidBagItem, RemoveScrollArrow, RemoveScrollIndicatorArrowPair, RemoveWindow,
  ...
  SWAP, ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram, SetBagItemsListTemplate,
  SetBgTilemapBuffer, SetGpuReg, SetMainCallback2, SetMonData,
  SetSwapLineInvisibility, SetSwapLineSpritesInvisibility, SetTaskToMainPyramidBagInputHandler, SetVBlankCallback,
  SetVBlankHBlankCallbacksToNull, ShakePyramidBag, ShowBg, ShowCantHoldMessage,
  ShowItemIcon, ShowNumToToss, StartSpriteAffineAnim, StringCopy,
  StringExpandPlaceholders, SwapItems, Task_BeginItemSwap, Task_CloseBattlePyramidBagMessage,
  TransferPlttBuffer, TryCloseBagToGiveItem, UpdateNumToToss, UpdatePaletteFade,
  UpdatePyramidBagCursorPos, UpdatePyramidBagList, UpdateSwapLinePos, UpdateSwapLineSpritesPos,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
