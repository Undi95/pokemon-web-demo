...
export function CreateAvailableDecorationsMenu(...args: any[]): any {
  let i: any = null;
      let data = gTasks[taskId].data;
      let trader: any = gSaveBlock1Ptr.oldMan.trader;
      let windowTemplate: any = [
          .bg = 0,
          .tilemapLeft = 1,
          .tilemapTop = 1,
          .width = 10,
      ...
      let windowWidth = GetStringWidth(FONT_NORMAL, gText_Exit, 0);
      let fiveMarksWidth = GetStringWidth(FONT_NORMAL, gText_FiveMarks, 0);
      for (i = 0; i < NUM_TRADER_ITEMS; i++)
      {
...
export function Task_BufferDecorSelectionAndCloseWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleGetDecorationMenuInput(...args: any[]): any {
  let trader: any = gSaveBlock1Ptr.oldMan.trader;
...
export function DecorationItemsMenuAction_Trade(...args: any[]): any {
...
export function ExitTraderMenu(...args: any[]): any {
...
export function TraderMenuGetDecoration(): any {
  let taskId = CreateTask(Task_HandleGetDecorationMenuInput, 0);
