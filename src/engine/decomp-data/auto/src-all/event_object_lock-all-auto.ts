...
export function Task_FreezePlayer(...args: any[]): any {
...
export function Task_FreezeSelectedObjectAndPlayer(...args: any[]): any {
...
export function ScriptUnfreezeObjectEvents(): any {
  let playerObjectId = GetObjectEventIdByLocalIdAndMap(LOCALID_PLAYER, 0, 0);
...
export function Task_FreezeObjectAndPlayer(...args: any[]): any {
  let task: any = gTasks[taskId];
      let objectEventId = task.tObjectId;
