...
export function AddCameraTileOffset(cameraOffset: any, xOffset: any, yOffset: any): any {
...
export function AddCameraPixelOffset(cameraOffset: any, xOffset: any, yOffset: any): any {
...
export function GetCameraOffsetWithPan(x: any, y: any): any {
...
export function DrawWholeMapViewInternal(x: any, y: any, mapLayout: any): any {
  let i: any = null;
      let j: any = null;
      let r6: any = null;
      let temp: any = null;
...
export function RedrawMapSlicesForCameraUpdate(cameraOffset: any, x: any, y: any): any {
...
export function RedrawMapSliceNorth(cameraOffset: any, mapLayout: any): any {
  let i: any = null;
      let temp: any = null;
      let r7: any = null;
...
export function RedrawMapSliceSouth(cameraOffset: any, mapLayout: any): any {
  let i: any = null;
      let temp: any = null;
      let r7: any = cameraOffset.yTileOffset * 32;
...
export function RedrawMapSliceEast(cameraOffset: any, mapLayout: any): any {
  let i: any = null;
      let temp: any = null;
      let r6: any = cameraOffset.xTileOffset;
...
export function RedrawMapSliceWest(cameraOffset: any, mapLayout: any): any {
  let i: any = null;
      let temp: any = null;
      let r5: any = cameraOffset.xTileOffset + 28;
...
export function CurrentMapDrawMetatileAt(x: any, y: any): any {
  let offset: any = MapPosToBgTilemapOffset(sFieldCameraOffset, x, y);
...
export function DrawDoorMetatileAt(x: any, y: any, tiles: any): any {
  let offset: any = MapPosToBgTilemapOffset(sFieldCameraOffset, x, y);
...
export function DrawMetatileAt(mapLayout: any, offset: any, x: any, y: any): any {
...
export function DrawMetatile(metatileLayerType: any, tiles: any, offset: any): any {
...
export function MapPosToBgTilemapOffset(cameraOffset: any, x: any, y: any): any {
...
export function CameraUpdateCallback(fieldCamera: any): any {
...
export function InitCameraUpdateCallback(trackedSpriteId: any): any {
...
export function MoveCameraAndRedrawMap(deltaX: any, deltaY: any): any {
  CameraMove(deltaX, deltaY);
      UpdateObjectEventsForCameraUpdate(deltaX, deltaY);
      DrawWholeMapView();
...
export function SetCameraPanningCallback(callback: any): any {
  sFieldCameraPanningCallback = callback;
}

/** void SetCameraPanning(s16 horizontal, s16 vertical) */
export function SetCameraPanning(horizontal: any, vertical: any): any {
...
export function CameraPanningCB_PanAhead(): any {
  let _var: any = null;
      ...
      else
      {
          ...
          _var = GetPlayerMovementDirection();
          if (_var == 2)
          {
