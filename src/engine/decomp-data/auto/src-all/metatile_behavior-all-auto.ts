...
const {
  MetatileBehavior_IsEncounterTile, MetatileBehavior_IsPacifidlogLog, MetatileBehavior_IsSurfableWaterOrUnderwater, MetatileBehavior_IsWaterfall,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
