...
const {
  DIR_NORTH, FALSE, MB_ANIMATED_DOOR, MB_AQUA_HIDEOUT_WARP,
  MB_ASHGRASS, MB_BATTLE_PYRAMID_WARP, MB_BERRY_TREE_SOIL, MB_BIKE_BRIDGE_OVER_BARRIER,
  MB_BLUEPRINT, MB_BOOKSHELF, MB_BRIDGE_OVER_OCEAN, MB_BRIDGE_OVER_POND_HIGH,
  MB_BRIDGE_OVER_POND_HIGH_EDGE_1, MB_BRIDGE_OVER_POND_HIGH_EDGE_2, MB_BRIDGE_OVER_POND_LOW, MB_BRIDGE_OVER_POND_MED,
  MB_BRIDGE_OVER_POND_MED_EDGE_1, MB_BRIDGE_OVER_POND_MED_EDGE_2, MB_BUMPY_SLOPE, MB_CABLE_BOX_RESULTS_1,
  MB_CABLE_BOX_RESULTS_2, MB_CLOSED_SOOTOPOLIS_DOOR, MB_COUNTER, MB_CRACKED_FLOOR,
  MB_CRACKED_FLOOR_HOLE, MB_CRACKED_ICE, MB_DEEP_SAND, MB_DEEP_SOUTH_WARP,
  MB_DEEP_WATER, MB_DOWN_ESCALATOR, MB_EASTWARD_CURRENT, MB_EAST_ARROW_WARP,
  MB_FOOTPRINTS, MB_FORTREE_BRIDGE, MB_HOLDS_LARGE_DECORATION, MB_HOLDS_SMALL_DECORATION,
  MB_HORIZONTAL_RAIL, MB_HOT_SPRINGS, MB_ICE, MB_IMPASSABLE_EAST,
  MB_IMPASSABLE_NORTH, MB_IMPASSABLE_NORTHEAST, MB_IMPASSABLE_NORTHWEST, MB_IMPASSABLE_SOUTH,
  MB_IMPASSABLE_SOUTHEAST, MB_IMPASSABLE_SOUTHWEST, MB_IMPASSABLE_SOUTH_AND_NORTH, MB_IMPASSABLE_WEST,
  MB_IMPASSABLE_WEST_AND_EAST, MB_INDOOR_ENCOUNTER, MB_INTERIOR_DEEP_WATER, MB_ISOLATED_HORIZONTAL_RAIL,
  MB_ISOLATED_VERTICAL_RAIL, MB_JUMP_EAST, MB_JUMP_NORTH, MB_JUMP_SOUTH,
  MB_JUMP_WEST, MB_LADDER, MB_LAVARIDGE_GYM_1F_WARP, MB_LAVARIDGE_GYM_B1F_WARP,
  MB_LONG_GRASS, MB_LONG_GRASS_SOUTH_EDGE, MB_MOSSDEEP_GYM_WARP, MB_MOUNTAIN_TOP,
  MB_MT_PYRE_HOLE, MB_MUDDY_SLOPE, MB_NON_ANIMATED_DOOR, MB_NORMAL,
  MB_NORTHWARD_CURRENT, MB_NORTH_ARROW_WARP, MB_NO_RUNNING, MB_NO_SURFACING,
  MB_OCEAN_WATER, MB_PACIFIDLOG_HORIZONTAL_LOG_LEFT, MB_PACIFIDLOG_HORIZONTAL_LOG_RIGHT, MB_PACIFIDLOG_VERTICAL_LOG_BOTTOM,
  MB_PACIFIDLOG_VERTICAL_LOG_TOP, MB_PC, MB_PETALBURG_GYM_DOOR, MB_PICTURE_BOOK_SHELF,
  MB_PLAYER_ROOM_PC_ON, MB_POKEBLOCK_FEEDER, MB_POKEMON_CENTER_BOOKSHELF, MB_POND_WATER,
  MB_PUDDLE, MB_QUESTIONNAIRE, MB_REFLECTION_UNDER_BRIDGE, MB_REGION_MAP,
  MB_ROULETTE, MB_RUNNING_SHOES_INSTRUCTION, MB_SAND, MB_SEAWEED,
  MB_SEAWEED_NO_SURFACING, MB_SECRET_BASE_BALLOON, MB_SECRET_BASE_BREAKABLE_DOOR, MB_SECRET_BASE_HOLE,
  MB_SECRET_BASE_NORTH_WALL, MB_SECRET_BASE_PC, MB_SECRET_BASE_REGISTER_PC, MB_SHALLOW_WATER,
  MB_SHOAL_CAVE_ENTRANCE, MB_SHOP_SHELF, MB_SHORT_GRASS, MB_SKY_PILLAR_CLOSED_DOOR,
  MB_SLIDE_EAST, MB_SLIDE_NORTH, MB_SLIDE_SOUTH, MB_SLIDE_WEST,
  MB_SOOTOPOLIS_DEEP_WATER, MB_SOUTHWARD_CURRENT, MB_SOUTH_ARROW_WARP, MB_STAIRS_OUTSIDE_ABANDONED_SHIP,
  MB_TALL_GRASS, MB_TELEVISION, MB_THIN_ICE, MB_TRAINER_HILL_TIMER,
  MB_TRASH_CAN, MB_TRICK_HOUSE_PUZZLE_8_FLOOR, MB_TRICK_HOUSE_PUZZLE_DOOR, MB_UP_ESCALATOR,
  MB_VASE, MB_VERTICAL_RAIL, MB_WALK_EAST, MB_WALK_NORTH,
  MB_WALK_SOUTH, MB_WALK_WEST, MB_WATERFALL, MB_WATER_DOOR,
  MB_WATER_SOUTH_ARROW_WARP, MB_WESTWARD_CURRENT, MB_WEST_ARROW_WARP, MB_WIRELESS_BOX_RESULTS,
