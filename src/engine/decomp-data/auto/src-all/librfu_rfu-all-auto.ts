...
export function rfu_initializeAPI(...args: any[]): any {
  let i: any = null;
      let dst: any = null;
      let src: any = null;
...
export function rfu_UNI_PARENT_getDRAC_ACK(...args: any[]): any {
  let buf: any = null;
...
export function rfu_STC_REQ_callback(...args: any[]): any {
...
export function rfu_CB_defaultCallback(...args: any[]): any {
...
export function rfu_getRFUStatus(...args: any[]): any {
...
export function rfu_MBOOT_CHILD_inheritanceLinkStatus(): any {
  let s1 = str_checkMbootLL;
      let s2 = (char *)(IWRAM_START + 0xF0);
      ...
      if (checksum != *(u16 *)(IWRAM_START + 0xFA))
          return 1;
      CpuCopy16(IWRAM_START, gRfuLinkStatus, sizeof(struct RfuLinkStatus));
...
export function rfu_CB_stopMode(...args: any[]): any {
  if (reqResult == 0)
          REG_SIOCNT = SIO_MULTI_MODE;
...
export function rfu_CB_reset(...args: any[]): any {
  if (reqResult == 0)
          rfu_STC_clearAPIVariables();
      rfu_STC_REQ_callback(reqCommand, reqResult);
}
...
export function rfu_REQ_configSystem(...args: any[]): any {
  STWI_set_Callback_M(rfu_STC_REQ_callback);
...
export function rfu_REQ_configGameData(...args: any[]): any {
  const packet: any[] = [];
      let i: any = null;
      let check_sum: any = null;
      let gnameBackup = gname;
...
export function rfu_CB_configGameData(...args: any[]): any {
...
export function rfu_CB_startSearchChild(...args: any[]): any {
  if (reqResult == 0)
...
export function rfu_STC_clearLinkStatus(...args: any[]): any {
  let i: any = null;
...
export function rfu_CB_pollAndEndSearchChild(...args: any[]): any {
  if (reqResult == 0)
...
export function rfu_STC_readChildList(): any {
  let stwiParam: any = null;
      let numSlots = gRfuFixed.STWIBuffer.rxPacketAlloc.rfuPacket8.data[1];
      let data_p: any = null;
      let i: any = null;
...
export function rfu_CB_startSearchParent(...args: any[]): any {
  if (reqResult == 0)
...
export function rfu_CB_pollSearchParent(...args: any[]): any {
  if (reqResult == 0)
...
export function rfu_REQ_startConnectParent(...args: any[]): any {
  let result = 0;
      let i: any = null;
...
export function rfu_CB_pollConnectParent(...args: any[]): any {
  let id: any = null;
      let slot: any = null;
      let bm_slot_flag, i;
...
export function rfu_getConnectParentStatus(...args: any[]): any {
  let packet_p: any = null;
...
export function rfu_REQBN_watchLink(...args: any[]): any {
  let reasonMaybe = 0;
      let reqResult = 0;
      let i: any = null;
      ...
      *parentBmLinkRecoverySlot = 0;
      ...
      {
          let packet_p_2 = gRfuFixed.STWIBuffer.rxPacketAlloc.rfuPacket8.data;
...
export function rfu_STC_removeLinkData(...args: any[]): any {
  let bmLinkLossFlag = 1 << bmConnectedPartnerId;
...
export function rfu_REQ_disconnect(...args: any[]): any {
  let result: any = null;
...
export function rfu_CB_disconnect(...args: any[]): any {
  let i, bm_slot_flag;
...
export function rfu_REQ_CHILD_startConnectRecovery(...args: any[]): any {
  let i: any = null;
...
export function rfu_CB_CHILD_pollConnectRecovery(...args: any[]): any {
  let bm_slot_flag, i;
...
export function rfu_CHILD_getConnectRecoveryStatus(...args: any[]): any {
  *status = 0xFF;
...
export function rfu_STC_fastCopy(...args: any[]): any {
  let src = *src_p;
      let dst = *dst_p;
      let i: any = null;
...
export function rfu_getMasterSlave(): any {
  let masterSlave = STWI_read_status(1);
...
export function rfu_STC_releaseFrame(...args: any[]): any {
...
export function rfu_clearSlot(...args: any[]): any {
...
export function rfu_setRecvBuffer(...args: any[]): any {
...
export function rfu_NI_setSendData(...args: any[]): any {
...
export function rfu_UNI_setSendData(...args: any[]): any {
...
export function rfu_NI_CHILD_setSendGameName(...args: any[]): any {
...
export function rfu_STC_setSendData_org(...args: any[]): any {
  let bm_slot_id, sendSlotFlag;
      let frameSize: any = null;
      let llFrameSize_p = NULL;
...
export function rfu_changeSendTarget(...args: any[]): any {
...
export function rfu_NI_stopReceivingData(...args: any[]): any {
  let imeBak: any = null;
      let NI_comm: any = null;
...
export function rfu_UNI_changeAndReadySendData(...args: any[]): any {
...
export function rfu_UNI_readySendData(...args: any[]): any {
  if (slotStatusIndex < RFU_CHILD_MAX)
      {
          if (gRfuSlotStatusUNI[slotStatusIndex].send.state == SLOT_STATE_SEND_UNI)
...
export function rfu_UNI_clearRecvNewDataFlag(...args: any[]): any {
  if (slotStatusIndex < RFU_CHILD_MAX)
          gRfuSlotStatusUNI[slotStatusIndex].recv.newDataFlag = 0;
}

/** void rfu_REQ_sendData(bool8 clockChangeFlag) */
export function rfu_REQ_sendData(...args: any[]): any {
  if (gRfuLinkStatus.parentChild != MODE_NEUTRAL)
      {
          if (gRfuLinkStatus.parentChild == MODE_PARENT
...
export function rfu_CB_sendData(...args: any[]): any {
  let i: any = null;
      let NI_comm: any = null;
...
export function rfu_CB_sendData2(...args: any[]): any {
  rfu_STC_REQ_callback(ID_DATA_TX_REQ, reqResult);
}

/** static void rfu_CB_sendData3(u8 reqCommand, u16 reqResult) */
export function rfu_CB_sendData3(...args: any[]): any {
  if (reqResult != 0)
          rfu_STC_REQ_callback(ID_DATA_TX_REQ, reqResult);
  ...
  let pakcketSize, currSize;
       ...
       && gRfuLinkStatus.sendSlotNIFlag | gRfuLinkStatus.recvSlotNIFlag | gRfuLinkStatus.sendSlotUNIFlag)
      {
          ...
          if (pakcketSize != 0)
          {
              ...
              {
                  let maxSize = llf_p - offsetof(struct RfuFixed, LLFBuffer[1]);
...
export function rfu_STC_NI_constructLLSF(...args: any[]): any {
  let size: any = null;
      let frame: any = null;
      let i: any = null;
      ...
      if (size != 0)
      {
          let src = NI_comm.now_p[NI_comm.phase];
...
export function rfu_STC_UNI_constructLLSF(...args: any[]): any {
  let llsf: any = null;
      let src_p: any = null;
      let frame: any = null;
      let frame8_p: any = null;
...
export function rfu_CB_recvData(...args: any[]): any {
  let i: any = null;
      let slotStatusNI: any = null;
      let NI_comm: any = null;
...
export function rfu_STC_PARENT_analyzeRecvPacket(): any {
  let frames32: any = null;
      ...
      for (bm_slot_id = 0; bm_slot_id < RFU_CHILD_MAX; ++bm_slot_id)
      {
          ...
          {
              let frames_p = frame_counts[bm_slot_id];

              do
              {
                  let analyzed_frames = rfu_STC_analyzeLLSF(bm_slot_id, packet_p, *frames_p);
...
export function rfu_STC_analyzeLLSF(...args: any[]): any {
  let llsf_NI: any = null;
      ...
      if (llsf_NI.recvFirst == 0)
      {
          ...
          {
              let conSlots = gRfuLinkStatus.connSlotFlag & llsf_NI.connSlotFlag;
...
export function rfu_STC_UNI_receive(...args: any[]): any {
  let dest: any = null;
      let size: any = null;
...
export function rfu_STC_NI_receive_Sender(...args: any[]): any {
  let NI_comm: any = gRfuSlotStatusNI[NI_slot].send;
      let state = NI_comm.state;
      let n = NI_comm.n[llsf_NI.phase];
      let i: any = null;
      let imeBak: any = null;
...
export function rfu_STC_NI_receive_Receiver(...args: any[]): any {
  let imeBak: any = null;
      let state_check = 0;
      let slotStatus_NI: any = gRfuSlotStatusNI[bm_slot_id];
      let recvSlot: any = slotStatus_NI.recv;
      let state = slotStatus_NI.recv.state;
      let n = slotStatus_NI.recv.n[llsf_NI.phase];
...
export function rfu_STC_NI_initSlot_asRecvControllData(...args: any[]): any {
  let llFrameSize_p: any = null;
...
export function rfu_STC_NI_initSlot_asRecvDataEntity(...args: any[]): any {
