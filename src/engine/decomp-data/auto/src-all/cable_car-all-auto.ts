...
const {
  ...
  CreateObjectGraphicsSprite, CreateSprite, CreateTask, DISPCNT_OBJ_1D_MAP,
  DISPCNT_OBJ_ON, DISPLAY_HEIGHT, DecompressAndCopyTileDataToVram, DestroySprite,
  DestroyTask, DmaFill16Defvars, DmaFill32Defvars, DmaFillLarge16,
  FALSE, FREE_AND_SET_NULL, FadeInNewBGM, FadeOutBGM,
  ...
  NULL, PALETTES_ALL, PLTT_SIZE, PLTT_SIZE_4BPP,
  ...
  REG_OFFSET_BG3VOFS, REG_OFFSET_BLDCNT, REG_OFFSET_WIN0H, REG_OFFSET_WIN0V,
  ...
  S16TOPOSFLOAT, ScanlineEffect_Stop, SetBgTilemapBuffer, SetCurrentAndNextWeatherNoDelay,
  SetGpuReg, SetMainCallback2, SetNextWeather, SetVBlankCallback,
  ShowBg, StartSpriteAnim, StartWeather, TRUE,
