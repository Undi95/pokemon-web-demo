...
export function Task_LoadCableCar(...args: any[]): any {
...
export function Task_CableCar(...args: any[]): any {
  let i = 0;
...
export function Task_AnimateBgGoingUp(...args: any[]): any {
...
export function Task_AnimateBgGoingDown(...args: any[]): any {
  if (sCableCar.state != STATE_END)
      {
          sCableCar.bg3HorizontalOffset++;
          if ((sCableCar.timer % 2) == 0)
...
export function SpriteCB_CableCar(...args: any[]): any {
  if (sCableCar.state != STATE_END)
      {
          if (!GOING_DOWN)
          {
...
export function SpriteCB_HikerGoingUp(...args: any[]): any {
  if (sprite.sTimer == 0)
      {
...
export function SpriteCB_HikerGoingDown(...args: any[]): any {
  if (sprite.sTimer == 0)
          sprite.y += 16 + sprite.centerToCornerVecY;
...
export function SetBgRegs(...args: any[]): any {
  switch (active)
      {
      case FALSE:
      default:
...
export function InitGroundTilemapData(...args: any[]): any {
  switch (goingDown)
      {
          case FALSE:
          default:
