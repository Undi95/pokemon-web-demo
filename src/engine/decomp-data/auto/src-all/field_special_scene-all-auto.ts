...
export function GetTruckCameraBobbingY(...args: any[]): any {
  if (!(time % 120))
          return -1;
      else if ((time % 10) <= 4)
          return 1;
...
export function GetTruckBoxYMovement(...args: any[]): any {
  if (!((time + 120) % 180))
          return -1;
...
export function Task_Truck1(...args: any[]): any {
...
export function Task_Truck2(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_Truck3(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleTruckSequence(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function EndTruckSequence(...args: any[]): any {
...
export function Task_HandlePorthole(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ShowSSTidalWhileSailing(): any {
  let spriteId = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_SS_TIDAL, SpriteCallbackDummy, 112, 80, 0);
