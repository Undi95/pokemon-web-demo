...
export function ChooseMoveAndTargetInBattlePalace(): any {
  let i, var1, var2;
      ...
      let unusableMovesBits = CheckMoveLimitations(gActiveBattler, 0, MOVE_LIMITATIONS_ALL);
...
export function GetBattlePalaceMoveGroup(...args: any[]): any {
...
export function SpriteCB_WaitForBattlerBallReleaseAnim(...args: any[]): any {
...
export function SpriteCB_TrainerSlideIn(...args: any[]): any {
...
export function SpriteCB_TrainerSlideVertical(...args: any[]): any {
  sprite.y2 -= 2;
      if (sprite.y2 == 0)
          sprite.callback = SpriteCallbackDummy;
}
...
export function InitAndLaunchChosenStatusAnimation(...args: any[]): any {
...
export function TryHandleLaunchBattleTableAnimation(...args: any[]): any {
  let taskId: any = null;
...
export function Task_ClearBitWhenBattleTableAnimDone(...args: any[]): any {
  gAnimScriptCallback();
...
export function ShouldAnimBeDoneRegardlessOfSubstitute(...args: any[]): any {
  switch (animId)
      {
...
export function InitAndLaunchSpecialAnimation(...args: any[]): any {
  let taskId: any = null;
...
export function Task_ClearBitWhenSpecialAnimDone(...args: any[]): any {
  gAnimScriptCallback();
      if (!gAnimScriptActive)
      {
...
export function IsMoveWithoutAnimation(...args: any[]): any {
  return FALSE;
}

/** bool8 IsBattleSEPlaying(u8 battler) */
export function IsBattleSEPlaying(...args: any[]): any {
  let zero = 0;
...
export function BattleLoadOpponentMonSpriteGfx(...args: any[]): any {
...
export function BattleLoadPlayerMonSpriteGfx(...args: any[]): any {
  let monsPersonality, currentPersonality, otId;
      let species: any = null;
      let position: any = null;
      let paletteOffset: any = null;
...
export function DecompressTrainerFrontPic(...args: any[]): any {
...
export function DecompressTrainerBackPic(...args: any[]): any {
  let position = GetBattlerPosition(battler);
...
export function FreeTrainerFrontPicPalette(...args: any[]): any {
...
export function BattleLoadAllHealthBoxesGfx(...args: any[]): any {
  let retVal = FALSE;
...
export function LoadBattleBarGfx(...args: any[]): any {
...
export function BattleInitAllSprites(...args: any[]): any {
  let retVal = FALSE;
...
export function CopyBattleSpriteInvisibility(...args: any[]): any {
...
export function HandleSpeciesGfxDataChange(...args: any[]): any {
  let paletteOffset: any = null;
...
export function BattleLoadSubstituteOrMonSpriteGfx(...args: any[]): any {
...
export function LoadBattleMonGfxAndAnimate(...args: any[]): any {
...
export function TrySetBehindSubstituteSpriteBit(...args: any[]): any {
  if (move == MOVE_SUBSTITUTE)
          gBattleSpritesDataPtr.battlerData[battler].behindSubstitute = 1;
}

/** void ClearBehindSubstituteBit(u8 battler) */
export function ClearBehindSubstituteBit(...args: any[]): any {
  gBattleSpritesDataPtr.battlerData[battler].behindSubstitute = 0;
}

/** void HandleLowHpMusicChange(struct Pokemon *mon, u8 battler) */
export function HandleLowHpMusicChange(...args: any[]): any {
  let hp = GetMonData(mon, MON_DATA_HP);
      let maxHP = GetMonData(mon, MON_DATA_MAX_HP);
...
export function BattleStopLowHpSound(): any {
  let playerBattler = GetBattlerAtPosition(B_POSITION_PLAYER_LEFT);
...
export function GetMonHPBarLevel(...args: any[]): any {
  let hp = GetMonData(mon, MON_DATA_HP);
      let maxHP = GetMonData(mon, MON_DATA_MAX_HP);
...
export function HandleBattleLowHpMusicChange(): any {
  if (gMain.inBattle)
      {
          let playerBattler1 = GetBattlerAtPosition(B_POSITION_PLAYER_LEFT);
          let playerBattler2 = GetBattlerAtPosition(B_POSITION_PLAYER_RIGHT);
          let battler1PartyId = GetPartyIdFromBattlePartyId(gBattlerPartyIndexes[playerBattler1]);
          let battler2PartyId = GetPartyIdFromBattlePartyId(gBattlerPartyIndexes[playerBattler2]);
...
export function SetBattlerSpriteAffineMode(...args: any[]): any {
  let i: any = null;
...
export function SpriteCB_EnemyShadow(...args: any[]): any {
  let invisible = FALSE;
      let battler = shadowSprite.tBattlerId;
...
export function SpriteCB_SetInvisible(...args: any[]): any {
  sprite.invisible = TRUE;
}

/** void SetBattlerShadowSpriteCallback(u8 battler, u16 species) */
export function SetBattlerShadowSpriteCallback(...args: any[]): any {
  if (GetBattlerSide(battler) == B_SIDE_PLAYER)
          return;
...
export function HideBattlerShadowSprite(...args: any[]): any {
  gSprites[gBattleSpritesDataPtr.healthBoxesData[battler].shadowSpriteId].callback = SpriteCB_SetInvisible;
}

/** void FillAroundBattleWindows(void) */
export function FillAroundBattleWindows(): any {
  let vramPtr = (u16 *)(VRAM + 0x240);
      let i: any = null;
      let j: any = null;
...
export function ClearTemporarySpeciesSpriteData(...args: any[]): any {
...
export function ShouldPlayNormalMonCry(...args: any[]): any {
  let hp, maxHP;
