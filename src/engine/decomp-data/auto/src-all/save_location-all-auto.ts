...
const {
  IsCurMapInEmptyList, IsCurMapInLocationList, IsCurMapPokeCenter, IsCurMapReloadLocation,
  TrySetPokeCenterWarpStatus, TrySetReloadWarpStatus, TrySetUnknownWarpStatus,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
