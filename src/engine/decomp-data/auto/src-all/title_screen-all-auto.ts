...
const {
  ...
  Cos, CreateCopyrightBanner, CreatePressStartBanner, CreateSprite,
  CreateTask, DestroySprite, DmaFill16, DmaFill32,
  EnableInterrupts, FadeOutBGM, FreeAllSpritePalettes, JOY_HELD,
  ...
  ResetSpriteData, ResetTasks, RunTasks, ScanlineEffect_InitHBlankDmaTransfer,
  ScanlineEffect_InitWave, ScanlineEffect_Stop, SetGpuReg, SetMainCallback2,
  SetVBlankCallback, StartPokemonLogoShine, StartSpriteAnim, TransferPlttBuffer,
  UpdateLegendaryMarkingColor, UpdatePaletteFade, _RGB,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
