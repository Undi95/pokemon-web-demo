...
export function SpriteCB_VersionBannerLeft(...args: any[]): any {
...
export function SpriteCB_VersionBannerRight(...args: any[]): any {
  if (gTasks[sprite.sParentTaskId].tSkipToNext)
      {
          sprite.oam.objMode = ST_OAM_OBJ_NORMAL;
          sprite.y = VERSION_BANNER_Y_GOAL;
...
export function SpriteCB_PressStartCopyrightBanner(...args: any[]): any {
...
export function CreatePressStartBanner(...args: any[]): any {
  let i: any = null;
...
export function CreateCopyrightBanner(...args: any[]): any {
  let i: any = null;
      let spriteId: any = null;
...
export function SpriteCB_PokemonLogoShine(...args: any[]): any {
...
export function SpriteCB_PokemonLogoShine_Fast(...args: any[]): any {
  if (sprite.x < DISPLAY_WIDTH + 32)
...
export function StartPokemonLogoShine(...args: any[]): any {
  let spriteId: any = null;
...
export function CB2_InitTitleScreen(): any {
  switch (gMain.state)
      ...
      case 2:
      {
          let taskId = CreateTask(Task_TitleScreenPhase1, 0);
...
export function Task_TitleScreenPhase1(...args: any[]): any {
  if (JOY_NEW(A_B_START_SELECT) || gTasks[taskId].tSkipToNext)
      ...
      {
          let frameNum = gTasks[taskId].tCounter;
          if (frameNum == 176)
...
export function Task_TitleScreenPhase2(...args: any[]): any {
  let yPos: any = null;
...
export function Task_TitleScreenPhase3(...args: any[]): any {
...
export function UpdateLegendaryMarkingColor(...args: any[]): any {
  if ((frameNum % 4) == 0)  
      {
          let intensity = Cos(frameNum, Q_8_8(0.5)) + Q_8_8(0.5);
          let r = 31 - Q_8_8_TO_INT(intensity * 31);
          let g = 31 - Q_8_8_TO_INT(intensity * 22);
          let b = 12;
