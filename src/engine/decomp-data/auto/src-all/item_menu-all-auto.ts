...
export function ChooseBerryForMachine(...args: any[]): any {
...
export function GoToBagMenu(...args: any[]): any {
...
export function CreateBagInputHandlerTask(...args: any[]): any {
  let taskId: any = null;
...
export function LoadBagItemListBuffers(...args: any[]): any {
  let i: any = null;
...
export function GetItemNameFromPocket(...args: any[]): any {
...
export function BagMenu_MoveCursorCallback(...args: any[]): any {
  if (onInit != TRUE)
      {
          PlaySE(SE_SELECT);
          ShakeBagSprite();
...
export function BagMenu_ItemPrintCallback(...args: any[]): any {
  let itemId: any = null;
...
export function PrintItemDescription(...args: any[]): any {
  let str: any = null;
      if (itemIndex != LIST_CANCEL)
      {
...
export function BagMenu_PrintCursor(...args: any[]): any {
...
export function BagMenu_PrintCursorAtPos(...args: any[]): any {
...
export function Task_FadeAndCloseBagMenu(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_CloseBagMenu;
}

/** static void Task_CloseBagMenu(u8 taskId) */
export function Task_CloseBagMenu(...args: any[]): any {
...
export function UpdatePocketItemList(...args: any[]): any {
  let i: any = null;
      let pocket: any = gBagPockets[pocketId];
      switch (pocketId)
      {
...
export function UpdatePocketListPosition(...args: any[]): any {
...
export function GetItemListPosition(...args: any[]): any {
...
export function DisplayItemMessage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function CloseItemMessage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function AddItemQuantityWindow(...args: any[]): any {
  let windowId = BagMenu_AddWindow(windowType);
      PrintItemQuantity(windowId, 1, TEXT_SKIP_DRAW);
      CopyWindowToVram(windowId, 3);
}

/** static void PrintItemQuantity(u8 windowId, s16 quantity, u32 speed) */
export function PrintItemQuantity(...args: any[]): any {
  let numDigits = (gBagPosition.pocket == BERRIES_POCKET) ? BERRY_CAPACITY_DIGITS : BAG_ITEM_CAPACITY_DIGITS;
...
export function PrintItemSoldAmount(...args: any[]): any {
  let numDigits = (gBagPosition.pocket == BERRIES_POCKET) ? BERRY_CAPACITY_DIGITS : BAG_ITEM_CAPACITY_DIGITS;
...
export function Task_BagMenu_HandleInput(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
...
export function ReturnToItemList(...args: any[]): any {
  CreatePocketScrollArrowPair();
      CreatePocketSwitchArrowPair();
...
export function ChangeBagPocketId(...args: any[]): any {
...
export function SwitchBagPocket(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_SwitchBagPocket(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DrawItemListBgRow(...args: any[]): any {
  FillBgTilemapBufferRect_Palette0(2, 17, 14, y + 2, 15, 1);
      ScheduleBgCopyTilemapToVram(2);
}

/** static void DrawPocketIndicatorSquare(u8 x, bool8 isCurrentPocket) */
export function DrawPocketIndicatorSquare(...args: any[]): any {
  if (!isCurrentPocket)
...
export function StartItemSwap(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_HandleSwappingItemsInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DoItemSwap(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
      let realPos = (*scrollPos + *cursorPos);
...
export function CancelItemSwap(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
...
export function OpenContextMenu(...args: any[]): any {
...
export function PrintContextMenuItems(...args: any[]): any {
...
export function PrintContextMenuItemGrid(...args: any[]): any {
...
export function Task_ItemContext_Normal(...args: any[]): any {
...
export function Task_ItemContext_SingleRow(...args: any[]): any {
  if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
...
export function Task_ItemContext_MultipleRows(...args: any[]): any {
  if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE)
      {
...
export function IsValidContextMenuPos(...args: any[]): any {
  if (cursorPos < 0)
          return FALSE;
...
export function ItemMenu_UseOutOfBattle(...args: any[]): any {
...
export function ItemMenu_Toss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function AskTossItems(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function CancelToss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ChooseHowManyToToss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ConfirmToss(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_RemoveItemFromBag(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
...
export function ItemMenu_Register(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
...
export function ItemMenu_Give(...args: any[]): any {
  RemoveContextWindow();
...
export function HandleErrorMessage(...args: any[]): any {
  if (JOY_NEW(A_BUTTON))
      {
          PlaySE(SE_SELECT);
...
export function ItemMenu_CheckTag(...args: any[]): any {
  gBagMenu.newScreenCallback = DoBerryTagScreen;
      Task_FadeAndCloseBagMenu(taskId);
}

/** static void ItemMenu_Cancel(u8 taskId) */
export function ItemMenu_Cancel(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ItemMenu_UseInBattle(...args: any[]): any {
...
export function Task_ItemContext_GiveToParty(...args: any[]): any {
  if (!IsWritingMailAllowed(gSpecialVar_ItemId))
      {
          DisplayItemMessage(taskId, FONT_NORMAL, gText_CantWriteMail, HandleErrorMessage);
      }
...
export function Task_ItemContext_GiveToPC(...args: any[]): any {
  if (ItemIsMail(gSpecialVar_ItemId) == TRUE)
          DisplayItemMessage(taskId, FONT_NORMAL, gText_CantWriteMail, HandleErrorMessage);
      else if (gBagPosition.pocket != KEYITEMS_POCKET && !GetItemImportance(gSpecialVar_ItemId))
          gTasks[taskId].func = Task_FadeAndCloseBagMenu;
...
export function Task_ItemContext_Sell(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DisplaySellItemPriceAndConfirm(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function InitSellHowManyInput(...args: any[]): any {
  let data = gTasks[taskId].data;
      let windowId = BagMenu_AddWindow(ITEMWIN_QUANTITY_WIDE);
...
export function Task_ChooseHowManyToSell(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ConfirmSell(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function SellItem(...args: any[]): any {
  let data = gTasks[taskId].data;
      let scrollPos = gBagPosition.scrollPosition[gBagPosition.pocket];
      let cursorPos = gBagPosition.cursorPosition[gBagPosition.pocket];
...
export function WaitAfterItemSell(...args: any[]): any {
  if (JOY_NEW(A_BUTTON | B_BUTTON))
      {
          PlaySE(SE_SELECT);
          RemoveMoneyWindow();
...
export function Task_ItemContext_Deposit(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ChooseHowManyToDeposit(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function TryDepositItem(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function WaitDepositErrorMessage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_WallyTutorialBagMenu(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ItemMenu_Show(...args: any[]): any {
...
export function ItemMenu_GiveFavorLady(...args: any[]): any {
...
export function ItemMenu_ConfirmQuizLady(...args: any[]): any {
  gSpecialVar_Result = TRUE;
      RemoveContextWindow();
      Task_FadeAndCloseBagMenu(taskId);
}
...
export function PrintPocketNames(...args: any[]): any {
  let window: any = [0];
...
export function CopyPocketNameToWindow(...args: any[]): any {
...
export function BagMenu_Print(...args: any[]): any {
...
export function BagMenu_AddWindow(...args: any[]): any {
  let windowId = gBagMenu.windowIds[windowType];
...
export function BagMenu_RemoveWindow(...args: any[]): any {
  let windowId = gBagMenu.windowIds[windowType];
      if (*windowId != WINDOW_NONE)
      {
...
export function AddItemMessageWindow(...args: any[]): any {
  let windowId = gBagMenu.windowIds[windowType];
      if (*windowId == WINDOW_NONE)
          *windowId = AddWindow(sContextMenuWindowTemplates[windowType]);
      return *windowId;
...
export function RemoveItemMessageWindow(...args: any[]): any {
  let windowId = gBagMenu.windowIds[windowType];
      if (*windowId != WINDOW_NONE)
      {
...
export function BagMenu_YesNo(...args: any[]): any {
...
export function DisplayCurrentMoneyWindow(): any {
  let windowId = BagMenu_AddWindow(ITEMWIN_MONEY);
...
export function PrintTMHMMoveData(...args: any[]): any {
  let i: any = null;
      let move: any = null;
      let text: any = null;
