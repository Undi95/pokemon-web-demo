...
const {
  ...
  AddItemMessageWindow, AddItemQuantityWindow, AddMoney, AddMoneyLabelObject,
  AddPCItem, AddScrollIndicatorArrowPair, AddScrollIndicatorArrowPairParameterized, AddSwitchPocketRotatingBallSprite,
  AddTextPrinterParameterized, AddTextPrinterParameterized4, AddWindow, AdjustQuantityAccordingToDPadInput,
  Alloc, AllocZeroed, AllocateBagItemListBuffers, AnimateSprites,
  AskTossItems, BG_PLTT_ID, BagDestroyPocketScrollArrowPair, BagGetItemIdByPocketPosition,
  BagGetQuantityByPocketPosition, BagMenu_AddWindow, BagMenu_InitBGs, BagMenu_Print,
  BagMenu_PrintCursor, BagMenu_PrintCursorAtPos, BagMenu_RemoveWindow, BagMenu_YesNo,
  BeginNormalPaletteFade, BlendPalettes, BlitBitmapToWindow, BlitMenuInfoIcon,
  BuildOamBuffer, CalculatePlayerPartyCount, CanSwapItems, CancelItemSwap,
  CancelToss, ChangeBagPocketId, ChangeBgY_ScreenOff, ChangeMenuGridCursorPosition,
  CheckBagHasItem, ClearDialogWindowAndFrameToTransparent, ClearItemSlots, ClearScheduledBgCopiesToVram,
  ClearStdWindowAndFrameToTransparent, ClearWindowTilemap, CloseItemMessage, CompactItemsInBagPocket,
  ConvertIntToDecimalStringN, CopyItemName, CopyPocketNameToWindow, CopyWindowToVram,
  CpuCopy32, CreateBagInputHandlerTask, CreateItemMenuSwapLine, CreatePocketScrollArrowPair,
  CreatePocketSwitchArrowPair, CreateTask, CreateYesNoMenuWithCallbacks, CurrentBattlePyramidLocation,
  DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram, DestroyListMenuTask, DestroyPocketSwitchArrowPair,
  DestroyTask, DisplayCurrentMoneyWindow, DisplayItemMessage, DisplayMessageAndContinueTask,
  DisplaySellItemPriceAndConfirm, DoItemSwap, DoScheduledBgTilemapCopiesToVram, DrawItemListBgRow,
  DrawPocketIndicatorSquare, DrawStdFrameWithCustomTileAndPalette, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  FillWindowPixelRect, Free, FreeAllSpritePalettes, FreeAllWindowBuffers,
  FreeBagMenu, FreeTempTileDataBuffersIfPossible, FreezeObjectEvents, GetItemBattleFunc,
  GetItemBattleUsage, GetItemDescription, GetItemFieldFunc, GetItemImportance,
  GetItemNameFromPocket, GetItemPrice, GetItemType, GetLRKeysPressed,
  GetMenuCursorDimensionByFont, GetMoney, GetPlayerTextSpeedDelay, GetStringCenterAlignXOffset,
  GetStringRightAlignXOffset, GetSwitchBagPocketDirection, GetWindowAttribute, GoToBagMenu,
  ...
  InitPocketListPositions, InitPocketScrollPositions, InitWindows, IsHoldingItemAllowed,
  IsValidContextMenuPos, IsWallysBag, IsWritingMailAllowed, ItemIdToBattleMoveId,
  ItemIsMail, ItemMenu_Cancel, ItemUseOutOfBattle_Berry, JOY_NEW,
  LZDecompressWram, ListMenuGetScrollAndRow, ListMenuGetYCoordForPrintingArrowCursor, ListMenuInit,
  ListMenuLoadStdPalAt, ListMenuSetTemplateField, ListMenu_ProcessInput, LoadBagItemListBuffers,
  LoadBagMenuTextWindows, LoadBagMenu_Graphics, LoadCompressedPalette, LoadCompressedSpritePalette,
  ...
  OpenContextMenu, PIXEL_FILL, PlaySE, PlayerFreeze,
  PrepareBagForWallyTutorial, PrepareTMHMMoveWindow, PrintContextMenuItemGrid, PrintContextMenuItems,
  PrintItemCantBeHeld, PrintItemDescription, PrintItemQuantity, PrintItemSoldAmount,
  PrintMenuActionGrid, PrintMenuActionTexts, PrintMoneyAmount, PrintMoneyAmountInMoneyBox,
  PrintMoneyAmountInMoneyBoxWithBorder, PrintPocketNames, PrintTMHMMoveData, PrintThereIsNoPokemon,
  ProcessSpriteCopyRequests, PutWindowTilemap, RemoveBagItem, RemoveBagItemIconSprite,
  RemoveBagSprite, RemoveContextWindow, RemoveItemMessageWindow, RemoveMoneyLabelObject,
  RemoveMoneyWindow, RemoveScrollIndicatorArrowPair, RemoveWindow, ResetAllBgsCoordinates,
  ResetBagScrollPositions, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData,
  ResetTasks, ResetTempTileDataBuffers, ResetVramOamAndBgCntRegs, RestoreBagAfterWallyTutorial,
  ReturnToItemList, RunTasks, ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram,
  ...
  SetTaskFuncWithFollowupFunc, SetVBlankCallback, SetVBlankHBlankCallbacksToNull, SetupBagMenu,
  ShakeBagSprite, ShowBg, SortBerriesOrTMHMs, StartItemSwap,
  StopPlayerAvatar, StringCopy, StringExpandPlaceholders, SwitchBagPocket,
  SwitchTaskToFollowupFunc, Task_FadeAndCloseBagMenu, TestPlayerAvatarFlags, TransferPlttBuffer,
  TryDepositItem, UpdateItemMenuSwapLinePos, UpdatePaletteFade, UpdatePocketItemList,
  UpdatePocketItemLists, UpdatePocketListPosition,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
