...
export function BattleAI_SetupAIData(defaultScoreMoves: any): any {
  let i: any = null;
      let data: any = AI_THINKING_STRUCT;
...
export function RecordAbilityBattle(battler: any, abilityId: any): any {
...
export function Cmd_if_hp_less_than(): any {
  let battler: any = null;
      ...
      if ((100 * gBattleMons[battler].hp / gBattleMons[battler].maxHP) < gAIScriptPtr[2])
...
export function Cmd_if_less_than_ptr(): any {
  let value: any = T1_READ_PTR(gAIScriptPtr + 1);
...
export function Cmd_if_move(): any {
  let move: any = T1_READ_16(gAIScriptPtr + 1);
...
export function Cmd_if_in_bytes(): any {
  let ptr: any = T1_READ_PTR(gAIScriptPtr + 1);
...
export function Cmd_get_type(): any {
  let typeVar: any = gAIScriptPtr[1];
...
export function Cmd_if_has_move(): any {
  let i: any = null;
      let movePtr: any = (gAIScriptPtr + 2);
...
export function Cmd_if_random_safari_flee(): any {
  let safariFleeRate: any = gBattleStruct.safariEscapeFactor * 5;  
...
export function Cmd_get_used_held_item(): any {
  let battler: any = null;
      ...
      AI_THINKING_STRUCT.funcResult = gBattleStruct.usedHeldItems[battler];
...
export function AIStackPushVar(_var: any): any {
  gBattleResources.AI_ScriptsStack.ptr[gBattleResources.AI_ScriptsStack.size++] = _var;
}
