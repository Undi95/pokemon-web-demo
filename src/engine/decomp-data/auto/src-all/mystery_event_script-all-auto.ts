...
export function CheckCompatibility(...args: any[]): any {
  if (!(unk0 & 0x1))
          return FALSE;
...
export function InitMysteryEventScript(...args: any[]): any {
...
export function RunMysteryEventScriptCommand(...args: any[]): any {
...
export function InitMysteryEventScriptContext(...args: any[]): any {
  InitMysteryEventScript(sMysteryEventScriptContext, script);
}

/** bool32 RunMysteryEventScriptContextCommand(u32 *status) */
export function RunMysteryEventScriptContextCommand(...args: any[]): any {
...
export function RunMysteryEventScript(...args: any[]): any {
...
export function SetMysteryEventScriptStatus(...args: any[]): any {
...
export function CalcRecordMixingGiftChecksum(): any {
  unsigned int i;
      let sum = 0;
      let data = (u8 *)(gSaveBlock1Ptr.recordMixingGift.data);
...
export function SetRecordMixingGift(...args: any[]): any {
...
export function MEScrCmd_end(...args: any[]): any {
  StopScript(ctx);
      return TRUE;
}

/** bool8 MEScrCmd_checkcompat(struct ScriptContext *ctx) */
export function MEScrCmd_checkcompat(...args: any[]): any {
  let unk0: any = null;
      let unk1: any = null;
      let unk2: any = null;
...
export function MEScrCmd_nop(...args: any[]): any {
  return FALSE;
}

/** bool8 MEScrCmd_setstatus(struct ScriptContext *ctx) */
export function MEScrCmd_setstatus(...args: any[]): any {
...
export function MEScrCmd_setmsg(...args: any[]): any {
  let status = ScriptReadByte(ctx);
      let str = (u8 *)(ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase);
...
export function MEScrCmd_runscript(...args: any[]): any {
  let script = (u8 *)(ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase);
      RunScriptImmediately(script);
      return FALSE;
}

/** bool8 MEScrCmd_setenigmaberry(struct ScriptContext *ctx) */
export function MEScrCmd_setenigmaberry(...args: any[]): any {
  let str: any = null;
      let message: any = null;
      let haveBerry = IsEnigmaBerryValid();
      let berry = (u8 *)(ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase);
...
export function MEScrCmd_giveribbon(...args: any[]): any {
...
export function MEScrCmd_addrareword(...args: any[]): any {
...
export function MEScrCmd_setrecordmixinggift(...args: any[]): any {
...
export function MEScrCmd_givepokemon(...args: any[]): any {
  let mail: any = null;
      let pokemon: any = null;
      let species: any = null;
      let heldItem: any = null;
      let data = ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase;
...
export function MEScrCmd_addtrainer(...args: any[]): any {
  let data = ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase;
...
export function MEScrCmd_enableresetrtc(...args: any[]): any {
  EnableResetRTC();
...
export function MEScrCmd_checksum(...args: any[]): any {
  let checksum = ScriptReadWord(ctx);
      let data = (u8 *)(ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase);
      let dataEnd = (u8 *)(ScriptReadWord(ctx) - ctx.mOffset + ctx.mScriptBase);
...
export function MEScrCmd_crc(...args: any[]): any {
