...
const {
  AGBPrint, AGBPrintFlush, AGBPrintFlush1Block, AGBPrintTransferDataInternal,
  AGBPrintf, AGBPutc, AGBPutcInternal, MgbaPrintf,
  NoCashGBAPrint, NoCashGBAPrintf,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
