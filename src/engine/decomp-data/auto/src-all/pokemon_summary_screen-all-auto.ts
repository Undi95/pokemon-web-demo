...
const {
  ARRAY_COUNT, AddAndFillMoveNamesWindow, AddTextPrinterParameterized4, AddWindow,
  AddWindowFromTemplateList, AdvanceMonIndex, AdvanceMultiBattleMonIndex, AdvanceStorageMonIndex,
  Alloc, AllocZeroed, AnimateSprites, BG_PLTT_ID,
  BeginCloseSummaryScreen, BeginNormalPaletteFade, BlendPalettes, BlitBitmapToWindow,
  BoxMonToMon, BufferLeftColumnStats, BufferMonTrainerMemo, BufferNatureString,
  BufferRightColumnStats, BuildOamBuffer, CalculatePPWithBonus, CanReplaceMove,
  ChangeBgX, ChangePage, ChangeSelectedMove, ChangeSummaryPokemon,
  CheckPartyHasHadPokerus, CheckPartyPokerus, ClearPageWindowTilemaps, ClearScheduledBgCopiesToVram,
  ClearWindowTilemap, CloseMoveSelectMode, ConvertIntToDecimalStringN, ConvertInternationalString,
  CopyItemName, CopyMonToSummaryStruct, CopyNColumnsToTilemap, CopyToBgTilemapBufferRect_ChangePalette,
  CopyWindowToVram, CpuCopy16, CpuFill16, CreateCaughtBallSprite,
  CreateMonMarkingAllCombosSprite, CreateMonMarkingsSprite, CreateMonSprite, CreateMonSpritesGfxManager,
  CreateMoveSelectorSprites, CreateMoveTypeIcons, CreateSetStatusSprite, CreateSprite,
  CreateTask, CreateTextPrinterTask, DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram,
  DecompressGraphics, DestroyMonSpritesGfxManager, DestroyMoveSelectorSprites, DestroySprite,
  DestroySpriteAndFreeResources, DestroySpriteInArray, DestroyTask, DidMonComeFromGBAGames,
  DidMonComeFromRSE, DoScheduledBgTilemapCopiesToVram, DoesMonOTMatchOwner, DrawContestMoveHearts,
  DrawExperienceProgressBar, DrawPagination, DrawPokerusCuredSymbol, DynamicPlaceholderTextUtil_ExpandPlaceholders,
  DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr, ExitMovePositionSwitchMode, ExtractMonDataToSummaryStruct,
  FillWindowPixelBuffer, FillWindowPixelRect, FindTaskIdByFunc, Free,
  FreeAllSpritePalettes, FreeAllWindowBuffers, FreeSpriteOamMatrix, FreeSpriteTilesByTag,
  FreeSummaryScreen, FreeTempTileDataBuffersIfPossible, FuncIsActiveTask, GetAbilityBySpecies,
  GetBgTilemapBuffer, GetCurrentPpToMaxPpState, GetItemName, GetLRKeysPressed,
  GetMapNameHandleAquaHideout, GetMetLevelString, GetMonAilment, GetMonData,
  GetMonGender, GetMonNickname, GetMonSpritePalStructFromOtIdPersonality, GetMultiplayerId,
  GetNature, GetPlayerIDAsU32, GetStringCenterAlignXOffset, GetStringRightAlignXOffset,
  GetStringWidth, HandleLoadSpecialPokePic_2, HandleLoadSpecialPokePic_DontHandleDeoxys, HasMoreThanOneMove,
  HidePageSpecificSprites, InBattleFactory, InSlateportBattleTent, InitBGs,
  InitBgsFromTemplates, InitWindows, IsInGamePartnerMon, IsMonShiny,
  IsMonSpriteNotFlipped, IsMoveHm, IsMultiBattle, IsValidToViewInMulti,
  ItemIdToBallId, JOY_NEW, KeepMoveSelectorVisible, LZDecompressWram,
  LimitEggSummaryPageDisplay, LoadBallGfx, LoadCompressedPalette, LoadCompressedSpritePalette,
  LoadCompressedSpriteSheet, LoadGraphics, LoadMonGfxAndSprite, LoadOam,
  LoadPalette, MenuHelpers_IsLinkActive, MenuHelpers_ShouldWaitForLinkRecv, MonSpritesGfxManager_GetSpritePtr,
  OBJ_PLTT_ID, PIXEL_FILL, PLTT_SIZEOF, PlayCry_ByMode,
  PlayMonCry, PlaySE, PokemonSummaryDoMonAnimation, PositionAppealJamSlidingWindow,
  PositionPowerAccSlidingWindow, PositionStatusSlidingWindow, PrintAOrBButtonIcon, PrintContestMoveDescription,
  PrintEggInfo, PrintEggMemo, PrintEggOTID, PrintEggOTName,
  PrintEggState, PrintExpPointsNextLevel, PrintGenderSymbol, PrintHMMovesCantBeForgotten,
  PrintHeldItemName, PrintLeftColumnStats, PrintMonAbilityDescription, PrintMonAbilityName,
  PrintMonInfo, PrintMonOTID, PrintMonOTName, PrintMonTrainerMemo,
  PrintMoveDetails, PrintMoveNameAndPP, PrintMovePowerAndAccuracy, PrintNewMoveDetailsOrCancelText,
  PrintNotEggInfo, PrintPageNamesAndStats, PrintPageSpecificText, PrintRibbonCount,
  PrintRightColumnStats, PrintTextOnWindow, ProcessSpriteCopyRequests, PutPageWindowTilemaps,
  PutWindowTilemap, RemoveAndCreateMonMarkingsSprite, RemoveWindow, RemoveWindowByIndex,
  ResetAllBgsCoordinates, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData,
  ResetSpriteIds, ResetTempTileDataBuffers, ResetVramOamAndBgCntRegs, ResetWindows,
  RunTasks, ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram, SetBgAttribute,
  SetBgTilemapBuffer, SetBgTilemapPalette, SetBoxMonData, SetContestMoveTypeIcons,
  SetDefaultTilemaps, SetGpuReg, SetMainCallback2, SetMainMoveSelectorColor,
  SetMonData, SetMonPicBackgroundPalette, SetMonTypeIcons, SetMoveTypeIcons,
  SetMultiuseSpriteTemplateToPokemon, SetNewMoveTypeIcon, SetSpriteInvisibility, SetTaskFuncWithFollowupFunc,
  SetTypeIcons, SetTypeSpritePosAndPal, SetVBlankCallback, SetVBlankHBlankCallbacksToNull,
  ShouldIgnoreDeoxysForm, ShouldPlayNormalMonCry, ShowBg, ShowCantForgetHMsWindow,
  ShowPokemonSummaryScreen, SpeciesToPokedexNum, StartSpriteAnim, StopCryAndClearCrySongs,
  StopPokemonAnimationDelayTask, StopPokemonAnimations, StringAppend, StringCompareWithoutExtCtrlCodes,
  StringCopy, StringExpandPlaceholders, SummaryScreen_DestroyAnimDelayTask, SummaryScreen_SetAnimDelayTaskId,
  SwapBoxMonMoves, SwapMonMoves, SwapMovesNamesPP, SwapMovesTypeSprites,
  SwitchTaskToFollowupFunc, SwitchToMovePositionSwitchMode, SwitchToMoveSelection, TilemapFiveMovesDisplay,
  TransferPlttBuffer, TryDrawExperienceProgressBar, UpdatePaletteFade,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
