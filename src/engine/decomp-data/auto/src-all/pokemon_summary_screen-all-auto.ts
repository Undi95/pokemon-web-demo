...
const {
  ...
  CreateSprite, CreateTask, DeactivateAllTextPrinters, DecompressAndCopyTileDataToVram,
  DestroyMonSpritesGfxManager, DestroySprite, DestroySpriteAndFreeResources, DestroyTask,
  DoScheduledBgTilemapCopiesToVram, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr,
  ...
  FreeTempTileDataBuffersIfPossible, FuncIsActiveTask, GetAbilityBySpecies, GetBgTilemapBuffer,
  GetCurrentPpToMaxPpState, GetItemName, GetLRKeysPressed, GetMapNameHandleAquaHideout,
  GetMonAilment, GetMonData, GetMonGender, GetMonNickname,
  GetMonSpritePalStructFromOtIdPersonality, GetMultiplayerId, GetNature, GetPlayerIDAsU32,
  GetStringCenterAlignXOffset, GetStringRightAlignXOffset, GetStringWidth, HandleLoadSpecialPokePic_2,
  HandleLoadSpecialPokePic_DontHandleDeoxys, InBattleFactory, InSlateportBattleTent, InitBgsFromTemplates,
  InitWindows, IsMonShiny, IsMonSpriteNotFlipped, IsMoveHm,
  IsMultiBattle, ItemIdToBallId, JOY_NEW, LZDecompressWram,
  LoadBallGfx, LoadCompressedPalette, LoadCompressedSpritePalette, LoadCompressedSpriteSheet,
  LoadOam, LoadPalette, MenuHelpers_IsLinkActive, MenuHelpers_ShouldWaitForLinkRecv,
  MonSpritesGfxManager_GetSpritePtr, OBJ_PLTT_ID, PIXEL_FILL, PLTT_SIZEOF,
  PlayCry_ByMode, PlaySE, PokemonSummaryDoMonAnimation, ProcessSpriteCopyRequests,
  PutWindowTilemap, RemoveWindow, ResetAllBgsCoordinates, ResetBgsAndClearDma3BusyFlags,
  ...
  SetBgTilemapBuffer, SetBgTilemapPalette, SetBoxMonData, SetGpuReg,
  SetMainCallback2, SetMonData, SetMultiuseSpriteTemplateToPokemon, SetTaskFuncWithFollowupFunc,
  SetVBlankCallback, SetVBlankHBlankCallbacksToNull, ShouldIgnoreDeoxysForm, ShouldPlayNormalMonCry,
  ShowBg, SpeciesToPokedexNum, StartSpriteAnim, StopCryAndClearCrySongs,
  StopPokemonAnimationDelayTask, StringAppend, StringCompareWithoutExtCtrlCodes, StringCopy,
  StringExpandPlaceholders, SwitchTaskToFollowupFunc, TransferPlttBuffer, UpdatePaletteFade,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
