...
export function ShowPokemonSummaryScreen(...args: any[]): any {
...
export function ShowSelectMovePokemonSummaryScreen(...args: any[]): any {
...
export function ShowPokemonSummaryScreenHandleDeoxys(...args: any[]): any {
...
export function CopyMonToSummaryStruct(...args: any[]): any {
...
export function ExtractMonDataToSummaryStruct(...args: any[]): any {
  let i: any = null;
...
export function BeginCloseSummaryScreen(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = CloseSummaryScreen;
}

/** static void CloseSummaryScreen(u8 taskId) */
export function CloseSummaryScreen(...args: any[]): any {
...
export function Task_HandleInput(...args: any[]): any {
  if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE && !gPaletteFade.active)
      {
          if (JOY_NEW(DPAD_UP))
          {
...
export function ChangeSummaryPokemon(...args: any[]): any {
  let monId: any = null;
...
export function Task_ChangeSummaryMon(...args: any[]): any {
...
export function AdvanceMonIndex(...args: any[]): any {
  let mon: any = sMonSummaryScreen.monList.mons;
      ...
      {
          let index = sMonSummaryScreen.curMonIndex;
...
export function AdvanceMultiBattleMonIndex(...args: any[]): any {
...
export function IsValidToViewInMulti(...args: any[]): any {
...
export function ChangePage(...args: any[]): any {
...
export function PssScrollRight(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (data[0] == 0)
      {
...
export function PssScrollRightEnd(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function PssScrollLeft(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (data[0] == 0)
      {
          if (sMonSummaryScreen.bgDisplayOrder == 0)
...
export function PssScrollLeftEnd(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (sMonSummaryScreen.bgDisplayOrder == 0)
      {
          SetBgAttribute(1, BG_ATTR_PRIORITY, 1);
...
export function SwitchToMoveSelection(...args: any[]): any {
  let move: any = null;
...
export function Task_HandleInput_MoveSelect(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ChangeSelectedMove(...args: any[]): any {
  let i, newMoveIndex;
      let move: any = null;
...
export function CloseMoveSelectMode(...args: any[]): any {
...
export function SwitchToMovePositionSwitchMode(...args: any[]): any {
...
export function Task_HandleInput_MovePositionSwitch(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ExitMovePositionSwitchMode(...args: any[]): any {
  let move: any = null;
...
export function SwapMonMoves(...args: any[]): any {
  let summary: any = sMonSummaryScreen.summary;

      let move1 = summary.moves[moveIndex1];
      let move2 = summary.moves[moveIndex2];
      let move1pp = summary.pp[moveIndex1];
      let move2pp = summary.pp[moveIndex2];
      let ppBonuses = summary.ppBonuses;

       
      let ppUpMask1 = gPPUpGetMask[moveIndex1];
      let ppBonusMove1 = (ppBonuses & ppUpMask1) >> (moveIndex1 * 2);
      let ppUpMask2 = gPPUpGetMask[moveIndex2];
      let ppBonusMove2 = (ppBonuses & ppUpMask2) >> (moveIndex2 * 2);
      ppBonuses &= ~ppUpMask1;
      ppBonuses &= ~ppUpMask2;
...
export function SwapBoxMonMoves(...args: any[]): any {
  let summary: any = sMonSummaryScreen.summary;
...
export function Task_SetHandleReplaceMoveInput(...args: any[]): any {
  SetNewMoveTypeIcon();
      CreateMoveSelectorSprites(SPRITE_ARR_ID_MOVE_SELECTOR1);
...
export function Task_HandleReplaceMoveInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function ShowCantForgetHMsWindow(...args: any[]): any {
  ClearWindowTilemap(PSS_LABEL_WINDOW_MOVES_POWER_ACC);
      ClearWindowTilemap(PSS_LABEL_WINDOW_MOVES_APPEAL_JAM);
      ScheduleBgCopyTilemapToVram(0);
      PositionPowerAccSlidingWindow(0, 3);
...
export function Task_HandleInputCantForgetHMsMoves(...args: any[]): any {
  let data = gTasks[taskId].data;
      let move: any = null;
...
export function DrawPagination(): any {
  let tilemap = Alloc(8 * PSS_PAGE_COUNT);
      let i: any = null;
...
export function CopyNColumnsToTilemap(...args: any[]): any {
  let i: any = null;
      let alloced = Alloc(slidingWindow.width * 2 * slidingWindow.height);
...
export function PositionPowerAccSlidingWindow(...args: any[]): any {
  if (speed > sPowerAccSlidingWindow.width)
      ...
      {
          let taskId = FindTaskIdByFunc(Task_SlidePowerAccWindow);
          if (taskId == TASK_NONE)
...
export function Task_SlidePowerAccWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function PositionAppealJamSlidingWindow(...args: any[]): any {
  if (speed > sAppealJamSlidingWindow.width)
      ...
      {
          let taskId = FindTaskIdByFunc(Task_SlideAppealJamWindow);
          if (taskId == TASK_NONE)
...
export function Task_SlideAppealJamWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
      tVisibleColumns += tScrollingSpeed;
      if (tVisibleColumns < 0)
      {
...
export function PositionStatusSlidingWindow(...args: any[]): any {
  if (speed > sStatusSlidingWindow1.width)
      ...
      {
          let taskId = CreateTask(Task_SlideStatusWindow, 8);
          gTasks[taskId].tScrollingSpeed = speed;
          gTasks[taskId].tVisibleColumns = visibleColumns;
      }
}
...
export function Task_SlideStatusWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
      tVisibleColumns += tScrollingSpeed;
      if (tVisibleColumns < 0)
          tVisibleColumns = 0;
...
export function TilemapFiveMovesDisplay(...args: any[]): any {
  let i, id;
...
export function DrawPokerusCuredSymbol(...args: any[]): any {
...
export function SetMonPicBackgroundPalette(...args: any[]): any {
  if (!isMonShiny)
...
export function DrawExperienceProgressBar(...args: any[]): any {
  s64 numExpProgressBarTicks;
      ...
      {
          let expBetweenLevels = gExperienceTables[gSpeciesInfo[summary.species].growthRate][summary.level + 1] - gExperienceTables[gSpeciesInfo[summary.species].growthRate][summary.level];
          let expSinceLastLevel = summary.exp - gExperienceTables[gSpeciesInfo[summary.species].growthRate][summary.level];
...
export function DrawContestMoveHearts(...args: any[]): any {
  let tilemap = sMonSummaryScreen.bgTilemapBuffers[PSS_PAGE_CONTEST_MOVES][1];
      let i: any = null;

      if (move != MOVE_NONE)
      {
           
          let effectValue = gContestEffects[gContestMoves[move].effect].appeal;
          if (effectValue != 0xFF)
              effectValue /= 10;
...
export function PrintTextOnWindow(...args: any[]): any {
...
export function PrintNotEggInfo(): any {
  const strArray: any[] = [];
      ...
      let summary: any = sMonSummaryScreen.summary;
      let dexNum = SpeciesToPokedexNum(summary.species);
...
export function PrintGenderSymbol(...args: any[]): any {
...
export function PrintAOrBButtonIcon(...args: any[]): any {
  let button: any = null;
      if (!bButton)
...
export function PutPageWindowTilemaps(...args: any[]): any {
  let i: any = null;
...
export function ClearPageWindowTilemaps(...args: any[]): any {
  let i: any = null;
...
export function AddWindowFromTemplateList(...args: any[]): any {
  let windowIdPtr = sMonSummaryScreen.windowIds[templateId];
...
export function RemoveWindowByIndex(...args: any[]): any {
  let windowIdPtr = sMonSummaryScreen.windowIds[windowIndex];
      if (*windowIdPtr != WINDOW_NONE)
      {
...
export function PrintPageSpecificText(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < ARRAY_COUNT(sMonSummaryScreen.windowIds); i++)
      {
...
export function CreateTextPrinterTask(...args: any[]): any {
...
export function Task_PrintInfoPage(...args: any[]): any {
  let data = gTasks[taskId].data;
      switch (data[0])
      {
      case 1:
...
export function PrintMonAbilityName(): any {
  let ability = GetAbilityBySpecies(sMonSummaryScreen.summary.species, sMonSummaryScreen.summary.abilityNum);
...
export function BufferMonTrainerMemo(): any {
  let sum: any = sMonSummaryScreen.summary;
      ...
      {
          let metLevelString = Alloc(32);
          let metLocationString = Alloc(32);
...
export function GetMetLevelString(...args: any[]): any {
  let level = sMonSummaryScreen.summary.metLevel;
      if (level == 0)
...
export function DoesMonOTMatchOwner(): any {
  let sum: any = sMonSummaryScreen.summary;
      ...
      {
          let multiID = GetMultiplayerId() ^ 1;
...
export function PrintEggOTName(): any {
  let windowId = AddWindowFromTemplateList(sPageInfoTemplate, PSS_DATA_WINDOW_INFO_ORIGINAL_TRAINER);
      let width = GetStringWidth(FONT_NORMAL, gText_OTSlash, 0);
      PrintTextOnWindow(windowId, gText_OTSlash, 0, 1, 0, 1);
...
export function Task_PrintSkillsPage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function BufferLeftColumnStats(): any {
  let currentHPString = Alloc(8);
      let maxHPString = Alloc(8);
      let attackString = Alloc(8);
      let defenseString = Alloc(8);
...
export function PrintExpPointsNextLevel(): any {
  let sum: any = sMonSummaryScreen.summary;
      let windowId = AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_EXP);
      let x: any = null;
...
export function Task_PrintBattleMoves(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function PrintMoveNameAndPP(...args: any[]): any {
  let pp: any = null;
      let ppState, x;
      let text: any = null;
      let summary: any = sMonSummaryScreen.summary;
      let moveNameWindowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_NAMES);
      let ppValueWindowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_PP);
      let move = summary.moves[moveIndex];
...
export function PrintMovePowerAndAccuracy(...args: any[]): any {
  let text: any = null;
      if (moveIndex != 0)
      {
...
export function Task_PrintContestMoves(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function PrintContestMoveDescription(...args: any[]): any {
  let move: any = null;
      ...
      if (move != MOVE_NONE)
      {
          let windowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_DESCRIPTION);
          PrintTextOnWindow(windowId, gContestEffectDescriptionPointers[gContestMoves[move].effect], 6, 1, 0, 0);
      }
}

/** static void PrintMoveDetails(u16 move) */
export function PrintMoveDetails(...args: any[]): any {
  let windowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_DESCRIPTION);
...
export function PrintNewMoveDetailsOrCancelText(): any {
  let windowId1 = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_NAMES);
      let windowId2 = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_PP);
      ...
      {
          let move = sMonSummaryScreen.newMove;
...
export function AddAndFillMoveNamesWindow(): any {
  let windowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_NAMES);
      FillWindowPixelRect(windowId, PIXEL_FILL(0), 0, 65, 72, 15);  
      CopyWindowToVram(windowId, COPYWIN_GFX);
}

/** static void SwapMovesNamesPP(u8 moveIndex1, u8 moveIndex2) */
export function SwapMovesNamesPP(...args: any[]): any {
  let windowId1 = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_NAMES);
      let windowId2 = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_PP);
...
export function DestroySpriteInArray(...args: any[]): any {
...
export function SetSpriteInvisibility(...args: any[]): any {
...
export function SetTypeSpritePosAndPal(...args: any[]): any {
...
export function SwapMovesTypeSprites(...args: any[]): any {
...
export function LoadMonGfxAndSprite(...args: any[]): any {
  let pal: any = null;
      let summary: any = sMonSummaryScreen.summary;
...
export function CreateMonSprite(...args: any[]): any {
  let summary: any = sMonSummaryScreen.summary;
      let spriteId = CreateSprite(gMultiuseSpriteTemplate, 40, 64, 5);
...
export function SpriteCB_Pokemon(...args: any[]): any {
  let summary: any = sMonSummaryScreen.summary;
...
export function SummaryScreen_SetAnimDelayTaskId(...args: any[]): any {
...
export function StopPokemonAnimations(): any {
  let i: any = null;
      ...
      for (i = 0; i < 16; i++)
      {
          let id = i + paletteIndex;
          gPlttBufferUnfaded[id] = gPlttBufferFaded[id];
      }
}

/** static void CreateMonMarkingsSprite(struct Pokemon *mon) */
export function CreateMonMarkingsSprite(...args: any[]): any {
...
export function RemoveAndCreateMonMarkingsSprite(...args: any[]): any {
...
export function CreateCaughtBallSprite(...args: any[]): any {
  let ball = ItemIdToBallId(GetMonData(mon, MON_DATA_POKEBALL));
...
export function CreateSetStatusSprite(): any {
  let spriteId = sMonSummaryScreen.spriteIds[SPRITE_ARR_ID_STATUS];
...
export function CreateMoveSelectorSprites(...args: any[]): any {
  let i: any = null;
      let spriteIds = sMonSummaryScreen.spriteIds[idArrayStart];
...
export function SpriteCB_MoveSelector(...args: any[]): any {
...
export function DestroyMoveSelectorSprites(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < MOVE_SELECTOR_SPRITES_COUNT; i++)
...
export function SetMainMoveSelectorColor(...args: any[]): any {
  let i: any = null;
      let spriteIds = sMonSummaryScreen.spriteIds[SPRITE_ARR_ID_MOVE_SELECTOR1];
...
export function KeepMoveSelectorVisible(...args: any[]): any {
  let i: any = null;
      let spriteIds = sMonSummaryScreen.spriteIds[firstSpriteId];
