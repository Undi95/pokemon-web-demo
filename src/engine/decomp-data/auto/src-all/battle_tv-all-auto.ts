...
export function BattleTv_SetDataBasedOnString(...args: any[]): any {
  let tvPtr: any = null;
...
export function IsNotSpecialBattleString(...args: any[]): any {
  let i = 0;
...
export function BattleTv_SetDataBasedOnMove(...args: any[]): any {
  let tvPtr: any = null;
      let atkSide, defSide;
      let moveSlot: any = null;
...
export function BattleTv_SetDataBasedOnAnimation(...args: any[]): any {
  let tvPtr: any = null;
...
export function TryPutLinkBattleTvShowOnAir(): any {
  let playerBestSpecies = 0, opponentBestSpecies = 0;
      let playerBestSum = 0, opponentBestSum = SHRT_MAX;
      let playerBestMonId = 0, opponentBestMonId = 0;
      let movePoints: any = NULL;
      let countPlayer = 0, countOpponent = 0;
      let sum = 0;
      let species = 0;
      let move = MOVE_NONE;
      let i, j;
...
export function AddMovePoints(...args: any[]): any {
...
export function AddPointsOnFainting(...args: any[]): any {
  let tvPtr: any = gBattleStruct.tv;
      let atkSide = GetBattlerSide(gBattlerAttacker);
      let defSide = GetBattlerSide(gBattlerTarget);
...
export function ShouldCalculateDamage(...args: any[]): any {
...
export function GetBattlerMoveSlotId(...args: any[]): any {
  let i: any = null;
      let party: any = null;
...
export function AddPointsBasedOnWeather(...args: any[]): any {
