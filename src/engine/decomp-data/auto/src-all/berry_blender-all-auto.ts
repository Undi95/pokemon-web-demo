...
const {
  ...
  CreateWirelessStatusIndicatorSprite, CreateYesNoMenu, DeactivateAllTextPrinters, DestroySprite,
  DestroyTask, DrawDialogFrameWithCustomTileAndPalette, DrawStdFrameWithCustomTileAndPalette, DrawStdWindowFrame,
  FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FlagGet,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, GetBerryInfo,
  GetBlockReceivedStatus, GetCurrentMapMusic, GetDecompressedDataSize, GetFirstFreePokeblockSlot,
  GetHighestPokeblocksFlavorLevel, GetLinkPlayerCount, GetLinkPlayerCountAsBitFlags, GetMultiplayerId,
  GetPlayerTextSpeedDelay, GetPokeblocksFeel, GetPokeblocksFlavor, GetStringCenterAlignXOffset,
  GetStringRightAlignXOffset, ITEM_TO_BERRY, IncrementDailyBerryBlender, IncrementGameStat,
  InitBgsFromTemplates, InitWindows, IsBagPocketNonEmpty, IsFanfareTaskInactive,
  IsLinkTaskFinished, IsTextPrinterActive, JOY_HELD_RAW, JOY_NEW,
  LZDecompressWram, LoadBgTiles, LoadMessageBoxGfx, LoadOam,
  ...
  Put3CheersForPokeblocksOnTheAir, PutWindowTilemap, Random, RemoveBagItem,
  ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlags, ResetSpriteData, ResetTasks,
  RunTasks, RunTextPrinters, SWAP, SendBlock,
  ...
  StringCompare, StringCopy, TransferPlttBuffer, UnsetBgTilemapBuffer,
