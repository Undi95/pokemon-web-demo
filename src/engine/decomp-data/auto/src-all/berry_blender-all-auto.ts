...
const {
  ...
  AddWindow, AllocZeroed, AnimateSprites, AreBlenderBerriesSame,
  ArrowSpeedToRPM, BGCNT_PRIORITY, BG_PLTT_ID, BG_SCREEN_ADDR,
  BeginFastPaletteFade, BeginNormalPaletteFade, BlenderLandShakeBgCoord, Blender_AddTextPrinter,
  Blender_DummiedOutFunc, BuildOamBuffer, CalculatePokeblock, CalculatePokeblockColor,
  ChangeBgX, ChangeBgY, CheckRecvCmdMatches, ChooseBerryForMachine,
  ClearDialogWindowAndFrameToTransparent, ClearLinkCallback, ClearStdWindowAndFrameToTransparent, ConvertIntToDecimalStringN,
  ConvertInternationalString, ConvertItemToBlenderBerry, CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer,
  CopyWindowToVram, CreateBerrySprite, CreateOpponentMissTask, CreateParticleSprites,
  CreateScoreSymbolSprite, CreateSpinningBerrySprite, CreateSprite, CreateTask,
  CreateWirelessStatusIndicatorSprite, CreateYesNoMenu, DeactivateAllTextPrinters, Debug_SetGameTimeStage,
  Debug_SetMaxRPMStage, Debug_SetStageVars, DestroySprite, DestroyTask,
  DrawBlenderBg, DrawBlenderCenter, DrawDialogFrameWithCustomTileAndPalette, DrawStdFrameWithCustomTileAndPalette,
  DrawStdWindowFrame, FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  FlagGet, Free, FreeAllSpritePalettes, FreeAllWindowBuffers,
  GetArrowProximity, GetBerryInfo, GetBlockReceivedStatus, GetCurrentMapMusic,
  GetDecompressedDataSize, GetFirstFreePokeblockSlot, GetHighestPokeblocksFlavorLevel, GetLinkPlayerCount,
  GetLinkPlayerCountAsBitFlags, GetMultiplayerId, GetPlayerTextSpeedDelay, GetPokeblocksFeel,
  GetPokeblocksFlavor, GetStringCenterAlignXOffset, GetStringRightAlignXOffset, HandlePlayerInput,
  ITEM_TO_BERRY, IncrementDailyBerryBlender, IncrementGameStat, InitBerryBlenderWindows,
  InitBgsFromTemplates, InitBlenderBgs, InitLocalPlayers, InitWindows,
  IsBagPocketNonEmpty, IsFanfareTaskInactive, IsLinkTaskFinished, IsTextPrinterActive,
  JOY_HELD_RAW, JOY_NEW, LZDecompressWram, LinkPlayAgainHandleSaving,
  LoadBerryBlenderGfx, LoadBgTiles, LoadMessageBoxGfx, LoadOam,
  LoadPalette, LoadSpritePalette, LoadSpriteSheet, LoadUserWindowBorderGfx,
  LoadWirelessStatusIndicatorSpriteGfx, Menu_LoadStdPalAt, Menu_ProcessInputNoWrapClearOnChoose, PIXEL_FILL,
  PlayBGM, PlayFanfare, PlaySE, PrintBlendingRanking,
  PrintBlendingResults, PrintMadePokeblockString, PrintMessage, PrintPlayerNames,
  ProcessLinkPlayerCmds, ProcessSpriteCopyRequests, Put3CheersForPokeblocksOnTheAir, PutWindowTilemap,
  Random, RemoveBagItem, ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlags,
  ResetLinkCmds, ResetSpriteData, ResetTasks, RestoreBgCoord,
  RestoreBgCoords, RunTasks, RunTextPrinters, SWAP,
  SendBlock, SendBlockRequest, SendContinuePromptResponse, SetBerryBlenderLinkCallback,
  SetBerrySpriteData, SetBgAffine, SetBgPos, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetGpuReg, SetGpuRegBits, SetLinkDebugValues,
  SetLinkStandbyCallback, SetMainCallback2, SetOpponentsBerryData, SetPlayerBerryData,
  SetPlayerIdMaps, SetVBlankCallback, SetWirelessCommType0, ShakeBgCoordForHit,
  ShowBg, SortBasedOnPoints, SortScores, StartSpriteAnim,
  StringAppend, StringAppendWithPlaceholder, StringCompare, StringCopy,
  TransferPlttBuffer, TryAddContestLinkTvShow, TryUpdateBerryBlenderRecord, TryUpdateProgressBar,
  UnsetBgTilemapBuffer, UpdateBlenderCenter, UpdateBlenderLandScreenShake, UpdateHitPitch,
  UpdateOpponentScores, UpdatePaletteFade, UpdateProgressBar, UpdateRPM,
  UpdateSpeedFromHit, WriteSaveBlock1Sector, WriteSaveBlock2,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
