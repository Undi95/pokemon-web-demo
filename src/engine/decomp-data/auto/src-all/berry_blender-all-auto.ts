...
export function SpriteCB_Berry(...args: any[]): any {
...
export function SetBerrySpriteData(...args: any[]): any {
  sprite.sTargetY = y;
      sprite.sX = x;
      sprite.sY = y;
...
export function CreateBerrySprite(...args: any[]): any {
  let spriteId = CreateSpinningBerrySprite(ITEM_TO_BERRY(itemId) - 1, 0, 80, playerId & 1);
...
export function ConvertItemToBlenderBerry(...args: any[]): any {
...
export function InitLocalPlayers(...args: any[]): any {
  switch (opponentsNum)
      {
      case 0:  
...
export function GetArrowProximity(...args: any[]): any {
  let pos = (arrowPos / 256) + 24;
      let arrowId = sBerryBlender.playerIdToArrowId[playerId];
      let hitRangeStart = sArrowHitRangeStart[arrowId];
...
export function SetOpponentsBerryData(...args: any[]): any {
  let opponentSetId = 0;
...
export function Task_OpponentMiss(...args: any[]): any {
...
export function CreateOpponentMissTask(...args: any[]): any {
  let taskId = CreateTask(Task_OpponentMiss, 80);
      gTasks[taskId].tDelay = delay;
      gTasks[taskId].tPlayerId = playerId;
}

/** static void Task_HandleOpponent1(u8 taskId) */
export function Task_HandleOpponent1(...args: any[]): any {
...
export function Task_HandleOpponent2(...args: any[]): any {
...
export function Task_HandleOpponent3(...args: any[]): any {
  let var1 = (sBerryBlender.arrowPos + 0x1800) & 0xFFFF;
...
export function Task_HandleBerryMaster(...args: any[]): any {
  if (GetArrowProximity(sBerryBlender.arrowPos, 1) == PROXIMITY_BEST)
      {
          if (!gTasks[taskId].tDidInput)
          {
...
export function CreateScoreSymbolSprite(...args: any[]): any {
...
export function UpdateSpeedFromHit(...args: any[]): any {
  UpdateHitPitch();
      switch (cmd)
      {
...
export function CheckRecvCmdMatches(...args: any[]): any {
  if (gReceivedRemoteLinkPlayers && gWirelessCommType)
      {
...
export function UpdateOpponentScores(): any {
  let i: any = null;
      ...
      for (i = 0; i < sBerryBlender.numPlayers; i++)
      {
          ...
          {
              let arrowId = sBerryBlender.playerIdToArrowId[i];
...
export function AreBlenderBerriesSame(...args: any[]): any {
...
export function CalculatePokeblockColor(...args: any[]): any {
  const flavors: any[] = [];
      let i, j;
...
export function Debug_SetMaxRPMStage(...args: any[]): any {
  sDebug_MaxRPMStage = value;
}

/** static void Debug_SetGameTimeStage(s16 value) */
export function Debug_SetGameTimeStage(...args: any[]): any {
...
export function CalculatePokeblock(...args: any[]): any {
  let i, j;
      ...
      for (i = 0; i < FLAVOR_COUNT; i++)
      {
          ...
          let flavor = sPokeblockFlavors[i];
...
export function Debug_SetStageVars(): any {
  let frames = (u16)(sBerryBlender.gameFrameTime);
      let maxRPM = sBerryBlender.maxRPM;
      let stage = 0;
...
export function SendContinuePromptResponse(...args: any[]): any {
  if (gReceivedRemoteLinkPlayers && gWirelessCommType)
  ...
  let i, j;
      ...
      case 4:
          if (GetBlockReceivedStatus())
          {
              ...
              if (gReceivedRemoteLinkPlayers && gWirelessCommType)
              {
                  let receivedBlock: any = (struct BlenderGameBlock *)(gBlockRecvBuffer);
              ...
              {
                  let receivedBlock: any = (struct TimeAndRPM *)(gBlockRecvBuffer);
...
export function DrawBlenderCenter(...args: any[]): any {
...
export function SpriteCB_Particle(...args: any[]): any {
...
export function SpriteCB_ScoreSymbol(...args: any[]): any {
  sprite.data[0]++;
...
export function SpriteCB_ScoreSymbolBest(...args: any[]): any {
  sprite.data[0]++;
...
export function SetPlayerBerryData(...args: any[]): any {
...
export function SpriteCB_CountdownNumber(...args: any[]): any {
...
export function SpriteCB_Start(...args: any[]): any {
...
export function TryUpdateProgressBar(...args: any[]): any {
...
export function UpdateProgressBar(...args: any[]): any {
...
export function ArrowSpeedToRPM(...args: any[]): any {
  return 60 * 60 * 100 * speed / MAX_ARROW_POS;
}

/** static void UpdateRPM(u16 speed) */
export function UpdateRPM(...args: any[]): any {
  let i: any = null;
      const digits: any[] = [];

       
      let currentRPM = ArrowSpeedToRPM(speed);
...
export function ShakeBgCoordForHit(...args: any[]): any {
  if (*coord == 0)
          *coord = (Random() % speed) - (speed / 2);
}

/** static void RestoreBgCoord(s16 *coord) */
export function RestoreBgCoord(...args: any[]): any {
  if (*coord < 0)
          (*coord)++;
      if (*coord > 0)
          (*coord)--;
...
export function BlenderLandShakeBgCoord(...args: any[]): any {
...
export function SpriteCB_PlayerArrow(...args: any[]): any {
      ...
      case 3:
          {
              ...
              {
                  let place = sBerryBlender.playerPlaces[i];
...
export function PrintMadePokeblockString(...args: any[]): any {
  const text: any[] = [];
      let flavorLvl, feel;
...
export function SortBasedOnPoints(...args: any[]): any {
  let i, j;
...
export function Task_PlayPokeblockFanfare(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
      {
...
export function TryAddContestLinkTvShow(...args: any[]): any {
  let flavorLevel = GetHighestPokeblocksFlavorLevel(pokeblock);
      let sheen = (flavorLevel * 10) / GetPokeblocksFeel(pokeblock);
...
export function Blender_AddTextPrinter(...args: any[]): any {
  const txtColor: any[] = [];
      let letterSpacing = 0;
