...
const {
  ARRAY_COUNT, ActionSelectionCreateCursorAt, ActionSelectionDestroyCursorAt, AddBagItem,
  AllocSpritePalette, BATTLE_OPPOSITE, BATTLE_PARTNER, BattleArena_DeductSkillPoints,
  BattleCreateYesNoCursorAt, BattleDestroyYesNoCursorAt, BattleGfxSfxDummy2, BattleGfxSfxDummy3,
  BattleLoadPlayerMonSpriteGfx, BattlePutTextOnWindow, BattleStopLowHpSound, BattleStringExpandPlaceholdersToDisplayedString,
  BattleTv_ClearExplosionFaintCause, BattleTv_SetDataBasedOnAnimation, BattleTv_SetDataBasedOnMove, BattleTv_SetDataBasedOnString,
  BeginFastPaletteFade, BeginNormalPaletteFade, BtlController_EmitChosenMonReturnValue, BtlController_EmitDataTransfer,
  BtlController_EmitOneReturnValue, BtlController_EmitOneReturnValue_Duplicate, BtlController_EmitTwoReturnValues, BufferStringBattle,
  CB2_BagMenuFromBattle, CalculateMonStats, ChooseMoveAndTargetInBattlePalace, ClearTemporarySpeciesSpriteData,
  ConvertIntToDecimalStringN, CopyAllBattleSpritesInvisibilities, CopyBattleSpriteInvisibility, CopyBgTilemapBufferToVram,
  CopyPlayerMonData, CopyToBgTilemapBufferRect_ChangePalette, CountAliveMonsInBattle, CreateInvisibleSpriteWithCallback,
  CreatePartyStatusSummarySprites, CreateSprite, CreateTask, DecompressTrainerBackPic,
  DecompressTrainerFrontPic, DestroySprite, DestroyTask, DmaCopy16,
  DoBounceEffect, DoHitAnimHealthboxEffect, DoMoveAnim, DoPokeballSendOutAnimation,
  EndBounceEffect, FadeOutMapMusic, FreeAllWindowBuffers, FreeOamMatrix,
  ...
  InitMoveSelectionsVarsAndStrings, IsBattleSEPlaying, IsBattlerSpritePresent, IsCryPlayingOrClearCrySongs,
  IsDma3ManagerBusyWithBgCopy, IsDoubleBattle, IsLinkTaskFinished, IsMoveWithoutAnimation,
  IsTextPrinterActive, JOY_HELD, JOY_NEW, JOY_REPEAT,
  LoadBattleBarGfx, LoadCompressedPalette, MoveBattleBar, MoveSelectionCreateCursorAt,
  MoveSelectionDestroyCursorAt, MoveSelectionDisplayMoveNames, MoveSelectionDisplayMoveType, MoveSelectionDisplayPpNumber,
  MoveSelectionDisplayPpString, OBJ_PLTT_ID, OpenPartyMenuInBattle, PlayBGM,
  PlayCry_ByMode, PlayFanfare, PlaySE, PlaySE12WithPanning,
  PlayerBufferExecCompleted, PlayerGenderToFrontTrainerPicId, PlayerHandlePrintString, PrepareBufferDataTransferLink,
  PrintLinkStandbyMsg, RecordedBattle_RecordAllBattlerData, ReshowBattleScreenDummy, SetBattleBarStruct,
  ...
  SetMultiuseSpriteTemplateToTrainerBack, SetMultiuseSpriteTemplateToTrainerFront, SetPlayerMonData, SetPpNumbersPaletteInMoveSelection,
  SetSpritePrimaryCoordsFromSecondaryCoords, StartHealthboxSlideIn, StartSendOutAnim, StartSpriteAnim,
  StoreSpriteCallbackInData6, StringCopy, StringCopy_Nickname, SwapHpBarsWithHpText,
  T1_READ_16, TryHandleLaunchBattleTableAnimation, TryPutLinkBattleTvShowOnAir, TrySetBehindSubstituteSpriteBit,
