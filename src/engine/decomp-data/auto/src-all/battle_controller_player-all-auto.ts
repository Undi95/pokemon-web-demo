...
const {
  ...
  DestroyTask, DmaCopy16, DoBounceEffect, DoHitAnimHealthboxEffect,
  DoMoveAnim, DoPokeballSendOutAnimation, EndBounceEffect, FALSE,
  FadeOutMapMusic, FreeAllWindowBuffers, FreeOamMatrix, FreeSpriteOamMatrix,
  FreeSpritePaletteByTag, FreeSpriteTilesByTag, GET_BATTLER_SIDE, GetBattlerAtPosition,
  GetBattlerPosition, GetBattlerSide, GetBattlerSpriteCoord, GetBattlerSpriteDefault_Y,
  GetBattlerSpriteSubpriority, GetDefaultMoveTarget, GetMonData, GetMultiplayerId,
  GetSpritePaletteTagByPaletteNum, HandleBattleWindow, HandleIntroSlide, HandleLowHpMusicChange,
  IndexOfSpritePaletteTag, InitAndLaunchChosenStatusAnimation, InitAndLaunchSpecialAnimation, IsBattleSEPlaying,
  IsBattlerSpritePresent, IsCryPlayingOrClearCrySongs, IsDma3ManagerBusyWithBgCopy, IsDoubleBattle,
  IsLinkTaskFinished, IsMoveWithoutAnimation, IsTextPrinterActive, JOY_HELD,
  JOY_NEW, JOY_REPEAT, LoadBattleBarGfx, LoadCompressedPalette,
  MoveBattleBar, NULL, OBJ_PLTT_ID, OpenPartyMenuInBattle,
  PALETTES_ALL, PLTT_SIZE_4BPP, PlayBGM, PlayCry_ByMode,
  PlayFanfare, PlaySE, PlaySE12WithPanning, PlayerGenderToFrontTrainerPicId,
  PrepareBufferDataTransferLink, RecordedBattle_RecordAllBattlerData, ReshowBattleScreenDummy, STR_CONV_MODE_RIGHT_ALIGN,
