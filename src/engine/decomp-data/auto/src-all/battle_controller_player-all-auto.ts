...
export function HandleInputChooseAction(): any {
  let itemId = gBattleBufferA[gActiveBattler][2] | (gBattleBufferA[gActiveBattler][3] << 8);
...
export function HandleInputChooseTarget(): any {
  let i: any = null;
      ...
      else if (JOY_NEW(DPAD_LEFT | DPAD_UP))
      {
          ...
          do
          {
              let currSelIdentity = GetBattlerPosition(gMultiUsePlayerCursor);
...
export function HandleInputChooseMove(): any {
  let canSelectTarget = FALSE;
      let moveInfo: any = (struct ChooseMoveStruct *)(gBattleBufferA[gActiveBattler][4]);
...
export function Task_PlayerController_RestoreBgmAfterCry(...args: any[]): any {
...
export function CompleteOnHealthbarDone(): any {
  let hpValue = MoveBattleBar(gActiveBattler, gHealthboxSpriteIds[gActiveBattler], HEALTH_BAR, 0);
...
export function Task_GiveExpToMon(...args: any[]): any {
  let monId = (u8)(gTasks[taskId].tExpTask_monId);
      let battler = gTasks[taskId].tExpTask_battler;
      let gainedExp = gTasks[taskId].tExpTask_gainedExp;
...
export function Task_PrepareToGiveExpWithExpBar(...args: any[]): any {
  let monIndex = gTasks[taskId].tExpTask_monId;
      let gainedExp = gTasks[taskId].tExpTask_gainedExp;
      let battler = gTasks[taskId].tExpTask_battler;
...
export function Task_GiveExpWithExpBar(...args: any[]): any {
  if (gTasks[taskId].tExpTask_frames < 13)
      ...
      {
          let monId = gTasks[taskId].tExpTask_monId;
          let gainedExp = gTasks[taskId].tExpTask_gainedExp;
          let battler = gTasks[taskId].tExpTask_battler;
...
export function Task_LaunchLvlUpAnim(...args: any[]): any {
  let battler = gTasks[taskId].tExpTask_battler;
      let monIndex = gTasks[taskId].tExpTask_monId;
...
export function Task_UpdateLvlInHealthbox(...args: any[]): any {
  let battler = gTasks[taskId].tExpTask_battler;
...
export function DestroyExpTaskAndCompleteOnInactiveTextPrinter(...args: any[]): any {
...
export function FreeMonSpriteAfterFaintAnim(): any {
  if (gSprites[gBattlerSpriteIds[gActiveBattler]].y + gSprites[gBattlerSpriteIds[gActiveBattler]].y2 > DISPLAY_HEIGHT)
      {
          let species = GetMonData(gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_SPECIES);
...
export function DoHitAnimBlinkSpriteEffect(): any {
  let spriteId = gBattlerSpriteIds[gActiveBattler];
...
export function MoveSelectionCreateCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = baseTileNum + 1;
      src[1] = baseTileNum + 2;
...
export function MoveSelectionDestroyCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = 0x1016;
      src[1] = 0x1016;
...
export function ActionSelectionCreateCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = 1;
      src[1] = 2;
...
export function ActionSelectionDestroyCursorAt(...args: any[]): any {
  const src: any[] = [];
      src[0] = 0x1016;
      src[1] = 0x1016;
...
export function CopyPlayerMonData(...args: any[]): any {
...
export function PlayerHandleGetRawMonData(): any {
  let battleMon: any = null;
      let src = (u8 *)&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]] + gBattleBufferA[gActiveBattler][1];
      let dst = (u8 *)&battleMon + gBattleBufferA[gActiveBattler][1];
      let i: any = null;
...
export function SetPlayerMonData(...args: any[]): any {
  let battlePokemon: any = (struct BattlePokemon *)&gBattleBufferA[gActiveBattler][3];
      let moveData: any = (struct MovePpInfo *)&gBattleBufferA[gActiveBattler][3];
      let i: any = null;
...
export function PlayerHandleSetRawMonData(): any {
  let dst = (u8 *)&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]] + gBattleBufferA[gActiveBattler][1];
      let i: any = null;
...
export function StartSendOutAnim(...args: any[]): any {
  let species: any = null;
...
export function PlayerHandleBallThrowAnim(): any {
  let ballThrowCaseId = gBattleBufferA[gActiveBattler][1];
...
export function PlayerHandlePause(): any {
  let timer = gBattleBufferA[gActiveBattler][1];
...
export function PlayerHandleMoveAnimation(): any {
  if (!IsBattleSEPlaying(gActiveBattler))
      {
          let move = gBattleBufferA[gActiveBattler][1] | (gBattleBufferA[gActiveBattler][2] << 8);
...
export function PlayerDoMoveAnimation(): any {
  let move = gBattleBufferA[gActiveBattler][1] | (gBattleBufferA[gActiveBattler][2] << 8);
      let multihit = gBattleBufferA[gActiveBattler][11];
...
export function PlayerHandleHealthBarUpdate(): any {
  let hpVal: any = null;
      ...
      {
          let maxHP = GetMonData(gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_MAX_HP);
          let curHP = GetMonData(gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_HP);
...
export function PlayerHandleExpUpdate(): any {
  let monId = gBattleBufferA[gActiveBattler][1];
...
export function PlayerHandleStatusXor(): any {
  let val = GetMonData(gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_STATUS) ^ gBattleBufferA[gActiveBattler][1];
...
export function PlayerHandleDMA3Transfer(): any {
  let dstArg = gBattleBufferA[gActiveBattler][1]
              | (gBattleBufferA[gActiveBattler][2] << 8)
              | (gBattleBufferA[gActiveBattler][3] << 16)
              | (gBattleBufferA[gActiveBattler][4] << 24);
      let sizeArg = gBattleBufferA[gActiveBattler][5] | (gBattleBufferA[gActiveBattler][6] << 8);

      let src = gBattleBufferA[gActiveBattler][7];
      let dst = (u8 *)(dstArg);
      let size = sizeArg;
...
export function SpriteCB_FreePlayerSpriteLoadMonSprite(...args: any[]): any {
  let battler = sprite.sBattlerId;
...
export function Task_StartSendOutAnim(...args: any[]): any {
...
export function PlayerHandleBattleAnimation(): any {
  if (!IsBattleSEPlaying(gActiveBattler))
      {
          let animationId = gBattleBufferA[gActiveBattler][1];
          let argument = gBattleBufferA[gActiveBattler][2] | (gBattleBufferA[gActiveBattler][3] << 8);
