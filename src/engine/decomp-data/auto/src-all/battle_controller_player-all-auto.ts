...
const {
  ...
  DecompressTrainerBackPic, DecompressTrainerFrontPic, DestroySprite, DestroyTask,
  DmaCopy16, DoBounceEffect, DoHitAnimHealthboxEffect, DoMoveAnim,
  DoPokeballSendOutAnimation, EndBounceEffect, FadeOutMapMusic, FreeAllWindowBuffers,
  FreeOamMatrix, FreeSpriteOamMatrix, FreeSpritePaletteByTag, FreeSpriteTilesByTag,
  GET_BATTLER_SIDE, GetBattlerAtPosition, GetBattlerPosition, GetBattlerSide,
  GetBattlerSpriteCoord, GetBattlerSpriteDefault_Y, GetBattlerSpriteSubpriority, GetDefaultMoveTarget,
  GetMonData, GetMultiplayerId, GetSpritePaletteTagByPaletteNum, HandleBattleWindow,
  ...
  OpenPartyMenuInBattle, PlayBGM, PlayCry_ByMode, PlayFanfare,
  PlaySE, PlaySE12WithPanning, PlayerGenderToFrontTrainerPicId, PrepareBufferDataTransferLink,
  RecordedBattle_RecordAllBattlerData, ReshowBattleScreenDummy, SetBattleBarStruct, SetBattlerSpriteAffineMode,
  SetCloseLinkCallback, SetHealthboxSpriteInvisible, SetHealthboxSpriteVisible, SetLinkStandbyCallback,
  SetMainCallback2, SetMonData, SetMultiuseSpriteTemplateToPokemon, SetMultiuseSpriteTemplateToTrainerBack,
  SetMultiuseSpriteTemplateToTrainerFront, SetPpNumbersPaletteInMoveSelection, SetSpritePrimaryCoordsFromSecondaryCoords, StartHealthboxSlideIn,
  StartSpriteAnim, StoreSpriteCallbackInData6, StringCopy, StringCopy_Nickname,
  SwapHpBarsWithHpText, T1_READ_16, TryHandleLaunchBattleTableAnimation, TryPutLinkBattleTvShowOnAir,
