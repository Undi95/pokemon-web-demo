...
const {
  AnimatePartySlot, CantUseSoftboiledOnMon, ClearStdWindowAndFrameToTransparent, ClearWindowTilemap,
  DisplayPartyMenuMessage, DisplayPartyMenuStdMessage, GetCursorSelectionMonId, GetMonData,
  GetMonNickname, IsPartyMenuTextPrinterActive, PartyMenuModifyHP, PlaySE,
  ScheduleBgCopyTilemapToVram, StringExpandPlaceholders,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
