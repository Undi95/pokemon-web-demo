...
export function mini_pchar_decode(...args: any[]): any {
  let ret = '?';
...
export function _putsAscii(...args: any[]): any {
  let p0: any = null;
      let i: any = null;
      let b: any = null;
...
export function _putsEncoded(...args: any[]): any {
  let p0: any = null;
      let i: any = null;
      let b: any = null;
...
export function mini_strlen(...args: any[]): any {
  let len = 0;
      while (s[len] != '\0') len++;
      return len;
}
...
export function mini_itoa(...args: any[]): any {
  let pbuffer = buffer;
      let negative = 0;
      let i, len;
...
export function mini_itoa_bin(...args: any[]): any {
  let pbuffer = buffer;
      let i, len;
...
export function mini_pad(...args: any[]): any {
  let i: any = null;
      let overflow = FALSE;
      let pbuffer = buffer;
      if(pad_to == 0)
...
export function mini_vsnprintf(...args: any[]): any {
  let b: any = null;
      let n: any = null;
      b.buffer = buffer;
      b.pbuffer = buffer;
...
export function mini_vpprintf(...args: any[]): any {
  const bf: any[] = [];
      const bf2: any[] = [];
      let ch: any = null;
      let n: any = null;
