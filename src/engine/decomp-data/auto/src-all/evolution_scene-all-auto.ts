...
export function Task_BeginEvolutionScene(...args: any[]): any {
  let mon: any = NULL;
...
export function BeginEvolutionScene(...args: any[]): any {
  let taskId = CreateTask(Task_BeginEvolutionScene, 0);
...
export function EvolutionScene(...args: any[]): any {
  const name: any[] = [];
...
export function CB2_TradeEvolutionSceneLoadGraphics(): any {
  let mon: any = gPlayerParty[gTasks[sEvoStructPtr.evoTaskId].tPartyId];
      let postEvoSpecies = gTasks[sEvoStructPtr.evoTaskId].tPostEvoSpecies;
...
export function TradeEvolutionScene(...args: any[]): any {
  const name: any[] = [];
      let currSpecies: any = null;
      let trainerId, personality;
      let pokePal: any = null;
...
export function CreateShedinja(...args: any[]): any {
  let data = 0;
...
export function Task_EvolutionScene(...args: any[]): any {
  let var: any = null;
          ...
          case MVSTATE_HANDLE_MOVE_SELECT:
              if (!gPaletteFade.active && gMain.callback2 == CB2_EvolutionSceneUpdate)
              {
                  ...
                  else
                  {
                      ...
                      let move = GetMonData(mon, var + MON_DATA_MOVE1);
                      if (IsHMMove2(move))
                      {
...
export function Task_TradeEvolutionScene(...args: any[]): any {
  let var = 0;
      let mon: any = gPlayerParty[gTasks[taskId].tPartyId];
...
export function Task_UpdateBgPalette(...args: any[]): any {
...
export function CreateBgAnimTask(...args: any[]): any {
  let taskId = CreateTask(Task_AnimateBg, 7);
...
export function Task_AnimateBg(...args: any[]): any {
  u16 *outer_X, *outer_Y;
...
export function InitMovingBgPalette(...args: any[]): any {
  let i, j;
...
export function StartBgAnimation(...args: any[]): any {
