...
export function TryRunFromBattle(...args: any[]): any {
  let effect = FALSE;
...
export function GetBattlerForBattleScript(...args: any[]): any {
  let ret = 0;
      switch (caseId)
      {
      case BS_TARGET:
...
export function PressurePPLose(...args: any[]): any {
...
export function PressurePPLoseOnUsingImprison(...args: any[]): any {
  let i, j;
      let imprisonPos = MAX_MON_MOVES;
      let atkSide = GetBattlerSide(attacker);
...
export function PressurePPLoseOnUsingPerishSong(...args: any[]): any {
  let i, j;
...
export function MarkBattlerForControllerExec(...args: any[]): any {
...
export function MarkBattlerReceivedLinkData(...args: any[]): any {
  let i: any = null;
...
export function CancelMultiTurnMoves(...args: any[]): any {
...
export function WasUnableToUseMove(...args: any[]): any {
...
export function PrepareStringBattle(...args: any[]): any {
...
export function OpponentSwitchInResetSentPokesToOpponentValue(...args: any[]): any {
  let i = 0;
      let bits = 0;

      if (GetBattlerSide(battler) == B_SIDE_OPPONENT)
      {
          let flank = ((battler & BIT_FLANK) >> 1);
...
export function UpdateSentPokesToOpponentValue(...args: any[]): any {
  if (GetBattlerSide(battler) == B_SIDE_OPPONENT)
      {
...
export function BattleScriptPush(...args: any[]): any {
...
export function TrySetCantSelectMoveBattleScript(): any {
  let limitations = 0;
      let move = gBattleMons[gActiveBattler].moves[gBattleBufferB[gActiveBattler][2]];
      let holdEffect: any = null;
      let choicedMove = gBattleStruct.choicedMove[gActiveBattler];
...
export function CheckMoveLimitations(...args: any[]): any {
  let holdEffect: any = null;
      let choicedMove = gBattleStruct.choicedMove[battlerId];
      let i: any = null;
...
export function AreAllMovesUnusable(): any {
  let unusable = CheckMoveLimitations(gActiveBattler, 0, MOVE_LIMITATIONS_ALL);
...
export function GetImprisonedMovesCount(...args: any[]): any {
  let i: any = null;
      let imprisonedMoves = 0;
      let battlerSide = GetBattlerSide(battlerId);
  ...
  let effect = 0;
      ...
      do
      {
          ...
          case ENDTURN_ORDER:
              ...
              {
                  let var = gBattleStruct.turnCountersTracker;
                  (*var)++;
...
export function HandleWishPerishSongOnTurnEnd(): any {
  gHitMarker |= (HITMARKER_GRUDGE | HITMARKER_IGNORE_BIDE);
      ...
      case 0:
          ...
          {
              let state = gBattleStruct.wishPerishSongState;
              *state = 1;
...
export function AtkCanceler_UnableToUseMove(): any {
  let effect = 0;
      let bideDmg = gBattleScripting.bideDmg;
      do
      {
...
export function HasNoMonsToSwitch(...args: any[]): any {
...
export function CastformDataTypeChange(...args: any[]): any {
  let formChange = 0;
...
export function AbilityBattleEffects(...args: any[]): any {
  let effect = 0;
...
export function BattleScriptExecute(...args: any[]): any {
...
export function BattleScriptPushCursorAndCallback(...args: any[]): any {
  BattleScriptPushCursor();
      gBattlescriptCurrInstr = BS_ptr;
      gBattleResources.battleCallbackStack.function[gBattleResources.battleCallbackStack.size++] = gBattleMainFunc;
...
export function ItemBattleEffects(...args: any[]): any {
  let i = 0;
          ...
          if (gBattleMons[battlerId].hp)
          {
              ...
              case HOLD_EFFECT_RESTORE_PP:
                  if (!moveTurn)
                  {
                      ...
                      if (i != MAX_MON_MOVES)
                      {
                          let maxPP = CalculatePPWithBonus(move, ppBonuses, i);
...
export function ClearFuryCutterDestinyBondGrudge(...args: any[]): any {
...
export function GetMoveTarget(...args: any[]): any {
  let targetBattler = 0;
...
export function IsBattlerModernFatefulEncounter(...args: any[]): any {
