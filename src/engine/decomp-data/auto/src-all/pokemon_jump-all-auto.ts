...
export function StartPokemonJump(...args: any[]): any {
  let taskId: any = null;
...
export function InitGame(...args: any[]): any {
...
export function ResetForNewGame(...args: any[]): any {
  let i: any = null;
...
export function GetPokemonJumpSpeciesIdx(...args: any[]): any {
  let i: any = null;
...
export function InitJumpMonInfo(...args: any[]): any {
...
export function SetPokeJumpTask(...args: any[]): any {
  sPokemonJump.taskId = CreateTask(func, 1);
      sPokemonJump.mainState = 0;
}

/** static void Task_StartPokemonJump(u8 taskId) */
export function Task_StartPokemonJump(...args: any[]): any {
...
export function SetLinkTimeInterval(...args: any[]): any {
...
export function SetFunc_Leader(...args: any[]): any {
  let i: any = null;
...
export function Task_PokemonJump_Leader(...args: any[]): any {
  RecvLinkData_Leader();
      TryUpdateScore();
...
export function SetFunc_Member(...args: any[]): any {
  sPokemonJump.comm.funcId = funcId;
      sPokemonJump.mainState = 0;
      sPokemonJump.helperState = 0;
      sPokemonJump.funcActive = TRUE;
...
export function Task_PokemonJump_Member(...args: any[]): any {
  RecvLinkData_Member();
...
export function Task_CommunicateMonInfo(...args: any[]): any {
  let i: any = null;
...
export function SetTaskWithPokeJumpStruct(...args: any[]): any {
  let taskId = CreateTask(func, taskPriority);
...
export function IsPlayersMonState(...args: any[]): any {
  ...
  if (sPokemonJump.updateScore)
      {
          ...
          {
              let numPlayers = DoSameJumpTimeBonus(sPokemonJump.comm.receivedBonusFlags);
...
export function HandleMonState(): any {
  let i: any = null;
      let soundFlags = 0;
      let numPlayers = sPokemonJump.numPlayers;
...
export function UpdateJump(...args: any[]): any {
...
export function TryUpdateScore(): any {
  if (sPokemonJump.vineState == VINE_UPSWING_HIGH && sPokemonJump.prevVineState == VINE_UPSWING_LOW)
      ...
      {
          let numPlayers = GetNumPlayersForBonus(sPokemonJump.atJumpPeak3);
      ...
      if (sPokemonJump.initScoreUpdate)
      {
          let numAtPeak = GetPlayersAtJumpPeak();
...
export function AddJumpScore(...args: any[]): any {
...
export function GetNumPlayersForBonus(...args: any[]): any {
  let i = 0;
      let flags = 0;
      let count = 0;
...
export function GetScoreBonus(...args: any[]): any {
  return sScoreBonuses[numPlayers];
}

/** static void TryUpdateExcellentsRecord(u16 excellentsInRow) */
export function TryUpdateExcellentsRecord(...args: any[]): any {
...
export function GetPrizeItemId(): any {
  let index = Random() % ARRAY_COUNT(sPrizeItems);
...
export function GetQuantityLimitedByBag(...args: any[]): any {
...
export function IsSpeciesAllowedInPokemonJump(...args: any[]): any {
...
export function LoadSpriteSheetsAndPalettes(...args: any[]): any {
  let i: any = null;
...
export function ResetPokeJumpSpriteData(...args: any[]): any {
  let i: any = null;
...
export function CreateJumpMonSprite(...args: any[]): any {
...
export function DoStarAnim(...args: any[]): any {
...
export function SpriteCB_Star(...args: any[]): any {
...
export function Gfx_StartMonHitShake(...args: any[]): any {
...
export function Gfx_IsMonHitShakeActive(...args: any[]): any {
...
export function SpriteCB_MonHitShake(...args: any[]): any {
  if (++sprite.sTimer > 1)
      {
...
export function Gfx_StartMonHitFlash(...args: any[]): any {
  ResetPokeJumpSpriteData(jumpGfx.monSprites[multiplayerId]);
...
export function Gfx_StopMonHitFlash(...args: any[]): any {
  let i: any = null;
      let numPlayers = GetNumPokeJumpPlayers();
      for (i = 0; i < numPlayers; i++)
      {
...
export function SpriteCB_MonHitFlash(...args: any[]): any {
  if (++sprite.sTimer > 3)
      {
          sprite.sTimer = 0;
          sprite.invisible ^= 1;
...
export function Gfx_ResetMonSpriteSubpriorities(...args: any[]): any {
  let i: any = null;
      let numPlayers = GetNumPokeJumpPlayers();
      for (i = 0; i < numPlayers; i++)
...
export function Gfx_StartMonIntroBounce(...args: any[]): any {
  ResetPokeJumpSpriteData(jumpGfx.monSprites[multiplayerId]);
...
export function Gfx_IsMonIntroBounceActive(...args: any[]): any {
  let i: any = null;
      let numPlayers = GetNumPokeJumpPlayers();
      for (i = 0; i < numPlayers; i++)
      {
...
export function SpriteCB_MonIntroBounce(...args: any[]): any {
  switch (sprite.sState)
      {
      case 0:
          PlaySE(SE_BIKE_HOP);
...
export function CreateStarSprite(...args: any[]): any {
  let spriteId = CreateSprite(sSpriteTemplate_Star, x, y, 1);
      if (spriteId != MAX_SPRITES)
      {
...
export function CreateVineSprites(...args: any[]): any {
  let i: any = null;
      let count: any = null;
      let spriteId: any = null;
...
export function UpdateVineAnim(...args: any[]): any {
  let i, count, palNum;
...
export function StartPokeJumpCountdown(...args: any[]): any {
...
export function StartPokeJumpGfx(...args: any[]): any {
  let taskId: any = null;
...
export function InitPokeJumpGfx(...args: any[]): any {
  jumpGfx.mainState = 0;
...
export function SetUpPokeJumpGfxFuncById(...args: any[]): any {
  let i: any = null;
...
export function SetUpPokeJumpGfxFunc(...args: any[]): any {
...
export function Task_RunPokeJumpGfxFunc(...args: any[]): any {
...
export function PrintPrizeMessage(...args: any[]): any {
...
export function PrintPrizeFilledBagMessage(...args: any[]): any {
...
export function PrintNoRoomForPrizeMessage(...args: any[]): any {
  CopyItemName(itemId, sPokemonJumpGfx.itemName);
      DynamicPlaceholderTextUtil_Reset();
      DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, sPokemonJumpGfx.itemName);
...
export function AddMessageWindow(...args: any[]): any {
...
export function CreatePokeJumpYesNoMenu(...args: any[]): any {
  let window: any = null;
...
export function CreateJumpMonSprites(): any {
  int i, y, playersCount = GetNumPokeJumpPlayers();
      let xCoords = sMonXCoords[playersCount - 2];
...
export function SetMonSpriteY(...args: any[]): any {
  sPokemonJumpGfx.monSprites[id].y2 = y;
}

/** static void UpdateVineSwing(int vineState) */
export function UpdateVineSwing(...args: any[]): any {
...
export function DoSameJumpTimeBonus(...args: any[]): any {
  let i, numPlayers;
...
export function StartMonIntroBounce(...args: any[]): any {
...
export function AddPlayerNameWindows(): any {
  let window: any = null;
      ...
      let winCoords = sPlayerNameWindowCoords[playersCount - 2];
...
export function PrintPokeJumpPlayerName(...args: any[]): any {
  let x: any = null;
...
export function PrintPokeJumpPlayerNames(...args: any[]): any {
...
export function ShowBonus(...args: any[]): any {
...
export function Task_UpdateBonus(...args: any[]): any {
  if (!UpdateBonus())
          DestroyTask(taskId);
}

/** static void SendPacket_MonInfo(struct PokemonJump_MonInfo *monInfo) */
export function SendPacket_MonInfo(...args: any[]): any {
  let packet: any = null;
...
export function RecvPacket_MonInfo(...args: any[]): any {
  let packet: any = null;
...
export function SendPacket_LeaderState(...args: any[]): any {
  let packet: any = null;
...
export function RecvPacket_LeaderState(...args: any[]): any {
  let packet: any = null;
...
export function SendPacket_MemberState(...args: any[]): any {
  let packet: any = null;
...
export function RecvPacket_MemberStateToLeader(...args: any[]): any {
  let packet: any = null;
...
export function RecvPacket_MemberStateToMember(...args: any[]): any {
  let packet: any = null;
...
export function TryUpdateRecords(...args: any[]): any {
  let records: any = GetPokeJumpRecords();
      let newRecord = FALSE;
...
export function ShowPokemonJumpRecords(): any {
  let taskId = CreateTask(Task_ShowPokemonJumpRecords, 0);
      Task_ShowPokemonJumpRecords(taskId);
}

/** static void Task_ShowPokemonJumpRecords(u8 taskId) */
export function Task_ShowPokemonJumpRecords(...args: any[]): any {
  let window: any = null;
...
export function PrintRecordsText(...args: any[]): any {
  let i, x;
...
export function TruncateToFirstWordOnly(...args: any[]): any {
  for (;*str != EOS; str++)
      {
          if (*str == CHAR_SPACE)
          {
