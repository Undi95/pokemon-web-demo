...
const {
  ...
  GetLinkPlayerCount, GetMonData, GetMonInfoByMultiplayerId, GetMonSpritePalFromSpeciesAndPersonality,
  GetMultiplayerId, GetPokeJumpPlayerName, GetPokeJumpRecords, GetStringCenterAlignXOffset,
  GetStringWidth, GetWordTaskArg, HandleLoadSpecialPokePic, HideBg,
  ISO_RANDOMIZE1, IndexOfSpritePaletteTag, InitBgsFromTemplates, InitWindows,
  IsDma3ManagerBusyWithBgCopy, IsFanfareTaskInactive, IsLinkTaskFinished, IsMinigameCountdownRunning,
  IsNotWaitingForBGMStop, JOY_NEW, LoadCompressedSpritePalette, LoadCompressedSpriteSheet,
  LoadOam, LoadPalette, LoadSpritePalette, LoadSpriteSheet,
  LoadUserWindowBorderGfxOnBg, LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx, Menu_ProcessInputNoWrapClearOnChoose,
  PIXEL_FILL, PlayFanfare, PlaySE, ProcessSpriteCopyRequests,
  ...
  ScriptContext_Enable, SetBgTilemapBuffer, SetCloseLinkCallback, SetMainCallback2,
  SetVBlankCallback, SetWordTaskArg, ShowBg, StartMinigameCountdown,
  StartSpriteAnim, StringCopy, TransferPlttBuffer, UpdatePaletteFade,
  VINE_STATE_TIMER,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
