...
const {
  ARRAY_COUNT, AddBagItem, AddJumpScore, AddMessageWindow,
  AddPlayerNameWindows, AddTextPrinterParameterized, AddTextPrinterParameterized3, AddWindow,
  AllPlayersJumpedOrHit, Alloc, AllowVineUpdates, AnimateSprites,
  AreLinkQueuesEmpty, BG_PLTT_ID, BeginNormalPaletteFade, BlendPalettes,
  BuildOamBuffer, ChangeBgX, ChangeBgY, CheckBagHasSpace,
  ClearMessageWindow, ClearUnreadField, ClearWindowTilemap, CloseMessageAndResetScore,
  ClosePokeJumpLink, ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyItemName,
  CopyItemNameHandlePlural, CopyWindowToVram, CreateJumpMonSprite, CreateJumpMonSprites,
  CreatePokeJumpYesNoMenu, CreateSprite, CreateStarSprite, CreateTask,
  CreateVineSprites, CreateWirelessStatusIndicatorSprite, CreateYesNoMenu, DecompressAndCopyTileDataToVram,
  DestroyTask, DidAllPlayersClearVine, DigitObjUtil_CreatePrinter, DigitObjUtil_Free,
  DigitObjUtil_Init, DigitObjUtil_PrintNumOn, DisallowVineUpdates, DoGameIntro,
  DoPlayAgainPrompt, DoPrizeMessageAndFanfare, DoSameJumpTimeBonus, DoStarAnim,
  DoVineHitEffect, DrawPlayerNameWindows, DrawTextBorderOuter, DynamicPlaceholderTextUtil_ExpandPlaceholders,
  DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr, EraseYesNoWindow, FadeOutAndPlayNewMapMusic,
  FadeOutMapMusic, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, Free,
  FreeAllSpritePalettes, FreeAllWindowBuffers, FreePokemonJump, FreeTempTileDataBuffersIfPossible,
  FreeWindowsAndDigitObj, FuncIsActiveTask, GetLinkPlayerCount, GetMonData,
  GetMonInfoByMultiplayerId, GetMonSpritePalFromSpeciesAndPersonality, GetMultiplayerId, GetNumPlayersForBonus,
  GetNumPokeJumpPlayers, GetPlayersAtJumpPeak, GetPokeJumpMultiplayerId, GetPokeJumpPlayerName,
  GetPokeJumpRecords, GetPokemonJumpSpeciesIdx, GetPrizeData, GetPrizeItemId,
  GetPrizeQuantity, GetQuantityLimitedByBag, GetScoreBonus, GetStringCenterAlignXOffset,
  GetStringWidth, GetVineSpeed, GetWordTaskArg, Gfx_IsMonHitShakeActive,
  Gfx_IsMonIntroBounceActive, Gfx_ResetMonSpriteSubpriorities, Gfx_StartMonHitFlash, Gfx_StartMonHitShake,
  Gfx_StartMonIntroBounce, Gfx_StopMonHitFlash, HandleLoadSpecialPokePic, HandleMonState,
  HandlePlayAgainInput, HandleSwingRound, HasEnoughScoreForPrize, HideBg,
  ISO_RANDOMIZE1, IncrementGamesWithMaxPlayers, IndexOfSpritePaletteTag, InitBgsFromTemplates,
  InitDigitPrinters, InitGame, InitJumpMonInfo, InitPlayerAndJumpTypes,
  InitPokeJumpGfx, InitVineState, InitWindows, IsDma3ManagerBusyWithBgCopy,
  IsFanfareTaskInactive, IsGameOver, IsLinkTaskFinished, IsMinigameCountdownRunning,
  IsMonHitShakeActive, IsMonIntroBounceActive, IsNotWaitingForBGMStop, IsPlayersMonState,
  IsPokeJumpCountdownRunning, IsPokeJumpGfxFuncFinished, IsSpeciesAllowedInPokemonJump, JOY_NEW,
  LoadCompressedSpritePalette, LoadCompressedSpriteSheet, LoadOam, LoadPalette,
  LoadSpritePalette, LoadSpriteSheet, LoadSpriteSheetsAndPalettes, LoadUserWindowBorderGfxOnBg,
  LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx, Menu_ProcessInputNoWrapClearOnChoose, PIXEL_FILL,
  PlayFanfare, PlaySE, PokeJumpRandom, PrintJumpsInRow,
  PrintNoRoomForPrizeMessage, PrintPokeJumpPlayerName, PrintPokeJumpPlayerNames, PrintPrizeFilledBagMessage,
  PrintPrizeMessage, PrintRecordsText, PrintScore, PrintScoreSuffixes,
  ProcessSpriteCopyRequests, PutWindowTilemap, Random, RecvLinkData_Leader,
  RecvLinkData_Member, RecvPacket_LeaderState, RecvPacket_MemberStateToLeader, RecvPacket_MemberStateToMember,
  RecvPacket_MonInfo, RemoveMessageWindow, RemoveWindow, ResetBgPositions,
  ResetBgsAndClearDma3BusyFlags, ResetForNewGame, ResetMonSpriteSubpriorities, ResetPlayersForNewGame,
  ResetPlayersJumpStates, ResetPlayersMonState, ResetPokeJumpSpriteData, ResetSpriteData,
  ResetTasks, ResetTempTileDataBuffers, ResetVineAfterHit, ResetVineGfx,
  ResetVineState, Rfu_SendPacket, RunTasks, SPRITE_SHAPE,
  SPRITE_SIZE, ScriptContext_Enable, SendLinkData_Leader, SendLinkData_Member,
  SendPacket_LeaderState, SendPacket_MemberState, SendPacket_MonInfo, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetFunc_Leader, SetFunc_Member, SetLinkTimeInterval,
  SetMainCallback2, SetMonSpriteY, SetMonStateHit, SetMonStateJump,
  SetMonStateNormal, SetPokeJumpTask, SetTaskWithPokeJumpStruct, SetUpPokeJumpGfxFunc,
  SetUpPokeJumpGfxFuncById, SetUpResetVineGfx, SetVBlankCallback, SetWordTaskArg,
  ShouldPlayAgain, ShowBg, ShowBonus, StartMinigameCountdown,
  StartMonHitFlash, StartMonHitShake, StartMonIntroBounce, StartPokeJumpCountdown,
  StartPokeJumpGfx, StartSpriteAnim, StopMonHitFlash, StringCopy,
  Task_ShowPokemonJumpRecords, TransferPlttBuffer, TruncateToFirstWordOnly, TryGivePrize,
  TryUpdateExcellentsRecord, TryUpdateRecords, TryUpdateScore, TryUpdateVineSwing,
  UnpackPrizeData, UpdateBonus, UpdateGame, UpdateJump,
  UpdatePaletteFade, UpdateVineAnim, UpdateVineHitStates, UpdateVineSpeed,
  UpdateVineState, UpdateVineSwing, VINE_STATE_TIMER,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
