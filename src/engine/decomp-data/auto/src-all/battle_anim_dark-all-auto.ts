...
export function AnimTask_AttackerFadeToInvisible(...args: any[]): any {
  CMD_ARGS(stepDelay);
...
export function AnimTask_AttackerFadeToInvisible_Step(...args: any[]): any {
  let blendA = gTasks[taskId].data[1] >> 8;
      let blendB = gTasks[taskId].data[1];
...
export function AnimTask_AttackerFadeFromInvisible(...args: any[]): any {
  CMD_ARGS(stepDelay);
...
export function AnimTask_AttackerFadeFromInvisible_Step(...args: any[]): any {
  let blendA = gTasks[taskId].data[1] >> 8;
      let blendB = gTasks[taskId].data[1];
      if (gTasks[taskId].data[2] == gTasks[taskId].data[0])
      {
...
export function AnimTask_InitAttackerFadeFromInvisible(...args: any[]): any {
...
export function AnimUnusedBagSteal(...args: any[]): any {
...
export function AnimUnusedBagSteal_Step(...args: any[]): any {
  sprite.data[3] += sprite.data[1];
      sprite.data[4] += sprite.data[2];
...
export function AnimBite(...args: any[]): any {
...
export function AnimBite_Step1(...args: any[]): any {
...
export function AnimBite_Step2(...args: any[]): any {
  sprite.data[4] -= sprite.data[0];
      sprite.data[5] -= sprite.data[1];
      sprite.x2 = sprite.data[4] >> 8;
      sprite.y2 = sprite.data[5] >> 8;
...
export function AnimTearDrop(...args: any[]): any {
...
export function AnimTearDrop_Step(...args: any[]): any {
  if (TranslateAnimHorizontalArc(sprite))
          DestroySpriteAndMatrix(sprite);
}

/** void AnimTask_MoveAttackerMementoShadow(u8 taskId) */
export function AnimTask_MoveAttackerMementoShadow(...args: any[]): any {
...
export function AnimTask_MoveAttackerMementoShadow_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_MoveTargetMementoShadow(...args: any[]): any {
  let animBg: any = null;
      let scanlineParams: any = null;
      let x: any = null;
      let i: any = null;
...
export function AnimTask_MoveTargetMementoShadow_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function DoMementoShadowEffect(...args: any[]): any {
  let var0, var1;
      let var2: any = null;
      let i: any = null;
      let var4: any = null;
...
export function SetAllBattlersSpritePriority(...args: any[]): any {
  let i: any = null;

      for (i = 0; i < MAX_BATTLERS_COUNT; i++)
      {
          let spriteId = GetAnimBattlerSpriteId(i);
...
export function AnimTask_InitMementoShadow(...args: any[]): any {
  let toBG2 = GetBattlerSpriteBGPriorityRank(gBattleAnimAttacker) ^ 1 ? 1 : 0;
...
export function AnimTask_MementoHandleBg(...args: any[]): any {
  let toBG2 = GetBattlerSpriteBGPriorityRank(gBattleAnimAttacker) ^ 1 ? TRUE : FALSE;
...
export function AnimClawSlash(...args: any[]): any {
...
export function AnimTask_MetallicShine(...args: any[]): any {
...
export function AnimTask_MetallicShine_Step(...args: any[]): any {
  let animBg: any = null;
      let paletteNum: any = null;
      let spriteId: any = null;
...
export function AnimTask_SetGrayscaleOrOriginalPal(...args: any[]): any {
...
export function GetIsDoomDesireHitTurn(...args: any[]): any {
  if (gAnimMoveTurn < 2)
