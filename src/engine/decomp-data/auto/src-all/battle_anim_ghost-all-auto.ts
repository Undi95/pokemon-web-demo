...
export function AnimConfuseRayBallBounce(...args: any[]): any {
...
export function AnimConfuseRayBallBounce_Step1(...args: any[]): any {
  let r0: any = null;
      let r2: any = null;
...
export function AnimConfuseRayBallBounce_Step2(...args: any[]): any {
  let r2: any = null;
      let r0: any = null;
      sprite.data[0] = 1;
...
export function UpdateConfuseRayBallBlend(...args: any[]): any {
...
export function AnimConfuseRayBallSpiral(...args: any[]): any {
...
export function AnimConfuseRayBallSpiral_Step(...args: any[]): any {
  let temp1: any = null;
...
export function AnimTask_NightShadeClone(...args: any[]): any {
...
export function AnimTask_NightShadeClone_Step1(...args: any[]): any {
...
export function AnimTask_NightShadeClone_Step2(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimShadowBall(...args: any[]): any {
  let oldPosX = sprite.x;
      let oldPosY = sprite.y;
...
export function AnimShadowBall_Step(...args: any[]): any {
...
export function AnimLick(...args: any[]): any {
  InitSpritePosToAnimTarget(sprite, TRUE);
      sprite.callback = AnimLick_Step;
}

/** static void AnimLick_Step(struct Sprite *sprite) */
export function AnimLick_Step(...args: any[]): any {
  let r5 = FALSE;
      let r6 = FALSE;
...
export function AnimTask_NightmareClone(...args: any[]): any {
  let task: any = null;
...
export function AnimTask_NightmareClone_Step(...args: any[]): any {
  let task: any = null;
...
export function AnimTask_SpiteTargetShadow(...args: any[]): any {
  let task: any = null;
...
export function AnimTask_SpiteTargetShadow_Step1(...args: any[]): any {
  let startLine: any = null;
      let task: any = gTasks[taskId];
      let position = GetBattlerSpriteBGPriorityRank(gBattleAnimTarget);
      ...
      case 0:
          ...
          else
          {
              ...
              else
              {
                  ...
                  if (position == 1)
                  {
                      let mask = DISPCNT_BG1_ON;
                      mask2 = mask;
                  }
                  else
                  {
                      let mask = DISPCNT_BG2_ON;
                      mask2 = mask;
                  }
...
export function AnimTask_SpiteTargetShadow_Step2(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[1]++;
...
export function AnimTask_SpiteTargetShadow_Step3(...args: any[]): any {
  let task: any = gTasks[taskId];
      let rank = GetBattlerSpriteBGPriorityRank(gBattleAnimTarget);
...
export function AnimDestinyBondWhiteShadow(...args: any[]): any {
...
export function AnimDestinyBondWhiteShadow_Step(...args: any[]): any {
  if (sprite.data[4])
      {
...
export function AnimTask_DestinyBondWhiteShadow(...args: any[]): any {
  let task: any = null;
...
export function AnimTask_DestinyBondWhiteShadow_Step(...args: any[]): any {
  let i: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_CurseStretchingBlackBg(...args: any[]): any {
  let startX, startY;
...
export function AnimTask_CurseStretchingBlackBg_Step1(...args: any[]): any {
  let step: any = null;
...
export function AnimTask_CurseStretchingBlackBg_Step2(...args: any[]): any {
...
export function AnimCurseNail(...args: any[]): any {
  let xDelta: any = null;
...
export function AnimCurseNail_Step1(...args: any[]): any {
  let var0: any = null;
...
export function AnimCurseNail_Step2(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          SetGpuReg(REG_OFFSET_BLDCNT, (BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_ALL));
...
export function AnimCurseNail_End(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDCNT, 0);
      SetGpuReg(REG_OFFSET_BLDALPHA, 0);
      gBattle_WIN0H = 0;
      gBattle_WIN0V = 0;
...
export function AnimGhostStatusSprite(...args: any[]): any {
  let coeffB: any = null;
      let coeffA: any = null;
...
export function AnimGhostStatusSprite_Step(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDCNT, 0);
      SetGpuReg(REG_OFFSET_BLDALPHA, 0);
      DestroyAnimSprite(sprite);
}
...
export function AnimTask_GrudgeFlames(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_GrudgeFlames_Step(...args: any[]): any {
  let i: any = null;
      let spriteId: any = null;
      let task: any = gTasks[taskId];
...
export function AnimGrudgeFlame(...args: any[]): any {
  let index: any = null;
...
export function AnimMonMoveCircular(...args: any[]): any {
  sprite.invisible = TRUE;
...
export function AnimMonMoveCircular_Step(...args: any[]): any {
  if (sprite.data[3])
      {
          sprite.data[3]--;
