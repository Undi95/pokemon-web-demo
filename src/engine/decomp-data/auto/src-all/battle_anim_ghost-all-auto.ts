...
// Source : src/battle_anim_ghost.c
// Generated : 2026-05-09
// DO NOT EDIT — re-run `node scripts/transpile-decomp-all.mjs` to refresh.
//
// Total : 37 functions extracted from src/battle_anim_ghost.c.
//
// IMPORTANT :
...
const {
  ...
  BeginNormalPaletteFade, BlendPalette, ClearGpuRegBits, CloneBattlerSpriteWithBlend,
  Cos, CpuCopy32, CreateSprite, DestroyAnimSprite,
  ...
  PlaySE, PlaySE12WithPanning, PrepareBattlerSpriteForRotScale, ResetSpriteRotScale,
  ScanlineEffect_InitWave, SetGpuReg, SetGpuRegBits, SetSpriteRotScale,
  Sin, StoreSpriteCallbackInData6, UpdateConfuseRayBallBlend, WIN_RANGE,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
...
export function AnimConfuseRayBallBounce_Step1(sprite: any): any {
  let r0: any = null;
      let r2: any = null;
...
export function AnimConfuseRayBallBounce_Step2(sprite: any): any {
  let r2: any = null;
      let r0: any = null;
      sprite.data[0] = 1;
...
export function UpdateConfuseRayBallBlend(sprite: any): any {
...
export function AnimConfuseRayBallSpiral(sprite: any): any {
...
export function AnimConfuseRayBallSpiral_Step(sprite: any): any {
  let temp1: any = null;
...
export function AnimTask_NightShadeClone_Step1(taskId: any): any {
...
export function AnimTask_NightShadeClone_Step2(taskId: any): any {
  let spriteId: any = null;
...
export function AnimShadowBall(sprite: any): any {
  let oldPosX: any = sprite.x;
      let oldPosY: any = sprite.y;
...
export function AnimShadowBall_Step(sprite: any): any {
...
export function AnimLick(sprite: any): any {
  InitSpritePosToAnimTarget(sprite, TRUE);
      sprite.callback = AnimLick_Step;
}

/** static void AnimLick_Step(struct Sprite *sprite) */
export function AnimLick_Step(sprite: any): any {
  let r5: any = FALSE;
      let r6: any = FALSE;
...
export function AnimTask_NightmareClone(taskId: any): any {
  let task: any = null;
...
export function AnimTask_NightmareClone_Step(taskId: any): any {
  let task: any = null;
...
export function AnimTask_SpiteTargetShadow(taskId: any): any {
  let task: any = null;
...
export function AnimTask_SpiteTargetShadow_Step1(taskId: any): any {
  let startLine: any = null;
      let task: any =gTasks[taskId];
      let position: any = GetBattlerSpriteBGPriorityRank(gBattleAnimTarget);
      ...
      case 0:
          ...
          else
          {
              ...
              else
              {
                  ...
                  if (position == 1)
                  {
                      let mask: any = DISPCNT_BG1_ON;
                      mask2 = mask;
                  }
                  else
                  {
                      let mask: any = DISPCNT_BG2_ON;
                      mask2 = mask;
                  }
...
export function AnimTask_SpiteTargetShadow_Step2(taskId: any): any {
  let task: any =gTasks[taskId];
      task.data[1]++;
...
export function AnimTask_SpiteTargetShadow_Step3(taskId: any): any {
  let task: any =gTasks[taskId];
      let rank: any = GetBattlerSpriteBGPriorityRank(gBattleAnimTarget);
...
export function AnimDestinyBondWhiteShadow(sprite: any): any {
  let battler1X, battler1Y;
      let battler2X, battler2Y;
      let yDiff: any = null;
...
export function AnimDestinyBondWhiteShadow_Step(sprite: any): any {
  if (sprite.data[4])
      {
...
export function AnimTask_DestinyBondWhiteShadow(taskId: any): any {
  let task: any = null;
...
export function AnimTask_DestinyBondWhiteShadow_Step(taskId: any): any {
  let i: any = null;
      let task: any =gTasks[taskId];
...
export function AnimTask_CurseStretchingBlackBg(taskId: any): any {
  let startX, startY;
      let leftDistance, topDistance, bottomDistance, rightDistance;
...
export function AnimTask_CurseStretchingBlackBg_Step1(taskId: any): any {
  let step: any = null;
...
export function AnimTask_CurseStretchingBlackBg_Step2(taskId: any): any {
...
export function AnimCurseNail(sprite: any): any {
  let xDelta: any = null;
...
export function AnimCurseNail_Step1(sprite: any): any {
  let var0: any = null;
...
export function AnimCurseNail_Step2(sprite: any): any {
  if (sprite.data[0] == 0)
      {
          SetGpuReg(REG_OFFSET_BLDCNT, (BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_ALL));
...
export function AnimCurseNail_End(sprite: any): any {
  SetGpuReg(REG_OFFSET_BLDCNT, 0);
      SetGpuReg(REG_OFFSET_BLDALPHA, 0);
      gBattle_WIN0H = 0;
      gBattle_WIN0V = 0;
...
export function AnimGhostStatusSprite(sprite: any): any {
  let coeffB: any = null;
      let coeffA: any = null;
...
export function AnimGhostStatusSprite_Step(sprite: any): any {
  SetGpuReg(REG_OFFSET_BLDCNT, 0);
      SetGpuReg(REG_OFFSET_BLDALPHA, 0);
      DestroyAnimSprite(sprite);
}
...
export function AnimTask_GrudgeFlames(taskId: any): any {
  let task: any =gTasks[taskId];
...
export function AnimTask_GrudgeFlames_Step(taskId: any): any {
  let i: any = null;
      let spriteId: any = null;
      let task: any =gTasks[taskId];
...
export function AnimGrudgeFlame(sprite: any): any {
  let index: any = null;
...
export function AnimMonMoveCircular(sprite: any): any {
  sprite.invisible = TRUE;
...
export function AnimMonMoveCircular_Step(sprite: any): any {
  if (sprite.data[3])
      {
          sprite.data[3]--;
...
export const __callsTo__: ReadonlyArray<string> = ["AllocSpritePalette","AnimTranslateLinear","BATTLE_PARTNER","BLDALPHA_BLEND","BeginNormalPaletteFade","BlendPalette","ClearGpuRegBits","CloneBattlerSpriteWithBlend","Cos","CpuCopy32","CreateSprite","DestroyAnimSprite","DestroyAnimVisualTask","DestroySprite","DestroySpriteAndMatrix","DestroySpriteWithActiveSheet","FreeSpritePaletteByTag","GetAnimBattlerSpriteId","GetBattlePalettesMask","GetBattlerSide","GetBattlerSpriteBGPriority","GetBattlerSpriteBGPriorityRank","GetBattlerSpriteCoord","GetBattlerSpriteCoordAttr","GetBattlerSpriteSubpriority","GetBattlerYCoordWithElevation","InitAnimLinearTranslationWithSpeed","InitSpritePosToAnimAttacker","InitSpritePosToAnimTarget","IsBattlerSpriteVisible","IsContest","OBJ_PLTT_ID2","PlaySE","PlaySE12WithPanning","PrepareBattlerSpriteForRotScale","ResetSpriteRotScale","ScanlineEffect_InitWave","SetGpuReg","SetGpuRegBits","SetSpriteRotScale","Sin","StoreSpriteCallbackInData6","UpdateConfuseRayBallBlend","WIN_RANGE"];
