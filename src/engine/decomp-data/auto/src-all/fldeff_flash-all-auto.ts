...
export function TryDoMapTransition(): any {
  let i: any = null;
      let fromType = GetLastUsedWarpMapType();
      let toType = GetCurrentMapType();
...
export function GetMapPairFadeToType(...args: any[]): any {
  let i: any = null;
      let fromType = _fromType;
      let toType = _toType;
...
export function GetMapPairFadeFromType(...args: any[]): any {
  let i: any = null;
      let fromType = _fromType;
      let toType = _toType;
...
export function Task_ExitCaveTransition1(...args: any[]): any {
  gTasks[taskId].func = Task_ExitCaveTransition2;
}

/** static void Task_ExitCaveTransition2(u8 taskId) */
export function Task_ExitCaveTransition2(...args: any[]): any {
  SetGpuReg(REG_OFFSET_DISPCNT, 0);
...
export function Task_ExitCaveTransition3(...args: any[]): any {
  let count = gTasks[taskId].data[1];
...
export function Task_ExitCaveTransition4(...args: any[]): any {
  let count: any = null;
...
export function Task_ExitCaveTransition5(...args: any[]): any {
...
export function Task_EnterCaveTransition1(...args: any[]): any {
  gTasks[taskId].func = Task_EnterCaveTransition2;
}

/** static void Task_EnterCaveTransition2(u8 taskId) */
export function Task_EnterCaveTransition2(...args: any[]): any {
  SetGpuReg(REG_OFFSET_DISPCNT, 0);
      LZ77UnCompVram(sCaveTransitionTiles, (void *)(VRAM + 0xC000));
      LZ77UnCompVram(sCaveTransitionTilemap, (void *)(VRAM + 0xF800));
...
export function Task_EnterCaveTransition3(...args: any[]): any {
  let count = gTasks[taskId].data[2];
...
export function Task_EnterCaveTransition4(...args: any[]): any {
  let count = 16 - gTasks[taskId].data[1];
      let blend = count + 0x1000;
