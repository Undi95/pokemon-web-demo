...
export function SetUpReflection(...args: any[]): any {
...
export function GetReflectionVerticalOffset(...args: any[]): any {
...
export function LoadObjectReflectionPalette(...args: any[]): any {
  let bridgeType: any = null;
      const bridgeReflectionVerticalOffsets: any = [
...
export function LoadObjectRegularReflectionPalette(...args: any[]): any {
...
export function LoadObjectHighBridgeReflectionPalette(...args: any[]): any {
  let graphicsInfo: any = GetObjectEventGraphicsInfo(objectEvent.graphicsId);
      if (graphicsInfo.reflectionPaletteTag != OBJ_EVENT_PAL_TAG_NONE)
      {
...
export function UpdateObjectReflectionSprite(...args: any[]): any {
...
export function CreateWarpArrowSprite(): any {
  let spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_ARROW], 0, 0, 82);
...
export function SetSpriteInvisible(...args: any[]): any {
  gSprites[spriteId].invisible = TRUE;
}

/** void ShowWarpArrowSprite(u8 spriteId, u8 direction, s16 x, s16 y) */
export function ShowWarpArrowSprite(...args: any[]): any {
  let sprite: any = gSprites[spriteId];
...
export function UpdateShadowFieldEffect(...args: any[]): any {
...
export function UpdateTallGrassFieldEffect(...args: any[]): any {
  let metatileBehavior: any = null;
      let localId: any = null;
      let objectEventId: any = null;
      let mapNum = sprite.sCurrentMap >> 8;
      let mapGroup = sprite.sCurrentMap;
...
export function FindTallGrassFieldEffectSpriteId(...args: any[]): any {
  let i: any = null;
...
export function UpdateLongGrassFieldEffect(...args: any[]): any {
  let metatileBehavior: any = null;
      let localId: any = null;
      let objectEventId: any = null;
      let mapNum = sprite.sCurrentMap >> 8;
...
export function UpdateShortGrassFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
      ...
      else
      {
          ...
          let parentY = linkedSprite.y;
          let parentX = linkedSprite.x;
...
export function UpdateFootprintsTireTracksFieldEffect(...args: any[]): any {
  gFadeFootprintsTireTracksFuncs[sprite.sState](sprite);
}

/** static void FadeFootprintsTireTracks_Step0(struct Sprite *sprite) */
export function FadeFootprintsTireTracks_Step0(...args: any[]): any {
  if (++sprite.sTimer > 40)
          sprite.sState = 1;
...
export function FadeFootprintsTireTracks_Step1(...args: any[]): any {
  sprite.invisible ^= 1;
      sprite.sTimer++;
...
export function UpdateSplashFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
...
export function UpdateFeetInFlowingWaterFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
...
export function UpdateHotSpringsWaterFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
...
export function StartAshFieldEffect(...args: any[]): any {
...
export function UpdateAshFieldEffect(...args: any[]): any {
  gAshFieldEffectFuncs[sprite.sState](sprite);
}

/** static void UpdateAshFieldEffect_Wait(struct Sprite *sprite) */
export function UpdateAshFieldEffect_Wait(...args: any[]): any {
  sprite.invisible = TRUE;
...
export function UpdateAshFieldEffect_Show(...args: any[]): any {
  sprite.invisible = FALSE;
...
export function UpdateAshFieldEffect_End(...args: any[]): any {
  UpdateObjectEventSpriteInvisibility(sprite, FALSE);
      if (sprite.animEnded)
...
export function SetSurfBlob_BobState(...args: any[]): any {
...
export function SetSurfBlob_DontSyncAnim(...args: any[]): any {
...
export function SetSurfBlob_PlayerOffset(...args: any[]): any {
...
export function GetSurfBlob_BobState(...args: any[]): any {
  return sprite.sBitfield & 0xF;
}

/** static u8 GetSurfBlob_DontSyncAnim(struct Sprite *sprite) */
export function GetSurfBlob_DontSyncAnim(...args: any[]): any {
  return (sprite.sBitfield & 0xF0) >> 4;
}

/** static u8 GetSurfBlob_HasPlayerOffset(struct Sprite *sprite) */
export function GetSurfBlob_HasPlayerOffset(...args: any[]): any {
  return (sprite.sBitfield & 0xF00) >> 8;
}

/** void UpdateSurfBlobFieldEffect(struct Sprite *sprite) */
export function UpdateSurfBlobFieldEffect(...args: any[]): any {
...
export function SynchronizeSurfAnim(...args: any[]): any {
  const surfBlobDirectionAnims: any = [
          [DIR_NONE] = 0,
          [DIR_SOUTH] = 0,
          [DIR_NORTH] = 1,
          [DIR_WEST] = 2,
...
export function SynchronizeSurfPosition(...args: any[]): any {
  let i: any = null;
      let x = playerObj.currentCoords.x;
      let y = playerObj.currentCoords.y;
      let spriteY = sprite.y2;
...
export function UpdateBobbingEffect(...args: any[]): any {
  const intervals: any = [0x3, 0x7];

      let bobState = GetSurfBlob_BobState(sprite);
...
export function StartUnderwaterSurfBlobBobbing(...args: any[]): any {
  let spriteId = CreateSpriteAtEnd(gDummySpriteTemplate, 0, 0, -1);
      let sprite: any = gSprites[spriteId];
...
export function SpriteCB_UnderwaterSurfBlob(...args: any[]): any {
...
export function UpdateSandPileFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
      ...
      {
          let parentY = gSprites[gObjectEvents[objectEventId].spriteId].y;
          let parentX = gSprites[gObjectEvents[objectEventId].spriteId].x;
          if (parentX != sprite.sPrevX || parentY != sprite.sPrevY)
          {
              sprite.sPrevX = parentX;
              sprite.sPrevY = parentY;
...
export function UpdateBubblesFieldEffect(...args: any[]): any {
  sprite.sY += ((1 << 8) / 2);
      sprite.sY &= (1 << 8);
...
export function ShowDisguiseFieldEffect(...args: any[]): any {
  let spriteId: any = null;
...
export function UpdateDisguiseFieldEffect(...args: any[]): any {
  let objectEventId: any = null;
...
export function StartRevealDisguise(...args: any[]): any {
...
export function UpdateRevealDisguise(...args: any[]): any {
  let sprite: any = null;
...
export function UpdateSparkleFieldEffect(...args: any[]): any {
  if (!sprite.sFinished)
      {
          if (sprite.animEnded)
          {
...
export function InitRayquazaForFigure8Anim(...args: any[]): any {
  sprite.sAnimCounter = 0;
      sprite.sAnimState = 0;
}

/** static bool8 AnimateRayquazaInFigure8(struct Sprite *sprite) */
export function AnimateRayquazaInFigure8(...args: any[]): any {
  let finished = FALSE;
...
export function UpdateRayquazaSpotlightEffect(...args: any[]): any {
  let i, j;
...
export function UpdateJumpImpactEffect(...args: any[]): any {
  if (sprite.animEnded)
      {
...
export function WaitFieldEffectSpriteAnim(...args: any[]): any {
  if (sprite.animEnded)
...
export function UpdateGrassFieldEffectSubpriority(...args: any[]): any {
  let i: any = null;
      let var, xhi, lyhi, yhi, ylo;
