...
export function FontFunc_Braille(...args: any[]): any {
  let char_: any = null;
...
export function DecompressGlyph_Braille(...args: any[]): any {
  let glyphs = sFont_Braille + 0x100 * (glyph / 8) + 0x10 * (glyph % 8);
...
export function GetGlyphWidth_Braille(...args: any[]): any {
  return 16;
}
