...
export function LoadMessageBoxGfx(...args: any[]): any {
...
export function LoadUserWindowBorderGfx_(...args: any[]): any {
  LoadUserWindowBorderGfx(windowId, destOffset, palOffset);
}

/** void LoadWindowGfx(u8 windowId, u8 frameId, u16 destOffset, u8 palOffset) */
export function LoadWindowGfx(...args: any[]): any {
...
export function LoadUserWindowBorderGfx(...args: any[]): any {
  LoadWindowGfx(windowId, gSaveBlock2Ptr.optionsWindowFrameType, destOffset, palOffset);
}

/** void DrawTextBorderOuter(u8 windowId, u16 tileNum, u8 palNum) */
export function DrawTextBorderOuter(...args: any[]): any {
  let bgLayer = GetWindowAttribute(windowId, WINDOW_BG);
      let tilemapLeft = GetWindowAttribute(windowId, WINDOW_TILEMAP_LEFT);
      let tilemapTop = GetWindowAttribute(windowId, WINDOW_TILEMAP_TOP);
      let width = GetWindowAttribute(windowId, WINDOW_WIDTH);
      let height = GetWindowAttribute(windowId, WINDOW_HEIGHT);
...
export function DrawTextBorderInner(...args: any[]): any {
  let bgLayer = GetWindowAttribute(windowId, WINDOW_BG);
      let tilemapLeft = GetWindowAttribute(windowId, WINDOW_TILEMAP_LEFT);
      let tilemapTop = GetWindowAttribute(windowId, WINDOW_TILEMAP_TOP);
      let width = GetWindowAttribute(windowId, WINDOW_WIDTH);
...
export function rbox_fill_rectangle(...args: any[]): any {
  let bgLayer = GetWindowAttribute(windowId, WINDOW_BG);
      let tilemapLeft = GetWindowAttribute(windowId, WINDOW_TILEMAP_LEFT);
      let tilemapTop = GetWindowAttribute(windowId, WINDOW_TILEMAP_TOP);
      let width = GetWindowAttribute(windowId, WINDOW_WIDTH);
...
export function LoadUserWindowBorderGfxOnBg(...args: any[]): any {
