...
export function ApplyImageProcessingEffects(...args: any[]): any {
...
export function ApplyImageEffect_RedChannelGrayscale(...args: any[]): any {
  let i, j;

      for (j = 0; j < gCanvasRowEnd; j++)
      {
          let pixelRow = gCanvasPixels[(gCanvasRowStart + j) * gCanvasWidth];
...
export function ApplyImageEffect_RedChannelGrayscaleHighlight(...args: any[]): any {
  let i, j;
...
export function ApplyImageEffect_Blur(): any {
  let i, j;
      ...
      {
          let pixelRow = gCanvasPixels[gCanvasRowStart * gCanvasWidth];
...
export function ApplyImageEffect_PersonalityColor(...args: any[]): any {
  let i, j;
...
export function AddPointillismPoints(...args: any[]): any {
  let i: any = null;
      ...
      {
          let pixel = gCanvasPixels[points[i].row * MAX_DIMENSION] + points[i].column;
...
export function ConvertColorToGrayscale(...args: any[]): any {
  let clr = *color;
      let r = GET_R(clr);
      let g = GET_G(clr);
      let b = GET_B(clr);
      let gray = (r * Q_8_8(0.3) + g * Q_8_8(0.59) + b * Q_8_8(0.1133)) >> 8;
      return RGB2(gray, gray, gray);
}

/** static u16 QuantizePixel_PersonalityColor(u16 *color, u8 personality) */
export function QuantizePixel_PersonalityColor(...args: any[]): any {
  let red =   GET_R(*color);
...
export function GetColorFromPersonality(...args: any[]): any {
  let red =   0;
      let green = 0;
      let blue =  0;
      let strength = (personality / 6) % 3;
      let colorType = personality % 6;
...
export function QuantizePixel_BlackAndWhite(...args: any[]): any {
  let red =   GET_R(*color);
      let green = GET_G(*color);
      let blue =  GET_B(*color);
...
export function QuantizePixel_BlackOutline(...args: any[]): any {
  if (*pixelA != RGB_BLACK)
      {
          if (IS_ALPHA(*pixelA))
              return RGB_ALPHA;
...
export function QuantizePixel_Invert(...args: any[]): any {
  let red =   GET_R(*color);
      let green = GET_G(*color);
      let blue =  GET_B(*color);
...
export function QuantizePixel_MotionBlur(...args: any[]): any {
...
export function QuantizePixel_Blur(...args: any[]): any {
  let red, green, blue;
...
export function QuantizePixel_BlurHard(...args: any[]): any {
  let red, green, blue;
      let prevAvg, curAvg, nextAvg;
      let prevDiff, nextDiff;
      let diff: any = null;
...
export function ConvertImageProcessingToGBA(...args: any[]): any {
  let i, j, k;
...
export function ApplyImageProcessingQuantization(...args: any[]): any {
...
export function QuantizePalette_Standard(...args: any[]): any {
  let i, j;
      ...
      for (j = 0; j < gCanvasRowEnd; j++)
      {
          ...
          for (i = 0; i < gCanvasColumnEnd; i++, pixel++)
          {
              ...
              {
                  let quantizedColor = QuantizePixel_Standard(pixel);
                  let curIndex = 1;
...
export function QuantizePixel_Standard(...args: any[]): any {
  let red =   GET_R(*pixel);
      let green = GET_G(*pixel);
      let blue =  GET_B(*pixel);
...
export function QuantizePixel_PrimaryColors(...args: any[]): any {
  let red =   GET_R(*color);
      let green = GET_G(*color);
      let blue =  GET_B(*color);
...
export function QuantizePixel_GrayscaleSmall(...args: any[]): any {
  let red =   GET_R(*color);
      let green = GET_G(*color);
      let blue =  GET_B(*color);
      let average = ((red + green + blue) / 3) & 0x1E;
      if (average == 0)
          return 1;
      else
          return average / 2;
...
export function QuantizePixel_Grayscale(...args: any[]): any {
  let red =   GET_R(*color);
      let green = GET_G(*color);
      let blue =  GET_B(*color);
