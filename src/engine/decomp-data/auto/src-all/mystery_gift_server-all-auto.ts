...
export function MysterGiftServer_Run(...args: any[]): any {
  let result: any = null;
      if (sServer == NULL)
          return SVR_RET_END;
...
export function MysteryGiftServer_Init(...args: any[]): any {
  svr.unused = 0;
...
export function MysteryGiftServer_Free(...args: any[]): any {
  Free(svr.card);
      Free(svr.news);
      Free(svr.recvBuffer);
...
export function MysteryGiftServer_InitSend(...args: any[]): any {
...
export function MysteryGiftServer_GetSendData(...args: any[]): any {
  if (dynamicData != NULL)
          return dynamicData;
      else
          return defaultData;
...
export function MysteryGiftServer_Compare(...args: any[]): any {
  if (b < a)
          return 0;
      else if (b == a)
          return 1;
...
export function Server_Init(...args: any[]): any {
  svr.funcId = FUNC_RUN;
      return SVR_RET_INIT;
}

/** static u32 Server_Done(struct MysteryGiftServer *svr) */
export function Server_Done(...args: any[]): any {
  return SVR_RET_END;
}

/** static u32 Server_Recv(struct MysteryGiftServer *svr) */
export function Server_Recv(...args: any[]): any {
...
export function Server_Send(...args: any[]): any {
...
export function Server_Run(...args: any[]): any {
...
export function MysteryGiftServer_CallFunc(...args: any[]): any {
