...
// Source : src/mystery_gift_server.c
// Generated : 2026-05-09
// DO NOT EDIT — re-run `node scripts/transpile-decomp-all.mjs` to refresh.
//
// Total : 14 functions extracted from src/mystery_gift_server.c.
//
// IMPORTANT :
...
const {
  ...
  MysteryGiftLink_Recv, MysteryGiftLink_Send, MysteryGiftServer_CallFunc, MysteryGiftServer_Compare,
  MysteryGiftServer_Free, MysteryGiftServer_GetSendData, MysteryGiftServer_Init, MysteryGiftServer_InitSend,
  MysteryGift_CheckStamps, MysteryGift_CompareCardFlags, MysteryGift_DoesQuestionnaireMatch, MysteryGift_GetCardStatFromLinkData,
  MysteryGift_ValidateLinkGameData,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
...
export function MysteryGiftServer_Init(svr: any, script: any, sendPlayerId: any, recvPlayerId: any): any {
  svr.unused = 0;
...
export function MysteryGiftServer_Free(svr: any): any {
  Free(svr.card);
      Free(svr.news);
      Free(svr.recvBuffer);
...
export function MysteryGiftServer_GetSendData(dynamicData: any, defaultData: any): any {
  if (dynamicData != NULL)
          return dynamicData;
      else
          return defaultData;
...
export function MysteryGiftServer_Compare(a: any, b: any): any {
  if (b < a)
          return 0;
      else if (b == a)
          return 1;
...
export function Server_Init(svr: any): any {
  svr.funcId = FUNC_RUN;
      return SVR_RET_INIT;
}

/** static u32 Server_Done(struct MysteryGiftServer *svr) */
export function Server_Done(svr: any): any {
  return SVR_RET_END;
}

/** static u32 Server_Recv(struct MysteryGiftServer *svr) */
export function Server_Recv(svr: any): any {
...
export function Server_Send(svr: any): any {
...
export function Server_Run(svr: any): any {
  let cmd: any =svr.script[svr.cmdidx];
      let ptr: any = null;
      svr.cmdidx++;
      ...
      case SVR_COMPARE:
          AGB_ASSERT(cmd.parameter == 0);
          svr.param = MysteryGiftServer_Compare(cmd.ptr, svr.recvBuffer);
          break;
      case SVR_LOAD_NEWS:
          AGB_ASSERT(cmd.parameter == 0);
      ...
      case SVR_LOAD_EREADER_TRAINER:
          AGB_ASSERT(cmd.parameter == 0);
          MysteryGiftServer_InitSend(svr, MG_LINKID_EREADER_TRAINER, cmd.ptr, 0);
          break;
      case SVR_LOAD_MSG:
...
export function MysteryGiftServer_CallFunc(svr: any): any {
...
export const __callsTo__: ReadonlyArray<string> = ["AGB_ASSERT","ARRAY_COUNT","AllocZeroed","DisableWonderCardSending","FREE_AND_SET_NULL","Free","GetSavedRamScriptIfValid","GetSavedWonderCard","GetSavedWonderNews","MysteryGiftLink_Init","MysteryGiftLink_InitRecv","MysteryGiftLink_InitSend","MysteryGiftLink_Recv","MysteryGiftLink_Send","MysteryGiftServer_CallFunc","MysteryGiftServer_Compare","MysteryGiftServer_Free","MysteryGiftServer_GetSendData","MysteryGiftServer_Init","MysteryGiftServer_InitSend","MysteryGift_CheckStamps","MysteryGift_CompareCardFlags","MysteryGift_DoesQuestionnaireMatch","MysteryGift_GetCardStatFromLinkData","MysteryGift_ValidateLinkGameData"];
