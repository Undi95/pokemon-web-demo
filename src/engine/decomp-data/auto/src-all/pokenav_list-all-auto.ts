...
export function CreatePokenavList(...args: any[]): any {
  let list: any = AllocSubstruct(POKENAV_SUBSTRUCT_LIST, sizeof(struct PokenavList));
      if (list == NULL)
          return FALSE;
...
export function LoopedTask_CreatePokenavList(...args: any[]): any {
  let list: any = null;
...
export function InitPokenavListBg(...args: any[]): any {
...
export function InitPokenavListWindow(...args: any[]): any {
...
export function InitListItems(...args: any[]): any {
...
export function PrintListItems(...args: any[]): any {
  if (numItems == 0)
          return;
...
export function LoopedTask_PrintListItems(...args: any[]): any {
  let row: any = null;
...
export function MoveListWindow(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_LIST);
      let windowState: any = list.windowState;
...
export function CreateMoveListWindowTask(...args: any[]): any {
...
export function LoopedTask_MoveListWindow(...args: any[]): any {
  let oldY, newY;
...
export function PrintCheckPageInfo(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_LIST);
...
export function LoopedTask_EraseListForCheckPage(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_LIST);
...
export function LoopedTask_PrintCheckPageInfo(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_LIST);
      if (IsDma3ManagerBusyWithBgCopy())
          return LT_PAUSE;
...
export function LoopedTask_ReshowListFromCheckPage(...args: any[]): any {
  let list: any = null;
...
export function EraseListEntry(...args: any[]): any {
...
export function SetListMarginTile(...args: any[]): any {
  let var: any = null;
...
export function PrintCheckPageTrainerName(...args: any[]): any {
...
export function PrintMatchCallListTrainerName(...args: any[]): any {
  list.bufferItemFunc(state.listPtr + state.listItemSize * state.windowTopIndex, list.itemTextBuffer);
...
export function PrintMatchCallFieldNames(...args: any[]): any {
  const u8 *fieldNames[] = [
...
export function PrintMatchCallFlavorText(...args: any[]): any {
  const lineOffsets: any = [
...
export function CreateListArrowSprites(...args: any[]): any {
...
export function DestroyListArrows(...args: any[]): any {
...
export function ToggleListArrows(...args: any[]): any {
  if (invisible)
      {
...
export function SpriteCB_UpArrow(...args: any[]): any {
...
export function PokenavList_ToggleVerticalArrows(...args: any[]): any {
  let list: any = GetSubstructPtr(POKENAV_SUBSTRUCT_LIST);
...
export function InitPokenavListWindowState(...args: any[]): any {
...
export function CopyPokenavListMenuTemplate(...args: any[]): any {
  let window: any = null;
