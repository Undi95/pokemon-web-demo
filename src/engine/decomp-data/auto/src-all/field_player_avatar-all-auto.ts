...
const {
  ARRAY_COUNT, AddTextPrinterParameterized, AddTextPrinterParameterized2, AlignFishingAnimationFrames,
  AnimateSprite, BikeClearState, Bike_HandleBumpySlopeJump, Bike_TryAcroBikeHistoryUpdate,
  Bike_UpdateBikeCounterSpeed, CameraObjectFreeze, CameraObjectReset, CanStopSurfing,
  CheckAcroBikeCollision, CheckForObjectEventCollision, CheckForObjectEventStaticCollision, CheckForPlayerAvatarCollision,
  CheckForPlayerAvatarStaticCollision, CheckForRotatingGatePuzzleCollision, CheckForRotatingGatePuzzleCollisionWithoutAnimation, CheckMovementInputNotOnBike,
  ClearDialogWindowAndFrame, ClearPlayerAvatarInfo, CreateStopSurfingTask, CreateTask,
  CreateWarpArrowSprite, DestroySprite, DestroyTask, DoForcedMovement,
  DoForcedMovementInCurrentDirection, DoPlayerAvatarSecretBaseMatJump, DoPlayerAvatarTransition, DoPlayerMatJump,
  DoPlayerMatSpin, DoesCurrentMapHaveFishingMons, FieldEffectStart, FillWindowPixelBuffer,
  FindTaskIdByFunc, FishingWildEncounter, FlagGet, ForcedMovement_None,
  ForcedMovement_Slide, FuncIsActiveTask, GetAcroEndWheelieFaceDirectionMovementAction, GetAcroEndWheelieMoveDirectionMovementAction,
  ...
  GetFishingBiteDirectionAnimNum, GetFishingDirectionAnimNum, GetFishingNoCatchDirectionAnimNum, GetForcedMovementByMetatileBehavior,
  GetJump2MovementAction, GetJumpInPlaceMovementAction, GetJumpInPlaceTurnAroundMovementAction, GetJumpSpecialMovementAction,
  GetLedgeJumpDirection, GetMonAbility, GetMonData, GetObjectEventIdByLocalIdAndMap,
  GetObjectEventIdByPosition, GetObjectEventIdByXY, GetOppositeDirection, GetPlayerAvatarGraphicsIdByStateId,
  ...
  GetPlayerRunMovementAction, GetPlayerSpeed, GetRideWaterCurrentMovementAction, GetSpinStartFacingDir,
  GetWalkFastMovementAction, GetWalkFasterMovementAction, GetWalkInPlaceFastMovementAction, GetWalkInPlaceNormalMovementAction,
  GetWalkInPlaceSlowMovementAction, GetWalkNormalMovementAction, GetWalkSlowMovementAction, HideShowWarpArrow,
  IncrementGameStat, IsPlayerCollidingWithFarawayIslandMew, IsPlayerNotUsingAcroBikeOnBumpySlope, IsRunningDisallowed,
  IsTextPrinterActive, JOY_NEW, LoadMessageBoxAndFrameGfx, LockPlayerFieldControls,
  ...
  MoveCoords, MoveObjectEventToMapCoords, MovePlayerAvatarUsingKeypadInput, MovePlayerNotOnBike,
  ...
  Overworld_ChangeMusicToDefault, Overworld_ClearSavedMusic, PIXEL_FILL, PlayCollisionSoundIfNotFacingWarp,
  PlaySE, PlayerAllowForcedMovementIfMovingSameDirection, PlayerAnimIsMultiFrameStationary, PlayerAnimIsMultiFrameStationaryAndStateNotTurning,
  PlayerAvatar_DoSecretBaseMatSpin, PlayerCheckIfAnimFinishedOrInactive, PlayerFaceDirection, PlayerForceSetHeldMovement,
  PlayerGetDestCoords, PlayerGetElevation, PlayerIsAnimActive, PlayerJumpLedge,
  PlayerNotOnBikeCollide, PlayerNotOnBikeCollideWithFarawayIslandMew, PlayerRun, PlayerSetAnimId,
  PlayerSetCopyableMovement, PlayerTurnInPlace, PlayerWalkFast, PlayerWalkNormal,
  Random, RecordFishingAttemptForTV, RunTextPrinters, SeekSpriteAnim,
  SetObjectEventDirection, SetPlayerAvatarFishing, SetPlayerAvatarStateMask, SetSpinStartFacingDir,
  SetSpriteInvisible, SetSurfBlob_BobState, SetSurfBlob_PlayerOffset, ShouldJumpLedge,
  ShowWarpArrowSprite, SpawnSpecialObjectEvent, StartSpriteAnim, StartStrengthAnim,
  StartUnderwaterSurfBlobBobbing, Task_DoPlayerSpinEntrance, Task_DoPlayerSpinExit, Task_Fishing,
  Task_PushBoulder, Task_StopSurfingInit, TestPlayerAvatarFlags, TryDoMetatileBehaviorForcedMovement,
  TryInterruptObjectEventSpecialAnim, TryPushBoulder, TrySpinPlayerForWarp, UnfreezeObjectEvents,
