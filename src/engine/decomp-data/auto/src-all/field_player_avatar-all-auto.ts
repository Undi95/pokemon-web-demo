...
const {
  ...
  ClearDialogWindowAndFrame, CreateTask, CreateWarpArrowSprite, DestroySprite,
  DestroyTask, DoesCurrentMapHaveFishingMons, FieldEffectStart, FillWindowPixelBuffer,
  FindTaskIdByFunc, FishingWildEncounter, FlagGet, FuncIsActiveTask,
  GetAcroEndWheelieFaceDirectionMovementAction, GetAcroEndWheelieMoveDirectionMovementAction, GetAcroPopWheelieFaceDirectionMovementAction, GetAcroPopWheelieMoveDirectionMovementAction,
  GetAcroWheelieDirectionAnimNum, GetAcroWheelieFaceDirectionMovementAction, GetAcroWheelieHopDirectionMovementAction, GetAcroWheelieHopFaceDirectionMovementAction,
  GetAcroWheelieInPlaceDirectionMovementAction, GetAcroWheelieJumpDirectionMovementAction, GetAcroWheelieMoveDirectionMovementAction, GetCollisionAtCoords,
  GetFaceDirectionAnimNum, GetFaceDirectionMovementAction, GetFishingBiteDirectionAnimNum, GetFishingDirectionAnimNum,
  GetFishingNoCatchDirectionAnimNum, GetJump2MovementAction, GetJumpInPlaceMovementAction, GetJumpInPlaceTurnAroundMovementAction,
  GetJumpSpecialMovementAction, GetLedgeJumpDirection, GetMonAbility, GetMonData,
  GetObjectEventIdByLocalIdAndMap, GetObjectEventIdByPosition, GetObjectEventIdByXY, GetOppositeDirection,
  GetPlayerRunMovementAction, GetPlayerSpeed, GetRideWaterCurrentMovementAction, GetWalkFastMovementAction,
  GetWalkFasterMovementAction, GetWalkInPlaceFastMovementAction, GetWalkInPlaceNormalMovementAction, GetWalkInPlaceSlowMovementAction,
  GetWalkNormalMovementAction, GetWalkSlowMovementAction, IncrementGameStat, IsPlayerNotUsingAcroBikeOnBumpySlope,
  IsRunningDisallowed, IsTextPrinterActive, JOY_NEW, LoadMessageBoxAndFrameGfx,
  LockPlayerFieldControls, MAP_GROUP, MAP_NUM, MapGridGetElevationAt,
  MapGridGetMetatileBehaviorAt, MetatileBehavior_IsNonAnimDoor, MetatileBehavior_IsSurfableFishableWater, MetatileBehavior_IsWarpDoor,
  MonKnowsMove, MoveCoords, MoveObjectEventToMapCoords, MovePlayerOnBike,
  ObjectEventCheckHeldMovementStatus, ObjectEventClearHeldMovement, ObjectEventClearHeldMovementIfActive, ObjectEventClearHeldMovementIfFinished,
  ObjectEventForceSetHeldMovement, ObjectEventGetHeldMovementActionId, ObjectEventIsHeldMovementActive, ObjectEventIsMovementOverridden,
  ObjectEventSetGraphicsId, ObjectEventSetHeldMovement, ObjectEventTurn, Overworld_ChangeMusicToDefault,
  Overworld_ClearSavedMusic, PIXEL_FILL, PlaySE, Random,
  RecordFishingAttemptForTV, RunTextPrinters, SeekSpriteAnim, SetObjectEventDirection,
  SetSpriteInvisible, SetSurfBlob_BobState, SetSurfBlob_PlayerOffset, ShowWarpArrowSprite,
  SpawnSpecialObjectEvent, StartSpriteAnim, StartUnderwaterSurfBlobBobbing, UnfreezeObjectEvents,
