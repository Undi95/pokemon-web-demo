...
export function CyclePalette(...args: any[]): any {
  let idx: any = null;
      if (++(*counter) > 5)
      {
...
export function Task_WirelessCommunicationScreen(...args: any[]): any {
  let i: any = null;
...
export function WCSS_AddTextPrinterParameterized(...args: any[]): any {
  const color: any[] = [];
...
export function CountPlayersInGroupAndGetActivity(...args: any[]): any {
  let i, j, k;
      let activity = player.rfu.data.activity;
...
export function HaveCountsChanged(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < NUM_GROUPTYPES; i++)
      {
...
export function UpdateCommunicationCounts(...args: any[]): any {
  let activitiesChanged = FALSE;
      const groupCountBuffer: any = [0, 0, 0, 0];
      let players: any = (void *)gTasks[taskId].data;
      let i: any = null;

      for (i = 0; i < NUM_TASK_DATA; i++)
      {
          let activity = CountPlayersInGroupAndGetActivity(&(*players)[i], groupCountBuffer);
