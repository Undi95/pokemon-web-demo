...
export function PrintCreditsText(...args: any[]): any {
  let x: any = null;
      const color: any[] = [];
...
export function Task_WaitPaletteFade(...args: any[]): any {
  if (!gPaletteFade.active)
          gTasks[taskId].func = Task_CreditsMain;
}

/** static void Task_CreditsMain(u8 taskId) */
export function Task_CreditsMain(...args: any[]): any {
  let mode: any = null;
...
export function Task_ReadyBikeScene(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_SetBikeScene(...args: any[]): any {
  SetVBlankCallback(NULL);
...
export function Task_ReadyShowMons(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          SetGpuReg(REG_OFFSET_DISPCNT, 0);
          ResetCreditsTasks(taskId);
...
export function Task_LoadShowMons(...args: any[]): any {
  switch (gMain.state)
      {
      default:
      case 0:
...
export function Task_CreditsTheEnd1(...args: any[]): any {
...
export function Task_CreditsTheEnd2(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          ResetCreditsTasks(taskId);
...
export function Task_CreditsTheEnd3(...args: any[]): any {
  ResetGpuAndVram();
      ResetPaletteFade();
...
export function Task_CreditsTheEnd4(...args: any[]): any {
...
export function Task_CreditsTheEnd5(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          DrawTheEnd(0x3800, 0);
...
export function Task_CreditsTheEnd6(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_CreditsSoftReset(...args: any[]): any {
  if (!gPaletteFade.active)
          SoftReset(RESET_ALL);
}
...
export function Task_UpdatePage(...args: any[]): any {
  let i: any = null;
...
export function CheckChangeScene(...args: any[]): any {
...
export function Task_ShowMons(...args: any[]): any {
...
export function Task_BikeScene(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
...
export function Task_CycleSceneryPalette(...args: any[]): any {
  let bikeTaskId: any = null;
...
export function SetBikeScene(...args: any[]): any {
  switch (scene)
      {
      case SCENE_OCEAN_MORNING:
...
export function LoadBikeScene(...args: any[]): any {
  let spriteId: any = null;
...
export function ResetCreditsTasks(...args: any[]): any {
...
export function LoadTheEndScreen(...args: any[]): any {
...
export function SpriteCB_Rival(...args: any[]): any {
  if (gIntroCredits_MovingSceneryState != INTROCRED_SCENERY_NORMAL)
      {
          DestroySprite(sprite);
          return;
...
export function SpriteCB_CreditsMon(...args: any[]): any {
  if (gIntroCredits_MovingSceneryState != INTROCRED_SCENERY_NORMAL)
      {
...
export function CreateCreditsMonSprite(...args: any[]): any {
...
export function SpriteCB_CreditsMonBg(...args: any[]): any {
