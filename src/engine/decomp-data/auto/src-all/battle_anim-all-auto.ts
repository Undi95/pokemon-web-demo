...
export function DoMoveAnim(...args: any[]): any {
...
export function LaunchBattleAnimation(...args: any[]): any {
  let i: any = null;
...
export function DestroyAnimSprite(...args: any[]): any {
...
export function DestroyAnimVisualTask(...args: any[]): any {
  DestroyTask(taskId);
      gAnimVisualTaskCount--;
}

/** void DestroyAnimSoundTask(u8 taskId) */
export function DestroyAnimSoundTask(...args: any[]): any {
  DestroyTask(taskId);
      gAnimSoundTaskCount--;
}

/** static void AddSpriteIndex(u16 index) */
export function AddSpriteIndex(...args: any[]): any {
  let i: any = null;
...
export function ClearSpriteIndex(...args: any[]): any {
  let i: any = null;
...
export function Task_InitUpdateMonBg(...args: any[]): any {
  let updateTaskId: any = null;

      let data = gTasks[taskId].data;
      let battlerSpriteId = gBattlerSpriteIds[tBattlerId];
...
export function IsBattlerSpriteVisible(...args: any[]): any {
  if (IsContest())
      {
...
export function MoveBattlerSpriteToBG(...args: any[]): any {
  let animBg: any = null;
...
export function RelocateBattleBgPal(...args: any[]): any {
  let i, j;
      let size: any = null;
...
export function ResetBattleAnimBg(...args: any[]): any {
  let animBg: any = null;
      GetBattleAnimBg1Data(animBg);
...
export function Task_UpdateMonBg(...args: any[]): any {
...
export function Task_ClearMonBg(...args: any[]): any {
  gTasks[taskId].data[1]++;
      if (gTasks[taskId].data[1] != 1)
      {
          let to_BG2: any = null;
          let position = GetBattlerPosition(gTasks[taskId].data[2]);
          if (position == B_POSITION_OPPONENT_LEFT || position == B_POSITION_PLAYER_RIGHT || IsContest())
              to_BG2 = FALSE;
          else
              to_BG2 = TRUE;
...
export function Task_ClearMonBgStatic(...args: any[]): any {
  gTasks[taskId].data[1]++;
      if (gTasks[taskId].data[1] != 1)
      {
          let toBG_2: any = null;
          let battler = gTasks[taskId].data[2];
          let position = GetBattlerPosition(battler);
          if (position == B_POSITION_OPPONENT_LEFT || position == B_POSITION_PLAYER_RIGHT || IsContest())
              toBG_2 = FALSE;
          else
...
export function Task_FadeToBg(...args: any[]): any {
  if (gTasks[taskId].tState == 0)
      ...
      {
          let bgId = gTasks[taskId].tBackgroundId;
...
export function LoadMoveBg(...args: any[]): any {
  if (IsContest())
      {
          let tilemap = gBattleAnimBackgroundTable[bgId].tilemap;
          void *dmaSrc;
          void *dmaDest;
...
export function BattleAnimAdjustPanning(...args: any[]): any {
...
export function BattleAnimAdjustPanning2(...args: any[]): any {
  if (!IsContest() && gBattleSpritesDataPtr.healthBoxesData[gBattleAnimAttacker].statusAnimActive)
      {
          if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
              pan = SOUND_PAN_TARGET;
...
export function KeepPanInRange(...args: any[]): any {
  let pan = panArg;
...
export function CalculatePanIncrement(...args: any[]): any {
  let ret: any = null;
...
export function Task_PanFromInitialToTarget(...args: any[]): any {
...
export function Task_LoopAndPlaySE(...args: any[]): any {
  if (gTasks[taskId].tFrameCounter++ >= gTasks[taskId].tFramesToWait)
      {
          let songId: any = null;
...
export function Task_WaitAndPlaySE(...args: any[]): any {
