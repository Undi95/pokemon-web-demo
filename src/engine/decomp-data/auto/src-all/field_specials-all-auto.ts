...
const {
  ...
  AllocZeroed, BitmaskAllOtherLinkPlayers, BlendPalettes, BufferFanClubTrainerName_,
  CalculatePlayerPartyCount, CameraObjectSetFollowedSpriteId, ChangeDeoxysRockLevel, CheckFreePokemonStorageSpace,
  CheckPartyPokerus, ClearStdWindowAndFrameToTransparent, ClearWindowTilemap, CloseScrollableMultichoice,
  ConvertIntToDecimalString, ConvertIntToDecimalStringN, ConvertInternationalString, ConvertPixelWidthToTileWidth,
  CopyMonFavoritePokeblockName, CopyWindowToVram, CountDigits, CreateMon,
  CreateTask, CreateWindowTemplate, DestroyListMenuTask, DestroySpriteAndFreeResources,
  DestroyTask, DetermineCyclingRoadResults, DidPlayerGetFirstFans, DisplayTextAndGetWidth,
  DoRayquazaScene, DrawWholeMapView, FLIP_TRAINER_FAN_CLUB_FLAG, FRONTIER_CHALLENGE,
  FieldEffectActiveListContains, FieldEffectStart, FieldInitRegionMap, FillFrontierExchangeCornerWindowAndItemIcon,
  FillWindowPixelBuffer, FillWindowPixelRect, FindTaskIdByFunc, FlagClear,
  FlagGet, FlagSet, Free, FreeSpritePaletteByTag,
  FreeSpriteTilesByTag, FuncIsActiveTask, GET_TRAINER_FAN_CLUB_FLAG, GetBlockReceivedStatus,
  GetBoxMonData, GetBoxedMonPtr, GetEreaderTrainerName, GetGameStat,
  GetLastUsedWarpMapType, GetLeadMonIndex, GetLinkPlayerCount, GetMapName,
  GetMonData, GetMonEVCount, GetMultiplayerId, GetNature,
  GetNumFansOfPlayerInTrainerFanClub, GetObjectEventIdByLocalIdAndMap, GetPCBoxToSendMon, GetPlayerAvatarSpriteId,
  GetPlayerFacingDirection, GetRematchIdxByTrainerIdx, GetRibbonCount, GetStarterPokemon,
  GetStringCenterAlignXOffset, GetStringRightAlignXOffset, GetVarPointer, HideFrontierExchangeCornerItemIcon,
  INCR_TRAINER_FAN_CLUB_COUNTER, IncrementGameStat, InitScrollableMultichoice, InstallCameraPanAheadCallback,
  IsLinkTaskFinished, IsMapTypeOutdoors, IsPokeNewsActive, IsTextPrinterActive,
  ItemIdToBattleMoveId, ListMenuGetCurrentItemArrayId, ListMenuGetScrollAndRow, ListMenuInit,
  ListMenu_ProcessInput, LoadLinkPartnerObjectEventSpritePalette, LoadPalette, LockPlayerFieldControls,
  LotteryCornerComputerEffect, MAP_GROUP, MAP_NUM, MapGridGetMetatileIdAt,
  MapGridSetMetatileIdAt, MoveElevatorWindowLights, MysteryGift_GetCardStat, OBJ_PLTT_ID,
  Overworld_SetSavedMusic, PCTurnOffEffect, PCTurnOnEffect, PCTurnOnEffect_SetMetatile,
  PIXEL_FILL, PLTT_SIZEOF, PetalburgGymSetDoorMetatiles, PlaySE,
  PlayerGainRandomTrainerFan, PlayerLoseRandomTrainerFan, PutWindowTilemap, Random,
  RecordCyclingRoadResults, RemoveObjectEventByLocalIdAndMap, RemoveScrollIndicatorArrowPair, RemoveWindow,
  ResetBlockReceivedFlag, SET_TRAINER_FAN_CLUB_COUNTER, SET_TRAINER_FAN_CLUB_FLAG, ScheduleBgCopyTilemapToVram,
  ScriptContext_Enable, ScrollableMultichoice_RemoveScrollArrows, ScrollableMultichoice_UpdateScrollArrows, SendBlock,
  SetCameraPanning, SetCameraPanningCallback, SetCloseLinkCallback, SetCurrentAndNextWeather,
  SetInitialFansOfPlayer, SetLastHealLocationWarp, SetLinkStandbyCallback, SetMainCallback2,
  SetMonData, SetObjEventTemplateCoords, SetPCBoxToSendMon, SetPlayerGotFirstFans,
  SetSavedWeather, SetStandardWindowBorderStyle, SetWarpDestination, ShouldShowBoxWasFullMessage,
  ShowBattleFrontierTutorMoveDescription, ShowBattleFrontierTutorWindow, ShowFieldAutoScrollMessage, ShowFieldMessage,
  ShowFrontierExchangeCornerItemIcon, SpawnSpecialObjectEventParameterized, StopCameraShake, StorageGetCurrentBox,
  StringAppend, StringCompare, StringCopy, StringCopyN,
  TestPlayerAvatarFlags, TryGainNewFanFromCounter, TryGetObjectEventIdByLocalIdAndMap, TryLoseFansFromPlayTime,
  TryLoseFansFromPlayTimeAfterLinkBattle, TryPutSpotTheCutiesOnAir, UpdateBattlePointsWindow, VarGet,
