...
const {
  ...
  LockPlayerFieldControls, MAP_GROUP, MAP_NUM, MapGridGetMetatileIdAt,
  MapGridSetMetatileIdAt, MysteryGift_GetCardStat, NULL, OBJ_PLTT_ID,
  Overworld_SetSavedMusic, PIXEL_FILL, PLTT_SIZEOF, PLTT_SIZE_4BPP,
  PlaySE, PutWindowTilemap, Random, RemoveObjectEventByLocalIdAndMap,
  RemoveScrollIndicatorArrowPair, RemoveWindow, ResetBlockReceivedFlag, SET_TRAINER_FAN_CLUB_COUNTER,
  SET_TRAINER_FAN_CLUB_FLAG, STR_CONV_MODE_LEADING_ZEROS, STR_CONV_MODE_LEFT_ALIGN, STR_CONV_MODE_RIGHT_ALIGN,
  ScheduleBgCopyTilemapToVram, ScriptContext_Enable, SendBlock, SetCameraPanning,
  SetCameraPanningCallback, SetCloseLinkCallback, SetCurrentAndNextWeather, SetLastHealLocationWarp,
  SetLinkStandbyCallback, SetMainCallback2, SetMonData, SetObjEventTemplateCoords,
  SetSavedWeather, SetStandardWindowBorderStyle, SetWarpDestination, ShowFieldAutoScrollMessage,
  ShowFieldMessage, SpawnSpecialObjectEventParameterized, StorageGetCurrentBox, StringAppend,
  StringCompare, StringCopy, StringCopyN, TASK_NONE,
  TRUE, TestPlayerAvatarFlags, TryGetObjectEventIdByLocalIdAndMap, TryPutSpotTheCutiesOnAir,
