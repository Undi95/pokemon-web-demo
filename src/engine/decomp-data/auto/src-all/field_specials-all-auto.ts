...
const {
  ...
  CreateMon, CreateTask, CreateWindowTemplate, DestroyListMenuTask,
  DestroySpriteAndFreeResources, DestroyTask, DisplayTextAndGetWidth, DoRayquazaScene,
  DrawWholeMapView, FLIP_TRAINER_FAN_CLUB_FLAG, FRONTIER_CHALLENGE, FieldEffectActiveListContains,
  FieldEffectStart, FieldInitRegionMap, FillWindowPixelBuffer, FillWindowPixelRect,
  FindTaskIdByFunc, FlagClear, FlagGet, FlagSet,
  Free, FreeSpritePaletteByTag, FreeSpriteTilesByTag, FuncIsActiveTask,
  GET_TRAINER_FAN_CLUB_FLAG, GetBlockReceivedStatus, GetBoxMonData, GetBoxedMonPtr,
  GetEreaderTrainerName, GetGameStat, GetLastUsedWarpMapType, GetLinkPlayerCount,
  GetMapName, GetMonData, GetMonEVCount, GetMultiplayerId,
  GetNature, GetObjectEventIdByLocalIdAndMap, GetPlayerAvatarSpriteId, GetPlayerFacingDirection,
  GetRematchIdxByTrainerIdx, GetRibbonCount, GetStarterPokemon, GetStringCenterAlignXOffset,
  GetStringRightAlignXOffset, GetVarPointer, INCR_TRAINER_FAN_CLUB_COUNTER, IncrementGameStat,
  InstallCameraPanAheadCallback, IsLinkTaskFinished, IsMapTypeOutdoors, IsPokeNewsActive,
  IsTextPrinterActive, ItemIdToBattleMoveId, ListMenuGetCurrentItemArrayId, ListMenuGetScrollAndRow,
  ListMenuInit, ListMenu_ProcessInput, LoadPalette, LockPlayerFieldControls,
  MAP_GROUP, MAP_NUM, MapGridGetMetatileIdAt, MapGridSetMetatileIdAt,
  MysteryGift_GetCardStat, OBJ_PLTT_ID, Overworld_SetSavedMusic, PIXEL_FILL,
  PLTT_SIZEOF, PlaySE, PutWindowTilemap, Random,
  RemoveObjectEventByLocalIdAndMap, RemoveScrollIndicatorArrowPair, RemoveWindow, ResetBlockReceivedFlag,
  SET_TRAINER_FAN_CLUB_COUNTER, SET_TRAINER_FAN_CLUB_FLAG, ScheduleBgCopyTilemapToVram, ScriptContext_Enable,
  ...
  StringCopyN, TestPlayerAvatarFlags, TryGetObjectEventIdByLocalIdAndMap, TryPutSpotTheCutiesOnAir,
