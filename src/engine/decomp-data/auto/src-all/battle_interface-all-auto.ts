...
export function DummiedOutFunction(...args: any[]): any {
  return 9;
}

/** static void Debug_DrawNumber(s16 number, u16 *dest, bool8 unk) */
export function Debug_DrawNumber(...args: any[]): any {
  let i, j;
      const buff: any[] = [];
...
export function CreateBattlerHealthboxSprites(...args: any[]): any {
  let data6 = 0;
...
export function SpriteCB_HealthBar(...args: any[]): any {
...
export function SpriteCB_HealthBoxOther(...args: any[]): any {
...
export function SetBattleBarStruct(...args: any[]): any {
...
export function SetHealthboxSpriteInvisible(...args: any[]): any {
...
export function SetHealthboxSpriteVisible(...args: any[]): any {
...
export function UpdateSpritePos(...args: any[]): any {
  gSprites[spriteId].x = x;
      gSprites[spriteId].y = y;
}

/** void DestoryHealthboxSprite(u8 healthboxSpriteId) */
export function DestoryHealthboxSprite(...args: any[]): any {
...
export function UpdateOamPriorityInAllHealthboxes(...args: any[]): any {
  let i: any = null;

      for (i = 0; i < gBattlersCount; i++)
      {
          let healthboxLeftSpriteId = gHealthboxSpriteIds[i];
          let healthboxRightSpriteId = gSprites[gHealthboxSpriteIds[i]].oam.affineParam;
          let healthbarSpriteId = gSprites[gHealthboxSpriteIds[i]].hMain_HealthBarSpriteId;
...
export function InitBattlerHealthboxCoords(...args: any[]): any {
  let x = 0, y = 0;
...
export function UpdateLvlInHealthbox(...args: any[]): any {
...
export function UpdateHpTextInHealthbox(...args: any[]): any {
  let windowId, spriteTileNum;
      let windowTileData: any = null;
      const text: any[] = [];
      void *objVram;
...
export function UpdateHpTextInHealthboxInDoubles(...args: any[]): any {
  let windowId, spriteTileNum;
      let windowTileData: any = null;
      const text: any[] = [];
      void *objVram;
...
export function PrintSafariMonInfo(...args: any[]): any {
  const text: any[] = [];
      let j, spriteTileNum;
      let barFontGfx: any = null;
      let i, var, nature, healthBarSpriteId;
...
export function CreatePartyStatusSummarySprites(...args: any[]): any {
...
export function Task_HidePartyStatusSummary(...args: any[]): any {
...
export function Task_HidePartyStatusSummary_BattleStart_1(...args: any[]): any {
...
export function Task_HidePartyStatusSummary_BattleStart_2(...args: any[]): any {
  const ballIconSpriteIds: any[] = [];
      let i: any = null;

      let battler = gTasks[taskId].tBattler;
      if (--gTasks[taskId].tBlend == -1)
      {
          let summaryBarSpriteId = gTasks[taskId].tSummaryBarSpriteId;
...
export function Task_HidePartyStatusSummary_DuringBattle(...args: any[]): any {
  const ballIconSpriteIds: any[] = [];
      let i: any = null;
      let battler = gTasks[taskId].tBattler;
...
export function SpriteCB_StatusSummaryBar_Enter(...args: any[]): any {
  if (sprite.x2 != 0)
          sprite.x2 += sprite.data[0];
}

/** static void SpriteCB_StatusSummaryBar_Exit(struct Sprite *sprite) */
export function SpriteCB_StatusSummaryBar_Exit(...args: any[]): any {
  sprite.data[1] += 32;
      if (sprite.data[0] > 0)
...
export function SpriteCB_StatusSummaryBalls_Enter(...args: any[]): any {
  let var1: any = null;
      let var2: any = null;
      let pan: any = null;
...
export function SpriteCB_StatusSummaryBalls_Exit(...args: any[]): any {
  let var1: any = null;
      let var2: any = null;
...
export function SpriteCB_StatusSummaryBalls_OnSwitchout(...args: any[]): any {
...
export function UpdateNickInHealthbox(...args: any[]): any {
  const nickname: any[] = [];
      void *ptr;
      let windowId, spriteTileNum;
      let windowTileData: any = null;
...
export function TryAddPokeballIconToHealthbox(...args: any[]): any {
...
export function UpdateStatusIconInHealthbox(...args: any[]): any {
  let i: any = null;
      let battler, healthBarSpriteId;
      let status, pltAdder;
...
export function GetStatusIconForBattlerId(...args: any[]): any {
...
export function UpdateSafariBallsTextOnHealthbox(...args: any[]): any {
  let windowId, spriteTileNum;
      let windowTileData: any = null;
...
export function UpdateLeftNoOfBallsTextOnHealthbox(...args: any[]): any {
  const text: any[] = [];
      let txtPtr: any = null;
      let windowId, spriteTileNum;
      let windowTileData: any = null;
...
export function UpdateHealthboxAttribute(...args: any[]): any {
  let maxHp, currHp;
      let battler = gSprites[healthboxSpriteId].hMain_Battler;
...
export function MoveBattleBar(...args: any[]): any {
  let currentBarValue: any = null;
      ...
      {
          let expFraction = GetScaledExpFraction(gBattleSpritesDataPtr.battleBars[battler].oldValue,
                      gBattleSpritesDataPtr.battleBars[battler].receivedValue,
...
export function MoveBattleBarGraphically(...args: any[]): any {
  const array: any[] = [];
      ...
      case HEALTH_BAR:
          ...
          for (i = 0; i < 6; i++)
          {
              let healthbarSpriteId = gSprites[gBattleSpritesDataPtr.battleBars[battler].healthboxSpriteId].hMain_HealthBarSpriteId;
              if (i < 2)
...
export function CalcNewBarValue(...args: any[]): any {
  let ret, newValue;
      scale *= 8;
      ...
      if (maxValue < scale)  
      {
          let toAdd = Q_24_8(maxValue) / scale;
...
export function CalcBarFilledPixels(...args: any[]): any {
...
export function Debug_TestHealthBar_Helper(...args: any[]): any {
  const pixels: any[] = [];
      const src: any[] = [];
      let i: any = null;
...
export function GetScaledExpFraction(...args: any[]): any {
  let newVal, result;
...
export function GetScaledHPFraction(...args: any[]): any {
  let result = hp * scale / maxhp;
...
export function GetHPBarLevel(...args: any[]): any {
  let result: any = null;
      ...
      {
          let fraction = GetScaledHPFraction(hp, maxhp, B_HEALTHBAR_PIXELS);
...
export function RemoveWindowOnHealthbox(...args: any[]): any {
  RemoveWindow(windowId);
}

/** static void FillHealthboxObject(void *dest, u32 valMult, u32 numTiles) */
export function FillHealthboxObject(...args: any[]): any {
...
export function HpTextIntoHealthboxObject(...args: any[]): any {
  CpuCopy32(windowTileData + 256, dest, windowWidth * TILE_SIZE_4BPP);
}

/** static void TextIntoHealthboxObject(void *dest, u8 *windowTileData, s32 windowWidth) */
export function TextIntoHealthboxObject(...args: any[]): any {
...
export function SafariTextIntoHealthboxObject(...args: any[]): any {
