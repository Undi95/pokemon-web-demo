...
/** u16 VarGet(u16 id) */
export function VarGet(...args: any[]): any {
  let ptr = GetVarPointer(id);
      if (!ptr)
          return id;
      return *ptr;
}
...
export function VarSet(...args: any[]): any {
  let ptr = GetVarPointer(id);
      if (!ptr)
          return FALSE;
      *ptr = value;
...
export function VarGetObjectEventGraphicsId(...args: any[]): any {
  return VarGet(VAR_OBJ_GFX_ID_0 + id);
}

/** u8 FlagSet(u16 id) */
export function FlagSet(...args: any[]): any {
  let ptr = GetFlagPointer(id);
      if (ptr)
          *ptr |= 1 << (id & 7);
      return 0;
}
...
/** u8 FlagClear(u16 id) */
export function FlagClear(...args: any[]): any {
  let ptr = GetFlagPointer(id);
      if (ptr)
          *ptr &= ~(1 << (id & 7));
      return 0;
...
export function FlagGet(...args: any[]): any {
  let ptr = GetFlagPointer(id);
