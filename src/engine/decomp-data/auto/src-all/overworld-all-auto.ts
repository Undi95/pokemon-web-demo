...
const {
  ...
  ResetAllPicSprites, ResetCameraUpdateInfo, ResetCyclingRoadChallengeData, ResetFieldCamera,
  ResetFieldTasksArgs, ResetMapMusic, ResetOamRange, ResetObjectEvents,
  ResetPaletteFade, ResetSafariZoneFlag, ResetSpriteData, ResetTasks,
  ResetTempTileDataBuffers, ResetWinStreaks, RestartWildEncounterImmunitySteps, ResumePausedWeather,
  RoamerMove, RoamerMoveToOtherLocationSet, RotatingGate_InitPuzzleAndGraphics, RunOnDiveWarpMapScript,
  RunOnResumeMapScript, RunOnReturnToFieldMapScript, RunOnTransitionMapScript, RunScriptImmediately,
  ...
  SetCameraFocusCoords, SetGpuReg, SetHBlankCallback, SetMainCallback2,
  SetMoney, SetObjectSubpriorityByElevation, SetPlayerAvatarTransitionFlags, SetSavedWeatherFromCurrMapHeader,
  SetSpritePosToMapCoords, SetUpFieldTasks, SetVBlankCallback, ShiftObjectEventCoords,
  ShiftStillObjectEventCoords, ShowBg, ShowMapNamePopup, ShowStartMenu,
  SpawnObjectEventsOnReturnToField, StartSpriteAnim, StartSpriteAnimIfDifferent, StartWeather,
  StopMapMusic, TRUE, TRY_FREE_AND_SET_NULL, TestPlayerAvatarFlags,
  TransferPlttBuffer, TransferTilesetAnimsBuffer, TryGetTileEventScript, TryInteractWithPlayer,
  ...
  UnlockPlayerFieldControls, UpdateCameraPanning, UpdateLocationHistoryForRoamer, UpdateObjectEventSpriteInvisibility,
  UpdatePaletteFade, UpdatePlayerAvatarTransitionState, UpdateTVScreensOnMap, UpdateTilesetAnimations,
  UseContinueGameWarp, UsedPokemonCenterWarp, VRAM_SIZE, VarGet,
  VarSet, WriteBattlePyramidViewScanlineEffectBuffer, WriteFlashScanlineEffectBuffer, memset,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
