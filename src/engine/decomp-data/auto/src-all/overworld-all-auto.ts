...
const {
  ...
  MoveCoords, MoveSaveBlocks_ResetHeap, NULL, NewGameInitData,
  ObjectEventMoveDestCoords, ObjectEventUpdateElevation, Overworld_GetMapHeaderByGroupAndId, PLTT_SIZE,
  PlayCry_NormalNoDucking, PlayNewMapMusic, PlaySE, PlayTimeCounter_Start,
  PlayerGetDestCoords, PlayerStep, ProcessPlayerFieldInput, ProcessSpriteCopyRequests,
  ...
  REG_OFFSET_WINOUT, Random, ResetAllPicSprites, ResetCameraUpdateInfo,
  ResetCyclingRoadChallengeData, ResetFieldCamera, ResetFieldTasksArgs, ResetMapMusic,
  ResetOamRange, ResetObjectEvents, ResetPaletteFade, ResetSafariZoneFlag,
  ResetSpriteData, ResetTasks, ResetTempTileDataBuffers, ResetWinStreaks,
  RestartWildEncounterImmunitySteps, ResumePausedWeather, RoamerMove, RoamerMoveToOtherLocationSet,
  RotatingGate_InitPuzzleAndGraphics, RunOnDiveWarpMapScript, RunOnResumeMapScript, RunOnReturnToFieldMapScript,
  RunOnTransitionMapScript, RunScriptImmediately, RunTasks, ScanlineEffect_Clear,
  ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams, ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram,
  ScriptContext_Init, ScriptContext_RunScript, ScriptContext_SetupScript, SecretBaseMapPopupEnabled,
  SetBgAttribute, SetBgTilemapBuffer, SetCameraFocusCoords, SetGpuReg,
  SetHBlankCallback, SetMainCallback2, SetMoney, SetObjectSubpriorityByElevation,
  SetPlayerAvatarTransitionFlags, SetSavedWeatherFromCurrMapHeader, SetSpritePosToMapCoords, SetUpFieldTasks,
  SetVBlankCallback, ShiftObjectEventCoords, ShiftStillObjectEventCoords, ShowBg,
  ShowMapNamePopup, ShowStartMenu, SpawnObjectEventsOnReturnToField, StartSpriteAnim,
  StartSpriteAnimIfDifferent, StartWeather, StopMapMusic, TRUE,
  ...
  VRAM_SIZE, VarGet, VarSet, WriteBattlePyramidViewScanlineEffectBuffer,
  WriteFlashScanlineEffectBuffer,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
