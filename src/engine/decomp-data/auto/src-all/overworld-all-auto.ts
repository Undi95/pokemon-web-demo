...
const {
  ARRAY_COUNT, AllocZeroed, AnimateSprites, ApplyCurrentWarp,
  ApplyNewEncryptionKeyToWord, ApplyWeatherColorMapToPal, AreAllPlayersInLinkState, ArePlayerFieldControlsLocked,
  BLDALPHA_BLEND, BuildOamBuffer, CB2_ReturnToField, CalculatePlayerPartyCount,
  CameraUpdate, CanCableClubPlayerPressStart, ChangeBgX, ChangeBgY,
  CheckLeftFriendsSecretBase, CheckRfuKeepAliveTimer, ChooseAmbientCrySpecies, ClearAllPlayerKeys,
  ClearContinueGameWarpStatus, ClearDiveAndHoleWarps, ClearMirageTowerPulseBlend, ClearMirageTowerPulseBlendEffect,
  ...
  CpuFill32, CreateLinkPlayerSprite, CreateLinkPlayerSprites, CreateObjectGraphicsSprite,
  CreateWirelessStatusIndicatorSprite, DisableInterrupts, DmaClear16, DmaFillLarge16,
  DoCB1_Overworld, DoCurrentWeather, DoMapLoadLoop, DoScheduledBgTilemapCopiesToVram,
  DoTimeBasedEvents, DoWhiteOut, DrawWholeMapView, ElevationToPriority,
  EnableInterrupts, FadeOutAndFadeInNewMapMusic, FadeOutAndPlayNewMapMusic, FadeOutMapMusic,
  FieldCB_DefaultWarpExit, FieldCB_WarpExitFadeFromBlack, FieldClearPlayerInput, FieldClearVBlankHBlankCallbacks,
  FieldEffectActiveListClear, FieldGetPlayerInput, FieldUpdateBgTilemapScroll, FlagClear,
  FlagGet, FlipVerticalAndClearForced, FreeAllOverworldWindowBuffers, FreeTempTileDataBuffersIfPossible,
  GetCameraFocusCoords, GetCurrLocationDefaultMusic, GetCurrentMapMusic, GetCurrentMapType,
  GetCurrentTrainerHillMapId, GetDestinationWarpMapHeader, GetDirectionForDpadKey, GetDirectionForEventScript,
  GetFRLGAvatarGraphicsIdByGender, GetFaceDirectionAnimNum, GetFirstInactiveObjectEventId, GetFlashLevel,
  GetGameStat, GetHealLocation, GetInitialPlayerAvatarState, GetLinkPlayerCoords,
  GetLinkPlayerElevation, GetLinkPlayerFacingDirection, GetLinkRecvQueueLength, GetLinkSendQueueLength,
  GetLocalWaterMon, GetLocalWildMon, GetLocationMusic, GetMapConnection,
  GetMapLayout, GetMapMusicFadeoutSpeed, GetMapTypeByGroupAndId, GetMapTypeByWarpData,
  GetMonAbility, GetMonData, GetMoney, GetMoveDirectionAnimNum,
  GetPlayerFacingDirection, GetRSAvatarGraphicsIdByGender, GetRivalAvatarGraphicsIdByStateIdAndGender, GetSavedWeather,
  GetSpriteForLinkedPlayer, GetWarpDestinationMusic, HandleLinkPlayerKeyInput, HealPlayerParty,
  HideMapNamePopUpWindow, InBattlePyramid_, InTrainerHill, InitBattlePyramidMap,
  InitBgsFromTemplates, InitCameraUpdateCallback, InitCurrentFlashLevelScanlineEffect, InitFieldMessageBox,
  InitLinkPlayerObjectEventPos, InitLinkPlayerQueueScript, InitLinkRoomStartMenuScript, InitMap,
  InitMapFromSavedGame, InitMapView, InitMatchCallCounters, InitMenuBasedScript,
  InitObjectEventPalettes, InitObjectEventsLink, InitObjectEventsLocal, InitObjectEventsReturnToField,
  InitOverworldBgs, InitOverworldGraphicsRegisters, InitPlayerAvatar, InitSecondaryTilesetAnimation,
  InitSecretBaseAppearance, InitStandardTextBoxWindows, InitTextBoxGfxAndPrinters, InitTilesetAnimations,
  InitTrainerHillMap, InitViewGraphics, InstallCameraPanAheadCallback, IsAnyPlayerInLinkState,
  IsCableClubPlayerUnfrozen, IsDummyWarp, IsInfiltratedSpaceCenter, IsInfiltratedWeatherInstitute,
  IsMapTypeIndoors, IsMapTypeOutdoors, IsMirageIslandPresent, IsNotWaitingForBGMStop,
  IsOverworldLinkActive, IsRfuRecvQueueEmpty, IsSendingKeysToLink, JOY_HELD,
  JOY_NEW, KeyInterCB_ReadButtons, LinkPlayerGetCollision, LinkRfu_FatalError,
  LoadBattlePyramidFloorObjectEventScripts, LoadBattlePyramidObjectEventTemplates, LoadCableClubPlayer, LoadCurrentMapData,
  LoadMapFromWarp, LoadMapInStepsLink, LoadMapInStepsLocal, LoadMapTilesetPalettes,
  LoadOam, LoadObjEventTemplatesFromHeader, LoadSaveblockMapHeader, LoadSaveblockObjEventScripts,
  LoadSecondaryTilesetPalette, LoadTrainerHillFloorObjectEventScripts, LoadTrainerHillObjectEventTemplates, LoadWirelessStatusIndicatorSpriteGfx,
  LockPlayerFieldControls, MAP_GROUP, MAP_NUM, MapGridGetCollisionAt,
  MapGridGetMetatileBehaviorAt, MetatileBehavior_IsDeepSouthWarp, MetatileBehavior_IsDoor, MetatileBehavior_IsEastArrowWarp,
  MetatileBehavior_IsLadder, MetatileBehavior_IsNonAnimDoor, MetatileBehavior_IsNorthArrowWarp, MetatileBehavior_IsSouthArrowWarp,
  MetatileBehavior_IsSurfableWaterOrUnderwater, MetatileBehavior_IsWestArrowWarp, MoveCoords, MoveSaveBlocks_ResetHeap,
  NewGameInitData, NoMusicInSootopolisWithLegendaries, ObjectEventMoveDestCoords, ObjectEventUpdateElevation,
  OffsetCameraFocusByLinkPlayerId, OverworldBasic, Overworld_ClearSavedMusic, Overworld_GetMapHeaderByGroupAndId,
  Overworld_IsBikingAllowed, Overworld_IsRecvQueueAtMax, Overworld_ResetStateAfterWhiteOut, PlayAmbientCry,
  PlayCry_NormalNoDucking, PlayNewMapMusic, PlaySE, PlayTimeCounter_Start,
  PlayerGetDestCoords, PlayerIsAtSouthExit, PlayerStep, ProcessPlayerFieldInput,
  ProcessSpriteCopyRequests, Random, ResetAllMultiplayerState, ResetAllPicSprites,
  ResetAllPlayerLinkStates, ResetCameraUpdateInfo, ResetCyclingRoadChallengeData, ResetFieldCamera,
  ResetFieldTasksArgs, ResetInitialPlayerAvatarState, ResetMapMusic, ResetMirageTowerAndSaveBlockPtrs,
  ResetOamRange, ResetObjectEvents, ResetPaletteFade, ResetPlayerHeldKeys,
  ResetSafariZoneFlag, ResetSafariZoneFlag_, ResetScreenForMapLoad, ResetSpriteData,
  ResetTasks, ResetTempTileDataBuffers, ResetWinStreaks, RestartWildEncounterImmunitySteps,
  ResumeMap, ResumePausedWeather, ReturnToFieldLink, ReturnToFieldLocal,
  RoamerMove, RoamerMoveToOtherLocationSet, RotatingGate_InitPuzzleAndGraphics, RunConfirmLeaveCableClubScript,
  RunFieldCallback, RunInteractLocalPlayerScript, RunOnDiveWarpMapScript, RunOnResumeMapScript,
  RunOnReturnToFieldMapScript, RunOnTransitionMapScript, RunScriptImmediately, RunTasks,
  RunTerminateLinkScript, ScanlineEffect_Clear, ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams,
  ScanlineEffect_Stop, ScheduleBgCopyTilemapToVram, ScriptContext_Init, ScriptContext_RunScript,
  ScriptContext_SetupScript, SecretBaseMapPopupEnabled, SetBgAttribute, SetBgTilemapBuffer,
  SetCameraFocusCoords, SetCameraToTrackGuestPlayer, SetCameraToTrackGuestPlayer_2, SetCameraToTrackPlayer,
  SetDefaultFlashLevel, SetDiveWarp, SetEscapeWarp, SetFieldVBlankCallback,
  SetGameStat, SetGpuReg, SetHBlankCallback, SetKeyInterceptCallback,
  SetMainCallback1, SetMainCallback2, SetMoney, SetObjectSubpriorityByElevation,
  SetPlayerAvatarTransitionFlags, SetPlayerCoordsFromWarp, SetPlayerFacingDirection, SetSavedWeatherFromCurrMapHeader,
  SetSpritePosToMapCoords, SetUpFieldTasks, SetVBlankCallback, SetWarpData,
  SetWarpDestination, SetWarpDestinationToContinueGameWarp, SetWarpDestinationToDiveWarp, SetWarpDestinationToLastHealLocation,
  ShiftObjectEventCoords, ShiftStillObjectEventCoords, ShouldLegendaryMusicPlayAtLocation, ShowBg,
  ShowMapNamePopup, ShowStartMenu, SpawnLinkPlayerObjectEvent, SpawnLinkPlayers,
  SpawnObjectEventsOnReturnToField, StartSpriteAnim, StartSpriteAnimIfDifferent, StartWeather,
  StopMapMusic, TRY_FREE_AND_SET_NULL, TestPlayerAvatarFlags, TransferPlttBuffer,
  TransferTilesetAnimsBuffer, TransitionMapMusic, TryGetTileEventScript, TryInteractWithPlayer,
  TryLoadTrainerHillEReaderPalette, TryPutTodaysRivalTrainerOnAir, TryRunOnWarpIntoMapScript, TrySetMapSaveWarpStatus,
  TrySpawnObjectEvents, TryStartMirageTowerPulseBlendEffect, TryUpdateRandomTrainerRematches, UnfreezeObjectEvents,
  UnlockPlayerFieldControls, UpdateAllLinkPlayers, UpdateCameraPanning, UpdateHeldKeyCode,
  UpdateLocationHistoryForRoamer, UpdateMiscOverworldStates, UpdateObjectEventSpriteInvisibility, UpdatePaletteFade,
  UpdatePlayerAvatarTransitionState, UpdateTVScreensOnMap, UpdateTilesetAnimations, UseContinueGameWarp,
  UsedPokemonCenterWarp, VarGet, VarSet, WarpIntoMap,
  WriteBattlePyramidViewScanlineEffectBuffer, WriteFlashScanlineEffectBuffer, ZeroLinkPlayerObjectEvent, ZeroObjectEvent,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
