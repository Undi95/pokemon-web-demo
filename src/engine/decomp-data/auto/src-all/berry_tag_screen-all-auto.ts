...
export function PrintTextInBerryTagScreen(...args: any[]): any {
...
export function PrepareToCloseBerryTagScreen(...args: any[]): any {
  PlaySE(SE_SELECT);
...
export function Task_CloseBerryTagScreen(...args: any[]): any {
...
export function TryChangeDisplayedBerry(...args: any[]): any {
  let data = gTasks[taskId].data;
      let currPocketPosition = gBagPosition.scrollPosition[BERRIES_POCKET] + gBagPosition.cursorPosition[BERRIES_POCKET];
      let newPocketPosition = currPocketPosition + toMove;
...
export function HandleBagCursorPositionChange(...args: any[]): any {
  let scrollPos = gBagPosition.scrollPosition[BERRIES_POCKET];
      let cursorPos = gBagPosition.cursorPosition[BERRIES_POCKET];
      if (toMove > 0)
      {
...
export function Task_DisplayAnotherBerry(...args: any[]): any {
  let i: any = null;
      let y: any = null;
      let data = gTasks[taskId].data;
