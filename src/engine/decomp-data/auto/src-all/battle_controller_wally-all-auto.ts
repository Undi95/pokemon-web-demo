...
const {
  ...
  DoMoveAnim, DoPokeballSendOutAnimation, DoWallyTutorialBagMenu, FALSE,
  FadeOutMapMusic, FreeAllWindowBuffers, FreeSpriteOamMatrix, FreeSpritePaletteByTag,
  ...
  GetMultiplayerId, HandleIntroSlide, HandleLowHpMusicChange, InitAndLaunchSpecialAnimation,
  InitMoveSelectionsVarsAndStrings, IsDma3ManagerBusyWithBgCopy, IsDoubleBattle, IsMoveWithoutAnimation,
  IsTextPrinterActive, LoadBattleBarGfx, LoadCompressedPalette, MoveBattleBar,
  OBJ_PLTT_ID, PALETTES_ALL, PLTT_SIZE_4BPP, PlayBGM,
  PlayCry_Normal, PlayFanfare, PlaySE, PlayerHandleGetRawMonData,
  PrepareBufferDataTransferLink, ReshowBattleScreenDummy, ST_OAM_AFFINE_NORMAL, ST_OAM_AFFINE_OFF,
