...
export function ValidateTrainerChecksum(...args: any[]): any {
  let checksum = CalcByteArraySum(hillTrainer, offsetof(typeof(*hillTrainer), checksum));
...
export function ValidateTrainerHillData(...args: any[]): any {
  let i: any = null;
      ...
      checksum = CalcByteArraySum(hillSet.trainers, numTrainers * sizeof(struct EReaderTrainerHillTrainer));
...
export function ValidateTrainerHillChecksum(...args: any[]): any {
  let checksum: any = null;
      let numTrainers = hillSet.numTrainers;
      if (numTrainers < 1 || numTrainers > NUM_TRAINER_HILL_TRAINERS)
          return FALSE;

      checksum = CalcByteArraySum(hillSet.trainers, sizeof(struct EReaderTrainerHillSet) - offsetof(struct EReaderTrainerHillSet, trainers));
      if (checksum != hillSet.checksum)
          return FALSE;
...
export function TryWriteTrainerHill_Internal(...args: any[]): any {
  let i: any = null;
      ...
      challenge.checksum = CalcByteArraySum(challenge.floors, NUM_TRAINER_HILL_FLOORS * sizeof(struct TrainerHillFloor));
...
export function TryWriteTrainerHill(...args: any[]): any {
...
export function TryReadTrainerHill_Internal(...args: any[]): any {
...
export function TryReadTrainerHill(...args: any[]): any {
  let buffer = AllocZeroed(SECTOR_SIZE);
...
export function EReader_Send(...args: any[]): any {
  let result: any = null;
...
export function EReader_Recv(...args: any[]): any {
  let result: any = null;
...
export function EReaderHandleTransfer(...args: any[]): any {
...
export function DetermineSendRecvState(...args: any[]): any {
  let resp: any = null;
...
export function SetUpTransferManager(...args: any[]): any {
