...
export function AnimFallingRock(...args: any[]): any {
...
export function AnimFallingRock_Step(...args: any[]): any {
...
export function AnimRockFragment(...args: any[]): any {
...
export function AnimParticleInVortex(...args: any[]): any {
...
export function AnimParticleInVortex_Step(...args: any[]): any {
...
export function AnimTask_LoadSandstormBackground(...args: any[]): any {
  let var0: any = null;
      let animBg: any = null;
...
export function AnimTask_LoadSandstormBackground_Step(...args: any[]): any {
  let animBg: any = null;
...
export function AnimFlyingSandCrescent(...args: any[]): any {
  if (sprite.sState == 0)
      {
...
export function AnimRaiseSprite(...args: any[]): any {
...
export function AnimTask_Rollout(...args: any[]): any {
...
export function AnimTask_Rollout_Step(...args: any[]): any {
  let task: any = null;
...
export function CreateRolloutDirtSprite(...args: any[]): any {
...
export function AnimRolloutParticle(...args: any[]): any {
  if (TranslateAnimHorizontalArc(sprite))
      {
          let taskId = FindTaskIdByFunc(AnimTask_Rollout_Step);
          if (taskId != TASK_NONE)
...
export function GetRolloutCounter(): any {
  let retVal = gAnimDisableStructPtr.rolloutTimerStartValue - gAnimDisableStructPtr.rolloutTimer;
      let var0 = retVal - 1;
      if (var0 > 4)
          retVal = 1;
...
export function AnimRockTomb(...args: any[]): any {
  StartSpriteAnim(sprite, gBattleAnimArgs[4]);
...
export function AnimRockTomb_Step(...args: any[]): any {
...
export function AnimRockBlastRock(...args: any[]): any {
...
export function AnimRockScatter(...args: any[]): any {
...
export function AnimRockScatter_Step(...args: any[]): any {
  sprite.data[0] += 8;
...
export function AnimTask_GetSeismicTossDamageLevel(...args: any[]): any {
  if (gAnimMoveDmg < 33)
...
export function AnimTask_MoveSeismicTossBg(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
      {
...
export function AnimTask_SeismicTossBgAccelerateDownAtEnd(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
      {
          UpdateAnimBg3ScreenSize(FALSE);
          gTasks[taskId].data[0]++;
