...
export function Task_WaitForFadeOut(...args: any[]): any {
...
export function PrintMessageWithPlaceholders(...args: any[]): any {
...
export function DoMoveRelearnerMain(): any {
  switch (sMoveRelearnerStruct.state)
      ...
      case MENU_STATE_TEACH_MOVE_CONFIRM:
          {
              let selection = Menu_ProcessInputNoWrapClearOnChoose();
      ...
      case MENU_STATE_TRY_OVERWRITE_MOVE:
          if (!gPaletteFade.active)
          {
              ...
              {
                  let move = GetMonData(gPlayerParty[sMoveRelearnerStruct.partyMon], MON_DATA_MOVE1 + sMoveRelearnerStruct.moveSlot);
...
export function HideHeartSpritesAndShowTeachMoveText(...args: any[]): any {
  let i: any = null;
...
export function HandleInput(...args: any[]): any {
  let itemId = ListMenu_ProcessInput(sMoveRelearnerStruct.moveListMenuTask);
...
export function ShowTeachMoveText(...args: any[]): any {
...
export function MoveRelearnerShowHideHearts(...args: any[]): any {
