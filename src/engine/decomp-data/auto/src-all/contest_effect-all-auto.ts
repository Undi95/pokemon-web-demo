...
export function AreMovesContestCombo(...args: any[]): any {
...
export function JamByMoveCategory(...args: any[]): any {
  let i: any = null;
      let numJammed = 0;
...
export function CanUnnerveContestant(...args: any[]): any {
...
export function RoundUp(...args: any[]): any {
  let absScore = abs(score) % 10;
      if (absScore != 0)
          score += 10 - absScore;
      return score;
