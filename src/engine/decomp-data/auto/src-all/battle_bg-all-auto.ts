...
export function DrawMainBattleBackground(): any {
  if (gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_FRONTIER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_RECORDED_LINK))
      ...
      else
      {
          ...
          {
              let trainerClass = gTrainers[gTrainerBattleOpponent_A].trainerClass;
...
export function DrawLinkBattleParticipantPokeballs(...args: any[]): any {
  let i: any = null;
...
export function InitLinkBattleVsScreen(...args: any[]): any {
  let linkPlayer: any = null;
      ...
      case 0:
          ...
          {
              let playerId = gBattleScripting.multiplayerId;
              let opponentId = playerId ^ BIT_SIDE;
              let opponentId_copy = opponentId;
...
export function LoadChosenBattleElement(...args: any[]): any {
  let ret = FALSE;
