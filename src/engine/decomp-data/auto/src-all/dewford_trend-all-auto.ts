...
export function UpdateDewfordTrendPerDay(...args: any[]): any {
  let i: any = null;

      if (days != 0)
      {
          let clockRand = days * 5;
          ...
          for (i = 0; i < SAVED_TRENDS_COUNT; i++)
          {
              ...
              if (trendiness > trend.maxTrendiness)
              {
                  ...
                  let newTrendiness = trendiness % trend.maxTrendiness;
...
export function TrySetTrendyPhrase(...args: any[]): any {
  let trend: any = [0];
      let i: any = null;
...
export function SortTrends(...args: any[]): any {
  let i: any = null;
...
export function ReceiveDewfordTrendData(...args: any[]): any {
  let i, j, numTrends, players;
      ...
      for (i = 0; i < players; i++)
      {
          ...
          {
              let idx = GetSavedTrendIndex(savedTrendsBuffer, src, numTrends);
              if (idx < 0)
              {
...
export function CompareTrends(...args: any[]): any {
  switch (mode)
      {
...
export function SeedTrendRng(...args: any[]): any {
  let rand: any = null;
...
export function IsPhraseInSavedTrends(...args: any[]): any {
  let i: any = null;
...
export function IsEasyChatPairEqual(...args: any[]): any {
  let i: any = null;
...
export function GetSavedTrendIndex(...args: any[]): any {
  let i: any = null;
