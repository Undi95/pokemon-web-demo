...
export function CopyRecordedOpponentMonData(...args: any[]): any {
...
export function SetRecordedOpponentMonData(...args: any[]): any {
...
export function RecordedOpponentHandleSetRawMonData(): any {
  let dst = (u8 *)&gEnemyParty[gBattlerPartyIndexes[gActiveBattler]] + gBattleBufferA[gActiveBattler][1];
      let i: any = null;
...
export function RecordedOpponentHandleLoadMonSprite(): any {
  let species = GetMonData(gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_SPECIES);
...
export function RecordedOpponentHandleChooseMove(): any {
  if (gBattleTypeFlags & BATTLE_TYPE_PALACE)
      ...
      {
          let moveIndex = RecordedBattle_GetBattlerAction(gActiveBattler);
          let target = RecordedBattle_GetBattlerAction(gActiveBattler);
...
export function RecordedOpponentHandleHealthBarUpdate(): any {
  let hpVal: any = null;
      ...
      {
          let maxHP = GetMonData(gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_MAX_HP);
          let curHP = GetMonData(gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_HP);
...
export function SpriteCB_FreeOpponentSprite(...args: any[]): any {
