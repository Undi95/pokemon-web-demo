...
// Source : src/battle_controller_recorded_opponent.c
// Generated : 2026-05-09
// DO NOT EDIT — re-run `node scripts/transpile-decomp-all.mjs` to refresh.
//
// Total : 86 functions extracted from src/battle_controller_recorded_opponent.c.
//
// IMPORTANT :
...
const {
  ...
  BattleStopLowHpSound, BeginFastPaletteFade, BtlController_EmitChosenMonReturnValue, BtlController_EmitDataTransfer,
  BtlController_EmitTwoReturnValues, BufferStringBattle, ChooseMoveAndTargetInBattlePalace, ClearTemporarySpeciesSpriteData,
  CopyAllBattleSpritesInvisibilities, CopyBattleSpriteInvisibility, CopyRecordedOpponentMonData, CreateInvisibleSpriteWithCallback,
  CreatePartyStatusSummarySprites, CreateSprite, CreateTask, DecompressTrainerFrontPic,
  DestroySprite, DestroyTask, DoHitAnimHealthboxEffect, DoMoveAnim,
  DoPokeballSendOutAnimation, FadeOutMapMusic, FreeSpriteOamMatrix, FreeSpritePaletteByTag,
  ...
  PlaySE12WithPanning, PlayerGenderToFrontTrainerPicId, PrepareBufferDataTransferLink, RecordedBattle_GetBattlerAction,
  RecordedOpponentBufferExecCompleted, SetBattleBarStruct, SetBattlerShadowSpriteCallback, SetBattlerSpriteAffineMode,
  SetHealthboxSpriteInvisible, SetHealthboxSpriteVisible, SetMonData, SetMultiuseSpriteTemplateToPokemon,
  SetMultiuseSpriteTemplateToTrainerBack, SetRecordedOpponentMonData, SetSpritePrimaryCoordsFromSecondaryCoords, StartHealthboxSlideIn,
...
export function RecordedOpponentBufferExecCompleted(): any {
  gBattlerControllerFuncs[gActiveBattler] = RecordedOpponentBufferRunCommand;
...
export function RecordedOpponentHandleGetRawMonData(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleSetMonData(void) */
export function RecordedOpponentHandleSetMonData(): any {
  let monToCheck: any = null;
      let i: any = null;
...
export function SetRecordedOpponentMonData(monId: any): any {
...
export function RecordedOpponentHandleSetRawMonData(): any {
...
export function RecordedOpponentHandleLoadMonSprite(): any {
...
export function RecordedOpponentHandleSwitchInAnim(): any {
...
export function RecordedOpponentHandleReturnMonToBall(): any {
...
export function RecordedOpponentHandleDrawTrainerPic(): any {
  let xPos: any = null;
...
export function RecordedOpponentHandleTrainerSlide(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleTrainerSlideBack(void) */
export function RecordedOpponentHandleTrainerSlideBack(): any {
...
export function RecordedOpponentHandleFaintAnimation(): any {
...
export function RecordedOpponentHandlePaletteFade(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleSuccessBallThrowAnim(void) */
export function RecordedOpponentHandleSuccessBallThrowAnim(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleBallThrowAnim(void) */
export function RecordedOpponentHandleBallThrowAnim(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandlePause(void) */
export function RecordedOpponentHandlePause(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleMoveAnimation(void) */
export function RecordedOpponentHandleMoveAnimation(): any {
...
export function RecordedOpponentDoMoveAnimation(): any {
  let move: any = gBattleBufferA[gActiveBattler][1] | (gBattleBufferA[gActiveBattler][2] << 8);
...
export function RecordedOpponentHandlePrintString(): any {
...
export function RecordedOpponentHandlePrintSelectionString(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleChooseAction(void) */
export function RecordedOpponentHandleChooseAction(): any {
...
export function RecordedOpponentHandleYesNoBox(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleChooseMove(void) */
export function RecordedOpponentHandleChooseMove(): any {
...
export function RecordedOpponentHandleChooseItem(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleChoosePokemon(void) */
export function RecordedOpponentHandleChoosePokemon(): any {
...
export function RecordedOpponentHandleCmd23(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleHealthBarUpdate(void) */
export function RecordedOpponentHandleHealthBarUpdate(): any {
  let hpVal: any = null;
...
export function RecordedOpponentHandleExpUpdate(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleStatusIconUpdate(void) */
export function RecordedOpponentHandleStatusIconUpdate(): any {
  if (!IsBattleSEPlaying(gActiveBattler))
      {
...
export function RecordedOpponentHandleStatusAnimation(): any {
  if (!IsBattleSEPlaying(gActiveBattler))
      {
...
export function RecordedOpponentHandleStatusXor(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleDataTransfer(void) */
export function RecordedOpponentHandleDataTransfer(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleDMA3Transfer(void) */
export function RecordedOpponentHandleDMA3Transfer(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandlePlayBGM(void) */
export function RecordedOpponentHandlePlayBGM(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleCmd32(void) */
export function RecordedOpponentHandleCmd32(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleTwoReturnValues(void) */
export function RecordedOpponentHandleTwoReturnValues(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleChosenMonReturnValue(void) */
export function RecordedOpponentHandleChosenMonReturnValue(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleOneReturnValue(void) */
export function RecordedOpponentHandleOneReturnValue(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleOneReturnValue_Duplicate(void) */
export function RecordedOpponentHandleOneReturnValue_Duplicate(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleClearUnkVar(void) */
export function RecordedOpponentHandleClearUnkVar(): any {
  gUnusedControllerStruct.unk = 0;
      RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleSetUnkVar(void) */
export function RecordedOpponentHandleSetUnkVar(): any {
  gUnusedControllerStruct.unk = gBattleBufferA[gActiveBattler][1];
      RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleClearUnkFlag(void) */
export function RecordedOpponentHandleClearUnkFlag(): any {
  gUnusedControllerStruct.flag = 0;
      RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleToggleUnkFlag(void) */
export function RecordedOpponentHandleToggleUnkFlag(): any {
  gUnusedControllerStruct.flag ^= 1;
      RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleHitAnimation(void) */
export function RecordedOpponentHandleHitAnimation(): any {
...
export function RecordedOpponentHandleCantSwitch(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandlePlaySE(void) */
export function RecordedOpponentHandlePlaySE(): any {
  let pan: any = null;
...
export function RecordedOpponentHandlePlayFanfareOrBGM(): any {
...
export function RecordedOpponentHandleFaintingCry(): any {
  let species: any = GetMonData(gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_SPECIES);
...
export function RecordedOpponentHandleIntroSlide(): any {
...
export function RecordedOpponentHandleIntroTrainerBallThrow(): any {
  let taskId: any = null;
...
export function RecordedOpponentHandleDrawPartyStatusSummary(): any {
...
export function RecordedOpponentHandleHidePartyStatusSummary(): any {
  if (gBattleSpritesDataPtr.healthBoxesData[gActiveBattler].partyStatusSummaryShown)
          gTasks[gBattlerStatusSummaryTaskId[gActiveBattler]].func = Task_HidePartyStatusSummary;
      RecordedOpponentBufferExecCompleted();
}
...
export function RecordedOpponentHandleEndBounceEffect(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleSpriteInvisibility(void) */
export function RecordedOpponentHandleSpriteInvisibility(): any {
...
export function RecordedOpponentHandleBattleAnimation(): any {
  if (!IsBattleSEPlaying(gActiveBattler))
      {
...
export function RecordedOpponentHandleLinkStandbyMsg(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleResetActionMoveSelection(void) */
export function RecordedOpponentHandleResetActionMoveSelection(): any {
  RecordedOpponentBufferExecCompleted();
}

/** static void RecordedOpponentHandleEndLinkBattle(void) */
export function RecordedOpponentHandleEndLinkBattle(): any {
...
export const __callsTo__: ReadonlyArray<string> = ["ARRAY_COUNT","BATTLE_PARTNER","BattleLoadOpponentMonSpriteGfx","BattlePutTextOnWindow","BattleStopLowHpSound","BeginFastPaletteFade","BtlController_EmitChosenMonReturnValue","BtlController_EmitDataTransfer","BtlController_EmitTwoReturnValues","BufferStringBattle","ChooseMoveAndTargetInBattlePalace","ClearTemporarySpeciesSpriteData","CopyAllBattleSpritesInvisibilities","CopyBattleSpriteInvisibility","CopyRecordedOpponentMonData","CreateInvisibleSpriteWithCallback","CreatePartyStatusSummarySprites","CreateSprite","CreateTask","DecompressTrainerFrontPic","DestroySprite","DestroyTask","DoHitAnimHealthboxEffect","DoMoveAnim","DoPokeballSendOutAnimation","FadeOutMapMusic","FreeSpriteOamMatrix","FreeSpritePaletteByTag","FreeSpriteTilesByTag","FreeTrainerFrontPicPalette","GetActiveBattlerLinkPlayerGender","GetBattlerPosition","GetBattlerSide","GetBattlerSpriteCoord","GetBattlerSpriteDefault_Y","GetBattlerSpriteSubpriority","GetFrontierTrainerFrontSpriteId","GetMonData","GetMultiplayerId","GetUnionRoomTrainerPic","HandleIntroSlide","HideBattlerShadowSprite","IndexOfSpritePaletteTag","InitAndLaunchChosenStatusAnimation","InitAndLaunchSpecialAnimation","IsBattleSEPlaying","IsBattlerSpritePresent","IsCryPlayingOrClearCrySongs","IsDoubleBattle","IsMoveWithoutAnimation","IsTextPrinterActive","LoadBattleBarGfx","MoveBattleBar","PlayBGM","PlayCry_ByMode","PlayFanfare","PlaySE12WithPanning","PlayerGenderToFrontTrainerPicId","PrepareBufferDataTransferLink","RecordedBattle_GetBattlerAction","RecordedOpponentBufferExecCompleted","SetBattleBarStruct","SetBattlerShadowSpriteCallback","SetBattlerSpriteAffineMode","SetHealthboxSpriteInvisible","SetHealthboxSpriteVisible","SetMonData","SetMultiuseSpriteTemplateToPokemon","SetMultiuseSpriteTemplateToTrainerBack","SetRecordedOpponentMonData","SetSpritePrimaryCoordsFromSecondaryCoords","StartHealthboxSlideIn","StartSendOutAnim","StartSpriteAnim","StoreSpriteCallbackInData6","StringCopy_Nickname","TryHandleLaunchBattleTableAnimation","TrySetBehindSubstituteSpriteBit","TryShinyAnimation","UpdateHealthboxAttribute","UpdateHpTextInHealthbox"];

// ─── Failed transpiles (2) ───────────────────────────────
// RecordedOpponentDummy : empty body
// RecordedOpponentCmdEnd : empty body