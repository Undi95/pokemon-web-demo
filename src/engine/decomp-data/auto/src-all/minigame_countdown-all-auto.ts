...
export function Task_StaticCountdown(...args: any[]): any {
...
export function StaticCountdown_CreateSprites(...args: any[]): any {
  let i: any = null;
      let sprite: any = null;
...
export function Task_StaticCountdown_Init(...args: any[]): any {
  let data = gTasks[taskId].data;
      tSpriteTemplateId = 0;
      tSpriteSheetId = 0;
      tSpritePalId = 0;
...
export function Task_StaticCountdown_Free(...args: any[]): any {
  let i = 0;
      let data = gTasks[taskId].data;
...
export function SpriteCB_StaticCountdown(...args: any[]): any {
  let data = gTasks[sprite.sTaskId].data;
...
export function Task_StaticCountdown_Start(...args: any[]): any {
  let data = gTasks[taskId].data;
      PlaySE(SE_BALL_BOUNCE_1);
...
export function Task_StaticCountdown_Run(...args: any[]): any {
  const packet: any[] = [];
      let data = gTasks[taskId].data;
...
export function StartMinigameCountdown(...args: any[]): any {
  let taskId = CreateTask(Task_MinigameCountdown, 80);
...
export function Task_MinigameCountdown(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function RunMinigameCountdownDigitsAnim(...args: any[]): any {
...
export function InitStartGraphic(...args: any[]): any {
...
export function IsStartGraphicAnimRunning(...args: any[]): any {
...
export function Load321StartGfx(...args: any[]): any {
...
export function CreateNumberSprite(...args: any[]): any {
...
export function CreateStartSprite(...args: any[]): any {
  let spriteTemplate: any = [
          .oam = sOamData_Start,
