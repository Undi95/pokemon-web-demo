...
export function AddTextPrinterForUnionRoomBattle(windowId: any, str: any, x: any, y: any, speed: any): any {
...
export function PrintUnionRoomBattleMessage(state: any, str: any, speed: any): any {
  switch (state)
      {
      case 0:
