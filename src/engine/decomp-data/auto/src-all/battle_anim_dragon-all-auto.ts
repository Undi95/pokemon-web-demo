...
export function AnimOutrageFlame(...args: any[]): any {
...
export function StartDragonFireTranslation(...args: any[]): any {
...
export function AnimDragonRageFirePlume(...args: any[]): any {
...
export function AnimDragonFireToTarget(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
...
export function AnimDragonDanceOrb(...args: any[]): any {
  CMD_ARGS(angle);
...
export function AnimDragonDanceOrb_Step(...args: any[]): any {
...
export function AnimTask_DragonDanceWaver(...args: any[]): any {
...
export function AnimTask_DragonDanceWaver_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.data[0])
      {
      case 0:
...
export function UpdateDragonDanceScanlineEffect(...args: any[]): any {
  let sineIndex = task.data[5];
      let i: any = null;
      for (i = task.data[3]; i <= task.data[4]; i++)
      {
...
export function AnimOverheatFlame(...args: any[]): any {
  CMD_ARGS(speed, unk1, unk2, duration, y);

      let i: any = null;
      let yAmplitude = (cmd.unk2 * 3) / 5;
      sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
...
export function AnimOverheatFlame_Step(...args: any[]): any {
