...
export function LoadCompressedPalette(...args: any[]): any {
...
export function LoadPalette(...args: any[]): any {
  CpuCopy16(src, gPlttBufferUnfaded[offset], size);
      CpuCopy16(src, gPlttBufferFaded[offset], size);
}

/** void FillPalette(u16 value, u16 offset, u16 size) */
export function FillPalette(...args: any[]): any {
...
export function BeginNormalPaletteFade(...args: any[]): any {
  let temp: any = null;
...
export function PaletteStruct_Copy(...args: any[]): any {
...
export function PaletteStruct_Blend(...args: any[]): any {
...
export function PaletteStruct_TryEnd(...args: any[]): any {
  if (pal.countdown2 == 0)
      {
          let state = pal.template.state;
...
export function PaletteStruct_ResetById(...args: any[]): any {
  let paletteNum = PaletteStruct_GetPalNum(id);
      if (paletteNum != NUM_PALETTE_STRUCTS)
          PaletteStruct_Reset(paletteNum);
}

/** static void PaletteStruct_Reset(u8 paletteNum) */
export function PaletteStruct_Reset(...args: any[]): any {
...
export function PaletteStruct_GetPalNum(...args: any[]): any {
  let i: any = null;
...
export function InvertPlttBuffer(...args: any[]): any {
  let paletteOffset = 0;
...
export function TintPlttBuffer(...args: any[]): any {
  let paletteOffset = 0;
      ...
      while (selectedPalettes)
      {
          if (selectedPalettes & 1)
          {
              ...
              for (i = 0; i < 16; i++)
              {
                  let data: any = (struct PlttData *)&gPlttBufferFaded[paletteOffset + i];
                  data.r += r;
                  data.g += g;
                  data.b += b;
              }
...
export function UnfadePlttBuffer(...args: any[]): any {
  let paletteOffset = 0;
...
export function BeginFastPaletteFade(...args: any[]): any {
  gPaletteFade.deltaY = 2;
      BeginFastPaletteFadeInternal(submode);
}

/** static void BeginFastPaletteFadeInternal(u8 submode) */
export function BeginFastPaletteFadeInternal(...args: any[]): any {
  gPaletteFade.y = 31;
...
export function UpdateFastPaletteFade(): any {
  let i: any = null;
      ...
      case FAST_FADE_OUT_TO_WHITE:
          for (i = paletteOffsetStart; i < paletteOffsetEnd; i++)
          {
              let data: any = (struct PlttData *)&gPlttBufferFaded[i];
              r = data.r + 2;
              g = data.g + 2;
              b = data.b + 2;
...
export function BeginHardwarePaletteFade(...args: any[]): any {
...
export function BlendPalettes(...args: any[]): any {
  let paletteOffset: any = null;
...
export function BlendPalettesUnfaded(...args: any[]): any {
...
export function TintPalette_GrayScale(...args: any[]): any {
  let r, g, b, i;
      let gray: any = null;
...
export function TintPalette_GrayScale2(...args: any[]): any {
  let r, g, b, i;
      let gray: any = null;
...
export function TintPalette_SepiaTone(...args: any[]): any {
  let r, g, b, i;
      let gray: any = null;
...
export function TintPalette_CustomTone(...args: any[]): any {
  let r, g, b, i;
      let gray: any = null;
...
export function BlendPalettesGradually(...args: any[]): any {
  let taskId: any = null;
...
export function Task_BlendPalettesGradually(...args: any[]): any {
