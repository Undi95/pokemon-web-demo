...
export function CreateLinkupTask(...args: any[]): any {
...
export function PrintNumPlayersInLink(...args: any[]): any {
  let xPos: any = null;
...
export function ClearLinkPlayerCountWindow(...args: any[]): any {
  ClearStdWindowAndFrame(windowId, FALSE);
      CopyWindowToVram(windowId, COPYWIN_FULL);
}

/** static void UpdateLinkPlayerCountDisplay(u8 taskId, u8 numPlayers) */
export function UpdateLinkPlayerCountDisplay(...args: any[]): any {
...
export function ExchangeDataAndGetLinkupStatus(...args: any[]): any {
...
export function CheckLinkErrored(...args: any[]): any {
...
export function CheckLinkCanceledBeforeConnection(...args: any[]): any {
  if ((JOY_NEW(B_BUTTON))
...
export function CheckLinkCanceled(...args: any[]): any {
...
export function CheckSioErrored(...args: any[]): any {
...
export function Task_LinkupStart(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_LinkupAwaitConnection(...args: any[]): any {
...
export function Task_LinkupConfirmWhenReady(...args: any[]): any {
  if (CheckLinkCanceledBeforeConnection(taskId) == TRUE
...
export function Task_LinkupAwaitConfirmation(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_LinkupTryConfirmation(...args: any[]): any {
  if (CheckLinkCanceledBeforeConnection(taskId) == TRUE
       || CheckSioErrored(taskId) == TRUE
       || CheckLinkErrored(taskId) == TRUE)
          return;
...
export function Task_LinkupConfirm(...args: any[]): any {
  let minPlayers = gTasks[taskId].tMinPlayers;
      let maxPlayers = gTasks[taskId].tMaxPlayers;
...
export function Task_LinkupExchangeDataWithLeader(...args: any[]): any {
...
export function Task_LinkupCheckStatusAfterConfirm(...args: any[]): any {
  let card: any = null;
...
export function AreBattleTowerLinkSpeciesSame(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let haveSameSpecies = FALSE;
...
export function FinishLinkup(...args: any[]): any {
...
export function Task_LinkupAwaitTrainerCardData(...args: any[]): any {
  let index: any = null;
...
export function Task_StopLinkup(...args: any[]): any {
...
export function Task_LinkupFailed(...args: any[]): any {
...
export function Task_LinkupConnectionError(...args: any[]): any {
...
export function TryLinkTimeout(...args: any[]): any {
...
export function Task_ValidateMixingGameLanguage(...args: any[]): any {
...
export function Task_ReestablishLink(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_ReestablishLinkAwaitConnection(...args: any[]): any {
...
export function Task_ReestablishLinkLeader(...args: any[]): any {
  if (GetSavedPlayerCount() == GetLinkPlayerCount_2())
      {
          CheckShouldAdvanceLinkState();
          gTasks[taskId].func = Task_ReestablishLinkAwaitConfirmation;
...
export function Task_ReestablishLinkAwaitConfirmation(...args: any[]): any {
...
export function SetLinkBattleTypeFlags(...args: any[]): any {
  switch (linkService)
      {
      case USING_SINGLE_BATTLE:
...
export function Task_StartWiredCableClubBattle(...args: any[]): any {
...
export function Task_StartWirelessCableClubBattle(...args: any[]): any {
  let i: any = null;
      let data = gTasks[taskId].data;
...
export function Task_EnterCableClubSeat(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateTask_EnterCableClubSeat(...args: any[]): any {
  let taskId = CreateTask(Task_EnterCableClubSeat, 80);
      SetTaskFuncWithFollowupFunc(taskId, Task_EnterCableClubSeat, followupFunc);
      ScriptContext_Stop();
}

/** static void Task_StartWiredTrade(u8 taskId) */
export function Task_StartWiredTrade(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_StartWirelessTrade(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function GetLinkTrainerCardColor(...args: any[]): any {
...
export function Task_WaitForLinkPlayerConnection(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_WaitExitToScript(...args: any[]): any {
  if (!gReceivedRemoteLinkPlayers)
      {
          ScriptContext_Enable();
          DestroyTask(taskId);
...
export function Task_ReconnectWithLinkPlayers(...args: any[]): any {
  let data = gTasks[taskId].data;
