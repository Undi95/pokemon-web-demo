...
export function OpenConditionGraphMenu(): any {
  let menu: any = AllocSubstruct(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX, sizeof(struct Pokenav_ConditionMenuGfx));
...
export function CreateConditionGraphMenuLoopedTask(...args: any[]): any {
...
export function LoopedTask_OpenConditionGraphMenu(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function LoopedTask_ExitConditionGraphMenu(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function LoopedTask_TransitionMons(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function LoopedTask_MoveCursorNoTransition(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function LoopedTask_SlideMonOut(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function LoopedTask_OpenMonMarkingsWindow(...args: any[]): any {
  switch (state)
      {
      case 0:
...
export function LoopedTask_CloseMonMarkingsWindow(...args: any[]): any {
  switch (state)
      {
      case 0:
          FreeMonMarkingsMenu();
...
export function UpdateConditionGraphMenuWindows(...args: any[]): any {
  const text: any[] = [];
      let str: any = null;
      let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
...
export function SpriteCB_PartyPokeball(...args: any[]): any {
...
export function HighlightCurrentPartyIndexPokeball(...args: any[]): any {
...
export function MonMarkingsCallback(...args: any[]): any {
...
export function FreeConditionMenuGfx(...args: any[]): any {
  let i: any = null;
...
export function MonPicGfxSpriteCallback(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU_GFX);
      sprite.x = menu.monTransitionX + 38;
}

/** static void CreateConditionMonPic(u8 id) */
export function CreateConditionMonPic(...args: any[]): any {
  let sprTemplate: any = null;
      let sprSheet: any = null;
      let sprPal: any = null;
...
export function ToggleGraphData(...args: any[]): any {
  if (showBg)
          ShowBg(2);
      else
          HideBg(2);
