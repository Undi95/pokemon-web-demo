...
export function WarpFadeInScreen(): any {
  let previousMapType = GetLastUsedWarpMapType();
...
export function WarpFadeOutScreen(): any {
  let currentMapType = GetCurrentMapType();
...
export function SetPlayerVisibility(...args: any[]): any {
  SetPlayerInvisibility(!visible);
}

/** static void Task_WaitForUnionRoomFade(u8 taskId) */
export function Task_WaitForUnionRoomFade(...args: any[]): any {
...
export function Task_WaitForFadeAndEnableScriptCtx(...args: any[]): any {
  if (WaitForWeatherFadeIn() == TRUE)
      {
          DestroyTask(taskID);
...
export function Task_ReturnToFieldCableLink(...args: any[]): any {
...
export function Task_ReturnToFieldWirelessLink(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_ReturnToFieldRecordMixing(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_ExitDoor(...args: any[]): any {
  let task: any = gTasks[taskId];
      let x = task.data[2];
      let y = task.data[3];
...
export function Task_ExitNonAnimDoor(...args: any[]): any {
  let task: any = gTasks[taskId];
      let x = task.data[2];
      let y = task.data[3];
...
export function Task_ExitNonDoor(...args: any[]): any {
...
export function Task_WaitForFadeShowStartMenu(...args: any[]): any {
  if (WaitForWeatherFadeIn() == TRUE)
      {
          DestroyTask(taskId);
...
export function Task_ReturnToFieldNoScript(...args: any[]): any {
...
export function DoEscalatorWarp(...args: any[]): any {
  LockPlayerFieldControls();
...
export function Task_DoCableClubWarp(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_ReturnToWorldFromLinkRoom(...args: any[]): any {
...
export function Task_WarpAndLoadMap(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function Task_DoDoorWarp(...args: any[]): any {
  let task: any = gTasks[taskId];
      let x = task.data[2];
      let y = task.data[3];
...
export function Task_DoContestHallWarp(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function SetFlashScanlineEffectWindowBoundary(...args: any[]): any {
  if (y <= 160)
      {
          if (left < 0)
              left = 0;
...
export function SetFlashScanlineEffectWindowBoundaries(...args: any[]): any {
  let r = radius;
      let v2 = radius;
      let v3 = 0;
      while (r >= v3)
...
export function SetOrbFlashScanlineEffectWindowBoundary(...args: any[]): any {
  if (y <= 160)
      {
          if (left < 0)
              left = 0;
...
export function SetOrbFlashScanlineEffectWindowBoundaries(...args: any[]): any {
  let r = radius;
      let v2 = radius;
      let v3 = 0;
      while (r >= v3)
...
export function UpdateFlashLevelEffect(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function UpdateOrbFlashEffect(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_WaitForFlashUpdate(...args: any[]): any {
...
export function StartUpdateFlashLevelEffect(...args: any[]): any {
  let taskId = CreateTask(UpdateFlashLevelEffect, 80);
      let data = gTasks[taskId].data;
...
export function StartUpdateOrbFlashEffect(...args: any[]): any {
  let taskId = CreateTask(UpdateOrbFlashEffect, 80);
      let data = gTasks[taskId].data;
...
export function AnimateFlash(...args: any[]): any {
  let curFlashLevel = GetFlashLevel();
...
export function WriteFlashScanlineEffectBuffer(...args: any[]): any {
  if (flashLevel)
      {
...
export function Task_SpinEnterWarp(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
          FreezeObjectEvents();
...
export function Task_SpinExitWarp(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function LoadOrbEffectPalette(...args: any[]): any {
  let i: any = null;
      const color: any[] = [];
...
export function UpdateOrbEffectBlend(...args: any[]): any {
  let lo = REG_BLDALPHA & 0xFF;
      let hi = REG_BLDALPHA >> 8;
...
export function Task_OrbEffect(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DoOrbEffect(): any {
  let taskId = CreateTask(Task_OrbEffect, 80);
      let data = gTasks[taskId].data;
...
export function Task_EnableScriptAfterMusicFade(...args: any[]): any {
