...
const {
  ...
  AddBoxOptionsMenu, AddMenu, AddTextPrinterParameterized, AddTextPrinterParameterized2,
  AddTextPrinterParameterized3, AddTextPrinterParameterized4, AddTextPrinterParameterized5, AddWallpaperSetsMenu,
  AddWallpapersMenu, AddWindow, AddWindow8Bit, Alloc,
  AllocSpritePalette, AnimateBoxScrollArrows, AnimateSprites, AtLeastThreeUsableMons,
  BGCNT_CHARBASE, BGCNT_PRIORITY, BGCNT_SCREENBASE, BG_PLTT_ID,
  BG_SCREEN_ADDR, BLDALPHA_BLEND, BeginNormalPaletteFade, BlendPalettes,
  BlitBitmapRectToWindow4BitTo8Bit, BoxMonAtToMon, BoxMonRestorePP, BoxMonToMon,
  BufferMonMarkingsMenuTiles, BuildOamBuffer, CalculatePlayerPartyCount, CanShiftMon,
  ChangeBgX, ChangeBgY, CheckBoxMonSanityAt, CheckForSpaceForDma3Request,
  ChooseBoxMenu_CreateSprites, ChooseBoxMenu_DestroySprites, ChooseBoxMenu_MoveLeft, ChooseBoxMenu_MoveRight,
  ChooseBoxMenu_PrintInfo, CleanupOverworldWindowsAndTilemaps, ClearBottomWindow, ClearDma3Requests,
  ClearGpuRegBits, ClearSavedCursorPos, ClearScheduledBgCopiesToVram, ClearStdWindowAndFrame,
  ClearStdWindowAndFrameToTransparent, ClearWindowTilemap, CompactPartySlots, CompactPartySprites,
  ComputerScreenCloseEffect, ComputerScreenOpenEffect, ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram,
  CopyRectToBgTilemapBufferRect, CopyToBgTilemapBufferRect, CopyWindowToVram, CopyWindowToVram8Bit,
  CountMonsInBox, CountPartyAliveNonEggMonsExcept, CountPartyMons, CpuCopy16,
  CpuCopy32, CpuFastCopy, CpuFastFill, CpuFill16,
  CpuFill32, CreateBoxMon, CreateBoxMonIconAtPos, CreateBoxMonIconsInColumn,
  CreateBoxScrollArrows, CreateChooseBoxArrows, CreateChooseBoxMenuSprites, CreateCursorSprites,
  CreateDisplayMonSprite, CreateIncomingBoxTitle, CreateInitBoxTask, CreateItemIconSprites,
  CreateMainMenu, CreateMarkingComboSprite, CreateMonIconSprite, CreateMonMarkingComboSprite,
  CreateMovingMonIcon, CreatePartyMonsSprites, CreateSprite, CreateTask,
  CreateWaveformSprites, CreateYesNoMenu, CycleBoxTitleColor, CycleBoxTitleSprites,
  DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap, DestroyAllPartyMonIcons, DestroyBoxMonIcon,
  DestroyBoxMonIconAtPosition, DestroyBoxMonIconsInColumn, DestroyChooseBoxMenuSprites, DestroyMovingMonIcon,
  DestroyPartyMonIcon, DestroyReleaseMonIcon, DestroySprite, DestroyTask,
  DetermineBoxScrollDirection, Dma3FillLarge16_, DoCursorNewPosUpdate, DoMonPlaceChange,
  DoNamingScreen, DoScheduledBgTilemapCopiesToVram, DoShowPartyMenu, DoWallpaperGfxChange,
  DrawDialogueFrame, DrawItemInfoWindow, DrawStdFrameWithCustomTileAndPalette, DrawStdWindowFrame,
  DrawTextBorderOuter, DrawTextWindowAndBufferTiles, DrawWallpaper, DynamicPlaceholderTextUtil_ExpandPlaceholders,
  DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr, EnterPokeStorage, FREE_AND_SET_NULL,
  FadeInFromBlack, FadeScreen, FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0,
  FillWindowPixelBuffer, FillWindowPixelBuffer8Bit, FillWindowPixelRect8Bit, FlagClear,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, FreeChooseBoxMenu,
  FreeMonMarkingsMenu, FreeOamMatrix, FreePokeStorageData, FreeSpritePaletteByTag,
  FreeSpriteTileRanges, FreeSpriteTilesByTag, FuncIsActiveTask, GetAndCopyBoxMonDataAt,
  GetBgAttribute, GetBoxMonData, GetBoxMonDataAt, GetBoxNamePtr,
  GetBoxTitleBaseX, GetBoxWallpaper, GetBoxedMonPtr, GetCurrentBoxMonData,
  GetCurrentBoxOption, GetCursorBoxColumnAndRow, GetCursorCoordsByPos, GetCursorPosition,
  GetFirstFreeBoxSpot, GetGenderFromSpeciesAndPersonality, GetIncomingBoxMonData, GetItemDescription,
  GetItemIconIdxByPosition, GetItemIconIdxBySprite, GetItemIconPalette, GetItemIconPic,
  GetItemName, GetLevelFromBoxMonExp, GetMaxWidthInMenuTable, GetMenuItemTextId,
  GetMonData, GetMonFrontSpritePal, GetMonGender, GetMonIconPriorityByCursorPos,
  GetMonIconPtr, GetMonIconTiles, GetMonSpritePalFromSpeciesAndPersonality, GetMovingItemId,
  GetMovingItemName, GetNewItemIconIdx, GetNumPartySpritesCompacting, GetRestrictedReleaseMoves,
  GetSavedCursorPos, GetSpeciesAtCursorPosition, GetSpriteTileStartByTag, GetStringCenterAlignXOffset,
  GetStringWidth, GetTextWindowPalette, GetValidMonIconPalIndex, GetWaldaWallpaperColorsPtr,
  GetWaldaWallpaperIconId, GetWaldaWallpaperPatternId, GetWindowAttribute, GiveChosenBagItem,
  GiveItemToMon, GoToBagMenu, HandleChooseBoxMenuInput, HandleInput,
  HandleMenuInput, HandleMonMarkingsMenuInput, HideBg, HidePartyMenu,
  InBoxInput_MovingMultiple, InBoxInput_Normal, InBoxInput_SelectingMultiple, IndexOfSpritePaletteTag,
  InitBgsFromTemplates, InitBoxMonIconScroll, InitBoxMonSprites, InitBoxTitle,
  InitCanReleaseMonVars, InitCursor, InitCursorItemIcon, InitCursorMove,
  InitCursorOnReopen, InitItemIconInCursor, InitItemInfoWindow, InitMenu,
  InitMenuInUpperLeftCornerNormal, InitMonIconFields, InitMonMarkingsMenu, InitMonPlaceChange,
  InitMultiMonPlaceChange, InitNewCursorPos, InitPalettesAndSprites, InitPokeStorageBg0,
  InitPokeStorageWindows, InitReleaseMon, InitSpriteAffineAnim, InitStartingPosData,
  InitSummaryScreenData, InitSupplementalTilemaps, InitWindows, IsComputerScreenCloseEffectActive,
  IsComputerScreenOpenEffectActive, IsCursorInBox, IsCursorOnBoxTitle, IsCursorOnCloseBox,
  IsDisplayMosaicActive, IsDma3ManagerBusyWithBgCopy, IsInitBoxActive, IsItemIconAnimActive,
  IsItemIconAtPosition, IsMenuLoading, IsMonBeingMoved, IsMovingItem,
  IsRemovingLastPartyMon, IsWaldaWallpaperUnlocked, IsWeatherNotFadingIn, ItemIsMail,
  JOY_HELD, JOY_NEW, JOY_REPEAT, LZ77UnCompVram,
  LZ77UnCompWram, LoadBgTiles, LoadChooseBoxMenuGfx, LoadCompressedSpriteSheet,
  LoadDisplayMonGfx, LoadItemIconGfx, LoadMessageBoxAndBorderGfx, LoadMonIconPalettes,
  LoadOam, LoadPalette, LoadPokeStorageMenuGfx, LoadSavedMovingMon,
  LoadSpecialPokePic, LoadSpritePalette, LoadSpritePalettes, LoadSpriteSheet,
  LoadSpriteSheets, LoadUserWindowBorderGfx, LoadWallpaperGfx, LoadWaveformSpritePalette,
  LockPlayerFieldControls, Menu_GetCursorPos, Menu_MoveCursor, Menu_MoveCursorNoWrapAround,
  Menu_ProcessInput, Menu_ProcessInputNoWrapClearOnChoose, MonPlaceChange_CursorDown, MonPlaceChange_CursorUp,
  MoveHeldItemWithPartyMenu, MoveItemFromCursorToBag, MoveItemFromMonToBag, MoveMon,
  MovePartySpriteToNextSlot, MovePartySprites, MoveShiftingMons, MultiMove_CanPlaceSelection,
  MultiMove_Cancel, MultiMove_ChangeSelection, MultiMove_ClearIconFromBg, MultiMove_CreatePlacedMonIcons,
  MultiMove_DeselectColumn, MultiMove_DeselectRow, MultiMove_Free, MultiMove_GetMonsFromSelection,
  MultiMove_GetOrigin, MultiMove_GrabSelection, MultiMove_Init, MultiMove_InitMove,
  MultiMove_MoveMons, MultiMove_PlaceMons, MultiMove_RemoveMonsFromBox, MultiMove_ResetBg,
  MultiMove_RunFunction, MultiMove_SelectColumn, MultiMove_SelectRow, MultiMove_SetFunction,
  MultiMove_SetIconToBg, MultiMove_SetPlacedMonData, MultiMove_Start, MultiMove_TryMoveGroup,
  MultiMove_UpdateMove, MultiMove_UpdateSelectedIcons, OBJ_PLTT_ID, OpenMonMarkingsMenu,
  PIXEL_FILL, PLTT_SIZEOF, PlaceMon, PlaySE,
  PrintDisplayMonInfo, PrintItemDescription, PrintMenuTable, PrintMessage,
  ProcessSpriteCopyRequests, PurgeMonOrBoxMon, PutWindowTilemap, Q_8_8,
  RefreshDisplayMon, RefreshDisplayMonData, ReleaseMon, RemoveBagItem,
  RemoveMenu, RemoveSpeciesFromIconList, RemoveWindow, RequestDma3Fill,
  ResetAllBgCoords, ResetForPokeStorage, ResetPaletteFade, ResetReleaseMonSpritePtr,
  ResetSelectionAfterDeposit, ResetSpriteData, ResetTasks, ResetWaldaWallpaper,
  ReshowDisplayMon, ReshowReleaseMon, RunCanReleaseMon, RunTasks,
  SPRITE_SHAPE, SPRITE_SIZE, SWAP, SaveCursorPos,
  SaveMonSpriteAtPos, SaveMovingMon, ScheduleBgCopyTilemapToVram, ScriptContext_Enable,
  ScrollBackground, ScrollToBox, SetBgAttribute, SetBgTilemapBuffer,
  SetBoxMonAt, SetBoxMonData, SetBoxMonDataAt, SetBoxMonIconObjMode,
  SetBoxWallpaper, SetCurrentBox, SetCurrentBoxMonData, SetCursorBoxPosition,
  SetCursorInParty, SetCursorPosition, SetCursorPriorityTo1, SetDisplayMonData,
  SetGpuReg, SetGpuRegBits, SetItemIconActive, SetItemIconAffineAnim,
  SetItemIconCallback, SetItemIconPosition, SetMainCallback2, SetMenuText,
  SetMenuTexts_Item, SetMenuTexts_Mon, SetMonData, SetMonIconTransparency,
  SetMonMarkings, SetMovingMonData, SetMovingMonPriority, SetMovingMonSprite,
  SetPartyMonIconObjMode, SetPartySlotTilemap, SetPartySlotTilemaps, SetPlacedMonData,
  SetPlacedMonSprite, SetPokeStorageTask, SetReleaseMon, SetScrollingBackground,
  SetSelectionAfterSummaryScreen, SetSelectionMenuTexts, SetShiftedMonData, SetUpDoShowPartyMenu,
  SetUpHidePartyMenu, SetUpScrollToBox, SetUpShowPartyMenu, SetVBlankCallback,
  SetWallpaperForCurrentBox, ShowBg, ShowPartyMenu, ShowPokemonSummaryScreen,
  ShowPokemonSummaryScreenHandleDeoxys, ShowYesNoWindow, StartBoxMonIconsScrollOut, StartBoxScrollArrowsSlide,
  StartCursorAnim, StartDisplayMonMosaicEffect, StartFlashingCloseBoxButton, StartSpriteAffineAnim,
  StartSpriteAnim, StartSpriteAnimIfDifferent, StopBoxScrollArrowsSlide, StopFlashingCloseBoxButton,
  StorageGetCurrentBox, StringAppend, StringCopy, StringCopyPadded,
  StringFill, StringGet_Nickname, StringLength, SwapItemsWithMon,
  TRY_FREE_AND_SET_NULL, TakeItemFromMon, Task_PCMainMenu, TilemapUtil_Draw,
  TilemapUtil_DrawPrev, TilemapUtil_Free, TilemapUtil_Init, TilemapUtil_Move,
  TilemapUtil_SetMap, TilemapUtil_SetPos, TilemapUtil_SetRect, TilemapUtil_Update,
  ToggleCursorAutoAction, TransferPlttBuffer, TrimOldWallpaper, TryHideItemAtCursor,
  TryHideItemIconAtPos, TryHideReleaseMon, TryHideReleaseMonSprite, TryLoadAllMonIconPalettesAtOffset,
  TryLoadItemIconAtPos, TryRefreshDisplayMon, TrySetCursorFistAnim, TryShowItemAtCursor,
  TryStorePartyMonInBox, UnkUtil_Init, UnkUtil_Run, UnlockPlayerFieldControls,
  UpdateBoxMonIconScroll, UpdateBoxToSendMons, UpdateCloseBoxButtonFlash, UpdateCloseBoxButtonTilemap,
  UpdateCursorPos, UpdateItemInfoWindowSlideIn, UpdateItemInfoWindowSlideOut, UpdateMonMarkingTiles,
  UpdatePaletteFade, UpdatePartySlotColors, UpdateWaveformAnimation, VarSet,
  WaitForWallpaperGfxLoad, WriteSequenceToBgTilemapBuffer, ZeroBoxMonAt, ZeroBoxMonData,
...
export function Task_PCMainMenu(taskId: any): any {
...
export function ShowPokemonStorageSystemPC(): any {
  let taskId: any = CreateTask(Task_PCMainMenu, 80);
...
export function FieldTask_ReturnToPcMenu(): any {
  let taskId: any = null;
      let vblankCb: any = gMain.vblankCallback;
...
export function CreateMainMenu(whichMenu: any, windowIdPtr: any): any {
  let windowId: any = null;
      let template: any = sWindowTemplate_MainMenu;
      template.width = GetMaxWidthInMenuTable(sMainMenuTexts, OPTIONS_COUNT);
      windowId = AddWindow(template);

      DrawStdWindowFrame(windowId, FALSE);
      PrintMenuTable(windowId, OPTIONS_COUNT, sMainMenuTexts);
...
export function LoadChooseBoxMenuGfx(menu: any, tileTag: any, palTag: any, subpriority: any, loadPal: any): any {
  let palette: any =
      [
...
export function CreateChooseBoxMenuSprites(curBox: any): any {
...
export function ChooseBoxMenu_CreateSprites(curBox: any): any {
  let i: any = null;
      let spriteId: any = null;
      let template: any = null;
      let oamData: any = [];
      oamData.size = SPRITE_SIZE(_64x64);
      ...
      oamData.shape = SPRITE_SHAPE(_8x32);
      oamData.size = SPRITE_SIZE(_8x32);
...
export function ChooseBoxMenu_PrintInfo(): any {
  const numBoxMonsText: any[] = [];
      ...
      let numInBox: any = CountMonsInBox(sChooseBoxMenu.curBox);
...
export function SpriteCB_ChooseBoxArrow(sprite: any): any {
  if (++sprite.data[1] > 3)
      {
          sprite.data[1] = 0;
...
export function EnterPokeStorage(boxOption: any): any {
  ResetTasks();
...
export function SetPokeStorageTask(newFunc: any): any {
  gTasks[sStorage.taskId].func = newFunc;
      sStorage.state = 0;
}

/** static void Task_InitPokeStorage(u8 taskId) */
export function Task_InitPokeStorage(taskId: any): any {
...
export function Task_ShowPokeStorage(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          PlaySE(SE_PC_LOGIN);
...
export function Task_ReshowPokeStorage(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_PokeStorageMain(taskId: any): any {
  switch (sStorage.state)
      {
...
export function Task_ShowPartyPokemon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_HidePartyPokemon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function Task_OnSelectedMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_MoveMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_PlaceMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_ShiftMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_WithdrawMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_DepositMenu(taskId: any): any {
  let boxId: any = null;
...
export function Task_ReleaseMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
      ...
      case 2:
          ...
          if (!TryHideReleaseMon())
          {
              while (1)
              {
                  let canRelease: any = RunCanReleaseMon();
                  if (canRelease == TRUE)
                  {
                      sStorage.state++;
                      break;
...
export function Task_ShowMarkMenu(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_TakeItemForMoving(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          if (!ItemIsMail(sStorage.displayMonItemId))
...
export function Task_GiveMovingItemToMon(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          ClearBottomWindow();
...
export function Task_ItemToBag(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_SwitchSelectedItem(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          if (!ItemIsMail(sStorage.displayMonItemId))
...
export function Task_ShowItemInfo(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          ClearBottomWindow();
...
export function Task_CloseBoxWhileHoldingItem(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function Task_HandleMovingMonFromParty(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          CompactPartySlots();
...
export function Task_PrintCantStoreMail(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_HandleBoxOptions(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_HandleWallpapers(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_JumpBox(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_NameBox(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          SaveMovingMon();
...
export function Task_ShowMonSummary(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
...
export function Task_GiveItemFromBag(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
...
export function Task_OnCloseBoxPressed(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          if (IsMonBeingMoved())
...
export function Task_OnBPressed(taskId: any): any {
  switch (sStorage.state)
      {
      case 0:
          if (IsMonBeingMoved())
...
export function Task_ChangeScreen(taskId: any): any {
  let boxMons: any = null;
      let mode, monIndex, maxMonIndex;
      let screenChangeType: any = sStorage.screenChangeType;
...
export function SetScrollingBackground(): any {
  SetGpuReg(REG_OFFSET_BG3CNT, BGCNT_PRIORITY(3) | BGCNT_CHARBASE(3) | BGCNT_16COLOR | BGCNT_SCREENBASE(31));
      ...
      LZ77UnCompVram(sScrollingBg_Tilemap, BG_SCREEN_ADDR(31));
}
...
export function InitPalettesAndSprites(): any {
  LoadPalette(sInterface_Pal, BG_PLTT_ID(0), 0);
      LoadPalette(sPkmnDataGray_Pal, BG_PLTT_ID(2), 0);
      LoadPalette(sTextWindows_Pal, BG_PLTT_ID(15), 0);
      if (sStorage.boxOption != OPTION_MOVE_ITEMS)
          LoadPalette(sScrollingBg_Pal, BG_PLTT_ID(3), 0);
      else
          LoadPalette(sScrollingBgMoveItems_Pal, BG_PLTT_ID(3), 0);
...
export function CreateMarkingComboSprite(): any {
  sStorage.markingComboSprite = CreateMonMarkingComboSprite(GFXTAG_MARKING_COMBO, PALTAG_MARKING_COMBO, NULL);
      ...
      sStorage.markingComboTilesPtr = OBJ_VRAM0 + 32 * GetSpriteTileStartByTag(GFXTAG_MARKING_COMBO);
}
...
export function CreateWaveformSprites(): any {
  let i: any = null;
      ...
      {
          let spriteId: any = CreateSprite(sSpriteTemplate_Waveform, i * 63 + 8, 9, 2);
...
export function SpriteCB_DisplayMonMosaic(sprite: any): any {
...
export function CreateDisplayMonSprite(): any {
  let i: any = null;
      ...
      do
      {
          ...
          sStorage.displayMonTilePtr = OBJ_VRAM0 + tileStart * TILE_SIZE_4BPP;
      } while (0);
...
export function LoadDisplayMonGfx(species: any, pid: any): any {
  if (sStorage.displayMonSprite == NULL)
          return;
...
export function UpdateCloseBoxButtonTilemap(normal: any): any {
  if (normal)
          TilemapUtil_SetRect(TILEMAPID_CLOSE_BUTTON, 0, 0, 9, 2);
      else  
...
export function SetPartySlotTilemap(partyId: any, hasMon: any): any {
  let i, j, index;
      let data: any = null;
...
export function PrintMessage(id: any): any {
  let txtPtr: any = null;
...
export function ShowYesNoWindow(cursorPos: any): any {
...
export function AddWallpapersMenu(wallpaperSet: any): any {
  InitMenu();
      switch (wallpaperSet)
      {
...
export function CreateMovingMonIcon(): any {
  let personality: any = GetMonData(sStorage.movingMon, MON_DATA_PERSONALITY);
      let species: any = GetMonData(sStorage.movingMon, MON_DATA_SPECIES_OR_EGG);
      let priority: any = GetMonIconPriorityByCursorPos();
...
export function InitBoxMonSprites(boxId: any): any {
...
export function SpriteCB_BoxMonIconScrollIn(sprite: any): any {
...
export function SpriteCB_BoxMonIconScrollOut(sprite: any): any {
  if (sprite.sDelay != 0)
      {
          sprite.sDelay--;
      }
...
export function DestroyBoxMonIconsInColumn(column: any): any {
  let row: any = null;
...
export function CreateBoxMonIconsInColumn(column: any, distance: any, speed: any): any {
  let i: any = null;
      let y: any = 44;
      let xDest: any = 8 * (3 * column) + 100;
      let x: any = xDest - ((distance + 1) * speed);
      let subpriority: any = 19 - column;
      let iconsCreated: any = 0;
      let boxPosition: any = column;
...
export function InitBoxMonIconScroll(boxId: any, direction: any): any {
...
export function GetIncomingBoxMonData(boxId: any): any {
  let i, j, boxPosition;
...
export function DestroyBoxMonIconAtPosition(boxPosition: any): any {
  if (sStorage.boxMonsSprites[boxPosition] != NULL)
      {
          DestroyBoxMonIcon(sStorage.boxMonsSprites[boxPosition]);
          sStorage.boxMonsSprites[boxPosition] = NULL;
...
export function SetBoxMonIconObjMode(boxPosition: any, objMode: any): any {
  if (sStorage.boxMonsSprites[boxPosition] != NULL)
          sStorage.boxMonsSprites[boxPosition].oam.objMode = objMode;
}

/** static void CreatePartyMonsSprites(bool8 visible) */
export function CreatePartyMonsSprites(visible: any): any {
  let i, count;
      let species: any = GetMonData(gPlayerParty[0], MON_DATA_SPECIES_OR_EGG);
      let personality: any = GetMonData(gPlayerParty[0], MON_DATA_PERSONALITY);
...
export function MovePartySpriteToNextSlot(sprite: any, partyId: any): any {
  let x, y;
      ...
      sprite.sMonX = (sprite.x) * 8;
      sprite.sMonY = (sprite.y) * 8;
...
export function SpriteCB_MovePartyMonToNextSlot(sprite: any): any {
  if (sprite.sMoveSteps != 0)
      {
          let x: any = sprite.sMonX += sprite.sSpeedX;
          let y: any = sprite.sMonY += sprite.sSpeedY;
          sprite.x = x / 8;
          sprite.y = y / 8;
          sprite.sMoveSteps--;
      }
...
export function DestroyPartyMonIcon(partyId: any): any {
...
export function SetPartyMonIconObjMode(partyId: any, objMode: any): any {
  if (sStorage.partySprites[partyId] != NULL)
      {
...
export function SetMovingMonSprite(mode: any, id: any): any {
  if (mode == MODE_PARTY)
      {
...
export function SetReleaseMon(mode: any, position: any): any {
  switch (mode)
      {
      case MODE_PARTY:
...
export function SetMovingMonPriority(priority: any): any {
  sStorage.movingMonSprite.oam.priority = priority;
}

/** static void SpriteCB_HeldMon(struct Sprite *sprite) */
export function SpriteCB_HeldMon(sprite: any): any {
...
export function TryLoadMonIconTiles(species: any): any {
  let i, offset;
...
export function DestroyBoxMonIcon(sprite: any): any {
  RemoveSpeciesFromIconList(sprite.data[0]);
      DestroySprite(sprite);
}

/** static void CreateInitBoxTask(u8 boxId) */
export function CreateInitBoxTask(boxId: any): any {
  let taskId: any = CreateTask(Task_InitBox, 2);
...
export function Task_InitBox(taskId: any): any {
  let task: any =gTasks[taskId];
...
export function SetUpScrollToBox(boxId: any): any {
  let direction: any = DetermineBoxScrollDirection(boxId);
...
export function DetermineBoxScrollDirection(boxId: any): any {
  let i: any = null;
      let currentBox: any = StorageGetCurrentBox();
...
export function SetWallpaperForCurrentBox(wallpaperId: any): any {
  let boxId: any = StorageGetCurrentBox();
...
export function DoWallpaperGfxChange(): any {
  switch (sStorage.wallpaperChangeState)
      ...
      case 1:
          if (!UpdatePaletteFade())
          {
              let curBox: any = StorageGetCurrentBox();
...
export function LoadWallpaperGfx(boxId: any, direction: any): any {
  let wallpaperId: any = null;
      let wallpaper: any = null;
      let iconGfx: any = null;
...
export function DrawWallpaper(tilemap: any, direction: any, offset: any): any {
  let tileOffset: any = offset * 256;
      let paletteNum: any = (offset * 2) + 3;
      let x: any = ((sStorage.bg2_X / 8 + 10) + (direction * 24)) & 0x3F;
...
export function TrimOldWallpaper(tilemap: any): any {
  let i: any = null;
      let dest: any = tilemap;
...
export function InitBoxTitle(boxId: any): any {
  let tagIndex: any = null;
      ...
      let wallpaperId: any = GetBoxWallpaper(boxId);
      ...
      for (i = 0; i < 2; i++)
      {
          let spriteId: any = CreateSprite(sSpriteTemplate_BoxTitle, x + i * 32, 28, 24);
...
export function CreateIncomingBoxTitle(boxId: any, direction: any): any {
  let palOffset: any = null;
      ...
      for (i = 0; i < 2; i++)
      {
          let spriteId: any = CreateSprite(template, i * 32 + adjustedX, 28, 24);
...
export function SpriteCB_IncomingBoxTitle(sprite: any): any {
...
export function SpriteCB_OutgoingBoxTitle(sprite: any): any {
...
export function GetBoxTitleBaseX(string: any): any {
...
export function StartBoxScrollArrowsSlide(direction: any): any {
  let i: any = null;
...
export function AnimateBoxScrollArrows(animate: any): any {
  let i: any = null;
...
export function SpriteCB_Arrow(sprite: any): any {
...
export function GetCursorCoordsByPos(cursorArea: any, cursorPosition: any, x: any, y: any): any {
  switch (cursorArea)
      {
...
export function InitNewCursorPos(newCursorArea: any, newCursorPosition: any): any {
  let x, y;
...
export function SetCursorPosition(newCursorArea: any, newCursorPosition: any): any {
...
export function SetCursorBoxPosition(cursorBoxPosition: any): any {
...
export function InitMonPlaceChange(_type: any): any {
  const placeChangeFuncs: any =
      [ MonPlaceChange_Grab, MonPlaceChange_Place, MonPlaceChange_Shift,
      ];

      sStorage.monPlaceChangeFunc = placeChangeFuncs[_type];
      sStorage.monPlaceChangeState = 0;
}

/** static void InitMultiMonPlaceChange(bool8 up) */
export function InitMultiMonPlaceChange(up: any): any {
  if (!up)
...
export function TryStorePartyMonInBox(boxId: any): any {
  let boxPosition: any = GetFirstFreeBoxSpot(boxId);
      if (boxPosition == -1)
          return FALSE;
...
export function GetRestrictedReleaseMoves(moves: any): any {
  let i: any = null;
...
export function SetMonMarkings(markings: any): any {
...
export function SetDisplayMonData(pokemon: any, mode: any): any {
  let txtPtr: any = null;
      let gender: any = null;
...
export function SetMenuTexts_Mon(): any {
  let species: any = GetSpeciesAtCursorPosition();
...
export function SpriteCB_CursorShadow(sprite: any): any {
  sprite.x = sStorage.cursorSprite.x;
...
export function CreateCursorSprites(): any {
  let x, y;
      ...
      let spritePalettes: any =
      [
          [sHandCursor_Pal, PALTAG_MISC_1],
          []
      ];

      let sOamData_Cursor: any =
      [ SPRITE_SHAPE(_32x32), SPRITE_SIZE(_32x32), 1,
      ];
      let sOamData_CursorShadow: any =
      [ SPRITE_SHAPE(_16x16), SPRITE_SIZE(_16x16), 1,
      ];

      const sAnim_Cursor_Bouncing: any =
      [
          ANIMCMD_FRAME(0, 30),
          ANIMCMD_FRAME(16, 30),
          ANIMCMD_JUMP(0)
      ...
      [ sAnim_Cursor_Bouncing, sAnim_Cursor_Still, sAnim_Cursor_Open, sAnim_Cursor_Fist
      ];

      let sSpriteTemplate_Cursor: any =
      [ GFXTAG_CURSOR, PALTAG_MISC_2, sOamData_Cursor, sAnims_Cursor, NULL, gDummySpriteAffineAnimTable, SpriteCallbackDummy,
      ];

      let sSpriteTemplate_CursorShadow: any =
      [ GFXTAG_CURSOR_SHADOW, PALTAG_MISC_2, sOamData_CursorShadow, gDummySpriteAnimTable, NULL, gDummySpriteAffineAnimTable, SpriteCB_CursorShadow,
      ];
...
export function StartCursorAnim(animNum: any): any {
...
export function SetMenuText(textId: any): any {
...
export function GetMenuItemTextId(menuIdx: any): any {
...
export function AddMenu(): any {
  sStorage.menuWindow.width = sStorage.menuWidth + 2;
      ...
      PrintMenuTable(sStorage.menuWindowId, sStorage.menuItemsCount, sStorage.menuItems);
...
export function MultiMove_SetFunction(id: any): any {
...
export function MultiMove_MoveMons(): any {
  let movingCursor: any = UpdateCursorPos();
      let movingBg: any = MultiMove_UpdateMove();
...
export function MultiMove_TryMoveGroup(dir: any): any {
  switch (dir)
      {
      case 0:  
...
export function MultiMove_UpdateSelectedIcons(): any {
  let columnChange: any = (abs(sMultiMove.fromColumn - sMultiMove.cursorColumn)) - (abs(sMultiMove.fromColumn - sMultiMove.toColumn));
      let rowChange: any = (abs(sMultiMove.fromRow - sMultiMove.cursorRow)) - (abs(sMultiMove.fromRow - sMultiMove.toRow));
...
export function MultiMove_SelectColumn(column: any, minRow: any, maxRow: any): any {
  if (minRow > maxRow)
      {
          let temp: any = null;
...
export function MultiMove_SelectRow(row: any, minColumn: any, maxColumn: any): any {
...
export function MultiMove_DeselectColumn(column: any, minRow: any, maxRow: any): any {
  if (minRow > maxRow)
      {
          let temp: any = null;
          SWAP(minRow, maxRow, temp);
...
export function MultiMove_DeselectRow(row: any, minColumn: any, maxColumn: any): any {
  if (minColumn > maxColumn)
      {
          let temp: any = null;
          SWAP(minColumn, maxColumn, temp);
...
export function MultiMove_InitMove(x: any, y: any, moveSteps: any): any {
  sMultiMove.bgX = x;
      sMultiMove.bgY = y;
...
export function MultiMove_RemoveMonsFromBox(): any {
  let i, j;
      let columnCount: any = sMultiMove.minColumn + sMultiMove.columnsTotal;
      let rowCount: any = sMultiMove.minRow + sMultiMove.rowsTotal;
      let boxId: any = StorageGetCurrentBox();
  ...
  let i: any = null;
      ...
      if (sStorage.boxOption == OPTION_MOVE_ITEMS)
      {
          ...
          for (i = 0; i < MAX_ITEM_ICONS; i++)
          {
              ...
              sStorage.itemIcons[i].tiles = GetSpriteTileStartByTag(spriteSheet.tag) * TILE_SIZE_4BPP + (OBJ_VRAM0);
...
export function TryLoadItemIconAtPos(cursorArea: any, cursorPos: any): any {
...
export function TryHideItemIconAtPos(cursorArea: any, cursorPos: any): any {
  let id: any = null;
...
export function TakeItemFromMon(cursorArea: any, cursorPos: any): any {
  let id: any = null;
      let itemId: any = null;
...
export function InitItemIconInCursor(itemId: any): any {
  let tiles: any = GetItemIconPic(itemId);
      let pal: any = GetItemIconPalette(itemId);
      let id: any = GetNewItemIconIdx();
      LoadItemIconGfx(id, tiles, pal);
...
export function SwapItemsWithMon(cursorArea: any, cursorPos: any): any {
  let id: any = null;
      let itemId: any = null;
...
export function GiveItemToMon(cursorArea: any, cursorPos: any): any {
  let id: any = null;
...
export function MoveItemFromMonToBag(cursorArea: any, cursorPos: any): any {
  let id: any = null;
      let itemId: any = null;
...
export function DrawItemInfoWindow(x: any): any {
  if (x != 0)
      {
...
export function SpriteCB_ItemIcon_WaitAnim(sprite: any): any {
...
export function SpriteCB_ItemIcon_ToHand(sprite: any): any {
  switch (sprite.sState)
      {
      case 0:
...
export function SpriteCB_ItemIcon_SetPosToCursor(sprite: any): any {
...
export function SpriteCB_ItemIcon_ToMon(sprite: any): any {
  switch (sprite.sState)
      {
      case 0:
          sprite.data[1] = sprite.x << 4;
...
export function SpriteCB_ItemIcon_SwapToHand(sprite: any): any {
  switch (sprite.sState)
      {
      case 0:
          sprite.data[1] = sprite.x << 4;
...
export function SpriteCB_ItemIcon_SwapToMon(sprite: any): any {
  switch (sprite.sState)
      {
      case 0:
          sprite.data[1] = sprite.x << 4;
...
export function SpriteCB_ItemIcon_HideParty(sprite: any): any {
  sprite.y -= 8;
...
export function GetCurrentBoxMonData(boxPosition: any, request: any): any {
  return GetBoxMonDataAt(gPokemonStoragePtr.currentBox, boxPosition, request);
}

/** void SetCurrentBoxMonData(u8 boxPosition, s32 request, const void *value) */
export function SetCurrentBoxMonData(boxPosition: any, request: any, value: any): any {
...
export function AdvanceStorageMonIndex(boxMons: any, currIndex: any, maxIndex: any, mode: any): any {
  let i: any = null;
      let direction: any = -1;
...
export function SetWaldaWallpaperLockedOrUnlocked(unlocked: any): any {
...
export function SetWaldaWallpaperPatternId(id: any): any {
...
export function TilemapUtil_Init(count: any): any {
  let i: any = null;

      sTilemapUtil = Alloc(0 * count);
...
export function TilemapUtil_SetMap(id: any, bg: any, tilemap: any, width: any, height: any): any {
...
export function TilemapUtil_SetPos(id: any, x: any, y: any): any {
  if (id >= sNumTilemapUtilIds)
          return;
...
export function TilemapUtil_SetRect(id: any, x: any, y: any, width: any, height: any): any {
  if (id >= sNumTilemapUtilIds)
          return;
...
export function TilemapUtil_Move(id: any, mode: any, val: any): any {
  if (id >= sNumTilemapUtilIds)
          return;
...
export function TilemapUtil_Update(id: any): any {
  if (id >= sNumTilemapUtilIds)
          return;
...
export function TilemapUtil_DrawPrev(id: any): any {
  let i: any = null;
      let adder: any = sTilemapUtil[id].tileSize * sTilemapUtil[id].altWidth;
      let tiles: any = (sTilemapUtil[id].savedTilemap + (adder * sTilemapUtil[id].prev.destY))
...
export function TilemapUtil_Draw(id: any): any {
  let i: any = null;
      let adder: any = sTilemapUtil[id].tileSize * sTilemapUtil[id].width;
      let tiles: any = (sTilemapUtil[id].tilemap + (adder * sTilemapUtil[id].cur.y))
...
export function UnkUtil_Init(util: any, data: any, max: any): any {
  sUnkUtil = util;
      util.data = data;
      util.max = max;
      util.numActive = 0;
...
export function UnkUtil_CpuRun(data: any): any {
  let i: any = null;
...
export function UnkUtil_DmaRun(data: any): any {
  let i: any = null;
