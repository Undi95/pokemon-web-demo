...
const {
  ...
  DISPCNT_OBJ_ON, DISPLAY_HEIGHT, DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap,
  DestroySprite, DestroyTask, Dma3FillLarge16_, DoNamingScreen,
  DoScheduledBgTilemapCopiesToVram, DrawDialogueFrame, DrawStdFrameWithCustomTileAndPalette, DrawStdWindowFrame,
  DrawTextBorderOuter, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr,
  FALSE, FREE_AND_SET_NULL, FadeInFromBlack, FadeScreen,
  ...
  Menu_ProcessInputNoWrapClearOnChoose, NULL, OBJ_PLTT_ID, OpenMonMarkingsMenu,
  PALETTES_ALL, PIXEL_FILL, PLTT_SIZEOF, PLTT_SIZE_4BPP,
  PlaySE, PrintMenuTable, ProcessSpriteCopyRequests, PutWindowTilemap,
  Q_8_8, REG_OFFSET_BG0CNT, REG_OFFSET_BG0HOFS, REG_OFFSET_BG0VOFS,
  ...
  RemoveBagItem, RemoveWindow, RequestDma3Fill, ResetPaletteFade,
  ResetSpriteData, ResetTasks, RunTasks, SPRITE_SHAPE,
  SPRITE_SIZE, STR_CONV_MODE_LEFT_ALIGN, STR_CONV_MODE_RIGHT_ALIGN, ST_OAM_AFFINE_NORMAL,
  ST_OAM_OBJ_BLEND, ST_OAM_OBJ_NORMAL, SWAP, ScheduleBgCopyTilemapToVram,
  ScriptContext_Enable, SetBgAttribute, SetBgTilemapBuffer, SetBoxMonData,
  SetGpuReg, SetGpuRegBits, SetMainCallback2, SetMonData,
  SetVBlankCallback, ShowBg, ShowPokemonSummaryScreen, ShowPokemonSummaryScreenHandleDeoxys,
  StartSpriteAffineAnim, StartSpriteAnim, StartSpriteAnimIfDifferent, StringAppend,
  StringCopy, StringCopyPadded, StringFill, StringGet_Nickname,
