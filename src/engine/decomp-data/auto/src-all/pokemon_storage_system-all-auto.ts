...
const {
  ...
  AllocSpritePalette, AnimateSprites, BGCNT_CHARBASE, BGCNT_PRIORITY,
  BGCNT_SCREENBASE, BG_PLTT_ID, BG_SCREEN_ADDR, BLDALPHA_BLEND,
  BeginNormalPaletteFade, BlendPalettes, BlitBitmapRectToWindow4BitTo8Bit, BoxMonRestorePP,
  BoxMonToMon, BufferMonMarkingsMenuTiles, BuildOamBuffer, CalculatePlayerPartyCount,
  ChangeBgX, ChangeBgY, CheckForSpaceForDma3Request, CleanupOverworldWindowsAndTilemaps,
  ClearDma3Requests, ClearGpuRegBits, ClearScheduledBgCopiesToVram, ClearStdWindowAndFrame,
  ClearStdWindowAndFrameToTransparent, ClearWindowTilemap, ComputerScreenCloseEffect, ComputerScreenOpenEffect,
  ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyRectToBgTilemapBufferRect, CopyToBgTilemapBufferRect,
  CopyWindowToVram, CopyWindowToVram8Bit, CpuCopy16, CpuCopy32,
  CpuFastCopy, CpuFastFill, CpuFill16, CpuFill32,
  CreateBoxMon, CreateChooseBoxArrows, CreateMonIconSprite, CreateMonMarkingComboSprite,
  ...
  DynamicPlaceholderTextUtil_SetPlaceholderPtr, FREE_AND_SET_NULL, FadeInFromBlack, FadeScreen,
  FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FillWindowPixelBuffer8Bit,
  FillWindowPixelRect8Bit, FlagClear, Free, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreeMonMarkingsMenu, FreeOamMatrix, FreeSpritePaletteByTag,
  FreeSpriteTileRanges, FreeSpriteTilesByTag, FuncIsActiveTask, GetBgAttribute,
  GetBoxMonData, GetBoxNamePtr, GetBoxedMonPtr, GetGenderFromSpeciesAndPersonality,
  GetItemDescription, GetItemIconPalette, GetItemIconPic, GetItemName,
  GetLevelFromBoxMonExp, GetMaxWidthInMenuTable, GetMonData, GetMonFrontSpritePal,
  GetMonGender, GetMonIconPtr, GetMonIconTiles, GetMonSpritePalFromSpeciesAndPersonality,
  GetMovingItemName, GetSpriteTileStartByTag, GetStringCenterAlignXOffset, GetStringWidth,
  GetTextWindowPalette, GetValidMonIconPalIndex, GetWaldaWallpaperColorsPtr, GetWindowAttribute,
  GoToBagMenu, HandleMonMarkingsMenuInput, HideBg, IndexOfSpritePaletteTag,
  InitBgsFromTemplates, InitMenuInUpperLeftCornerNormal, InitMonMarkingsMenu, InitSpriteAffineAnim,
  InitWindows, IsComputerScreenCloseEffectActive, IsComputerScreenOpenEffectActive, IsDma3ManagerBusyWithBgCopy,
  IsWeatherNotFadingIn, ItemIsMail, JOY_HELD, JOY_NEW,
  JOY_REPEAT, LZ77UnCompVram, LZ77UnCompWram, LoadBgTiles,
  LoadCompressedSpriteSheet, LoadMessageBoxAndBorderGfx, LoadMonIconPalettes, LoadOam,
  LoadPalette, LoadSpecialPokePic, LoadSpritePalette, LoadSpritePalettes,
  LoadSpriteSheet, LoadSpriteSheets, LoadUserWindowBorderGfx, LockPlayerFieldControls,
  Menu_GetCursorPos, Menu_MoveCursor, Menu_MoveCursorNoWrapAround, Menu_ProcessInput,
  Menu_ProcessInputNoWrapClearOnChoose, OBJ_PLTT_ID, OpenMonMarkingsMenu, PIXEL_FILL,
  PLTT_SIZEOF, PlaySE, PrintMenuTable, ProcessSpriteCopyRequests,
  PutWindowTilemap, Q_8_8, RemoveBagItem, RemoveWindow,
  RequestDma3Fill, ResetPaletteFade, ResetSpriteData, ResetTasks,
  RunTasks, SPRITE_SHAPE, SPRITE_SIZE, SWAP,
  ScheduleBgCopyTilemapToVram, ScriptContext_Enable, SetBgAttribute, SetBgTilemapBuffer,
  SetBoxMonData, SetGpuReg, SetGpuRegBits, SetMainCallback2,
  SetMonData, SetVBlankCallback, ShowBg, ShowPokemonSummaryScreen,
  ShowPokemonSummaryScreenHandleDeoxys, StartSpriteAffineAnim, StartSpriteAnim, StartSpriteAnimIfDifferent,
  StringAppend, StringCopy, StringCopyPadded, StringFill,
  StringGet_Nickname, StringLength, TRY_FREE_AND_SET_NULL, TransferPlttBuffer,
  TryLoadAllMonIconPalettesAtOffset, UnlockPlayerFieldControls, UpdateMonMarkingTiles, UpdatePaletteFade,
  VarSet, WriteSequenceToBgTilemapBuffer, ZeroBoxMonData, ZeroMonData,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
