...
export function AnimLightning(...args: any[]): any {
...
export function AnimLightning_Step(...args: any[]): any {
  if (sprite.animEnded)
          DestroyAnimSprite(sprite);
}

/** static void AnimUnusedSpinningFist(struct Sprite *sprite) */
export function AnimUnusedSpinningFist(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
          sprite.x -= gBattleAnimArgs[0];
      else
          sprite.x += gBattleAnimArgs[0];
...
export function AnimUnusedSpinningFist_Step(...args: any[]): any {
  if (sprite.affineAnimEnded)
          DestroySpriteAndMatrix(sprite);
}

/** static void AnimUnusedCirclingShock(struct Sprite *sprite) */
export function AnimUnusedCirclingShock(...args: any[]): any {
...
export function AnimSparkElectricity(...args: any[]): any {
...
export function AnimZapCannonSpark(...args: any[]): any {
...
export function AnimZapCannonSpark_Step(...args: any[]): any {
...
export function AnimThunderboltOrb_Step(...args: any[]): any {
  if (--sprite.data[5] == -1)
      {
          sprite.invisible ^= 1;
...
export function AnimThunderboltOrb(...args: any[]): any {
...
export function AnimSparkElectricityFlashing(...args: any[]): any {
  let battler: any = null;
...
export function AnimSparkElectricityFlashing_Step(...args: any[]): any {
  sprite.x2 = Sin(sprite.data[7], sprite.data[5]);
      sprite.y2 = Cos(sprite.data[7], sprite.data[5]);
...
export function AnimElectricity(...args: any[]): any {
...
export function AnimTask_ElectricBolt(...args: any[]): any {
...
export function AnimTask_ElectricBolt_Step(...args: any[]): any {
  let r8: any = null;
      let r2: any = null;
      let r12: any = null;
      let spriteId = 0;
      let r7 = 0;
      let sp = gTasks[taskId].data[2];
      let x = gTasks[taskId].data[0];
      let y = gTasks[taskId].data[1];
...
export function AnimElectricBoltSegment(...args: any[]): any {
  if (!sprite.data[0])
      {
...
export function AnimThunderWave(...args: any[]): any {
...
export function AnimThunderWave_Step(...args: any[]): any {
  if (++sprite.data[0] == 3)
      {
          sprite.data[0] = 0;
          sprite.invisible ^= 1;
...
export function AnimTask_ElectricChargingParticles(...args: any[]): any {
...
export function AnimTask_ElectricChargingParticles_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimElectricChargingParticles_Step(...args: any[]): any {
  if (AnimTranslateLinear(sprite))
      {
...
export function AnimElectricChargingParticles(...args: any[]): any {
  StartSpriteAnim(sprite, 1);
      sprite.callback = AnimElectricChargingParticles_Step;
}

/** static void AnimGrowingChargeOrb(struct Sprite *sprite) */
export function AnimGrowingChargeOrb(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
...
export function AnimElectricPuff(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
          sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
          sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimVoltTackleOrbSlide(...args: any[]): any {
...
export function AnimVoltTackleOrbSlide_Step(...args: any[]): any {
...
export function AnimTask_VoltTackleAttackerReappear(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_VoltTackleBolt(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateVoltTackleBolt(...args: any[]): any {
  let spriteId = CreateSprite(gVoltTackleBoltSpriteTemplate, task.data[3], task.data[5], 35);
      if (spriteId != MAX_SPRITES)
      {
...
export function AnimVoltTackleBolt(...args: any[]): any {
  if (++sprite.data[0] > 12)
      {
...
export function AnimGrowingShockWaveOrb(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
          sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
...
export function AnimTask_ShockWaveProgressingBolt(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateShockWaveBoltSprite(...args: any[]): any {
  let spriteId = CreateSprite(gShockWaveProgressingBoltSpriteTemplate, task.data[6], task.data[7], 35);
      if (spriteId != MAX_SPRITES)
      {
...
export function AnimShockWaveProgressingBolt(...args: any[]): any {
  if (++sprite.data[0] > 12)
      {
          gTasks[sprite.data[6]].data[sprite.data[7]]--;
          DestroySprite(sprite);
...
export function AnimTask_ShockWaveLightning(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateShockWaveLightningSprite(...args: any[]): any {
  let spriteId = CreateSprite(gLightningSpriteTemplate, task.data[13], task.data[14], task.data[12]);
...
export function AnimShockWaveLightning(...args: any[]): any {
  if (sprite.animEnded)
      {
          gTasks[sprite.data[6]].data[sprite.data[7]]--;
          DestroySprite(sprite);
