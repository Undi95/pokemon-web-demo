...
const {
  ARRAY_COUNT, AddContestTextPrinter, AddTextPrinter, AddTextPrinterParameterized3,
  AddWindow, AllocContestResults, AllocZeroed, AllocateMonSpritesGfx,
  AnimateSprites, BG_CHAR_ADDR, BG_PLTT_ID, BeginHardwarePaletteFade,
  BeginNormalPaletteFade, BlendPalette, BlendPalettes, BounceMonIconInBox,
  BravoTrainerPokemonProfile_BeforeInterview2, BufferContestantMonNickname, BufferContestantMonSpecies, BufferContestantTrainerName,
  BuildOamBuffer, CalculateContestantsResultData, CalculateRound1Points, ClearContinueGameWarpStatus2,
  ClearToTransparentAndRemoveWindow, ConvertInternationalContestantName, CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer,
  CopyToBgTilemapBufferRect, CopyToBgTilemapBufferRect_ChangePalette, CpuCopy32, CpuFill32,
  CreateContestMonFromParty, CreateResultsTextWindowSprites, CreateSprite, CreateTask,
  CreateWindowFromRect, CreateWirelessStatusIndicatorSprite, DeactivateAllTextPrinters, DestroySprite,
  DestroyTask, DestroyWirelessStatusIndicatorSprite, DoMonFrontSpriteAnimation, DrawResultsTextWindow,
  EndTextBoxSlideOut, FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  FindTaskIdByFunc, FreeAllSpritePalettes, FreeAllWindowBuffers, FreeContestResults,
  FreeMonSpritesGfx, FreeOamMatrix, FreeSpritePaletteByTag, GET_CONTEST_WINNER_ID,
  GetContestEntryEligibility, GetContestWinnerSaveIdx, GetIconSpecies, GetMonData,
  GetMonIconPtr, GetMonSpritePalStructFromOtIdPersonality, GetMultiplayerId, GetNumPreliminaryPoints,
  GetNumRound2Points, GetObjectEventIdByLocalIdAndMap, GetRibbonCount, GetSetPokedexFlag,
  GetSpritePaletteTagByPaletteNum, GetStringWidth, GetWindowAttribute, HandleLoadSpecialPokePic_2,
  HandleLoadSpecialPokePic_DontHandleDeoxys, HideLinkResultsTextBox, ISO_RANDOMIZE1, IncrementGameStat,
  InitBgsFromTemplates, InitContestResultsDisplay, InitWindows, InterviewAfter,
  InterviewBefore, IsLinkTaskFinished, JOY_NEW, LZDecompressVram,
  LinkContest_GetLeaderIndex, LoadAllContestMonIconPalettes, LoadAllContestMonIcons, LoadAllContestMonNames,
  LoadCompressedPalette, LoadCompressedSpritePalette, LoadCompressedSpriteSheet, LoadContestMonIcon,
  LoadContestMonName, LoadContestResultsBgGfx, LoadContestResultsTitleBarTilemaps, LoadOam,
  LoadPalette, LoadSpritePalette, LoadSpriteSheet, LoadWirelessStatusIndicatorSpriteGfx,
  LockPlayerFieldControls, OBJ_PLTT_ID, PIXEL_FILL, PlayBGM,
  PlayCry_Normal, PlaySE, ProcessSpriteCopyRequests, PutWindowTilemap,
  Random, RemoveWindow, RequestDma3Copy, RequestDma3Fill,
  ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData, ResetTasks,
  RunTasks, SWAP, SaveContestWinner, SaveLinkContestResults,
  ScanlineEffect_Clear, ScanlineEffect_InitHBlankDmaTransfer, ScriptContext_Enable, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetContestants, SetContinueGameWarpStatusToDynamicWarp, SetDynamicWarp,
  SetGpuReg, SetGpuRegBits, SetLinkStandbyCallback, SetMainCallback2,
  SetMonData, SetMultiuseSpriteTemplateToPokemon, SetStandardWindowBorderStyle, SetTaskFuncWithFollowupFunc,
  SetVBlankCallback, ShowBg, ShowLinkResultsTextBox, Sin,
  SortContestants, SpeciesToNationalPokedexNum, StartTextBoxSlideIn, StartTextBoxSlideOut,
  StringAppend, StringCopy, StringExpandPlaceholders, StringGet_Nickname,
  TransferPlttBuffer, TryCreateWirelessSprites, TryGainNewFanFromCounter, TryPutSpotTheCutiesOnAir,
  TrySavingData, UnlockPlayerFieldControls, UpdateContestResultBars, UpdatePaletteFade,
