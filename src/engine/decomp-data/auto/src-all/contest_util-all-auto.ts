...
const {
  ...
  DISPLAY_HEIGHT, DeactivateAllTextPrinters, DestroySprite, DestroyTask,
  DestroyWirelessStatusIndicatorSprite, DoMonFrontSpriteAnimation, FALSE, FREE_AND_SET_NULL,
  ...
  LoadWirelessStatusIndicatorSpriteGfx, LockPlayerFieldControls, NULL, OBJ_PLTT_ID,
  PALETTES_ALL, PALETTES_BG, PIXEL_FILL, PLTT_SIZE_4BPP,
  ...
  RemoveWindow, RequestDma3Copy, RequestDma3Fill, ResetBgsAndClearDma3BusyFlags,
  ResetPaletteFade, ResetSpriteData, ResetTasks, RunTasks,
  ST_OAM_OBJ_WINDOW, SWAP, SaveContestWinner, SaveLinkContestResults,
  ...
  SetVBlankCallback, ShowBg, Sin, SortContestants,
