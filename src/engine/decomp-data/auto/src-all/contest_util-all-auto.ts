...
export function LoadContestMonName(...args: any[]): any {
  let mon: any = gContestMons[monIndex];
      let str = gDisplayedStringBattle;
...
export function Task_ShowContestResults(...args: any[]): any {
  let var: any = null;
...
export function Task_WaitForLinkPartnersBeforeResults(...args: any[]): any {
...
export function Task_CommunicateMonIdxsForResults(...args: any[]): any {
...
export function Task_WaitForLinkPartnerMonIdxs(...args: any[]): any {
  if (IsLinkTaskFinished())
      {
          DestroyTask(taskId);
...
export function Task_AnnouncePreliminaryResults(...args: any[]): any {
  let x: any = null;
...
export function Task_ShowPreliminaryResults(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
...
export function Task_AnnounceRound2Results(...args: any[]): any {
  let x: any = null;
...
export function Task_ShowRound2Results(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
          if (!sContestResults.data.pointsFlashing)
...
export function Task_AnnounceWinner(...args: any[]): any {
  let i: any = null;
      switch (gTasks[taskId].tState)
      {
      case 0:
      ...
      case 2:
          for (i = 0; i < CONTESTANT_COUNT; i++)
          {
              let newTaskId = CreateTask(Task_DrawFinalStandingNumber, 10);
...
export function Task_ShowWinnerMonBanner(...args: any[]): any {
  let i: any = null;
...
export function Task_SetSeenWinnerMon(...args: any[]): any {
...
export function Task_TryDisconnectLinkPartners(...args: any[]): any {
  if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_LINK)
      {
...
export function Task_WaitForLinkPartnersDisconnect(...args: any[]): any {
  if (!gReceivedRemoteLinkPlayers)
      {
          if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_WIRELESS)
...
export function Task_TrySetContestInterviewData(...args: any[]): any {
  if (!(gLinkContestFlags & LINK_CONTEST_FLAG_IS_LINK))
...
export function Task_EndShowContestResults(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_SlideContestResultsBg(...args: any[]): any {
  gBattle_BG3_X += 2;
      gBattle_BG3_Y += 1;
...
export function Task_FlashStarsAndHearts(...args: any[]): any {
...
export function LoadContestMonIcon(...args: any[]): any {
...
export function LoadAllContestMonIcons(...args: any[]): any {
  let i: any = null;
...
export function DrawResultsTextWindow(...args: any[]): any {
...
export function StartTextBoxSlideIn(...args: any[]): any {
...
export function StartTextBoxSlideOut(...args: any[]): any {
  let sprite: any = gSprites[sContestResults.data.slidingTextBoxSpriteId];
      sprite.x += sprite.x2;
      sprite.y += sprite.y2;
      sprite.y2 = 0;
...
export function EndTextBoxSlideOut(...args: any[]): any {
  sprite.x = TEXT_BOX_X;
      sprite.y = TEXT_BOX_Y;
      sprite.y2 = 0;
      sprite.x2 = 0;
...
export function SpriteCB_TextBoxSlideIn(...args: any[]): any {
  let i: any = null;

      let delta = sprite.sDistance + sprite.sSlideIncrement;
      sprite.x -= delta >> 8;
...
export function SpriteCB_EndTextBoxSlideIn(...args: any[]): any {
...
export function SpriteCB_TextBoxSlideOut(...args: any[]): any {
  let i: any = null;
      let delta: any = null;
...
export function ShowLinkResultsTextBox(...args: any[]): any {
  let i: any = null;
      let x: any = null;
      let sprite: any = null;
...
export function GetNumPreliminaryPoints(...args: any[]): any {
  let condition = gContestMonRound1Points[monIndex] << 16;
      let numStars = condition / 0x3F;
...
export function GetNumRound2Points(...args: any[]): any {
  let r4, numHearts;
...
export function Task_DrawFinalStandingNumber(...args: any[]): any {
...
export function Task_StartHighlightWinnersBox(...args: any[]): any {
  let i: any = null;
      GET_CONTEST_WINNER_ID(i);
...
export function Task_HighlightWinnersBox(...args: any[]): any {
  if (++gTasks[taskId].data[11] == 1)
      {
...
export function SpriteCB_WinnerMonSlideIn(...args: any[]): any {
  if (sprite.data[0] < 10)
      {
          if (++sprite.data[0] == 10)
          {
...
export function SpriteCB_WinnerMonSlideOut(...args: any[]): any {
  let delta = sprite.data[1] + 0x600;
      sprite.x -= delta >> 8;
      sprite.data[1] += + 0x600;
      sprite.data[1] &= 0xFF;
...
export function Task_CreateConfetti(...args: any[]): any {
  if (++gTasks[taskId].data[0] == 5)
      {
          gTasks[taskId].data[0] = 0;
          if (sContestResults.data.confettiCount < 40)
          {
              let spriteId = CreateSprite(sSpriteTemplate_Confetti, (Random() % DISPLAY_WIDTH) - 20, 44, 5);
...
export function SpriteCB_Confetti(...args: any[]): any {
  let delta: any = null;
...
export function BounceMonIconInBox(...args: any[]): any {
  let taskId = CreateTask(Task_BounceMonIconInBox, 8);
...
export function Task_BounceMonIconInBox(...args: any[]): any {
  let monIndex = gTasks[taskId].tMonIndex;
...
export function CalculateContestantsResultData(): any {
  let i, relativePoints;
      ...
      for (i = 0; i < CONTESTANT_COUNT; i++)
      {
          ...
          {
              let barLengthPreliminary = (*sContestResults.monResults)[i].barLengthPreliminary;
              let barLengthRound2 = (*sContestResults.monResults)[i].barLengthRound2;
...
export function UpdateContestResultBars(...args: any[]): any {
  let i, taskId;
      let target: any = null;
      let numIncreasing = 0, numDecreasing = 0;

      if (!isRound2)
      {
          for (i = 0; i < CONTESTANT_COUNT; i++)
          {
              let numStars = (*sContestResults.monResults)[i].numStars;
      ...
      else
      {
          for (i = 0; i < CONTESTANT_COUNT; i++)
          {
              let numHearts = (*sContestResults.monResults)[i].numHearts;
              let tile = (*sContestResults.monResults)[i].lostPoints ? 0x60A5 : 0x60A3;
...
export function Task_UpdateContestResultBar(...args: any[]): any {
  let i: any = null;
      let minMaxReached = FALSE;
      let targetReached = FALSE;
      let monId = gTasks[taskId].tMonId;
      let target = gTasks[taskId].tTarget;
      let decreasing = gTasks[taskId].tDecreasing;
...
export function AddContestTextPrinter(...args: any[]): any {
...
export function Task_StartContest(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          DestroyTask(taskId);
...
export function Task_StartShowContestResults(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          DestroyTask(taskId);
...
export function ContestLinkTransfer(...args: any[]): any {
...
export function Task_StartCommunication(...args: any[]): any {
...
export function Task_StartCommunicateRngRS(...args: any[]): any {
...
export function Task_StartCommunicateLeaderIdsRS(...args: any[]): any {
...
export function Task_StartCommunicateCategoryRS(...args: any[]): any {
...
export function Task_LinkContest_SetUpContestRS(...args: any[]): any {
  let i: any = null;
...
export function Task_LinkContest_CalculateTurnOrderRS(...args: any[]): any {
...
export function LinkContest_GetLeaderIndex(...args: any[]): any {
  let i: any = null;
      let leaderIdx = 0;
...
export function Task_LinkContest_FinalizeConnection(...args: any[]): any {
  let i: any = null;
...
export function Task_LinkContest_Disconnect(...args: any[]): any {
  SetCloseLinkCallback();
      gTasks[taskId].func = Task_LinkContest_WaitDisconnect;
}

/** static void Task_LinkContest_WaitDisconnect(u8 taskId) */
export function Task_LinkContest_WaitDisconnect(...args: any[]): any {
  if (!gReceivedRemoteLinkPlayers)
      {
          DestroyTask(taskId);
          UnlockPlayerFieldControls();
...
export function Task_ShowContestEntryMonPic(...args: any[]): any {
...
export function Task_LinkContestWaitForConnection(...args: any[]): any {
