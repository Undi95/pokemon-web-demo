...
export function SaveWonderNews(...args: any[]): any {
...
export function ValidateWonderNews(...args: any[]): any {
  if (news.id == 0)
          return FALSE;
...
export function IsWonderNewsSameAsSaved(...args: any[]): any {
  let savedNews = (const u8 *)&gSaveBlock1Ptr.mysteryGift.news;
      let i: any = null;
...
export function SaveWonderCard(...args: any[]): any {
...
export function ValidateWonderCard(...args: any[]): any {
  if (card.flagId == 0)
          return FALSE;
...
export function DisableWonderCardSending(...args: any[]): any {
...
export function IsWonderCardFlagIDInValidRange(...args: any[]): any {
...
export function GetNumStampsInMetadata(...args: any[]): any {
  let numStamps = 0;
      let i: any = null;
      for (i = 0; i < size; i++)
      {
...
export function IsStampInMetadata(...args: any[]): any {
  let i: any = null;
...
export function ValidateStamp(...args: any[]): any {
  if (stamp[STAMP_ID] == 0)
          return FALSE;
...
export function MysteryGift_TrySaveStamp(...args: any[]): any {
  let card: any = gSaveBlock1Ptr.mysteryGift.card;
      let maxStamps = card.maxStamps;
      let i: any = null;
...
export function MysteryGift_LoadLinkGameData(...args: any[]): any {
  let i: any = null;
...
export function MysteryGift_ValidateLinkGameData(...args: any[]): any {
...
export function MysteryGift_CompareCardFlags(...args: any[]): any {
  if (data.flagId == 0)
          return HAS_NO_CARD;
...
export function MysteryGift_CheckStamps(...args: any[]): any {
  let stampsMissing = data.maxStamps - GetNumStampsInMetadata(data.cardMetadata, data.maxStamps);
...
export function MysteryGift_DoesQuestionnaireMatch(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < NUM_QUESTIONNAIRE_WORDS; i++)
      {
...
export function GetNumStampsInLinkData(...args: any[]): any {
...
export function MysteryGift_GetCardStatFromLinkData(...args: any[]): any {
  switch (stat)
      {
...
export function IncrementCardStat(...args: any[]): any {
  let card: any = gSaveBlock1Ptr.mysteryGift.card;
...
export function MysteryGift_GetCardStat(...args: any[]): any {
  switch (stat)
      {
      case CARD_STAT_BATTLES_WON:
      {
...
export function MysteryGift_TryEnableStatsByFlagId(...args: any[]): any {
  sStatsEnabled = FALSE;
      if (flagId == 0)
          return FALSE;
...
export function MysteryGift_TryIncrementStat(...args: any[]): any {
  if (sStatsEnabled)
      {
          switch (stat)
          {
...
export function RecordTrainerId(...args: any[]): any {
  let i, j;
...
export function IncrementCardStatForNewTrainer(...args: any[]): any {
