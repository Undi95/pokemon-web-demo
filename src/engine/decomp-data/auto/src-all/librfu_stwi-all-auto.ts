...
export function STWI_init_all(...args: any[]): any {
...
export function STWI_init_timer(...args: any[]): any {
...
export function STWI_set_MS_mode(...args: any[]): any {
  gSTWIStatus.msMode = mode;
}

/** u16 STWI_read_status(u8 index) */
export function STWI_read_status(...args: any[]): any {
  switch (index)
      {
      case 0:
...
export function STWI_set_Callback_M(...args: any[]): any {
  gSTWIStatus.callbackM = callbackM;
}

/** void STWI_set_Callback_S(void (*callbackS)(u16)) */
export function STWI_set_Callback_S(...args: any[]): any {
  gSTWIStatus.callbackS = callbackS;
}

/** void STWI_set_Callback_ID(void (*func)(void)) */
export function STWI_set_Callback_ID(...args: any[]): any {
...
export function STWI_send_GameConfigREQ(...args: any[]): any {
...
export function STWI_send_SystemConfigREQ(...args: any[]): any {
...
export function STWI_send_CP_StartREQ(...args: any[]): any {
...
export function STWI_send_DataTxREQ(...args: any[]): any {
  if (!STWI_init(ID_DATA_TX_REQ))
      {
          let reqLength = (size / sizeof(u32));
...
export function STWI_send_DataTxAndChangeREQ(...args: any[]): any {
...
export function STWI_send_DataReadyAndChangeREQ(...args: any[]): any {
...
export function STWI_send_DisconnectedAndChangeREQ(...args: any[]): any {
...
export function STWI_send_DisconnectREQ(...args: any[]): any {
...
export function STWI_send_TestModeREQ(...args: any[]): any {
...
export function STWI_send_CPR_StartREQ(...args: any[]): any {
...
export function STWI_set_timer(...args: any[]): any {
  let timerL = REG_TMCNT_L(gSTWIStatus.timerSelect);
      let timerH = REG_TMCNT_H(gSTWIStatus.timerSelect);
      REG_IME = 0;
      switch (count)
      {
      case 50:
...
export function STWI_init(...args: any[]): any {
  if (!REG_IME)
      {
