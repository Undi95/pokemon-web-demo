...
export function PokenavCallback_Init_ConditionGraph_Party(): any {
  let menu: any = AllocSubstruct(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU, sizeof(struct Pokenav_ConditionMenu));
...
export function HandleConditionMenuInput(...args: any[]): any {
...
export function OpenMarkingsMenu(...args: any[]): any {
  let monListPtr: any = null;
      let markings: any = null;
      let ret = CONDITION_FUNC_NONE, boxId, monId;
...
export function GetConditionReturnCallback(...args: any[]): any {
  if (!menu.inSearchMode)
...
export function ConditionGraphHandleDpadInput(...args: any[]): any {
  let monListPtr: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MON_LIST);
...
export function SwitchConditionSummaryIndex(...args: any[]): any {
...
export function LoadNextConditionMenuMonData(...args: any[]): any {
  let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU);
...
export function CopyMonNameGenderLocation(...args: any[]): any {
  let boxId, i;
      let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU);
      let monListPtr: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MON_LIST);
...
export function InitPartyConditionListParameters(): any {
  let i, count;
      let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU);
      let monListPtr: any = AllocSubstruct(POKENAV_SUBSTRUCT_MON_LIST, sizeof(struct PokenavMonList));
...
export function GetMonConditionGraphData(...args: any[]): any {
  let boxId, monId, i;
      let menu: any = GetSubstructPtr(POKENAV_SUBSTRUCT_CONDITION_GRAPH_MENU);
      let monListPtr: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MON_LIST);
...
export function ConditionGraphDrawMonPic(...args: any[]): any {
