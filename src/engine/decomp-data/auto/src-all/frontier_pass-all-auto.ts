...
export function ShowFrontierPass(...args: any[]): any {
...
export function AllocateFrontierPassData(...args: any[]): any {
  mapsec_u8_t i;
...
export function GetCursorAreaFromCoords(...args: any[]): any {
  let i: any = null;
...
export function TryCallPassAreaFunction(...args: any[]): any {
  switch (cursorArea)
      {
      case CURSOR_AREA_RECORD:
...
export function Task_HandleFrontierPassInput(...args: any[]): any {
  let var = FALSE;  
...
export function Task_PassAreaZoom(...args: any[]): any {
...
export function PrintAreaDescription(...args: any[]): any {
...
export function ShowHideZoomingArea(...args: any[]): any {
  switch (sPassData.areaToShow)
      {
      case CURSOR_AREA_MAP:
          if (show)
...
export function UpdateAreaHighlight(...args: any[]): any {
...
export function ShowFrontierMap(...args: any[]): any {
  if (sMapData != NULL)
...
export function Task_HandleFrontierMap(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MapNumToFrontierFacilityId(...args: any[]): any {
...
export function InitFrontierMapSprites(): any {
  let sprite: any = null;
      ...
      {
          let mapNum = gSaveBlock1Ptr.location.mapNum;
...
export function HandleFrontierMapCursorMove(...args: any[]): any {
  let oldCursorPos, i;
