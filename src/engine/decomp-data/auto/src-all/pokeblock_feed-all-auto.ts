...
export function LoadMonAndSceneGfx(mon: any): any {
...
export function Task_HandlePokeblockFeed(taskId: any): any {
...
export function LaunchPokeblockFeedTask(): any {
  let taskId: any = CreateTask(Task_HandlePokeblockFeed, 0);
      gTasks[taskId].tState = 0;
      gTasks[taskId].tHorizontalThrow = TRUE;
}

/** static void Task_WaitForAtePokeblockMessage(u8 taskId) */
export function Task_WaitForAtePokeblockMessage(taskId: any): any {
...
export function Task_PrintAtePokeblockMessage(taskId: any): any {
...
export function Task_ExitPokeblockFeed(taskId: any): any {
  if (!gPaletteFade.active)
      {
          ResetSpriteData();
          FreeAllSpritePalettes();
...
export function SpriteCB_MonJumpForPokeblock(sprite: any): any {
  sprite.x += 4;
...
export function CreatePokeblockCaseSpriteForFeeding(): any {
  let spriteId: any = CreatePokeblockCaseSprite(188, 100, 2);
...
export function DoPokeblockCaseThrowEffect(spriteId: any, horizontalThrow: any): any {
...
export function CreatePokeblockSprite(): any {
  let spriteId: any = CreateSprite(sSpriteTemplate_Pokeblock, 174, 84, 1);
...
export function SpriteCB_ThrownPokeblock(sprite: any): any {
  sprite.x -= 4;
      sprite.y += sprite.sSpeed;
      sprite.sSpeed += sprite.sAccel;
      if (sprite.sSpeed == 10)
...
export function DoMonAnimStep(): any {
  let time: any = sPokeblockFeed.maxAnimStageTime - sPokeblockFeed.animData[ANIMDATA_TIME];
...
export function CalculateMonAnimMovementEnd(): any {
  let pokeblockFeed: any = sPokeblockFeed;
      let i: any = null;
      let approachTime: any = pokeblockFeed.animData[ANIMDATA_APPR_TIME];
      let time: any = pokeblockFeed.maxAnimStageTime - approachTime;
      let x: any = pokeblockFeed.monX + pokeblockFeed.animData[ANIMDATA_TARGET_X];
      let y: any = pokeblockFeed.monY + pokeblockFeed.animData[ANIMDATA_TARGET_Y];

      for (i = 0; i < time - 1; i++)
      {
          let xOffset: any = pokeblockFeed.monAnimX[approachTime + i] - x;
          let yOffset: any = pokeblockFeed.monAnimY[approachTime + i] - y;
...
export function CalculateMonAnimMovement(): any {
  let pokeblockFeed: any = sPokeblockFeed;
      ...
      let x: any = pokeblockFeed.monX - pokeblockFeed.monInitX;
      let y: any = pokeblockFeed.monY - pokeblockFeed.monInitY;
