          ...
          if (IsContest())
          {
              if (IsSpeciesNotUnown(gContestResources.moveAnim.species) != IsSpeciesNotUnown(gContestResources.moveAnim.targetSpecies))
              {
                  ...
                  for (i = 0; i < 8; i++)
                  {
                      for (j = 0; j < 4; j++)
                      {
                          let temp: any = bgTilemap[j + i * 0x20];
...
export function AnimTask_RolePlaySilhouette(taskId: any): any {
  let isBackPic: any = null;
      ...
      FillPalette((RGB(31, 31, 31)), OBJ_PLTT_ID(gSprites[spriteId].oam.paletteNum), PLTT_SIZE_4BPP);
      gSprites[spriteId].oam.priority = priority;
...
export function AnimTask_SnatchOpposingMonMove(taskId: any): any {
  let spriteId, spriteId2;
      ...
      case 1:
          ...
          if (gBattleSpritesDataPtr.battlerData[gBattleAnimAttacker].transformSpecies != (0))
              BlendPalette(OBJ_PLTT_ID(gSprites[spriteId2].oam.paletteNum), 16, 6, (RGB(31, 31, 31)));
