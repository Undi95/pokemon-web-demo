...
export function AnimBlackSmoke(...args: any[]): any {
...
export function AnimBlackSmoke_Step(...args: any[]): any {
  if (sprite.data[1] > 0)
      {
...
export function AnimTask_SmokescreenImpact(...args: any[]): any {
  SmokescreenImpact(
...
export function AnimWhiteHalo(...args: any[]): any {
  sprite.data[0] = 90;
...
export function AnimWhiteHalo_Step1(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(sprite.data[1], 16 - sprite.data[1]));
      if (--sprite.data[1] < 0)
      {
...
export function AnimWhiteHalo_Step2(...args: any[]): any {
...
export function AnimTealAlert(...args: any[]): any {
  let rotation: any = null;
      let x = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2);
      let y = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimMeanLookEye(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDCNT, BLDCNT_TGT2_ALL | BLDCNT_EFFECT_BLEND);
...
export function AnimMeanLookEye_Step1(...args: any[]): any {
...
export function AnimMeanLookEye_Step2(...args: any[]): any {
  if (sprite.data[2]++ > 9)
      {
...
export function AnimMeanLookEye_Step3(...args: any[]): any {
...
export function AnimMeanLookEye_Step4(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(sprite.data[0], 16 - sprite.data[0]));
...
export function AnimTask_SetPsychicBackground(...args: any[]): any {
  gTasks[taskId].func = SetPsychicBackground_Step;
      gAnimVisualTaskCount--;
}

/** static void SetPsychicBackground_Step(u8 taskId) */
export function SetPsychicBackground_Step(...args: any[]): any {
  let i: any = null;
      let lastColor: any = null;
      let paletteIndex = GetBattleBgPaletteNum();
...
export function AnimTask_FadeScreenToWhite(...args: any[]): any {
  gTasks[taskId].func = FadeScreenToWhite_Step;
      gAnimVisualTaskCount--;
}

/** static void FadeScreenToWhite_Step(u8 taskId) */
export function FadeScreenToWhite_Step(...args: any[]): any {
  let i: any = null;
      let lastColor: any = null;
      let paletteIndex = GetBattleBgPaletteNum();
...
export function AnimSpikes(...args: any[]): any {
  let x, y;
...
export function AnimSpikes_Step1(...args: any[]): any {
...
export function AnimSpikes_Step2(...args: any[]): any {
  if (sprite.data[1] & 1)
          sprite.invisible ^= 1;
...
export function AnimLeer(...args: any[]): any {
...
export function AnimLetterZ(...args: any[]): any {
  let var0: any = null;
      if (sprite.data[0] == 0)
      {
          SetSpriteCoordsToAnimAttackerCoords(sprite);
...
export function AnimFang(...args: any[]): any {
  if (sprite.animEnded)
          DestroyAnimSprite(sprite);
}

/** void AnimTask_IsTargetPlayerSide(u8 taskId) */
export function AnimTask_IsTargetPlayerSide(...args: any[]): any {
...
export function AnimTask_IsHealingMove(...args: any[]): any {
  if (gAnimMoveDmg > 0)
          gBattleAnimArgs[ARG_RET_ID] = FALSE;
      else
          gBattleAnimArgs[ARG_RET_ID] = TRUE;
...
export function AnimSpotlight(...args: any[]): any {
...
export function AnimSpotlight_Step1(...args: any[]): any {
...
export function AnimSpotlight_Step2(...args: any[]): any {
...
export function AnimClappingHand(...args: any[]): any {
...
export function AnimClappingHand_Step(...args: any[]): any {
  if (sprite.data[2] == 0)
      {
...
export function AnimClappingHand2(...args: any[]): any {
  sprite.oam.objMode = ST_OAM_OBJ_WINDOW;
      sprite.data[3] = 255;
...
export function AnimTask_CreateSpotlight(...args: any[]): any {
  if (IsContest())
      {
...
export function AnimTask_RemoveSpotlight(...args: any[]): any {
...
export function AnimRapidSpin(...args: any[]): any {
...
export function AnimRapidSpin_Step(...args: any[]): any {
...
export function AnimTask_RapinSpinMonElevation(...args: any[]): any {
  let var0: any = null;
      let toBG2: any = null;
      let var2: any = null;
      let var3: any = null;
...
export function RapinSpinMonElevation_Step(...args: any[]): any {
  let i: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_TormentAttacker(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function TormentAttacker_Step(...args: any[]): any {
  let var0, var1;
      let x, y;
      let i, j;
...
export function TormentAttacker_Callback(...args: any[]): any {
  if (sprite.animEnded)
      {
...
export function AnimTriAttackTriangle(...args: any[]): any {
  if (sprite.data[0] == 0)
          InitSpritePosToAnimAttacker(sprite, FALSE);

      if (++sprite.data[0] < 40)
      {
          let var = sprite.data[0];
          if ((var & 1) == 0)
              sprite.invisible = TRUE;
          else
              sprite.invisible = FALSE;
...
export function AnimTask_DefenseCurlDeformMon(...args: any[]): any {
...
export function AnimBatonPassPokeball(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
...
export function AnimWishStar(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
          sprite.x = -16;
      else
...
export function AnimWishStar_Step(...args: any[]): any {
  let newX: any = null;
...
export function AnimMiniTwinklingStar(...args: any[]): any {
  let rand: any = null;
      let y: any = null;
...
export function AnimMiniTwinklingStar_Step(...args: any[]): any {
  if (++sprite.data[0] < 30)
      {
          if (++sprite.data[1] == 2)
          {
...
export function AnimTask_StockpileDeformMon(...args: any[]): any {
...
export function AnimTask_SpitUpDeformMon(...args: any[]): any {
  if (!gTasks[taskId].data[0])
      {
...
export function AnimSwallowBlueOrb(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
          InitSpritePosToAnimAttacker(sprite, FALSE);
...
export function AnimTask_SwallowDeformMon(...args: any[]): any {
  if (!gTasks[taskId].data[0])
      {
...
export function AnimTask_TransformMon(...args: any[]): any {
  let i, j;
...
export function AnimTask_IsMonInvisible(...args: any[]): any {
...
export function AnimTask_CastformGfxDataChange(...args: any[]): any {
  HandleSpeciesGfxDataChange(gBattleAnimAttacker, gBattleAnimTarget, TRUE);
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_MorningSunLightBeam(u8 taskId) */
export function AnimTask_MorningSunLightBeam(...args: any[]): any {
  let animBg: any = null;
...
export function AnimGreenStar(...args: any[]): any {
...
export function AnimGreenStar_Step1(...args: any[]): any {
  let delta = sprite.data[3] + sprite.data[2];
      sprite.y2 -= delta >> 8;
...
export function AnimGreenStar_Step2(...args: any[]): any {
...
export function AnimGreenStar_Callback(...args: any[]): any {
  if (!sprite.invisible)
      {
          let delta = sprite.data[3] + sprite.data[2];
          sprite.y2 -= delta >> 8;
...
export function AnimTask_DoomDesireLightBeam(...args: any[]): any {
  let animBg: any = null;
      ...
      case 0:
          ...
          {
              let position = GetBattlerPosition(gBattleAnimTarget);
...
export function AnimTask_StrongFrustrationGrowAndShrink(...args: any[]): any {
...
export function AnimWeakFrustrationAngerMark(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          InitSpritePosToAnimAttacker(sprite, FALSE);
          sprite.data[0]++;
...
export function AnimTask_RockMonBackAndForth(...args: any[]): any {
  let side: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_RockMonBackAndForth_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimSweetScentPetal(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
      {
          sprite.x = 0;
...
export function AnimSweetScentPetal_Step(...args: any[]): any {
  sprite.data[0] += 3;
      if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
      {
          sprite.x += 5;
...
export function AnimTask_FlailMovement(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_FlailMovement_Step(...args: any[]): any {
  let temp: any = null;
      let task: any = gTasks[taskId];
      ...
      case 0:
          ...
          {
              let diff = task.data[14] - task.data[2];
              let div = diff / (task.data[14] * 2);
              let mod = diff % (task.data[14] * 2);
...
export function AnimPainSplitProjectile(...args: any[]): any {
  if (!sprite.data[0])
      {
...
export function AnimTask_PainSplitMovement(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimFlatterConfetti(...args: any[]): any {
...
export function AnimFlatterConfetti_Step(...args: any[]): any {
  if (sprite.data[2] == 0)
      {
...
export function AnimFlatterSpotlight(...args: any[]): any {
  SetGpuReg(REG_OFFSET_WINOUT, WINOUT_WIN01_BG_ALL | WINOUT_WIN01_OBJ | WINOUT_WIN01_CLR | WINOUT_WINOBJ_BG_ALL | WINOUT_WINOBJ_OBJ);
      SetGpuRegBits(REG_OFFSET_DISPCNT, DISPCNT_OBJWIN_ON);
      gBattle_WIN0H = 0;
      gBattle_WIN0V = 0;
...
export function AnimFlatterSpotlight_Step(...args: any[]): any {
...
export function AnimReversalOrb(...args: any[]): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimReversalOrb_Step(...args: any[]): any {
...
export function AnimTask_RolePlaySilhouette(...args: any[]): any {
...
export function AnimTask_RolePlaySilhouette_Step1(...args: any[]): any {
...
export function AnimTask_RolePlaySilhouette_Step2(...args: any[]): any {
  let spriteId = gTasks[taskId].data[0];
...
export function AnimTask_AcidArmor(...args: any[]): any {
...
export function AnimTask_AcidArmor_Step(...args: any[]): any {
  let task: any = null;
      let var1: any = null;
      let var2: any = null;
      let bgX, bgY;
...
export function AnimTask_DeepInhale(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[0] = 0;
      task.data[15] = GetAnimBattlerSpriteId(gBattleAnimArgs[0]);
...
export function AnimTask_DeepInhale_Step(...args: any[]): any {
  let var0: any = null;
...
export function InitYawnCloudPosition(...args: any[]): any {
  sprite.x = startX;
      sprite.y = startY;
...
export function UpdateYawnCloudPosition(...args: any[]): any {
...
export function AnimYawnCloud(...args: any[]): any {
  let destX = sprite.x;
      let destY = sprite.y;
...
export function AnimYawnCloud_Step(...args: any[]): any {
  let index: any = null;
...
export function AnimSmokeBallEscapeCloud(...args: any[]): any {
...
export function AnimTask_SlideMonForFocusBand_Step2(...args: any[]): any {
  let var0 = 0;
      let var1 = 0;
...
export function AnimTask_SlideMonForFocusBand_Step1(...args: any[]): any {
  let var0 = 0;
      let var1 = 0;
...
export function AnimTask_SlideMonForFocusBand(...args: any[]): any {
...
export function AnimTask_SquishAndSweatDroplets(...args: any[]): any {
  let battler: any = null;
      let task: any = gTasks[taskId];
...
export function AnimTask_SquishAndSweatDroplets_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateSweatDroplets(...args: any[]): any {
  let i: any = null;
      let xOffset, yOffset;
      let task: any = null;
      const xCoords: any[] = [];
      ...
      for (i = 0; i < 4; i++)
      {
          let spriteId = CreateSprite(gFacadeSweatDropSpriteTemplate, xCoords[i], yCoords[i & 1], task.tSubpriority - 5);
          if (spriteId != MAX_SPRITES)
          {
...
export function AnimFacadeSweatDrop(...args: any[]): any {
...
export function AnimTask_FacadeColorBlend(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimTask_FacadeColorBlend_Step(...args: any[]): any {
  if (gTasks[taskId].data[1])
      {
...
export function AnimTask_StatusClearedEffect(...args: any[]): any {
...
export function AnimRoarNoiseLine(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_OPPONENT)
...
export function AnimRoarNoiseLine_Step(...args: any[]): any {
...
export function AnimTask_GlareEyeDots(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_GlareEyeDots_Step(...args: any[]): any {
  let i: any = null;
      let x, y;
      let task: any = gTasks[taskId];
      ...
      case 0:
          ...
          if (++task.tTimer > 3)
          {
              ...
              for (i = 0; i < 2; i++)
              {
                  let spriteId = CreateSprite(gGlareEyeDotSpriteTemplate, x, y, 35);
                  if (spriteId != MAX_SPRITES)
                  {
                      if (!task.tIsContest)
                      {
...
export function GetGlareEyeDotCoords(...args: any[]): any {
  let x2: any = null;
      let y2: any = null;
...
export function AnimGlareEyeDot(...args: any[]): any {
  if (++sprite.sTimer > 36)
      {
          gTasks[sprite.sTaskId].data[sprite.sActiveSpritesIdx]--;
          DestroySprite(sprite);
...
export function AnimAssistPawprint(...args: any[]): any {
  sprite.x = gBattleAnimArgs[0];
      sprite.y = gBattleAnimArgs[1];
      sprite.data[2] = gBattleAnimArgs[2];
      sprite.data[4] = gBattleAnimArgs[3];
...
export function AnimTask_BarrageBall(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_BarrageBall_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimSmellingSaltsHand(...args: any[]): any {
  let battler: any = null;
...
export function AnimSmellingSaltsHand_Step(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
          if (++sprite.data[1] > 1)
...
export function AnimTask_SmellingSaltsSquish(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
          DestroyAnimVisualTask(taskId);
      }
...
export function AnimTask_SmellingSaltsSquish_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimSmellingSaltExclamation(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
          sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
...
export function AnimSmellingSaltExclamation_Step(...args: any[]): any {
...
export function AnimHelpingHandClap(...args: any[]): any {
  if (gBattleAnimArgs[0] == 0)
      {
          sprite.oam.matrixNum |= ST_OAM_HFLIP;
          sprite.x = 100;
...
export function AnimHelpingHandClap_Step(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
...
export function AnimTask_HelpingHandAttackerMovement(...args: any[]): any {
  let task: any = gTasks[taskId];
      ...
      if (!IsContest())
      {
          if (IsDoubleBattle() == TRUE)
          {
              ...
              let partnerX = GetBattlerSpriteCoord(BATTLE_PARTNER(gBattleAnimAttacker), BATTLER_COORD_X);
...
export function AnimTask_HelpingHandAttackerMovement_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimForesightMagnifyingGlass(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
          InitSpritePosToAnimAttacker(sprite, TRUE);
...
export function AnimForesightMagnifyingGlass_Step(...args: any[]): any {
  let x, y;
...
export function AnimMeteorMashStar_Step(...args: any[]): any {
...
export function AnimMeteorMashStar(...args: any[]): any {
  let y = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2);
      let x = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimTask_MonToSubstitute(...args: any[]): any {
  let i: any = null;
      let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
...
export function AnimTask_MonToSubstituteDoll(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
...
export function AnimBlockX(...args: any[]): any {
  let y: any = null;
...
export function AnimBlockX_Step(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
          sprite.y2 += 10;
...
export function AnimTask_OdorSleuthMovement(...args: any[]): any {
...
export function AnimTask_OdorSleuthMovementWaitFinish(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
          DestroyAnimVisualTask(taskId);
}

/** static void MoveOdorSleuthClone(struct Sprite *sprite) */
export function MoveOdorSleuthClone(...args: any[]): any {
  if (++sprite.data[1] > 1)
      {
          sprite.data[1] = 0;
          if (!gBattleSpritesDataPtr.battlerData[gBattleAnimTarget].invisible)
...
export function AnimTask_GetReturnPowerLevel(...args: any[]): any {
...
export function AnimTask_SnatchOpposingMonMove(...args: any[]): any {
...
export function AnimUnusedItemBagSteal(...args: any[]): any {
...
export function AnimTask_SnatchPartnerMove(...args: any[]): any {
...
export function AnimTask_TeeterDanceMovement(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_TeeterDanceMovement_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.data[0])
      {
      case 0:
...
export function AnimKnockOffStrike_Step(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimTarget) == B_SIDE_PLAYER)
      {
...
export function AnimKnockOffStrike(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimTarget) == B_SIDE_PLAYER)
      {
          sprite.x -= gBattleAnimArgs[0];
          sprite.y += gBattleAnimArgs[1];
...
export function AnimRecycle(...args: any[]): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoordAttr(gBattleAnimAttacker, BATTLER_COORD_ATTR_TOP);
      if (sprite.y < 16)
          sprite.y = 16;
...
export function AnimRecycle_Step(...args: any[]): any {
...
export function AnimTask_GetWeather(...args: any[]): any {
...
export function AnimTask_SlackOffSquish(...args: any[]): any {
  let task: any = gTasks[taskId];
      task.data[0] = 0;
      task.data[15] = GetAnimBattlerSpriteId(gBattleAnimArgs[0]);
...
export function AnimTask_SlackOffSquish_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
