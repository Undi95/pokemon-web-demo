...
export function AllocateBattleResources(): any {
  if (gBattleResources != NULL) {
      ...
      {
          let currSecretBaseId = VarGet(VAR_CURRENT_SECRET_BASE);
...
export function AdjustFriendshipOnBattleFaint(...args: any[]): any {
...
export function SwitchPartyOrderInGameMulti(...args: any[]): any {
...
export function BattlePalace_TryEscapeStatus(...args: any[]): any {
  let effect = 0;
