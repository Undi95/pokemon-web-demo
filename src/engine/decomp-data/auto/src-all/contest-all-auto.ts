...
const {
  ...
  BLDALPHA_BLEND, BeginFastPaletteFade, BeginNormalPaletteFade, BlendPalette,
  BravoTrainerPokemonProfile_BeforeInterview1, BuildOamBuffer, ClearBattleAnimationVars, ClearBattleMonForms,
  ContestAI_GetActionToUse, ContestAI_ResetAI, ContestLiveUpdates_Init, ContestLiveUpdates_SetLoserData,
  ContestLiveUpdates_SetRound2Placing, ContestLiveUpdates_SetWinnerAppealFlag, ContestLiveUpdates_SetWinnerMoveUsed, Contest_CopyStringWithColor,
  ConvertIntToDecimalStringN, ConvertInternationalString, CopyBgTilemapBufferToVram, CopySpriteTiles,
  CopyToBgTilemapBuffer, CopyWindowToVram, CpuCopy16, CpuCopy32,
  CpuFill32, CreateInvisibleSpriteWithCallback, CreateSprite, CreateTask,
  CreateWirelessStatusIndicatorSprite, DeactivateAllTextPrinters, DestroySprite, DestroySpriteAndFreeResources,
  DestroyTask, DmaCopy16Defvars, DmaCopy32Defvars, DmaCopyLarge32,
  DoMoveAnim, FREE_AND_SET_NULL, FillPalette, FillWindowPixelBuffer,
  ...
  LoadSpriteSheet, LoadWirelessStatusIndicatorSpriteGfx, OBJ_PLTT_ID, PIXEL_FILL,
  PLTT_ID, PLTT_SIZEOF, PlayFanfare, PlaySE,
  PlaySE12WithPanning, ProcessSpriteCopyRequests, PutWindowTilemap, Random,
  RequestDma3Copy, RequestDma3Fill, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade,
  ResetSpriteData, ResetTasks, RunTasks, RunTextPrinters,
  SWAP, ScanlineEffect_Clear, ScanlineEffect_InitHBlankDmaTransfer, ScriptContext_Enable,
  SetBackdropFromColor, SetBgAttribute, SetBgTilemapBuffer, SetGpuReg,
  SetGpuRegBits, SetLinkStandbyCallback, SetMainCallback2, SetMultiuseSpriteTemplateToPokemon,
  SetSubspriteTables, SetTaskFuncWithFollowupFunc, SetVBlankCallback, ShowBg,
  StartSpriteAffineAnim, StringAppend, StringCopy, StringExpandPlaceholders,
  StringGet_Nickname, StringLength, StripExtCtrlCodes, TransferPlttBuffer,
  UnlockPlayerFieldControls, UpdatePaletteFade, WriteSequenceToBgTilemapBuffer,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
