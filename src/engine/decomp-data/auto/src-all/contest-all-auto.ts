...
const {
  ALIGNED, ARRAY_COUNT, AddTextPrinter, AllocContestResources,
  AllocOamMatrix, AllocZeroed, AllocateMonSpritesGfx, AnimateAudience,
  AnimateSliderHearts, AnimateSprite, AnimateSprites, ApplyNextTurnOrder,
  AreMovesContestCombo, BG_CHAR_ADDR, BG_PLTT_ID, BG_SCREEN_ADDR,
  BLDALPHA_BLEND, BeginFastPaletteFade, BeginNormalPaletteFade, BlendAudienceBackground,
  BlendPalette, BlinkContestantBox, BravoTrainerPokemonProfile_BeforeInterview1, BuildOamBuffer,
  CalculateAppealMoveImpact, CalculateContestLiveUpdateData, CalculateContestantRound1Points, CalculateFinalScores,
  CalculateTotalPointsForContestant, ClearBattleAnimationVars, ClearBattleMonForms, ClearMoveAnimData,
  ContestAI_GetActionToUse, ContestAI_ResetAI, ContestBG_FillBoxWithIncrementingTile, ContestBG_FillBoxWithTile,
  ContestClearGeneralTextWindow, ContestDebugDoPrint, ContestDebugPrintBitStrings, ContestLiveUpdates_Init,
  ...
  ContestPrintLinkStandby, Contest_CopyStringWithColor, Contest_GetMoveExcitement, Contest_IsMonsTurnDisabled,
  Contest_PrintTextToBg0WindowAt, Contest_PrintTextToBg0WindowStd, Contest_RunTextPrinters, Contest_SetBgCopyFlags,
  Contest_StartTextPrinter, ContestantCanUseTurn, ConvertIntToDecimalStringN, ConvertInternationalString,
  CopyBgTilemapBufferToVram, CopySpriteTiles, CopyToBgTilemapBuffer, CopyWindowToVram,
  CpuCopy16, CpuCopy32, CpuFill32, CreateApplauseMeterSprite,
  CreateContestMonFromParty, CreateContestantBoxBlinkSprites, CreateContestantSprite, CreateInvisibleBattleTargetSprite,
  CreateInvisibleSpriteWithCallback, CreateJudgeAttentionEyeTask, CreateJudgeSpeechBubbleSprite, CreateJudgeSprite,
  CreateNextTurnSprites, CreateSliderHeartSprites, CreateSprite, CreateTask,
  CreateUnusedBlendTask, CreateWirelessStatusIndicatorSprite, DeactivateAllTextPrinters, DestroyContestantBoxBlinkSprites,
  DestroySprite, DestroySpriteAndFreeResources, DestroyTask, DetermineFinalStandings,
  DidContestantPlaceHigher, DmaCopy16Defvars, DmaCopy32Defvars, DmaCopyLarge32,
  DoJudgeSpeechBubble, DoMoveAnim, DrawConditionStars, DrawContestantWindowText,
  DrawContestantWindows, DrawMoveSelectArrow, DrawStatusSymbol, DrawStatusSymbols,
  DrawUnnervedSymbols, EraseMoveSelectArrow, FREE_AND_SET_NULL, FillContestantWindowBgs,
  FillPalette, FillWindowPixelBuffer, FlagGet, FreeAllSpritePalettes,
  FreeAllWindowBuffers, FreeContestResources, FreeMonSpritesGfx, FreeSpriteOamMatrix,
  GetAllChosenMoves, GetAppealHeartTileOffset, GetBattlerSpriteCoord, GetBattlerSpriteFinal_Y,
  GetBattlerSpriteSubpriority, GetChosenMove, GetContestRand, GetContestWinnerSaveIdx,
  GetContestantRound2Points, GetGpuReg, GetMonData, GetMonNicknameLanguage,
  GetMonSpritePalFromSpeciesAndPersonality, GetMoveEffectSymbolTileOffset, GetMultiplayerId, GetNumHeartsFromAppealPoints,
  GetPlayerTextSpeedDelay, GetStarTileOffset, GetStatusSymbolTileOffset, GetStringRightAlignXOffset,
  GetTurnOrderNumberGfx, HandleLoadSpecialPokePic_2, HandleLoadSpecialPokePic_DontHandleDeoxys, IndexOfSpritePaletteTag,
  InitBgsFromTemplates, InitContestInfoBgs, InitContestResources, InitContestWindows,
  InitSpriteAffineAnim, InitUnusedBlendTaskData, InitWindows, IsContestantAllowedToCombo,
  IsLinkTaskFinished, IsPlayerLinkLeader, IsSpeciesNotUnown, IsTextPrinterActive,
  JOY_NEW, LZDecompressVram, LoadCompressedPalette, LoadCompressedSpritePalette,
  LoadCompressedSpriteSheet, LoadContestPalettes, LoadOam, LoadPalette,
  LoadSpritePalette, LoadSpriteSheet, LoadWirelessStatusIndicatorSpriteGfx, OBJ_PLTT_ID,
  PIXEL_FILL, PLTT_ID, PLTT_SIZEOF, PlayFanfare,
  PlaySE, PlaySE12WithPanning, PrintAppealMoveResultText, PrintContestMoveDescription,
  PrintContestantMonName, PrintContestantMonNameWithColor, PrintContestantTrainerName, PrintContestantTrainerNameWithColor,
  ProcessSpriteCopyRequests, PutWindowTilemap, Random, RankContestants,
  RequestDma3Copy, RequestDma3Fill, ResetBgsAndClearDma3BusyFlags, ResetBlendForContestantBoxBlink,
  ResetPaletteFade, ResetSpriteData, ResetTasks, RunTasks,
  RunTextPrinters, SWAP, SanitizeMove, SanitizeSpecies,
  ScanlineEffect_Clear, ScanlineEffect_InitHBlankDmaTransfer, ScriptContext_Enable, SetAttentionLevels,
  SetBackdropFromColor, SetBattleTargetSpritePosition, SetBgAttribute, SetBgForCurtainDrop,
  SetBgTilemapBuffer, SetBlendForContestantBoxBlink, SetBottomSliderHeartsInvisibility, SetConestLiveUpdateTVData,
  SetContestLiveUpdateFlags, SetContestantEffectStringID, SetContestantStatusesForNextRound, SetGpuReg,
  SetGpuRegBits, SetLinkStandbyCallback, SetMainCallback2, SetMoveAnimAttackerData,
  SetMoveSpecificAnimData, SetMoveTargetPosition, SetMultiuseSpriteTemplateToPokemon, SetSubspriteTables,
  SetTaskFuncWithFollowupFunc, SetVBlankCallback, SetupContestGpuRegs, SetupContestGraphics,
  ShowAndUpdateApplauseMeter, ShowBg, ShowHideNextTurnGfx, SlideApplauseMeterIn,
  SlideApplauseMeterOut, SlidersDoneUpdating, SortContestants, StartApplauseOverflowAnimation,
  StartFlashJudgeAttentionEye, StartSpriteAffineAnim, StartStopFlashJudgeAttentionEye, StopFlashJudgeAttentionEye,
  StringAppend, StringCopy, StringExpandPlaceholders, StringGet_Nickname,
  StringLength, StripExtCtrlCodes, StripMonNameForLinkContest, StripPlayerNameForLinkContest,
  SwapMoveDescAndContestTilemaps, TransferPlttBuffer, TryPutPlayerLast, UnlockPlayerFieldControls,
  UpdateAppealHearts, UpdateApplauseMeter, UpdateBlendTaskContestantData, UpdateBlendTaskContestantsData,
  UpdateConditionStars, UpdateContestantBoxOrder, UpdateHeartSlider, UpdateHeartSliders,
  UpdatePaletteFade, UpdateSliderHeartSpriteYPositions, WriteSequenceToBgTilemapBuffer,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
