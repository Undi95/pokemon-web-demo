...
export function Task_StartContestWaitFade(...args: any[]): any {
...
export function Task_TryStartLinkContest(...args: any[]): any {
  if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_LINK)
      {
          if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_WIRELESS)
          {
...
export function Task_CommunicateMonIdxs(...args: any[]): any {
...
export function Task_EndCommunicateMonIdxs(...args: any[]): any {
  gTasks[taskId].data[0] = 1;
      gTasks[taskId].func = Task_ReadyStartLinkContest;
}

/** static void Task_ReadyStartLinkContest(u8 taskId) */
export function Task_ReadyStartLinkContest(...args: any[]): any {
  gTasks[taskId].data[0]--;
...
export function SetupContestGraphics(...args: any[]): any {
...
export function Task_WaitToRaiseCurtainAtStart(...args: any[]): any {
  gPaletteFade.bufferTransferDisabled = FALSE;
      if (!gPaletteFade.active)
      {
          gTasks[taskId].data[0] = 0;
...
export function Task_RaiseCurtainAtStart(...args: any[]): any {
  switch (gTasks[taskId].data[0])
      {
      case 0:
...
export function Task_DisplayAppealNumberText(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
      {
          gBattle_BG0_Y = 0;
          gBattle_BG2_Y = 0;
...
export function Task_TryShowMoveSelectScreen(...args: any[]): any {
...
export function Task_ShowMoveSelectScreen(...args: any[]): any {
  let i: any = null;
      const moveName: any[] = [];
...
export function Task_HandleMoveSelectInput(...args: any[]): any {
  let numMoves = 0;
      let i: any = null;
...
export function Task_SelectedMove(...args: any[]): any {
  if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_LINK)
      {
...
export function Task_EndCommunicateMoveSelections(...args: any[]): any {
  DestroyTask(taskId);
      gTasks[eContest.mainTaskId].func = Task_HideMoveSelectScreen;
}

/** static void Task_HideMoveSelectScreen(u8 taskId) */
export function Task_HideMoveSelectScreen(...args: any[]): any {
  let i: any = null;
...
export function Task_HideApplauseMeterForAppealStart(...args: any[]): any {
...
export function Task_WaitHideApplauseMeterForAppealStart(...args: any[]): any {
...
export function Task_AppealSetup(...args: any[]): any {
...
export function Task_DoAppeals(...args: any[]): any {
...
export function Task_EndWaitForLink(...args: any[]): any {
  eContest.waitForLink = FALSE;
      DestroyTask(taskId);
}

/** static void SpriteCB_MonSlideIn(struct Sprite *sprite) */
export function SpriteCB_MonSlideIn(...args: any[]): any {
  if (sprite.x2 != 0)
      {
          sprite.x2 -= 2;
      }
...
export function SpriteCB_MonSlideOut(...args: any[]): any {
  sprite.x2 -= 6;
...
export function Task_FinishRoundOfAppeals(...args: any[]): any {
  switch (gTasks[taskId].data[0])
      {
      case 0:
          if (gLinkContestFlags & LINK_CONTEST_FLAG_IS_LINK)
...
export function Task_ReadyUpdateHeartSliders(...args: any[]): any {
...
export function Task_UpdateHeartSliders(...args: any[]): any {
  switch (gTasks[taskId].data[0])
      {
      case 0:
...
export function Task_WaitForHeartSliders(...args: any[]): any {
...
export function Task_RestorePlttBufferUnfaded(...args: any[]): any {
...
export function Task_WaitPrintRoundResult(...args: any[]): any {
  if (++gTasks[taskId].data[0] > 2)
      {
          gTasks[taskId].data[0] = 0;
...
export function Task_PrintRoundResultText(...args: any[]): any {
  if (gTasks[taskId].data[0] == 0)
      {
...
export function Task_ReUpdateHeartSliders(...args: any[]): any {
...
export function Task_WaitForHeartSlidersAgain(...args: any[]): any {
  if (SlidersDoneUpdating())
      {
          gTasks[taskId].data[0] = 0;
...
export function Task_StartNewRoundOfAppeals(...args: any[]): any {
  if (!eContest.applauseMeterIsMoving)
          gTasks[taskId].func = Task_DisplayAppealNumberText;
}

/** static void Task_EndAppeals(u8 taskId) */
export function Task_EndAppeals(...args: any[]): any {
  let i: any = null;
...
export function Task_WaitForOutOfTimeMsg(...args: any[]): any {
  if (!Contest_RunTextPrinters())
      {
          SetBgForCurtainDrop();
          gBattle_BG1_X = 0;
...
export function Task_DropCurtainAtAppealsEnd(...args: any[]): any {
  gBattle_BG1_Y -= 7;
      if (gBattle_BG1_Y < 0)
          gBattle_BG1_Y = 0;
      if (gBattle_BG1_Y == 0)
...
export function Task_TryCommunicateFinalStandings(...args: any[]): any {
...
export function Task_CommunicateFinalStandings(...args: any[]): any {
  let taskId2 = CreateTask(Task_LinkContest_CommunicateFinalStandings, 0);
...
export function Task_EndCommunicateFinalStandings(...args: any[]): any {
  DestroyTask(taskId);
      BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
...
export function Task_ContestReturnToField(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          DestroyTask(taskId);
...
export function CreateContestMonFromParty(...args: any[]): any {
  const name: any[] = [];
...
export function SetContestants(...args: any[]): any {
  let i: any = null;
      let opponentsCount = 0;
      const opponents: any[] = [];
      let allowPostgameContestants = FALSE;
      let filter: any = null;
...
export function SetLinkAIContestants(...args: any[]): any {
  let i, j;
      let opponentsCount = 0;
      const opponents: any[] = [];
      ...
      {
          let rnd = GetContestRand() % opponentsCount;
...
export function GetContestEntryEligibility(...args: any[]): any {
  let ribbon: any = null;
...
export function PrintContestantTrainerName(...args: any[]): any {
...
export function PrintContestantTrainerNameWithColor(...args: any[]): any {
  const buffer: any[] = [];
      let offset: any = null;
...
export function PrintContestantMonName(...args: any[]): any {
...
export function PrintContestantMonNameWithColor(...args: any[]): any {
...
export function CalculateContestantRound1Points(...args: any[]): any {
...
export function CalculateRound1Points(...args: any[]): any {
  let i: any = null;
...
export function CreateContestantSprite(...args: any[]): any {
  let spriteId: any = null;
...
export function IsSpeciesNotUnown(...args: any[]): any {
...
export function GetMoveEffectSymbolTileOffset(...args: any[]): any {
  let offset: any = null;
...
export function PrintContestMoveDescription(...args: any[]): any {
...
export function DrawMoveEffectSymbol(...args: any[]): any {
  let contestantOffset = gContestantTurnOrder[contestant] * 5 + 2;

      if (!Contest_IsMonsTurnDisabled(contestant) && move != MOVE_NONE)
      {
          let tile = GetMoveEffectSymbolTileOffset(move, contestant);
...
export function UpdateConditionStars(...args: any[]): any {
...
export function DrawConditionStars(): any {
  let i: any = null;
      ...
      for (i = 0; i < CONTESTANT_COUNT; i++)
      {
          let contestantOffset = gContestantTurnOrder[i] * 5 + 2;
          let starOffset = GetStarTileOffset();
...
export function GetStatusSymbolTileOffset(...args: any[]): any {
  let offset = 0;
...
export function DrawStatusSymbol(...args: any[]): any {
  let statused = TRUE;
      let symbolOffset = 0;
      let contestantOffset = gContestantTurnOrder[contestant] * 5 + 2;
...
export function GetChosenMove(...args: any[]): any {
...
export function ContestantCanUseTurn(...args: any[]): any {
...
export function Contest_IsMonsTurnDisabled(...args: any[]): any {
  if (eContestantStatus[contestant].numTurnsSkipped != 0 || eContestantStatus[contestant].noMoreTurns)
          return TRUE;
      else
          return FALSE;
...
export function CalculateTotalPointsForContestant(...args: any[]): any {
...
export function GetContestantRound2Points(...args: any[]): any {
...
export function DidContestantPlaceHigher(...args: any[]): any {
  let retVal: any = null;
...
export function GetAppealHeartTileOffset(...args: any[]): any {
  let offset: any = null;
...
export function GetNumHeartsFromAppealPoints(...args: any[]): any {
  let hearts = appeal / 10;
...
export function UpdateAppealHearts(...args: any[]): any {
  let taskId: any = null;
...
export function Task_UpdateAppealHearts(...args: any[]): any {
  let contestant = gTasks[taskId].tContestant;
      let startHearts = gTasks[taskId].tNumHearts;
      let heartsDelta = gTasks[taskId].tHeartsDelta;
...
export function CreateSliderHeartSprites(): any {
  let i: any = null;
      ...
      for (i = 0; i < CONTESTANT_COUNT; i++)
      {
          let y = sSliderHeartYPositions[gContestantTurnOrder[i]];
...
export function UpdateHeartSlider(...args: any[]): any {
  let spriteId: any = null;
...
export function SpriteCB_UpdateHeartSlider(...args: any[]): any {
...
export function SetBottomSliderHeartsInvisibility(...args: any[]): any {
  let i: any = null;
...
export function CreateJudgeAttentionEyeTask(): any {
  let i: any = null;
      let taskId = CreateTask(Task_FlashJudgeAttentionEye, 30);
...
export function StartFlashJudgeAttentionEye(...args: any[]): any {
...
export function StopFlashJudgeAttentionEye(...args: any[]): any {
  let taskId = CreateTask(Task_StopFlashJudgeAttentionEye, 31);
      gTasks[taskId].data[0] = contestant;
}

/** static void Task_StopFlashJudgeAttentionEye(u8 taskId) */
export function Task_StopFlashJudgeAttentionEye(...args: any[]): any {
  let contestant = gTasks[taskId].data[0];
...
export function Task_FlashJudgeAttentionEye(...args: any[]): any {
  let i: any = null;
...
export function InitUnusedBlendTaskData(...args: any[]): any {
...
export function UpdateBlendTaskContestantData(...args: any[]): any {
...
export function Task_UnusedBlend(...args: any[]): any {
  let i: any = null;
...
export function StartStopFlashJudgeAttentionEye(...args: any[]): any {
  if (eContestantStatus[contestant].hasJudgesAttention)
...
export function CreateContestantBoxBlinkSprites(...args: any[]): any {
  let spriteId1, spriteId2;
      let x = gContestantTurnOrder[contestant] * 40 + 32;
...
export function DestroyContestantBoxBlinkSprites(...args: any[]): any {
  let spriteId2 = gSprites[spriteId].data[0];
...
export function BlinkContestantBox(...args: any[]): any {
...
export function SpriteCB_BlinkContestantBox(...args: any[]): any {
...
export function SpriteCB_EndBlinkContestantBox(...args: any[]): any {
...
export function SortContestants(...args: any[]): any {
  const scratch: any[] = [];
      const randomOrdering: any = [0];
      let i: any = null;
      let v3: any = null;
      ...
      else
      {
          ...
          for (i = 0; i < CONTESTANT_COUNT; i++)
          {
              let j = eContestantStatus[i].ranking;
          ...
          for (i = 0; i < CONTESTANT_COUNT - 1; i++)
          {
              for (v3 = CONTESTANT_COUNT - 1; v3 > i; v3--)
              {
                  ...
                  {
                      let temp = gContestantTurnOrder[v3];
...
export function CalculateAppealMoveImpact(...args: any[]): any {
  let move: any = null;
      let effect: any = null;
      let rnd: any = null;
      let i: any = null;
      ...
      {
          let completedCombo = AreMovesContestCombo(eContestantStatus[contestant].prevMove, eContestantStatus[contestant].currMove);
...
export function SetContestantEffectStringID(...args: any[]): any {
...
export function SetContestantEffectStringID2(...args: any[]): any {
  eContestantStatus[contestant].effectStringId2 = effectStringId;
}

/** void SetStartledString(u8 contestant, u8 jam) */
export function SetStartledString(...args: any[]): any {
  if      (jam >= 60)
...
export function PrintAppealMoveResultText(...args: any[]): any {
  StringCopy(gStringVar1, gContestMons[contestant].nickname);
      StringCopy(gStringVar2, gMoveNames[eContestantStatus[contestant].currMove]);
...
export function MakeContestantNervous(...args: any[]): any {
...
export function SpriteCB_JudgeSpeechBubble(...args: any[]): any {
  if (sprite.data[1]++ > 84)
      {
          sprite.data[1] = 0;
          sprite.invisible = TRUE;
...
export function DoJudgeSpeechBubble(...args: any[]): any {
  let spriteId = eContest.judgeSpeechBubbleSpriteId;
...
export function Contest_GetMoveExcitement(...args: any[]): any {
...
export function StartApplauseOverflowAnimation(): any {
  let taskId = CreateTask(Task_ApplauseOverflowAnimation, 10);
...
export function Task_ApplauseOverflowAnimation(...args: any[]): any {
...
export function Task_SlideApplauseMeterIn(...args: any[]): any {
...
export function Task_SlideApplauseMeterOut(...args: any[]): any {
  let sprite: any = gSprites[eContest.applauseMeterSpriteId];
...
export function ShowAndUpdateApplauseMeter(...args: any[]): any {
  let taskId = CreateTask(Task_ShowAndUpdateApplauseMeter, 5);
...
export function Task_ShowAndUpdateApplauseMeter(...args: any[]): any {
...
export function Task_AnimateAudience(...args: any[]): any {
...
export function BlendAudienceBackground(...args: any[]): any {
  let taskId = CreateTask(Task_BlendAudienceBackground, 10);
...
export function Task_BlendAudienceBackground(...args: any[]): any {
...
export function ShowHideNextTurnGfx(...args: any[]): any {
  let i: any = null;
...
export function DrawUnnervedSymbols(): any {
  let i = 0;
      for (i = 0; i < CONTESTANT_COUNT; i++)
      {
          ...
          {
              let contestantOffset = gContestantTurnOrder[i] * 5 + 2;
              let symbolOffset = GetStatusSymbolTileOffset(STAT_SYMBOL_SWIRL);
...
export function IsContestantAllowedToCombo(...args: any[]): any {
...
export function Task_StartDropCurtainAtRoundEnd(...args: any[]): any {
  gBattle_BG1_X = 0;
      gBattle_BG1_Y = DISPLAY_HEIGHT;
      PlaySE12WithPanning(SE_CONTEST_CURTAIN_FALL, 0);
...
export function Task_UpdateCurtainDropAtRoundEnd(...args: any[]): any {
...
export function Task_ResetForNextRound(...args: any[]): any {
  let i: any = null;
...
export function Task_UpdateRaiseCurtainAtRoundEnd(...args: any[]): any {
...
export function Task_WaitRaiseCurtainAtRoundEnd(...args: any[]): any {
...
export function Task_StartRaiseCurtainAtRoundEnd(...args: any[]): any {
  if (gTasks[taskId].data[2] < 10)
      {
          gTasks[taskId].data[2]++;
      }
...
export function AnimateSliderHearts(...args: any[]): any {
  let i: any = null;
      let taskId: any = null;
...
export function Task_WaitForSliderHeartAnim(...args: any[]): any {
  let i: any = null;
...
export function SanitizeMove(...args: any[]): any {
  if (move >= MOVES_COUNT)
          move = MOVE_POUND;
      return move;
}
...
export function SanitizeSpecies(...args: any[]): any {
...
export function SetMoveSpecificAnimData(...args: any[]): any {
  let i: any = null;
      let move = SanitizeMove(eContestantStatus[contestant].currMove);
      let species = SanitizeSpecies(gContestMons[contestant].species);
...
export function ClearMoveAnimData(...args: any[]): any {
...
export function SetMoveAnimAttackerData(...args: any[]): any {
...
export function SetMoveTargetPosition(...args: any[]): any {
...
export function Contest_PrintTextToBg0WindowStd(...args: any[]): any {
...
export function Contest_PrintTextToBg0WindowAt(...args: any[]): any {
  let printerTemplate: any = null;
...
export function Contest_StartTextPrinter(...args: any[]): any {
  let printerTemplate: any = null;
      let speed: any = null;
...
export function ContestBG_FillBoxWithIncrementingTile(...args: any[]): any {
...
export function ContestBG_FillBoxWithTile(...args: any[]): any {
...
export function Contest_SetBgCopyFlags(...args: any[]): any {
...
export function SaveContestWinner(...args: any[]): any {
  let i: any = null;
      let captionId = Random() % NUM_PAINTING_CAPTIONS;
      ...
      if (rank != CONTEST_SAVE_FOR_ARTIST)
      {
          ...
          let id = GetContestWinnerSaveIdx(rank, TRUE);
...
export function GetContestWinnerSaveIdx(...args: any[]): any {
  let i: any = null;
...
export function SetContestLiveUpdateFlags(...args: any[]): any {
  let i: any = null;
...
export function ContestDebugToggleBitfields(...args: any[]): any {
...
export function GetMonNicknameLanguage(...args: any[]): any {
  let ret = GAME_LANGUAGE;
...
export function StripPlayerNameForLinkContest(...args: any[]): any {
  let chr = playerName[5];
...
export function StripMonNameForLinkContest(...args: any[]): any {
  let chr: any = null;
...
export function StripPlayerAndMonNamesForLinkContest(...args: any[]): any {
