...
export function BuildSpritePriorities(): any {
  let i: any = null;
      ...
      {
          let sprite: any = gSprites[i];
          let priority = sprite.subpriority | (sprite.oam.priority << 8);
...
export function SortSprites(): any {
  let i: any = null;
      for (i = 1; i < MAX_SPRITES; i++)
      {
          ...
          let sprite1Priority = sSpritePriorities[sSpriteOrder[i - 1]];
          let sprite2Priority = sSpritePriorities[sSpriteOrder[i]];
          let sprite1Y = sprite1.oam.y;
          let sprite2Y = sprite2.oam.y;
...
export function CreateSprite(...args: any[]): any {
  let i: any = null;
...
export function CreateSpriteAtEnd(...args: any[]): any {
  let i: any = null;
...
export function CreateInvisibleSprite(...args: any[]): any {
  let index = CreateSprite(gDummySpriteTemplate, 0, 0, 31);
...
export function CreateSpriteAt(...args: any[]): any {
...
export function CreateSpriteAndAnimate(...args: any[]): any {
  let i: any = null;
      ...
      for (i = 0; i < MAX_SPRITES; i++)
      {
          ...
          if (!gSprites[i].inUse)
          {
              let index = CreateSpriteAt(i, template, x, y, subpriority);
...
export function DestroySprite(...args: any[]): any {
  if (sprite.inUse)
      {
          if (!sprite.usingSheet)
          {
              let i: any = null;
              let tileEnd = (sprite.images.size / TILE_SIZE_4BPP) + sprite.oam.tileNum;
...
export function ResetOamRange(...args: any[]): any {
  let i: any = null;
      for (i = start; i < end; i++)
...
export function SetOamMatrix(...args: any[]): any {
...
export function ResetSprite(...args: any[]): any {
  *sprite = sDummySprite;
}

/** void CalcCenterToCornerVec(struct Sprite *sprite, u8 shape, u8 size, u8 affineMode) */
export function CalcCenterToCornerVec(...args: any[]): any {
  let x = sCenterToCornerVecTable[shape][size][0];
      let y = sCenterToCornerVecTable[shape][size][1];
...
export function AllocSpriteTiles(...args: any[]): any {
  let i: any = null;
      let start: any = null;
...
export function SpriteTileAllocBitmapOp(...args: any[]): any {
  let index = bit / 8;
      let shift = bit % 8;
      let val = bit % 8;
      let retVal = 0;
...
export function RequestSpriteFrameImageCopy(...args: any[]): any {
...
export function RequestSpriteCopy(...args: any[]): any {
  if (sSpriteCopyRequestCount < MAX_SPRITE_COPY_REQUESTS)
      {
...
export function CopyFromSprites(...args: any[]): any {
  let i: any = null;
      let src = gSprites;
...
export function CopyToSprites(...args: any[]): any {
  let i: any = null;
      let dest = gSprites;
      for (i = 0; i < sizeof(struct Sprite) * MAX_SPRITES; i++)
      {
...
export function FreeSpriteTiles(...args: any[]): any {
...
export function FreeSpritePalette(...args: any[]): any {
      if (!sprite || !sprite.template)
          return;
...
export function FreeSpriteOamMatrix(...args: any[]): any {
  if (sprite.oam.affineMode & ST_OAM_AFFINE_ON_MASK)
      {
...
export function DestroySpriteAndFreeResources(...args: any[]): any {
...
export function AnimateSprite(...args: any[]): any {
...
export function BeginAnim(...args: any[]): any {
...
export function ContinueAnim(...args: any[]): any {
...
export function AnimCmd_frame(...args: any[]): any {
  let imageValue: any = null;
      let duration: any = null;
      let hFlip: any = null;
      let vFlip: any = null;
...
export function AnimCmd_end(...args: any[]): any {
  sprite.animCmdIndex--;
      sprite.animEnded = TRUE;
}

/** void AnimCmd_jump(struct Sprite *sprite) */
export function AnimCmd_jump(...args: any[]): any {
  let imageValue: any = null;
      let duration: any = null;
      let hFlip: any = null;
      let vFlip: any = null;
...
export function AnimCmd_loop(...args: any[]): any {
...
export function BeginAnimLoop(...args: any[]): any {
...
export function ContinueAnimLoop(...args: any[]): any {
...
export function JumpToTopOfAnimLoop(...args: any[]): any {
  if (sprite.animLoopCounter)
      {
          sprite.animCmdIndex--;
...
export function ContinueAffineAnim(...args: any[]): any {
  if (sprite.oam.affineMode & ST_OAM_AFFINE_ON_MASK)
      {
          let matrixNum = GetSpriteMatrixNum(sprite);
...
export function AffineAnimDelay(...args: any[]): any {
...
export function AffineAnimCmd_loop(...args: any[]): any {
...
export function BeginAffineAnimLoop(...args: any[]): any {
...
export function ContinueAffineAnimLoop(...args: any[]): any {
...
export function JumpToTopOfAffineAnimLoop(...args: any[]): any {
  if (sAffineAnimStates[matrixNum].loopCounter)
      {
          sAffineAnimStates[matrixNum].animCmdIndex--;
...
export function AffineAnimCmd_jump(...args: any[]): any {
  let frameCmd: any = null;
...
export function AffineAnimCmd_end(...args: any[]): any {
...
export function AffineAnimCmd_frame(...args: any[]): any {
  let frameCmd: any = null;
      GetAffineAnimFrame(matrixNum, sprite, frameCmd);
      ApplyAffineAnimFrame(matrixNum, frameCmd);
      sAffineAnimStates[matrixNum].delayCounter = frameCmd.duration;
...
export function CopyOamMatrix(...args: any[]): any {
...
export function GetSpriteMatrixNum(...args: any[]): any {
  let matrixNum = 0;
      if (sprite.oam.affineMode & ST_OAM_AFFINE_ON_MASK)
...
export function SetSpriteMatrixAnchor(...args: any[]): any {
  sprite.sAnchorX = x;
      sprite.sAnchorY = y;
...
export function GetAnchorCoord(...args: any[]): any {
  let subResult, var1;
...
export function UpdateSpriteMatrixAnchorPos(...args: any[]): any {
...
export function SetSpriteOamFlipBits(...args: any[]): any {
...
export function AffineAnimStateRestartAnim(...args: any[]): any {
...
export function AffineAnimStateStartAnim(...args: any[]): any {
...
export function AffineAnimStateReset(...args: any[]): any {
...
export function ApplyAffineAnimFrameAbsolute(...args: any[]): any {
...
export function DecrementAnimDelayCounter(...args: any[]): any {
  if (!sprite.animPaused)
          sprite.animDelayCounter--;
}

/** bool8 DecrementAffineAnimDelayCounter(struct Sprite *sprite, u8 matrixNum) */
export function DecrementAffineAnimDelayCounter(...args: any[]): any {
...
export function ApplyAffineAnimFrameRelativeAndUpdateMatrix(...args: any[]): any {
...
export function ApplyAffineAnimFrame(...args: any[]): any {
  let dummyFrameCmd: any = [0];
...
export function StartSpriteAnim(...args: any[]): any {
...
export function StartSpriteAnimIfDifferent(...args: any[]): any {
  if (sprite.animNum != animNum)
          StartSpriteAnim(sprite, animNum);
}

/** void SeekSpriteAnim(struct Sprite *sprite, u8 animCmdIndex) */
export function SeekSpriteAnim(...args: any[]): any {
  let temp = sprite.animPaused;
...
export function StartSpriteAffineAnim(...args: any[]): any {
  let matrixNum = GetSpriteMatrixNum(sprite);
...
export function StartSpriteAffineAnimIfDifferent(...args: any[]): any {
  let matrixNum = GetSpriteMatrixNum(sprite);
...
export function ChangeSpriteAffineAnim(...args: any[]): any {
  let matrixNum = GetSpriteMatrixNum(sprite);
      sAffineAnimStates[matrixNum].animNum = animNum;
      sprite.affineAnimBeginning = TRUE;
      sprite.affineAnimEnded = FALSE;
...
export function ChangeSpriteAffineAnimIfDifferent(...args: any[]): any {
  let matrixNum = GetSpriteMatrixNum(sprite);
      if (sAffineAnimStates[matrixNum].animNum != animNum)
...
export function SetSpriteSheetFrameTileNum(...args: any[]): any {
  if (sprite.usingSheet)
      {
          let tileOffset = sprite.anims[sprite.animNum][sprite.animCmdIndex].frame.imageValue;
          if (tileOffset < 0)
              tileOffset = 0;
...
export function AllocOamMatrix(): any {
  let i = 0;
      let bit = 1;
      let bitmap = gOamMatrixAllocBitmap;
...
export function FreeOamMatrix(...args: any[]): any {
  let i = 0;
      let bit = 1;
...
export function InitSpriteAffineAnim(...args: any[]): any {
  let matrixNum = AllocOamMatrix();
      if (matrixNum != 0xFF)
      {
          CalcCenterToCornerVec(sprite, sprite.oam.shape, sprite.oam.size, sprite.oam.affineMode);
...
export function SetOamMatrixRotationScaling(...args: any[]): any {
  let srcData: any = null;
      let matrix: any = null;
...
export function LoadSpriteSheet(...args: any[]): any {
  let tileStart = AllocSpriteTiles(sheet.size / TILE_SIZE_4BPP);
...
export function LoadSpriteSheets(...args: any[]): any {
  let i: any = null;
...
export function FreeSpriteTilesByTag(...args: any[]): any {
  let index = IndexOfSpriteTileTag(tag);
      if (index != 0xFF)
      {
          let i: any = null;
...
export function GetSpriteTileStartByTag(...args: any[]): any {
  let index = IndexOfSpriteTileTag(tag);
      if (index == 0xFF)
          return 0xFFFF;
...
export function IndexOfSpriteTileTag(...args: any[]): any {
  let i: any = null;
...
export function GetSpriteTileTagByTileStart(...args: any[]): any {
  let i: any = null;
...
export function AllocSpriteTileRange(...args: any[]): any {
  let freeIndex = IndexOfSpriteTileTag(TAG_NONE);
...
export function LoadSpritePalette(...args: any[]): any {
...
export function LoadSpritePalettes(...args: any[]): any {
  let i: any = null;
...
export function DoLoadSpritePalette(...args: any[]): any {
  LoadPalette(src, OBJ_PLTT_OFFSET + paletteOffset, PLTT_SIZE_4BPP);
}

/** u8 AllocSpritePalette(u16 tag) */
export function AllocSpritePalette(...args: any[]): any {
  let index = IndexOfSpritePaletteTag(TAG_NONE);
      if (index == 0xFF)
      {
          return 0xFF;
      }
...
export function IndexOfSpritePaletteTag(...args: any[]): any {
  let i: any = null;
...
export function GetSpritePaletteTagByPaletteNum(...args: any[]): any {
  return sSpritePaletteTags[paletteNum];
}

/** void FreeSpritePaletteByTag(u16 tag) */
export function FreeSpritePaletteByTag(...args: any[]): any {
  let index = IndexOfSpritePaletteTag(tag);
      if (index != 0xFF)
          sSpritePaletteTags[index] = TAG_NONE;
}

/** void SetSubspriteTables(struct Sprite *sprite, const struct SubspriteTable *subspriteTables) */
export function SetSubspriteTables(...args: any[]): any {
...
export function AddSpriteToOamBuffer(...args: any[]): any {
...
export function AddSubspritesToOamBuffer(...args: any[]): any {
  let subspriteTable: any = null;
      ...
      else
      {
          ...
          for (i = 0; i < subspriteCount; i++, (*oamIndex)++)
          {
              ...
              if (hFlip)
              {
                  let width = sOamDimensions[subspriteTable.subsprites[i].shape][subspriteTable.subsprites[i].size].width;
                  let right = x;
                  right += width;
                  x = right;
                  x = ~x + 1;
              ...
              if (vFlip)
              {
                  let height = sOamDimensions[subspriteTable.subsprites[i].shape][subspriteTable.subsprites[i].size].height;
                  let bottom = y;
                  bottom += height;
                  y = bottom;
                  y = ~y + 1;
