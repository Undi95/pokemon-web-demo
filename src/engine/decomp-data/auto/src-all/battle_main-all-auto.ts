...
export function FindLinkBattleMaster(...args: any[]): any {
  let found = 0;
...
export function SetMultiPartnerMenuParty(...args: any[]): any {
  let i: any = null;
  ...
  let playerMultiplayerId: any = null;
      ...
      case 9:
          if ((GetBlockReceivedStatus() & 0xF) == 0xF)
          {
              ...
              for (var = 0; var < 4; var++)
              {
                  let blockValue = gBlockRecvBuffer[var][0];
                  if (blockValue & 4)
                  {
...
export function SpriteCB_UnusedBattleInit(...args: any[]): any {
  sprite.sState = 0;
      sprite.callback = SpriteCB_UnusedBattleInit_Main;
}

/** static void SpriteCB_UnusedBattleInit_Main(struct Sprite *sprite) */
export function SpriteCB_UnusedBattleInit_Main(...args: any[]): any {
...
export function CreateNPCTrainerParty(...args: any[]): any {
  let nameHash = 0;
...
export function SpriteCB_VsLetter(...args: any[]): any {
  if (sprite.data[0] != 0)
...
export function SpriteCB_VsLetterInit(...args: any[]): any {
...
export function BufferPartyVsScreenHealth_AtEnd(...args: any[]): any {
  let party1: any = NULL;
      let party2: any = NULL;
      let multiplayerId = gBattleScripting.multiplayerId;
      let flags: any = null;
      let i: any = null;
...
export function GetBattleBgTemplateData(...args: any[]): any {
  let ret = 0;
...
export function TryCorrectShedinjaLanguage(...args: any[]): any {
  const nickname: any[] = [];
      let language = LANGUAGE_JAPANESE;
...
export function GetBattleWindowTemplatePixelWidth(...args: any[]): any {
  return gBattleWindowTemplates[windowsType][tableId].width * 8;
}

/** void SpriteCB_WildMon(struct Sprite *sprite) */
export function SpriteCB_WildMon(...args: any[]): any {
...
export function SpriteCB_MoveWildMonToRight(...args: any[]): any {
...
export function SpriteCB_WildMonShowHealthbox(...args: any[]): any {
  if (sprite.animEnded)
      {
...
export function SpriteCB_WildMonAnimate(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function SpriteCB_Flicker(...args: any[]): any {
  sprite.sDelay--;
      if (sprite.sDelay == 0)
      {
          sprite.sDelay = 8;
...
export function SpriteCB_FaintOpponentMon(...args: any[]): any {
...
export function SpriteCB_AnimFaintOpponent(...args: any[]): any {
  let i: any = null;
      ...
      if (--sprite.data[4] == 0)
      {
          ...
          {
              let dst = gMonSpritesGfxPtr.sprites.byte[GetBattlerPosition(sprite.sBattler)] + (gBattleMonForms[sprite.sBattler] << 11) + (sprite.data[3] << 8);
...
export function SpriteCB_ShowAsMoveTarget(...args: any[]): any {
  sprite.data[3] = 8;
...
export function SpriteCB_BlinkVisible(...args: any[]): any {
  if (--sprite.data[3] == 0)
      {
          sprite.invisible ^= 1;
          sprite.data[3] = 8;
...
export function SpriteCB_HideAsMoveTarget(...args: any[]): any {
...
export function SpriteCB_OpponentMonFromBall(...args: any[]): any {
  if (sprite.affineAnimEnded)
      {
...
export function SpriteCB_BattleSpriteStartSlideLeft(...args: any[]): any {
  sprite.callback = SpriteCB_BattleSpriteSlideLeft;
}

/** static void SpriteCB_BattleSpriteSlideLeft(struct Sprite *sprite) */
export function SpriteCB_BattleSpriteSlideLeft(...args: any[]): any {
...
export function SpriteCB_FaintSlideAnim(...args: any[]): any {
  if (!(gIntroSlideFlags & 1))
      {
...
export function DoBounceEffect(...args: any[]): any {
...
export function EndBounceEffect(...args: any[]): any {
  let bouncerSpriteId: any = null;
...
export function SpriteCB_BounceEffect(...args: any[]): any {
  let bouncerSpriteId = sprite.sBouncerSpriteId;
      let index: any = null;
...
export function SpriteCB_PlayerMonFromBall(...args: any[]): any {
  if (sprite.affineAnimEnded)
          BattleAnimateBackSprite(sprite, sprite.sSpeciesId);
}

/** static void SpriteCB_TrainerThrowObject_Main(struct Sprite *sprite) */
export function SpriteCB_TrainerThrowObject_Main(...args: any[]): any {
...
export function SpriteCB_TrainerThrowObject(...args: any[]): any {
  StartSpriteAnim(sprite, 1);
      sprite.callback = SpriteCB_TrainerThrowObject_Main;
}

/** void AnimSetCenterToCornerVecX(struct Sprite *sprite) */
export function AnimSetCenterToCornerVecX(...args: any[]): any {
...
export function SwitchPartyOrder(...args: any[]): any {
  let i: any = null;
...
export function HandleTurnActionSelectionState(): any {
  let i: any = null;
      ...
      for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
      {
          let position = GetBattlerPosition(gActiveBattler);
...
export function SwapTurnOrder(...args: any[]): any {
  let temp: any = null;
...
export function GetWhoStrikesFirst(...args: any[]): any {
  let strikesFirst = 0;
      ...
      else
      {
          ...
          else
          {
              ...
              for (i = 0; i < gBattlersCount - 1; i++)
              {
                  for (j = i + 1; j < gBattlersCount; j++)
                  {
                      let battler1 = gBattlerByTurnOrder[i];
                      let battler2 = gBattlerByTurnOrder[j];
...
export function TurnValuesCleanUp(...args: any[]): any {
  let i: any = null;
      let dataPtr: any = null;
...
export function SpecialStatusesClear(): any {
  for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
      {
          let i: any = null;
          let dataPtr = (u8 *)(gSpecialStatuses[gActiveBattler]);
  ...
  let i: any = null;
      ...
      while (gLeveledUpInBattle != 0)
      {
          for (i = 0; i < PARTY_SIZE; i++)
          {
              ...
              {
                  let species: any = null;
                  let levelUpBits = gLeveledUpInBattle;
