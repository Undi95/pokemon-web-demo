...
export function OpenMatchCall(): any {
  let gfx: any = AllocSubstruct(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN, sizeof(struct Pokenav_MatchCallGfx));
      if (!gfx)
          return FALSE;
...
export function CreateMatchCallLoopedTask(...args: any[]): any {
...
export function LoopedTask_OpenMatchCall(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function MatchCallListCursorDown(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function MatchCallListCursorUp(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function MatchCallListPageDown(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function MatchCallListPageUp(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function SelectMatchCallEntry(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function MoveMatchCallOptionsCursor(...args: any[]): any {
  let gfx: any = null;
...
export function CancelMatchCallSelection(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function DoMatchCallMessage(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function DoTrainerCloseByMessage(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function CloseMatchCallMessage(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
...
export function ShowCheckPage(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function ShowCheckPageDown(...args: any[]): any {
  let topId: any = null;
      let delta: any = null;
      let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
...
export function ExitCheckPage(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
      {
      case 0:
...
export function ShowCheckPageUp(...args: any[]): any {
  let topId: any = null;
      let delta: any = null;
      let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_OPEN);
      switch (state)
...
export function ExitMatchCall(...args: any[]): any {
  switch (state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function SetPokeballIconsFlashing(...args: any[]): any {
...
export function Task_FlashPokeballIcons(...args: any[]): any {
...
export function TryDrawRematchPokeballIcon(...args: any[]): any {
...
export function ClearRematchPokeballIcon(...args: any[]): any {
  let bg = GetWindowAttribute(windowId, WINDOW_BG);
      let tilemap = GetBgTilemapBuffer(bg);
      tilemap += tileOffset * 64 + 0x1D;
      tilemap[0] = POKEBALL_ICON_EMPTY;
...
export function DrawMatchCallLeftColumnWindows(...args: any[]): any {
...
export function UpdateMatchCallInfoBox(...args: any[]): any {
  FillWindowPixelBuffer(gfx.infoBoxWindowId, PIXEL_FILL(1));
...
export function PrintNumberRegisteredLabel(...args: any[]): any {
  PrintMatchCallInfoLabel(windowId, gText_NumberRegistered, 0);
}

/** static void PrintNumberRegistered(u16 windowId) */
export function PrintNumberRegistered(...args: any[]): any {
  const str: any[] = [];
...
export function PrintNumberOfBattlesLabel(...args: any[]): any {
  PrintMatchCallInfoLabel(windowId, gText_NumberOfBattles, 2);
}

/** static void PrintNumberOfBattles(u16 windowId) */
export function PrintNumberOfBattles(...args: any[]): any {
  const str: any[] = [];
...
export function PrintMatchCallInfoLabel(...args: any[]): any {
  let y = top * 16 + 1;
...
export function PrintMatchCallInfoNumber(...args: any[]): any {
...
export function PrintMatchCallLocation(...args: any[]): any {
  const mapName: any[] = [];
      let x: any = null;
...
export function PrintMatchCallSelectionOptions(...args: any[]): any {
  let i: any = null;
...
export function ShowOptionsCursor(...args: any[]): any {
  if (!IsDma3ManagerBusyWithBgCopy())
      {
...
export function LoadCallWindowAndFade(...args: any[]): any {
...
export function DrawMsgBoxForMatchCallMsg(...args: any[]): any {
  let sprite: any = null;
      LoadMatchCallWindowGfx(gfx.msgBoxWindowId, 1, 4);
...
export function DrawMsgBoxForCloseByMsg(...args: any[]): any {
...
export function IsDma3ManagerBusyWithBgCopy2(...args: any[]): any {
  return IsDma3ManagerBusyWithBgCopy();
}

/** static void PrintCallingDots(struct Pokenav_MatchCallGfx *gfx) */
export function PrintCallingDots(...args: any[]): any {
...
export function WaitForTrainerIsCloseByText(...args: any[]): any {
  RunTextPrinters();
      return IsTextPrinterActive(gfx.msgBoxWindowId);
}

/** static void PrintMatchCallMessage(struct Pokenav_MatchCallGfx *gfx) */
export function PrintMatchCallMessage(...args: any[]): any {
...
export function WaitForMatchCallMessageText(...args: any[]): any {
...
export function EraseCallMessageBox(...args: any[]): any {
...
export function WaitForCallMessageBoxErase(...args: any[]): any {
  return IsDma3ManagerBusyWithBgCopy();
}
...
export function CreateOptionsCursorSprite(...args: any[]): any {
  if (!gfx.optionsCursorSprite)
      {
...
export function CloseMatchCallSelectOptionsWindow(...args: any[]): any {
  DestroySprite(gfx.optionsCursorSprite);
      gfx.optionsCursorSprite = NULL;
}

/** static void UpdateCursorGfxPos(struct Pokenav_MatchCallGfx *gfx, int top) */
export function UpdateCursorGfxPos(...args: any[]): any {
  gfx.optionsCursorSprite.y2 = top * 16;
}

/** static void SpriteCB_OptionsCursor(struct Sprite *sprite) */
export function SpriteCB_OptionsCursor(...args: any[]): any {
  if (++sprite.data[0] > 3)
      {
          sprite.data[0] = 0;
...
export function LoadCheckPageTrainerPic(...args: any[]): any {
  let cursor: any = null;
...
export function TrainerPicSlideOffscreen(...args: any[]): any {
...
export function WaitForTrainerPic(...args: any[]): any {
...
export function SpriteCB_TrainerPicSlideOnscreen(...args: any[]): any {
...
export function SpriteCB_TrainerPicSlideOffscreen(...args: any[]): any {
  sprite.x2 -= 8;
      if (sprite.x2 <= -80)
      {
