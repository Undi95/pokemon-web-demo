...
const {
  ARRAY_COUNT, AddTextPrinterParameterized, AddWindow, AllocMatchCallSprites,
  AllocSpritePalette, AllocSubstruct, AreLeftHeaderSpritesMoving, BG_PLTT_ID,
  BgDmaFill, ChangeBgX, ChangeBgY, CheckForSpaceForDma3Request,
  CloseMatchCallSelectOptionsWindow, ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyPaletteIntoBufferUnfaded,
  CopyToBgTilemapBuffer, CopyWindowToVram, CpuCopy32, CreateLoopedTask,
  CreateMatchCallList, CreateOptionsCursorSprite, CreatePokenavList, CreateSprite,
  CreateTask, CreateTrainerPicSprite, DecompressAndCopyTileDataToVram, DecompressPicFromTable,
  DestroyMatchCallList, DestroyPokenavList, DestroySprite, DestroyTask,
  DrawMatchCallLeftColumnWindows, DrawMatchCallTextBoxBorder, DrawMsgBoxForCloseByMsg, DrawMsgBoxForMatchCallMsg,
  DrawTextBorderOuter, EraseCallMessageBox, FadeToBlackExceptPrimary, FillBgTilemapBufferRect_Palette0,
  FillWindowPixelBuffer, FindTaskIdByFunc, FreeMatchCallSprites, FreePokenavSubstruct,
  FreeSpritePaletteByTag, FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, GetBgTilemapBuffer,
  GetGameStat, GetIndexDeltaOfNextCheckPageDown, GetIndexDeltaOfNextCheckPageUp, GetMapName,
  GetMatchCallList, GetMatchCallMapSec, GetMatchCallMessageText, GetMatchCallOptionCursorPos,
  GetMatchCallOptionId, GetMatchCallTrainerPic, GetNumberRegistered, GetPlayerTextSpeedDelay,
  GetSpinningPokenavSprite, GetStringCenterAlignXOffset, GetStringRightAlignXOffset, GetSubstructPtr,
  GetWindowAttribute, HideSpinningPokenavSprite, InitBgTemplates, IsCreatePokenavListTaskActive,
  IsDma3ManagerBusyWithBgCopy, IsDma3ManagerBusyWithBgCopy1, IsDma3ManagerBusyWithBgCopy2, IsLoopedTaskActive,
  IsMatchCallListInitFinished, IsPaletteFadeActive, IsTextPrinterActive, JOY_HELD,
  LT_SET_STATE, LZ77UnCompWram, LoadCallWindowAndFade, LoadCheckPageTrainerPic,
  LoadCompressedSpriteSheet, LoadLeftHeaderGfxForIndex, LoadMatchCallWindowGfx, LoadPalette,
  LoadSpriteSheet, LoadUserWindowBorderGfx, MainMenuLoopedTaskIsBusy, OBJ_PLTT_ID,
  PIXEL_FILL, PlaySE, PokenavCopyPalette, PokenavFadeScreen,
  PokenavList_DrawCurrentItemIcon, PokenavList_EraseListForCheckPage, PokenavList_GetSelectedIndex, PokenavList_GetTopIndex,
  PokenavList_IsMoveWindowTaskActive, PokenavList_IsTaskActive, PokenavList_MoveCursorDown, PokenavList_MoveCursorUp,
  PokenavList_PageDown, PokenavList_PageUp, PokenavList_ReshowListFromCheckPage, PokenavList_ToggleVerticalArrows,
  Pokenav_AllocAndLoadPalettes, PrintCallingDots, PrintCheckPageInfo, PrintHelpBarText,
  PrintMatchCallInfoLabel, PrintMatchCallInfoNumber, PrintMatchCallLocation, PrintMatchCallMessage,
  PrintMatchCallSelectionOptions, PrintNumberOfBattles, PrintNumberOfBattlesLabel, PrintNumberRegistered,
  PrintNumberRegisteredLabel, PrintTrainerIsCloseBy, PutWindowTilemap, RemoveWindow,
  RequestDma3Copy, RunTextPrinters, SetBgTilemapBuffer, SetLeftHeaderSpritesInvisibility,
  SetPokeballIconsFlashing, ShouldDrawRematchPokeballIcon, ShowBg, ShowLeftHeaderGfx,
  ShowOptionsCursor, SlideMenuHeaderDown, StringCopy, TrainerPicSlideOffscreen,
  UpdateCursorGfxPos, UpdateMatchCallInfoBox, UpdateWindowsReturnToTrainerList, UpdateWindowsToShowCheckPage,
  WaitForCallMessageBoxErase, WaitForCallingDotsText, WaitForHelpBar, WaitForMatchCallMessageText,
  WaitForTrainerIsCloseByText, WaitForTrainerPic,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
