...
export function AnimTask_ShakeMon(...args: any[]): any {
...
export function AnimTask_ShakeMon_Step(...args: any[]): any {
...
export function AnimTask_ShakeMon2(...args: any[]): any {
  let spriteId: any = null;
      let abort = FALSE;
...
export function AnimTask_ShakeMon2_Step(...args: any[]): any {
  if (gTasks[taskId].data[3] == 0)
      {
...
export function AnimTask_ShakeMonInPlace(...args: any[]): any {
...
export function AnimTask_ShakeMonInPlace_Step(...args: any[]): any {
  if (gTasks[taskId].data[3] == 0)
      {
...
export function AnimTask_ShakeAndSinkMon(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[0]);
      gSprites[spriteId].x2 = gBattleAnimArgs[1];
      gTasks[taskId].data[0] = spriteId;
...
export function AnimTask_ShakeAndSinkMon_Step(...args: any[]): any {
  let spriteId = gTasks[taskId].data[0];
      let x = gTasks[taskId].data[1];
...
export function AnimTask_TranslateMonElliptical(...args: any[]): any {
  let i: any = null;
      let wavePeriod = 1;
      let spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[0]);
...
export function AnimTask_TranslateMonElliptical_Step(...args: any[]): any {
  let spriteId = gTasks[taskId].data[0];
...
export function AnimTask_TranslateMonEllipticalRespectSide(...args: any[]): any {
...
export function DoHorizontalLunge(...args: any[]): any {
...
export function ReverseHorizontalLungeDirection(...args: any[]): any {
...
export function DoVerticalDip(...args: any[]): any {
  let spriteId: any = null;
      sprite.invisible = TRUE;
...
export function ReverseVerticalDipDirection(...args: any[]): any {
  sprite.data[0] = sprite.data[4];
...
export function SlideMonToOriginalPos(...args: any[]): any {
...
export function SlideMonToOriginalPos_Step(...args: any[]): any {
  let monSpriteId: any = null;
      let lo: any = null;
...
export function SlideMonToOffset(...args: any[]): any {
  let battler: any = null;
      let monSpriteId: any = null;
      if (!gBattleAnimArgs[0])
...
export function SlideMonToOffsetAndBack(...args: any[]): any {
  let spriteId: any = null;
      let battler: any = null;
      sprite.invisible = TRUE;
...
export function SlideMonToOffsetAndBack_End(...args: any[]): any {
...
export function AnimTask_WindUpLunge(...args: any[]): any {
  let wavePeriod = 0x8000 / gBattleAnimArgs[3];
      if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
      {
          gBattleAnimArgs[1] = -gBattleAnimArgs[1];
...
export function AnimTask_WindUpLunge_Step1(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimTask_WindUpLunge_Step2(...args: any[]): any {
  let spriteId: any = null;
      if (gTasks[taskId].data[4] > 0)
      {
...
export function AnimTask_SlideOffScreen(...args: any[]): any {
  let spriteId: any = null;
      switch (gBattleAnimArgs[0])
      {
      case ANIM_ATTACKER:
...
export function AnimTask_SlideOffScreen_Step(...args: any[]): any {
  let spriteId = gTasks[taskId].data[0];
...
export function AnimTask_SwayMon(...args: any[]): any {
  let spriteId: any = null;
      if (GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER)
          gBattleAnimArgs[1] = -gBattleAnimArgs[1];
...
export function AnimTask_SwayMonStep(...args: any[]): any {
...
export function AnimTask_ScaleMonAndRestore(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[3]);
...
export function AnimTask_ScaleMonAndRestore_Step(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimTask_RotateMonSpriteToSide(...args: any[]): any {
  let spriteId: any = null;
      spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[2]);
...
export function AnimTask_RotateMonToSideAndRestore(...args: any[]): any {
  let spriteId = GetAnimBattlerSpriteId(gBattleAnimArgs[2]);
      PrepareBattlerSpriteForRotScale(spriteId, ST_OAM_OBJ_NORMAL);
      gTasks[taskId].data[1] = 0;
      gTasks[taskId].data[2] = gBattleAnimArgs[0];
      if (gBattleAnimArgs[2] == ANIM_ATTACKER)
...
export function AnimTask_RotateMonSpriteToSide_Step(...args: any[]): any {
  gTasks[taskId].data[3] += gTasks[taskId].data[4];
...
export function AnimTask_ShakeTargetBasedOnMovePowerOrDmg(...args: any[]): any {
  if (!gBattleAnimArgs[0])
      {
...
export function AnimTask_ShakeTargetBasedOnMovePowerOrDmg_Step(...args: any[]): any {
