...
const {
  BG_PLTT_ID, BLDALPHA_BLEND, BeginNormalPaletteFade, ChangeBgX,
  ChangeBgY, ClearGpuRegBits, Cos2, CreateSlidingLogoCircleSprite,
  CreateSpiralingLogoCircleSprite, CreateSprite, DestroyLogoCirclesGfx, DestroySprite,
  DestroyTask, FindTaskIdByFunc, FreeSpritePaletteByTag, FreeSpriteTilesByTag,
  GetBg0TilesDst, IsLogoCirclesAnimFinished, LZ77UnCompVram, LoadCompressedSpriteSheet,
  LoadLogoGfx, LoadPalette, LoadSpritePalette, SetGpuReg,
  SetGpuRegBits, Sin2, StartSpriteAnim,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
