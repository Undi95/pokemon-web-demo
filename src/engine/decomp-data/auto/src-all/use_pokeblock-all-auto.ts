...
export function SetUsePokeblockCallback(func: any): any {
  sInfo.callback = func;
      sInfo.mainState = 0;
}
  ...
  switch (sInfo.mainState)
      ...
      case 1:
          if (!gPaletteFade.active)
          {
              ...
              {
                  let numSparkles: any = sMenu.numSparkles[sMenu.curLoadId];
...
export function HandleAskUsePokeblockInput(): any {
  let menuItem: any = Menu_ProcessInputNoWrapClearOnChoose();
...
export function PrintMenuWindowText(message: any): any {
  AddTextPrinterParameterized(WIN_TEXT, FONT_NORMAL, gStringVar4, 0, 1, 0, NULL);
}

/** static void BufferEnhancedText(u8 *dest, u8 condition, s16 enhancement) */
export function BufferEnhancedText(dest: any, condition: any, enhancement: any): any {
  switch (enhancement)
      {
      case 1:  
          enhancement = 0;
...
export function GetMonConditions(mon: any, data: any): any {
  let i: any = null;
...
export function AddPokeblockToConditions(pokeblock: any, mon: any): any {
  let i: any = null;
      let stat: any = null;
      let data: any = null;
...
export function CalculatePokeblockEffectiveness(pokeblock: any, mon: any): any {
  let i, direction, flavor;
      ...
      for (i = 0; i < CONDITION_COUNT; i++)
      {
          let amount: any = sInfo.pokeblockStatBoosts[i];
          let boost: any = amount / 10;
...
export function GetSelectionIdFromPartyId(partyId: any): any {
  let i, numEggs;
...
export function SpriteCB_UpDown(sprite: any): any {
  if (sprite.tTimer < 6)
          sprite.y2 -= 2;
...
export function LoadMonInfo(partyId: any, loadId: any): any {
  let boxId: any = sMenu.party[partyId].boxId;
      let monId: any = sMenu.party[partyId].monId;
      let numSelections: any = sMenu.info.numSelections;
      let excludesCancel: any = FALSE;  
...
export function UpdateMonPic(loadId: any): any {
  let spriteId: any = null;
      ...
      if (sMenu.curMonSpriteId == SPRITE_NONE)
      {
          ...
          else
          {
              ...
              sMenu.curMonTileStart = (OBJ_VRAM0 + (sMenu.curMonSheet * 32));
...
export function UpdateMonInfoText(loadId: any, firstPrint: any): any {
...
export function UpdateSelection(up: any): any {
...
export function SpriteCB_MonPic(sprite: any): any {
  sprite.x = sMenu.curMonXOffset + 38;
}

/** static void SpriteCB_SelectionIconPokeball(struct Sprite *sprite) */
export function SpriteCB_SelectionIconPokeball(sprite: any): any {
...
export function SpriteCB_SelectionIconCancel(sprite: any): any {
  if (sMenu.info.curSelection == sMenu.info.numSelections - 1)
...
export function CalculateNumAdditionalSparkles(monIndex: any): any {
  let sheen: any = GetMonData(gPlayerParty[monIndex], MON_DATA_SHEEN);
...
export function SpriteCB_Condition(sprite: any): any {
  let prevX: any = sprite.x;
