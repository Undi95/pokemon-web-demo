...
export function AnimUnusedIceCrystalThrow(...args: any[]): any {
...
export function AnimUnusedIceCrystalThrow_Step(...args: any[]): any {
  if (sprite.data[0] != 0)
      {
...
export function AnimIcePunchSwirlingParticle(...args: any[]): any {
...
export function AnimIceBeamParticle(...args: any[]): any {
...
export function AnimIceEffectParticle(...args: any[]): any {
...
export function AnimFlickerIceEffectParticle(...args: any[]): any {
  sprite.invisible ^= 1;
      sprite.data[0] += 1;
      if (sprite.data[0] == 20)
...
export function AnimSwirlingSnowball(...args: any[]): any {
  let i: any = null;
...
export function AnimSwirlingSnowball_Step1(...args: any[]): any {
...
export function AnimSwirlingSnowball_Step2(...args: any[]): any {
  let tempVar: any = null;
      tempVar = GetBattlerSide(gBattleAnimAttacker) != B_SIDE_PLAYER ? 20 : -20;
...
export function AnimSwirlingSnowball_End(...args: any[]): any {
  sprite.data[0] = 1;
      AnimFastTranslateLinear(sprite);
...
export function AnimMoveParticleBeyondTarget(...args: any[]): any {
  let i: any = null;
      const tempDataHolder: any[] = [];
...
export function AnimWiggleParticleTowardsTarget(...args: any[]): any {
  AnimFastTranslateLinear(sprite);
      if (sprite.data[0] == 0)
          sprite.data[0] = 1;
...
export function AnimWaveFromCenterOfTarget(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          if (gBattleAnimArgs[2] == 0)
          {
...
export function InitSwirlingFogAnim(...args: any[]): any {
  let tempVar: any = null;
...
export function AnimSwirlingFogAnim(...args: any[]): any {
...
export function AnimTask_HazeScrollingFog(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_HazeScrollingFog_Step(...args: any[]): any {
  let animBg: any = null;
...
export function AnimThrowMistBall(...args: any[]): any {
...
export function AnimTask_MistBallFog(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_MistBallFog_Step(...args: any[]): any {
  let animBg: any = null;
...
export function InitPoisonGasCloudAnim(...args: any[]): any {
  sprite.data[0] = gBattleAnimArgs[0];
...
export function MovePoisonGasCloud(...args: any[]): any {
  let value: any = null;
...
export function AnimTask_Hail(...args: any[]): any {
...
export function AnimTask_Hail2(...args: any[]): any {
  let task: any = gTasks[taskId];
      switch (task.tState)
      {
      case 0:
...
export function GenerateHailParticle(...args: any[]): any {
  let id: any = null;
      let battlerX, battlerY;
      let spriteX: any = null;
      let shouldSpawnImpactEffect = FALSE;
      let type = sHailCoordData[hailStructId].type;
...
export function AnimHailBegin(...args: any[]): any {
...
export function AnimHailContinue(...args: any[]): any {
  if (++sprite.sTimer == 20)
      {
          gTasks[sprite.sOwnerTaskId].data[sprite.sOwnerTaskSpriteCountField]--;
          FreeOamMatrix(sprite.oam.matrixNum);
...
export function InitIceBallAnim(...args: any[]): any {
  let animNum = gAnimDisableStructPtr.rolloutTimerStartValue - gAnimDisableStructPtr.rolloutTimer - 1;
...
export function AnimThrowIceBall(...args: any[]): any {
...
export function InitIceBallParticle(...args: any[]): any {
  let randA, randB;
...
export function AnimIceBallParticle(...args: any[]): any {
...
export function AnimTask_GetIceBallCounter(...args: any[]): any {
  let arg = gBattleAnimArgs[0];
