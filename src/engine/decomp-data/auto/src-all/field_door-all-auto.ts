...
export function CopyDoorTilesToVram(...args: any[]): any {
  if (gfx.size == 2)
...
export function BuildDoorTiles(...args: any[]): any {
  let i: any = null;
      let tile: any = null;
...
export function DrawCurrentDoorAnimFrame(...args: any[]): any {
  const tiles: any[] = [];
...
export function DrawClosedDoorTiles(...args: any[]): any {
...
export function DrawDoor(...args: any[]): any {
...
export function AnimateDoorFrame(...args: any[]): any {
  if (tCounter == 0)
...
export function Task_AnimateDoor(...args: any[]): any {
  let data = gTasks[taskId].data;
      let frames: any = (struct DoorAnimFrame *)(tFramesHi << 16 | tFramesLo);
      let gfx: any = (struct DoorGraphics *)(tGfxHi << 16 | tGfxLo);
...
export function StartDoorAnimationTask(...args: any[]): any {
  if (FuncIsActiveTask(Task_AnimateDoor) == TRUE)
      ...
      {
          let taskId = CreateTask(Task_AnimateDoor, 0x50);
          let data = gTasks[taskId].data;
...
export function DrawClosedDoor(...args: any[]): any {
  DrawClosedDoorTiles(gfx, x, y);
}

/** static void DrawOpenedDoor(const struct DoorGraphics *gfx, u32 x, u32 y) */
export function DrawOpenedDoor(...args: any[]): any {
...
export function StartDoorOpenAnimation(...args: any[]): any {
  gfx = GetDoorGraphics(gfx, MapGridGetMetatileIdAt(x, y));
      if (gfx == NULL)
      {
          return -1;
...
export function StartDoorCloseAnimation(...args: any[]): any {
  gfx = GetDoorGraphics(gfx, MapGridGetMetatileIdAt(x, y));
      if (gfx == NULL)
          return -1;
      else
...
export function GetDoorSoundType(...args: any[]): any {
  gfx = GetDoorGraphics(gfx, MapGridGetMetatileIdAt(x, y));
      if (gfx == NULL)
          return -1;
      else
...
export function FieldSetDoorOpened(...args: any[]): any {
...
export function FieldSetDoorClosed(...args: any[]): any {
  if (MetatileBehavior_IsDoor(MapGridGetMetatileBehaviorAt(x, y)))
          DrawClosedDoor(sDoorAnimGraphicsTable, x, y);
}

/** s8 FieldAnimateDoorClose(u32 x, u32 y) */
export function FieldAnimateDoorClose(...args: any[]): any {
  if (!MetatileBehavior_IsDoor(MapGridGetMetatileBehaviorAt(x, y)))
          return -1;
      else
...
export function FieldAnimateDoorOpen(...args: any[]): any {
  if (!MetatileBehavior_IsDoor(MapGridGetMetatileBehaviorAt(x, y)))
          return -1;
      else
...
export function GetDoorSoundEffect(...args: any[]): any {
  let sound = GetDoorSoundType(sDoorAnimGraphicsTable, x, y);
