...
const {
  AnimateDoorFrame, BuildDoorTiles, CopyDoorTilesToVram, CpuFastCopy,
  CreateTask, CurrentMapDrawMetatileAt, DestroyTask, DrawClosedDoor,
  DrawClosedDoorTiles, DrawCurrentDoorAnimFrame, DrawDoor, DrawDoorMetatileAt,
  DrawOpenedDoor, FlagGet, FuncIsActiveTask, GetDoorGraphics,
  GetDoorSoundType, GetLastDoorFrame, MAP_GROUP, MAP_NUM,
  MapGridGetMetatileBehaviorAt, MapGridGetMetatileIdAt, MetatileBehavior_IsDoor, ShouldUseMultiCorridorDoor,
  StartDoorAnimationTask, StartDoorCloseAnimation, StartDoorOpenAnimation, TILE_OFFSET_4BPP,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
