...
export function Task_SetClock_WaitFadeIn(...args: any[]): any {
...
export function Task_SetClock_HandleInput(...args: any[]): any {
...
export function Task_SetClock_AskConfirm(...args: any[]): any {
...
export function Task_SetClock_HandleConfirmInput(...args: any[]): any {
...
export function Task_SetClock_Confirmed(...args: any[]): any {
...
export function Task_SetClock_Exit(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_ViewClock_WaitFadeIn(...args: any[]): any {
  if (!gPaletteFade.active)
          gTasks[taskId].func = Task_ViewClock_HandleInput;
}

/** static void Task_ViewClock_HandleInput(u8 taskId) */
export function Task_ViewClock_HandleInput(...args: any[]): any {
  InitClockWithRtc(taskId);
...
export function Task_ViewClock_FadeOut(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_ViewClock_Exit;
}

/** static void Task_ViewClock_Exit(u8 taskId) */
export function Task_ViewClock_Exit(...args: any[]): any {
  if (!gPaletteFade.active)
          SetMainCallback2(gMain.savedCallback);
}

/** static u8 CalcMinHandDelta(u16 speed) */
export function CalcMinHandDelta(...args: any[]): any {
  if (speed > 60)
          return 6;
      if (speed > 30)
          return 3;
...
export function CalcNewMinHandAngle(...args: any[]): any {
  let delta = CalcMinHandDelta(speed);
      switch (direction)
      {
      case MOVE_BACKWARD:
          if (angle)
...
export function AdvanceClock(...args: any[]): any {
  switch (direction)
      {
      case MOVE_BACKWARD:
...
export function UpdateClockPeriod(...args: any[]): any {
  let hours = gTasks[taskId].tHours;
      switch (direction)
      {
      case MOVE_BACKWARD:
          switch (hours)
...
export function InitClockWithRtc(...args: any[]): any {
  RtcCalcLocalTime();
...
export function SpriteCB_MinuteHand(...args: any[]): any {
  let angle = gTasks[sprite.sTaskId].tMinuteHandAngle;
...
export function SpriteCB_HourHand(...args: any[]): any {
  let angle = gTasks[sprite.sTaskId].tHourHandAngle;
      let sin = Sin2(angle) / 16;
      let cos = Cos2(angle) / 16;
      let x, y;
...
export function SpriteCB_PMIndicator(...args: any[]): any {
...
export function SpriteCB_AMIndicator(...args: any[]): any {
  if (gTasks[sprite.sTaskId].tPeriod != PERIOD_AM)
      {
