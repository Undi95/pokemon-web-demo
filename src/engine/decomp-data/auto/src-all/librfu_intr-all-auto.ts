...
export function handshake_wait(...args: any[]): any {
  do
      {
...
export function STWI_set_timer_in_RAM(...args: any[]): any {
  let regTMCNTL = REG_TMCNT_L(gSTWIStatus.timerSelect);
      let regTMCNTH = REG_TMCNT_H(gSTWIStatus.timerSelect);
      REG_IME = 0;
      switch (count)
      {
      case 50:
...
export function Callback_Dummy_S(...args: any[]): any {
  asm("bx r1");
}

/** static void Callback_Dummy_ID(void (*callbackId)(void)) */
export function Callback_Dummy_ID(...args: any[]): any {
  asm("bx r0");
}
