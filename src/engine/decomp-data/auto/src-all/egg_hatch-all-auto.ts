...
export function CreateHatchedMon(...args: any[]): any {
...
export function AddHatchedMonToParty(...args: any[]): any {
  let isEgg = 0x46;  
      let species: any = null;
      const name: any[] = [];
      let ball: any = null;
...
export function _CheckDaycareMonReceivedMail(...args: any[]): any {
  const nickname: any[] = [];
...
export function EggHatchCreateMonSprite(...args: any[]): any {
  let position = 0;
      let spriteId = 0;
      let mon: any = NULL;
      ...
      case 0:
           
          {
              ...
              let pid = GetMonData(mon, MON_DATA_PERSONALITY);
...
export function Task_EggHatch(...args: any[]): any {
...
export function Task_EggHatchPlayBGM(...args: any[]): any {
...
export function SpriteCB_Egg_Shake1(...args: any[]): any {
  if (++sprite.sTimer > 20)
      {
...
export function SpriteCB_Egg_Shake2(...args: any[]): any {
...
export function SpriteCB_Egg_Shake3(...args: any[]): any {
  if (++sprite.sDelayTimer > 30)
      {
          if (++sprite.sTimer > 38)
          {
...
export function SpriteCB_Egg_WaitHatch(...args: any[]): any {
  if (++sprite.sTimer > 50)
      {
...
export function SpriteCB_Egg_Hatch(...args: any[]): any {
  let i: any = null;
...
export function SpriteCB_Egg_Reveal(...args: any[]): any {
  if (sprite.sTimer == 0)
      {
...
export function SpriteCB_EggShard(...args: any[]): any {
...
export function CreateRandomEggShardSprite(): any {
  let spriteAnimIndex: any = null;
      ...
      let velocityX = sEggShardVelocities[sEggHatchData.eggShardVelocityId][0];
      let velocityY = sEggShardVelocities[sEggHatchData.eggShardVelocityId][1];
...
export function CreateEggShardSprite(...args: any[]): any {
  let spriteId = CreateSprite(sSpriteTemplate_EggShard, x, y, 4);
...
export function EggHatchPrintMessage(...args: any[]): any {
...
export function GetEggCyclesToSubtract(): any {
  let count, i;
      for (count = CalculatePlayerPartyCount(), i = 0; i < count; i++)
      {
          ...
          {
              let ability = GetMonAbility(gPlayerParty[i]);
