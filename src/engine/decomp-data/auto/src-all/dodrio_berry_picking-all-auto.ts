...
const {
  ...
  DrawDialogueFrame, DrawTextBorderOuter, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset,
  DynamicPlaceholderTextUtil_SetPlaceholderPtr, FREE_AND_SET_NULL, FadeOutAndFadeInNewMapMusic, FadeOutAndPlayNewMapMusic,
  ...
  PIXEL_FILL, PlayFanfareByFanfareNum, PlayNewMapMusic, PlaySE,
  ...
  SWAP, ScriptContext_Enable, SendBlock, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetGpuReg, SetMainCallback2, SetVBlankCallback,
  ShowBg, StartMinigameCountdown, StartSpriteAnim, StopMapMusic,
  TransferPlttBuffer, UpdatePaletteFade, WaitFanfare,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
