...
const {
  ...
  AddTextPrinterParameterized3, AddWindow, AllLinkBlocksReceived, AllPlayersReadyToStart,
  AllocZeroed, AnimateSprites, BG_PLTT_ID, BeginNormalPaletteFade,
  BlendPalettes, BuildOamBuffer, ChangeBgX, ChangeBgY,
  CheckBagHasSpace, ClearRecvCommands, ClearWindowTilemap, ConvertIntToDecimalStringN,
  CopyBgTilemapBufferToVram, CopyItemName, CopyToBgTilemapBuffer, CopyWindowToVram,
  CreateBerrySprites, CreateCloudSprites, CreateDodrioGameTask, CreateDodrioSprite,
  CreateSprite, CreateStatusBarSprites, CreateTask, CreateTask_,
  CreateWirelessStatusIndicatorSprite, DecompressAndCopyTileDataToVram, DestroySprite, DestroySpriteAndFreeResources,
  DestroyTask, DmaClear16, DmaClear32, DmaClearLarge16,
  DoDodrioIntroAnim, DoDodrioMissedAnim, DoStatusBarIntro, DrawDialogueFrame,
  DrawMessageWindow, DrawTextBorderOuter, DrawYesNoMessageWindow, DynamicPlaceholderTextUtil_ExpandPlaceholders,
  DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr, FREE_AND_SET_NULL, FadeOutAndFadeInNewMapMusic,
  FadeOutAndPlayNewMapMusic, FillBgTilemapBufferRect, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, FreeBerrySprites,
  FreeCloudSprites, FreeDodrioSprites, FreeStatusBar, FreeTempTileDataBuffersIfPossible,
  FuncIsActiveTask, GetActiveBerryColumns, GetBerriesPicked, GetBerryResult,
  GetBlockReceivedStatus, GetDodrioXPos, GetGfxFunc, GetHighestBerryResult,
  GetHighestScore, GetLinkPlayerCount, GetLinkPlayerCountAsBitFlags, GetMonData,
  GetMultiplayerId, GetNewBerryId, GetNewBerryIdByDifficulty, GetNumPlayers,
  GetPlayAgainState, GetPlayerIdAtColumn, GetPlayerIdByPos, GetPlayerName,
  GetPrizeItemId, GetScore, GetScoreByRanking, GetScoreResults,
  GetStringCenterAlignXOffset, GetStringWidth, GetTextWindowPalette, GetWindowFrameTilesPal,
  HandlePickBerries, HandleSound_Leader, HandleSound_Member, HandleWaitPlayAgainInput,
  IncrementBerryResult, IncrementWithLimit, InitBgs, InitBgsFromTemplates,
  InitDodrioGame, InitFirstWaveOfBerries, InitGameGfx, InitMonInfo,
  InitStandardTextBoxWindows, InitStatusBarPos, InitTextBoxGfxAndPrinters, IsDma3ManagerBusyWithBgCopy,
  IsGfxFuncActive, IsLinkTaskFinished, IsMinigameCountdownRunning, IsMonShiny,
  IsSEPlaying, IsTotalBerriesMissedOver10, JOY_NEW, LZ77UnCompWram,
  LoadBerryGfx, LoadBgGfx, LoadBgTiles, LoadDodrioGfx,
  LoadOam, LoadPalette, LoadSpritePalette, LoadSpriteSheet,
  LoadUserWindowBorderGfx_, LoadUserWindowFrameGfx, LoadWindowFrameGfx, LoadWirelessStatusIndicatorSpriteGfx,
  Min, PIXEL_FILL, PlayFanfareByFanfareNum, PlayNewMapMusic,
  PlaySE, PrintRankedScores, PrintRecordsText, ProcessSpriteCopyRequests,
  PutWindowTilemap, Random, ReadyToEndGame_Leader, ReadyToEndGame_Member,
  RecvLinkData_Gameplay, RecvLinkData_Leader, RecvLinkData_Member, RecvLinkData_ReadyToEnd,
  RecvPacket_GameState, RecvPacket_PickState, RecvPacket_ReadyToEnd, RecvPacket_ReadyToStart,
  RemoveWindow, ResetBerryAndStatusBarSprites, ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlags,
  ResetCloudPos, ResetForPlayAgainPrompt, ResetGfxState, ResetPickState,
  ResetReadyToStart, ResetSpriteData, ResetTasks, ResetTasksAndSprites,
  ResetTempTileDataBuffers, Rfu_SendPacket, Rfu_SetLinkStandbyCallback, RunTasks,
  SWAP, ScriptContext_Enable, SendBlock, SendLinkData_Leader,
  SendLinkData_Member, SendPacket_GameState, SendPacket_PickState, SendPacket_ReadyToEnd,
  SendPacket_ReadyToStart, SetAllDodrioDisabled, SetAllDodrioInvisibility, SetBerryAnim,
  SetBerryIconsInvisibility, SetBerryInvisibility, SetBerryYPos, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetCloudInvisibility, SetDodrioAnim, SetDodrioInvisibility,
  SetGameFunc, SetGfxFunc, SetGfxFuncById, SetGpuReg,
  SetMainCallback2, SetMaxBerriesPickedInRow, SetRandomPrize, SetScoreResults,
  SetStatusBarInvisibility, SetVBlankCallback, ShowBg, SlideTreeBordersOut,
  StartCloudMovement, StartDodrioIntroAnim, StartDodrioMissedAnim, StartMinigameCountdown,
  StartSpriteAnim, StopMapMusic, Task_ShowDodrioBerryPickingRecords, TransferPlttBuffer,
  TryGivePrize, TryIncrementDifficulty, TryPickBerry, TryUpdateRecords,
  UpdateAllDodrioAnims, UpdateBerriesPickedInRow, UpdateBerrySprites, UpdateFallingBerries,
  UpdateGame_Leader, UpdateGame_Member, UpdatePaletteFade, UpdatePickStateQueue,
  UpdateStatusBarAnim, WaitFanfare,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
