...
export function RouletteFlash_Reset(...args: any[]): any {
  flash.enabled = 0;
      flash.flags = 0;
...
export function RouletteFlash_Add(...args: any[]): any {
...
export function RouletteFlash_FadePalette(...args: any[]): any {
  let i: any = null;
      let returnval: any = null;

      for (i = 0; i < pal.settings.numColors; i++)
      {
          let faded: any =   (struct PlttData *)&gPlttBufferFaded[pal.settings.paletteOffset + i];
          let unfaded: any = (struct PlttData *)&gPlttBufferUnfaded[pal.settings.paletteOffset + i];
...
export function RouletteFlash_FlashPalette(...args: any[]): any {
  let i = 0;
      switch (pal.state)
      {
      case 1:
...
export function RouletteFlash_Run(...args: any[]): any {
  let i = 0;
...
export function RouletteFlash_Enable(...args: any[]): any {
  let i = 0;
...
export function RouletteFlash_Stop(...args: any[]): any {
  let i: any = null;
      ...
      for (i = 0; i < ARRAY_COUNT(flash.palettes); i++)
      {
          if ((flash.flags >> i) & 1)
          {
              if (flash.palettes[i].available)
              {
                  if ((flags >> i) & 1)
                  {
                      let offset = flash.palettes[i].settings.paletteOffset;
                      let faded = gPlttBufferFaded[offset];
                      let unfaded = gPlttBufferUnfaded[offset];
...
export function InitPulseBlend(...args: any[]): any {
  let i = 0;
...
export function InitPulseBlendPaletteSettings(...args: any[]): any {
  let i = 0;
...
export function ClearPulseBlendPalettesSettings(...args: any[]): any {
  let i: any = null;
...
export function UnloadUsedPulseBlendPalettes(...args: any[]): any {
  let i = 0;
...
export function MarkUsedPulseBlendPalettes(...args: any[]): any {
  let i = 0;
...
export function UnmarkUsedPulseBlendPalettes(...args: any[]): any {
  let i: any = null;
      let pulseBlendPalette: any = null;
      let j = 0;
...
export function UpdatePulseBlend(...args: any[]): any {
  let pulseBlendPalette: any = null;
      let i = 0;
              ...
              if ((!pulseBlendPalette.available && pulseBlendPalette.inUse) && (!gPaletteFade.active || !pulseBlendPalette.pulseBlendSettings.unk7_7))
              {
                  if (--pulseBlendPalette.delayCounter == 0xFF)
                  {
                      ...
                      case 1:  
                          ...
                          {
                              let max = (pulseBlendPalette.pulseBlendSettings.maxBlendCoeff - 1) & 0xF;
...
export function FillTilemapRect(...args: any[]): any {
  let _dest: any = null;
      let i: any = null;
      let j: any = null;
      i = 0;
...
export function SetTilemapRect(...args: any[]): any {
  let _dest: any = null;
      let _src = src;
      let i: any = null;
      let j: any = null;
