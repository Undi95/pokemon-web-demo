...
export function CanMewMoveToCoords(...args: any[]): any {
...
export function GetValidMewMoveDirection(...args: any[]): any {
  let i: any = null;
      let count = 0;
      let mew: any = gObjectEvents[GetMewObjectEventId()];
...
export function ObjectEventIsFarawayIslandMew(...args: any[]): any {
  if (gSaveBlock1Ptr.location.mapNum == MAP_NUM(MAP_FARAWAY_ISLAND_INTERIOR)
       && gSaveBlock1Ptr.location.mapGroup == MAP_GROUP(MAP_FARAWAY_ISLAND_INTERIOR))
      {
...
export function ShouldMewShakeGrass(...args: any[]): any {
...
export function ShouldMewMoveNorth(...args: any[]): any {
...
export function ShouldMewMoveEast(...args: any[]): any {
...
export function ShouldMewMoveSouth(...args: any[]): any {
  if (sPlayerToMewDeltaY < 0 && CanMewMoveToCoords(mew.currentCoords.x, mew.currentCoords.y + 1))
      {
...
export function ShouldMewMoveWest(...args: any[]): any {
  if (sPlayerToMewDeltaX > 0 && CanMewMoveToCoords(mew.currentCoords.x - 1, mew.currentCoords.y))
      {
...
export function GetRandomMewDirectionCandidate(...args: any[]): any {
