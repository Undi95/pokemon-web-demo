...
export function OpenPokenavMenu(): any {
  let gfx: any = AllocSubstruct(POKENAV_SUBSTRUCT_MENU_GFX, sizeof(struct Pokenav_MenuGfx));
...
export function CreateMenuHandlerLoopedTask(...args: any[]): any {
...
export function LoopedTask_OpenMenu(...args: any[]): any {
  let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX);
...
export function LoopedTask_MoveMenuCursor(...args: any[]): any {
  switch (state)
      {
      case 0:
          SetMenuOptionGlow();
...
export function LoopedTask_OpenConditionMenu(...args: any[]): any {
  switch (state)
      {
      case 0:
          ResetBldCnt();
...
export function LoopedTask_ReturnToMainMenu(...args: any[]): any {
  switch (state)
      {
      case 0:
          ResetBldCnt();
...
export function LoopedTask_OpenConditionSearchMenu(...args: any[]): any {
  switch (state)
      {
      case 0:
          ResetBldCnt();
...
export function LoopedTask_ReturnToConditionMenu(...args: any[]): any {
  switch (state)
      {
      case 0:
          ResetBldCnt();
...
export function LoopedTask_SelectRibbonsNoWinners(...args: any[]): any {
  switch (state)
      {
      case 0:
          PlaySE(SE_FAILURE);
...
export function LoopedTask_ReShowDescription(...args: any[]): any {
  switch (state)
      {
      case 0:
          PlaySE(SE_SELECT);
...
export function LoopedTask_OpenPokenavFeature(...args: any[]): any {
  switch (state)
      {
      case 0:
...
export function DrawOptionLabelGfx(...args: any[]): any {
  let i, j;
      let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX);
...
export function StartOptionSlide(...args: any[]): any {
  let i: any = null;
...
export function StartOptionZoom(...args: any[]): any {
  let i: any = null;
      let gfx: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX);
      let taskId: any = null;
...
export function SetOptionInvisibility(...args: any[]): any {
  let i: any = null;
...
export function SpriteCB_OptionSlide(...args: any[]): any {
  sprite.sSlideTime--;
...
export function SpriteCB_OptionZoom(...args: any[]): any {
  let temp: any = null;
      let x: any = null;
...
export function Task_OptionBlend(...args: any[]): any {
...
export function SpriteCB_BlinkingBlueLight(...args: any[]): any {
  sprite.data[0]++;
      if (sprite.data[0] > 8)
      {
          sprite.data[0] = 0;
...
export function Task_UpdateBgDotsPalette(...args: any[]): any {
  const sp8: any[] = [];
      let data = gTasks[taskId].data;
      let pal1 = (const u16 *)GetWordTaskArg(taskId, 1);
      let pal2 = (const u16 *)GetWordTaskArg(taskId, 3);
...
export function Task_CurrentMenuOptionGlow(...args: any[]): any {
  let data = gTasks[taskId].data;
      data[0]++;
      if (data[0] > 0)
      {
