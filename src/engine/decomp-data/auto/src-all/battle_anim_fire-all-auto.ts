...
export function AnimFireSpiralInward(...args: any[]): any {
...
export function AnimFireSpread(...args: any[]): any {
...
export function AnimFirePlume(...args: any[]): any {
...
export function AnimLargeFlame(...args: any[]): any {
  if (GetBattlerSide(gBattleAnimAttacker))
      {
          sprite.x -= gBattleAnimArgs[0];
          sprite.y += gBattleAnimArgs[1];
...
export function AnimLargeFlame_Step(...args: any[]): any {
...
export function AnimUnusedSmallEmber(...args: any[]): any {
  SetSpriteCoordsToAnimAttackerCoords(sprite);
...
export function AnimUnusedSmallEmber_Step(...args: any[]): any {
  if (sprite.data[3])
      {
...
export function AnimSunlight(...args: any[]): any {
  sprite.x = 0;
      sprite.y = 0;
      sprite.data[0] = 60;
      sprite.data[2] = 140;
...
export function AnimEmberFlare(...args: any[]): any {
...
export function AnimBurnFlame(...args: any[]): any {
...
export function AnimFireRing(...args: any[]): any {
...
export function AnimFireRing_Step1(...args: any[]): any {
...
export function AnimFireRing_Step2(...args: any[]): any {
...
export function AnimFireRing_Step3(...args: any[]): any {
  UpdateFireRingCircleOffset(sprite);
...
export function UpdateFireRingCircleOffset(...args: any[]): any {
  sprite.x2 = Sin(sprite.data[7], 28);
      sprite.y2 = Cos(sprite.data[7], 28);
...
export function AnimFireCross(...args: any[]): any {
  sprite.x += gBattleAnimArgs[0];
      sprite.y += gBattleAnimArgs[1];
...
export function AnimFireSpiralOutward(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
...
export function AnimFireSpiralOutward_Step1(...args: any[]): any {
...
export function AnimFireSpiralOutward_Step2(...args: any[]): any {
...
export function AnimTask_EruptionLaunchRocks(...args: any[]): any {
...
export function AnimTask_EruptionLaunchRocks_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateEruptionLaunchRocks(...args: any[]): any {
  let i, j;
      let sign: any = null;

      let y = GetEruptionLaunchRockInitialYPos(spriteId);
      let x = gSprites[spriteId].x;
      ...
      for (i = 0, j = 0; i <= 6; i++)
      {
          let spriteId = CreateSprite(gEruptionLaunchRockSpriteTemplate, x, y, 2);
...
export function AnimEruptionLaunchRock(...args: any[]): any {
...
export function GetEruptionLaunchRockInitialYPos(...args: any[]): any {
  let y = gSprites[spriteId].y + gSprites[spriteId].y2 + gSprites[spriteId].centerToCornerVecY;
...
export function InitEruptionLaunchRockCoordData(...args: any[]): any {
...
export function UpdateEruptionLaunchRockPos(...args: any[]): any {
...
export function AnimEruptionFallingRock(...args: any[]): any {
  sprite.x = gBattleAnimArgs[0];
      sprite.y = gBattleAnimArgs[1];
...
export function AnimEruptionFallingRock_Step(...args: any[]): any {
...
export function AnimWillOWispOrb(...args: any[]): any {
...
export function AnimWillOWispOrb_Step(...args: any[]): any {
...
export function AnimWillOWispFire(...args: any[]): any {
  if (!sprite.data[0])
      {
...
export function AnimTask_MoveHeatWaveTargets(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_MoveHeatWaveTargets_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_BlendBackground(...args: any[]): any {
  let animBg: any = null;
...
export function AnimTask_ShakeTargetInPattern(...args: any[]): any {
  let dir: any = null;
