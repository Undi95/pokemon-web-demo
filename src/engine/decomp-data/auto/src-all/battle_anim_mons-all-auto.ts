...
export function GetBattlerYDelta(battler: any, species: any): any {
  let letter: any = null;
...
export function GetBattlerSpriteFinal_Y(battler: any, species: any, a3: any): any {
  let offset: any = null;
      let y: any = null;
...
export function GetBattlerSpriteCoord2(battler: any, coordType: any): any {
  let species: any = null;
      let spriteInfo: any = null;
...
export function GetBattlerSpriteDefault_Y(battler: any): any {
...
export function GetBattlerYCoordWithElevation(battler: any): any {
  let species: any = null;
      let y: any = null;
      let spriteInfo: any = null;
...
export function StoreSpriteCallbackInData6(sprite: any, callback: any): any {
  sprite.data[6] = (callback) & 0xffff;
      sprite.data[7] = (callback) >> 16;
}

/** void SetCallbackToStoredInData6(struct Sprite *sprite) */
export function SetCallbackToStoredInData6(sprite: any): any {
  let callback: any = sprite.data[6] | (sprite.data[7] << 16);
      sprite.callback = callback;
}

/** void TranslateSpriteInCircle(struct Sprite *sprite) */
export function TranslateSpriteInCircle(sprite: any): any {
  if (sprite.sDuration)
      {
...
export function TranslateSpriteInGrowingCircle(sprite: any): any {
  if (sprite.sDuration)
      {
...
export function TranslateSpriteInEllipse(sprite: any): any {
  if (sprite.sDuration)
      {
...
export function WaitAnimForDuration(sprite: any): any {
  if (sprite.data[0] > 0)
          sprite.data[0]--;
      else
          SetCallbackToStoredInData6(sprite);
...
export function AnimPosToTranslateLinear(sprite: any): any {
...
export function ConvertPosDataToTranslateLinearData(sprite: any): any {
  let old: any = null;
      let xDiff: any = null;
...
export function TranslateSpriteLinear(sprite: any): any {
...
export function TranslateSpriteLinearFixedPoint(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
...
export function TranslateSpriteLinearFixedPointIconFrame(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
          sprite.data[3] += sprite.data[1];
...
export function TranslateSpriteLinearById(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
...
export function TranslateSpriteLinearByIdFixedPoint(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
          sprite.data[3] += sprite.data[1];
...
export function TranslateSpriteLinearAndFlicker(sprite: any): any {
  if (sprite.data[0] > 0)
      {
          sprite.data[0]--;
...
export function DestroySpriteAndMatrix(sprite: any): any {
  FreeSpriteOamMatrix(sprite);
      DestroyAnimSprite(sprite);
}

/** void RunStoredCallbackWhenAffineAnimEnds(struct Sprite *sprite) */
export function RunStoredCallbackWhenAffineAnimEnds(sprite: any): any {
  if (sprite.affineAnimEnded)
          SetCallbackToStoredInData6(sprite);
}

/** void RunStoredCallbackWhenAnimEnds(struct Sprite *sprite) */
export function RunStoredCallbackWhenAnimEnds(sprite: any): any {
  if (sprite.animEnded)
          SetCallbackToStoredInData6(sprite);
}

/** void DestroyAnimSpriteAndDisableBlend(struct Sprite *sprite) */
export function DestroyAnimSpriteAndDisableBlend(sprite: any): any {
...
export function DestroyAnimVisualTaskAndDisableBlend(taskId: any): any {
  SetGpuReg(REG_OFFSET_BLDCNT, 0);
      SetGpuReg(REG_OFFSET_BLDALPHA, 0);
...
export function SetSpriteCoordsToAnimAttackerCoords(sprite: any): any {
  sprite.x = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite.y = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
}

/** void SetAnimSpriteInitialXOffset(struct Sprite *sprite, s16 xOffset) */
export function SetAnimSpriteInitialXOffset(sprite: any, xOffset: any): any {
  let attackerX: any = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X);
      let targetX: any = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X);
...
export function InitAnimArcTranslation(sprite: any): any {
...
export function TranslateAnimHorizontalArc(sprite: any): any {
...
export function TranslateAnimVerticalArc(sprite: any): any {
  if (AnimTranslateLinear(sprite))
          return TRUE;
      sprite.data[7] += sprite.data[6];
      sprite.x2 += Sin((sprite.data[7] >> 8), sprite.data[5]);
      return FALSE;
}

/** void SetSpritePrimaryCoordsFromSecondaryCoords(struct Sprite *sprite) */
export function SetSpritePrimaryCoordsFromSecondaryCoords(sprite: any): any {
  sprite.x += sprite.x2;
      sprite.y += sprite.y2;
      sprite.x2 = 0;
      sprite.y2 = 0;
...
export function InitSpritePosToAnimTarget(sprite: any, respectMonPicOffsets: any): any {
...
export function InitSpritePosToAnimAttacker(sprite: any, respectMonPicOffsets: any): any {
  if (!respectMonPicOffsets)
      {
...
export function GetBattlerSide(battler: any): any {
  return GET_BATTLER_SIDE2(battler);
}

/** u8 GetBattlerPosition(u8 battler) */
export function GetBattlerPosition(battler: any): any {
  return gBattlerPositions[battler];
}

/** u8 GetBattlerAtPosition(u8 position) */
export function GetBattlerAtPosition(position: any): any {
  let i: any = null;
...
export function IsBattlerSpritePresent(battler: any): any {
  if (IsContest())
      {
...
export function GetBattleAnimBg1Data(out: any): any {
  if (IsContest())
      {
...
export function GetBattleAnimBgData(out: any, bgId: any): any {
  if (IsContest())
      {
          out.bgTiles = gBattleAnimBgTileBuffer;
          out.bgTilemap = gBattleAnimBgTilemapBuffer;
...
export function GetBgDataForTransform(out: any, battler: any): any {
  out.bgTiles = gBattleAnimBgTileBuffer;
      out.bgTilemap = gBattleAnimBgTilemapBuffer;
      if (IsContest())
      {
...
export function ClearBattleAnimBg(bgId: any): any {
...
export function InitAnimBgTilemapBuffer(bgId: any, src: any): any {
  FillBgTilemapBufferRect(bgId, 0, 0, 0, 32, 64, 17);
      CopyToBgTilemapBuffer(bgId, src, 0, 0);
}

/** void AnimLoadCompressedBgTilemap(u32 bgId, const void *src) */
export function AnimLoadCompressedBgTilemap(bgId: any, src: any): any {
...
export function AnimLoadCompressedBgTilemapHandleContest(data: any, src: any, largeScreen: any): any {
...
export function UpdateAnimBg3ScreenSize(largeScreenSize: any): any {
...
export function Trade_MoveSelectedMonToTarget(sprite: any): any {
  sprite.data[1] = sprite.x;
      sprite.data[3] = sprite.y;
...
export function InitSpriteDataForLinearTranslation(sprite: any): any {
  let x: any = (sprite.data[2] - sprite.data[1]) << 8;
      let y: any = (sprite.data[4] - sprite.data[3]) << 8;
...
export function InitAnimLinearTranslation(sprite: any): any {
  let x: any = sprite.data[2] - sprite.data[1];
      let y: any = sprite.data[4] - sprite.data[3];
      let movingLeft: any = x < 0;
      let movingUp: any = y < 0;
      let xDelta: any = abs(x) << 8;
      let yDelta: any = abs(y) << 8;
...
export function StartAnimLinearTranslation(sprite: any): any {
  sprite.data[1] = sprite.x;
      sprite.data[3] = sprite.y;
      InitAnimLinearTranslation(sprite);
...
export function AnimTranslateLinear(sprite: any): any {
  let v1, v2, x, y;
...
export function AnimTranslateLinear_WithFollowup(sprite: any): any {
  if (AnimTranslateLinear(sprite))
          SetCallbackToStoredInData6(sprite);
}

/** static void AnimTranslateLinear_WithFollowup_SetCornerVecX(struct Sprite *sprite) */
export function AnimTranslateLinear_WithFollowup_SetCornerVecX(sprite: any): any {
...
export function InitAnimLinearTranslationWithSpeed(sprite: any): any {
  let v1: any = abs(sprite.data[2] - sprite.data[1]) << 8;
      sprite.data[0] = v1 / sprite.data[0];
      InitAnimLinearTranslation(sprite);
}

/** void InitAnimLinearTranslationWithSpeedAndPos(struct Sprite *sprite) */
export function InitAnimLinearTranslationWithSpeedAndPos(sprite: any): any {
  sprite.data[1] = sprite.x;
      sprite.data[3] = sprite.y;
...
export function InitAnimFastLinearTranslation(sprite: any): any {
  let xDiff: any = sprite.data[2] - sprite.data[1];
      let yDiff: any = sprite.data[4] - sprite.data[3];
      let x_sign: any = xDiff < 0;
      let y_sign: any = yDiff < 0;
      let x2: any = abs(xDiff) << 4;
      let y2: any = abs(yDiff) << 4;
...
export function InitAndRunAnimFastLinearTranslation(sprite: any): any {
  sprite.data[1] = sprite.x;
      sprite.data[3] = sprite.y;
...
export function AnimFastTranslateLinear(sprite: any): any {
  let v1, v2, x, y;
...
export function AnimFastTranslateLinearWaitEnd(sprite: any): any {
  if (AnimFastTranslateLinear(sprite))
          SetCallbackToStoredInData6(sprite);
}

/** void InitAnimFastLinearTranslationWithSpeed(struct Sprite *sprite) */
export function InitAnimFastLinearTranslationWithSpeed(sprite: any): any {
  let xDiff: any = abs(sprite.data[2] - sprite.data[1]) << 4;
      sprite.data[0] = xDiff / sprite.data[0];
      InitAnimFastLinearTranslation(sprite);
}

/** void InitAnimFastLinearTranslationWithSpeedAndPos(struct Sprite *sprite) */
export function InitAnimFastLinearTranslationWithSpeedAndPos(sprite: any): any {
  sprite.data[1] = sprite.x;
      sprite.data[3] = sprite.y;
...
export function SetSpriteRotScale(spriteId: any, xScale: any, yScale: any, rotation: any): any {
  let i: any = null;
      let src: any = null;
      let matrix: any = null;
...
export function PrepareBattlerSpriteForRotScale(spriteId: any, objMode: any): any {
  let battler: any = gSprites[spriteId].data[0];
...
export function SetBattlerSpriteYOffsetFromRotation(spriteId: any): any {
  let matrixNum: any = gSprites[spriteId].oam.matrixNum;
       
      let c: any = gOamMatrices[matrixNum].c;
      if (c < 0)
          c = -c;
...
export function TrySetSpriteRotScale(sprite: any, recalcCenterVector: any, xScale: any, yScale: any, rotation: any): any {
  let i: any = null;
      let src: any = null;
      let matrix: any = null;
...
export function ArcTan2_(x: any, y: any): any {
  return ArcTan2(x, y);
}

/** u16 ArcTan2Neg(s16 x, s16 y) */
export function ArcTan2Neg(x: any, y: any): any {
  let _var: any = ArcTan2_(x, y);
      return -_var;
}

/** void SetGrayscaleOrOriginalPalette(u16 paletteNum, bool8 restoreOriginalColor) */
export function SetGrayscaleOrOriginalPalette(paletteNum: any, restoreOriginalColor: any): any {
  let i: any = null;
      let originalColor: any = null;
      let destColor: any = null;
      let average: any = null;
      let paletteOffset: any = PLTT_ID(paletteNum);

      if (!restoreOriginalColor)
      {
          for (i = 0; i < 16; i++)
          {
              originalColor =gPlttBufferUnfaded[paletteOffset + i];
              average = originalColor.r + originalColor.g + originalColor.b;
              average /= 3;

              destColor =gPlttBufferFaded[paletteOffset + i];
              destColor.r = average;
              destColor.g = average;
              destColor.b = average;
          }
...
export function GetBattlePalettesMask(battleBackground: any, attacker: any, target: any, attackerPartner: any, targetPartner: any, anim1: any, anim2: any): any {
...
export function GetBattleMonSpritePalettesMask(playerLeft: any, playerRight: any, opponentLeft: any, opponentRight: any): any {
  let selectedPalettes: any = 0;
      let shift: any = null;
...
export function GetSpritePalIdxByBattler(battler: any): any {
  return battler;
}

/** void AnimSpriteOnMonPos(struct Sprite *sprite) */
export function AnimSpriteOnMonPos(sprite: any): any {
...
export function TranslateAnimSpriteToTargetMonLocation(sprite: any): any {
  let respectMonPicOffsets: any = null;
...
export function AnimThrowProjectile(sprite: any): any {
...
export function AnimThrowProjectile_Step(sprite: any): any {
  if (TranslateAnimHorizontalArc(sprite))
          DestroyAnimSprite(sprite);
}

/** void AnimTravelDiagonally(struct Sprite *sprite) */
export function AnimTravelDiagonally(sprite: any): any {
  let respectMonPicOffsets: any = null;
...
export function CloneBattlerSpriteWithBlend(animBattler: any): any {
  let i: any = null;
...
export function DestroySpriteWithActiveSheet(sprite: any): any {
  sprite.usingSheet = TRUE;
      DestroySprite(sprite);
}

/** void AnimTask_AlphaFadeIn(u8 taskId) */
export function AnimTask_AlphaFadeIn(taskId: any): any {
  let v1: any = 0;
      let v2: any = 0;
...
export function AnimTask_AlphaFadeIn_Step(taskId: any): any {
...
export function AnimTask_BlendPalInAndOutSetup(task: any): any {
...
export function AnimTask_BlendMonInAndOut_Step(taskId: any): any {
  let task: any =gTasks[taskId];
...
export function AnimTask_BlendPalInAndOutByTag(task: any): any {
  let palette: any = IndexOfSpritePaletteTag(gBattleAnimArgs[0]);
...
export function PrepareAffineAnimInTaskData(task: any, spriteId: any, affineAnimCmds: any): any {
  task.data[7] = 0;
      task.data[8] = 0;
      task.data[9] = 0;
...
export function RunAffineAnimFromTaskData(task: any): any {
  sAnimTaskAffineAnim =(LoadPointerFromVars(task.data[13], task.data[14]))[task.data[7]];
...
export function GetBattlerYDeltaFromSpriteId(spriteId: any): any {
  let spriteInfo: any = null;
      let battler: any = gSprites[spriteId].data[0];
      let species: any = null;
      let i: any = null;
...
export function StorePointerInVars(lo: any, hi: any, ptr: any): any {
  lo = (ptr) & 0xffff;
      hi = ((ptr) >> 16) & 0xffff;
}
...
export function PrepareEruptAnimTaskData(task: any, spriteId: any, xScaleStart: any, yScaleStart: any, xScaleEnd: any, yScaleEnd: any, duration: any): any {
...
export function UpdateEruptAnimTask(task: any): any {
  if (!task.data[8])
          return 0;
...
export function AnimTask_GetFrustrationPowerLevel(taskId: any): any {
...
export function GetBattlerSpriteSubpriority(battler: any): any {
...
export function GetBattlerSpriteBGPriority(battler: any): any {
...
export function GetBattlerSpriteBGPriorityRank(battler: any): any {
  if (!IsContest())
      {
          let position: any = GetBattlerPosition(battler);
...
export function CreateAdditionalMonSpriteForMoveAnim(species: any, isBackpic: any, id: any, x: any, y: any, subpriority: any, personality: any, trainerId: any, battler: any, ignoreDeoxysForm: any): any {
  let spriteId: any = null;
      let sheet: any = LoadSpriteSheet(sSpriteSheets_MoveEffectMons[id]);
...
export function DestroySpriteAndFreeResources_(sprite: any): any {
  DestroySpriteAndFreeResources(sprite);
}

/** s16 GetBattlerSpriteCoordAttr(u8 battler, u8 attr) */
export function GetBattlerSpriteCoordAttr(battler: any, attr: any): any {
  let species: any = null;
      let personality: any = null;
      let letter: any = null;
...
export function SetAverageBattlerPositions(battler: any, respectMonPicOffsets: any, x: any, y: any): any {
...
export function CreateInvisibleSpriteCopy(battler: any, spriteId: any, species: any): any {
  let newSpriteId: any = CreateInvisibleSpriteWithCallback(SpriteCallbackDummy);
...
export function AnimTranslateLinearAndFlicker_Flipped(sprite: any): any {
...
export function AnimSpinningSparkle(sprite: any): any {
  SetSpriteCoordsToAnimAttackerCoords(sprite);
      if (GetBattlerSide(gBattleAnimAttacker))
          sprite.x -= gBattleAnimArgs[0];
      else
...
export function AnimTask_AttackerPunchWithTrace(taskId: any): any {
  let src: any = null;
      let dest: any = null;
      let task: any =gTasks[taskId];
...
export function AnimTask_AttackerPunchWithTrace_Step(taskId: any): any {
  let task: any =gTasks[taskId];
      switch (task.tState)
      {
      case 0:
...
export function CreateBattlerTrace(task: any, taskId: any): any {
...
export function AnimBattlerTrace(sprite: any): any {
...
export function AnimWeatherBallUp_Step(sprite: any): any {
...
export function AnimWeatherBallDown(sprite: any): any {
  let x: any = null;
      sprite.data[0] = gBattleAnimArgs[2];
