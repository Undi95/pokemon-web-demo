...
export function CheckTrainer(...args: any[]): any {
...
export function GetTrainerApproachDistance(...args: any[]): any {
  let x, y;
      let i: any = null;
      let approachDistance: any = null;
...
export function GetTrainerApproachDistanceSouth(...args: any[]): any {
...
export function GetTrainerApproachDistanceNorth(...args: any[]): any {
  if (trainerObj.currentCoords.x == x
       && y < trainerObj.currentCoords.y
       && y >= trainerObj.currentCoords.y - range)
...
export function GetTrainerApproachDistanceWest(...args: any[]): any {
...
export function GetTrainerApproachDistanceEast(...args: any[]): any {
  if (trainerObj.currentCoords.y == y
       && x > trainerObj.currentCoords.x
       && x <= trainerObj.currentCoords.x + range)
...
export function CheckPathBetweenTrainerAndPlayer(...args: any[]): any {
  let x, y;
      let rangeX, rangeY;
      let i: any = null;
...
export function InitTrainerApproachTask(...args: any[]): any {
  let task: any = null;
...
export function StartTrainerApproach(...args: any[]): any {
  let taskId: any = null;
      TaskFunc taskFunc;
...
export function Task_RunTrainerSeeFuncList(...args: any[]): any {
...
export function TrainerSeeIdle(...args: any[]): any {
  return FALSE;
}

/** static bool8 TrainerExclamationMark(u8 taskId, struct Task *task, struct ObjectEvent *trainerObj) */
export function TrainerExclamationMark(...args: any[]): any {
...
export function WaitTrainerExclamationMark(...args: any[]): any {
...
export function TrainerMoveToPlayer(...args: any[]): any {
...
export function PlayerFaceApproachingTrainer(...args: any[]): any {
...
export function WaitPlayerFaceApproachingTrainer(...args: any[]): any {
...
export function RevealDisguisedTrainer(...args: any[]): any {
...
export function WaitRevealDisguisedTrainer(...args: any[]): any {
...
export function RevealBuriedTrainer(...args: any[]): any {
  if (!ObjectEventIsMovementOverridden(trainerObj)
       || ObjectEventClearHeldMovementIfFinished(trainerObj))
      {
          ObjectEventSetHeldMovement(trainerObj, MOVEMENT_ACTION_FACE_PLAYER);
...
export function PopOutOfAshBuriedTrainer(...args: any[]): any {
...
export function JumpInPlaceBuriedTrainer(...args: any[]): any {
  let sprite: any = null;
...
export function WaitRevealBuriedTrainer(...args: any[]): any {
...
export function Task_SetBuriedTrainerMovement(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function SetBuriedTrainerMovement(...args: any[]): any {
...
export function Task_EndTrainerApproach(...args: any[]): any {
  DestroyTask(taskId);
...
export function SetIconSpriteData(...args: any[]): any {
...
export function SpriteCB_TrainerIcons(...args: any[]): any {
...
export function GetChosenApproachingTrainerObjectEventId(...args: any[]): any {
