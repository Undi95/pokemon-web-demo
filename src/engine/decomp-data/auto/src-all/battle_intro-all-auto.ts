...
export function SetAnimBgAttribute(...args: any[]): any {
  if (bgId < 4)
      {
...
export function GetAnimBgAttribute(...args: any[]): any {
  let bgCnt: any = null;
...
export function HandleIntroSlide(...args: any[]): any {
  let taskId: any = null;
...
export function BattleIntroSlideEnd(...args: any[]): any {
  DestroyTask(taskId);
      gBattle_BG1_X = 0;
      gBattle_BG1_Y = 0;
      gBattle_BG2_X = 0;
...
export function BattleIntroSlide1(...args: any[]): any {
  let i: any = null;
...
export function BattleIntroSlide2(...args: any[]): any {
  let i: any = null;
...
export function BattleIntroSlide3(...args: any[]): any {
  let i: any = null;
...
export function BattleIntroSlideLink(...args: any[]): any {
  let i: any = null;

      if (gTasks[taskId].tState > 1 && !gTasks[taskId].data[4])
      {
          let var0 = gBattle_BG1_X & 0x8000;
...
export function BattleIntroSlidePartner(...args: any[]): any {
  switch (gTasks[taskId].tState)
      {
      case 0:
          gTasks[taskId].data[2] = 1;
...
export function DrawBattlerOnBg(...args: any[]): any {
  let i, j;
      let battler = GetBattlerAtPosition(battlerPosition);
