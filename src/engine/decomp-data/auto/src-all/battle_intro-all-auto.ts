...
const {
  ...
  BLDALPHA_BLEND, BattleIntroSlideEnd, Cos2, CpuCopy16,
  CpuFill32, CreateTask, DestroyTask, GetBattlerAtPosition,
  GetGpuReg, LoadBgTilemap, LoadBgTiles, SetBgAttribute,
