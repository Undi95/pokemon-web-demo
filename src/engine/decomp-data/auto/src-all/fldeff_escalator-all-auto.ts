...
const {
  CreateEscalatorTask, CreateTask, DestroyTask, DrawWholeMapView,
  MapGridGetMetatileIdAt, MapGridSetMetatileIdAt, PlayerGetDestCoords, SetEscalatorMetatile,
  Task_DrawEscalator,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
