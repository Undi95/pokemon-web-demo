...
export function LoadIntroPart2Graphics(...args: any[]): any {
...
export function SetIntroPart2BgCnt(...args: any[]): any {
  switch (scenery)
      {
      default:
      case 0:
...
export function LoadCreditsSceneGraphics(...args: any[]): any {
  LZ77UnCompVram(sGrass_Gfx, (void *)(BG_CHAR_ADDR(1)));
      LZ77UnCompVram(sGrass_Tilemap, (void *)(BG_SCREEN_ADDR(15)));
      switch (scene)
      {
...
export function SetCreditsSceneBgCnt(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BG3CNT, BGCNT_PRIORITY(3)
                                 | BGCNT_CHARBASE(0)
                                 | BGCNT_16COLOR
                                 | BGCNT_SCREENBASE(6)
...
export function CreateBicycleBgAnimationTask(...args: any[]): any {
  let taskId = CreateTask(Task_BicycleBgAnimation, 0);
...
export function Task_BicycleBgAnimation(...args: any[]): any {
...
export function CycleSceneryPalette(...args: any[]): any {
  let x: any = null;
      let y: any = null;
      switch (mode)
      {
...
export function SpriteCB_MovingScenery(...args: any[]): any {
  let x: any = null;
...
export function CreateMovingScenerySprites(...args: any[]): any {
  let i: any = null;

      for(i = 0; i < numSprites; i++)
      {
          let sprite = CreateSprite(sSpriteTemplate_MovingScenery, metadata[i].x, metadata[i].y, metadata[i].subpriority);
...
export function SpriteCB_Bicycle(...args: any[]): any {
...
export function CreateIntroBrendanSprite(...args: any[]): any {
  let playerSpriteId = CreateSprite(sSpriteTemplate_Brendan, x, y, 2);
      let bicycleSpriteId = CreateSprite(sSpriteTemplate_BrendanBicycle, x, y + 8, 3);
      gSprites[bicycleSpriteId].sPlayerSpriteId = playerSpriteId;
      return playerSpriteId;
}

/** u8 CreateIntroMaySprite(s16 x, s16 y) */
export function CreateIntroMaySprite(...args: any[]): any {
  let playerSpriteId = CreateSprite(sSpriteTemplate_May, x, y, 2);
      let bicycleSpriteId = CreateSprite(sSpriteTemplate_MayBicycle, x, y + 8, 3);
      gSprites[bicycleSpriteId].sPlayerSpriteId = playerSpriteId;
      return playerSpriteId;
}

/** static void SpriteCB_FlygonRightHalf(struct Sprite *sprite) */
export function SpriteCB_FlygonRightHalf(...args: any[]): any {
...
export function CreateIntroFlygonSprite(...args: any[]): any {
  let leftSpriteId = CreateSprite(sSpriteTemplate_FlygonLatias, x - 32, y, 5);
      let rightSpriteId = CreateSprite(sSpriteTemplate_FlygonLatias, x + 32, y, 6);
