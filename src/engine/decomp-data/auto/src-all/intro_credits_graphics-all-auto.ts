...
const {
  ...
  DISPCNT_BG2_ON, DISPCNT_BG3_ON, DISPCNT_BG_ALL_ON, DISPCNT_OBJ_1D_MAP,
  DISPCNT_OBJ_ON, DestroySprite, FALSE, LZ77UnCompVram,
  LoadCompressedSpriteSheet, LoadPalette, OBJ_PLTT_ID, REG_OFFSET_BG1CNT,
  ...
  ST_OAM_AFFINE_OFF, SetGpuReg, StartSpriteAnim, TRUE,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
