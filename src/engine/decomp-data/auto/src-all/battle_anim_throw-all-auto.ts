...
const {
  ...
  DIRECTION, DISPLAY_HEIGHT, DISPLAY_WIDTH, DestroyAnimSprite,
  DestroyAnimVisualTask, DestroySprite, DestroySpriteAndFreeResources, DestroyTask,
  FALL, FALSE, FreeBallGfx, FreeOamMatrix,
  FreeSpriteOamMatrix, FreeSpritePaletteByTag, FreeSpriteTilesByTag, FuncIsActiveTask,
  GET_SHINY_VALUE, GetBattleAnimBg1Data, GetBattlePalettesMask, GetBattlerAtPosition,
  GetBattlerSide, GetBattlerSpriteBGPriorityRank, GetBattlerSpriteCoord, GetBattlerSpriteSubpriority,
  GetGpuReg, GetMonData, GetSpriteTileStartByTag, IndexOfSpritePaletteTag,
  InitAnimArcTranslation, InitSpritePosToAnimAttacker, IsBattlerSpriteVisible, IsContest,
  LoadBallGfx, LoadBattleMonGfxAndAnimate, LoadCompressedPalette, LoadCompressedSpritePaletteUsingHeap,
  LoadCompressedSpriteSheetUsingHeap, LoadPalette, OBJ_PLTT_ID, PHASE_DELTA,
  PLTT_SIZE_4BPP, PlaySE, PlaySE12WithPanning, PrepareBattlerSpriteForRotScale,
  REG_OFFSET_BLDALPHA, REG_OFFSET_BLDCNT, REG_OFFSET_DISPCNT, REG_OFFSET_WININ,
  REG_OFFSET_WINOUT, RESET_STATE, RISE_FASTER, RequestDma3Fill,
  ResetBattleAnimBg, ResetSpriteRotScale, SHAKES, SHAKE_INC,
  STATE, ST_OAM_OBJ_BLEND, ST_OAM_OBJ_NORMAL, ST_OAM_OBJ_WINDOW,
  SetAnimBgAttribute, SetBattlerSpriteYOffsetFromYScale, SetGpuReg, SetGpuRegBits,
  SetSpriteRotScale, Sin, SpriteCallbackDummy, StartSpriteAffineAnim,
  StartSpriteAnim, TILE_SIZE_4BPP, TRUE, TranslateAnimHorizontalArc,
  UpdateOamPriorityInAllHealthboxes, m4aMPlayAllStop, sDirection,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
