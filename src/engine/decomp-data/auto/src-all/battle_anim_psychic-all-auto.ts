...
export function AnimDefensiveWall(...args: any[]): any {
  let isContest = IsContest();
      ...
      if (!isContest)
      {
          ...
          let battler = battlerCopy = GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT);
          let rank = GetBattlerSpriteBGPriorityRank(battler);
          let var0 = 1;
          let toBG_2 = (rank ^ var0) != 0;
...
export function AnimDefensiveWall_Step1(...args: any[]): any {
  let battler = GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT);
      if (!sprite.data[7])
      {
          sprite.data[7] = 1;
          return;
...
export function AnimDefensiveWall_Step2(...args: any[]): any {
...
export function AnimDefensiveWall_Step3(...args: any[]): any {
  let color: any = null;
...
export function AnimDefensiveWall_Step4(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(sprite.data[3], 16 - sprite.data[3]));
...
export function AnimDefensiveWall_Step5(...args: any[]): any {
  if (!IsContest())
      {
          let battlerCopy: any = null;
          let battler = battlerCopy = GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT);
...
export function AnimWallSparkle(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          let ignoreOffsets = gBattleAnimArgs[3];
...
export function AnimBentSpoon(...args: any[]): any {
...
export function AnimQuestionMark(...args: any[]): any {
  let x = GetBattlerSpriteCoordAttr(gBattleAnimAttacker, BATTLER_COORD_ATTR_WIDTH) /  2;
      let y = GetBattlerSpriteCoordAttr(gBattleAnimAttacker, BATTLER_COORD_ATTR_HEIGHT) / -2;
...
export function AnimQuestionMark_Step1(...args: any[]): any {
...
export function AnimQuestionMark_Step2(...args: any[]): any {
...
export function AnimTask_MeditateStretchAttacker(...args: any[]): any {
...
export function AnimTask_MeditateStretchAttacker_Step(...args: any[]): any {
  if (!RunAffineAnimFromTaskData(gTasks[taskId]))
          DestroyAnimVisualTask(taskId);
}

/** void AnimTask_Teleport(u8 taskId) */
export function AnimTask_Teleport(...args: any[]): any {
  let task: any = gTasks[taskId];
      let spriteId = GetAnimBattlerSpriteId(ANIM_ATTACKER);
      task.data[0] = spriteId;
      task.data[1] = 0;
...
export function AnimTask_Teleport_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_ImprisonOrbs(...args: any[]): any {
  let var0, var1;
...
export function AnimTask_ImprisonOrbs_Step(...args: any[]): any {
  let i: any = null;
...
export function AnimRedX_Step(...args: any[]): any {
...
export function AnimRedX(...args: any[]): any {
...
export function AnimTask_SkillSwap(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_SkillSwap_Step(...args: any[]): any {
  let spriteId: any = null;
      let task: any = gTasks[taskId];
...
export function AnimSkillSwapOrb(...args: any[]): any {
...
export function AnimTask_ExtrasensoryDistortion(...args: any[]): any {
  let i: any = null;
...
export function AnimTask_ExtrasensoryDistortion_Step(...args: any[]): any {
  let sineIndex, i;
      let task: any = gTasks[taskId];
...
export function AnimTask_TransparentCloneGrowAndShrink(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimTask_TransparentCloneGrowAndShrink_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimPsychoBoost(...args: any[]): any {
  switch (sprite.data[0])
      {
      case 0:
