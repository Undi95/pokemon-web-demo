...
export function AnimMegahornHorn(...args: any[]): any {
...
export function AnimLeechLifeNeedle(...args: any[]): any {
...
export function AnimTranslateWebThread(...args: any[]): any {
...
export function AnimTranslateWebThread_Step(...args: any[]): any {
...
export function AnimStringWrap(...args: any[]): any {
  CMD_ARGS(x, y);
...
export function AnimStringWrap_Step(...args: any[]): any {
  if (++sprite.data[0] == 3)
      {
          sprite.data[0] = 0;
          sprite.invisible ^= 1;
...
export function AnimSpiderWeb(...args: any[]): any {
...
export function AnimSpiderWeb_Step(...args: any[]): any {
  if (sprite.data[2] < 20)
      {
          sprite.data[2]++;
      }
...
export function AnimSpiderWeb_End(...args: any[]): any {
...
export function AnimTranslateStinger(...args: any[]): any {
...
export function AnimMissileArc(...args: any[]): any {
...
export function AnimMissileArc_Step(...args: any[]): any {
  sprite.invisible = FALSE;
      ...
      else
      {
          ...
          if (!TranslateAnimHorizontalArc(sprite))
          {
              let rotation = ArcTan2Neg(sprite.x + sprite.x2 - x2,
...
export function AnimTailGlowOrb(...args: any[]): any {
  CMD_ARGS(relativeTo);
