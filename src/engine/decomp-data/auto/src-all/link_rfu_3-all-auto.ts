...
export function RfuRecvQueue_Reset(...args: any[]): any {
  let i: any = null;
      let j: any = null;
...
export function RfuSendQueue_Reset(...args: any[]): any {
  let i: any = null;
      let j: any = null;
...
export function RfuRecvQueue_Enqueue(...args: any[]): any {
  let i: any = null;
      let imeBak: any = null;
      let count: any = null;
...
export function RfuSendQueue_Enqueue(...args: any[]): any {
  let i: any = null;
      let imeBak: any = null;
...
export function RfuRecvQueue_Dequeue(...args: any[]): any {
  let imeBak: any = null;
      let i: any = null;
...
export function RfuSendQueue_Dequeue(...args: any[]): any {
  let i: any = null;
      let imeBak: any = null;
...
export function RfuBackupQueue_Enqueue(...args: any[]): any {
  let i: any = null;
...
export function RfuBackupQueue_Dequeue(...args: any[]): any {
  let i: any = null;
...
export function GetConnectedChildStrength(...args: any[]): any {
  let flagCount = 0;
      let flags = gRfuLinkStatus.connSlotFlag;
      let i: any = null;
...
export function InitHostRfuGameData(...args: any[]): any {
  let i: any = null;
...
export function Rfu_GetCompatiblePlayerData(...args: any[]): any {
  let retVal: any = null;
...
export function Rfu_GetWonderDistributorPlayerData(...args: any[]): any {
  let retVal = FALSE;
...
export function CopyHostRfuGameDataAndUsername(...args: any[]): any {
  memcpy(gameData, gHostRfuGameData, RFU_GAME_NAME_LENGTH);
      memcpy(username, gHostRfuUsername, RFU_USER_NAME_LENGTH);
}

/** void CreateWirelessStatusIndicatorSprite(u8 x, u8 y) */
export function CreateWirelessStatusIndicatorSprite(...args: any[]): any {
  let sprId: any = null;
  ...
  if (gSprites[gWirelessStatusIndicatorSpriteId].sValidator == STATUS_INDICATOR_ACTIVE)
      {
          ...
          CpuCopy16(gDummyOamData, OAM + 125, sizeof(struct OamData));
      }
}
...
export function SetWirelessStatusIndicatorAnim(...args: any[]): any {
  ...
  if (gWirelessStatusIndicatorSpriteId != SPRITE_NONE && gSprites[gWirelessStatusIndicatorSpriteId].sValidator == STATUS_INDICATOR_ACTIVE)
      {
          ...
          CpuCopy16(gMain.oamBuffer[125], OAM + 125, sizeof(struct OamData));
...
export function CopyTrainerRecord(...args: any[]): any {
  dest.trainerId = trainerId;
      StringCopy(dest.trainerName, name);
}

/** static bool32 NameIsNotEmpty(const u8 *name) */
export function NameIsNotEmpty(...args: any[]): any {
  let i: any = null;
...
export function PlayerHasMetTrainerBefore(...args: any[]): any {
  let i: any = null;
