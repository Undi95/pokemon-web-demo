...
export function ComputerScreenOpenEffect(...args: any[]): any {
...
export function ComputerScreenCloseEffect(...args: any[]): any {
...
export function CreateComputerScreenEffectTask(...args: any[]): any {
  let taskId = CreateTask(func, priority);
...
export function Task_ComputerScreenOpenEffect(...args: any[]): any {
...
export function Task_ComputerScreenCloseEffect(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function SpriteCB_CaveEntranceInit(...args: any[]): any {
...
export function SpriteCB_CaveEntranceOpen(...args: any[]): any {
  if (sprite.data[0] < 40)
      {
          if (++sprite.data[0] == 20)
...
export function SpriteCB_CaveEntranceEnd(...args: any[]): any {
...
export function SpriteCB_TreeEntranceInit(...args: any[]): any {
  PlaySE(SE_M_SCRATCH);
...
export function SpriteCB_TreeEntranceOpen(...args: any[]): any {
  sprite.data[0]++;
...
export function SpriteCB_TreeEntranceEnd(...args: any[]): any {
...
export function SpriteCB_ShrubEntranceInit(...args: any[]): any {
...
export function SpriteCB_ShrubEntranceOpen(...args: any[]): any {
  if (sprite.data[0] < 40)
      {
          sprite.data[0]++;
...
export function SpriteCB_ShrubEntranceEnd(...args: any[]): any {
...
export function Task_SecretBasePCTurnOn(...args: any[]): any {
...
export function PopSecretBaseBalloon(...args: any[]): any {
  let taskId = CreateTask(Task_PopSecretBaseBalloon, 0);
...
export function Task_PopSecretBaseBalloon(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function DoBalloonSoundEffect(...args: any[]): any {
  switch (metatileId)
      {
...
export function DoSecretBaseBreakableDoorEffect(...args: any[]): any {
...
export function Task_ShatterSecretBaseBreakableDoor(...args: any[]): any {
...
export function ShatterSecretBaseBreakableDoor(...args: any[]): any {
  let dir = GetPlayerFacingDirection();
      ...
      {
          let taskId = CreateTask(Task_ShatterSecretBaseBreakableDoor, 5);
...
export function Task_SecretBaseMusicNoteMatSound(...args: any[]): any {
...
export function PlaySecretBaseMusicNoteMatSound(...args: any[]): any {
  let taskId = CreateTask(Task_SecretBaseMusicNoteMatSound, 5);
...
export function SpriteCB_GlitterMatSparkle(...args: any[]): any {
  sprite.data[0]++;
...
export function DoSecretBaseGlitterMatSparkle(): any {
  let x = gObjectEvents[gPlayerAvatar.objectEventId].currentCoords.x;
      let y = gObjectEvents[gPlayerAvatar.objectEventId].currentCoords.y;
...
export function SpriteCB_SandPillar_BreakTop(...args: any[]): any {
  PlaySE(SE_M_ROCK_THROW);
...
export function SpriteCB_SandPillar_BreakBase(...args: any[]): any {
  if (sprite.data[0] < 18)
      {
          sprite.data[0]++;
      }
...
export function SpriteCB_SandPillar_End(...args: any[]): any {
...
export function IsLargeBreakableDecoration(...args: any[]): any {
...
export function Task_FieldPoisonEffect(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_WateringBerryTreeAnim(...args: any[]): any {
  gTasks[taskId].func = Task_WateringBerryTreeAnim_Start;
}

/** static void Task_WateringBerryTreeAnim_Start(u8 taskId) */
export function Task_WateringBerryTreeAnim_Start(...args: any[]): any {
...
export function Task_WateringBerryTreeAnim_Continue(...args: any[]): any {
  let playerObjEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];

      if (ObjectEventClearHeldMovementIfFinished(playerObjEvent))
      {
          let value = gTasks[taskId].data[1]++;
...
export function Task_WateringBerryTreeAnim_End(...args: any[]): any {
