...
export function rfu_LMAN_REQBN_softReset_and_checkID(): any {
  let id = rfu_REQBN_softReset_and_checkID();
      if (id == RFU_ID)
...
export function rfu_LMAN_REQ_sendData(...args: any[]): any {
...
export function rfu_LMAN_initializeManager(...args: any[]): any {
...
export function rfu_LMAN_initializeRFU(...args: any[]): any {
...
export function rfu_LMAN_establishConnection(...args: any[]): any {
  let i: any = null;
...
export function rfu_LMAN_CHILD_connectParent(...args: any[]): any {
  let i: any = null;
...
export function rfu_LMAN_stopManager(...args: any[]): any {
  let msg = 0;
      lman.pcswitch_flag = 0;
...
export function rfu_LMAN_linkWatcher(...args: any[]): any {
  let i: any = null;
      ...
      let disconnect_occure_flag = FALSE;
...
export function rfu_LMAN_manager_entity(...args: any[]): any {
  let msg: any = null;
...
export function rfu_LMAN_settingPCSWITCH(...args: any[]): any {
...
export function rfu_LMAN_REQ_callback(...args: any[]): any {
  let status: any = null;
...
export function rfu_LMAN_MSC_callback(...args: any[]): any {
...
export function rfu_LMAN_occureCallback(...args: any[]): any {
...
export function rfu_LMAN_disconnect(...args: any[]): any {
  let active_bak = lman.active;
      lman.active = 1;
...
export function rfu_LMAN_reflectCommunicationStatus(...args: any[]): any {
  let i: any = null;
...
export function rfu_LMAN_setMSCCallback(...args: any[]): any {
  lman.MSC_callback = MSC_callback_p;
      rfu_setMSCCallback(rfu_LMAN_MSC_callback);
}

/** u8 rfu_LMAN_setLinkRecovery(u8 enable_flag, u16 recovery_period) */
export function rfu_LMAN_setLinkRecovery(...args: any[]): any {
  let imeBak: any = null;
