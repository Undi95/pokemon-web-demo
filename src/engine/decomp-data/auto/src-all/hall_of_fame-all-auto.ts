...
export function CB2_DoHallOfFameScreen(): any {
  if (!InitHallOfFameScreen())
      {
          let taskId = CreateTask(Task_Hof_InitMonData, 0);
...
export function Task_Hof_InitMonData(...args: any[]): any {
  let i, j;
...
export function Task_Hof_InitTeamSaveData(...args: any[]): any {
  let i: any = null;
      let lastSavedTeam: any = (struct HallofFameTeam *)(gDecompressionBuffer);
      ...
      {
          let afterTeam: any = (struct HallofFameTeam *)(gDecompressionBuffer);
          let beforeTeam: any = (struct HallofFameTeam *)(gDecompressionBuffer);
          afterTeam++;
...
export function Task_Hof_TrySaveData(...args: any[]): any {
...
export function Task_Hof_WaitToDisplayMon(...args: any[]): any {
...
export function Task_Hof_SetMonDisplayTask(...args: any[]): any {
  gTasks[taskId].func = Task_Hof_DisplayMon;
}

/** static void Task_Hof_DisplayMon(u8 taskId) */
export function Task_Hof_DisplayMon(...args: any[]): any {
  let spriteId: any = null;
      let startX, startY, destX, destY;

      let currMonId = gTasks[taskId].tDisplayedMonId;
...
export function Task_Hof_PrintMonInfoAfterAnimating(...args: any[]): any {
  let currMonId = gTasks[taskId].tDisplayedMonId;
      let currMon: any = sHofMonPtr.mon[currMonId];
...
export function Task_Hof_TryDisplayAnotherMon(...args: any[]): any {
  let currPokeID = gTasks[taskId].tDisplayedMonId;
...
export function Task_Hof_PaletteFadeAndPrintWelcomeText(...args: any[]): any {
  let i: any = null;
...
export function Task_Hof_DoConfetti(...args: any[]): any {
  if (gTasks[taskId].tFrameCount != 0)
      {
          gTasks[taskId].tFrameCount--;
...
export function Task_Hof_WaitToDisplayPlayer(...args: any[]): any {
...
export function Task_Hof_DisplayPlayer(...args: any[]): any {
...
export function Task_Hof_WaitAndPrintPlayerInfo(...args: any[]): any {
  if (gTasks[taskId].tFrameCount != 0)
      {
          gTasks[taskId].tFrameCount--;
      }
...
export function Task_Hof_ExitOnKeyPressed(...args: any[]): any {
  if (JOY_NEW(A_BUTTON))
      {
          FadeOutBGM(4);
...
export function Task_Hof_HandlePaletteOnExit(...args: any[]): any {
...
export function Task_Hof_HandleExit(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          let i: any = null;
          ...
          for (i = 0; i < PARTY_SIZE; i++)
          {
              let spriteId = gTasks[taskId].tMonSpriteId(i);
...
export function CB2_DoHallOfFamePC(): any {
  switch (gMain.state)
      ...
      case 3:
          if (!LoadHofBgs())
          {
              let fameTeam: any = (struct HallofFameTeam *)(gDecompressionBuffer);
...
export function Task_HofPC_CopySaveData(...args: any[]): any {
...
export function Task_HofPC_DrawSpritesPrintText(...args: any[]): any {
...
export function Task_HofPC_PrintMonInfo(...args: any[]): any {
  let savedTeams: any = sHofMonPtr;
      let currMon: any = null;
      let i: any = null;
...
export function Task_HofPC_HandleInput(...args: any[]): any {
  let i: any = null;
...
export function Task_HofPC_HandlePaletteOnExit(...args: any[]): any {
...
export function Task_HofPC_HandleExit(...args: any[]): any {
...
export function Task_HofPC_PrintDataIsCorrupted(...args: any[]): any {
...
export function Task_HofPC_ExitOnButtonPress(...args: any[]): any {
  if (JOY_NEW(A_BUTTON))
          gTasks[taskId].func = Task_HofPC_HandlePaletteOnExit;
}

/** static void HallOfFame_PrintWelcomeText(u8 unusedPossiblyWindowId, u8 unused2) */
export function HallOfFame_PrintWelcomeText(...args: any[]): any {
  FillWindowPixelBuffer(0, PIXEL_FILL(0));
      PutWindowTilemap(0);
...
export function HallOfFame_PrintMonInfo(...args: any[]): any {
  const text: any[] = [];
...
export function HallOfFame_PrintPlayerInfo(...args: any[]): any {
  const text: any[] = [];
      let width: any = null;
...
export function SpriteCB_GetOnScreenAndAnimate(...args: any[]): any {
...
export function SpriteCB_HofConfetti(...args: any[]): any {
  if (sprite.y2 > 120)
      {
...
export function UpdateDomeConfetti(...args: any[]): any {
  if (util.yDelta > 110)
      {
...
export function Task_DoDomeConfetti(...args: any[]): any {
  let id = 0;
