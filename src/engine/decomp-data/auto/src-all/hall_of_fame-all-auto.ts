...
const {
  ...
  DrawStdFrameWithCustomTileAndPalette, FALSE, FadeOutBGM, FillBgTilemapBufferRect_Palette0,
  FillWindowPixelBuffer, FindTaskIdByFunc, FreeAllSpritePalettes, FreeAllWindowBuffers,
  FreeAndDestroyMonPicSprite, FreeAndDestroyTrainerPicSprite, FreeOamMatrix, FreeSpritePaletteByTag,
  FreeSpriteTilesByTag, FreeTempTileDataBuffersIfPossible, GetGameStat, GetGenderFromSpeciesAndPersonality,
  GetMonData, GetStringCenterAlignXOffset, GetStringRightAlignXOffset, GetTextWindowPalette,
  HideBg, HofPCTopBar_AddWindow, HofPCTopBar_Print, HofPCTopBar_PrintPair,
  HofPCTopBar_RemoveWindow, InitBgsFromTemplates, InitStandardTextBoxWindows, InitTextBoxGfxAndPrinters,
  IsComputerScreenCloseEffectActive, IsComputerScreenOpenEffectActive, IsCryPlayingOrClearCrySongs, JOY_NEW,
  LoadCompressedSpritePalette, LoadCompressedSpriteSheet, LoadGameSave, LoadOam,
  LoadPalette, LoadWindowGfx, NULL, PALETTES_ALL,
  PIXEL_FILL, PLTT_SIZE, PLTT_SIZE_4BPP, PlayBGM,
  ...
  STR_CONV_MODE_RIGHT_ALIGN, ST_OAM_AFFINE_OFF, ScanlineEffect_Stop, SetBgTilemapBuffer,
