...
const {
  ...
  BLDCNT_TGT1_BG1, BLDCNT_TGT1_BG2, BLDCNT_TGT2_BD, BLDCNT_TGT2_BG0,
  BLDCNT_TGT2_BG1, BLDCNT_TGT2_BG2, BLDCNT_TGT2_BG3, BLDCNT_TGT2_OBJ,
  BeginNormalPaletteFade, BgAffineSet, BlendPalette, BuildOamBuffer,
  CalcCenterToCornerVec, Cos, CpuCopy16, CpuFill16,
  CpuFill32, CreateBicycleBgAnimationTask, CreateIntroBrendanSprite, CreateIntroFlygonSprite,
  CreateIntroMaySprite, CreateSprite, CreateTask, CycleSceneryPalette,
  DISPCNT_BG0_ON, DISPCNT_BG1_ON, DISPCNT_BG2_ON, DISPCNT_BG_ALL_ON,
  DISPCNT_MODE_1, DISPCNT_OBJ_1D_MAP, DISPCNT_OBJ_ON, DISPCNT_WIN0_ON,
  DISPLAY_HEIGHT, DestroySprite, DestroyTask, DmaClear16,
  EnableInterrupts, FALSE, FreeAllSpritePalettes, GET_TRUE_SPRITE_INDEX,
  ...
  LZ77UnCompVram, LZDecompressVram, LoadCompressedSpritePaletteUsingHeap, LoadCompressedSpriteSheet,
  LoadCompressedSpriteSheetUsingHeap, LoadGameSave, LoadIntroPart2Graphics, LoadOam,
  LoadPalette, LoadSpritePalette, LoadSpritePalettes, MOD,
  NULL, OBJ_PLTT_ID, PALETTES_ALL, PALETTES_BG,
  PLTT_SIZE, PLTT_SIZEOF, PLTT_SIZE_4BPP, PlayCryInternal,
  PlaySE, ProcessSpriteCopyRequests, Q_8_8_TO_INT, REG_OFFSET_BG0CNT,
