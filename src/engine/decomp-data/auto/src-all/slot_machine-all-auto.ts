...
const {
  ...
  BG_PLTT_ID, BLDALPHA_BLEND, BLDCNT_EFFECT_BLEND, BLDCNT_TGT1_BG3,
  BLDCNT_TGT2_OBJ, BeginNormalPaletteFade, BuildOamBuffer, ClearDialogWindowAndFrame,
  ClearWindowTilemap, CopyWindowToVram, Cos, CpuFill32,
  CreateInvisibleSprite, CreateSprite, CreateTask, CreateYesNoMenuParameterized,
  DISPCNT_OBJ_1D_MAP, DISPCNT_OBJ_ON, DISPCNT_WIN0_ON, DISPLAY_HEIGHT,
  DeactivateAllTextPrinters, DestroySprite, DestroyTask, DmaClear16,
  DmaClearLarge16, DrawDialogueFrame, EnableInterrupts, FALSE,
  FREE_AND_SET_NULL, FillWindowPixelBuffer, FindTaskIdByFunc, FreeAllSpritePalettes,
  FreeOamMatrix, GetCoins, GetCurrentMapMusic, GetSpriteTileStartByTag,
  HideBg, IncrementDailySlotsUses, IncrementGameStat, IndexOfSpritePaletteTag,
  InitBgsFromTemplates, InitSpriteAffineAnim, InitWindows, IsFanfareTaskInactive,
  JOY_HELD, JOY_NEW, LZDecompressWram, LoadBgTilemap,
  ...
  LoadWordFromTwoHalfwords, Menu_ProcessInputNoWrapClearOnChoose, MultiplyInvertedPaletteRGBComponents, MultiplyPaletteRGBComponents,
  NULL, OBJ_PLTT_ID, PALETTES_ALL, PIXEL_FILL,
  PLTT_SIZEOF, PLTT_SIZE_4BPP, PlayFanfare, PlayNewMapMusic,
  ...
  REG_OFFSET_BG3CNT, REG_OFFSET_BG3HOFS, REG_OFFSET_BG3VOFS, REG_OFFSET_BLDALPHA,
  REG_OFFSET_BLDCNT, REG_OFFSET_MOSAIC, REG_OFFSET_WIN0H, REG_OFFSET_WIN0V,
  REG_OFFSET_WININ, REG_OFFSET_WINOUT, Random, RemoveWindow,
  ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData, ResetTasks,
  RunTasks, ST_OAM_AFFINE_DOUBLE, SetCoins, SetGpuReg,
  SetHBlankCallback, SetMainCallback2, SetSpriteSheetFrameTileNum, SetSubspriteTables,
