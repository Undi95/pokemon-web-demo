...
const {
  ...
  BG_PLTT_ID, BLDALPHA_BLEND, BeginNormalPaletteFade, BuildOamBuffer,
  ClearDialogWindowAndFrame, ClearWindowTilemap, CopyWindowToVram, Cos,
  CpuFill32, CreateInvisibleSprite, CreateSprite, CreateTask,
  CreateYesNoMenuParameterized, DeactivateAllTextPrinters, DestroySprite, DestroyTask,
  DmaClear16, DmaClearLarge16, DrawDialogueFrame, EnableInterrupts,
  ...
  OBJ_PLTT_ID, PIXEL_FILL, PLTT_SIZEOF, PlayFanfare,
  ...
  ResetSpriteData, ResetTasks, RunTasks, SetCoins,
  SetGpuReg, SetHBlankCallback, SetMainCallback2, SetSpriteSheetFrameTileNum,
  SetSubspriteTables, SetVBlankCallback, ShowBg, Sin,
  StartSpriteAnim, StartSpriteAnimIfDifferent, StopMapMusic, StoreWordInTwoHalfwords,
  TRY_FREE_AND_SET_NULL, TransferPlttBuffer, TryPutFindThatGamerOnAir, UpdatePaletteFade,
