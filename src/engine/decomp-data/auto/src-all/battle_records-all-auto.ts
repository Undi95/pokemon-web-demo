...
export function ClearLinkBattleRecord(...args: any[]): any {
...
export function ClearLinkBattleRecords(...args: any[]): any {
  let i: any = null;
...
export function GetLinkBattleRecordTotalBattles(...args: any[]): any {
  return record.wins + record.losses + record.draws;
}

/** static s32 FindLinkBattleRecord(struct LinkBattleRecord *records, const u8 *name, u16 trainerId) */
export function FindLinkBattleRecord(...args: any[]): any {
  let i: any = null;
...
export function SortLinkBattleRecords(...args: any[]): any {
  let i, j;
      ...
      for (i = LINK_B_RECORDS_COUNT - 1; i > 0; i--)
      {
          for (j = i - 1; j >= 0; j--)
          {
              let totalBattlesI = GetLinkBattleRecordTotalBattles(records.entries[i]);
              let totalBattlesJ = GetLinkBattleRecordTotalBattles(records.entries[j]);
...
export function UpdateLinkBattleRecord(...args: any[]): any {
...
export function UpdateLinkBattleGameStats(...args: any[]): any {
  let stat: any = null;
...
export function UpdateLinkBattleRecords(...args: any[]): any {
  let index: any = null;
...
export function IncTrainerCardWins(...args: any[]): any {
  let wins = gTrainerCards[battler].linkBattleWins;
      (*wins)++;
      if (*wins > 9999)
          *wins = 9999;
}
...
export function IncTrainerCardLosses(...args: any[]): any {
  let losses = gTrainerCards[battler].linkBattleLosses;
      (*losses)++;
      if (*losses > 9999)
          *losses = 9999;
}
...
export function UpdateTrainerCardWinsLosses(...args: any[]): any {
...
export function UpdatePlayerLinkBattleRecords(...args: any[]): any {
  if (InUnionRoom() != TRUE)
      {
...
export function PrintLinkBattleWinsLossesDraws(...args: any[]): any {
  let x: any = null;
...
export function PrintLinkBattleRecord(...args: any[]): any {
...
export function Task_TrainerHillWaitForPaletteFade(...args: any[]): any {
  if (!gPaletteFade.active)
          gTasks[taskId].func = Task_CloseTrainerHillRecordsOnButton;
}

/** static void Task_CloseTrainerHillRecordsOnButton(u8 taskId) */
export function Task_CloseTrainerHillRecordsOnButton(...args: any[]): any {
...
export function Task_BeginPaletteFade(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 0x10, RGB_BLACK);
      gTasks[taskId].func = Task_ExitTrainerHillRecords;
}

/** static void Task_ExitTrainerHillRecords(u8 taskId) */
export function Task_ExitTrainerHillRecords(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function RemoveTrainerHillRecordsWindow(...args: any[]): any {
...
export function LoadTrainerHillRecordsWindowGfx(...args: any[]): any {
