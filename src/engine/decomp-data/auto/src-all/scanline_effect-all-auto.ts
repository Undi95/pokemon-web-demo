...
const {
  ...
  DmaStop, GenerateWave, ScanlineEffect_Clear, ScanlineEffect_SetParams,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
...
export function ScanlineEffect_Clear(): any {
  CpuFill16(0, gScanlineEffectRegBuffers, 0);
...
export function ScanlineEffect_SetParams(params: any): any {
...
export function CopyValue16Bit(): any {
  let dest: any = gScanlineEffect.dmaDest;
      let src: any =gScanlineEffectRegBuffers[gScanlineEffect.srcBuffer];
...
export function TaskFunc_UpdateWavePerFrame(taskId: any): any {
  let value: any = 0;
      let i: any = null;
      let offset: any = null;
...
export function GenerateWave(buffer: any, frequency: any, amplitude: any, unused: any): any {
  let i: any = 0;
      let theta: any = 0;
...
export function ScanlineEffect_InitWave(startLine: any, endLine: any, frequency: any, amplitude: any, delayInterval: any, regOffset: any, applyBattleBgOffsets: any): any {
  let i: any = null;
      let offset: any = null;
      let params: any = null;
      let taskId: any = null;
      ...
      params.dmaDest = (REG_ADDR_BG0HOFS + regOffset);
