...
export function ResetLinkRfuGFLayer(): any {
  let i: any = null;
      let errorState = gRfu.errorState;
...
export function Task_ParentSearchForChildren(...args: any[]): any {
  UpdateChildStatuses();
      switch (gRfu.state)
      {
      case RFUSTATE_INIT:
...
export function Rfu_GetIndexOfNewestChild(...args: any[]): any {
  return sPlayerBitsToNewChildIdx[bits];
}

/** static void SetLinkPlayerIdsFromSlots(s32 baseSlots, s32 addSlots) */
export function SetLinkPlayerIdsFromSlots(...args: any[]): any {
  let i: any = null;
      let baseId = 1;
      let baseSlotsCopy = baseSlots;
      let newId = 0;
      if (addSlots == -1)
      {
...
export function Task_ChildSearchForParent(...args: any[]): any {
  switch (gRfu.state)
      {
      case RFUSTATE_INIT:
...
export function InitChildRecvBuffers(): any {
  let i: any = null;
      let acceptSlot = lman.acceptSlot_flag;
...
export function Task_UnionRoomListen(...args: any[]): any {
...
export function MSCCallback_Child(...args: any[]): any {
  let i: any = null;
...
export function MSCCallback_Parent(...args: any[]): any {
...
export function WaitRfuState(...args: any[]): any {
...
export function UpdateBackupQueue(): any {
  if (gRfu.linkRecovered)
      {
          let backupEmpty = RfuBackupQueue_Dequeue(gRfu.backupQueue, gRfu.childSendBuffer);
...
export function ChildBuildSendCmd(...args: any[]): any {
  let i: any = null;
...
export function HandleSendFailure(...args: any[]): any {
  let i, j, temp;

      let payload = gRfu.sendBlock.payload;
...
export function Rfu_SetBlockReceivedFlag(...args: any[]): any {
...
export function Rfu_ResetBlockReceivedFlag(...args: any[]): any {
...
export function LoadLinkPlayerIds(...args: any[]): any {
  let i: any = null;
      if (gRfu.parentChild == MODE_PARENT)
          return FALSE;
      for (i = 0; i < RFU_CHILD_MAX; i++)
...
export function RfuHandleReceiveCommand(...args: any[]): any {
  let i: any = null;
      let j: any = null;
...
export function ResetSendDataManager(...args: any[]): any {
  data.next = 0;
      data.count = 0;
      data.payload = NULL;
...
export function RfuPrepareSendBuffer(...args: any[]): any {
  let i: any = null;
      let buff: any = null;
      let tmp: any = null;
...
export function Rfu_SendPacket(...args: any[]): any {
...
export function Rfu_InitBlockSend(...args: any[]): any {
  let r4: any = null;
      if (gRfu.callback != NULL)
          return FALSE;
      if (gSendCmd[0] != 0)
...
export function SendNextBlock(): any {
  let i: any = null;
      let src = gRfu.sendBlock.payload;
...
export function Rfu_SendBlockRequest(...args: any[]): any {
...
export function WaitAllReadyToCloseLink(): any {
  let i: any = null;
      let playerCount = gRfu.playerCount;
      let count = 0;
...
export function Task_TryReadyCloseLink(...args: any[]): any {
  if (gRfu.callback == NULL)
      {
...
export function IsRfuSerialNumberValid(...args: any[]): any {
  let i: any = null;
...
export function Rfu_SetLinkRecovery(...args: any[]): any {
  if (enable == FALSE)
...
export function HasTrainerLeftPartnersList(...args: any[]): any {
  let idx = GetPartnerIndexByNameAndTrainerID(name, trainerId);
      if (idx == 0xFF)
          return TRUE;
...
export function SendRfuStatusToPartner(...args: any[]): any {
  let idx = GetPartnerIndexByNameAndTrainerID(name, trainerId);
...
export function WaitSendRfuStatusToPartner(...args: any[]): any {
  let idx = GetPartnerIndexByNameAndTrainerID(name, trainerId);
      if (idx == 0xFF)
          return 2;
...
export function Task_PlayerExchange(...args: any[]): any {
  let i: any = null;
...
export function ClearSelectedLinkPlayerIds(...args: any[]): any {
  let i: any = null;
...
export function ReceiveRfuLinkPlayers(...args: any[]): any {
  let i: any = null;
...
export function ValidateAndReceivePokemonSioInfo(...args: any[]): any {
...
export function Task_PlayerExchangeUpdate(...args: any[]): any {
  let i: any = null;
...
export function Task_PlayerExchangeChat(...args: any[]): any {
  if (gRfu.status == RFU_STATUS_FATAL_ERROR || gRfu.status == RFU_STATUS_CONNECTION_ERROR)
          DestroyTask(taskId);
      switch (gTasks[taskId].tState)
      {
...
export function SetHostRfuGameData(...args: any[]): any {
...
export function SetHostRfuWonderFlags(...args: any[]): any {
  gHostRfuGameData.compatibility.hasNews = hasNews;
      gHostRfuGameData.compatibility.hasCard = hasCard;
}

/** void SetTradeBoardRegisteredMonInfo(u32 type, u32 species, u32 level) */
export function SetTradeBoardRegisteredMonInfo(...args: any[]): any {
...
export function GetLinkPlayerInfoFlags(...args: any[]): any {
...
export function UpdateGameData_GroupLockedIn(...args: any[]): any {
...
export function UpdateGameData_SetActivity(...args: any[]): any {
...
export function SetUnionRoomChatPlayerData(...args: any[]): any {
  let i: any = null;
...
export function RfuSetErrorParams(...args: any[]): any {
  if (gRfu.errorState == RFU_ERROR_STATE_NONE)
      {
...
export function RfuSetIgnoreError(...args: any[]): any {
  if (!enable)
          gRfu.errorState = RFU_ERROR_STATE_NONE;
      else
...
export function LinkManagerCB_Parent(...args: any[]): any {
  let i: any = null;
      ...
      case LMAN_MSG_NEW_CHILD_CONNECT_ACCEPTED:
          ...
          for (i = 0; i < RFU_CHILD_MAX; i++)
          {
              if ((lman.param[0] >> i) & 1)
              {
                  let data: any = (void *)gRfuLinkStatus.partner[i].gname;
...
export function LinkManagerCB_Child(...args: any[]): any {
  switch (msg)
      {
      case LMAN_MSG_INITIALIZE_COMPLETED:
...
export function ParentResetChildRecvMetadata(...args: any[]): any {
  let i: any = null;
...
export function GetNewChildrenInUnionRoomChat(...args: any[]): any {
  let ret = 0;
      let i: any = null;
...
export function LinkManagerCB_UnionRoom(...args: any[]): any {
  let acceptSlot: any = null;
      ...
      case LMAN_MSG_NEW_CHILD_CONNECT_ACCEPTED:
          ...
          {
              let newChildren = GetNewChildrenInUnionRoomChat(lman.param[0]);
              if (newChildren != 0)
              {
...
export function RfuSetStatus(...args: any[]): any {
  gRfu.status = status;
      gRfu.errorInfo = errorInfo;
}
...
export function InitializeRfuLinkManager_LinkLeader(...args: any[]): any {
  gRfu.parentChild = MODE_PARENT;
      SetHostRfuUsername();
...
export function ReadU16(...args: any[]): any {
  let ptr_ = ptr;
      return (ptr_[1] << 8) | (ptr_[0]);
}

/** static u8 GetPartnerIndexByNameAndTrainerID(const u8 *name, u16 id) */
export function GetPartnerIndexByNameAndTrainerID(...args: any[]): any {
  let i: any = null;
      let idx = 0xFF;

      for (i = 0; i < RFU_CHILD_MAX; i++)
      {
          let trainerId = ReadU16((gRfuLinkStatus.partner[i].gname).compatibility.playerTrainerId);
...
export function RfuReqDisconnectSlot(...args: any[]): any {
...
export function RequestDisconnectSlotByTrainerNameAndId(...args: any[]): any {
  let index = GetPartnerIndexByNameAndTrainerID(name, id);
      if (index != 0xFF)
          RfuReqDisconnectSlot(1 << index);
}

/** void Rfu_DisconnectPlayerById(u32 playerIdx) */
export function Rfu_DisconnectPlayerById(...args: any[]): any {
  if (playerIdx != 0)
      {
          let i: any = null;
          let toDisconnect = 0;
...
export function Task_SendDisconnectCommand(...args: any[]): any {
  if (gSendCmd[0] == 0 && !gRfu.playerExchangeActive)
      {
...
export function SendDisconnectCommand(...args: any[]): any {
  let taskId = FindTaskIdByFunc(Task_SendDisconnectCommand);
      if (taskId == TASK_NONE)
      {
...
export function Task_RfuReconnectWithParent(...args: any[]): any {
...
export function CreateTask_RfuReconnectWithParent(...args: any[]): any {
  let taskId: any = null;
      let data: any = null;
...
export function IsPartnerActivityIncompatible(...args: any[]): any {
  if (GetHostRfuGameData().activity == (ACTIVITY_CHAT | IN_UNION_ROOM))
      {
...
export function Task_TryConnectToUnionRoomParent(...args: any[]): any {
...
export function TryConnectToUnionRoomParent(...args: any[]): any {
