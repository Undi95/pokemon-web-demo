...
export function AnimTask_BlendBattleAnimPal(...args: any[]): any {
...
export function AnimTask_BlendBattleAnimPalExclude(...args: any[]): any {
...
export function AnimTask_SetCamouflageBlend(...args: any[]): any {
  let selectedPalettes = UnpackSelectedBattlePalettes(gBattleAnimArgs[0]);
...
export function AnimTask_BlendParticle(...args: any[]): any {
  let paletteIndex = IndexOfSpritePaletteTag(gBattleAnimArgs[0]);
      let selectedPalettes = 1 << (paletteIndex + 16);
      StartBlendAnimSpriteColor(taskId, selectedPalettes);
}

/** void StartBlendAnimSpriteColor(u8 taskId, u32 selectedPalettes) */
export function StartBlendAnimSpriteColor(...args: any[]): any {
...
export function AnimTask_BlendSpriteColor_Step2(...args: any[]): any {
  let selectedPalettes: any = null;
      let singlePaletteOffset = 0;
...
export function AnimTask_HardwarePaletteFade(...args: any[]): any {
...
export function AnimTask_HardwarePaletteFade_Step(...args: any[]): any {
  if (!gPaletteFade.active)
          DestroyAnimVisualTask(taskId);
}

/** void AnimTask_TraceMonBlended(u8 taskId) */
export function AnimTask_TraceMonBlended(...args: any[]): any {
...
export function AnimTask_TraceMonBlended_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimMonTrace(...args: any[]): any {
  if (sprite.data[0])
      {
          sprite.data[0]--;
      }
...
export function AnimTask_DrawFallingWhiteLinesOnAttacker(...args: any[]): any {
...
export function AnimTask_DrawFallingWhiteLinesOnAttacker_Step(...args: any[]): any {
  let animBgData: any = null;
      let sprite: any = null;
      let bg1Cnt: any = null;
...
export function InitStatsChangeAnimation(...args: any[]): any {
  let i: any = null;
...
export function StatsChangeAnimation_Step1(...args: any[]): any {
...
export function StatsChangeAnimation_Step2(...args: any[]): any {
  let animBgData: any = null;
...
export function StatsChangeAnimation_Step3(...args: any[]): any {
...
export function AnimTask_Flash(...args: any[]): any {
...
export function AnimTask_Flash_Step(...args: any[]): any {
  let i: any = null;
      let task: any = gTasks[taskId];
...
export function SetPalettesToColor(...args: any[]): any {
  let i: any = null;
      ...
      for (i = 0; i < 32; i++)
      {
          if (selectedPalettes & 1)
          {
              let curOffset = PLTT_ID(i);
              let paletteOffset = curOffset;
...
export function AnimTask_BlendNonAttackerPalettes(...args: any[]): any {
  let battler: any = null;
      let j: any = null;
...
export function AnimTask_StartSlidingBg(...args: any[]): any {
...
export function AnimTask_UpdateSlidingBg(...args: any[]): any {
...
export function AnimTask_SetAllNonAttackersInvisiblity(...args: any[]): any {
  let battler: any = null;
...
export function StartMonScrollingBgMask(...args: any[]): any {
  let species: any = null;
      let spriteId, spriteId2;
      let bg1Cnt: any = null;
      let animBgData: any = null;
...
export function UpdateMonScrollingBgMask(...args: any[]): any {
      ...
      case 2:
          if (gTasks[taskId].data[11]++ >= gTasks[taskId].data[6])
          {
              ...
              if (gTasks[taskId].data[12] == 0)
              {
                  ...
                  if (!IsContest())
                  {
                      let bg1Cnt = GetGpuReg(REG_OFFSET_BG1CNT);
...
export function AnimTask_GetBattleEnvironment(...args: any[]): any {
  gBattleAnimArgs[0] = gBattleEnvironment;
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_AllocBackupPalBuffer(u8 taskId) */
export function AnimTask_AllocBackupPalBuffer(...args: any[]): any {
  gMonSpritesGfxPtr.buffer = AllocZeroed(MON_PIC_SIZE * MAX_MON_PIC_FRAMES);
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_FreeBackupPalBuffer(u8 taskId) */
export function AnimTask_FreeBackupPalBuffer(...args: any[]): any {
  FREE_AND_SET_NULL(gMonSpritesGfxPtr.buffer);
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_CopyPalUnfadedToBackup(u8 taskId) */
export function AnimTask_CopyPalUnfadedToBackup(...args: any[]): any {
  let selectedPalettes: any = null;
      let paletteIndex = 0;
...
export function AnimTask_CopyPalUnfadedFromBackup(...args: any[]): any {
  let selectedPalettes: any = null;
      let paletteIndex = 0;
...
export function AnimTask_CopyPalFadedToUnfaded(...args: any[]): any {
  let selectedPalettes: any = null;
      let paletteIndex = 0;
...
export function AnimTask_IsContest(...args: any[]): any {
  if (IsContest())
...
export function AnimTask_SetAnimAttackerAndTargetForEffectTgt(...args: any[]): any {
...
export function AnimTask_IsTargetSameSide(...args: any[]): any {
...
export function AnimTask_SetAnimTargetToBattlerTarget(...args: any[]): any {
  gBattleAnimTarget = gBattlerTarget;
      DestroyAnimVisualTask(taskId);
}

/** void AnimTask_SetAnimAttackerAndTargetForEffectAtk(u8 taskId) */
export function AnimTask_SetAnimAttackerAndTargetForEffectAtk(...args: any[]): any {
...
export function AnimTask_SetAttackerInvisibleWaitForSignal(...args: any[]): any {
  if (IsContest())
      {
          DestroyAnimVisualTask(taskId);
      }
...
export function AnimTask_WaitAndRestoreVisibility(...args: any[]): any {
