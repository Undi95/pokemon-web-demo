...
export function HasSuperEffectiveMoveAgainstOpponents(...args: any[]): any {
  let opposingPosition: any = null;
      let opposingBattler: any = null;
      let i: any = null;
      let moveFlags: any = null;
...
export function FindMonWithFlagsAndSuperEffective(...args: any[]): any {
  let battlerIn1, battlerIn2;
      let firstId: any = null;
      let lastId: any = null;  
      let party: any = null;
...
export function AI_TrySwitchOrUseItem(): any {
  let party: any = null;
      ...
      let firstId: any = null;
      let lastId: any = null;  
      let battlerIdentity = GetBattlerPosition(gActiveBattler);
...
export function ModulateByTypeEffectiveness(...args: any[]): any {
  let i = 0;
  ...
  let opposingBattler: any = null;
      ...
      while (invalidMons != (1 << PARTY_SIZE) - 1)  
      {
          ...
          for (i = firstId; i < lastId; i++)
          {
              ...
              {
                  let type1 = gSpeciesInfo[species].types[0];
                  let type2 = gSpeciesInfo[species].types[1];
                  let typeDmg = TYPE_MUL_NORMAL;
...
export function GetAI_ItemType(...args: any[]): any {
