...
export function GetStarterPokemon(...args: any[]): any {
...
export function Task_StarterChoose(...args: any[]): any {
...
export function Task_HandleStarterChooseInput(...args: any[]): any {
  let selection = gTasks[taskId].tStarterSelection;
...
export function Task_WaitForStarterSprite(...args: any[]): any {
...
export function Task_AskConfirmStarter(...args: any[]): any {
...
export function Task_HandleConfirmStarterInput(...args: any[]): any {
  let spriteId: any = null;
...
export function Task_DeclineStarter(...args: any[]): any {
  gTasks[taskId].func = Task_StarterChoose;
}

/** static void CreateStarterPokemonLabel(u8 selection) */
export function CreateStarterPokemonLabel(...args: any[]): any {
  const categoryText: any[] = [];
      ...
      let species = GetStarterPokemon(selection);
...
export function Task_MoveStarterChooseCursor(...args: any[]): any {
  ClearStarterLabel();
      gTasks[taskId].func = Task_CreateStarterLabel;
}

/** static void Task_CreateStarterLabel(u8 taskId) */
export function Task_CreateStarterLabel(...args: any[]): any {
  CreateStarterPokemonLabel(gTasks[taskId].tStarterSelection);
      gTasks[taskId].func = Task_HandleStarterChooseInput;
}

/** static u8 CreatePokemonFrontSprite(u16 species, u8 x, u8 y) */
export function CreatePokemonFrontSprite(...args: any[]): any {
  let spriteId: any = null;
...
export function SpriteCB_SelectionHand(...args: any[]): any {
...
export function SpriteCB_StarterPokemon(...args: any[]): any {
