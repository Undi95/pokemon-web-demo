...
const {
  ...
  ProcessSpriteCopyRequests, PutWindowTilemap, RemoveWindow, ResetAllPicSprites,
  ...
  SetMainCallback2, SetVBlankCallback, ShowBg, Sin,
  SpeciesToNationalPokedexNum, StartSpriteAnimIfDifferent, TransferPlttBuffer, UpdatePaletteFade,
