...
const {
  ...
  IncrementGameStat, IncrementRematchStepCounter, MAP_NUM, MapGridGetElevationAt,
  MapGridGetMetatileBehaviorAt, MapGridGetMetatileIdAt, MetatileBehavior_IsAquaHideoutWarp, MetatileBehavior_IsBattlePyramidWarp,
  MetatileBehavior_IsCrackedFloorHole, MetatileBehavior_IsDiveable, MetatileBehavior_IsEastArrowWarp, MetatileBehavior_IsEscalator,
  MetatileBehavior_IsForcedMovementTile, MetatileBehavior_IsLadder, MetatileBehavior_IsLavaridge1FWarp, MetatileBehavior_IsLavaridgeB1FWarp,
  MetatileBehavior_IsMossdeepGymWarp, MetatileBehavior_IsMtPyreHole, MetatileBehavior_IsNonAnimDoor, MetatileBehavior_IsNorthArrowWarp,
  MetatileBehavior_IsOpenSecretBaseDoor, MetatileBehavior_IsSecretBaseGlitterMat, MetatileBehavior_IsSecretBaseSoundMat, MetatileBehavior_IsSouthArrowWarp,
  MetatileBehavior_IsUnableToEmerge, MetatileBehavior_IsUnionRoomWarp, MetatileBehavior_IsWarpDoor, MetatileBehavior_IsWestArrowWarp,
  NULL, Overworld_GetMapHeaderByGroupAndId, PlaySE, PlaySecretBaseMusicNoteMatSound,
  PlayerGetDestCoords, PlayerGetElevation, SafariZoneTakeStep, ScriptContext_SetupScript,
  SetDiveWarpDive, SetDiveWarpEmerge, SetDynamicWarp, SetWarpDestinationToDynamicWarp,
  SetWarpDestinationToMapWarp, SetWarpDestinationTrainerHill4F, SetWarpDestinationTrainerHillFinalFloor, ShouldDoBrailleRegicePuzzle,
  ShouldDoRivalRayquazaCall, ShouldDoRoxanneCall, ShouldDoScottBattleFrontierCall, ShouldDoScottFortreeCall,
  ShouldDoWallyCall, ShouldEggHatch, ShowStartMenu, StandardWildEncounter,
  StoreInitialPlayerAvatarState, TRUE, TryRunOnFrameMapScript, TryStartMatchCall,
  UpdateEscapeWarp, UpdateFarawayIslandStepCounter, UpdateRepelCounter, UseRegisteredKeyItemOnField,
  VarSet, WarpIntoSecretBase,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
