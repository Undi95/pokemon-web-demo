...
export function FieldClearPlayerInput(...args: any[]): any {
...
export function FieldGetPlayerInput(...args: any[]): any {
  let tileTransitionState = gPlayerAvatar.tileTransitionState;
      let runningState = gPlayerAvatar.runningState;
      let forcedMove = MetatileBehavior_IsForcedMovementTile(GetPlayerCurMetatileBehavior(runningState));
...
export function ProcessPlayerFieldInput(...args: any[]): any {
...
export function GetPlayerCurMetatileBehavior(...args: any[]): any {
  let x, y;
...
export function TryStartInteractionScript(...args: any[]): any {
  let script = GetInteractionScript(position, metatileBehavior, direction);
      if (script == NULL)
          return FALSE;
...
export function TryStartStepBasedScript(...args: any[]): any {
...
export function TryStartCoordEventScript(...args: any[]): any {
  let script = GetCoordEventScriptAtPosition(gMapHeader, position.x - MAP_OFFSET, position.y - MAP_OFFSET, position.elevation);
...
export function TryStartMiscWalkingScripts(...args: any[]): any {
  let x, y;
...
export function TryStartStepCountScript(...args: any[]): any {
  if (InUnionRoom() == TRUE)
      {
          return FALSE;
      }
...
export function UpdateFriendshipStepCounter(): any {
  let ptr = GetVarPointer(VAR_FRIENDSHIP_STEP_COUNTER);
      let i: any = null;
...
export function CheckStandardWildEncounter(...args: any[]): any {
...
export function TryArrowWarp(...args: any[]): any {
  let warpEventId = GetWarpEventAtMapPosition(gMapHeader, position);
...
export function TryStartWarpEventScript(...args: any[]): any {
  let warpEventId = GetWarpEventAtMapPosition(gMapHeader, position);
...
export function IsWarpMetatileBehavior(...args: any[]): any {
...
export function IsArrowWarpMetatileBehavior(...args: any[]): any {
  switch (direction)
      {
      case DIR_NORTH:
...
export function GetWarpEventAtMapPosition(...args: any[]): any {
...
export function SetupWarp(...args: any[]): any {
  let warpEvent: any = null;

      let trainerHillMapId = GetCurrentTrainerHillMapId();
...
export function TryDoorWarp(...args: any[]): any {
...
export function GetWarpEventAtPosition(...args: any[]): any {
  let i: any = null;
      let warpEvent: any = mapHeader.events.warps;
      let warpCount = mapHeader.events.warpCount;
...
export function TryDoDiveWarp(...args: any[]): any {
