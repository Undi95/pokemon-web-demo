...
const {
  ...
  BG_PLTT_ID, BeginNormalPaletteFade, BufferDomeWinString, BuildOamBuffer,
  CALC_STAT, CalcDomeMonStats, CalculatePlayerPartyCount, ChangeBgX,
  ChangeBgY, ClearSelectedPartyOrder, CopyBgTilemapBufferToVram, CopyDomeBrainTrainerName,
  CopyDomeTrainerName, CopyToBgTilemapBufferRect_ChangePalette, CopyWindowToVram, CpuFill32,
  CreateDomeOpponentMon, CreateDomeOpponentMons, CreateMonIcon, CreateMonWithEVSpreadNatureOTID,
  CreateSprite, CreateTask, CreateTrainerPicSprite, DeactivateAllTextPrinters,
  DecideRoundWinners, DecompressAndLoadBgGfxUsingHeap, DestroyTask, DisplayMatchInfoOnCard,
  DisplayTrainerInfoOnCard, DrawTourneyAdvancementLine, EnableInterrupts, FREE_AND_SET_NULL,
  FillWindowPixelBuffer, Free, FreeAllSpritePalettes, FreeAllWindowBuffers,
  FreeAndDestroyMonIconSprite, FreeAndDestroyTrainerPicSprite, FreeMonIconPalettes, GetCurrentFacilityWinStreak,
  GetDomeBrainTrainerClass, GetDomeBrainTrainerPicId, GetDomeTrainerMonIvs, GetDomeTrainerSelectedMons,
  GetFrontierBrainMonEvs, GetFrontierBrainMonMove, GetFrontierBrainMonNature, GetFrontierBrainMonSpecies,
  GetFrontierBrainStatus, GetFrontierOpponentClass, GetFrontierTrainerFrontSpriteId, GetMonData,
  GetNature, GetNatureFromPersonality, GetOpposingNPCTournamentIdByRound, GetRandomFrontierMonFromSet,
  ...
  GetTypeEffectivenessPoints, GetWinningMove, InitBgsFromTemplates, InitWindows,
  IsFrontierTrainerFemale, JOY_NEW, LZDecompressWram, LoadCompressedPalette,
  LoadCompressedSpriteSheet, LoadMonIconPalettes, LoadOam, PIXEL_FILL,
  PlaySE, PlayerGenderToFrontTrainerPicId, ProcessSpriteCopyRequests, PutWindowTilemap,
  Random, Random32, ReducePlayerPartyToSelectedMons, ResetBgsAndClearDma3BusyFlags,
  ResetPaletteFade, ResetSpriteData, RunTasks, RunTextPrinters,
  SET_WIN0H_WIN1H, SWAP, SaveGameFrontier, ScanlineEffect_Clear,
  ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams, ScanlineEffect_Stop, SelectOpponentMonsFromParty,
  SelectOpponentMons_Bad, SelectOpponentMons_Good, SetBattleFacilityTrainerGfxId, SetBgTilemapBuffer,
  SetDynamicWarp, SetFacilityPtrsGetLevel, SetFacilityTrainerAndMonPtrs, SetGpuReg,
  SetHBlankCallback, SetMainCallback2, SetMonData, SetMonMoveSlot,
  SetVBlankCallback, ShowBg, StartSpriteAnim, StringAppend,
  StringCopy, StringExpandPlaceholders, SwapDomeTrainers, T1_READ_16,
  TYPE_EFFECT_ATK_TYPE, TYPE_EFFECT_DEF_TYPE, TYPE_EFFECT_MULTIPLIER, Task_GetInfoCardInput,
  TournamentIdOfOpponent, TrainerIdOfPlayerOpponent, TrainerIdToTournamentId, TransferPlttBuffer,
  UpdateMonIconFrame, UpdatePaletteFade, UpdateTourneyTreeCursor, VarGet,
