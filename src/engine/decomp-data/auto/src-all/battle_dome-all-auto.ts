...
const {
  ...
  DISPCNT_WIN1_ON, DISPLAY_HEIGHT, DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap,
  DestroyTask, EnableInterrupts, FALSE, FREE_AND_SET_NULL,
  ...
  GetNature, GetNatureFromPersonality, GetRandomFrontierMonFromSet, GetRandomScaledFrontierTrainerId,
  GetStringCenterAlignXOffsetWithLetterSpacing, GetStringWidthDifference, GetTrainerClassNameGenderSpecific, InitBgsFromTemplates,
  InitWindows, IsFrontierTrainerFemale, JOY_NEW, LZDecompressWram,
  LoadCompressedPalette, LoadCompressedSpriteSheet, LoadMonIconPalettes, LoadOam,
  NULL, PALETTES_ALL, PIXEL_FILL, PLTT_SIZE,
  PLTT_SIZE_4BPP, PlaySE, PlayerGenderToFrontTrainerPicId, ProcessSpriteCopyRequests,
  PutWindowTilemap, REG_OFFSET_BG0HOFS, REG_OFFSET_BG0VOFS, REG_OFFSET_BG1HOFS,
  REG_OFFSET_BG1VOFS, REG_OFFSET_BG2HOFS, REG_OFFSET_BG2VOFS, REG_OFFSET_BLDALPHA,
  REG_OFFSET_BLDCNT, REG_OFFSET_BLDY, REG_OFFSET_MOSAIC, REG_OFFSET_WIN0H,
  REG_OFFSET_WIN0V, REG_OFFSET_WIN1H, REG_OFFSET_WIN1V, REG_OFFSET_WININ,
  REG_OFFSET_WINOUT, Random, Random32, ReducePlayerPartyToSelectedMons,
  ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData, RunTasks,
  RunTextPrinters, SET_WIN0H_WIN1H, SWAP, SaveGameFrontier,
  ScanlineEffect_Clear, ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams, ScanlineEffect_Stop,
  SetBattleFacilityTrainerGfxId, SetBgTilemapBuffer, SetDynamicWarp, SetFacilityPtrsGetLevel,
  SetGpuReg, SetHBlankCallback, SetMainCallback2, SetMonData,
  SetMonMoveSlot, SetVBlankCallback, ShowBg, StartSpriteAnim,
  StringAppend, StringCopy, StringExpandPlaceholders, T1_READ_16,
  TRUE, TYPE_EFFECT_ATK_TYPE, TYPE_EFFECT_DEF_TYPE, TYPE_EFFECT_MULTIPLIER,
  TransferPlttBuffer, UpdateMonIconFrame, UpdatePaletteFade, VRAM_SIZE,
