...
export function CountPokemonInDaycare(...args: any[]): any {
  let i, count;
      count = 0;
...
export function InitDaycareMailRecordMixing(...args: any[]): any {
  let i: any = null;
...
export function Daycare_FindEmptySpot(...args: any[]): any {
  let i: any = null;
...
export function StorePokemonInDaycare(...args: any[]): any {
  if (MonHasMail(mon))
      {
          let mailId: any = null;
...
export function StorePokemonInEmptyDaycareSlot(...args: any[]): any {
  let slotId = Daycare_FindEmptySpot(daycare);
...
export function ShiftDaycareSlots(...args: any[]): any {
...
export function ApplyDaycareExperience(...args: any[]): any {
  let i: any = null;
...
export function TakeSelectedPokemonFromDaycare(...args: any[]): any {
...
export function TakeSelectedPokemonMonFromDaycareShiftSlots(...args: any[]): any {
  let species = TakeSelectedPokemonFromDaycare(daycare.mons[slotId]);
...
export function GetLevelAfterDaycareSteps(...args: any[]): any {
  let tempMon: any = *mon;

      let experience = GetBoxMonData(mon, MON_DATA_EXP) + steps;
      SetBoxMonData(tempMon, MON_DATA_EXP,  experience);
      return GetLevelFromBoxMonExp(tempMon);
}

/** static u8 GetNumLevelsGainedFromSteps(struct DaycareMon *daycareMon) */
export function GetNumLevelsGainedFromSteps(...args: any[]): any {
...
export function GetNumLevelsGainedForDaycareMon(...args: any[]): any {
  let numLevelsGained = GetNumLevelsGainedFromSteps(daycareMon);
...
export function GetDaycareCostForSelectedMon(...args: any[]): any {
  let cost: any = null;
...
export function GetDaycareCostForMon(...args: any[]): any {
...
export function ClearDaycareMonMail(...args: any[]): any {
  let i: any = null;
...
export function ClearDaycareMon(...args: any[]): any {
  ZeroBoxMonData(daycareMon.mon);
      daycareMon.steps = 0;
      ClearDaycareMonMail(daycareMon.mail);
}
...
export function GetEggSpecies(...args: any[]): any {
  let i, j, k;
      let found: any = null;
...
export function GetParentToInheritNature(...args: any[]): any {
  const species: any[] = [];
      let i: any = null;
...
export function _TriggerPendingDaycareEgg(...args: any[]): any {
  let parent: any = null;
      let natureTries = 0;
      ...
      {
          let wantedNature = GetNatureFromPersonality(GetBoxMonData(daycare.mons[parent].mon, MON_DATA_PERSONALITY, NULL));
...
export function _TriggerPendingDaycareMaleEgg(...args: any[]): any {
...
export function RemoveIVIndexFromList(...args: any[]): any {
  let i, j;
      const temp: any[] = [];
...
export function InheritIVs(...args: any[]): any {
  let i: any = null;
...
export function GetEggMoves(...args: any[]): any {
...
export function BuildEggMoveset(...args: any[]): any {
...
export function RemoveEggFromDayCare(...args: any[]): any {
...
export function AlterEggSpeciesWithIncenseItem(...args: any[]): any {
...
export function GiveVoltTackleIfLightBall(...args: any[]): any {
  let motherItem = GetBoxMonData(daycare.mons[0].mon, MON_DATA_HELD_ITEM);
      let fatherItem = GetBoxMonData(daycare.mons[1].mon, MON_DATA_HELD_ITEM);
...
export function DetermineEggSpeciesAndParentSlots(...args: any[]): any {
  let i: any = null;
      const species: any[] = [];
...
export function _GiveEggFromDaycare(...args: any[]): any {
  let egg: any = null;
      let species: any = null;
...
export function CreateEgg(...args: any[]): any {
...
export function SetInitialEggData(...args: any[]): any {
  let personality: any = null;
      let ball: any = null;
      let metLevel: any = null;
      let language: any = null;
...
export function TryProduceOrHatchEgg(...args: any[]): any {
  u32 i, validEggs = 0;
      ...
      {
          let compatibility = GetDaycareCompatibilityScore(daycare);
      ...
      if (++daycare.stepCounter == 255)
      {
          ...
          let toSub = GetEggCyclesToSubtract();
...
export function EggGroupsOverlap(...args: any[]): any {
  let i, j;
...
export function GetDaycareCompatibilityScore(...args: any[]): any {
  let i: any = null;
...
export function NameHasGenderSymbol(...args: any[]): any {
  let i: any = null;
...
export function DaycareAddTextPrinter(...args: any[]): any {
...
export function DaycarePrintMonNickname(...args: any[]): any {
  const nickname: any[] = [];
...
export function DaycarePrintMonLvl(...args: any[]): any {
  let level: any = null;
      let x: any = null;
      const lvlText: any[] = [];
      const intText: any[] = [];
...
export function DaycarePrintMonInfo(...args: any[]): any {
...
export function Task_HandleDaycareLevelMenuInput(...args: any[]): any {
  let input = ListMenu_ProcessInput(gTasks[taskId].tMenuListTaskId);
