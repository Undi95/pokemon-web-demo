...
const {
  ...
  LoadWirelessStatusIndicatorSpriteGfx, Menu_MoveCursor, Menu_ProcessInput, NULL,
  OBJ_PLTT_ID, PALETTES_ALL, PIXEL_FILL, PLTT_SIZEOF,
  PLTT_SIZE_4BPP, PlaySE, PrintMenuActionTextsAtPos, ProcessSpriteCopyRequests,
  PutWindowTilemap, REG_OFFSET_BLDCNT, REG_OFFSET_DISPCNT, REG_OFFSET_WIN0H,
  ...
  TrySavingData, UpdatePaletteFade, WIN_RANGE,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
