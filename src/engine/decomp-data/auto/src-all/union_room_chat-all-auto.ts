...
const {
  ARRAY_COUNT, AddStdMessageWindow, AddTextPrinterParameterized, AddTextPrinterParameterized3,
  AddTextPrinterParameterized5, AddWindow, AddYesNoMenuAt, Alloc,
  AnimateSprites, AppendTextToMessage, BG_CHAR_ADDR, BG_PLTT_ID,
  BeginNormalPaletteFade, BlendPalettes, BlitBitmapToWindow, BuildOamBuffer,
  ChangeBgX, ChangeBgY, ChatMessageIsNotEmpty, ClearBg0,
  ClearContinueGameWarpStatus2, ClearGpuRegBits, ClearStdWindowAndFrameToTransparent, ClearWindowTilemap,
  CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer, CopyWindowToVram, CpuFastCopy,
  CpuFastFill, CpuFill16, CreateKeyboardCursorSprite, CreateRButtonSprites,
  CreateSprite, CreateTask, CreateTextEntrySprites, CreateWirelessStatusIndicatorSprite,
  DecompressAndCopyTileDataToVram, DeleteLastMessageCharacter, DestroyStdMessageWindow, DestroyTask,
  DestroyYesNoMenuWindow, DrawKeyboardWindow, DrawTextBorderInner, DrawTextBorderOuter,
  DrawTextEntryMessage, DynamicPlaceholderTextUtil_ExpandPlaceholders, DynamicPlaceholderTextUtil_Reset, DynamicPlaceholderTextUtil_SetPlaceholderPtr,
  FillBgTilemapBufferRect_Palette0, FillTextEntryWindow, FillWindowPixelBuffer, FillWindowPixelRect,
  FinishSlidingKeyboard, Free, FreeAllSpritePalettes, FreeAllWindowBuffers,
  FreeDisplay, FreeSprites, FreeTempTileDataBuffersIfPossible, FreeUnionRoomChat,
  FuncIsActiveTask, GetBlockReceivedStatus, GetBufferSelectionRegion, GetChatHostName,
  GetCurrentKeyboardColAndRow, GetCurrentKeyboardPage, GetEndOfMessagePtr, GetLastCharOfMessagePtr,
  GetLastReceivedMessage, GetLengthOfMessageEntry, GetLimitedMessageStartPos, GetLimitedMessageStartPtr,
  GetLinkPlayerCount, GetMessageEntryBuffer, GetMultiplayerId, GetNumOverflowCharsInMessage,
  GetReceivedPlayerIndex, GetRegisteredTextByRow, GetShouldShowCaseToggleIcon, GetStringWidth,
  GetTextEntryCursorPosition, HandleDPadInput, HideKeyboardSwapMenu, HideStdMessageWindow,
  HideYesNoMenuWindow, IndexOfSpritePaletteTag, InitBgsFromTemplates, InitDisplay,
  InitMenuInUpperLeftCornerNormal, InitMenuNormal, InitScanlineEffect, InitUnionRoomChat,
  InitWindows, IsDisplaySubtask0Active, IsDisplaySubtaskActive, IsDma3ManagerBusyWithBgCopy,
  IsLinkTaskFinished, JOY_NEW, JOY_REPEAT, LoadChatMessagesWindow,
  LoadChatUnkPalette, LoadChatWindowGfx, LoadCompressedSpriteSheet, LoadKeyboardSwapWindow,
  LoadKeyboardWindowGfx, LoadOam, LoadPalette, LoadSpritePalette,
  LoadTextEntryWindow, LoadUserWindowBorderGfx, LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx,
  Menu_MoveCursor, Menu_ProcessInput, MoveKeyboardCursor, OBJ_PLTT_ID,
  PIXEL_FILL, PLTT_SIZEOF, PlaySE, PrepareSendBuffer_Chat,
  PrepareSendBuffer_Disband, PrepareSendBuffer_Drop, PrepareSendBuffer_Join, PrepareSendBuffer_Leave,
  PrepareSendBuffer_Null, PrintChatMessage, PrintCurrentKeyboardPage, PrintMenuActionTextsAtPos,
  ProcessMenuInput, ProcessReceivedChatMessage, ProcessSpriteCopyRequests, PutWindowTilemap,
  RegisterTextAtRow, RemoveWindow, RequestDma3Fill, ResetBgsAndClearDma3BusyFlags,
  ResetBlockReceivedFlag, ResetDisplaySubtasks, ResetGpuBgState, ResetMessageEntryBuffer,
  ResetSpriteData, ResetTasks, ResetTempTileDataBuffers, RfuSetNormalDisconnectMode,
  Rfu_DisconnectPlayerById, Rfu_IsPlayerExchangeActive, Rfu_StopPartnerSearch, RunDisplaySubtasks,
  RunTasks, SaveRegisteredTexts, ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams,
  ScrollWindow, SendBlock, SetBgTilemapBuffer, SetBgTilemapBuffers,
  SetChatFunction, SetCloseLinkCallback, SetContinueGameWarpStatusToDynamicWarp, SetGpuReg,
  SetGpuRegBits, SetKeyboardCursorInvisibility, SetMainCallback2, SetRegisteredTextPalette,
  SetUnionRoomChatPlayerData, SetVBlankCallback, ShowBg, ShowKeyboardSwapMenu,
  SlideKeyboardPageIn, SlideKeyboardPageOut, StartDisplaySubtask, StartKeyboardCursorAnim,
  StartSpriteAnim, StringCopy, StringCopyN_Multibyte, StringLength_Multibyte,
  SwitchCaseOfLastMessageCharacter, TRY_FREE_AND_SET_NULL, TransferPlttBuffer, TryAllocDisplay,
  TryAllocSprites, TryKeyboardCursorReopen, TrySavingData, UpdatePaletteFade,
  UpdateRButtonLabel, UpdateSlidingKeyboard, WIN_RANGE,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
