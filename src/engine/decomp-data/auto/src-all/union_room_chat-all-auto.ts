...
const {
  ...
  DISPLAY_HEIGHT, DecompressAndCopyTileDataToVram, DestroyTask, DrawTextBorderInner,
  ...
  FuncIsActiveTask, GetBlockReceivedStatus, GetChatHostName, GetEndOfMessagePtr,
  GetLastCharOfMessagePtr, GetLastReceivedMessage, GetLimitedMessageStartPtr, GetLinkPlayerCount,
  GetMessageEntryBuffer, GetMultiplayerId, GetRegisteredTextByRow, GetStringWidth,
  IndexOfSpritePaletteTag, InitBgsFromTemplates, InitMenuInUpperLeftCornerNormal, InitMenuNormal,
  InitWindows, IsDma3ManagerBusyWithBgCopy, IsLinkTaskFinished, JOY_NEW,
  JOY_REPEAT, LoadCompressedSpriteSheet, LoadOam, LoadPalette,
  LoadSpritePalette, LoadUserWindowBorderGfx, LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx,
  Menu_MoveCursor, Menu_ProcessInput, NULL, OBJ_PLTT_ID,
  PALETTES_ALL, PIXEL_FILL, PLTT_SIZEOF, PLTT_SIZE_4BPP,
  PlaySE, PrintMenuActionTextsAtPos, ProcessSpriteCopyRequests, PutWindowTilemap,
  REG_OFFSET_BLDCNT, REG_OFFSET_WIN0H, REG_OFFSET_WIN0V, REG_OFFSET_WININ,
  REG_OFFSET_WINOUT, RemoveWindow, RequestDma3Fill, ResetBgsAndClearDma3BusyFlags,
  ResetBlockReceivedFlag, ResetSpriteData, ResetTasks, ResetTempTileDataBuffers,
  RfuSetNormalDisconnectMode, Rfu_DisconnectPlayerById, Rfu_IsPlayerExchangeActive, Rfu_StopPartnerSearch,
  RunTasks, ScanlineEffect_InitHBlankDmaTransfer, ScanlineEffect_SetParams, ScrollWindow,
  SendBlock, SetBgTilemapBuffer, SetCloseLinkCallback, SetContinueGameWarpStatusToDynamicWarp,
  SetGpuReg, SetGpuRegBits, SetMainCallback2, SetUnionRoomChatPlayerData,
  SetVBlankCallback, ShowBg, StartSpriteAnim, StringCopy,
  StringCopyN_Multibyte, StringLength_Multibyte, TILE_SIZE_4BPP, TRUE,
  TRY_FREE_AND_SET_NULL, TransferPlttBuffer, TrySavingData, UpdatePaletteFade,
