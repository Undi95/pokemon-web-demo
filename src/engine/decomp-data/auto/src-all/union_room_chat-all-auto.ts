...
const {
  ...
  DecompressAndCopyTileDataToVram, DestroyTask, DrawTextBorderInner, DrawTextBorderOuter,
  ...
  GetChatHostName, GetEndOfMessagePtr, GetLastCharOfMessagePtr, GetLastReceivedMessage,
  GetLimitedMessageStartPtr, GetLinkPlayerCount, GetMessageEntryBuffer, GetMultiplayerId,
  GetRegisteredTextByRow, GetStringWidth, IndexOfSpritePaletteTag, InitBgsFromTemplates,
  InitMenuInUpperLeftCornerNormal, InitMenuNormal, InitWindows, IsDma3ManagerBusyWithBgCopy,
  IsLinkTaskFinished, JOY_NEW, JOY_REPEAT, LoadCompressedSpriteSheet,
  LoadOam, LoadPalette, LoadSpritePalette, LoadUserWindowBorderGfx,
  LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx, Menu_MoveCursor, Menu_ProcessInput,
  OBJ_PLTT_ID, PIXEL_FILL, PLTT_SIZEOF, PlaySE,
  PrintMenuActionTextsAtPos, ProcessSpriteCopyRequests, PutWindowTilemap, RemoveWindow,
  RequestDma3Fill, ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlag, ResetSpriteData,
  ResetTasks, ResetTempTileDataBuffers, RfuSetNormalDisconnectMode, Rfu_DisconnectPlayerById,
  Rfu_IsPlayerExchangeActive, Rfu_StopPartnerSearch, RunTasks, ScanlineEffect_InitHBlankDmaTransfer,
  ScanlineEffect_SetParams, ScrollWindow, SendBlock, SetBgTilemapBuffer,
  SetCloseLinkCallback, SetContinueGameWarpStatusToDynamicWarp, SetGpuReg, SetGpuRegBits,
  SetMainCallback2, SetUnionRoomChatPlayerData, SetVBlankCallback, ShowBg,
