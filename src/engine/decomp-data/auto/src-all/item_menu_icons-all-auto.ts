...
export function RemoveBagSprite(...args: any[]): any {
  let spriteId = gBagMenu.spriteIds[id];
...
export function AddBagVisualSprite(...args: any[]): any {
  let spriteId = gBagMenu.spriteIds[ITEMMENUSPRITE_BAG];
      *spriteId = CreateSprite(sBagSpriteTemplate, 68, 66, 0);
      SetBagVisualPocketId(bagPocketId, FALSE);
}

/** void SetBagVisualPocketId(u8 bagPocketId, bool8 isSwitchingPockets) */
export function SetBagVisualPocketId(...args: any[]): any {
...
export function SpriteCB_BagVisualSwitchingPockets(...args: any[]): any {
  if (sprite.y2 != 0)
      {
          sprite.y2++;
      }
...
export function SpriteCB_ShakeBagSprite(...args: any[]): any {
  if (sprite.affineAnimEnded)
      {
...
export function AddSwitchPocketRotatingBallSprite(...args: any[]): any {
  let spriteId = gBagMenu.spriteIds[ITEMMENUSPRITE_BALL];
...
export function UpdateSwitchPocketRotatingBallCoords(...args: any[]): any {
...
export function SpriteCB_SwitchPocketRotatingBallInit(...args: any[]): any {
...
export function SpriteCB_SwitchPocketRotatingBallContinue(...args: any[]): any {
  sprite.data[3]++;
      UpdateSwitchPocketRotatingBallCoords(sprite);
      if (sprite.data[3] == 16)
...
export function AddBagItemIconSprite(...args: any[]): any {
  let spriteId = gBagMenu.spriteIds[id + ITEMMENUSPRITE_ITEM];
      if (*spriteId == SPRITE_NONE)
      {
...
export function RemoveBagItemIconSprite(...args: any[]): any {
      let spriteId = gBagMenu.spriteIds[ITEMMENUSPRITE_ITEM];
...
export function SetItemMenuSwapLineInvisibility(...args: any[]): any {
...
export function UpdateItemMenuSwapLinePos(...args: any[]): any {
...
export function ArrangeBerryGfx(...args: any[]): any {
  let i, j;
...
export function LoadBerryGfx(...args: any[]): any {
  let pal: any = null;
...
export function CreateBerryTagSprite(...args: any[]): any {
  LoadBerryGfx(id);
...
export function CreateSpinningBerrySprite(...args: any[]): any {
...
export function CreateBerryFlavorCircleSprite(...args: any[]): any {
