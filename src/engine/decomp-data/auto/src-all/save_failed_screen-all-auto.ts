...
export function SaveFailedScreenTextPrint(...args: any[]): any {
  const color: any[] = [];
...
export function DoSaveFailedScreen(...args: any[]): any {
...
export function VBlankCB_UpdateClockGraphics(): any {
  let n = (gMain.vblankCounter2 >> 3) & 7;
...
export function VerifySectorWipe(...args: any[]): any {
  let ptr = (u32 *)&gSaveDataBuffer;
      let i: any = null;
...
export function WipeSector(...args: any[]): any {
  let i, j;
      let failed = TRUE;
...
export function WipeSectors(...args: any[]): any {
  let i: any = null;
