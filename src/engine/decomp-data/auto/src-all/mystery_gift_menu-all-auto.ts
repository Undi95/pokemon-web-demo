...
export function HandleMysteryGiftOrEReaderSetup(...args: any[]): any {
  switch (gMain.state)
      {
      case 0:
...
export function PrintMysteryGiftOrEReaderHeader(...args: any[]): any {
  let title: any = null;
...
export function MG_DrawTextBorder(...args: any[]): any {
  DrawTextBorderOuter(windowId, 0x01, 0xF);
}

/** void MG_DrawCheckerboardPattern(u32 bg) */
export function MG_DrawCheckerboardPattern(...args: any[]): any {
  let i = 0, j;
...
export function ClearScreenInBg0(...args: any[]): any {
...
export function MG_AddMessageTextPrinter(...args: any[]): any {
...
export function PrintMysteryGiftMenuMessage(...args: any[]): any {
  switch (*textState)
      {
      case 0:
...
export function PrintStringAndWait2Seconds(...args: any[]): any {
  if (*counter == 0)
          MG_AddMessageTextPrinter(str);
...
export function MysteryGift_HandleThreeOptionMenu(...args: any[]): any {
...
export function DoMysteryGiftYesNo(...args: any[]): any {
...
export function HandleGiftSelectMenu(...args: any[]): any {
  let windowTemplate: any = null;
      let input: any = null;
...
export function ValidateCardOrNews(...args: any[]): any {
  if (!isWonderNews)
...
export function HandleLoadWonderCardOrNews(...args: any[]): any {
  switch (*state)
      {
      case 0:
          if (!isWonderNews)
...
export function ClearSavedNewsOrCard(...args: any[]): any {
  if (!isWonderNews)
...
export function ExitWonderCardOrNews(...args: any[]): any {
  if (!isWonderNews)
      {
...
export function AskDiscardGift(...args: any[]): any {
  if (!isWonderNews)
...
export function PrintThrownAway(...args: any[]): any {
  if (!isWonderNews)
...
export function SaveOnMysteryGiftMenu(...args: any[]): any {
  switch (*state)
      {
      case 0:
...
export function GetClientResultMessage(...args: any[]): any {
  let msg = NULL;
      *successMsg = FALSE;
...
export function PrintSuccessMessage(...args: any[]): any {
  switch (*state)
      {
      case 0:
          if (msg != NULL)
...
export function GetServerResultMessage(...args: any[]): any {
  let result = gText_CommunicationError;
      *wonderSuccess = FALSE;
      switch (msgId)
      {
...
export function PrintServerResultMessage(...args: any[]): any {
  let wonderSuccess: any = null;
      let str = GetServerResultMessage(wonderSuccess, sourceIsFriend, msgId);
      if (wonderSuccess)
...
export function CreateMysteryGiftTask(): any {
  let taskId = CreateTask(Task_MysteryGift, 0);
...
export function Task_MysteryGift(...args: any[]): any {
  let data: any = (void *)gTasks[taskId].data;
...
export function LoadMysteryGiftTextboxBorder(...args: any[]): any {
