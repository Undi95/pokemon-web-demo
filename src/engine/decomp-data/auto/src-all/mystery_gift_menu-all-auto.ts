...
const {
  ...
  AllocZeroed, AnimateSprites, AskDiscardGift, BG_PLTT_ID,
  BuildOamBuffer, ChangeBgX, ChangeBgY, ClearGpuRegBits,
  ClearMessage, ClearSavedNewsOrCard, ClearSavedWonderCardAndRelated, ClearSavedWonderNewsAndRelated,
  ClearScreenInBg0, ClearWindowTilemap, CloseLink, CopyBgTilemapBufferToVram,
  CopyWindowToVram, CreateEReaderTask, CreateMysteryGiftTask, CreateTask,
  CreateTask_LinkMysteryGiftOverWireless, CreateTask_LinkMysteryGiftWithFriend, CreateTask_SendMysteryGift, CreateYesNoMenu,
  DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap, DestroyTask, DestroyWirelessStatusIndicatorSprite,
  DoMysteryGiftListMenu, DoMysteryGiftYesNo, DrawDownArrow, DrawTextBorderOuter,
  EnableInterrupts, ExitWonderCardOrNews, FillBgTilemapBufferRect, FillWindowPixelBuffer,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, GetBgTilemapBuffer,
  GetClientResultMessage, GetSavedWonderCard, GetSavedWonderCardMetadata, GetSavedWonderNews,
  GetServerResultMessage, GetStringRightAlignXOffset, GetTextWindowPalette, HandleGiftSelectMenu,
  HandleLoadWonderCardOrNews, HandleMysteryGiftOrEReaderSetup, InitBgsFromTemplates, InitWindows,
  Intl_GetListMenuWidth, IsFanfareTaskInactive, IsSavedWonderCardGiftNotReceived, IsSendingSavedWonderCardAllowed,
  IsSendingSavedWonderNewsAllowed, JOY_NEW, LoadMysteryGiftTextboxBorder, LoadOam,
  LoadPalette, LoadUserWindowBorderGfx, LoadUserWindowBorderGfx_, MG_AddMessageTextPrinter,
  MG_DrawCheckerboardPattern, Menu_LoadStdPalAt, Menu_ProcessInputNoWrapClearOnChoose, MysterGiftServer_CreateForCard,
  MysterGiftServer_CreateForNews, MysterGiftServer_Run, MysteryGiftClient_AdvanceState, MysteryGiftClient_Create,
  MysteryGiftClient_GetMsg, MysteryGiftClient_Run, MysteryGiftClient_SetParam, MysteryGift_HandleThreeOptionMenu,
  PlayBGM, PlayFanfare, PrintMysteryGiftMenuMessage, PrintMysteryGiftOrEReaderHeader,
  PrintServerResultMessage, PrintStringAndWait2Seconds, PrintSuccessMessage, PrintThrownAway,
  ProcessSpriteCopyRequests, PutWindowTilemap, RemoveWindow, ResetBgsAndClearDma3BusyFlags,
  ResetPaletteFade, ResetSpriteData, ResetTasks, Rfu_SetCloseLinkCallback,
  RunTasks, RunTextPrinters, SaveOnMysteryGiftMenu, ScanlineEffect_Stop,
  ...
  TrySavingData, ValidateCardOrNews, ValidateSavedWonderCard, ValidateSavedWonderNews,
