...
const {
  ...
  CopyAllBattleSpritesInvisibilities, CopyBattleSpriteInvisibility, CopyLinkOpponentMonData, CreateInvisibleSpriteWithCallback,
  ...
  FreeSpriteTilesByTag, FreeTrainerFrontPicPalette, GetBattlerMultiplayerId, GetBattlerPosition,
  ...
  InitAndLaunchSpecialAnimation, IsBattleSEPlaying, IsBattlerSpritePresent, IsBattlerSpriteVisible,
  IsCryPlayingOrClearCrySongs, IsDoubleBattle, IsMoveWithoutAnimation, IsTextPrinterActive,
  LinkOpponentBufferExecCompleted, LoadBattleBarGfx, MoveBattleBar, PlayBGM,
  PlayCry_ByMode, PlayFanfare, PlaySE12WithPanning, PlayerGenderToFrontTrainerPicId,
  PrepareBufferDataTransferLink, RecordedBattle_RecordAllBattlerData, SetBattleBarStruct, SetBattlerShadowSpriteCallback,
  SetBattlerSpriteAffineMode, SetHealthboxSpriteInvisible, SetHealthboxSpriteVisible, SetLinkOpponentMonData,
