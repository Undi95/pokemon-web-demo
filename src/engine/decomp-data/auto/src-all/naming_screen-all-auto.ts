...
const {
  ...
  CreateObjectGraphicsSprite, CreateSprite, CreateTask, DestroyTask,
  ...
  GetGpuReg, GetPCBoxToSendMon, GetPlayerTextSpeedDelay, GetRivalAvatarGraphicsIdByStateIdAndGender,
  GetSpriteTileStartByTag, GetTextWindowPalette, IndexOfSpritePaletteTag, InitBgsFromTemplates,
  InitStandardTextBoxWindows, InitTextBoxGfxAndPrinters, IsDestinationBoxFull, IsTextPrinterActive,
  JOY_NEW, JOY_REPEAT, LZ77UnCompWram, LoadBgTiles,
  LoadMonIconPalettes, LoadOam, LoadPalette, LoadSpritePalettes,
  LoadSpriteSheets, MOD, MultiplyInvertedPaletteRGBComponents, NamingScreen_Dummy,
  OBJ_PLTT_ID, PIXEL_FILL, PlaySE, ProcessSpriteCopyRequests,
  PutWindowTilemap, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData,
  ResetTasks, RunTasks, RunTextPrinters, SeedRngAndSetTrainerId,
  SetBgTilemapBuffer, SetGpuReg, SetGpuRegBits, SetHBlankCallback,
  SetMainCallback2, SetSubspriteTables, SetVBlankCallback, ShowBg,
  Sin, StartSpriteAnim, StartTimer1, StringCopy,
  StringCopyN, StringExpandPlaceholders, TransferPlttBuffer, UpdatePaletteFade,
