...
const {
  ARRAY_COUNT, AddTextCharacter, AddTextPrinterParameterized, AddTextPrinterParameterized2,
  AddTextPrinterParameterized3, AddWindow, Alloc, AnimateSprites,
  BGCNT_PRIORITY, BG_PLTT_ID, BLDALPHA_BLEND, BeginNormalPaletteFade,
  BlendPalettes, BufferCharacter, BuildOamBuffer, CalculatePlayerPartyCount,
  ChangeBgX, ChangeBgY, CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer,
  CopyWindowToVram, CreateBackOkSprites, CreateButtonFlashTask, CreateCursorSprite,
  CreateHelperTasks, CreateInputHandlerTask, CreateInputTargetIcon, CreateMonIcon,
  CreateNamingScreenTask, CreateObjectGraphicsSprite, CreatePageSwapButtonSprites, CreateSprite,
  CreateSprites, CreateTask, CreateTextEntrySprites, CurrentPageToKeyboardId,
  CurrentPageToNextKeyboardId, DeleteTextCharacter, DestroyTask, DisplaySentToPCMessage,
  DmaClear16, DmaClear32, DmaClearLarge16, DrawBgTilemap,
  DrawDialogueFrame, DrawKeyboardPageOnDeck, DrawTextEntry, DrawTextEntryBox,
  FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FindTaskIdByFunc,
  FlagGet, FreeAllSpritePalettes, FreeAllWindowBuffers, GetBoxNamePtr,
  GetButtonPalOffset, GetCharAtKeyboardPos, GetCurrentPageColumnCount, GetCursorPos,
  GetGpuReg, GetInputEvent, GetKeyRoleAtCursorPos, GetPCBoxToSendMon,
  GetPlayerTextSpeedDelay, GetPreviousTextCaretPosition, GetRivalAvatarGraphicsIdByStateIdAndGender, GetSpriteTileStartByTag,
  GetTextEntryPosition, GetTextWindowPalette, HandleDpadMovement, HandleKeyboardEvent,
  IndexOfSpritePaletteTag, InitBgsFromTemplates, InitStandardTextBoxWindows, InitTextBoxGfxAndPrinters,
  IsCursorAnimFinished, IsDestinationBoxFull, IsPageSwapAnimNotInProgress, IsTextPrinterActive,
  IsWideLetter, JOY_NEW, JOY_REPEAT, LZ77UnCompWram,
  LoadBgTiles, LoadGfx, LoadMonIconPalettes, LoadOam,
  LoadPalette, LoadPalettes, LoadSpritePalettes, LoadSpriteSheets,
  MOD, MainState_Exit, MainState_FadeIn, MainState_FadeOut,
  MainState_HandleInput, MainState_MoveToOKButton, MainState_PressedOKButton, MainState_StartPageSwap,
  MainState_WaitFadeIn, MainState_WaitPageSwap, MainState_WaitSentToPCMessage, MoveCursorToOKButton,
  MultiplyInvertedPaletteRGBComponents, NamingScreen_Dummy, NamingScreen_Init, NamingScreen_InitBGs,
  NamingScreen_ShowBgs, OBJ_PLTT_ID, PIXEL_FILL, PageToNextGfxId,
  PlaySE, PrintControls, PrintKeyboardKeys, ProcessSpriteCopyRequests,
  PutWindowTilemap, ResetBgsAndClearDma3BusyFlags, ResetPaletteFade, ResetSpriteData,
  ResetTasks, ResetVHBlank, RestoreButtonColor, RunTasks,
  RunTextPrinters, SaveInputText, SeedRngAndSetTrainerId, SetBgTilemapBuffer,
  SetCursorFlashing, SetCursorInvisibility, SetCursorPos, SetGpuReg,
  SetGpuRegBits, SetHBlankCallback, SetInputState, SetMainCallback2,
  SetPageSwapButtonGfx, SetSpritesVisible, SetSubspriteTables, SetVBlank,
  SetVBlankCallback, ShowBg, Sin, SquishCursor,
  StartButtonFlash, StartPageSwapAnim, StartPageSwapButtonAnim, StartSpriteAnim,
  StartTimer1, StringCopy, StringCopyN, StringExpandPlaceholders,
  SwapKeyboardPage, Task_HandlePageSwapAnim, TransferPlttBuffer, TryDrawGenderIcon,
  TryStartButtonFlash, UpdatePaletteFade, VarGet,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
