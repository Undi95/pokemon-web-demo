...
const {
  ARRAY_COUNT, AddTextPrinterParameterized, AddTextPrinterParameterized2, AddTextPrinterParameterized3,
  AddWindow, Alloc, AnimateSprites, BGCNT_PRIORITY,
  BG_PLTT_ID, BLDALPHA_BLEND, BLDCNT_EFFECT_BLEND, BLDCNT_TGT2_BG1,
  BLDCNT_TGT2_BG2, BeginNormalPaletteFade, BlendPalettes, BuildOamBuffer,
  CalculatePlayerPartyCount, ChangeBgX, ChangeBgY, CopyBgTilemapBufferToVram,
  CopyToBgTilemapBuffer, CopyWindowToVram, CreateMonIcon, CreateObjectGraphicsSprite,
  CreateSprite, CreateTask, DISPCNT_OBJ_1D_MAP, DISPCNT_OBJ_ON,
  DestroyTask, DmaClear16, DmaClear32, DmaClearLarge16,
  DrawDialogueFrame, FALSE, FREE_AND_SET_NULL, FillBgTilemapBufferRect_Palette0,
  FillWindowPixelBuffer, FindTaskIdByFunc, FlagGet, FreeAllSpritePalettes,
  FreeAllWindowBuffers, GetBoxNamePtr, GetGpuReg, GetPCBoxToSendMon,
  GetPlayerTextSpeedDelay, GetRivalAvatarGraphicsIdByStateIdAndGender, GetSpriteTileStartByTag, GetTextWindowPalette,
  IndexOfSpritePaletteTag, InitBgsFromTemplates, InitStandardTextBoxWindows, InitTextBoxGfxAndPrinters,
  IsDestinationBoxFull, IsTextPrinterActive, JOY_NEW, JOY_REPEAT,
  LZ77UnCompWram, LoadBgTiles, LoadMonIconPalettes, LoadOam,
  LoadPalette, LoadSpritePalettes, LoadSpriteSheets, MOD,
  MultiplyInvertedPaletteRGBComponents, NULL, NamingScreen_Dummy, OBJ_PLTT_ID,
  PALETTES_ALL, PIXEL_FILL, PLTT_SIZE, PLTT_SIZE_4BPP,
  PlaySE, ProcessSpriteCopyRequests, PutWindowTilemap, REG_OFFSET_BG1CNT,
  REG_OFFSET_BG1VOFS, REG_OFFSET_BG2CNT, REG_OFFSET_BG2VOFS, REG_OFFSET_BLDALPHA,
