...
export function DoNamingScreen(...args: any[]): any {
...
export function Task_NamingScreen(...args: any[]): any {
...
export function PageToNextGfxId(...args: any[]): any {
...
export function Task_HandlePageSwapAnim(...args: any[]): any {
...
export function PageSwapAnimState_Init(...args: any[]): any {
  sNamingScreen.bg1vOffset = 0;
      sNamingScreen.bg2vOffset = 0;
      task.tState++;
      return 0;
...
export function PageSwapAnimState_1(...args: any[]): any {
  u16 *const vOffsets[] = [
      ...
      *vOffsets[sNamingScreen.bgToHide] = Sin((task.tFrameCount + 128) & 0xFF, 40);
      ...
      {
          let temp = sNamingScreen.bg1Priority;   
...
export function PageSwapAnimState_2(...args: any[]): any {
  u16 *const vOffsets[] = [
          sNamingScreen.bg2vOffset,
          sNamingScreen.bg1vOffset
      ];
      ...
      *vOffsets[sNamingScreen.bgToHide] = Sin((task.tFrameCount + 128) & 0xFF, 40);
      ...
      {
          let temp = sNamingScreen.bgToReveal;
...
export function PageSwapAnimState_Done(...args: any[]): any {
...
export function TryStartButtonFlash(...args: any[]): any {
...
export function Task_UpdateButtonFlash(...args: any[]): any {
...
export function GetButtonPalOffset(...args: any[]): any {
...
export function RestoreButtonColor(...args: any[]): any {
  let index = GetButtonPalOffset(button);
      gPlttBufferFaded[index] = gPlttBufferUnfaded[index];
}

/** static void StartButtonFlash(struct Task *task, u8 button, bool8 keepFlashing) */
export function StartButtonFlash(...args: any[]): any {
...
export function SpriteCB_Cursor(...args: any[]): any {
  if (sprite.animEnded)
      ...
      if (sprite.sFlashing)
      {
          let gb = sprite.sColor;
          let r = sprite.sColor >> 1;
...
export function SpriteCB_InputArrow(...args: any[]): any {
  const x: any = [0, -4, -2, -1];
...
export function SpriteCB_Underscore(...args: any[]): any {
  const y: any = [2, 3, 2, 1];
      let pos: any = null;
...
export function SetCursorPos(...args: any[]): any {
...
export function GetCursorPos(...args: any[]): any {
  let cursorSprite: any = gSprites[sNamingScreen.cursorSpriteId];
...
export function SetCursorInvisibility(...args: any[]): any {
...
export function SetCursorFlashing(...args: any[]): any {
...
export function PageSwapSprite_Idle(...args: any[]): any {
  return FALSE;
}

/** static bool8 PageSwapSprite_SlideOff(struct Sprite *sprite) */
export function PageSwapSprite_SlideOff(...args: any[]): any {
  let text: any = gSprites[sprite.sTextSpriteId];
      let button: any = gSprites[sprite.sButtonSpriteId];
...
export function PageSwapSprite_SlideOn(...args: any[]): any {
  let text: any = gSprites[sprite.sTextSpriteId];
...
export function SetPageSwapButtonGfx(...args: any[]): any {
...
export function HandleKeyboardEvent(): any {
  let input = GetInputEvent();
      let keyRole = GetKeyRoleAtCursorPos();
...
export function KeyboardKeyHandler_Character(...args: any[]): any {
  TryStartButtonFlash(BUTTON_COUNT, FALSE, FALSE);
      if (input == INPUT_A_BUTTON)
      {
          let textFull = AddTextCharacter();
...
export function KeyboardKeyHandler_Page(...args: any[]): any {
...
export function KeyboardKeyHandler_Backspace(...args: any[]): any {
...
export function KeyboardKeyHandler_OK(...args: any[]): any {
...
export function GetInputEvent(): any {
  let taskId = FindTaskIdByFunc(Task_HandleInput);

      return gTasks[taskId].tKeyboardEvent;
}

/** static void SetInputState(u8 state) */
export function SetInputState(...args: any[]): any {
  let taskId = FindTaskIdByFunc(Task_HandleInput);
...
export function Input_Disabled(...args: any[]): any {
  task.tKeyboardEvent = INPUT_NONE;
}

/** static void Input_Enabled(struct Task *task) */
export function Input_Enabled(...args: any[]): any {
  task.tKeyboardEvent = INPUT_NONE;
...
export function Input_Override(...args: any[]): any {
  task.tKeyboardEvent = INPUT_NONE;
}

/** static void HandleDpadMovement(struct Task *task) */
export function HandleDpadMovement(...args: any[]): any {
...
export function GetCharAtKeyboardPos(...args: any[]): any {
...
export function BufferCharacter(...args: any[]): any {
  let index = GetTextEntryPosition();
...
export function DrawBgTilemap(...args: any[]): any {
...
export function DrawTextEntry(): any {
  let i: any = null;
      ...
      let maxChars = sNamingScreen.template.maxChars;
      let x = sNamingScreen.inputCharBaseXPos - 0x40;
...
export function PrintKeyboardKeys(...args: any[]): any {
  let i: any = null;
...
export function DrawKeyboardPageOnDeck(): any {
  let bg: any = null;
      ...
      let bg1Priority = GetGpuReg(REG_OFFSET_BG1CNT) & 3;
      let bg2Priority = GetGpuReg(REG_OFFSET_BG2CNT) & 3;
...
export function IsWideLetter(...args: any[]): any {
  let i: any = null;
