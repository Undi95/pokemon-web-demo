...
export function HealMon(...args: any[]): any {
  let i: any = null;
      let hp: any = null;
      ...
      {
          let move = GetMonData(mon, MON_DATA_MOVE1 + i);
...
export function DoesAbilityPreventStatus(...args: any[]): any {
...
export function DoesTypePreventStatus(...args: any[]): any {
  let ret = FALSE;
...
export function TryGenerateBattlePikeWildMon(...args: any[]): any {
  let i: any = null;
      ...
      let pikeMonId = GetMonData(gEnemyParty[0], MON_DATA_SPECIES, NULL);
...
export function DoStatusInflictionScreenFlash(...args: any[]): any {
...
export function StatusInflictionFadeOut(...args: any[]): any {
...
export function StatusInflictionFadeIn(...args: any[]): any {
  if (task.data[6] == 0 || --task.data[6] == 0)
      {
          task.data[6] = task.data[2];
...
export function StartStatusInflictionScreenFlash(...args: any[]): any {
  let taskId = CreateTask(DoStatusInflictionScreenFlash, 3);
...
export function Task_DoStatusInflictionScreenFlash(...args: any[]): any {
...
export function TryHealMons(...args: any[]): any {
  let j, i, k;
      const indices: any[] = [];
      ...
      for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
      {
          ...
          let curr = GetMonData(mon, MON_DATA_HP);
          let max = GetMonData(mon, MON_DATA_MAX_HP);
          if (curr < max)
          {
              canBeHealed = TRUE;
          }
          ...
          else
          {
              ...
              {
                  let move = GetMonData(mon, MON_DATA_MOVE1 + j);
...
export function PrepareOneTrainer(...args: any[]): any {
  let i: any = null;
...
export function PrepareTwoTrainers(): any {
  let i: any = null;
      let trainerId: any = null;
      let lvlMode = gSaveBlock2Ptr.frontier.lvlMode;
      let challengeNum = gSaveBlock2Ptr.frontier.pikeWinStreaks[lvlMode] / NUM_PIKE_ROOMS;
...
export function GetPikeQueenFightType(...args: any[]): any {
...
export function HealSomeMonsBeforePikeQueen(): any {
  let toHealCount = sNumMonsToHealBeforePikeQueen[gSaveBlock2Ptr.frontier.pikeHintedRoomIndex][gSpecialVar_0x8007];
...
export function SaveMonHeldItems(): any {
  let i: any = null;
      ...
      for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
      {
          let heldItem = GetMonData(gSaveBlock1Ptr.playerParty[gSaveBlock2Ptr.frontier.selectedPartyMons[i] - 1],
                                    MON_DATA_HELD_ITEM);
...
export function CanEncounterWildMon(...args: any[]): any {
...
export function SpeciesToPikeMonId(...args: any[]): any {
  let ret: any = null;
