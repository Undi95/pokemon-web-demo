...
const {
  ...
  BufferTradeParties, BufferTradeSceneStrings, BuildOamBuffer, CB_ChooseMonAfterButtonPress,
  CB_ExitCanceledTrade, CB_FadeToStartTrade, CB_HandleTradeCanceled, CB_InitConfirmTradePrompt,
  CB_InitExitCanceledTrade, CB_PartnersMonWasInvalid, CB_PrintIsThisTradeOkay, CB_ProcessCancelTradeInput,
  CB_ProcessConfirmTradeInput, CB_ProcessMenuInput, CB_ProcessSelectedMonInput, CB_SetSelectedMons,
  CB_ShowTradeMonSummaryScreen, CB_StartLinkTrade, CB_WaitToStartRfuTrade, CB_WaitToStartTrade,
  CalcCenterToCornerVec, CalculateEnemyPartyCount, CalculateMonStats, CalculatePlayerPartyCount,
  CanTradeSelectedMon, ChangeBgX, ChangeBgY, CheckForLinkTimeout,
  CheckMonsBeforeTrade, CheckPartnersMonForRibbons, CheckShouldAdvanceLinkState, CheckValidityOfTradeMons,
  ClearContinueGameWarpStatus2, ClearGpuRegBits, ClearLinkTimeoutTimer, ClearMail,
  ClearWindowTilemap, CloseLink, ComputePartyHPBarLevels, ComputePartyTradeableFlags,
  CopyBgTilemapBufferToVram, CopyToBgTilemapBuffer, CopyToBgTilemapBufferRect_ChangePalette, CopyWindowToVram,
  CreateInGameTradePokemonInternal, CreateMon, CreateMonIcon, CreatePokeballSpriteToReleaseMon,
  CreateSprite, CreateTask, CreateTask_RfuIdle, CreateTradePokeballSprite,
  CreateWirelessStatusIndicatorSprite, CreateYesNoMenu, DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap,
  DestroySprite, DestroyTask, DestroyTask_RfuIdle, DestroyWirelessStatusIndicatorSprite,
  DmaCopy16Defvars, DmaCopyLarge16, DoBgAffineSet, DoQueuedActions,
  DoTradeAnim, DoTradeAnim_Cable, DoTradeAnim_Wireless, DrawBottomRowText,
  DrawHeldItemIconsForTrade, DrawSelectedMonScreen, DrawTextBorderOuter, DrawTextOnTradeWindow,
  DrawTextWindowAndBufferTiles, FREE_AND_SET_NULL, FadeOutBGM, FillBgTilemapBufferRect,
  FillBgTilemapBufferRect_Palette0, FillWindowPixelBuffer, FlagSet, Follower_ReadLinkBuffer,
  ...
  GetHPBarLevel, GetInGameTradeMail, GetLinkPlayerCount, GetLinkPlayerCount_2,
  GetMonData, GetMonGender, GetMonNicknameWidth, GetMonSpritePalStruct,
  GetMultiplayerId, GetNewCursorPosition, GetNumQueuedActions, GetSavedPlayerCount,
  GetSetPokedexFlag, GetStringCenterAlignXOffset, GetStringWidth, GiveMailToMon,
  HandleLinkDataReceive, HandleLinkDataSend, HandleLoadSpecialPokePic_2, HandleLoadSpecialPokePic_DontHandleDeoxys,
  HandleSetPokedexFlag, HasLinkErrorOccurred, InUnionRoom, IncrementGameStat,
  InitBgsFromTemplates, InitMenuInUpperLeftCornerNormal, InitTradeMenu, InitTradeSequenceBgGpuRegs,
  InitWindows, IsBGMStopped, IsCryFinished, IsDeoxysOrMewUntradable,
  IsLinkMaster, IsLinkPlayerDataExchangeComplete, IsLinkRfuTaskFinished, IsLinkTaskFinished,
  IsLinkTradeTaskFinished, IsMonSpriteNotFlipped, IsNationalPokedexEnabled, IsSpeciesInHoennDex,
  IsWirelessTrade, ItemIsMail, JOY_NEW, JOY_REPEAT,
  LZ77UnCompVram, LZDecompressWram, Leader_HandleCommunication, Leader_ReadLinkBuffer,
  LinkFullSave_Init, LinkFullSave_ReplaceLastSector, LinkFullSave_SetLastSectorSignature, LinkFullSave_WriteSector,
  LinkTradeDrawWindow, LoadBgTilemap, LoadBgTiles, LoadCompressedPalette,
  LoadCompressedSpritePalette, LoadHeldItemIcons, LoadMonIconPalettes, LoadOam,
  LoadPalette, LoadSpritePalette, LoadSpriteSheet, LoadTradeBgGfx,
  LoadTradeMonPic, LoadTradeSequenceSpriteSheetsAndPalettes, LoadUISpriteGfx, LoadUserWindowBorderGfx,
  LoadUserWindowBorderGfx_, LoadWirelessStatusIndicatorSpriteGfx, LockPlayerFieldControls, Menu_ProcessInputNoWrap,
  Menu_ProcessInputNoWrapClearOnChoose, MysteryGift_TryIncrementStat, NameHasGenderSymbol, OBJ_PLTT_ID2,
  OpenLink, PIXEL_FILL, PLTT_SIZEOF, PadNameString,
  PlayBGM, PlayCry_Normal, PlayFanfare, PlayNewMapMusic,
  PlaySE, PrintIsThisTradeOkay, PrintLevelAndGender, PrintMenuTable,
  PrintPartyLevelsAndGenders, PrintPartyMonNickname, PrintPartyNicknames, PrintTradeMessage,
  PrintTradePartnerPartyNicknames, ProcessSpriteCopyRequests, PutWindowTilemap, QueueAction,
  Random, RedrawChooseAPokemonWindow, RedrawPartyWindow, RequestLinkData,
  ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlag, ResetBlockReceivedFlags, ResetPaletteFade,
  ResetSpriteData, ResetTasks, RestoreNicknamesCoveredByYesNo, Rfu_GetIndexOfNewestChild,
  Rfu_SetLinkRecovery, RunTasks, RunTextPrinters, RunTextPrintersAndIsPrinter0Active,
  RunTradeMenuCallback, SPRITE_SHAPE, SPRITE_SIZE, SWAP,
  SaveTradeGiftRibbons, SendBlock, SendBlockRequest, SendLinkData,
  SetActiveMenuOptions, SetBgTilemapBuffer, SetCloseLinkCallback, SetCloseLinkCallbackAndType,
  SetContinueGameWarpStatusToDynamicWarp, SetGpuReg, SetGpuRegBits, SetLinkData,
  SetLinkStandbyCallback, SetMainCallback2, SetMonData, SetMultiuseSpriteTemplateToPokemon,
  SetPartyHPBarSprite, SetReadyToTrade, SetSelectedMon, SetTradeBGAffine,
  SetTradeGpuRegs, SetTradeLinkStandbyCallback, SetTradePartyHPBarSprites, SetTradeSequenceBgGpuRegs,
  SetVBlankCallback, SetWirelessCommType1, ShowBg, ShowPokemonSummaryScreen,
  ShowTradePartyMonIcons, SpeciesToNationalPokedexNum, StartSpriteAffineAnim, StartSpriteAnim,
  StoreSpriteCallbackInData6, StringAppend, StringCompareWithoutExtCtrlCodes, StringCopy,
  StringCopy_Nickname, StringExpandPlaceholders, TradeAnimInit_LoadGfx, TradeEvolutionScene,
  TradeGetMultiplayerId, TradeMenuMoveCursor, TradeMons, TradeResetReceivedFlag,
  TradeResetReceivedFlags, Trade_Memcpy, Trade_MoveSelectedMonToTarget, TransferPlttBuffer,
  TryEnableNationalDexFromLinkPartner, UpdatePaletteFade, UpdatePokedexForReceivedMon, WIN_RANGE2,
  _GetBlockReceivedStatus, _IsLinkTaskFinished, _SetLinkData,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
