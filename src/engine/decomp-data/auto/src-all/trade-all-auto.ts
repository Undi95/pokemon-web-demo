...
export function SendLinkData(...args: any[]): any {
...
export function RequestLinkData(...args: any[]): any {
...
export function TradeResetReceivedFlag(...args: any[]): any {
  if (IsWirelessTrade())
          rfu_clearSlot(12, lman.acceptSlot_flag);
      else
...
export function SetTradeLinkStandbyCallback(...args: any[]): any {
...
export function LoadTradeBgGfx(...args: any[]): any {
  let i: any = null;
...
export function Trade_Memcpy(...args: any[]): any {
  let _dest = dest;
      let _src = src;
      let i: any = null;
      for (i = 0; i < size; i++)
...
export function Leader_ReadLinkBuffer(...args: any[]): any {
  if (status & 1)
      {
...
export function Follower_ReadLinkBuffer(...args: any[]): any {
  if (status & 1)
      {
          switch (gBlockRecvBuffer[0][0])
          {
...
export function _SetLinkData(...args: any[]): any {
  linkData[0] = linkCmd;
...
export function SetLinkData(...args: any[]): any {
...
export function GetNewCursorPosition(...args: any[]): any {
  let i: any = null;
      let newPosition = 0;
...
export function TradeMenuMoveCursor(...args: any[]): any {
  let newPosition = GetNewCursorPosition(*cursorPosition, direction);
...
export function CheckValidityOfTradeMons(...args: any[]): any {
  let i: any = null;
...
export function SetSelectedMon(...args: any[]): any {
  let whichParty = cursorPosition / PARTY_SIZE;
...
export function DrawSelectedMonScreen(...args: any[]): any {
  let nameStringWidth: any = null;
      ...
      let selectedMonIdx = sTradeMenu.selectedMonIdx[whichParty];
...
export function GetMonNicknameWidth(...args: any[]): any {
  const nickname: any[] = [];
...
export function BufferMovesString(...args: any[]): any {
  const moves: any[] = [];
      let i: any = null;
...
export function PrintPartyMonNickname(...args: any[]): any {
  let xPos: any = null;
...
export function PrintPartyNicknames(...args: any[]): any {
  let i: any = null;
      const nickname: any[] = [];
      const str: any[] = [];
...
export function PrintLevelAndGender(...args: any[]): any {
  let level: any = null;
...
export function PrintPartyLevelsAndGenders(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < sTradeMenu.partyCounts[whichParty]; i++)
      {
          let j = i + PARTY_SIZE * whichParty;
          PrintLevelAndGender(
              whichParty,
              i,
...
export function ShowTradePartyMonIcons(...args: any[]): any {
  let i: any = null;
...
export function RedrawPartyWindow(...args: any[]): any {
  CopyToBgTilemapBufferRect_ChangePalette(1, sTradePartyBoxTilemap, whichParty * 15, 0, 15, 17, 0);
      CopyBgTilemapBufferToVram(1);
...
export function Task_DrawSelectionSummary(...args: any[]): any {
  FillBgTilemapBufferRect_Palette0(0, 0, 0, 0, DISPLAY_TILE_WIDTH, DISPLAY_TILE_HEIGHT);
      CopyBgTilemapBufferToVram(0);
}

/** static void Task_DrawSelectionTrade(u8 taskId) */
export function Task_DrawSelectionTrade(...args: any[]): any {
  FillBgTilemapBufferRect_Palette0(0, 0, 0, 0, DISPLAY_TILE_WIDTH, DISPLAY_TILE_HEIGHT);
      CopyBgTilemapBufferToVram(0);
}

/** static void QueueAction(u16 delay, u8 actionId) */
export function QueueAction(...args: any[]): any {
  let i: any = null;
...
export function PrintTradeMessage(...args: any[]): any {
...
export function DrawBottomRowText(...args: any[]): any {
  DrawTextWindowAndBufferTiles(str, dest, 0, 0, 6);
}

/** static void ComputePartyTradeableFlags(u8 whichParty) */
export function ComputePartyTradeableFlags(...args: any[]): any {
  let i: any = null;
...
export function ComputePartyHPBarLevels(...args: any[]): any {
  let i, curHp, maxHp;
...
export function CanTradeSelectedMon(...args: any[]): any {
  let i, numMonsLeft;
...
export function IsDeoxysOrMewUntradable(...args: any[]): any {
...
export function GetUnionRoomTradeMessageId(...args: any[]): any {
  let playerHasNationalDex = player.hasNationalDex;
      let playerCanLinkNationally = player.canLinkNationally;
      let partnerHasNationalDex = partner.hasNationalDex;
      let partnerCanLinkNationally = partner.canLinkNationally;
      let partnerVersion = partner.version;
...
export function CanRegisterMonForTradingBoard(...args: any[]): any {
  let hasNationalDex = player.hasNationalDex;
...
export function CanSpinTradeMon(...args: any[]): any {
...
export function SpriteCB_LinkMonGlow(...args: any[]): any {
  if (++sprite.data[0] == 10)
      {
          PlaySE(SE_BALL);
          sprite.data[0] = 0;
...
export function SpriteCB_LinkMonGlowWireless(...args: any[]): any {
...
export function SpriteCB_LinkMonShadow(...args: any[]): any {
  if (!sprite.data[1])
      {
          if (++sprite.data[0] == 12)
              sprite.data[0] = 0;
...
export function SpriteCB_CableEndSending(...args: any[]): any {
  sprite.data[0]++;
      sprite.y2++;
...
export function SpriteCB_CableEndReceiving(...args: any[]): any {
  sprite.data[0]++;
      sprite.y2--;
...
export function SpriteCB_GbaScreen(...args: any[]): any {
  if (++sprite.data[0] == 15)
      {
...
export function LoadTradeMonPic(...args: any[]): any {
  let pos = 0;
      let mon: any = NULL;
...
export function UpdatePokedexForReceivedMon(...args: any[]): any {
  let mon: any = gPlayerParty[partyIdx];

      if (!GetMonData(mon, MON_DATA_IS_EGG))
      {
          let species = GetMonData(mon, MON_DATA_SPECIES, NULL);
          let personality = GetMonData(mon, MON_DATA_PERSONALITY, NULL);
...
export function TradeMons(...args: any[]): any {
  let friendship: any = null;

      let playerMon: any = gPlayerParty[playerPartyIdx];
      let playerMail = GetMonData(playerMon, MON_DATA_MAIL);

      let partnerMon: any = gEnemyParty[partnerPartyIdx];
      let partnerMail = GetMonData(partnerMon, MON_DATA_MAIL);
...
export function SetTradeSequenceBgGpuRegs(...args: any[]): any {
  switch (state)
      {
      case 0:
...
export function DoTradeAnim_Wireless(): any {
  let evoTarget: any = null;
      ...
      case STATE_PAN_TO_GBA_WIRELESS:
          ...
          if (++sTradeAnim.timer == 10)
          {
              let taskId = CreateTask(Task_AnimateWirelessSignal, 5);
...
export function SpriteCB_BouncingPokeball(...args: any[]): any {
...
export function SpriteCB_BouncingPokeballDepart(...args: any[]): any {
...
export function SpriteCB_BouncingPokeballDepartEnd(...args: any[]): any {
  if (sprite.data[1] == 20)
...
export function SpriteCB_BouncingPokeballArrive(...args: any[]): any {
  if (sprite.data[2] == 0)
      {
...
export function CreateInGameTradePokemonInternal(...args: any[]): any {
  let inGameTrade: any = sIngameTrades[whichInGameTrade];
      let level = GetMonData(gPlayerParty[whichPlayerMon], MON_DATA_LEVEL);
...
export function GetInGameTradeMail(...args: any[]): any {
  let i: any = null;
...
export function Task_InGameTrade(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function DrawTextOnTradeWindow(...args: any[]): any {
...
export function Task_AnimateWirelessSignal(...args: any[]): any {
  let data = gTasks[taskId].data;

      let paletteIdx = sWirelessSignalAnimParams[tIdx][0] * 16;
...
export function Task_OpenCenterWhiteColumn(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function Task_CloseCenterWhiteColumn(...args: any[]): any {
  let data = gTasks[taskId].data;
