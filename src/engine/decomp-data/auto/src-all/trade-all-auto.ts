...
const {
  ...
  BitmaskAllOtherLinkPlayers, BlendPalettes, BuildOamBuffer, CalcCenterToCornerVec,
  CalculateEnemyPartyCount, CalculateMonStats, CalculatePlayerPartyCount, ChangeBgX,
  ChangeBgY, CheckShouldAdvanceLinkState, ClearContinueGameWarpStatus2, ClearGpuRegBits,
  ClearMail, ClearWindowTilemap, CloseLink, CopyBgTilemapBufferToVram,
  CopyToBgTilemapBuffer, CopyToBgTilemapBufferRect_ChangePalette, CopyWindowToVram, CreateMon,
  CreateMonIcon, CreatePokeballSpriteToReleaseMon, CreateSprite, CreateTask,
  CreateTask_RfuIdle, CreateTradePokeballSprite, CreateWirelessStatusIndicatorSprite, CreateYesNoMenu,
  DeactivateAllTextPrinters, DecompressAndLoadBgGfxUsingHeap, DestroySprite, DestroyTask,
  DestroyTask_RfuIdle, DestroyWirelessStatusIndicatorSprite, DmaCopy16Defvars, DmaCopyLarge16,
  DoBgAffineSet, DrawHeldItemIconsForTrade, DrawTextBorderOuter, DrawTextWindowAndBufferTiles,
  ...
  Random, ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlag, ResetBlockReceivedFlags,
  ResetPaletteFade, ResetSpriteData, ResetTasks, Rfu_GetIndexOfNewestChild,
  Rfu_SetLinkRecovery, RunTasks, RunTextPrinters, RunTextPrintersAndIsPrinter0Active,
  SPRITE_SHAPE, SPRITE_SIZE, SWAP, SendBlock,
  SendBlockRequest, SetBgTilemapBuffer, SetCloseLinkCallback, SetCloseLinkCallbackAndType,
  SetContinueGameWarpStatusToDynamicWarp, SetGpuReg, SetGpuRegBits, SetLinkStandbyCallback,
  SetMainCallback2, SetMonData, SetMultiuseSpriteTemplateToPokemon, SetPartyHPBarSprite,
  SetVBlankCallback, SetWirelessCommType1, ShowBg, ShowPokemonSummaryScreen,
  SpeciesToNationalPokedexNum, StartSpriteAffineAnim, StartSpriteAnim, StoreSpriteCallbackInData6,
  StringAppend, StringCompareWithoutExtCtrlCodes, StringCopy, StringCopy_Nickname,
  StringExpandPlaceholders, TradeEvolutionScene, Trade_MoveSelectedMonToTarget, TransferPlttBuffer,
