...
export function FieldEffectStart(...args: any[]): any {
  let script: any = null;
      let val: any = null;
...
export function FieldEffectCmd_loadtiles(...args: any[]): any {
  (*script)++;
...
export function FieldEffectCmd_loadfadedpal(...args: any[]): any {
  (*script)++;
...
export function FieldEffectCmd_loadpal(...args: any[]): any {
  (*script)++;
...
export function FieldEffectCmd_callnative(...args: any[]): any {
  (*script)++;
...
export function FieldEffectCmd_end(...args: any[]): any {
  return FALSE;
}

/** bool8 FieldEffectCmd_loadgfx_callnative(u8 **script, u32 *val) */
export function FieldEffectCmd_loadgfx_callnative(...args: any[]): any {
  (*script)++;
      FieldEffectScript_LoadTiles(script);
      FieldEffectScript_LoadFadedPalette(script);
      FieldEffectScript_CallNative(script, val);
...
export function FieldEffectCmd_loadtiles_callnative(...args: any[]): any {
  (*script)++;
      FieldEffectScript_LoadTiles(script);
      FieldEffectScript_CallNative(script, val);
      return TRUE;
...
export function FieldEffectCmd_loadfadedpal_callnative(...args: any[]): any {
  (*script)++;
      FieldEffectScript_LoadFadedPalette(script);
      FieldEffectScript_CallNative(script, val);
      return TRUE;
...
export function FieldEffectScript_ReadWord(...args: any[]): any {
  return (*script)[0]
           + ((*script)[1] << 8)
           + ((*script)[2] << 16)
           + ((*script)[3] << 24);
...
export function FieldEffectScript_LoadTiles(...args: any[]): any {
...
export function FieldEffectScript_LoadFadedPalette(...args: any[]): any {
...
export function FieldEffectScript_LoadPalette(...args: any[]): any {
  let palette: any = FieldEffectScript_ReadWord(script);
      LoadSpritePalette(palette);
      (*script) += 4;
}
...
export function FieldEffectScript_CallNative(...args: any[]): any {
...
export function FieldEffectFreeGraphicsResources(...args: any[]): any {
  let sheetTileStart = sprite.sheetTileStart;
      let paletteNum = sprite.oam.paletteNum;
...
export function FieldEffectStop(...args: any[]): any {
  FieldEffectFreeGraphicsResources(sprite);
      FieldEffectActiveListRemove(id);
}

/** void FieldEffectFreeTilesIfUnused(u16 tileStart) */
export function FieldEffectFreeTilesIfUnused(...args: any[]): any {
  let i: any = null;
      let tag = GetSpriteTileTagByTileStart(tileStart);
...
export function FieldEffectFreePaletteIfUnused(...args: any[]): any {
  let i: any = null;
      let tag = GetSpritePaletteTagByPaletteNum(paletteNum);
...
export function FieldEffectActiveListAdd(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < ARRAY_COUNT(sActiveList); i++)
      {
...
export function FieldEffectActiveListRemove(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < ARRAY_COUNT(sActiveList); i++)
      {
          if (sActiveList[i] == id)
...
export function FieldEffectActiveListContains(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < ARRAY_COUNT(sActiveList); i++)
          if (sActiveList[i] == id)
              return TRUE;
...
export function CreateTrainerSprite(...args: any[]): any {
...
export function AddNewGameBirchObject(...args: any[]): any {
...
export function CreateMonSprite_PicBox(...args: any[]): any {
  let spriteId = CreateMonPicSprite_HandleDeoxys(species, 0, 0x8000, TRUE, x, y, 0, gMonPaletteTable[species].tag);
...
export function CreateMonSprite_FieldMove(...args: any[]): any {
  let spritePalette: any = GetMonSpritePalStructFromOtIdPersonality(species, otId, personality);
      let spriteId = CreateMonPicSprite_HandleDeoxys(species, otId, personality, TRUE, x, y, 0, spritePalette.tag);
...
export function FreeResourcesAndDestroySprite(...args: any[]): any {
...
export function MultiplyInvertedPaletteRGBComponents(...args: any[]): any {
  let curRed, curGreen, curBlue;
      let color = gPlttBufferUnfaded[i];
...
export function MultiplyPaletteRGBComponents(...args: any[]): any {
  let curRed, curGreen, curBlue;
      let color = gPlttBufferUnfaded[i];
...
export function Task_PokecenterHeal(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
...
export function PokecenterHealEffect_Init(...args: any[]): any {
  task.tState++;
...
export function PokecenterHealEffect_WaitForBallPlacement(...args: any[]): any {
...
export function PokecenterHealEffect_WaitForBallFlashing(...args: any[]): any {
...
export function PokecenterHealEffect_WaitForSoundAndEnd(...args: any[]): any {
...
export function Task_HallOfFameRecord(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
...
export function HallOfFameRecordEffect_Init(...args: any[]): any {
  let taskId: any = null;
      task.tState++;
...
export function HallOfFameRecordEffect_WaitForBallPlacement(...args: any[]): any {
  if (gSprites[task.tBallSpriteId].sState > 1)
      {
          task.tStartHofFlash++;
          task.tState++;
...
export function HallOfFameRecordEffect_WaitForBallFlashing(...args: any[]): any {
  if (gSprites[task.tBallSpriteId].sState > 4)
      {
          task.tState++;
      }
...
export function HallOfFameRecordEffect_WaitForSoundAndEnd(...args: any[]): any {
  if (gSprites[task.tBallSpriteId].sState > 6)
      {
          DestroySprite(gSprites[task.tBallSpriteId]);
...
export function CreateGlowingPokeballsEffect(...args: any[]): any {
...
export function SpriteCB_PokeballGlowEffect(...args: any[]): any {
  sPokeballGlowEffectFuncs[sprite.sState](sprite);
}

/** static void PokeballGlowEffect_PlaceBalls(struct Sprite *sprite) */
export function PokeballGlowEffect_PlaceBalls(...args: any[]): any {
  let spriteId: any = null;
...
export function PokeballGlowEffect_TryPlaySe(...args: any[]): any {
  if ((--sprite.sTimer) == 0)
      {
          sprite.sState++;
          sprite.sTimer = 8;
...
export function PokeballGlowEffect_Flash1(...args: any[]): any {
  let phase: any = null;
      if ((--sprite.sTimer) == 0)
      {
          sprite.sTimer = 8;
...
export function PokeballGlowEffect_Flash2(...args: any[]): any {
  let phase: any = null;
      if ((--sprite.sTimer) == 0)
      {
          sprite.sTimer = 8;
...
export function PokeballGlowEffect_WaitAfterFlash(...args: any[]): any {
  if ((--sprite.sTimer) == 0)
          sprite.sState++;
}

/** static void PokeballGlowEffect_Dummy(struct Sprite *sprite) */
export function PokeballGlowEffect_Dummy(...args: any[]): any {
  sprite.sState++;
}

/** static void PokeballGlowEffect_WaitForSound(struct Sprite *sprite) */
export function PokeballGlowEffect_WaitForSound(...args: any[]): any {
...
export function SpriteCB_PokeballGlow(...args: any[]): any {
...
export function CreatePokecenterMonitorSprite(...args: any[]): any {
  let spriteId: any = null;
      let sprite: any = null;
...
export function SpriteCB_PokecenterMonitor(...args: any[]): any {
  if (sprite.data[0] != 0)
      {
          sprite.data[0] = 0;
...
export function CreateHofMonitorSprite(...args: any[]): any {
  let spriteId: any = null;
      if (!isSmallMonitor)
      {
...
export function SpriteCB_HallOfFameMonitor(...args: any[]): any {
...
export function Task_UseFly(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
      if (!task.data[0])
      {
...
export function Task_FlyIntoMap(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
      if (task.data[0] == 0)
      {
...
export function Task_FallWarpFieldEffect(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
...
export function FallWarpEffect_Init(...args: any[]): any {
...
export function FallWarpEffect_WaitWeather(...args: any[]): any {
  if (IsWeatherNotFadingIn())
          task.tState++;
...
export function FallWarpEffect_StartFall(...args: any[]): any {
  let sprite: any = null;
...
export function FallWarpEffect_Fall(...args: any[]): any {
...
export function FallWarpEffect_Land(...args: any[]): any {
  task.tState++;
      task.tVertShake = 4;
      task.tNumShakes = 0;
...
export function FallWarpEffect_CameraShake(...args: any[]): any {
...
export function FallWarpEffect_End(...args: any[]): any {
...
export function StartEscalatorWarp(...args: any[]): any {
  let taskId: any = null;
...
export function Task_EscalatorWarpOut(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
...
export function EscalatorWarpOut_Init(...args: any[]): any {
  FreezeObjectEvents();
      CameraObjectFreeze();
...
export function EscalatorWarpOut_WaitForPlayer(...args: any[]): any {
  let objectEvent: any = null;
      objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function EscalatorWarpOut_Up_Ride(...args: any[]): any {
...
export function EscalatorWarpOut_Up_End(...args: any[]): any {
  RideUpEscalatorOut(task);
...
export function EscalatorWarpOut_Down_Ride(...args: any[]): any {
...
export function EscalatorWarpOut_Down_End(...args: any[]): any {
  RideDownEscalatorOut(task);
      WarpAtEndOfEscalator();
      return FALSE;
}
...
export function RideUpEscalatorOut(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
...
export function RideDownEscalatorOut(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
...
export function Task_EscalatorWarpIn(...args: any[]): any {
  let task: any = null;
      task = gTasks[taskId];
...
export function EscalatorWarpIn_Init(...args: any[]): any {
  let objectEvent: any = null;
      let x: any = null;
      let y: any = null;
...
export function EscalatorWarpIn_Down_Init(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
...
export function EscalatorWarpIn_Down_Ride(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
      sprite.x2 = Cos(0x84, task.data[1]);
      sprite.y2 = Sin(0x94, task.data[1]);
...
export function EscalatorWarpIn_Up_Init(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
...
export function EscalatorWarpIn_Up_Ride(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[gPlayerAvatar.spriteId];
      sprite.x2 = Cos(0x7c, task.data[1]);
      sprite.y2 = Sin(0x76, task.data[1]);
...
export function EscalatorWarpIn_WaitForMovement(...args: any[]): any {
...
export function EscalatorWarpIn_End(...args: any[]): any {
  let objectEvent: any = null;
      objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function Task_UseWaterfall(...args: any[]): any {
...
export function WaterfallFieldEffect_Init(...args: any[]): any {
  LockPlayerFieldControls();
      gPlayerAvatar.preventStep = TRUE;
      task.tState++;
      return FALSE;
...
export function WaterfallFieldEffect_ShowMon(...args: any[]): any {
  LockPlayerFieldControls();
...
export function WaterfallFieldEffect_WaitForShowMon(...args: any[]): any {
...
export function WaterfallFieldEffect_RideUp(...args: any[]): any {
...
export function WaterfallFieldEffect_ContinueRideOrEnd(...args: any[]): any {
  if (!ObjectEventClearHeldMovementIfFinished(objectEvent))
          return FALSE;
...
export function DiveFieldEffect_ShowMon(...args: any[]): any {
  LockPlayerFieldControls();
...
export function DiveFieldEffect_TryWarp(...args: any[]): any {
...
export function StartLavaridgeGymB1FWarp(...args: any[]): any {
  CreateTask(Task_LavaridgeGymB1FWarp, priority);
}

/** static void Task_LavaridgeGymB1FWarp(u8 taskId) */
export function Task_LavaridgeGymB1FWarp(...args: any[]): any {
...
export function LavaridgeGymB1FWarpEffect_Init(...args: any[]): any {
  FreezeObjectEvents();
      CameraObjectFreeze();
      SetCameraPanningCallback(NULL);
      gPlayerAvatar.preventStep = TRUE;
...
export function LavaridgeGymB1FWarpEffect_CameraShake(...args: any[]): any {
...
export function LavaridgeGymB1FWarpEffect_Launch(...args: any[]): any {
  sprite.y2 = 0;
      task.data[3] = 1;
...
export function LavaridgeGymB1FWarpEffect_Rise(...args: any[]): any {
  let centerToCornerVecY: any = null;
      SetCameraPanning(0, task.data[1]);
...
export function LavaridgeGymB1FWarpEffect_FadeOut(...args: any[]): any {
  TryFadeOutOldMapMusic();
      WarpFadeOutScreen();
      task.data[0]++;
      return FALSE;
...
export function LavaridgeGymB1FWarpEffect_Warp(...args: any[]): any {
  if (!gPaletteFade.active && BGMusicStopped() == TRUE)
      {
          WarpIntoMap();
...
export function Task_LavaridgeGymB1FWarpExit(...args: any[]): any {
...
export function LavaridgeGymB1FWarpExitEffect_Init(...args: any[]): any {
  CameraObjectFreeze();
      FreezeObjectEvents();
      gPlayerAvatar.preventStep = TRUE;
...
export function LavaridgeGymB1FWarpExitEffect_StartPopOut(...args: any[]): any {
  if (IsWeatherNotFadingIn())
      {
          gFieldEffectArguments[0] = objectEvent.currentCoords.x;
          gFieldEffectArguments[1] = objectEvent.currentCoords.y;
...
export function LavaridgeGymB1FWarpExitEffect_PopOut(...args: any[]): any {
...
export function LavaridgeGymB1FWarpExitEffect_End(...args: any[]): any {
  if (ObjectEventClearHeldMovementIfFinished(objectEvent))
      {
          gPlayerAvatar.preventStep = FALSE;
          UnlockPlayerFieldControls();
...
export function SpriteCB_AshLaunch(...args: any[]): any {
  if (sprite.animEnded)
          FieldEffectStop(sprite, FLDEFF_ASH_LAUNCH);
}

/** void StartLavaridgeGym1FWarp(u8 priority) */
export function StartLavaridgeGym1FWarp(...args: any[]): any {
  CreateTask(Task_LavaridgeGym1FWarp, priority);
}

/** static void Task_LavaridgeGym1FWarp(u8 taskId) */
export function Task_LavaridgeGym1FWarp(...args: any[]): any {
...
export function LavaridgeGym1FWarpEffect_Init(...args: any[]): any {
  FreezeObjectEvents();
      CameraObjectFreeze();
      gPlayerAvatar.preventStep = TRUE;
      objectEvent.fixedPriority = 1;
...
export function LavaridgeGym1FWarpEffect_AshPuff(...args: any[]): any {
  if (ObjectEventClearHeldMovementIfFinished(objectEvent))
      {
          if (task.data[1] > 3)
          {
...
export function LavaridgeGym1FWarpEffect_Disappear(...args: any[]): any {
...
export function LavaridgeGym1FWarpEffect_FadeOut(...args: any[]): any {
...
export function LavaridgeGym1FWarpEffect_Warp(...args: any[]): any {
  if (!gPaletteFade.active && BGMusicStopped() == TRUE)
      {
          WarpIntoMap();
...
export function SpriteCB_AshPuff(...args: any[]): any {
  if (sprite.animEnded)
...
export function Task_EscapeRopeWarpOut(...args: any[]): any {
...
export function EscapeRopeWarpOutEffect_Init(...args: any[]): any {
  task.tState++;
      task.tTimer = 64;
...
export function EscapeRopeWarpOutEffect_Spin(...args: any[]): any {
  let objectEvent: any = null;
...
export function EscapeRopeWarpInEffect_Spin(...args: any[]): any {
  const spinDirections: any = [DIR_SOUTH, DIR_WEST, DIR_EAST, DIR_NORTH, DIR_SOUTH];
...
export function Task_TeleportWarpOut(...args: any[]): any {
...
export function TeleportWarpOutFieldEffect_Init(...args: any[]): any {
  LockPlayerFieldControls();
      FreezeObjectEvents();
      CameraObjectFreeze();
...
export function TeleportWarpOutFieldEffect_SpinGround(...args: any[]): any {
  const spinDirections: any = [DIR_SOUTH, DIR_WEST, DIR_EAST, DIR_NORTH, DIR_SOUTH];
      let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function TeleportWarpOutFieldEffect_SpinExit(...args: any[]): any {
  const spinDirections: any = [DIR_SOUTH, DIR_WEST, DIR_EAST, DIR_NORTH, DIR_SOUTH];
      let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function TeleportWarpOutFieldEffect_End(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_TeleportWarpIn(...args: any[]): any {
...
export function TeleportWarpInFieldEffect_Init(...args: any[]): any {
  let sprite: any = null;
      let centerToCornerVecY: any = null;
      if (IsWeatherNotFadingIn())
      {
...
export function TeleportWarpInFieldEffect_SpinEnter(...args: any[]): any {
  const spinDirections: any = [DIR_SOUTH, DIR_WEST, DIR_EAST, DIR_NORTH, DIR_SOUTH];
      let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
      let sprite: any = gSprites[gPlayerAvatar.spriteId];
...
export function TeleportWarpInFieldEffect_SpinGround(...args: any[]): any {
  const spinDirections: any = [DIR_SOUTH, DIR_WEST, DIR_EAST, DIR_NORTH, DIR_SOUTH];
      let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
      if ((--task.data[1]) == 0)
      {
...
export function Task_FieldMoveShowMonOutdoors(...args: any[]): any {
...
export function FieldMoveShowMonOutdoorsEffect_Init(...args: any[]): any {
...
export function FieldMoveShowMonOutdoorsEffect_LoadGfx(...args: any[]): any {
  let offset = ((REG_BG0CNT >> 2) << 14);
      let delta = ((REG_BG0CNT >> 8) << 11);
...
export function FieldMoveShowMonOutdoorsEffect_CreateBanner(...args: any[]): any {
  let horiz: any = null;
      let vertHi: any = null;
      let vertLo: any = null;
      task.tBgHoriz -= 16;
...
export function FieldMoveShowMonOutdoorsEffect_WaitForMon(...args: any[]): any {
  task.tBgHoriz -= 16;
...
export function FieldMoveShowMonOutdoorsEffect_ShrinkBanner(...args: any[]): any {
  let vertHi: any = null;
      let vertLo: any = null;
      task.tBgHoriz -= 16;
      vertHi = (task.tWinVert >> 8);
...
export function FieldMoveShowMonOutdoorsEffect_RestoreBg(...args: any[]): any {
  let bg0cnt = (REG_BG0CNT >> 8) << 11;
...
export function FieldMoveShowMonOutdoorsEffect_End(...args: any[]): any {
...
export function LoadFieldMoveOutdoorStreaksTilemap(...args: any[]): any {
  let i: any = null;
      let dest: any = null;
...
export function Task_FieldMoveShowMonIndoors(...args: any[]): any {
...
export function FieldMoveShowMonIndoorsEffect_Init(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BG0HOFS, task.tBgHoriz);
      SetGpuReg(REG_OFFSET_BG0VOFS, task.tBgVert);
      StoreWordInTwoHalfwords((u16 *)&task.data[13], gMain.vblankCallback);
      SetVBlankCallback(VBlankCB_FieldMoveShowMonIndoors);
      task.tState++;
}

/** static void FieldMoveShowMonIndoorsEffect_LoadGfx(struct Task *task) */
export function FieldMoveShowMonIndoorsEffect_LoadGfx(...args: any[]): any {
  let offset: any = null;
      let delta: any = null;
...
export function FieldMoveShowMonIndoorsEffect_SlideBannerOn(...args: any[]): any {
...
export function FieldMoveShowMonIndoorsEffect_WaitForMon(...args: any[]): any {
  AnimateIndoorShowMonBg(task);
      if (gSprites[task.tMonSpriteId].sSlidOffscreen)
          task.tState++;
}
...
export function FieldMoveShowMonIndoorsEffect_RestoreBg(...args: any[]): any {
  AnimateIndoorShowMonBg(task);
...
export function FieldMoveShowMonIndoorsEffect_SlideBannerOff(...args: any[]): any {
  AnimateIndoorShowMonBg(task);
...
export function FieldMoveShowMonIndoorsEffect_End(...args: any[]): any {
...
export function AnimateIndoorShowMonBg(...args: any[]): any {
  task.tBgHoriz -= 16;
      task.tBgOffsetIdx += 16;
}

/** static bool8 SlideIndoorBannerOnscreen(struct Task *task) */
export function SlideIndoorBannerOnscreen(...args: any[]): any {
  let i: any = null;
      ...
      if (dstOffs >= task.tBgOffset)
      {
          ...
          dest = (u16 *)(VRAM + 0x140 + task.data[12]);
          for (i = 0; i < 10; i++)
          {
...
export function SlideIndoorBannerOffscreen(...args: any[]): any {
  let i: any = null;
      let dstOffs: any = null;
      let dest: any = null;
...
export function InitFieldMoveMonSprite(...args: any[]): any {
...
export function SpriteCB_FieldMoveMonSlideOnscreen(...args: any[]): any {
...
export function SpriteCB_FieldMoveMonWaitAfterCry(...args: any[]): any {
...
export function SpriteCB_FieldMoveMonSlideOffscreen(...args: any[]): any {
  if (sprite.x < -64)
...
export function FldEff_UseSurf(): any {
  let taskId = CreateTask(Task_SurfFieldEffect, 0xff);
      gTasks[taskId].tMonId = gFieldEffectArguments[0];
...
export function SurfFieldEffect_FieldMovePose(...args: any[]): any {
  let objectEvent: any = null;
      objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
      if (!ObjectEventIsMovementOverridden(objectEvent) || ObjectEventClearHeldMovementIfFinished(objectEvent))
      {
...
export function SurfFieldEffect_ShowMon(...args: any[]): any {
  let objectEvent: any = null;
      objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function SurfFieldEffect_JumpOnSurfBlob(...args: any[]): any {
  let objectEvent: any = null;
      if (!FieldEffectActiveListContains(FLDEFF_FIELD_MOVE_SHOW_MON))
      {
          objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function SurfFieldEffect_End(...args: any[]): any {
  let objectEvent: any = null;
      objectEvent = gObjectEvents[gPlayerAvatar.objectEventId];
      if (ObjectEventClearHeldMovementIfFinished(objectEvent))
      {
...
export function SpriteCB_NPCFlyOut(...args: any[]): any {
...
export function FlyOutFieldEffect_ShowMon(...args: any[]): any {
  let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
      if (ObjectEventClearHeldMovementIfFinished(objectEvent))
      {
          task.tState++;
...
export function FlyOutFieldEffect_BirdLeaveBall(...args: any[]): any {
  if (!FieldEffectActiveListContains(FLDEFF_FIELD_MOVE_SHOW_MON))
      {
          let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function FlyOutFieldEffect_WaitBirdLeave(...args: any[]): any {
...
export function FlyOutFieldEffect_BirdSwoopDown(...args: any[]): any {
  let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function FlyOutFieldEffect_JumpOnBird(...args: any[]): any {
  if ((++task.tTimer) >= 8)
      {
          let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
          ObjectEventSetGraphicsId(objectEvent, GetPlayerAvatarGraphicsIdByStateId(PLAYER_AVATAR_STATE_SURFING));
...
export function FlyOutFieldEffect_FlyOffWithBird(...args: any[]): any {
  if ((++task.tTimer) >= 10)
      {
          let objectEvent: any = gObjectEvents[gPlayerAvatar.objectEventId];
...
export function FlyOutFieldEffect_WaitFlyOff(...args: any[]): any {
  if (GetFlyBirdAnimCompleted(task.tBirdSpriteId))
      {
          WarpFadeOutScreen();
          task.tState++;
...
export function FlyOutFieldEffect_End(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function GetFlyBirdAnimCompleted(...args: any[]): any {
  return gSprites[spriteId].sAnimCompleted;
}

/** static void StartFlyBirdSwoopDown(u8 spriteId) */
export function StartFlyBirdSwoopDown(...args: any[]): any {
  let sprite: any = null;
      sprite = gSprites[spriteId];
...
export function SpriteCB_FlyBirdSwoopDown(...args: any[]): any {
  sprite.x2 = Cos(sprite.data[2], 0x8c);
      sprite.y2 = Sin(sprite.data[2], 0x48);
      sprite.data[2] = (sprite.data[2] + 4) & 0xff;
...
export function SpriteCB_FlyBirdReturnToBall(...args: any[]): any {
  if (sprite.sAnimCompleted == FALSE)
      {
          if (sprite.data[0] == 0)
          {
...
export function StartFlyBirdReturnToBall(...args: any[]): any {
...
export function FlyInFieldEffect_FlyInWithBird(...args: any[]): any {
  let objectEvent: any = null;
      let sprite: any = null;
      if (task.tTimer == 0 || (--task.tTimer) == 0)
      {
...
export function FlyInFieldEffect_JumpOffBird(...args: any[]): any {
...
export function FlyInFieldEffect_FieldMovePose(...args: any[]): any {
  let objectEvent: any = null;
      let sprite: any = null;
      if (GetFlyBirdAnimCompleted(task.tBirdSpriteId))
      {
...
export function FlyInFieldEffect_BirdReturnToBall(...args: any[]): any {
...
export function FlyInFieldEffect_WaitBirdReturn(...args: any[]): any {
  if (GetFlyBirdAnimCompleted(task.tBirdSpriteId))
      {
...
export function FlyInFieldEffect_End(...args: any[]): any {
  let state: any = null;
      let objectEvent: any = null;
      if ((--task.data[1]) == 0)
      {
...
export function Task_DeoxysRockCameraShake(...args: any[]): any {
...
export function StartEndingDeoxysRockCameraShake(...args: any[]): any {
  gTasks[taskId].tEnding = TRUE;
}

/** static void Task_DestroyDeoxysRock(u8 taskId) */
export function Task_DestroyDeoxysRock(...args: any[]): any {
  let data = gTasks[taskId].data;
      InstallCameraPanAheadCallback();
...
export function DestroyDeoxysRockEffect_CameraShake(...args: any[]): any {
  let newTaskId = CreateTask(Task_DeoxysRockCameraShake, 90);
      PlaySE(SE_THUNDER2);
...
export function DestroyDeoxysRockEffect_RockFragments(...args: any[]): any {
  if (++tTimer > 120)
      {
...
export function DestroyDeoxysRockEffect_WaitAndEnd(...args: any[]): any {
...
export function CreateDeoxysRockFragments(...args: any[]): any {
  let i: any = null;
      let xPos = gTotalCameraPixelOffsetX + sprite.x + sprite.x2;
      let yPos = gTotalCameraPixelOffsetY + sprite.y + sprite.y2 - 4;

      for (i = 0; i < 4; i++)
      {
          let spriteId = CreateSprite(sSpriteTemplate_DeoxysRockFragment, xPos, yPos, 0);
...
export function SpriteCB_DeoxysRockFragment(...args: any[]): any {
...
export function FldEff_MoveDeoxysRock(...args: any[]): any {
  let objectEventId: any = null;
      if (!TryGetObjectEventIdByLocalIdAndMap(gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2], objectEventId))
      {
          let object: any = null;
...
export function Task_MoveDeoxysRock(...args: any[]): any {
  let data = gTasks[taskId].data;
