...
const {
  ...
  CalcCenterToCornerVec, CalculatePlayerPartyCount, CameraObjectFreeze, CameraObjectReset,
  ClearMirageTowerPulseBlendEffect, Cos, CpuCopy16, CpuFill32,
  CreateInvisibleSprite, CreateMonPicSprite_HandleDeoxys, CreateSprite, CreateSpriteAtEnd,
  CreateTask, DestroySprite, DestroyTask, FadeInFromBlack,
  ...
  LockPlayerFieldControls, MapGridGetMetatileBehaviorAt, MetatileBehavior_IsWaterfall, MoveCoords,
  MoveObjectEventToMapCoords, OBJ_PLTT_ID, ObjectEventCheckHeldMovementStatus, ObjectEventClearHeldMovementIfActive,
  ObjectEventClearHeldMovementIfFinished, ObjectEventIsMovementOverridden, ObjectEventSetGraphicsId, ObjectEventSetHeldMovement,
  ObjectEventTurn, Overworld_ChangeMusicTo, Overworld_ClearSavedMusic, Overworld_PlaySpecialMapMusic,
  Overworld_ResetStateAfterFly, PlayCry_Normal, PlayCry_NormalNoDucking, PlayFanfare,
  PlaySE, PlayerGetDestCoords, PreservePaletteInWeather, RemoveObjectEventByLocalIdAndMap,
  ResetPreservedPalettesInWeather, SAFE_DIV, SetCameraPanning, SetCameraPanningCallback,
  ...
  StoreWordInTwoHalfwords, TryDoDiveWarp, TryFadeOutOldMapMusic, TryGetObjectEventIdByLocalIdAndMap,
  UnfreezeObjectEvents, UnlockPlayerFieldControls, UpdateCameraPanning, UpdateSpritePaletteWithWeather,
  WIN_RANGE, WarpFadeInScreen, WarpFadeOutScreen, WarpIntoMap,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
