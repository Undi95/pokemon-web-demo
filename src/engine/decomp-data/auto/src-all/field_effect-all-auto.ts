...
const {
  ...
  BG_SCREEN_ADDR, BLDALPHA_BLEND, BLDCNT_EFFECT_BLEND, BLDCNT_TGT2_BD,
  BLDCNT_TGT2_BG1, BLDCNT_TGT2_BG2, BLDCNT_TGT2_BG3, BLDCNT_TGT2_OBJ,
  BeginNormalPaletteFade, BlendPalettes, CalcCenterToCornerVec, CalculatePlayerPartyCount,
  CameraObjectFreeze, CameraObjectReset, ClearMirageTowerPulseBlendEffect, Cos,
  CpuCopy16, CpuFill32, CreateInvisibleSprite, CreateMonPicSprite_HandleDeoxys,
  CreateSprite, CreateSpriteAtEnd, CreateTask, DIR_EAST,
  DIR_NORTH, DIR_SOUTH, DIR_WEST, DISPLAY_HEIGHT,
  DestroySprite, DestroyTask, FALSE, FadeInFromBlack,
  FindTaskIdByFunc, FreeAndDestroyMonPicSprite, FreeOamMatrix, FreeSpritePaletteByTag,
  FreeSpriteTilesByTag, FreezeObjectEvents, FuncIsActiveTask, GetCurrentMapType,
  GetCursorSelectionMonId, GetFaceDirectionMovementAction, GetJumpMovementAction, GetJumpSpecialMovementAction,
  GetMonData, GetMonSpritePalStructFromOtIdPersonality, GetPlayerAvatarGraphicsIdByStateId, GetPlayerFacingDirection,
  GetSpritePaletteTagByPaletteNum, GetSpriteTileStartByTag, GetSpriteTileTagByTileStart, GetWalkInPlaceFasterMovementAction,
  GetWalkNormalMovementAction, GetWalkSlowMovementAction, IndexOfSpritePaletteTag, InitSpriteAffineAnim,
  ...
  LoadPalette, LoadSpritePalette, LoadSpriteSheet, LoadWordFromTwoHalfwords,
  LockPlayerFieldControls, MB_DOWN_ESCALATOR, MB_UP_ESCALATOR, MapGridGetMetatileBehaviorAt,
  MetatileBehavior_IsWaterfall, MoveCoords, MoveObjectEventToMapCoords, NULL,
  OBJ_PLTT_ID, ObjectEventCheckHeldMovementStatus, ObjectEventClearHeldMovementIfActive, ObjectEventClearHeldMovementIfFinished,
  ObjectEventIsMovementOverridden, ObjectEventSetGraphicsId, ObjectEventSetHeldMovement, ObjectEventTurn,
  Overworld_ChangeMusicTo, Overworld_ClearSavedMusic, Overworld_PlaySpecialMapMusic, Overworld_ResetStateAfterFly,
  PALETTES_BG, PlayCry_Normal, PlayCry_NormalNoDucking, PlayFanfare,
  PlaySE, PlayerGetDestCoords, PreservePaletteInWeather, REG_OFFSET_BG0HOFS,
  REG_OFFSET_BG0VOFS, REG_OFFSET_BLDALPHA, REG_OFFSET_BLDCNT, REG_OFFSET_WIN0H,
  REG_OFFSET_WIN0V, REG_OFFSET_WIN1H, REG_OFFSET_WIN1V, REG_OFFSET_WININ,
  REG_OFFSET_WINOUT, RemoveObjectEventByLocalIdAndMap, ResetPreservedPalettesInWeather, SAFE_DIV,
  ST_OAM_AFFINE_DOUBLE, ST_OAM_AFFINE_OFF, SetCameraPanning, SetCameraPanningCallback,
  SetGpuReg, SetMainCallback2, SetObjectEventDirection, SetPlayerAvatarFieldMove,
  SetPlayerAvatarStateMask, SetPlayerAvatarTransitionFlags, SetSpritePosToOffsetMapCoords, SetSubspriteTables,
  SetSurfBlob_BobState, SetSurfBlob_DontSyncAnim, SetVBlankCallback, SetWarpDestinationToEscapeWarp,
  SetWarpDestinationToLastHealLocation, ShiftObjectEventCoords, ShiftStillObjectEventCoords, Sin,
  StartEscalator, StartSpriteAffineAnim, StartSpriteAnim, StopEscalator,
