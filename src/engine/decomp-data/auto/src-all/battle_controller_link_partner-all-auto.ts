...
const {
  ...
  CreateTask, DISPLAY_HEIGHT, DecompressTrainerBackPic, DestroySprite,
  ...
  FreeSpritePaletteByTag, FreeSpriteTilesByTag, GetBattlerMultiplayerId, GetBattlerPosition,
  ...
  PlaySE12WithPanning, PrepareBufferDataTransferLink, RecordedBattle_RecordAllBattlerData, ST_OAM_AFFINE_NORMAL,
