...
export function AnimUnusedHumanoidFoot(...args: any[]): any {
...
export function AnimSlideHandOrFootToTarget(...args: any[]): any {
...
export function AnimJumpKick(...args: any[]): any {
  if (IsContest())
      {
          gBattleAnimArgs[1] = -gBattleAnimArgs[1];
          gBattleAnimArgs[3] = -gBattleAnimArgs[3];
...
export function AnimBasicFistOrFoot(...args: any[]): any {
...
export function AnimFistOrFootRandomPos(...args: any[]): any {
...
export function AnimFistOrFootRandomPos_Step(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          if (sprite.data[7] != MAX_SPRITES)
          {
...
export function AnimCrossChopHand(...args: any[]): any {
  InitSpritePosToAnimTarget(sprite, TRUE);
      sprite.data[0] = 30;
...
export function AnimCrossChopHand_Step(...args: any[]): any {
  if (++sprite.data[5] == 11)
      {
...
export function AnimSlidingKick(...args: any[]): any {
...
export function AnimSlidingKick_Step(...args: any[]): any {
...
export function AnimSpinningKickOrPunch(...args: any[]): any {
  InitSpritePosToAnimTarget(sprite, TRUE);
      StartSpriteAnim(sprite, gBattleAnimArgs[2]);
      sprite.data[0] = gBattleAnimArgs[3];
...
export function AnimSpinningKickOrPunchFinish(...args: any[]): any {
...
export function AnimStompFoot(...args: any[]): any {
  InitSpritePosToAnimTarget(sprite, TRUE);
      sprite.data[0] = gBattleAnimArgs[2];
...
export function AnimStompFoot_Step(...args: any[]): any {
  if (--sprite.data[0] == -1)
      {
          sprite.data[0] = 6;
...
export function AnimStompFoot_End(...args: any[]): any {
  sprite.data[0] = 15;
...
export function AnimDizzyPunchDuck(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          InitSpritePosToAnimTarget(sprite, TRUE);
...
export function AnimBrickBreakWall(...args: any[]): any {
...
export function AnimBrickBreakWall_Step(...args: any[]): any {
...
export function AnimBrickBreakWallShard(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
...
export function AnimBrickBreakWallShard_Step(...args: any[]): any {
...
export function AnimSuperpowerOrb(...args: any[]): any {
  if (gBattleAnimArgs[0] == ANIM_ATTACKER)
      {
...
export function AnimSuperpowerOrb_Step(...args: any[]): any {
...
export function AnimSuperpowerRock(...args: any[]): any {
...
export function AnimSuperpowerRock_Step1(...args: any[]): any {
  void *var0;
      ...
      {
          let pos0 = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
          let pos1 = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
          let pos2 = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2);
          let pos3 = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
...
export function AnimSuperpowerRock_Step2(...args: any[]): any {
  let edgeX: any = null;
...
export function AnimSuperpowerFireball(...args: any[]): any {
  let battler: any = null;
...
export function AnimArmThrustHit_Step(...args: any[]): any {
...
export function AnimArmThrustHit(...args: any[]): any {
  let turn: any = null;
...
export function AnimRevengeScratch(...args: any[]): any {
...
export function AnimFocusPunchFist(...args: any[]): any {
...
export function AnimTask_MoveSkyUppercutBg(...args: any[]): any {
