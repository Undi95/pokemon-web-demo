...
export function GetMoveBattleStyle(...args: any[]): any {
  let moves: any = null;
      let i, j;
...
export function GetFactoryMonFixedIV(...args: any[]): any {
  let ivSet: any = null;
      let useHigherIV = isLastBattle ? TRUE : FALSE;
...
export function GetFactoryMonId(...args: any[]): any {
  let numMons, monId;
      let adder: any = null;  
...
export function GetNumPastRentalsRank(...args: any[]): any {
  let ret: any = null;
...
export function SetMonMoveAvoidReturn(...args: any[]): any {
  let move = moveArg;
