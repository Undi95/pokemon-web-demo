...
export function InitBattlePyramidMap(...args: any[]): any {
...
export function InitMapLayoutData(...args: any[]): any {
...
export function InitBackupMapLayoutData(...args: any[]): any {
  let dest: any = null;
      let y: any = null;
...
export function InitBackupMapLayoutConnections(...args: any[]): any {
  let count: any = null;
...
export function FillConnection(...args: any[]): any {
  let i: any = null;
      let src: any = null;
      let dest: any = null;
...
export function FillSouthConnection(...args: any[]): any {
  let x, y;
      let x2: any = null;
      let width: any = null;
      let cWidth: any = null;
...
export function FillNorthConnection(...args: any[]): any {
  let x: any = null;
      let x2, y2;
      let width: any = null;
      let cWidth, cHeight;
...
export function FillWestConnection(...args: any[]): any {
  let y: any = null;
      let x2, y2;
      let height: any = null;
      let cWidth, cHeight;
...
export function FillEastConnection(...args: any[]): any {
  let x, y;
      let y2: any = null;
      let height: any = null;
...
export function MapGridGetElevationAt(...args: any[]): any {
  let block = GetMapGridBlockAt(x, y);
...
export function MapGridGetCollisionAt(...args: any[]): any {
  let block = GetMapGridBlockAt(x, y);
...
export function MapGridGetMetatileIdAt(...args: any[]): any {
  let block = GetMapGridBlockAt(x, y);
...
export function MapGridSetMetatileEntryAt(...args: any[]): any {
  let i: any = null;
      if (AreCoordsWithinMapGridBounds(x, y))
      {
...
export function GetMetatileAttributesById(...args: any[]): any {
...
export function MoveMapViewToBackup(...args: any[]): any {
  let width: any = null;
      let mapView: any = null;
      let x0, y0;
      let x2, y2;
...
export function GetMapBorderIdAt(...args: any[]): any {
...
export function GetPostCameraMoveMapBorderId(...args: any[]): any {
  return GetMapBorderIdAt(gSaveBlock1Ptr.pos.x + MAP_OFFSET + x, gSaveBlock1Ptr.pos.y + MAP_OFFSET + y);
}

/** bool32 CanCameraMoveInDirection(int direction) */
export function CanCameraMoveInDirection(...args: any[]): any {
  let x, y;
...
export function SetPositionFromConnection(...args: any[]): any {
...
export function CameraMove(...args: any[]): any {
...
export function IsPosInIncomingConnectingMap(...args: any[]): any {
  struct MapHeader const *mapHeader;
      mapHeader = GetMapHeaderFromConnection(connection);
      switch (direction)
      {
...
export function IsCoordInIncomingConnectingMap(...args: any[]): any {
...
export function IsCoordInConnectingMap(...args: any[]): any {
...
export function IsPosInConnectingMap(...args: any[]): any {
  struct MapHeader const *mapHeader;
      mapHeader = GetMapHeaderFromConnection(connection);
      switch (connection.direction)
      {
...
export function SetCameraFocusCoords(...args: any[]): any {
  gSaveBlock1Ptr.pos.x = x - MAP_OFFSET;
      gSaveBlock1Ptr.pos.y = y - MAP_OFFSET;
}

/** void GetCameraFocusCoords(u16 *x, u16 *y) */
export function GetCameraFocusCoords(...args: any[]): any {
  *x = gSaveBlock1Ptr.pos.x + MAP_OFFSET;
      *y = gSaveBlock1Ptr.pos.y + MAP_OFFSET;
}

/** void GetCameraCoords(u16 *x, u16 *y) */
export function GetCameraCoords(...args: any[]): any {
  *x = gSaveBlock1Ptr.pos.x;
      *y = gSaveBlock1Ptr.pos.y;
}

/** void MapGridSetMetatileImpassabilityAt(int x, int y, bool32 impassable) */
export function MapGridSetMetatileImpassabilityAt(...args: any[]): any {
  if (AreCoordsWithinMapGridBounds(x, y))
      {
          if (impassable)
...
export function SkipCopyingMetatileFromSavedMap(...args: any[]): any {
  if (yMode == 0xFF)
          return FALSE;
...
export function CopyTilesetToVram(...args: any[]): any {
  if (tileset)
      {
...
export function CopyTilesetToVramUsingHeap(...args: any[]): any {
  if (tileset)
      {
          if (!tileset.isCompressed)
              LoadBgTiles(2, tileset.tiles, numTiles * 32, offset);
...
export function LoadTilesetPalette(...args: any[]): any {
  let black = RGB_BLACK;
...
export function LoadPrimaryTilesetPalette(...args: any[]): any {
  LoadTilesetPalette(mapLayout.primaryTileset, BG_PLTT_ID(0), NUM_PALS_IN_PRIMARY * PLTT_SIZE_4BPP);
}

/** void LoadSecondaryTilesetPalette(struct MapLayout const *mapLayout) */
export function LoadSecondaryTilesetPalette(...args: any[]): any {
...
export function CopyMapTilesetsToVram(...args: any[]): any {
  if (mapLayout)
      {
...
export function LoadMapTilesetPalettes(...args: any[]): any {
  if (mapLayout)
      {
