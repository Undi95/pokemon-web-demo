...
const {
  ALIGNED, ARRAY_COUNT, AddDecorationActionsWindow, AddDecorationIconObjectFromIconTable,
  AddDecorationIconObjectFromObjectEvent, AddDecorationItemsScrollIndicators, AddDecorationItemsWindow, AddDecorationWindow,
  AddScrollIndicatorArrowPairParameterized, AddTextPrinterParameterized, AddTextPrinterParameterized2, AddWindow,
  Alloc, AllocItemIconTemporaryBuffers, AllocZeroed, ApplyCursorMovement_IsInvalid,
  AttemptMarkDecorUnderCursorForRemoval, AttemptMarkSpriteDecorUnderCursorForRemoval, AttemptPlaceDecoration_, AttemptPutAwayDecoration_,
  BG_PLTT_ID, BG_TILE_H_FLIP, BG_TILE_V_FLIP, BlitMenuInfoIcon,
  CanPlaceDecoration, CancelDecorating_, ClearDecorationContextIndex, ClearDialogWindowAndFrame,
  ClearPlaceDecorationGraphicsDataBuffer, ClearRearrangementNonSprites, ClearStdWindowAndFrameToTransparent, ClearWindowTilemap,
  ColorMenuItemString, CondenseDecorationsInCategory, ConfigureCameraObjectForPlacingDecoration, ContinueDecorating,
  ContinuePuttingAwayDecorations, ConvertIntToDecimalStringN, CopyDecorationMenuItemName, CopyItemIconPicTo4x4Buffer,
  CopyPalette, CopyTile, CpuFastCopy, CpuFill16,
  CreateObjectGraphicsSprite, CreateSprite, CreateTask, DecorationIsUnderCursor,
  DecorationMenuAction_Cancel, DestroyListMenuTask, DestroySprite, DestroyTask,
  DisplayItemMessageOnField, DisplayYesNoMenuDefaultYes, DoYesNoFuncWithChoice, DrawDialogueFrame,
  DrawStdFrameWithCustomTileAndPalette, DrawWholeMapView, ExitDecorationCategoriesMenu, ExitTraderDecorationMenu,
  ExitTraderMenu, FadeInFromBlack, FadeScreen, FillWindowPixelBuffer,
  FlagClear, FlagGet, Free, FreeItemIconTemporaryBuffers,
  FreePlayerSpritePalette, FreeSpritePaletteByTag, GetDecorationElevation, GetDecorationIconPicOrPalette,
  GetLayerType, GetMaxWidthInMenuTable, GetMetatile, GetMetatileAttributesById,
  GetNumOwnedDecorations, GetNumOwnedDecorationsInCategory, GetObjectEventIdByPosition, GetPlayerFacingDirection,
  GetStringRightAlignXOffset, HasDecorationSpace, HasDecorationsInUse, HideSecretBaseDecorationSprites,
  IdentifyOwnedDecorationsCurrentlyInUse, IdentifyOwnedDecorationsCurrentlyInUseInternal, InitDecorationActionsWindow, InitDecorationCategoriesWindow,
  InitDecorationItemsMenuLimits, InitDecorationItemsMenuScrollAndCursor, InitDecorationItemsMenuScrollAndCursor2, InitDecorationItemsWindow,
  InitMenuInUpperLeftCornerNormal, IsDecorationIndexInPlayersRoom, IsDecorationIndexInSecretBase, IsFloorOrBoardAndHole,
  IsHoldingDirection, IsSecretBaseTrainerSpot, IsSelectedDecorInThePC, IsWeatherNotFadingIn,
  IsntInitialPosition, JOY_HELD, JOY_NEW, LZDecompressWram,
  ListMenuGetScrollAndRow, ListMenuInit, ListMenu_ProcessInput, LoadCompressedSpritePalette,
  LoadPalette, LoadPlayerSpritePalette, LoadSpritePalette, LoadSpriteSheet,
  LockPlayerFieldControls, MapGridGetMetatileBehaviorAt, MapGridGetMetatileIdAt, MapGridSetMetatileEntryAt,
  MapGridSetMetatileIdAt, MarkSpriteDecorsInBoundsForRemoval, Menu_GetCursorPos, Menu_ProcessInput,
  ...
  MetatileBehavior_IsSecretBaseTrainerSpot, PIXEL_FILL, PlaceDecoration_, PlaySE,
  PlayerGetDestCoords, PrintCurMainMenuDescription, PrintDecorationCategoryMenuItem, PrintDecorationCategoryMenuItems,
  PrintDecorationItemDescription, PrintDecorationItemMenuItems, PrintMenuTable, ReinitDecorationCategoriesWindow,
  RemoveDecorationItemsOtherWindows, RemoveDecorationItemsScrollIndicators, RemoveDecorationWindow, RemoveScrollIndicatorArrowPair,
  RemoveWindow, ResetCursorMovement, ReshowPlayerPC, ReturnToActionsMenuFromCategories,
  ScheduleBgCopyTilemapToVram, ScriptContext_SetupScript, SecretBasePC_PrepMenuForSelectingStoredDecors, SelectDecorationCategory,
  SetCameraSpritePosition, SetCursorScrollWithinListBounds, SetCursorWithinListBounds, SetDecorRearrangementFlagIdIfFlagUnset,
  SetDecorRearrangementShape, SetDecorSelectionBoxOamAttributes, SetDecorSelectionBoxTiles, SetDecorSelectionMetatiles,
  SetInitialPositions, SetMainCallback2, SetUpDecorationShape, SetUpPlacingDecorationPlayerAvatar,
  SetUpPuttingAwayDecorationPlayerAvatar, SetWarpDestination, ShowDecorationCategorySummaryWindow, ShowDecorationItemsWindow,
  ShowDecorationOnMap, ShowDecorationOnMap_, StopPuttingAwayDecorations_, StringAppend,
  StringCopy, StringExpandPlaceholders, StringLength, TryMoveObjectEventToMapCoords,
  TryOverrideObjectEventTemplateCoords, TryPutSecretBaseVisitOnAir, TrySpawnObjectEvent, UNPACK_BEHAVIOR,
  VarSet, WarpIntoMap, WarpToInitialPosition,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
