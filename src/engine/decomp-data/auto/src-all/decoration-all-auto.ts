...
const {
  ...
  DrawWholeMapView, ExitTraderMenu, FadeInFromBlack, FadeScreen,
  FillWindowPixelBuffer, FlagClear, FlagGet, Free,
  FreeItemIconTemporaryBuffers, FreeSpritePaletteByTag, GetDecorationIconPicOrPalette, GetLayerType,
  GetMaxWidthInMenuTable, GetMetatileAttributesById, GetNumOwnedDecorations, GetNumOwnedDecorationsInCategory,
  GetObjectEventIdByPosition, GetPlayerFacingDirection, GetStringRightAlignXOffset, HideSecretBaseDecorationSprites,
  InitMenuInUpperLeftCornerNormal, IsWeatherNotFadingIn, JOY_HELD, JOY_NEW,
  LZDecompressWram, ListMenuGetScrollAndRow, ListMenuInit, ListMenu_ProcessInput,
  LoadCompressedSpritePalette, LoadPalette, LoadSpritePalette, LoadSpriteSheet,
  LockPlayerFieldControls, MapGridGetMetatileBehaviorAt, MapGridGetMetatileIdAt, MapGridSetMetatileEntryAt,
  MapGridSetMetatileIdAt, Menu_GetCursorPos, Menu_ProcessInput, MetatileBehavior_HoldsLargeDecoration,
  MetatileBehavior_HoldsSmallDecoration, MetatileBehavior_IsNormal, MetatileBehavior_IsPlayerRoomPCOn, MetatileBehavior_IsSecretBaseHole,
  MetatileBehavior_IsSecretBaseImpassable, MetatileBehavior_IsSecretBaseNorthWall, MetatileBehavior_IsSecretBasePC, MetatileBehavior_IsSecretBaseTrainerSpot,
  PIXEL_FILL, PlaySE, PlayerGetDestCoords, PrintMenuTable,
  RemoveScrollIndicatorArrowPair, RemoveWindow, ReshowPlayerPC, ScheduleBgCopyTilemapToVram,
  ...
  StringLength, TryMoveObjectEventToMapCoords, TryOverrideObjectEventTemplateCoords, TryPutSecretBaseVisitOnAir,
  TrySpawnObjectEvent, UNPACK_BEHAVIOR, VarSet, WarpIntoMap,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
