...
export function ResetPokedexView(...args: any[]): any {
  let i: any = null;
...
export function Task_OpenPokedexMainPage(...args: any[]): any {
...
export function Task_HandlePokedexInput(...args: any[]): any {
...
export function Task_WaitForScroll(...args: any[]): any {
...
export function Task_HandlePokedexStartMenuInput(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BG0VOFS, sPokedexView.menuY);
...
export function Task_OpenInfoScreenAfterMonMovement(...args: any[]): any {
...
export function Task_WaitForExitInfoScreen(...args: any[]): any {
...
export function Task_WaitForExitSearch(...args: any[]): any {
  if (!gTasks[gTasks[taskId].tLoadScreenTaskId].isActive)
      {
          ClearMonSprites();
...
export function Task_ClosePokedex(...args: any[]): any {
...
export function Task_OpenSearchResults(...args: any[]): any {
...
export function Task_HandleSearchResultsInput(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BG0VOFS, sPokedexView.menuY);
...
export function Task_WaitForSearchResultsScroll(...args: any[]): any {
  if (UpdateDexListScroll(sPokedexView.scrollDirection, sPokedexView.scrollMonIncrement, sPokedexView.maxScrollTimer))
          gTasks[taskId].func = Task_HandleSearchResultsInput;
}

/** static void Task_HandleSearchResultsStartMenuInput(u8 taskId) */
export function Task_HandleSearchResultsStartMenuInput(...args: any[]): any {
  SetGpuReg(REG_OFFSET_BG0VOFS, sPokedexView.menuY);
...
export function Task_OpenSearchResultsInfoScreenAfterMonMovement(...args: any[]): any {
  if (gSprites[sPokedexView.selectedMonSpriteId].x == MON_PAGE_X && gSprites[sPokedexView.selectedMonSpriteId].y == MON_PAGE_Y)
      {
          sPokedexView.currentPageBackup = sPokedexView.currentPage;
          gTasks[taskId].tLoadScreenTaskId = LoadInfoScreen(sPokedexView.pokedexList[sPokedexView.selectedPokemon], sPokedexView.selectedMonSpriteId);
...
export function Task_WaitForExitSearchResultsInfoScreen(...args: any[]): any {
  if (gTasks[gTasks[taskId].tLoadScreenTaskId].isActive)
      {
...
export function Task_ReturnToPokedexFromSearchResults(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          sPokedexView.pokeBallRotation = sPokedexView.pokeBallRotationBackup;
          sPokedexView.selectedPokemon = sPokedexView.selectedPokemonBackup;
...
export function Task_ClosePokedexFromSearchResultsStartMenu(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          sPokedexView.pokeBallRotation = sPokedexView.pokeBallRotationBackup;
          sPokedexView.selectedPokemon = sPokedexView.selectedPokemonBackup;
...
export function LoadPokedexListPage(...args: any[]): any {
  switch (gMain.state)
      {
      case 0:
      default:
...
export function LoadPokedexBgPalette(...args: any[]): any {
...
export function CreatePokedexList(...args: any[]): any {
  const vars: any[] = [];  
      let i: any = null;
...
export function PrintMonDexNumAndName(...args: any[]): any {
  const color: any[] = [];
...
export function CreateMonListEntry(...args: any[]): any {
...
export function CreateMonDexNum(...args: any[]): any {
  const text: any[] = [];
      let dexNum: any = null;
...
export function CreateCaughtBall(...args: any[]): any {
  if (owned)
...
export function CreateMonName(...args: any[]): any {
  let str: any = null;
...
export function UpdateDexListScroll(...args: any[]): any {
  let i: any = null;
      let step: any = null;
...
export function CreateScrollingPokemonSprite(...args: any[]): any {
  let dexNum: any = null;
      let spriteId: any = null;
...
export function TryDoPokedexScroll(...args: any[]): any {
...
export function UpdateSelectedMonSpriteId(): any {
  let i: any = null;
      ...
      for (i = 0; i < MAX_MONS_ON_SCREEN; i++)
      {
          let spriteId = sPokedexView.monSpriteIds[i];
...
export function GetPokemonSpriteToDisplay(...args: any[]): any {
...
export function CreatePokedexMonSprite(...args: any[]): any {
  let i: any = null;
      ...
      for (i = 0; i < MAX_MONS_ON_SCREEN; i++)
      {
          if (sPokedexView.monSpriteIds[i] == 0xFFFF)
          {
              let spriteId = CreateMonSpriteFromNationalDexNumber(num, x, y, i);
...
export function CreateInterfaceSprites(...args: any[]): any {
  let spriteId: any = null;
...
export function SpriteCB_SeenOwnInfo(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN)
          DestroySprite(sprite);
}

/** void SpriteCB_MoveMonForInfoScreen(struct Sprite *sprite) */
export function SpriteCB_MoveMonForInfoScreen(...args: any[]): any {
...
export function SpriteCB_PokedexListMonSprite(...args: any[]): any {
...
export function SpriteCB_Scrollbar(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN && sPokedexView.currentPage != PAGE_SEARCH_RESULTS)
          DestroySprite(sprite);
      else
...
export function SpriteCB_ScrollArrow(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN && sPokedexView.currentPage != PAGE_SEARCH_RESULTS)
      {
          DestroySprite(sprite);
      }
...
export function SpriteCB_DexListInterfaceText(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN && sPokedexView.currentPage != PAGE_SEARCH_RESULTS)
          DestroySprite(sprite);
}

/** static void SpriteCB_RotatingPokeBall(struct Sprite *sprite) */
export function SpriteCB_RotatingPokeBall(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN && sPokedexView.currentPage != PAGE_SEARCH_RESULTS)
      {
          DestroySprite(sprite);
      }
...
export function SpriteCB_DexListStartMenuCursor(...args: any[]): any {
  if (sPokedexView.currentPage != PAGE_MAIN && sPokedexView.currentPage != PAGE_SEARCH_RESULTS)
      {
          DestroySprite(sprite);
      }
...
export function PrintInfoScreenText(...args: any[]): any {
  const color: any[] = [];
      color[0] = TEXT_COLOR_TRANSPARENT;
      color[1] = TEXT_DYNAMIC_COLOR_6;
      color[2] = TEXT_COLOR_LIGHT_GRAY;
...
export function LoadInfoScreen(...args: any[]): any {
  let taskId: any = null;
...
export function IsInfoScreenScrolling(...args: any[]): any {
...
export function StartInfoScreenScroll(...args: any[]): any {
  sPokedexListItem = item;
...
export function Task_LoadInfoScreen(...args: any[]): any {
  switch (gMain.state)
      {
      case 0:
      default:
...
export function Task_HandleInfoScreenInput(...args: any[]): any {
...
export function Task_SwitchScreensFromInfoScreen(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function Task_LoadInfoScreenWaitForFade(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          FreeAndDestroyMonPicSprite(gTasks[taskId].tMonSpriteId);
...
export function Task_ExitInfoScreen(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          FreeAndDestroyMonPicSprite(gTasks[taskId].tMonSpriteId);
...
export function Task_LoadAreaScreen(...args: any[]): any {
  switch (gMain.state)
      {
      case 0:
      default:
...
export function Task_WaitForAreaScreenInput(...args: any[]): any {
  if (sPokedexView.screenSwitchState != 0)
          gTasks[taskId].func = Task_SwitchScreensFromAreaScreen;
}

/** static void Task_SwitchScreensFromAreaScreen(u8 taskId) */
export function Task_SwitchScreensFromAreaScreen(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          switch (sPokedexView.screenSwitchState)
          {
...
export function Task_LoadCryScreen(...args: any[]): any {
  switch (gMain.state)
      {
      case 0:
      default:
...
export function Task_HandleCryScreenInput(...args: any[]): any {
...
export function Task_SwitchScreensFromCryScreen(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          FreeCryScreen();
          FreeAndDestroyMonPicSprite(gTasks[taskId].tMonSpriteId);
...
export function LoadPlayArrowPalette(...args: any[]): any {
  let color: any = null;
...
export function Task_LoadSizeScreen(...args: any[]): any {
  let spriteId: any = null;
...
export function Task_HandleSizeScreenInput(...args: any[]): any {
  if (JOY_NEW(B_BUTTON))
      {
          BeginNormalPaletteFade(PALETTES_ALL & ~(0x14), 0, 0, 0x10, RGB_BLACK);
          sPokedexView.screenSwitchState = 1;
...
export function Task_SwitchScreensFromSizeScreen(...args: any[]): any {
  if (!gPaletteFade.active)
      {
          FreeAndDestroyMonPicSprite(gTasks[taskId].tMonSpriteId);
...
export function HighlightScreenSelectBarItem(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let ptr = GetBgTilemapBuffer(1);
...
export function HighlightSubmenuScreenSelectBarItem(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let ptr = GetBgTilemapBuffer(1);
...
export function DisplayCaughtMonDexPage(...args: any[]): any {
  let taskId = CreateTask(Task_DisplayCaughtMonDexPage, 0);
...
export function Task_DisplayCaughtMonDexPage(...args: any[]): any {
  let spriteId: any = null;
      let dexNum = gTasks[taskId].tDexNum;
...
export function Task_HandleCaughtMonPageInput(...args: any[]): any {
...
export function Task_ExitCaughtMonPage(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function SpriteCB_SlideCaughtMonToCenter(...args: any[]): any {
...
export function PrintMonInfo(...args: any[]): any {
  const str: any[] = [];
      const str2: any[] = [];
      let natNum: any = null;
      let name: any = null;
...
export function GetSetPokedexFlag(...args: any[]): any {
  let index: any = null;
      let bit: any = null;
      let mask: any = null;
      let retVal: any = null;
...
export function GetNationalPokedexCount(...args: any[]): any {
  let count = 0;
      let i: any = null;
...
export function GetHoennPokedexCount(...args: any[]): any {
  let count = 0;
      let i: any = null;
...
export function GetKantoPokedexCount(...args: any[]): any {
  let count = 0;
      let i: any = null;
...
export function ResetOtherVideoRegisters(...args: any[]): any {
...
export function PrintInfoSubMenuText(...args: any[]): any {
  const color: any[] = [];
      color[0] = TEXT_COLOR_TRANSPARENT;
      color[1] = TEXT_DYNAMIC_COLOR_6;
      color[2] = TEXT_COLOR_LIGHT_GRAY;
...
export function PrintCryScreenSpeciesName(...args: any[]): any {
  const str: any[] = [];
      let i: any = null;
...
export function PrintDecimalNum(...args: any[]): any {
  const str: any[] = [];
      let outputted = FALSE;
      let result: any = null;
...
export function DrawFootprint(...args: any[]): any {
  const footprint4bpp: any[] = [];
      let footprintGfx = gMonFootprintTable[NationalPokedexNumToSpecies(dexNum)];
      let tileIdx = 0;
      let i, j;

      for (i = 0; i < TILE_SIZE_1BPP * NUM_FOOTPRINT_TILES; i++)
      {
          let footprint1bpp = footprintGfx[i];
...
export function GetNextPosition(...args: any[]): any {
  switch (direction)
      {
      case 1:  
          if (position > min)
...
export function GetPokedexMonPersonality(...args: any[]): any {
...
export function CreateMonSpriteFromNationalDexNumber(...args: any[]): any {
...
export function CreateSizeScreenTrainerPic(...args: any[]): any {
...
export function DoPokedexSearch(...args: any[]): any {
  let species: any = null;
      let i: any = null;
...
export function PrintSearchText(...args: any[]): any {
  const color: any[] = [];
...
export function ClearSearchMenuRect(...args: any[]): any {
  FillWindowPixelRect(0, PIXEL_FILL(0), x, y, width, height);
}

/** static void Task_LoadSearchMenu(u8 taskId) */
export function Task_LoadSearchMenu(...args: any[]): any {
  let i: any = null;
...
export function Task_SwitchToSearchMenuTopBar(...args: any[]): any {
...
export function Task_HandleSearchTopBarInput(...args: any[]): any {
  if (JOY_NEW(B_BUTTON))
      {
          PlaySE(SE_PC_OFF);
...
export function Task_SwitchToSearchMenu(...args: any[]): any {
...
export function Task_HandleSearchMenuInput(...args: any[]): any {
...
export function Task_StartPokedexSearch(...args: any[]): any {
...
export function Task_WaitAndCompleteSearch(...args: any[]): any {
  if (!IsSEPlaying())
      {
          if (sPokedexView.pokemonListCount != 0)
          {
...
export function Task_SearchCompleteWaitForInput(...args: any[]): any {
  if (JOY_NEW(A_BUTTON))
      {
          if (sPokedexView.pokemonListCount != 0)
          {
...
export function Task_SelectSearchMenuItem(...args: any[]): any {
...
export function Task_HandleSearchParameterInput(...args: any[]): any {
  let menuItem: any = null;
      let texts: any = null;
      let cursorPos: any = null;
      let scrollOffset: any = null;
...
export function Task_ExitSearch(...args: any[]): any {
  BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
      gTasks[taskId].func = Task_ExitSearchWaitForFade;
}

/** static void Task_ExitSearchWaitForFade(u8 taskId) */
export function Task_ExitSearchWaitForFade(...args: any[]): any {
  if (!gPaletteFade.active)
      {
...
export function SetSearchRectHighlight(...args: any[]): any {
  let i: any = null;
      let temp: any = null;  
      let ptr = GetBgTilemapBuffer(3);  
...
export function DrawSearchMenuItemBgHighlight(...args: any[]): any {
  let highlightFlags = (unselected & 1) | ((disabled & 1) << 1);
...
export function SetInitialSearchMenuBgHighlights(...args: any[]): any {
  switch (topBarItem)
      {
      case SEARCH_TOPBAR_SEARCH:
...
export function HighlightSelectedSearchTopBarItem(...args: any[]): any {
...
export function HighlightSelectedSearchMenuItem(...args: any[]): any {
  SetInitialSearchMenuBgHighlights(topBarItem);
      switch (menuItem)
      {
      case SEARCH_NAME:
...
export function PrintSelectedSearchParameters(...args: any[]): any {
...
export function DrawOrEraseSearchParameterBox(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let ptr = GetBgTilemapBuffer(3);
...
export function PrintSearchParameterText(...args: any[]): any {
  let texts: any = sSearchOptions[gTasks[taskId].tMenuItem].texts;
      let cursorPos = gTasks[taskId].data[sSearchOptions[gTasks[taskId].tMenuItem].taskDataCursorPos];
      let scrollOffset = gTasks[taskId].data[sSearchOptions[gTasks[taskId].tMenuItem].taskDataScrollOffset];
      let i: any = null;
      let j: any = null;
...
export function GetSearchModeSelection(...args: any[]): any {
  let cursorPos = gTasks[taskId].data[sSearchOptions[option].taskDataCursorPos];
      let scrollOffset = gTasks[taskId].data[sSearchOptions[option].taskDataScrollOffset];
      let id = *cursorPos + *scrollOffset;
...
export function SetDefaultSearchModeAndOrder(...args: any[]): any {
...
export function SearchParamCantScrollUp(...args: any[]): any {
  let menuItem = gTasks[taskId].tMenuItem;
      let scrollOffset = gTasks[taskId].data[sSearchOptions[menuItem].taskDataScrollOffset];
      let lastOption = sSearchOptions[menuItem].numOptions - 1;
...
export function SearchParamCantScrollDown(...args: any[]): any {
  let menuItem = gTasks[taskId].tMenuItem;
      let scrollOffset = gTasks[taskId].data[sSearchOptions[menuItem].taskDataScrollOffset];
      let lastOption = sSearchOptions[menuItem].numOptions - 1;
...
export function SpriteCB_SearchParameterScrollArrow(...args: any[]): any {
...
export function CreateSearchParameterScrollArrows(...args: any[]): any {
  let spriteId: any = null;
