...
const {
  ...
  BeginNormalPaletteFade, BlitBitmapToWindow, BuildOamBuffer, ClearGpuRegBits,
  ClearMonListEntry, ClearMonSprites, ClearSearchMenuRect, ClearSearchParameterBoxText,
  ConvertIntToDecimalStringN, CopyBgTilemapBufferToVram, CopyMonCategoryText, CopyToBgTilemapBuffer,
  CopyToWindowPixelBuffer, CopyWindowToVram, CreateCaughtBall, CreateInterfaceSprites,
  CreateMonDexNum, CreateMonListEntry, CreateMonName, CreateMonPicSprite_HandleDeoxys,
  CreateMonSpriteFromNationalDexNumber, CreateMonSpritesAtPos, CreatePokedexList, CreatePokedexMonSprite,
  CreateScrollingPokemonSprite, CreateSearchParameterScrollArrows, CreateSizeScreenTrainerPic, CreateSprite,
  CreateTask, CreateTrainerPicSprite, CryScreenPlayButton, DeactivateAllTextPrinters,
  DecompressAndLoadBgGfxUsingHeap, DestroySprite, DestroyTask, DisableNationalPokedex,
  DmaClear16, DmaClear32, DmaFillLarge16, DoPokedexSearch,
  DrawFootprint, DrawOrEraseSearchParameterBox, DrawSearchMenuItemBgHighlight, EnableInterrupts,
  EraseAndPrintSearchTextBox, EraseSelectorArrow, FillWindowPixelBuffer, FillWindowPixelRect,
  Free, FreeAllSpritePalettes, FreeAllWindowBuffers, FreeAndDestroyMonPicSprite,
  FreeAndDestroyTrainerPicSprite, FreeCryScreen, FreeInfoScreenWindowAndBgBuffers, FreeSearchWindowAndBgBuffers,
  FreeWindowAndBgBuffers, GetBgTilemapBuffer, GetHoennPokedexCount, GetMonSpritePalFromSpeciesAndPersonality,
  GetNationalPokedexCount, GetNextPosition, GetOverworldTextboxPalettePtr, GetPokedexMonPersonality,
  GetPokemonSpriteToDisplay, GetSearchModeSelection, GetSetPokedexFlag, GetStringCenterAlignXOffset,
  HideBg, HighlightScreenSelectBarItem, HighlightSelectedSearchMenuItem, HighlightSelectedSearchTopBarItem,
  HighlightSubmenuScreenSelectBarItem, HoennToNationalOrder, InitBgsFromTemplates, InitWindows,
  IsCryPlaying, IsCryPlayingOrClearCrySongs, IsInfoScreenScrolling, IsNationalPokedexEnabled,
  IsSEPlaying, JOY_HELD, JOY_NEW, JOY_REPEAT,
  LETTER_IN_RANGE_LOWER, LETTER_IN_RANGE_UPPER, LoadCompressedPalette, LoadCompressedSpriteSheet,
  LoadCryMeter, LoadCryWaveformWindow, LoadInfoScreen, LoadOam,
  LoadPalette, LoadPlayArrowPalette, LoadPokedexBgPalette, LoadPokedexListPage,
  LoadScreenSelectBarMain, LoadScreenSelectBarSubmenu, LoadSearchMenu, LoadSpritePalettes,
  NationalPokedexNumToSpecies, NationalToHoennOrder, OBJ_PLTT_ID, OBJ_PLTT_ID2,
  PIXEL_FILL, PLTT_SIZEOF, PlayCry_Normal, PlayCry_NormalNoDucking,
  PlaySE, PlayerGenderToFrontTrainerPicId, PrintCryScreenSpeciesName, PrintDecimalNum,
  PrintInfoScreenText, PrintInfoSubMenuText, PrintMonDexNumAndName, PrintMonHeight,
  PrintMonInfo, PrintMonWeight, PrintSearchParameterText, PrintSearchParameterTitle,
  PrintSearchText, PrintSelectedSearchParameters, PrintSelectorArrow, ProcessSpriteCopyRequests,
  PutWindowTilemap, ResetAllPicSprites, ResetBgsAndClearDma3BusyFlags, ResetOtherVideoRegisters,
  ResetPaletteFade, ResetPokedexView, ResetSpriteData, ResetTasks,
  RunTasks, SAFE_DIV, ScanlineEffect_Stop, SearchParamCantScrollDown,
  SearchParamCantScrollUp, SetBgTilemapBuffer, SetDefaultSearchModeAndOrder, SetGpuReg,
  SetInitialSearchMenuBgHighlights, SetMainCallback2, SetOamMatrix, SetSearchRectHighlight,
  SetVBlankCallback, ShowBg, ShowPokedexAreaScreen, StartInfoScreenScroll,
  StartSpriteAnim, StopCryAndClearCrySongs, StringAppend, StringCopy,
  StringLength, TransferPlttBuffer, TryDoInfoScreenScroll, TryDoPokedexScroll,
  UpdateCryWaveformWindow, UpdateDexListScroll, UpdatePaletteFade, UpdateSelectedMonSpriteId,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
