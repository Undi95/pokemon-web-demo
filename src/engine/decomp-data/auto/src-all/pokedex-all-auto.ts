...
const {
  ...
  CopyToWindowPixelBuffer, CopyWindowToVram, CreateMonPicSprite_HandleDeoxys, CreateSprite,
  ...
  FreeAllWindowBuffers, FreeAndDestroyMonPicSprite, FreeAndDestroyTrainerPicSprite, FreeCryScreen,
  GetBgTilemapBuffer, GetMonSpritePalFromSpeciesAndPersonality, GetOverworldTextboxPalettePtr, GetStringCenterAlignXOffset,
  HideBg, HoennToNationalOrder, InitBgsFromTemplates, InitWindows,
  IsCryPlaying, IsCryPlayingOrClearCrySongs, IsNationalPokedexEnabled, IsSEPlaying,
  JOY_HELD, JOY_NEW, JOY_REPEAT, LETTER_IN_RANGE_LOWER,
  LETTER_IN_RANGE_UPPER, LoadCompressedPalette, LoadCompressedSpriteSheet, LoadCryMeter,
  LoadCryWaveformWindow, LoadOam, LoadPalette, LoadSpritePalettes,
  ...
  ResetTasks, RunTasks, SAFE_DIV, ScanlineEffect_Stop,
  ...
  TransferPlttBuffer, UpdateCryWaveformWindow, UpdatePaletteFade,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
