...
const {
  ...
  FreeTrainerFrontPicPalette, GetBattlerAtPosition, GetBattlerPosition, GetBattlerSide,
  GetBattlerSpriteCoord, GetBattlerSpriteDefault_Y, GetBattlerSpriteSubpriority, GetEreaderTrainerFrontSpriteId,
  GetFrontierBrainTrainerPicIndex, GetFrontierTrainerFrontSpriteId, GetMonData, GetMostSuitableMonToSwitchInto,
  GetMultiplayerId, GetSecretBaseTrainerPicIndex, GetTrainerHillTrainerFrontSpriteId, HandleIntroSlide,
  ...
  ST_OAM_AFFINE_NORMAL, ST_OAM_AFFINE_OFF, SetBattleBarStruct, SetBattlerShadowSpriteCallback,
