...
const {
  ...
  BattleAI_SetupAIData, BattleArena_DeductSkillPoints, BattleLoadOpponentMonSpriteGfx, BattlePutTextOnWindow,
  BattleStopLowHpSound, BtlController_EmitChosenMonReturnValue, BtlController_EmitDataTransfer, BtlController_EmitOneReturnValue,
  ...
  DoPokeballSendOutAnimation, FALSE, FreeSpriteOamMatrix, FreeSpritePaletteByTag,
  FreeSpriteTilesByTag, FreeTrainerFrontPicPalette, GetBattlerAtPosition, GetBattlerPosition,
  GetBattlerSide, GetBattlerSpriteCoord, GetBattlerSpriteDefault_Y, GetBattlerSpriteSubpriority,
  GetEreaderTrainerFrontSpriteId, GetFrontierBrainTrainerPicIndex, GetFrontierTrainerFrontSpriteId, GetMonData,
  GetMostSuitableMonToSwitchInto, GetMultiplayerId, GetSecretBaseTrainerPicIndex, GetTrainerHillTrainerFrontSpriteId,
  ...
  MOD, MoveBattleBar, NULL, PlayBGM,
  PlayCry_ByMode, PlayFanfare, PlaySE12WithPanning, PrepareBufferDataTransferLink,
  Random, ST_OAM_AFFINE_NORMAL, ST_OAM_AFFINE_OFF, SetBattleBarStruct,
