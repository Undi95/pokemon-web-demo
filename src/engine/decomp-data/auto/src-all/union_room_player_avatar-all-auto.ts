...
export function CreateUnionRoomPlayerObjectEvent(leaderId: any): any {
...
export function RemoveUnionRoomPlayerObjectEvent(leaderId: any): any {
...
export function SetUnionRoomPlayerEnterExitMovement(leaderId: any, movement: any): any {
...
export function TryReleaseUnionRoomPlayerObjectEvent(leaderId: any): any {
  let objectId: any = null;
      let object: any = null;
      if (TryGetObjectEventIdByLocalIdAndMap(sUnionRoomLocalIds[leaderId], gSaveBlock1Ptr.location.mapNum, gSaveBlock1Ptr.location.mapGroup,objectId))
          return TRUE;
...
export function InitUnionRoomPlayerObjects(players: any): any {
  let i: any = null;
...
export function AnimateUnionRoomPlayerDespawn(state: any, leaderId: any, object: any): any {
  switch (state)
      {
      case 0:
...
export function AnimateUnionRoomPlayerSpawn(state: any, leaderId: any, object: any): any {
  let x, y;
...
export function AnimateUnionRoomPlayer(leaderId: any, object: any): any {
  switch (object.state)
      {
      case 0:
...
export function SpawnGroupMember(leaderId: any, memberId: any, graphicsId: any, gameData: any): any {
  let x, y;
      let id: any = UR_PLAYER_SPRITE_ID(leaderId, memberId);
...
export function AssembleGroup(leaderId: any, gameData: any): any {
  let x, y, x2, y2;
      let i: any = null;
...
export function SpawnGroupLeaderAndMembers(leaderId: any, gameData: any): any {
  let i: any = null;
...
export function UpdateUnionRoomPlayerSprites(uroom: any): any {
  let i: any = null;
...
export function ScheduleUnionRoomPlayerRefresh(uroom: any): any {
  sUnionObjRefreshTimer = 300;
}

/** void HandleUnionRoomPlayerRefresh(struct WirelessLink_URoom *uroom) */
export function HandleUnionRoomPlayerRefresh(uroom: any): any {
...
export function TryInteractWithUnionRoomMember(list: any, memberIdPtr: any, leaderIdPtr: any, spriteIds: any): any {
  let x, y;
      let i, memberId;
      let leaders: any = null;
      if (!IsPlayerStandingStill())
...
export function UpdateUnionRoomMemberFacing(memberId: any, leaderId: any, list: any): any {
