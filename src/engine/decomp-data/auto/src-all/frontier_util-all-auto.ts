...
export function GetFrontierData(): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let hasSymbol = GetPlayerSymbolCountForFacility(facility);
      if (hasSymbol == 2)
          hasSymbol = 1;
...
export function SaveSelectedParty(): any {
  let i: any = null;
      ...
      for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
      {
          let monId = gSaveBlock2Ptr.frontier.selectedPartyMons[i] - 1;
          if (monId < PARTY_SIZE)
...
export function IsWinStreakActive(...args: any[]): any {
...
export function PrintAligned(...args: any[]): any {
  let x = GetStringCenterAlignXOffset(FONT_NORMAL, str, DISPLAY_WIDTH - 16);
      y = (y * 8) + 1;
      AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x, y, TEXT_SKIP_DRAW, NULL);
}

/** static void PrintHyphens(s32 y) */
export function PrintHyphens(...args: any[]): any {
  let i: any = null;
      const text: any[] = [];
...
export function TowerPrintStreak(...args: any[]): any {
...
export function TowerPrintRecordStreak(...args: any[]): any {
  let num = gSaveBlock2Ptr.frontier.towerRecordWinStreaks[battleMode][lvlMode];
      TowerPrintStreak(gText_Record, num, x1, x2, y);
}

/** static u16 TowerGetWinStreak(u8 battleMode, u8 lvlMode) */
export function TowerGetWinStreak(...args: any[]): any {
...
export function TowerPrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = TowerGetWinStreak(battleMode, lvlMode);
      switch (battleMode)
      {
      default:
...
export function ShowTowerResultsWindow(...args: any[]): any {
...
export function DomeGetWinStreak(...args: any[]): any {
  let winStreak = gSaveBlock2Ptr.frontier.domeWinStreaks[battleMode][lvlMode];
      if (winStreak > MAX_STREAK)
          return MAX_STREAK;
      else
          return winStreak;
...
export function PrintTwoStrings(...args: any[]): any {
...
export function DomePrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = DomeGetWinStreak(battleMode, lvlMode);
      switch (battleMode)
      {
      default:
      case FRONTIER_MODE_SINGLES:
...
export function ShowDomeResultsWindow(...args: any[]): any {
  gRecordsWindowId = AddWindow(sFrontierResultsWindowTemplate);
      DrawStdWindowFrame(gRecordsWindowId, FALSE);
      FillWindowPixelBuffer(gRecordsWindowId, PIXEL_FILL(1));
      if (battleMode == FRONTIER_MODE_SINGLES)
...
export function PalacePrintStreak(...args: any[]): any {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y, TEXT_SKIP_DRAW, NULL);
      if (num > MAX_STREAK)
          num = MAX_STREAK;
      ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
export function PalacePrintRecordStreak(...args: any[]): any {
  let num = gSaveBlock2Ptr.frontier.palaceRecordWinStreaks[battleMode][lvlMode];
      PalacePrintStreak(gText_Record, num, x1, x2, y);
}

/** static u16 PalaceGetWinStreak(u8 battleMode, u8 lvlMode) */
export function PalaceGetWinStreak(...args: any[]): any {
  let winStreak = gSaveBlock2Ptr.frontier.palaceWinStreaks[battleMode][lvlMode];
      if (winStreak > MAX_STREAK)
          return MAX_STREAK;
      else
          return winStreak;
...
export function PalacePrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = PalaceGetWinStreak(battleMode, lvlMode);
      switch (battleMode)
      {
      default:
      case FRONTIER_MODE_SINGLES:
...
export function ShowPalaceResultsWindow(...args: any[]): any {
  gRecordsWindowId = AddWindow(sFrontierResultsWindowTemplate);
      DrawStdWindowFrame(gRecordsWindowId, FALSE);
      FillWindowPixelBuffer(gRecordsWindowId, PIXEL_FILL(1));
      if (battleMode == FRONTIER_MODE_SINGLES)
...
export function PikeGetWinStreak(...args: any[]): any {
...
export function PikePrintCleared(...args: any[]): any {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str1, x1, y, TEXT_SKIP_DRAW, NULL);
      ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
      StringExpandPlaceholders(gStringVar4, str2);
      AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4, x2, y, TEXT_SKIP_DRAW, NULL);
...
export function PikePrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = PikeGetWinStreak(lvlMode);
...
export function ArenaPrintStreak(...args: any[]): any {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y, TEXT_SKIP_DRAW, NULL);
      if (num > MAX_STREAK)
          num = MAX_STREAK;
      ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
export function ArenaPrintRecordStreak(...args: any[]): any {
  let num = gSaveBlock2Ptr.frontier.arenaRecordStreaks[lvlMode];
      ArenaPrintStreak(gText_Record, num, x1, x2, y);
}

/** static u16 ArenaGetWinStreak(u8 lvlMode) */
export function ArenaGetWinStreak(...args: any[]): any {
  let winStreak = gSaveBlock2Ptr.frontier.arenaWinStreaks[lvlMode];
      if (winStreak > MAX_STREAK)
          return MAX_STREAK;
      else
          return winStreak;
...
export function ArenaPrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = ArenaGetWinStreak(lvlMode);
...
export function FactoryPrintStreak(...args: any[]): any {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y, TEXT_SKIP_DRAW, NULL);
      if (num1 > MAX_STREAK)
          num1 = MAX_STREAK;
...
export function FactoryPrintRecordStreak(...args: any[]): any {
  let num1 = gSaveBlock2Ptr.frontier.factoryRecordWinStreaks[battleMode][lvlMode];
      let num2 = gSaveBlock2Ptr.frontier.factoryRecordRentsCount[battleMode][lvlMode];
      FactoryPrintStreak(gText_Record, num1, num2, x1, x2, x3, y);
}

/** static u16 FactoryGetWinStreak(u8 battleMode, u8 lvlMode) */
export function FactoryGetWinStreak(...args: any[]): any {
...
export function FactoryGetRentsCount(...args: any[]): any {
...
export function FactoryPrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = FactoryGetWinStreak(battleMode, lvlMode);
      let rents = FactoryGetRentsCount(battleMode, lvlMode);
      switch (battleMode)
      {
      default:
      case FRONTIER_MODE_SINGLES:
...
export function ShowFactoryResultsWindow(...args: any[]): any {
  gRecordsWindowId = AddWindow(sFrontierResultsWindowTemplate);
      DrawStdWindowFrame(gRecordsWindowId, FALSE);
      FillWindowPixelBuffer(gRecordsWindowId, PIXEL_FILL(1));
      if (battleMode == FRONTIER_MODE_SINGLES)
...
export function PyramidPrintStreak(...args: any[]): any {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y, TEXT_SKIP_DRAW, NULL);
      if (num > MAX_STREAK)
          num = MAX_STREAK;
      ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
export function PyramidPrintRecordStreak(...args: any[]): any {
  let num = gSaveBlock2Ptr.frontier.pyramidRecordStreaks[lvlMode];
      PyramidPrintStreak(gText_Record, num, x1, x2, y);
}

/** static u16 PyramidGetWinStreak(u8 lvlMode) */
export function PyramidGetWinStreak(...args: any[]): any {
  let winStreak = gSaveBlock2Ptr.frontier.pyramidWinStreaks[lvlMode];
      if (winStreak > MAX_STREAK)
          return MAX_STREAK;
      else
          return winStreak;
...
export function PyramidPrintPrevOrCurrentStreak(...args: any[]): any {
  let isCurrent: any = null;
      let winStreak = PyramidGetWinStreak(lvlMode);
...
export function GetFrontierBrainStatus(): any {
  let status = FRONTIER_BRAIN_NOT_READY;
      let facility = VarGet(VAR_FRONTIER_FACILITY);
      let battleMode = VarGet(VAR_FRONTIER_BATTLE_MODE);
      let winStreakNoModifier = GetCurrentFacilityWinStreak();
      let winStreak = winStreakNoModifier + sFrontierBrainStreakAppearances[facility][3];
...
export function CopyFrontierTrainerText(...args: any[]): any {
  switch (whichText)
      {
...
export function GetPlayerSymbolCountForFacility(...args: any[]): any {
...
export function AppendCaughtBannedMonSpeciesName(...args: any[]): any {
...
export function AppendIfValid(...args: any[]): any {
  let i = 0;
...
export function CheckPartyIneligibility(): any {
  const speciesArray: any[] = [];
      ...
      do
      {
          ...
          do
          {
              let species = GetMonData(gPlayerParty[monId], MON_DATA_SPECIES_OR_EGG);
              let heldItem = GetMonData(gPlayerParty[monId], MON_DATA_HELD_ITEM);
              let level = GetMonData(gPlayerParty[monId], MON_DATA_LEVEL);
              let hp = GetMonData(gPlayerParty[monId], MON_DATA_HP);
      ...
      {
          let i: any = null;
          let caughtBannedMons = 0;
          let species = gFrontierBannedSpecies[0];
...
export function RestoreHeldItems(): any {
  let i: any = null;
      ...
      for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
      {
          ...
          {
              let item = GetMonData(gSaveBlock1Ptr.playerParty[gSaveBlock2Ptr.frontier.selectedPartyMons[i] - 1], MON_DATA_HELD_ITEM, NULL);
...
export function Print1PRecord(...args: any[]): any {
  const text: any[] = [];
...
export function Print2PRecord(...args: any[]): any {
  const text: any[] = [];
      let winStreak: any = null;
...
export function Fill1PRecords(...args: any[]): any {
  let i, j;
      struct RankingHall1P record1P[HALL_RECORDS_COUNT + 1];
      let playerHallRecords: any = AllocZeroed(sizeof(struct PlayerHallRecords));
...
export function Fill2PRecords(...args: any[]): any {
  let i, j;
...
export function PrintHallRecords(...args: any[]): any {
  let i: any = null;
      let x: any = null;
...
export function SaveGameFrontier(): any {
  let i: any = null;
      let monsParty: any = AllocZeroed(sizeof(struct Pokemon) * PARTY_SIZE);
...
export function CopyFrontierBrainTrainerName(...args: any[]): any {
  let i: any = null;
      let facility: any = null;
...
export function CreateFrontierBrainPokemon(): any {
  let i, j;
      ...
      let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetFronterBrainSymbol();
...
export function GetFrontierBrainMonSpecies(...args: any[]): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetFronterBrainSymbol();
...
export function SetFrontierBrainObjEventGfx(...args: any[]): any {
  gTrainerBattleOpponent_A = TRAINER_FRONTIER_BRAIN;
      VarSet(VAR_OBJ_GFX_ID_0, sFrontierBrainObjEventGfx[facility][0]);
}

/** u16 GetFrontierBrainMonMove(u8 monId, u8 moveSlotId) */
export function GetFrontierBrainMonMove(...args: any[]): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetFronterBrainSymbol();
...
export function GetFrontierBrainMonNature(...args: any[]): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetFronterBrainSymbol();
...
export function GetFrontierBrainMonEvs(...args: any[]): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetFronterBrainSymbol();
...
export function GetFronterBrainSymbol(): any {
  let facility = VarGet(VAR_FRONTIER_FACILITY);
      let symbol = GetPlayerSymbolCountForFacility(facility);
...
export function CopyFrontierBrainText(...args: any[]): any {
  let facility: any = null;
      let symbol: any = null;
