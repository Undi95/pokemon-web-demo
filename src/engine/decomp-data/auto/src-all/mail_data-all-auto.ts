...
const {
  ClearMail, GetBoxMonData, GetMonData, GetUnownLetterByPersonality,
  GiveMailToMonByItemId, ItemIsMail, MonHasMail, PadNameString,
  SetMonData, SpeciesToMailSpecies,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
