...
export function ClearMail(...args: any[]): any {
  let i: any = null;
...
export function MonHasMail(...args: any[]): any {
  let heldItem = GetMonData(mon, MON_DATA_HELD_ITEM);
...
export function GiveMailToMonByItemId(...args: any[]): any {
  const heldItem: any[] = [];
      let id, i;
...
export function SpeciesToMailSpecies(...args: any[]): any {
  if (species == SPECIES_UNOWN)
      {
          let species = GetUnownLetterByPersonality(personality) + UNOWN_OFFSET;
          return species;
      }
...
export function MailSpeciesToSpecies(...args: any[]): any {
  let result: any = null;
...
export function GiveMailToMon(...args: any[]): any {
  const heldItem: any[] = [];
      let itemId = mail.itemId;
      let mailId = GiveMailToMonByItemId(mon, itemId);
...
export function TakeMailFromMon(...args: any[]): any {
  const heldItem: any[] = [];
      let mailId: any = null;
...
export function ClearMailItemId(...args: any[]): any {
  gSaveBlock1Ptr.mail[mailId].itemId = ITEM_NONE;
}

/** u8 TakeMailFromMonAndSave(struct Pokemon *mon) */
export function TakeMailFromMonAndSave(...args: any[]): any {
  let i: any = null;
...
export function ItemIsMail(...args: any[]): any {
  switch (itemId)
      {
