...
export function InitPlayerPCMenu(taskId: any): any {
  let data: any = null;
...
export function PlayerPCProcessMenuInput(taskId: any): any {
  let data: any = null;
...
export function ReshowPlayerPC(_var: any): any {
  DisplayItemMessageOnField(_var, gText_WhatWouldYouLike, InitPlayerPCMenu);
}

/** static void PlayerPC_ItemStorage(u8 taskId) */
export function PlayerPC_ItemStorage(taskId: any): any {
  InitItemStorageMenu(taskId, MENU_WITHDRAW);
      gTasks[taskId].func = ItemStorageMenuProcessInput;
}

/** static void PlayerPC_Mailbox(u8 taskId) */
export function PlayerPC_Mailbox(taskId: any): any {
...
export function PlayerPC_Decoration(taskId: any): any {
...
export function InitItemStorageMenu(taskId: any, _var: any): any {
  let data: any = null;
      let windowTemplate: any = null;
      ...
      InitMenuInUpperLeftCornerNormal(tWindowId, ARRAY_COUNT(sItemStorage_MenuActions), _var);
      ScheduleBgCopyTilemapToVram(0);
      ItemStorageMenuPrint(sItemStorage_OptionDescriptions[_var]);
}

/** static void ItemStorageMenuPrint(const u8 *textPtr) */
export function ItemStorageMenuPrint(textPtr: any): any {
  DrawDialogueFrame(0, FALSE);
      AddTextPrinterParameterized(0, FONT_NORMAL, textPtr, 0, 1, 0, 0);
}

/** static void ItemStorageMenuProcessInput(u8 taskId) */
export function ItemStorageMenuProcessInput(taskId: any): any {
  let oldPos, newPos;
      let inputOptionId: any = null;
...
export function Task_ItemStorage_Deposit(taskId: any): any {
...
export function ItemStorage_HandleReturnToProcessInput(taskId: any): any {
  if (IsWeatherNotFadingIn() == TRUE)
          gTasks[taskId].func = ItemStorageMenuProcessInput;
}

/** static void ItemStorage_Withdraw(u8 taskId) */
export function ItemStorage_Withdraw(taskId: any): any {
...
export function ItemStorage_Toss(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_Enter(taskId: any, toss: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_Exit(taskId: any): any {
  ItemStorage_EraseMainMenu(taskId);
      ReshowPlayerPC(taskId);
}

/** static void SetPlayerPCListCount(u8 taskId) */
export function SetPlayerPCListCount(taskId: any): any {
...
export function ItemStorage_EraseMainMenu(taskId: any): any {
  let data: any = gTasks[taskId].data;
      ClearStdWindowAndFrameToTransparent(tWindowId, FALSE);
      ClearWindowTilemap(tWindowId);
      RemoveWindow(tWindowId);
...
export function Mailbox_DrawMailboxMenu(taskId: any): any {
  let windowId: any = MailboxMenu_AddWindow(MAILBOXWIN_TITLE);
...
export function Mailbox_ProcessInput(taskId: any): any {
  let data: any = gTasks[taskId].data;

      if (!gPaletteFade.active)
      {
          let inputOptionId: any = ListMenu_ProcessInput(tListTaskId);
...
export function Mailbox_ReturnToPlayerPC(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function Mailbox_PrintMailOptions(taskId: any): any {
  let windowId: any = MailboxMenu_AddWindow(MAILBOXWIN_OPTIONS);
...
export function Mailbox_MailOptionsProcessInput(taskId: any): any {
  let inputOptionId: any = ProcessMenuInput_other();
...
export function Mailbox_FadeAndReadMail(taskId: any): any {
  if (!gPaletteFade.active)
      {
          MailboxMenu_Free();
          CleanupOverworldWindowsAndTilemaps();
...
export function Mailbox_HandleReturnToProcessInput(taskId: any): any {
  if (IsWeatherNotFadingIn() == TRUE)
          gTasks[taskId].func = Mailbox_ProcessInput;
}

/** static void Mailbox_MoveToBag(u8 taskId) */
export function Mailbox_MoveToBag(taskId: any): any {
...
export function Mailbox_AskConfirmMoveToBag(taskId: any): any {
  DisplayYesNoMenuDefaultYes();
      gTasks[taskId].func = Mailbox_HandleConfirmMoveToBag;
}

/** static void Mailbox_HandleConfirmMoveToBag(u8 taskId) */
export function Mailbox_HandleConfirmMoveToBag(taskId: any): any {
...
export function Mailbox_CancelMoveToBag(taskId: any): any {
  Mailbox_Cancel(taskId);
}

/** static void Mailbox_Give(u8 taskId) */
export function Mailbox_Give(taskId: any): any {
...
export function Mailbox_DoGiveMailPokeMenu(taskId: any): any {
  if (!gPaletteFade.active)
      {
          MailboxMenu_Free();
          CleanupOverworldWindowsAndTilemaps();
...
export function Mailbox_NoPokemonForMail(taskId: any): any {
  DisplayItemMessageOnField(taskId, gText_NoPokemon, Mailbox_Cancel);
}

/** static void Mailbox_Cancel(u8 taskId) */
export function Mailbox_Cancel(taskId: any): any {
...
export function CopyItemName_PlayerPC(string: any, itemId: any): any {
...
export function ItemStorage_PrintDescription(id: any): any {
...
export function ItemStorage_SetSwapArrow(listTaskId: any, b: any, speed: any): any {
...
export function ItemStorage_DrawSwapArrow(y: any, b: any, speed: any): any {
  let windowId: any = sItemStorageMenu.windowIds[ITEMPC_WIN_LIST];
      if (b == 0xFF)
...
export function ItemStorage_DrawItemIcon(itemId: any): any {
...
export function ItemStorage_CreateListMenu(taskId: any): any {
  let data: any = null;
      let toss: any = null;
      let i, x;
      let text: any = null;
...
export function ItemStorage_PrintMessage(string: any): any {
  let windowId: any = sItemStorageMenu.windowIds[ITEMPC_WIN_MESSAGE];
      FillWindowPixelBuffer(windowId, PIXEL_FILL(1));
...
export function ItemStorage_ProcessInput(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_ReturnToMenuSelect(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_ExitItemList(taskId: any): any {
  let data: any = gTasks[taskId].data;
      ItemStorage_EraseItemIcon();
...
export function ItemStorage_StartItemSwap(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_ProcessItemSwapInput(taskId: any): any {
  let data: any = null;
      let id: any = null;
...
export function ItemStorage_PrintItemQuantity(windowId: any, value: any, mode: any, x: any, y: any, n: any): any {
...
export function ItemStorage_DoItemAction(taskId: any): any {
  let data: any = gTasks[taskId].data;
      let pos: any = gPlayerPCItemPageInfo.cursorPos + gPlayerPCItemPageInfo.itemsAbove;
      ItemStorage_RemoveScrollIndicator();
      tQuantity = 1;
...
export function ItemStorage_HandleQuantityRolling(taskId: any): any {
  let data: any = gTasks[taskId].data;
      let pos: any = gPlayerPCItemPageInfo.cursorPos + gPlayerPCItemPageInfo.itemsAbove;
...
export function ItemStorage_DoItemWithdraw(taskId: any): any {
  let data: any = gTasks[taskId].data;
      let pos: any = gPlayerPCItemPageInfo.cursorPos + gPlayerPCItemPageInfo.itemsAbove;
...
export function ItemStorage_DoItemToss(taskId: any): any {
  let data: any = gTasks[taskId].data;
      let pos: any = gPlayerPCItemPageInfo.cursorPos + gPlayerPCItemPageInfo.itemsAbove;
...
export function ItemStorage_HandleRemoveItem(taskId: any): any {
  let data: any = gTasks[taskId].data;
...
export function ItemStorage_HandleErrorMessageInput(taskId: any): any {
  let data: any = gTasks[taskId].data;
      if (JOY_NEW(A_BUTTON | B_BUTTON))
      {
          ItemStorage_PrintMessage(ItemStorage_GetMessage(gSaveBlock1Ptr.pcItems[gPlayerPCItemPageInfo.itemsAbove + gPlayerPCItemPageInfo.cursorPos].itemId));
...
export function ItemStorage_ReturnToListInput(taskId: any): any {
  ItemStorage_AddScrollIndicator();
      gTasks[taskId].func = ItemStorage_ProcessInput;
}
