...
const {
  ...
  Rfu_GetLinkPlayerCount, Rfu_GetMultiplayerId, Rfu_InitBlockSend, Rfu_IsMaster,
  Rfu_ResetBlockReceivedFlag, Rfu_SendBlockRequest, Rfu_SetBerryBlenderLinkCallback, Rfu_SetBlockReceivedFlag,
