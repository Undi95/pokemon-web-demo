...
const {
  ...
  AreAnyLinkPlayersUsingVersions, BGCNT_CHARBASE, BGCNT_PRIORITY, BGCNT_SCREENBASE,
  BG_CHAR_ADDR, BG_PLTT_ID, BG_SCREEN_ADDR, BeginNormalPaletteFade,
  BuildOamBuffer, BuildSendCmd, CheckMasterOrSlave, ClearGpuRegBits,
  ClearLinkRfuCallback, CloseLink, ConvertInternationalString, ConvertLinkPlayerName,
  ...
  DequeueRecvCmds, DestroyTask, DisableInterrupts, DisableSerial,
  DmaCopy16, DoHandshake, DoRecv, DoSend,
  DoSoftReset, EXTRACT_CONN_ESTABLISHED, EXTRACT_LINK_ERRORS, EXTRACT_MASTER,
  EXTRACT_PLAYER_COUNT, EnableInterrupts, EnableSerial, EnqueueSendCmd,
  ErrorMsg_CheckConnections, ErrorMsg_MoveCloserToPartner, FillWindowPixelBuffer, FlagGet,
  FreeAllSpritePalettes, GetBlockReceivedStatus, GetGameProgressForLinkTrade, GetLinkPlayerCount,
  GetLinkPlayerCount_2, GetLinkRecvQueueLength, GetMultiplayerId, GetRfuRecvQueueLength,
  GetSioMultiSI, HandleReceiveRemoteLinkPlayer, HasLinkErrorOccurred, InitBgsFromTemplates,
  InitBlockSend, InitHeap, InitLink, InitLocalLinkPlayer,
  InitRFUAPI, InitTimer, InitWindows, IsLinkConnectionEstablished,
  IsLinkRfuTaskFinished, IsNationalPokedexEnabled, IsRfuRecvQueueEmpty, IsSendingKeysOverCable,
  IsSendingKeysToRfu, IsSioMultiMaster, JOY_HELD, JOY_NEW,
  LinkMain1, LinkMain2, LinkRfu_Shutdown, LinkTestCalcBlockChecksum,
  LinkTestProcessKeyInput, LinkTest_PrintChar, LinkTest_PrintHex, LinkTest_PrintNumChar,
  LinkTest_PrintString, LoadBgTiles, LoadOam, LoadPalette,
  OpenLink, PIXEL_FILL, PlaySE, ProcessRecvCmds,
  ProcessSpriteCopyRequests, PutWindowTilemap, REG_TMCNT_H, ReloadSave,
  ResetBgsAndClearDma3BusyFlags, ResetBlockReceivedFlag, ResetBlockReceivedFlags, ResetBlockSend,
  ResetLinkRfuGFLayer, ResetPaletteFadeControl, ResetSerial, ResetSpriteData,
  ...
  RunTasks, ScanlineEffect_Stop, SendBlock, SendRecvDone,
  SetBackdropFromColor, SetBerryBlenderLinkCallback, SetBgTilemapBuffer, SetBlockReceivedFlag,
  SetCloseLinkCallback, SetGpuReg, SetLinkDebugValues, SetMainCallback2,
  SetSuppressLinkErrorMessage, SetVBlankCallback, SetWirelessCommType0_Internal, SetWirelessCommType1,
  ShowBg, StartSendingKeysToRfu, StartTransfer, StopMapMusic,
  StopTimer, StringCompare, StringCopy, TestBlockTransfer,
  TransferPlttBuffer, TrySavingData, TrySetLinkErrorBuffer, UpdatePaletteFade,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
