...
const {
  ...
  REG_OFFSET_DISPCNT, REG_TMCNT_H, ReloadSave, ResetBgsAndClearDma3BusyFlags,
  ResetLinkRfuGFLayer, ResetPaletteFadeControl, ResetSpriteData, ResetTasks,
  ResetTempTileDataBuffers, RestoreSerialTimer3IntrHandlers, RfuMain1, RfuMain2,
  Rfu_GetBlockReceivedStatus, Rfu_GetLinkPlayerCount, Rfu_GetMultiplayerId, Rfu_InitBlockSend,
  Rfu_IsMaster, Rfu_ResetBlockReceivedFlag, Rfu_SendBlockRequest, Rfu_SetBerryBlenderLinkCallback,
  Rfu_SetBlockReceivedFlag, Rfu_SetCloseLinkCallback, Rfu_SetLinkStandbyCallback, RunTasks,
  ScanlineEffect_Stop, SetBackdropFromColor, SetBgTilemapBuffer, SetGpuReg,
  SetMainCallback2, SetVBlankCallback, ShowBg, StartSendingKeysToRfu,
  StopMapMusic, StringCompare, StringCopy, TRUE,
  TransferPlttBuffer, TrySavingData, UpdatePaletteFade, memcpy,
