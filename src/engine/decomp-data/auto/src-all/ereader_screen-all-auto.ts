...
export function EReader_Load(...args: any[]): any {
...
export function EReader_Reset(...args: any[]): any {
  volatile u16 backupIME = REG_IME;
      REG_IME = 0;
      EReaderHelper_ClearSendRecvMgr();
...
export function EReader_Transfer(...args: any[]): any {
...
export function TryReceiveCard(...args: any[]): any {
...
export function CreateEReaderTask(): any {
  let data: any = null;
      let taskId = CreateTask(Task_EReader, 0);
...
export function ResetTimer(...args: any[]): any {
  *timer = 0;
}

/** static bool32 UpdateTimer(u16 *timer, u16 time) */
export function UpdateTimer(...args: any[]): any {
  if (++(*timer) > time)
      {
...
export function Task_EReader(...args: any[]): any {
