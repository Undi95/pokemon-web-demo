...
export function ScriptMovement_StartObjectMovementScript(...args: any[]): any {
...
export function ScriptMovement_IsObjectMovementFinished(...args: any[]): any {
  let objEventId: any = null;
      let taskId: any = null;
...
export function ScriptMovement_StartMoveObjects(...args: any[]): any {
  let taskId: any = null;
      let i: any = null;
...
export function ScriptMovement_TryAddNewMovement(...args: any[]): any {
  let moveScrId: any = null;
...
export function GetMovementScriptIdFromObjectEventId(...args: any[]): any {
...
export function LoadObjectEventIdPtrFromMovementScript(...args: any[]): any {
  let i: any = null;
...
export function SetObjectEventIdAtMovementScript(...args: any[]): any {
  let ptr: any = null;
...
export function LoadObjectEventIdFromMovementScript(...args: any[]): any {
  let ptr: any = null;
...
export function ClearMovementScriptFinished(...args: any[]): any {
  let mask = ~gBitTable[moveScrId];

      gTasks[taskId].data[0] &= mask;
}

/** static void SetMovementScriptFinished(u8 taskId, u8 moveScrId) */
export function SetMovementScriptFinished(...args: any[]): any {
  gTasks[taskId].data[0] |= gBitTable[moveScrId];
}

/** static bool8 IsMovementScriptFinished(u8 taskId, u8 moveScrId) */
export function IsMovementScriptFinished(...args: any[]): any {
  let moveScriptFinished = gTasks[taskId].data[0] & gBitTable[moveScrId];
...
export function SetMovementScript(...args: any[]): any {
...
export function ScriptMovement_AddNewMovement(...args: any[]): any {
...
export function ScriptMovement_UnfreezeActiveObjects(...args: any[]): any {
...
export function ScriptMovement_MoveObjects(...args: any[]): any {
  let i: any = null;
      let objEventId: any = null;
...
export function ScriptMovement_TakeStep(...args: any[]): any {
