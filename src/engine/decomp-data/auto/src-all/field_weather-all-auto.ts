...
export function StartWeather(): any {
  if (!FuncIsActiveTask(Task_WeatherMain))
      {
          let index: any = AllocSpritePalette(PALTAG_WEATHER);
...
export function SetCurrentAndNextWeather(weather: any): any {
  PlayRainStoppingSoundEffect();
...
export function SetCurrentAndNextWeatherNoDelay(weather: any): any {
  PlayRainStoppingSoundEffect();
      gWeatherPtr.currWeather = weather;
      gWeatherPtr.nextWeather = weather;
...
export function Task_WeatherInit(taskId: any): any {
...
export function Task_WeatherMain(taskId: any): any {
...
export function ApplyColorMap(startPalIndex: any, numPalettes: any, colorMapIndex: any): any {
          ...
          while (curPalIndex < numPalettes)
          {
              ...
              else
              {
                  ...
                  for (i = 0; i < 16; i++)
                  {
                      ...
                      let baseColor: any = gPlttBufferUnfaded[palOffset];
...
export function ApplyColorMapWithBlend(startPalIndex: any, numPalettes: any, colorMapIndex: any, blendCoeff: any, blendColor: any): any {
  let palOffset: any = null;
      let curPalIndex: any = null;
      let i: any = null;
      let color: any = blendColor;
      let rBlend: any = color.r;
      let gBlend: any = color.g;
      let bBlend: any = color.b;
      ...
      while (curPalIndex < numPalettes)
      {
          ...
          else
          {
              ...
              {
                  let baseColor: any = gPlttBufferUnfaded[palOffset];
                  let r: any = colorMap[baseColor.r];
                  let g: any = colorMap[baseColor.g];
                  let b: any = colorMap[baseColor.b];
...
export function ApplyDroughtColorMapWithBlend(colorMapIndex: any, blendCoeff: any, blendColor: any): any {
  let color: any = null;
      let rBlend: any = null;
      let gBlend: any = null;
      let bBlend: any = null;
...
export function ApplyFogBlend(blendCoeff: any, blendColor: any): any {
  let color: any = null;
      let rBlend: any = null;
      let gBlend: any = null;
      let bBlend: any = null;
      ...
      for (curPalIndex = 16; curPalIndex < 32; curPalIndex++)
      {
          ...
          {
              let palEnd: any = PLTT_ID(curPalIndex + 1);
              let palOffset: any = PLTT_ID(curPalIndex);

              while (palOffset < palEnd)
              {
                  let color: any = gPlttBufferUnfaded[palOffset];
                  let r: any = color.r;
                  let g: any = color.g;
                  let b: any = color.b;
...
export function MarkFogSpritePalToLighten(paletteIndex: any): any {
...
export function LightenSpritePaletteInFog(paletteIndex: any): any {
  let i: any = null;
...
export function FadeScreen(mode: any, delay: any): any {
...
export function UpdateSpritePaletteWithWeather(spritePaletteIndex: any): any {
  let paletteIndex: any = 16 + spritePaletteIndex;
      let i: any = null;
...
export function ApplyWeatherColorMapToPal(paletteIndex: any): any {
  ApplyColorMap(paletteIndex, 1, gWeatherPtr.colorMapIndex);
}

/** void LoadCustomWeatherSpritePalette(const u16 *palette) */
export function LoadCustomWeatherSpritePalette(palette: any): any {
...
export function SetDroughtColorMap(colorMapIndex: any): any {
...
export function Weather_SetBlendCoeffs(eva: any, evb: any): any {
...
export function Weather_SetTargetBlendCoeffs(eva: any, evb: any, delay: any): any {
  gWeatherPtr.targetBlendEVA = eva;
      gWeatherPtr.targetBlendEVB = evb;
...
export function PreservePaletteInWeather(preservedPalIndex: any): any {
