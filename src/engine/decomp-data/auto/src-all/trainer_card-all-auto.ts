...
const {
  ...
  AnimateSprites, BG_PLTT_ID, BLDCNT_EFFECT_DARKEN, BeginNormalPaletteFade,
  BlendPalettes, BuildOamBuffer, ChangeBgX, ChangeBgY,
  ConvertIntToDecimalStringN, ConvertInternationalString, CopyBgTilemapBufferToVram, CopyEasyChatWord,
  CopyWindowToVram, CountPlayerMuseumPaintings, CpuSet, CreateTask,
  CreateTrainerCardTrainerPicSprite, CreateWirelessStatusIndicatorSprite, DISPCNT_OBJ_1D_MAP, DISPCNT_OBJ_ON,
  DISPCNT_WIN0_ON, DISPLAY_HEIGHT, DeactivateAllTextPrinters, DestroyTask,
  DmaClear16, DmaClear32, DmaCopy16, DrawDialogueFrame,
  EnableInterrupts, FALSE, FREE_AND_SET_NULL, FacilityClassToPicIndex,
  ...
  GetGameStat, GetHoennPokedexCount, GetMonIconPaletteIndexFromSpecies, GetMonIconTiles,
  GetMoney, GetNationalPokedexCount, GetStringCenterAlignXOffset, GetStringRightAlignXOffset,
  GetStringWidth, HasAllHoennMons, HideBg, InUnionRoom,
  InitBgsFromTemplates, InitWindows, IsDma3ManagerBusyWithBgCopy, IsNationalPokedexEnabled,
  IsSEPlaying, JOY_NEW, LZ77UnCompWram, LoadBgTiles,
  LoadMessageBoxAndBorderGfx, LoadOam, LoadPalette, LoadWirelessStatusIndicatorSpriteGfx,
  NULL, Overworld_IsRecvQueueAtMax, PALETTES_ALL, PIXEL_FILL,
  PLTT_SIZE, PLTT_SIZE_4BPP, PlaySE, ProcessSpriteCopyRequests,
  PutWindowTilemap, REG_OFFSET_BG0CNT, REG_OFFSET_BG1CNT, REG_OFFSET_BG2CNT,
  REG_OFFSET_BG3CNT, REG_OFFSET_BLDCNT, REG_OFFSET_BLDY, REG_OFFSET_WIN0H,
  ...
  STR_CONV_MODE_LEADING_ZEROS, STR_CONV_MODE_LEFT_ALIGN, STR_CONV_MODE_RIGHT_ALIGN, ScanlineEffect_Clear,
  ScanlineEffect_Stop, SetBgTilemapBuffer, SetCloseLinkCallback, SetGpuReg,
