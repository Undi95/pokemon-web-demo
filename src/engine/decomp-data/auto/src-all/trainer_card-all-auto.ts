...
export function CloseTrainerCard(...args: any[]): any {
...
export function Task_TrainerCard(...args: any[]): any {
...
export function GetCappedGameStat(...args: any[]): any {
  let statValue = GetGameStat(statId);
...
export function GetRubyTrainerStars(...args: any[]): any {
  let stars = 0;
...
export function SetPlayerCardData(...args: any[]): any {
...
export function TrainerCard_GenerateCardForPlayer(...args: any[]): any {
...
export function TrainerCard_GenerateCardForLinkPlayer(...args: any[]): any {
...
export function CopyTrainerCardData(...args: any[]): any {
...
export function UpdateCardFlipRegs(...args: any[]): any {
  let blendY = (cardTop + 40) / 10;
...
export function PrintStatOnBackOfCard(...args: any[]): any {
  ...
  let i: any = null;
      ...
      if (sData.cardType == CARD_TYPE_FRLG)
      {
          for (i = 0; i < PARTY_SIZE; i++)
          {
              ...
              {
                  let monSpecies = GetMonIconPaletteIndexFromSpecies(sData.trainerCard.monSpecies[i]);
...
export function PrintStickersOnCard(): any {
  let i: any = null;
      ...
      if (sData.cardType == CARD_TYPE_FRLG && sData.trainerCard.shouldDrawStickers == TRUE)
      {
          ...
          {
              let sticker = sData.trainerCard.stickers[i];
...
export function DrawTrainerCardWindow(...args: any[]): any {
...
export function DrawCardScreenBackground(...args: any[]): any {
  let i, j;
      let dst = sData.bgTilemapBuffer;
...
export function DrawCardFrontOrBack(...args: any[]): any {
  let i, j;
      let dst = sData.cardTilemapBuffer;
...
export function GetTrainerCardStars(...args: any[]): any {
...
export function FlipTrainerCard(): any {
  let taskId = CreateTask(Task_DoCardFlipTask, 0);
...
export function Task_AnimateCardFlipDown(...args: any[]): any {
  let cardHeight, r5, r10, cardTop, r6, var_24, cardBottom, var;
      let i: any = null;
...
export function Task_DrawFlippedCardSide(...args: any[]): any {
  sData.allowDMACopy = FALSE;
...
export function Task_SetCardFlipped(...args: any[]): any {
  sData.allowDMACopy = FALSE;
...
export function Task_AnimateCardFlipUp(...args: any[]): any {
  let cardHeight, r5, r10, cardTop, r6, var_24, cardBottom, var;
      let i: any = null;
...
export function Task_EndCardFlip(...args: any[]): any {
  ShowBg(1);
      ShowBg(3);
      SetHBlankCallback(NULL);
...
export function ShowPlayerTrainerCard(...args: any[]): any {
...
export function ShowTrainerCardInLink(...args: any[]): any {
  sData = AllocZeroed(sizeof(*sData));
      sData.callback2 = callback;
      sData.isLink = TRUE;
...
export function VersionToCardType(...args: any[]): any {
