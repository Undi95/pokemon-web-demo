...
export function ScriptMenu_Multichoice(...args: any[]): any {
...
export function ScriptMenu_MultichoiceWithDefault(...args: any[]): any {
  if (FuncIsActiveTask(Task_HandleMultichoiceInput) == TRUE)
      {
          return FALSE;
      }
...
export function DrawMultichoiceMenu(...args: any[]): any {
  let i: any = null;
      let windowId: any = null;
      let count = sMultichoiceLists[multichoiceId].count;
...
export function InitMultichoiceCheckWrap(...args: any[]): any {
  let i: any = null;
      let taskId: any = null;
...
export function Task_HandleMultichoiceInput(...args: any[]): any {
...
export function ScriptMenu_YesNo(...args: any[]): any {
  let taskId: any = null;
...
export function Task_HandleYesNoInput(...args: any[]): any {
...
export function ScriptMenu_MultichoiceGrid(...args: any[]): any {
...
export function Task_HandleMultichoiceGridInput(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function CreateLilycoveSSTidalMultichoice(): any {
  let selectionCount = 0;
      ...
      else
      {
          ...
          {
              let selection = sLilycoveSSTidalSelections[j];
              if (selection != 0xFF)
              {
...
export function Task_PokemonPicWindow(...args: any[]): any {
...
export function ScriptMenu_ShowPokemonPic(...args: any[]): any {
  let taskId: any = null;
...
export function CreateWindowFromRect(...args: any[]): any {
...
export function ClearToTransparentAndRemoveWindow(...args: any[]): any {
  ClearStdWindowAndFrameToTransparent(windowId, TRUE);
      RemoveWindow(windowId);
}

/** static void DrawLinkServicesMultichoiceMenu(u8 multichoiceId) */
export function DrawLinkServicesMultichoiceMenu(...args: any[]): any {
...
export function CreateStartMenuForPokenavTutorial(): any {
  let windowId = CreateWindowFromRect(21, 0, 7, 18);
      SetStandardWindowBorderStyle(windowId, FALSE);
...
export function InitMultichoiceNoWrap(...args: any[]): any {
  let taskId: any = null;
      sProcessInputDelay = 2;
      taskId = CreateTask(Task_HandleMultichoiceInput, 80);
      gTasks[taskId].tIgnoreBPress = ignoreBPress;
...
export function DisplayTextAndGetWidthInternal(...args: any[]): any {
  const temp: any[] = [];
...
export function DisplayTextAndGetWidth(...args: any[]): any {
...
export function ConvertPixelWidthToTileWidth(...args: any[]): any {
  return (((width + 9) / 8) + 1) > MAX_MULTICHOICE_WIDTH ? MAX_MULTICHOICE_WIDTH : (((width + 9) / 8) + 1);
}

/** int ScriptMenu_AdjustLeftCoordFromWidth(int left, int width) */
export function ScriptMenu_AdjustLeftCoordFromWidth(...args: any[]): any {
