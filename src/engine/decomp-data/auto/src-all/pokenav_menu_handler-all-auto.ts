...
export function PokenavCallback_Init_MainMenuCursorOnMap(): any {
  let menu: any = AllocSubstruct(POKENAV_SUBSTRUCT_MAIN_MENU_HANDLER, sizeof(struct Pokenav_Menu));
      if (!menu)
          return FALSE;
...
export function SetMenuInputHandler(...args: any[]): any {
...
export function HandleMainMenuInputTutorial(...args: any[]): any {
  if (UpdateMenuCursorPos(menu))
          return POKENAV_MENU_FUNC_MOVE_CURSOR;
...
export function HandleMainMenuInputEndTutorial(...args: any[]): any {
  if (UpdateMenuCursorPos(menu))
          return POKENAV_MENU_FUNC_MOVE_CURSOR;
...
export function HandleCantOpenRibbonsInput(...args: any[]): any {
  if (UpdateMenuCursorPos(menu))
      {
          menu.callback = GetMainMenuInputHandler();
          return POKENAV_MENU_FUNC_MOVE_CURSOR;
...
export function HandleConditionSearchMenuInput(...args: any[]): any {
  if (UpdateMenuCursorPos(menu))
          return POKENAV_MENU_FUNC_MOVE_CURSOR;
...
export function ReturnToConditionMenu(...args: any[]): any {
  menu.menuType = POKENAV_MENU_TYPE_CONDITION;
      menu.cursorPos = 1;
...
export function UpdateMenuCursorPos(...args: any[]): any {
  if (JOY_NEW(DPAD_UP))
      {
          if (--menu.cursorPos < 0)
              menu.cursorPos = sLastCursorPositions[menu.menuType];
