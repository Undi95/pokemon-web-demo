...
const {
  ...
  GetMainMenuInputHandler, GetPokenavMainMenuType, GetSelectedConditionSearch, GetSubstructPtr,
  JOY_NEW, PlaySE, ReturnToConditionMenu, ReturnToMainMenu,
  SetMenuIdAndCB, SetMenuInputHandler, SetPokenavMode, SetSelectedConditionSearch,
  UpdateMenuCursorPos,  // 4-per-line for readability
} = _bridge;
// ─── END BRIDGE IMPORT ───
