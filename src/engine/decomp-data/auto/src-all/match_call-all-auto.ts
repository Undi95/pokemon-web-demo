...
export function GetCurrentTotalMinutes(...args: any[]): any {
...
export function GetActiveMatchCallTrainerId(...args: any[]): any {
  let i: any = null;
...
export function StartMatchCallFromScript(...args: any[]): any {
...
export function ExecuteMatchCall(...args: any[]): any {
...
export function MatchCall_LoadGfx(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_DrawWindow(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_ReadyIntro(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_SlideWindowIn(...args: any[]): any {
...
export function MatchCall_PrintIntro(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_PrintMessage(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_SlideWindowOut(...args: any[]): any {
  let data = gTasks[taskId].data;
...
export function MatchCall_EndCall(...args: any[]): any {
...
export function DrawMatchCallTextBoxBorder_Internal(...args: any[]): any {
...
export function InitMatchCallTextPrinter(...args: any[]): any {
...
export function RunMatchCallTextPrinter(...args: any[]): any {
...
export function Task_SpinPokenavIcon(...args: any[]): any {
  let data = gTasks[taskId].data;
      if (++tTimer > 8)
      {
          tTimer = 0;
...
export function TrainerIsEligibleForRematch(...args: any[]): any {
...
export function GetNthRematchTrainerFought(...args: any[]): any {
  let i, count;
...
export function SelectMatchCallMessage(...args: any[]): any {
  let matchCallId: any = null;
...
export function GetTrainerMatchCallId(...args: any[]): any {
  let i = 0;
      while (1)
      {
...
export function BuildMatchCallString(...args: any[]): any {
...
export function PopulateMatchCallStringVars(...args: any[]): any {
  let i: any = null;
...
export function PopulateMapName(...args: any[]): any {
...
export function PopulateSpeciesFromTrainerLocation(...args: any[]): any {
  const species: any[] = [];
...
export function PopulateSpeciesFromTrainerParty(...args: any[]): any {
...
export function PopulateBattleFrontierFacilityName(...args: any[]): any {
...
export function PopulateBattleFrontierStreak(...args: any[]): any {
  let i = 0;
...
export function ShouldTrainerRequestBattle(...args: any[]): any {
...
export function GetFrontierStreakInfo(...args: any[]): any {
  let i: any = null;
      let j: any = null;
      let streak = 0;
...
export function GetPokedexRatingLevel(...args: any[]): any {
  if (numSeen < 10)
          return 0;
      if (numSeen < 20)
          return 1;
...
export function BufferPokedexRatingForMatchCall(...args: any[]): any {
  let numSeen, numCaught;
      let str: any = null;
      let dexRatingLevel: any = null;

      let buffer = Alloc(sizeof(gStringVar4));
      if (!buffer)
      {
          destStr[0] = EOS;
          return;
...
export function LoadMatchCallWindowGfx(...args: any[]): any {
...
export function DrawMatchCallTextBoxBorder(...args: any[]): any {
