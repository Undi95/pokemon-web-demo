...
const {
  ...
  DrawStdFrameWithCustomTileAndPalette, FALSE, FillWindowPixelBuffer, Free,
  FreeSpritePaletteByTag, FreeSpriteTilesByTag, GET_NUM_CONDITION_SPARKLES, GetAndCopyBoxMonDataAt,
  GetBoxMonDataAt, GetBoxNamePtr, GetConditionMenuMonString, GetMaxWidthInMenuTable,
  GetMonData, GetMonSpritePalFromSpeciesAndPersonality, GetPlayerTextSpeedDelay, GetStringCenterAlignXOffset,
  GetStringRightAlignXOffset, GetStringWidth, InitWindows, IsTextPrinterActive,
  LZ77UnCompWram, ListMenuInit, LoadPalette, LoadSpecialPokePic,
  LoadUserWindowBorderGfx, MoveRelearnerDummy, MoveRelearnerShowHideHearts, NULL,
  PIXEL_FILL, PLTT_SIZE_4BPP, PlaySE, PutWindowTilemap,
