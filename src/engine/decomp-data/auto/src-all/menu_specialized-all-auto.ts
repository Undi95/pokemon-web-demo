...
export function MailboxMenu_Alloc(...args: any[]): any {
  let i: any = null;
...
export function MailboxMenu_AddWindow(...args: any[]): any {
  if (sMailboxWindowIds[windowIdx] == WINDOW_NONE)
      {
          ...
          {
              let template: any = sWindowTemplates_MailboxMenu[windowIdx];
              let width = GetStringWidth(FONT_NORMAL, gText_Mailbox, 0) + 9;
...
export function MailboxMenu_RemoveWindow(...args: any[]): any {
...
export function MailboxMenu_ItemPrintFunc(...args: any[]): any {
  const buffer: any[] = [];
      let length: any = null;
...
export function MailboxMenu_CreateList(...args: any[]): any {
  let i: any = null;
...
export function MailboxMenu_MoveCursorFunc(...args: any[]): any {
  if (onInit != TRUE)
          PlaySE(SE_SELECT);
}

/** void MailboxMenu_AddScrollArrows(struct PlayerPCItemPageStruct *page) */
export function MailboxMenu_AddScrollArrows(...args: any[]): any {
...
export function ConditionGraph_Init(...args: any[]): any {
  let i, j;
...
export function ConditionGraph_SetNewPositions(...args: any[]): any {
  let i, j;
      let coord, increment;
...
export function ConditionGraph_TryUpdate(...args: any[]): any {
...
export function ConditionGraph_InitResetScanline(...args: any[]): any {
  graph.scanlineResetState = 0;
}

/** bool8 ConditionGraph_ResetScanline(struct ConditionGraph *graph) */
export function ConditionGraph_ResetScanline(...args: any[]): any {
  let params: any = null;
...
export function ConditionGraph_Draw(...args: any[]): any {
  let i: any = null;
...
export function ConditionGraph_InitWindow(...args: any[]): any {
  let flags: any = null;
...
export function ConditionGraph_Update(...args: any[]): any {
  let i: any = null;
      for (i = 0; i < CONDITION_COUNT; i++)
...
export function ConditionGraph_CalcLine(...args: any[]): any {
...
export function ConditionGraph_CalcRightHalf(...args: any[]): any {
  let i, y, bottom;
...
export function ConditionGraph_CalcLeftHalf(...args: any[]): any {
  let i, y, bottom;
...
export function ConditionGraph_CalcPositions(...args: any[]): any {
...
export function InitMoveRelearnerWindows(...args: any[]): any {
  let i: any = null;
...
export function LoadMoveRelearnerMovesList(...args: any[]): any {
...
export function MoveRelearnerLoadBattleMoveDescription(...args: any[]): any {
  let x: any = null;
      let move: any = null;
      const buffer: any[] = [];
      let str: any = null;
...
export function MoveRelearnerMenuLoadContestMoveDescription(...args: any[]): any {
  let x: any = null;
      let str: any = null;
      let move: any = null;
...
export function MoveRelearnerCursorCallback(...args: any[]): any {
  if (onInit != TRUE)
          PlaySE(SE_SELECT);
...
export function MoveRelearnerPrintMessage(...args: any[]): any {
  let speed: any = null;
...
export function GetBoxOrPartyMonData(...args: any[]): any {
  let ret: any = null;
...
export function GetConditionMenuMonNameAndLocString(...args: any[]): any {
  let i: any = null;
      let box = boxId;
      let mon = monId;
...
export function GetConditionMenuMonConditions(...args: any[]): any {
  let i: any = null;
...
export function GetConditionMenuMonGfx(...args: any[]): any {
  if (!excludesCancel)
          numMons--;

      if (partyId != numMons)
      {
          let species = GetBoxOrPartyMonData(boxId, monId, MON_DATA_SPECIES_OR_EGG, NULL);
          let trainerId = GetBoxOrPartyMonData(boxId, monId, MON_DATA_OT_ID, NULL);
          let personality = GetBoxOrPartyMonData(boxId, monId, MON_DATA_PERSONALITY, NULL);
...
export function MoveConditionMonOnscreen(...args: any[]): any {
  *x += 24;
      if (*x > 0)
          *x = 0;
...
export function MoveConditionMonOffscreen(...args: any[]): any {
  *x -= 24;
      if (*x < -80)
          *x = -80;
...
export function ConditionMenu_UpdateMonEnter(...args: any[]): any {
  let graphUpdating = ConditionGraph_TryUpdate(graph);
      let monUpdating = MoveConditionMonOnscreen(x);

      return (graphUpdating || monUpdating);
}

/** bool8 ConditionMenu_UpdateMonExit(struct ConditionGraph *graph, s16 *x) */
export function ConditionMenu_UpdateMonExit(...args: any[]): any {
  let graphUpdating = ConditionGraph_TryUpdate(graph);
      let monUpdating = MoveConditionMonOffscreen(x);

      return (graphUpdating || monUpdating);
}

/** void LoadConditionMonPicTemplate(struct SpriteSheet *sheet, struct SpriteTemplate *template, struct SpritePalette *pal) */
export function LoadConditionMonPicTemplate(...args: any[]): any {
...
export function LoadConditionSelectionIcons(...args: any[]): any {
  let i: any = null;
...
export function LoadConditionSparkle(...args: any[]): any {
...
export function SpriteCB_ConditionSparkle_DoNextAfterDelay(...args: any[]): any {
...
export function SpriteCB_ConditionSparkle_WaitForAllAnim(...args: any[]): any {
  if (sprite.animEnded)
      {
          sprite.sDelayTimer = 0;
...
export function SetConditionSparklePosition(...args: any[]): any {
...
export function InitConditionSparkles(...args: any[]): any {
  let i: any = null;
...
export function SetNextConditionSparkle(...args: any[]): any {
  let i: any = null;
      let id = sprite.sNextSparkleSpriteId;
...
export function ResetConditionSparkleSprites(...args: any[]): any {
  let i: any = null;
...
export function CreateConditionSparkleSprites(...args: any[]): any {
...
export function DestroyConditionSparkleSprites(...args: any[]): any {
  let i: any = null;
...
export function FreeConditionSparkles(...args: any[]): any {
...
export function SpriteCB_ConditionSparkle(...args: any[]): any {
...
export function ShowAllConditionSparkles(...args: any[]): any {
...
export function DrawLevelUpWindowPg1(...args: any[]): any {
  let i, x;
      const statsDiff: any[] = [];
      const text: any[] = [];
      const color: any[] = [];
...
export function DrawLevelUpWindowPg2(...args: any[]): any {
  let i, numDigits, x;
      const stats: any[] = [];
      const text: any[] = [];
      const color: any[] = [];
...
export function GetMonLevelUpWindowStats(...args: any[]): any {
