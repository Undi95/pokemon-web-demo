...
export function AnimTask_CreateRaindrops(...args: any[]): any {
  let x, y;
...
export function AnimRainDrop(...args: any[]): any {
  sprite.callback = AnimRainDrop_Step;
}

/** static void AnimRainDrop_Step(struct Sprite *sprite) */
export function AnimRainDrop_Step(...args: any[]): any {
  if (++sprite.data[0] <= 13)
      {
...
export function AnimWaterBubbleProjectile(...args: any[]): any {
...
export function AnimWaterBubbleProjectile_Step1(...args: any[]): any {
  let otherSpriteId = sprite.data[5];
      let timer = gSprites[otherSpriteId].data[4];
      let trigIndex = gSprites[otherSpriteId].data[3];
...
export function AnimWaterBubbleProjectile_Step2(...args: any[]): any {
...
export function AnimWaterBubbleProjectile_Step3(...args: any[]): any {
  sprite.data[0] = 10;
...
export function AnimAuroraBeamRings(...args: any[]): any {
  let unkArg: any = null;
...
export function AnimAuroraBeamRings_Step(...args: any[]): any {
...
export function AnimTask_RotateAuroraRingColors(...args: any[]): any {
...
export function AnimTask_RotateAuroraRingColors_Step(...args: any[]): any {
  let i: any = null;
...
export function AnimToTargetInSinWave(...args: any[]): any {
  let retArg: any = null;
...
export function AnimToTargetInSinWave_Step(...args: any[]): any {
  if (AnimTranslateLinear(sprite))
          DestroyAnimSprite(sprite);
...
export function AnimTask_StartSinAnimTimer(...args: any[]): any {
  gTasks[taskId].data[0] = gBattleAnimArgs[0];
      gBattleAnimArgs[7] = 0;
...
export function AnimTask_RunSinAnimTimer(...args: any[]): any {
...
export function AnimHydroCannonCharge(...args: any[]): any {
...
export function AnimHydroCannonCharge_Step(...args: any[]): any {
  if (sprite.affineAnimEnded)
          DestroyAnimSprite(sprite);
}

/** static void AnimHydroCannonBeam(struct Sprite *sprite) */
export function AnimHydroCannonBeam(...args: any[]): any {
...
export function AnimWaterGunDroplet(...args: any[]): any {
...
export function AnimSmallBubblePair(...args: any[]): any {
...
export function AnimSmallBubblePair_Step(...args: any[]): any {
...
export function AnimTask_CreateSurfWave(...args: any[]): any {
  CMD_ARGS(palette);
...
export function AnimTask_CreateSurfWave_Step1(...args: any[]): any {
  let animBg: any = null;
      let i: any = null;
      let rgbBuffer: any = null;
      let BGptrX = gBattle_BG1_X;
      let BGptrY = gBattle_BG1_Y;
...
export function AnimTask_CreateSurfWave_Step2(...args: any[]): any {
  let BGptrX = gBattle_BG1_X;
      let BGptrY = gBattle_BG1_Y;
      if (gTasks[taskId].data[0] == 0)
      {
...
export function AnimTask_SurfWaveScanlineEffect(...args: any[]): any {
  let i: any = null;
      let params: any = null;
...
export function AnimSmallDriftingBubbles(...args: any[]): any {
...
export function AnimSmallDriftingBubbles_Step(...args: any[]): any {
...
export function AnimTask_WaterSpoutLaunch(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_WaterSpoutLaunch_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateWaterSpoutLaunchDroplets(...args: any[]): any {
  let i: any = null;
      let attackerCoordX = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      let attackerCoordY = GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET);
      let trigIndex = 172;
      let subpriority = GetBattlerSpriteSubpriority(gBattleAnimAttacker) - 1;
...
export function AnimSmallWaterOrb(...args: any[]): any {
...
export function AnimTask_WaterSpoutRain(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_WaterSpoutRain_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
      let taskId2: any = null;
...
export function CreateWaterSpoutRainDroplet(...args: any[]): any {
  let yPosArg = ((gSineTable[task.data[8]] + 3) >> 4) + task.data[6];
      let spriteId = CreateSprite(gSmallWaterOrbSpriteTemplate, task.data[7], 0, 0);
...
export function AnimWaterSpoutRain(...args: any[]): any {
  if (sprite.data[0] == 0)
      {
          sprite.y += 8;
...
export function AnimWaterSpoutRainHit(...args: any[]): any {
  if (++sprite.data[1] > 1)
      {
          sprite.data[1] = 0;
          sprite.invisible ^= 1;
...
export function AnimTask_WaterSport(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function AnimTask_WaterSport_Step(...args: any[]): any {
  let task: any = gTasks[taskId];
...
export function CreateWaterSportDroplet(...args: any[]): any {
  let spriteId: any = null;
...
export function AnimWaterSportDroplet(...args: any[]): any {
...
export function AnimWaterSportDroplet_Step(...args: any[]): any {
  let i: any = null;
...
export function AnimWaterPulseBubble(...args: any[]): any {
...
export function AnimWaterPulseBubble_Step(...args: any[]): any {
...
export function AnimWaterPulseRingBubble(...args: any[]): any {
  sprite.data[3] += sprite.data[1];
      sprite.data[4] += sprite.data[2];
...
export function AnimWaterPulseRing(...args: any[]): any {
  InitSpritePosToAnimAttacker(sprite, TRUE);
...
export function AnimWaterPulseRing_Step(...args: any[]): any {
  let xDiff = sprite.data[1] - sprite.x;
      let yDiff = sprite.data[2] - sprite.y;
...
export function CreateWaterPulseRingBubbles(...args: any[]): any {
