...
export function PokenavCallback_Init_MatchCall(): any {
  let state: any = AllocSubstruct(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN, sizeof(struct Pokenav_MatchCallMenu));
      if (!state)
          return FALSE;
...
export function CB2_HandleMatchCallInput(...args: any[]): any {
...
export function GetExitMatchCallMenuId(...args: any[]): any {
...
export function CB2_HandleMatchCallOptionsInput(...args: any[]): any {
...
export function CB2_HandleCheckPageInput(...args: any[]): any {
  if (JOY_REPEAT(DPAD_UP))
...
export function CB2_HandleCallExitInput(...args: any[]): any {
...
export function LoopedTask_BuildMatchCallList(...args: any[]): any {
  let i, j;
      let state: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
      switch (taskState)
      {
...
export function IsRematchEntryRegistered(...args: any[]): any {
...
export function ShouldDrawRematchPokeballIcon(...args: any[]): any {
  let state: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
...
export function GetMatchCallTrainerPic(...args: any[]): any {
...
export function GetMatchCallOptionId(...args: any[]): any {
  let state: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
...
export function BufferMatchCallNameAndDesc(...args: any[]): any {
  let trainerName: any = null;
      ...
      if (!matchCallEntry.isSpecialTrainer)
      {
          ...
          let class = trainer.trainerClass;
...
export function GetIndexDeltaOfNextCheckPageDown(...args: any[]): any {
  let state: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
      let count = 1;
...
export function GetIndexDeltaOfNextCheckPageUp(...args: any[]): any {
  let state: any = GetSubstructPtr(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
      let count = -1;
      while (--index >= 0)
      {
