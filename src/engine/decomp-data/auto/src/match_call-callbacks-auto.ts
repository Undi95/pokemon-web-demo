...
// Source : src/match_call.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: match_call.c → Task_SpinPokenavIcon */
export const Task_SpinPokenavIcon: TaskCallback = (task, rt) => {
  ...
  const data = task.data;
      if (++data[0] > 8)
      {
          ...
          data[2] = (data[1] * 16) + TILE_POKENAV_ICON;
          WriteSequenceToBgTilemapBuffer(0, data[2] | ~0xFFF, 1, 15, 4, 4, 17, 1);
