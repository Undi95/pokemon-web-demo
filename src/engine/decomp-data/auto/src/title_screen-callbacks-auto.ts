...
const REG_OFFSET_BG2X_H = 42;
const REG_OFFSET_BG2X_L = 40;
const REG_OFFSET_BG2Y_H = 46;
const REG_OFFSET_BG2Y_L = 44;
...
const WININ_WIN1_BG_ALL = 3840;
const WININ_WIN1_OBJ = 4096;
const WINOUT_WIN01_BG_ALL = 15;
const WINOUT_WIN01_OBJ = 16;
const WINOUT_WINOBJ_ALL = 16128;
  ...
  if ((JOY_NEW(A_BUTTON)) || (JOY_NEW(START_BUTTON)))
      {
          ...
          /* TODO scene transition: SetMainCallback2(CB2_GoToMainMenu) */;
      }
...
export const CB2_GoToMainMenu: CB2Callback = (rt) => {
  if (!UpdatePaletteFade())
          /* TODO scene transition: SetMainCallback2(CB2_InitMainMenu) */;
};
