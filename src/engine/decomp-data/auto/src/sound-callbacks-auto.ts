...
// Source : src/sound.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: sound.c → Task_Fanfare */
export const Task_Fanfare: TaskCallback = (task, rt) => {
...
/** Source: sound.c → Task_DuckBGMForPokemonCry */
export const Task_DuckBGMForPokemonCry: TaskCallback = (task, rt) => {
  const taskId = task.taskId;
