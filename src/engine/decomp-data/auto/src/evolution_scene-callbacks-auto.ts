...
export const Task_EvolutionScene: TaskCallback = (task, rt) => {
  ...
  let _var = 0;
      ...
      case EVOSTATE_RESTORE_SCREEN:  
          ...
          {
              m4aMPlayAllStop();
              memcpy(rt.gPlttBufferUnfaded.get(BG_PLTT_ID(2)), sEvoStructPtr.savedPalette, /* sizeof(sEvoStructPtr.savedPalette) */ 0);
              RestoreBgAfterAnim();
...
export const Task_AnimateBg: TaskCallback = (task, rt) => {
  ...
  u16 *outer_X, outer_Y;
      ...
      let inner_X = gBattle_BG1_X;
      let inner_Y = gBattle_BG1_Y;
