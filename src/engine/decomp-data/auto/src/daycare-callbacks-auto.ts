...
// Source : src/daycare.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: daycare.c → Task_HandleDaycareLevelMenuInput */
export const Task_HandleDaycareLevelMenuInput: TaskCallback = (task, rt) => {
  const taskId = task.taskId;
  let input = ListMenu_ProcessInput(task.data[0]);
