...
// Source : src/battle_controller_recorded_player.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_controller_recorded_player.c → Task_StartSendOutAnim */
