...
const SE_M_POISON_POWDER = 169;
const SE_M_ROCK_THROW = 131;
const SE_M_SCRATCH = 155;
const SE_NOTE_A = 67;
const SE_NOTE_B = 68;
const SE_NOTE_C = 62;
const SE_NOTE_C_HIGH = 69;
const SE_NOTE_D = 63;
const SE_NOTE_E = 64;
const SE_NOTE_F = 65;
const SE_NOTE_G = 66;
...
export const Task_ComputerScreenOpenEffect: TaskCallback = (task, rt) => {
  ...
  /* task already param */
      ...
      {
      case 0:
  task.data[3] = Math.trunc(DISPLAY_WIDTH / 2);
  task.data[4] = Math.trunc(DISPLAY_WIDTH / 2);
  task.data[5] = Math.trunc(DISPLAY_HEIGHT / 2);task.data[6] = Math.trunc(DISPLAY_HEIGHT / 2) + 1;
