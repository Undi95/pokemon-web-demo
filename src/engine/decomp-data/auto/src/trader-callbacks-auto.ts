...
// Source : src/trader.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: trader.c → Task_HandleGetDecorationMenuInput */
export const Task_HandleGetDecorationMenuInput: TaskCallback = (task, rt) => {
