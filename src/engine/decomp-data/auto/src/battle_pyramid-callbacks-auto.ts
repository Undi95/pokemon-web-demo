...
// Source : src/battle_pyramid.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_pyramid.c → Task_SetPyramidFloorPalette */
export const Task_SetPyramidFloorPalette: TaskCallback = (task, rt) => {
  const taskId = task.taskId;
  if (rt.gPaletteFade.active)
      {
          rt.CpuCopy16((rt.getExtraPalette("gBattlePyramidFloor_Pal[gSaveBlock2Ptr.frontier.curChallengeBattleNum]") ?? new Uint16Array(0)), 0, ((6) * 16), Math.floor((PLTT_SIZE_4BPP) / 2));
