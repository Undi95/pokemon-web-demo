...
// Source : src/recorded_battle.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: recorded_battle.c → Task_StartAfterCountdown */
export const Task_StartAfterCountdown: TaskCallback = (task, rt) => {
...
/** Source: recorded_battle.c → CB2_RecordedBattleEnd */
export const CB2_RecordedBattleEnd: CB2Callback = (rt) => {
  gSaveBlock2Ptr.frontier.lvlMode = sLvlMode;
      ...
      /* TODO scene transition: SetMainCallback2(sCallback2_AfterRecordedBattle) */;
};

/** Source: recorded_battle.c → CB2_RecordedBattle */
export const CB2_RecordedBattle: CB2Callback = (rt) => {
  AnimateSprites();
      BuildOamBuffer();
      RunTasks();
};
