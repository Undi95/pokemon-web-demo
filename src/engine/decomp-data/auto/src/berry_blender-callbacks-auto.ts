...
export const SpriteCB_CountdownNumber: SpriteCallback = (sprite, rt) => {
  switch (sprite.data[0])
      ...
      case 0:
          ...
          {
              sprite.data[1] = DISPLAY_HEIGHT / 2 + 8;
              sprite.data[0]++;
              /* TODO sound PlaySE */;
          }
          break;
...
export const CB2_StartBlenderLink: CB2Callback = (rt) => {
  let i, j;
      ...
      case 8:
          ...
          memcpy(gBlockSendBuffer, sBerryBlender.blendedBerries[0], /* ((struct)?.length ?? 32) */ 0);
      ...
      case 10:
          if (++sBerryBlender.framesToWait > 20)
          {
              ...
              if (GetBlockReceivedStatus() == GetLinkPlayerCountAsBitFlags())
              {
                  ...
                  {
                      memcpy(sBerryBlender.blendedBerries[i], gBlockRecvBuffer[i][0], /* ((struct)?.length ?? 32) */ 0);
      ...
      case 3:
          ...
          else if (IsLinkTaskFinished())
          {
              if (gReceivedRemoteLinkPlayers && gWirelessCommType)
              {
                  ...
                  if (SendBlock(0, sBerryBlender.gameBlock, /* sizeof(sBerryBlender.gameBlock) */ 0))
                      sBerryBlender.gameEndState++;
              }
              else
              {
                  ...
                  if (SendBlock(0, sBerryBlender.smallBlock, /* sizeof(sBerryBlender.smallBlock) */ 0 + 32))
                      sBerryBlender.gameEndState++;
              }
          }
          break;
