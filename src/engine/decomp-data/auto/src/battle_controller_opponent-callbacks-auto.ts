...
// Source : src/battle_controller_opponent.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: battle_controller_opponent.c → SpriteCB_FreeOpponentSprite */
...
/** Source: battle_controller_opponent.c → Task_StartSendOutAnim */
