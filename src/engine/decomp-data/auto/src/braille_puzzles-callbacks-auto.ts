...
// Source : src/braille_puzzles.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: braille_puzzles.c → Task_SealedChamberShakingEffect */
export const Task_SealedChamberShakingEffect: TaskCallback = (task, rt) => {
