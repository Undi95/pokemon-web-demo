...
export const Task_LinkContest_CommunicateMonsEm: TaskCallback = (task, rt) => {
  ...
  let i = 0;
      ...
      case 0:
          ...
          {
              if (LinkContest_SendBlock(gContestMons[gContestPlayerMonIndex], /* ((struct)?.length ?? 32) */ 0) == 1)
                  task.data[0]++;
          }
          break;
      case 1:
  ...
  let i = 0;
      ...
      case 0:
          if (GetMultiplayerId() == 0)
          {
              ...
              if (LinkContest_SendBlock(gContestMons[gNumLinkContestPlayers], (CONTESTANT_COUNT - gNumLinkContestPlayers) * /* ((struct)?.length ?? 32) */ 0) == 1)
                  task.data[0]++;
          }
          else
          {
      ...
      case 1:
          if (LinkContest_GetBlockReceived(0))
          {
              memcpy(gContestMons[gNumLinkContestPlayers], gBlockRecvBuffer[0], (CONTESTANT_COUNT - gNumLinkContestPlayers) * /* ((struct)?.length ?? 32) */ 0);
