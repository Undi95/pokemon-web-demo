...
// Source : src/time_events.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: time_events.c → Task_WaitWeather */
export const Task_WaitWeather: TaskCallback = (task, rt) => {
