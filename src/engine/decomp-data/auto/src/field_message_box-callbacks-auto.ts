...
// Source : src/field_message_box.c (via SPRITE_CALLBACKS / TASKS / SPRITE_CBS / CB2S)
...
/** Source: field_message_box.c → Task_DrawFieldMessage */
export const Task_DrawFieldMessage: TaskCallback = (task, rt) => {
...
/** Source: field_message_box.c → Task_HidePokenavMessageWhenDone */
export const Task_HidePokenavMessageWhenDone: TaskCallback = (task, rt) => {
  const taskId = task.taskId;
