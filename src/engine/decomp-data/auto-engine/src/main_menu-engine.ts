// AUTO-GENERATED from src/main_menu.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  ...
  "LoadMainMenuWindowFrameTiles": {
    returnType: "static void",
    params: "u8 bgId, u16 tileOffset",
    callsTo: ["BG_PLTT_ID","GetWindowFrameTilesPal","LoadBgTiles","LoadPalette"],
    lineCount: 2,
    bodyC: "LoadBgTiles(bgId, GetWindowFrameTilesPal(gSaveBlock2Ptr->optionsWindowFrameType)->tiles, 0x120, tileOffset);\n    LoadPalette(GetWindowFrameTilesPal(gSaveBlock2Ptr->optionsWindowFrameType)->pal, BG_PLTT_ID(2), PLTT_SIZE_4BPP);",
  },
  "MainMenu_FormatSavegameBadges": {
    returnType: "static void",
    params: "void",
    callsTo: ["AddTextPrinterParameterized3","ConvertIntToDecimalStringN","FlagGet","GetStringRightAlignXOffset","StringExpandPlaceholders"],
    lineCount: 12,
  ...
  "MainMenu_FormatSavegamePlayer": {
    returnType: "static void",
    params: "void",
    callsTo: ["AddTextPrinterParameterized3","GetStringRightAlignXOffset","StringExpandPlaceholders"],
    lineCount: 3,
    bodyC: "StringExpandPlaceholders(gStringVar4, gText_ContinueMenuPlayer);\n    AddTextPrinterParameterized3(2, FONT_NORMAL, 0, 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);\n    AddTextPrinterParameterized3(2, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, gSaveBlock2Ptr->playerName, 100), 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gSaveBlock2Ptr->playerName);",
  },
  "MainMenu_FormatSavegamePokedex": {
    returnType: "static void",
    params: "void",
    callsTo: ["AddTextPrinterParameterized3","ConvertIntToDecimalStringN","FlagGet","GetHoennPokedexCount","GetNationalPokedexCount","GetStringRightAlignXOffset","IsNationalPokedexEnabled","StringExpandPlaceholders"],
    lineCount: 13,
  ...
  "MainMenu_FormatSavegameText": {
    returnType: "static void",
    params: "void",
    callsTo: ["MainMenu_FormatSavegameBadges","MainMenu_FormatSavegamePlayer","MainMenu_FormatSavegamePokedex","MainMenu_FormatSavegameTime"],
    lineCount: 4,
    bodyC: "MainMenu_FormatSavegamePlayer();\n    MainMenu_FormatSavegamePokedex();\n    MainMenu_FormatSavegameTime();\n    MainMenu_FormatSavegameBadges();",
  },
  "MainMenu_FormatSavegameTime": {
    returnType: "static void",
    params: "void",
    callsTo: ["AddTextPrinterParameterized3","ConvertIntToDecimalStringN","GetStringRightAlignXOffset","StringExpandPlaceholders"],
    lineCount: 8,
  ...
  "NewGameBirchSpeech_ShowDialogueWindow": {
    returnType: "static void",
    params: "u8 windowId, u8 copyToVram",
    callsTo: ["CallWindowFunction","CopyWindowToVram","FillWindowPixelBuffer","PIXEL_FILL","PutWindowTilemap"],
    lineCount: 5,
    bodyC: "CallWindowFunction(windowId, NewGameBirchSpeech_CreateDialogueWindowBorder);\n    FillWindowPixelBuffer(windowId, PIXEL_FILL(1));\n    PutWindowTilemap(windowId);\n    if (copyToVram == TRUE)\n        CopyWindowToVram(windowId, COPYWIN_FULL);",
  },
  "NewGameBirchSpeech_ShowGenderMenu": {
    returnType: "static void",
    params: "void",
    callsTo: ["ARRAY_COUNT","CopyWindowToVram","DrawMainMenuWindowBorder","FillWindowPixelBuffer","InitMenuInUpperLeftCornerNormal","PIXEL_FILL","PrintMenuTable","PutWindowTilemap"],
    lineCount: 6,
    bodyC: "DrawMainMenuWindowBorder(&sNewGameBirchSpeechTextWindows[1], 0xF3);\n    FillWindowPixelBuffer(1, PIXEL_FILL(1));\n    PrintMenuTable(1, ARRAY_COUNT(sMenuActions_Gender), sMenuActions_Gender);\n    InitMenuInUpperLeftCornerNormal(1, ARRAY_COUNT(sMenuActions_Gender), 0);\n    PutWindowTilemap(1);\n    CopyWindowToVram(1, COPYWIN_FULL);",
  },
  "NewGameBirchSpeech_StartFadeInTarget1OutTarget2": {
    returnType: "static void",
    params: "u8 taskId, u8 delay",
    callsTo: ["BLDALPHA_BLEND","CreateTask","SetGpuReg"],
    lineCount: 11,
