// AUTO-GENERATED from src/trade.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  ...
  "CB1_UpdateLink": {
    returnType: "static void",
    params: "void",
    callsTo: ["Follower_ReadLinkBuffer","GetMultiplayerId","Leader_HandleCommunication","Leader_ReadLinkBuffer","_GetBlockReceivedStatus"],
    lineCount: 11,
    bodyC: "u8 mpId = GetMultiplayerId();\n    u8 status;\n\n    if ((status = _GetBlockReceivedStatus()))\n    {\n        if (mpId == 0)\n            Leader_ReadLinkBuffer(mpId, status);\n        else\n            Follower_ReadLinkBuffer(mpId, status);\n    }\n\n    if (mpId == 0)\n        Leader_HandleCommunication();",
  },
  "CB2_CreateTradeMenu": {
    returnType: "static void",
    params: "void",
    callsTo: ["AllocZeroed","AnimateSprites","BeginNormalPaletteFade","BufferTradeParties","BuildOamBuffer","CalculateEnemyPartyCount","CalculatePlayerPartyCount","CheckShouldAdvanceLinkState","ComputePartyHPBarLevels","ComputePartyTradeableFlags","CreateMon","CreateMonIcon","CreateSprite","CreateTask","CreateTask_RfuIdle","CreateWirelessStatusIndicatorSprite","DestroyTask_RfuIdle","DrawBottomRowText","DrawHeldItemIconsForTrade","DrawTextWindowAndBufferTiles","GetLinkPlayerCount_2","GetMonData","GetMultiplayerId","GetSavedPlayerCount","GetStringCenterAlignXOffset","InitTradeMenu","IsLinkMaster","IsLinkPlayerDataExchangeComplete","IsLinkRfuTaskFinished","LoadHeldItemIcons","LoadTradeBgGfx","LoadUISpriteGfx","LoadWirelessStatusIndicatorSpriteGfx","OpenLink","PlayBGM","PrintPartyNicknames","PrintTradeMessage","Rfu_SetLinkRecovery","RunTasks","RunTextPrinters","SaveTradeGiftRibbons","SetActiveMenuOptions","SetGpuReg","SetLinkStandbyCallback","SetMainCallback2","SetTradePartyHPBarSprites","SetWirelessCommType1","ShowBg","UpdatePaletteFade","rbox_fill_rectangle"],
    lineCount: 242,
  ...
  "CB2_FreeTradeAnim": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BuildOamBuffer","DestroyWirelessStatusIndicatorSprite","FREE_AND_SET_NULL","Free","FreeAllWindowBuffers","FreeMonSpritesGfx","GetBgTilemapBuffer","RunTasks","SetMainCallback2","UpdatePaletteFade"],
    lineCount: 16,
  ...
  "CB2_InGameTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BuildOamBuffer","DoTradeAnim","RunTasks","RunTextPrinters","UpdatePaletteFade"],
    lineCount: 6,
    bodyC: "DoTradeAnim();\n    RunTasks();\n    RunTextPrinters();\n    AnimateSprites();\n    BuildOamBuffer();\n    UpdatePaletteFade();",
  },
  "CB2_InitInGameTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["AllocZeroed","AllocateMonSpritesGfx","AnimateSprites","BufferTradeSceneStrings","BuildOamBuffer","CopyWindowToVram","FillWindowPixelBuffer","FreeAllSpritePalettes","GetMonData","LoadSpritePalette","LoadSpriteSheet","LoadTradeMonPic","LoadTradeSequenceSpriteSheetsAndPalettes","PIXEL_FILL","PutWindowTilemap","ResetSpriteData","ResetTasks","RunTasks","RunTextPrinters","SetMainCallback2","SetTradeSequenceBgGpuRegs","SetVBlankCallback","ShowBg","StringCopy","TradeAnimInit_LoadGfx","UpdatePaletteFade"],
    lineCount: 77,
  ...
  "CB2_LinkTrade": {
    returnType: "void",
    params: "void",
    callsTo: ["AllocZeroed","AllocateMonSpritesGfx","AnimateSprites","BeginNormalPaletteFade","BufferTradeSceneStrings","BuildOamBuffer","CheckForLinkTimeout","CheckShouldAdvanceLinkState","ClearLinkTimeoutTimer","CloseLink","CreateWirelessStatusIndicatorSprite","FreeAllSpritePalettes","GetLinkPlayerCount_2","GetSavedPlayerCount","InitTradeSequenceBgGpuRegs","IsLinkMaster","IsLinkPlayerDataExchangeComplete","LinkTradeDrawWindow","LoadSpritePalette","LoadSpriteSheet","LoadTradeMonPic","LoadTradeSequenceSpriteSheetsAndPalettes","LoadWirelessStatusIndicatorSpriteGfx","OpenLink","ResetSpriteData","ResetTasks","RunTasks","RunTextPrinters","SetMainCallback2","SetVBlankCallback","ShowBg","TradeAnimInit_LoadGfx","UpdatePaletteFade"],
    lineCount: 128,
  ...
  "CB2_ReturnToTradeMenu": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BeginNormalPaletteFade","BlendPalettes","BuildOamBuffer","CalculateEnemyPartyCount","CalculatePlayerPartyCount","ClearWindowTilemap","CreateMonIcon","CreateSprite","CreateWirelessStatusIndicatorSprite","DrawBottomRowText","DrawHeldItemIconsForTrade","DrawTextWindowAndBufferTiles","GetMonData","GetMultiplayerId","GetStringCenterAlignXOffset","InitTradeMenu","LoadHeldItemIcons","LoadTradeBgGfx","LoadUISpriteGfx","LoadWirelessStatusIndicatorSpriteGfx","PrintPartyNicknames","RunTasks","SetActiveMenuOptions","SetGpuReg","SetMainCallback2","SetTradePartyHPBarSprites","UpdatePaletteFade"],
    lineCount: 165,
  ...
  "CB2_SaveAndEndTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BeginNormalPaletteFade","BuildOamBuffer","ClearContinueGameWarpStatus2","DrawTextOnTradeWindow","FadeOutBGM","GetMultiplayerId","HasLinkErrorOccurred","InUnionRoom","IncrementGameStat","IsBGMStopped","LinkFullSave_Init","LinkFullSave_ReplaceLastSector","LinkFullSave_SetLastSectorSignature","LinkFullSave_WriteSector","MysteryGift_TryIncrementStat","Random","RunTasks","SetCloseLinkCallback","SetContinueGameWarpStatusToDynamicWarp","SetMainCallback2","SetTradeLinkStandbyCallback","StringExpandPlaceholders","UpdatePaletteFade","_IsLinkTaskFinished"],
    lineCount: 143,
  ...
  "CB2_SaveAndEndWirelessTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BeginNormalPaletteFade","BuildOamBuffer","DrawTextOnTradeWindow","FadeOutBGM","GetMultiplayerId","HasLinkErrorOccurred","IncrementGameStat","IsBGMStopped","LinkFullSave_Init","LinkFullSave_ReplaceLastSector","LinkFullSave_SetLastSectorSignature","LinkFullSave_WriteSector","Random","RunTasks","SetMainCallback2","SetTradeLinkStandbyCallback","StringExpandPlaceholders","UpdatePaletteFade","_IsLinkTaskFinished"],
    lineCount: 106,
  ...
  "CB2_StartCreateTradeMenu": {
    ...
    lineCount: 3,
    bodyC: "SetMainCallback2(CB2_CreateTradeMenu);\n    gMain.callback1 = NULL;\n    gEnemyPartyCount = 0;",
  },
  "CB2_TradeMenu": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BuildOamBuffer","DoQueuedActions","DrawSelectedMonScreen","RunTasks","RunTextPrintersAndIsPrinter0Active","RunTradeMenuCallback","SetGpuReg","UpdatePaletteFade"],
    lineCount: 11,
    bodyC: "RunTradeMenuCallback();\n    DoQueuedActions();\n\n     \n    DrawSelectedMonScreen(TRADE_PLAYER);\n    DrawSelectedMonScreen(TRADE_PARTNER);\n\n    SetGpuReg(REG_OFFSET_BG2HOFS, sTradeMenu->bg2hofs++);\n    SetGpuReg(REG_OFFSET_BG3HOFS, sTradeMenu->bg3hofs--);\n\n    RunTextPrintersAndIsPrinter0Active();\n    RunTasks();\n    AnimateSprites();\n    BuildOamBuffer();\n    UpdatePaletteFade();",
  },
  "CB2_TryLinkTradeEvolution": {
    returnType: "static void",
    params: "void",
    callsTo: ["AnimateSprites","BuildOamBuffer","GetEvolutionTargetSpecies","HasLinkErrorOccurred","IsWirelessTrade","RunTasks","SetMainCallback2","TradeEvolutionScene","UpdatePaletteFade"],
    lineCount: 24,
  ...
  "CB_ExitCanceledTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["DestroyWirelessStatusIndicatorSprite","Free","FreeAllWindowBuffers","GetNumQueuedActions","IsLinkTradeTaskFinished","SetMainCallback2"],
    lineCount: 21,
  ...
  "CB_FadeToStartTrade": {
    ...
    lineCount: 5,
    bodyC: "if (++sTradeMenu->timer > 15)\n    {\n        BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);\n        sTradeMenu->callbackId = CB_WAIT_TO_START_TRADE;\n    }",
  },
  "CB_HandleTradeCanceled": {
    returnType: "static void",
    params: "void",
    callsTo: ["FillWindowPixelBuffer","JOY_NEW","PIXEL_FILL","PlaySE","RedrawPartyWindow","rbox_fill_rectangle"],
    lineCount: 16,
  ...
  "CB_PrintIsThisTradeOkay": {
    returnType: "static void",
    params: "void",
    callsTo: ["PrintIsThisTradeOkay"],
    lineCount: 6,
    bodyC: "if (sTradeMenu->drawSelectedMonState[TRADE_PLAYER] == DRAW_SELECTED_FINISH\n     && sTradeMenu->drawSelectedMonState[TRADE_PARTNER] == DRAW_SELECTED_FINISH)\n    {\n        PrintIsThisTradeOkay();\n        sTradeMenu->callbackId = CB_INIT_CONFIRM_TRADE_PROMPT;\n    }",
  },
  "CB_ProcessCancelTradeInput": {
    returnType: "static void",
    params: "void",
    callsTo: ["Menu_ProcessInputNoWrapClearOnChoose","PlaySE","PrintTradeMessage","RedrawChooseAPokemonWindow","RestoreNicknamesCoveredByYesNo","SetLinkData"],
    lineCount: 15,
  ...
  "CB_ProcessConfirmTradeInput": {
    returnType: "static void",
    params: "void",
    callsTo: ["CheckMonsBeforeTrade","IsLinkTradeTaskFinished","Menu_ProcessInputNoWrapClearOnChoose","PutWindowTilemap","QueueAction","SetLinkData"],
    lineCount: 18,
  ...
  "CB_ProcessMenuInput": {
    returnType: "static void",
    params: "void",
    callsTo: ["ARRAY_COUNT","BeginNormalPaletteFade","CopyWindowToVram","CreateYesNoMenu","DrawBottomRowText","DrawTextBorderOuter","FillWindowPixelBuffer","InitMenuInUpperLeftCornerNormal","JOY_NEW","JOY_REPEAT","PIXEL_FILL","PlaySE","PrintMenuTable","PutWindowTilemap","TradeMenuMoveCursor"],
    lineCount: 33,
  ...
  "CB_StartLinkTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["DestroyWirelessStatusIndicatorSprite","Free","FreeAllWindowBuffers","IsLinkRfuTaskFinished","SetMainCallback2"],
    lineCount: 24,
    bodyC: "gMain.savedCallback = CB2_StartCreateTradeMenu;\n\n    if (gWirelessCommType)\n    {\n         \n        if (IsLinkRfuTaskFinished())\n        {\n            Free(sMenuTextTileBuffer);\n            FreeAllWindowBuffers();\n            Free(sTradeMenu);\n            gMain.callback1 = NULL;\n            DestroyWirelessStatusIndicatorSprite();\n            SetMainCallback2(CB2_LinkTrade);\n        }\n    }\n    else\n    {\n         \n        if (!gReceivedRemoteLinkPlayers)\n        {\n            Free(sMenuTextTileBuffer);\n            FreeAllWindowBuffers();\n            Free(sTradeMenu);\n            gMain.callback1 = NULL;\n            SetMainCallback2(CB2_LinkTrade);\n        }\n    }",
  },
  "CB_WaitToStartRfuTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["GetNumQueuedActions","Rfu_SetLinkRecovery","SetLinkStandbyCallback"],
    lineCount: 5,
    bodyC: "if (!Rfu_SetLinkRecovery(FALSE) && GetNumQueuedActions() == 0)\n    {\n        SetLinkStandbyCallback();\n        sTradeMenu->callbackId = CB_START_LINK_TRADE;\n    }",
  },
  "CB_WaitToStartTrade": {
    returnType: "static void",
    params: "void",
    callsTo: ["SetCloseLinkCallbackAndType"],
    lineCount: 14,
  ...
  "CheckValidityOfTradeMons": {
    ...
    params: "u8 *aliveMons, u8 playerPartyCount, u8 playerMonIdx, u8 partnerMonIdx",
    callsTo: ["GetMonData","IsNationalPokedexEnabled","IsSpeciesInHoennDex"],
    lineCount: 23,
  ...
  "DoQueuedActions": {
    returnType: "static void",
    params: "void",
    callsTo: ["ARRAY_COUNT","PrintTradeMessage","SendLinkData"],
    lineCount: 41,
  ...
  "DoTradeAnim": {
    returnType: "static bool8",
    params: "void",
    callsTo: ["DoTradeAnim_Cable","DoTradeAnim_Wireless"],
    lineCount: 4,
    bodyC: "if (sTradeAnim->isCableTrade)\n        return DoTradeAnim_Cable();\n    else\n        return DoTradeAnim_Wireless();",
  },
  "DoTradeAnim_Cable": {
    returnType: "static bool8",
    params: "void",
    callsTo: ["BLDALPHA_BLEND","BeginNormalPaletteFade","BlendPalettes","BufferInGameTradeMonName","CalcCenterToCornerVec","CheckPartnersMonForRibbons","CopyWindowToVram","CreatePokeballSpriteToReleaseMon","CreateSprite","CreateTradePokeballSprite","DestroySprite","DrawTextOnTradeWindow","FREE_AND_SET_NULL","FillWindowPixelBuffer","Free","FreeAllWindowBuffers","FreeMonSpritesGfx","FreeSpriteOamMatrix","GetBgTilemapBuffer","GetCurrentMapMusic","GetEvolutionTargetSpecies","HandleLoadSpecialPokePic_2","IsCryFinished","IsMonSpriteNotFlipped","JOY_NEW","PIXEL_FILL","PlayCry_Normal","PlayFanfare","PlayNewMapMusic","PlaySE","SPRITE_SHAPE","SPRITE_SIZE","SetGpuReg","SetMainCallback2","SetTradeBGAffine","SetTradeSequenceBgGpuRegs","StartSpriteAffineAnim","StartSpriteAnim","StringExpandPlaceholders","TradeEvolutionScene","TradeMons"],
    lineCount: 454,
  ...
  "DoTradeAnim_Wireless": {
    returnType: "static bool8",
    params: "void",
    callsTo: ["BLDALPHA_BLEND","BeginNormalPaletteFade","BlendPalettes","BufferInGameTradeMonName","CalcCenterToCornerVec","CheckPartnersMonForRibbons","CopyWindowToVram","CreatePokeballSpriteToReleaseMon","CreateSprite","CreateTask","CreateTradePokeballSprite","DestroySprite","DrawTextOnTradeWindow","FREE_AND_SET_NULL","FillWindowPixelBuffer","Free","FreeAllWindowBuffers","FreeMonSpritesGfx","FreeSpriteOamMatrix","FuncIsActiveTask","GetBgTilemapBuffer","GetCurrentMapMusic","GetEvolutionTargetSpecies","HandleLoadSpecialPokePic_2","IsCryFinished","IsMonSpriteNotFlipped","JOY_NEW","PIXEL_FILL","PlayCry_Normal","PlayFanfare","PlayNewMapMusic","PlaySE","SPRITE_SHAPE","SPRITE_SIZE","SetGpuReg","SetMainCallback2","SetTradeSequenceBgGpuRegs","StartSpriteAffineAnim","StartSpriteAnim","StringExpandPlaceholders","TradeEvolutionScene","TradeMons"],
    lineCount: 480,
  ...
  "Follower_ReadLinkBuffer": {
    returnType: "static void",
    params: "u8 mpId, u8 status",
    callsTo: ["BeginNormalPaletteFade","PrintTradeMessage","SetSelectedMon","TradeResetReceivedFlag","rbox_fill_rectangle"],
    lineCount: 32,
  ...
  "GetInGameTradeMail": {
    returnType: "static void",
    params: "struct Mail *mail, const struct InGameTrade *trade",
    callsTo: ["PadNameString","StringCopy"],
    lineCount: 11,
  ...
  "GetInGameTradeSpeciesInfo": {
    ...
    callsTo: ["StringCopy"],
    lineCount: 4,
    bodyC: "const struct InGameTrade *inGameTrade = &sIngameTrades[gSpecialVar_0x8004];\n    StringCopy(gStringVar1, gSpeciesNames[inGameTrade->requestedSpecies]);\n    StringCopy(gStringVar2, gSpeciesNames[inGameTrade->species]);\n    return inGameTrade->requestedSpecies;",
  },
  "GetMonNicknameWidth": {
    returnType: "static u8",
    params: "u8 *str, u8 whichParty, u8 partyIdx",
    callsTo: ["GetFontAttribute","GetMonData","GetStringWidth","StringCopy_Nickname"],
    lineCount: 7,
  ...
  "GetNewCursorPosition": {
    returnType: "static u8",
    params: "u8 oldPosition, u8 direction",
    lineCount: 11,
  ...
  "HandleLinkDataSend": {
    returnType: "static void",
    params: "void",
    callsTo: ["BitmaskAllOtherLinkPlayers","IsLinkTaskFinished","SendBlock"],
    lineCount: 12,
    bodyC: "switch (sTradeAnim->scheduleLinkTransfer)\n    {\n    case 1:\n        if (IsLinkTaskFinished())\n        {\n            SendBlock(BitmaskAllOtherLinkPlayers(), sTradeAnim->linkData, sizeof(sTradeAnim->linkData));\n            sTradeAnim->scheduleLinkTransfer++;\n        }\n         \n    case 2:\n        sTradeAnim->scheduleLinkTransfer = 0;\n        break;\n    }",
  },
  "InitTradeMenu": {
    returnType: "static void",
    params: "void",
    callsTo: ["ARRAY_COUNT","BG_PLTT_ID","ClearWindowTilemap","DeactivateAllTextPrinters","FillBgTilemapBufferRect","FillWindowPixelBuffer","FreeAllSpritePalettes","InitBgsFromTemplates","InitWindows","LoadMonIconPalettes","LoadPalette","LoadUserWindowBorderGfx","LoadUserWindowBorderGfx_","PIXEL_FILL","PLTT_SIZEOF","ResetBgsAndClearDma3BusyFlags","ResetPaletteFade","ResetSpriteData","ResetTasks","SetBgTilemapBuffer","SetVBlankCallback"],
    lineCount: 33,
  ...
  "LinkTradeDrawWindow": {
    returnType: "void",
    params: "void",
    callsTo: ["CopyWindowToVram","FillWindowPixelBuffer","PIXEL_FILL","PutWindowTilemap"],
    lineCount: 3,
    bodyC: "FillWindowPixelBuffer(0, PIXEL_FILL(15));\n    PutWindowTilemap(0);\n    CopyWindowToVram(0, COPYWIN_FULL);",
  },
  "LoadTradeAnimGfx": {
    returnType: "void",
    params: "void",
    callsTo: ["TradeAnimInit_LoadGfx"],
    lineCount: 1,
    bodyC: "TradeAnimInit_LoadGfx();",
  },
  "LoadTradeBgGfx": {
    returnType: "static void",
    params: "u8 state",
    callsTo: ["BG_PLTT_ID","CopyBgTilemapBufferToVram","CopyToBgTilemapBufferRect_ChangePalette","LoadBgTilemap","LoadBgTiles","LoadPalette","PrintPartyLevelsAndGenders","SetGpuReg","ShowBg"],
    lineCount: 24,
  ...
  "LoadTradeMonPic": {
    returnType: "static void",
    params: "u8 whichParty, u8 state",
    callsTo: ["CreateSprite","GetMonData","GetMonSpritePalStruct","HandleLoadSpecialPokePic_2","HandleLoadSpecialPokePic_DontHandleDeoxys","LoadCompressedSpritePalette","SetMultiuseSpriteTemplateToPokemon"],
    lineCount: 34,
  ...
  "PrintPartyMonNickname": {
    returnType: "static void",
    params: "u8 whichParty, u8 windowId, u8 *nickname",
    callsTo: ["AddTextPrinterParameterized3","CopyWindowToVram","GetStringCenterAlignXOffset","PutWindowTilemap"],
    lineCount: 6,
  ...
  "PrintPartyNicknames": {
    returnType: "static void",
    params: "u8 whichParty",
    callsTo: ["GetMonData","PrintPartyMonNickname","StringCopy_Nickname","max"],
    lineCount: 10,
  ...
  "PrintTradeMessage": {
    returnType: "static void",
    params: "u8 messageId",
    callsTo: ["AddTextPrinterParameterized","CopyWindowToVram","DrawTextBorderOuter","FillWindowPixelBuffer","PIXEL_FILL","PutWindowTilemap"],
    lineCount: 5,
    bodyC: "FillWindowPixelBuffer(0, PIXEL_FILL(1));\n    AddTextPrinterParameterized(0, FONT_NORMAL, sMessages[messageId], 0, 1, TEXT_SKIP_DRAW, NULL);\n    DrawTextBorderOuter(0, 20, 12);\n    PutWindowTilemap(0);\n    CopyWindowToVram(0, COPYWIN_FULL);",
  },
  "PrintTradePartnerPartyNicknames": {
    returnType: "static void",
    params: "void",
    callsTo: ["PrintPartyNicknames","rbox_fill_rectangle"],
    lineCount: 2,
    bodyC: "rbox_fill_rectangle(1);\n   \n    PrintPartyNicknames(TRADE_PARTNER);",
  },
  "QueueAction": {
    returnType: "static void",
    params: "u16 delay, u8 actionId",
    callsTo: ["ARRAY_COUNT"],
    lineCount: 11,
  ...
  "RedrawChooseAPokemonWindow": {
    returnType: "static void",
    params: "void",
    callsTo: ["DrawBottomRowText","PrintTradePartnerPartyNicknames"],
    lineCount: 4,
    bodyC: "PrintTradePartnerPartyNicknames();\n    sTradeMenu->callbackId = CB_MAIN_MENU;\n    gSprites[sTradeMenu->cursorSpriteId].invisible = FALSE;\n    DrawBottomRowText(sActionTexts[TEXT_CHOOSE_MON], (void *)(OBJ_VRAM0 + sTradeMenu->bottomTextTileStart * 32), 24);",
  },
  "RedrawPartyWindow": {
    returnType: "static void",
    params: "u8 whichParty",
    callsTo: ["CopyBgTilemapBufferToVram","CopyToBgTilemapBufferRect_ChangePalette","DrawBottomRowText","PrintPartyLevelsAndGenders","PrintPartyNicknames","ShowTradePartyMonIcons"],
    lineCount: 7,
    bodyC: "CopyToBgTilemapBufferRect_ChangePalette(1, sTradePartyBoxTilemap, whichParty * 15, 0, 15, 17, 0);\n    CopyBgTilemapBufferToVram(1);\n    PrintPartyLevelsAndGenders(whichParty);\n    PrintPartyNicknames(whichParty);\n    ShowTradePartyMonIcons(whichParty);\n    DrawBottomRowText(sActionTexts[TEXT_CHOOSE_MON], (void *)(OBJ_VRAM0 + (sTradeMenu->bottomTextTileStart * 32)), 24);\n    sTradeMenu->drawSelectedMonState[whichParty] = 0;",
  },
  "RequestLinkData": {
    returnType: "static void",
    params: "u8 type",
    callsTo: ["SendBlockRequest"],
    lineCount: 1,
    bodyC: "SendBlockRequest(type);",
  },
  "RestoreNicknamesCoveredByYesNo": {
    returnType: "static void",
    params: "void",
    callsTo: ["CopyWindowToVram","PutWindowTilemap"],
    lineCount: 6,
  ...
  "SendLinkData": {
    returnType: "static bool8",
    params: "const void *linkData, u32 size",
    callsTo: ["SendBlock","rfu_NI_setSendData"],
    lineCount: 9,
  ...
  "SetTradeLinkStandbyCallback": {
    returnType: "static void",
    params: "u8 unused",
    callsTo: ["SetLinkStandbyCallback"],
    lineCount: 1,
    bodyC: "SetLinkStandbyCallback();",
  },
  "SetTradePartyHPBarSprites": {
    returnType: "static void",
    params: "void",
    callsTo: ["SetPartyHPBarSprite"],
    lineCount: 6,
  ...
  "SetTradeSequenceBgGpuRegs": {
    returnType: "static void",
    params: "u8 state",
    callsTo: ["BGCNT_CHARBASE","BGCNT_PRIORITY","BGCNT_SCREENBASE","BG_CHAR_ADDR","BG_PLTT_ID","BG_SCREEN_ADDR","BlendPalettes","DmaCopy16Defvars","DmaCopyLarge16","LZ77UnCompVram","LoadPalette","SetGpuReg"],
    lineCount: 150,
  ...
  "Task_CloseCenterWhiteColumn": {
    returnType: "static void",
    params: "u8 taskId",
    callsTo: ["BlendPalettes","ClearGpuRegBits","DestroyTask","SetGpuReg","WIN_RANGE2"],
    lineCount: 25,
  ...
  "Task_DrawSelectionSummary": {
    returnType: "static void",
    params: "u8 taskId",
    callsTo: ["CopyBgTilemapBufferToVram","FillBgTilemapBufferRect_Palette0"],
    lineCount: 2,
    bodyC: "FillBgTilemapBufferRect_Palette0(0, 0, 0, 0, DISPLAY_TILE_WIDTH, DISPLAY_TILE_HEIGHT);\n    CopyBgTilemapBufferToVram(0);",
  },
  ...
  "Task_OpenCenterWhiteColumn": {
    returnType: "static void",
    params: "u8 taskId",
    callsTo: ["DestroyTask","SetGpuReg","SetGpuRegBits","WIN_RANGE2"],
    lineCount: 19,
  ...
  "TradeAnimInit_LoadGfx": {
    returnType: "static void",
    params: "void",
    callsTo: ["ARRAY_COUNT","Alloc","BG_PLTT_ID","ChangeBgX","ChangeBgY","CopyToBgTilemapBuffer","DeactivateAllTextPrinters","DecompressAndLoadBgGfxUsingHeap","InitBgsFromTemplates","InitWindows","LZDecompressWram","LoadCompressedPalette","ResetBgsAndClearDma3BusyFlags","SetBgTilemapBuffer","SetGpuReg"],
    lineCount: 18,
  ...
  "TradeResetReceivedFlag": {
    returnType: "static void",
    params: "u32 who",
    callsTo: ["IsWirelessTrade","ResetBlockReceivedFlag","rfu_clearSlot"],
    lineCount: 4,
    bodyC: "if (IsWirelessTrade())\n        rfu_clearSlot(12, lman.acceptSlot_flag);\n    else\n        ResetBlockReceivedFlag(who);",
  },
  "TradeResetReceivedFlags": {
    returnType: "static void",
    params: "void",
    callsTo: ["IsWirelessTrade","ResetBlockReceivedFlags","rfu_clearSlot"],
    lineCount: 4,
    bodyC: "if (IsWirelessTrade())\n        rfu_clearSlot(12, lman.acceptSlot_flag);\n    else\n        ResetBlockReceivedFlags();",
  },
  "Trade_Memcpy": {
    returnType: "static void",
    params: "void *dest, const void *src, u32 size",
    lineCount: 5,
    bodyC: "u8 *_dest = dest;\n    const u8 *_src = src;\n    u32 i;\n    for (i = 0; i < size; i++)\n        _dest[i] = _src[i];",
  },
  "TryEnableNationalDexFromLinkPartner": {
    ...
    callsTo: ["GetMultiplayerId"],
    lineCount: 1,
    bodyC: "u8 UNUSED mpId = GetMultiplayerId();",
  },
  "UpdatePokedexForReceivedMon": {
    returnType: "static void",
    params: "u8 partyIdx",
    callsTo: ["GetMonData","GetSetPokedexFlag","HandleSetPokedexFlag","SpeciesToNationalPokedexNum"],
    lineCount: 9,
    bodyC: "struct Pokemon *mon = &gPlayerParty[partyIdx];\n\n    if (!GetMonData(mon, MON_DATA_IS_EGG))\n    {\n        u16 species = GetMonData(mon, MON_DATA_SPECIES, NULL);\n        u32 personality = GetMonData(mon, MON_DATA_PERSONALITY, NULL);\n        species = SpeciesToNationalPokedexNum(species);\n        GetSetPokedexFlag(species, FLAG_SET_SEEN);\n        HandleSetPokedexFlag(species, FLAG_SET_CAUGHT, personality);\n    }",
  },
  "VBlankCB_TradeAnim": {
    returnType: "static void",
    params: "void",
    callsTo: ["LoadOam","ProcessSpriteCopyRequests","SetTradeGpuRegs","TransferPlttBuffer"],
    lineCount: 4,
    bodyC: "SetTradeGpuRegs();\n    LoadOam();\n    ProcessSpriteCopyRequests();\n    TransferPlttBuffer();",
  },
  "VBlankCB_TradeMenu": {
    returnType: "static void",
    params: "void",
  ...
  "_GetBlockReceivedStatus": {
    returnType: "static u32",
    params: "void",
    callsTo: ["GetBlockReceivedStatus"],
    lineCount: 1,
    bodyC: "return GetBlockReceivedStatus();",
  },
  "_IsLinkTaskFinished": {
    returnType: "static bool32",
    params: "void",
    callsTo: ["IsLinkTaskFinished"],
    lineCount: 1,
    bodyC: "return IsLinkTaskFinished();",
  },
  "_SetLinkData": {
    returnType: "static void",
    params: "u16 *linkData, u16 linkCmd, u16 cursorPosition",
    callsTo: ["QueueAction"],
    lineCount: 3,
    bodyC: "linkData[0] = linkCmd;\n    linkData[1] = cursorPosition;\n    QueueAction(QUEUE_DELAY_DATA, QUEUE_SEND_DATA);",
  },
} as const;
