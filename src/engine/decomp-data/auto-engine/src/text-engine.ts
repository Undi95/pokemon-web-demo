// AUTO-GENERATED from src/text.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  "AddTextPrinter": {
    returnType: "bool16",
    params: "struct TextPrinterTemplate *printerTemplate, u8 speed, void (*callback)(struct TextPrinterTemplate *, u16)",
    callsTo: ["ARRAY_COUNT","CopyWindowToVram","GenerateFontHalfRowLookupTable","RenderFont"],
    lineCount: 35,
  ...
  "DecompressGlyphTile": {
    returnType: "void",
    params: "const void *src_, void *dest_",
    lineCount: 19,
  ...
  "FontFunc_Narrow": {
    ...
    callsTo: ["RenderText"],
    lineCount: 7,
    bodyC: "struct TextPrinterSubStruct *subStruct = (struct TextPrinterSubStruct *)(&textPrinter->subStructFields);\n\n    if (subStruct->hasFontIdBeenSet == FALSE)\n    {\n        subStruct->fontId = FONT_NARROW;\n        subStruct->hasFontIdBeenSet = TRUE;\n    }\n    return RenderText(textPrinter);",
  },
  "FontFunc_Normal": {
    returnType: "static u16",
    params: "struct TextPrinter *textPrinter",
  ...
  "RenderText": {
    returnType: "static u16",
    params: "struct TextPrinter *textPrinter",
    callsTo: ["ClearTextSpan","CopyGlyphToWindow","CopyWindowToVram","DecompressGlyph_Narrow","DecompressGlyph_Normal","DecompressGlyph_Short","DecompressGlyph_Small","DecompressGlyph_SmallNarrow","DrawKeypadIcon","FillWindowPixelBuffer","GenerateFontHalfRowLookupTable","GetPlayerTextSpeed","IsSEPlaying","JOY_HELD","JOY_NEW","PIXEL_FILL","PlayBGM","PlaySE","ScrollWindow","TextPrinterClearDownArrow","TextPrinterInitDownArrowCounters","TextPrinterWait","TextPrinterWaitWithDownArrow","m4aMPlayContinue","m4aMPlayStop"],
    lineCount: 279,
  ...
  "SaveTextColors": {
    ...
    params: "u8 *fgColor, u8 *bgColor, u8 *shadowColor",
    lineCount: 3,
    bodyC: "*bgColor = sLastTextBgColor;\n    *fgColor = sLastTextFgColor;\n    *shadowColor = sLastTextShadowColor;",
  },
  "SetDefaultFontsPointer": {
    returnType: "void",
    params: "void",
    callsTo: ["SetFontsPointer"],
    lineCount: 1,
    bodyC: "SetFontsPointer(sFontInfos);",
  },
  "SetFontsPointer": {
    returnType: "static void",
    params: "const struct FontInfo *fonts",
    lineCount: 1,
    bodyC: "gFonts = fonts;",
  },
  "TextPrinterClearDownArrow": {
    returnType: "void",
    params: "struct TextPrinter *textPrinter",
    callsTo: ["CopyWindowToVram","FillWindowPixelRect"],
    lineCount: 8,
    bodyC: "FillWindowPixelRect(\n        textPrinter->printerTemplate.windowId,\n        textPrinter->printerTemplate.bgColor << 4 | textPrinter->printerTemplate.bgColor,\n        textPrinter->printerTemplate.currentX,\n        textPrinter->printerTemplate.currentY,\n        8,\n        16);\n    CopyWindowToVram(textPrinter->printerTemplate.windowId, COPYWIN_GFX);",
  },
  ...
  "TextPrinterWait": {
    returnType: "bool16",
    params: "struct TextPrinter *textPrinter",
    callsTo: ["JOY_NEW","PlaySE","TextPrinterWaitAutoMode"],
    lineCount: 14,
  ...
  "TextPrinterWaitWithDownArrow": {
    returnType: "bool16",
    params: "struct TextPrinter *textPrinter",
    callsTo: ["JOY_NEW","PlaySE","TextPrinterDrawDownArrow","TextPrinterWaitAutoMode"],
    lineCount: 15,
    bodyC: "bool8 result = FALSE;\n    if (gTextFlags.autoScroll != 0)\n    {\n        result = TextPrinterWaitAutoMode(textPrinter);\n    }\n    else\n    {\n        TextPrinterDrawDownArrow(textPrinter);\n        if (JOY_NEW(A_BUTTON | B_BUTTON))\n        {\n            result = TRUE;\n            PlaySE(SE_SELECT);\n        }\n    }\n    return result;",
  },
} as const;
