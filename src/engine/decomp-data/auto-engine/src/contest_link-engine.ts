// AUTO-GENERATED from src/contest_link.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  "LinkContest_GetBlockReceived": {
    returnType: "bool8",
    params: "u8 flag",
    callsTo: ["GetBlockReceivedStatus","ResetBlockReceivedFlag"],
    lineCount: 10,
    bodyC: "u8 mask = (1 << flag);\n    if (!(GetBlockReceivedStatus() & mask))\n    {\n        return FALSE;\n    }\n    else\n    {\n        ResetBlockReceivedFlag(flag);\n        return TRUE;\n    }",
  },
  "LinkContest_GetBlockReceivedFromAllPlayers": {
    returnType: "bool8",
    params: "void",
    callsTo: ["GetBlockReceivedStatus","GetLinkPlayerCountAsBitFlags","ResetBlockReceivedFlags"],
    lineCount: 9,
    bodyC: "if (GetBlockReceivedStatus() == GetLinkPlayerCountAsBitFlags())\n    {\n        ResetBlockReceivedFlags();\n        return TRUE;\n    }\n    else\n    {\n        return FALSE;\n    }",
  },
  "LinkContest_SendBlock": {
    returnType: "bool32",
    params: "void *src, u16 size",
    callsTo: ["BitmaskAllOtherLinkPlayers","SendBlock","memcpy"],
    lineCount: 5,
    bodyC: "memcpy(gDecompressionBuffer, src, size);\n    if (SendBlock(BitmaskAllOtherLinkPlayers(), gDecompressionBuffer, size))\n        return TRUE;\n    else\n        return FALSE;",
  },
  "LinkContest_TryLinkStandby": {
    returnType: "bool32",
    params: "s16 *state",
    callsTo: ["IsLinkTaskFinished","SetLinkStandbyCallback"],
    lineCount: 20,
