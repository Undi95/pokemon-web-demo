// AUTO-GENERATED from src/mystery_event_menu.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  "CB2_InitMysteryEventMenu": {
    returnType: "void",
    params: "void",
    callsTo: ["ARRAY_COUNT","AnimateSprites","BG_PLTT_ID","BuildOamBuffer","CreateTask","DeactivateAllTextPrinters","FillBgTilemapBufferRect_Palette0","FillWindowPixelBuffer","FreeAllSpritePalettes","InitBgsFromTemplates","InitWindows","LoadUserWindowBorderGfx","Menu_LoadStdPalAt","PIXEL_FILL","ResetBgsAndClearDma3BusyFlags","ResetSpriteData","ResetTasks","RunTasks","RunTextPrinters","SetBackdropFromColor","SetGpuReg","SetMainCallback2","SetVBlankCallback","StopMapMusic","UpdatePaletteFade"],
    lineCount: 27,
  ...
  "CB2_MysteryEventMenu": {
    ...
    params: "void",
    callsTo: ["AnimateSprites","BeginNormalPaletteFade","BuildOamBuffer","CheckLanguageMatch","CheckShouldAdvanceLinkState","CloseLink","CopyWindowToVram","CpuFill32","DoSoftReset","DrawStdFrameWithCustomTileAndPalette","GetBlockReceivedStatus","GetEventLoadMessage","GetLinkPlayerCount_2","GetLinkPlayerDataExchangeStatusTimed","IsLinkConnectionEstablished","IsLinkMaster","IsTextPrinterActive","JOY_NEW","OpenLink","PlaySE","PrintMysteryMenuText","PutWindowTilemap","ResetBlockReceivedFlags","RunMysteryEventScript","RunTasks","RunTextPrinters","SetCloseLinkCallback","ShowBg","TrySavingData","UpdatePaletteFade"],
    lineCount: 170,
