// AUTO-GENERATED from src/mystery_gift_menu.c by extract-engine-helpers.mjs
...
export const ENGINE_FUNCTIONS = {
  ...
  "HandleMysteryGiftOrEReaderSetup": {
    returnType: "static bool32",
    params: "s32 isEReader",
    callsTo: ["ARRAY_COUNT","Alloc","BG_PLTT_ID","ChangeBgX","ChangeBgY","ClearGpuRegBits","CopyBgTilemapBufferToVram","DeactivateAllTextPrinters","EnableInterrupts","FillBgTilemapBufferRect","FreeAllSpritePalettes","GetTextWindowPalette","InitBgsFromTemplates","InitWindows","LoadMysteryGiftTextboxBorder","LoadPalette","LoadUserWindowBorderGfx","LoadUserWindowBorderGfx_","MG_DrawCheckerboardPattern","Menu_LoadStdPalAt","PlayBGM","PrintMysteryGiftOrEReaderHeader","ResetBgsAndClearDma3BusyFlags","ResetPaletteFade","ResetSpriteData","ResetTasks","ScanlineEffect_Stop","SetBgTilemapBuffer","SetGpuReg","SetVBlankCallback","ShowBg"],
    lineCount: 61,
  ...
  "HideDownArrow": {
    returnType: "static void",
    params: "void",
    callsTo: ["DrawDownArrow"],
    lineCount: 1,
    bodyC: "DrawDownArrow(WIN_MSG, DOWN_ARROW_X, DOWN_ARROW_Y, 1, FALSE, &sDownArrowCounterAndYCoordIdx[0], &sDownArrowCounterAndYCoordIdx[1]);",
  },
  "LoadMysteryGiftTextboxBorder": {
    returnType: "static void",
    params: "u8 bgId",
    callsTo: ["DecompressAndLoadBgGfxUsingHeap"],
    lineCount: 1,
    bodyC: "DecompressAndLoadBgGfxUsingHeap(bgId, sTextboxBorder_Gfx, 0x100, 0, 0);",
  },
  "MG_AddMessageTextPrinter": {
    returnType: "void",
    params: "const u8 *str",
    callsTo: ["AddTextPrinterParameterized4","CopyWindowToVram","DrawTextBorderOuter","FillWindowPixelBuffer","PutWindowTilemap","StringExpandPlaceholders"],
    lineCount: 6,
  ...
  "SaveOnMysteryGiftMenu": {
    returnType: "static bool32",
    params: "u8 *state",
    callsTo: ["ClearMessage","JOY_NEW","MG_AddMessageTextPrinter","TrySavingData"],
    lineCount: 24,
  ...
  "ShowDownArrow": {
    ...
    callsTo: ["DrawDownArrow"],
    lineCount: 1,
    bodyC: "DrawDownArrow(WIN_MSG, DOWN_ARROW_X, DOWN_ARROW_Y, 1, TRUE, &sDownArrowCounterAndYCoordIdx[0], &sDownArrowCounterAndYCoordIdx[1]);",
  },
  "Task_MysteryGift": {
    returnType: "static void",
    params: "u8 taskId",
  ...
  "VBlankCB_MysteryGiftEReader": {
    ...
    lineCount: 3,
    bodyC: "ProcessSpriteCopyRequests();\n    LoadOam();\n    TransferPlttBuffer();",
  },
  "ValidateCardOrNews": {
    returnType: "static bool32",
    params: "bool32 isWonderNews",
    callsTo: ["ValidateSavedWonderCard","ValidateSavedWonderNews"],
    lineCount: 4,
