...
export function installBatch01Handlers(commandsTable: BattleOpcodeHandler[]): void {
  ...
  console.log('[battle/cmd-batch-01] installed 11/11 Batch 01 handlers (audited 1:1 décomp)');
}
