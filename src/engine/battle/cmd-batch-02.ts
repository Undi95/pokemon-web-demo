...
export function installBatch02Handlers(commandsTable: BattleOpcodeHandler[]): void {
  ...
  console.log('[battle/cmd-batch-02] installed 8/8 Batch 02 handlers (stat stages + status)');
}
