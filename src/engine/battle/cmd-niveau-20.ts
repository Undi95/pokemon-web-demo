/**
 * battle/cmd-niveau-20.ts — Phase 1 Niveau 20 (protect/explosion/weather dmg) — 7 opcodes
...
export function installNiveau20Handlers(commands: BattleOpcodeHandler[]): void {
