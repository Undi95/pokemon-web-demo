...
export function startChooseStarterFlow(): ChooseStarterFlow {
  ...
  // 1:1 STRICT décomp : palette slots dynamiquement alloués via LoadSpritePalette.
  const starterFrontPalSlots: number[] = [-1, -1, -1];
            ...
            try {
              ...
              for (let i = 0; i < 3; i++) {
                ...
                try {
                  ...
                  // scan first-free → safe vs reserved player + other allocs.
