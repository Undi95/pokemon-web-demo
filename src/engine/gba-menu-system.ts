...
// ─── Window frame tiles (artificial — matches 9-tile standard window frame) ──

// 9 window-frame tiles (8×8 px, 4bpp) arranged as a standard border:
//   0 = top-left corner     1 = top edge        2 = top-right corner
//   3 = left edge           4 = unused          5 = right edge
//   6 = bottom-left corner  7 = bottom edge     8 = bottom-right corner
const WINDOW_FRAME_TILES = new Uint8Array([
  // Tile 0 : top-left corner  (row 0 white, col 0 white)
  0x11,0x11,0x11,0x11, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,
  0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,
  // Tile 1 : top edge  (row 0 white)
  0x11,0x11,0x11,0x11, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
  // Tile 2 : top-right corner  (row 0 white, col 7 white)
  0x11,0x11,0x11,0x11, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10,
  0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10,
  // Tile 3 : left edge  (col 0 white)
  0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,
  0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,
  // Tile 4 : unused (fill transparent)
  0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
  // Tile 5 : right edge  (col 7 white)
  0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10,
  0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10,
  // Tile 6 : bottom-left corner  (row 7 white, col 0 white)
  0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,
  0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x01,0x00,0x00,0x00, 0x11,0x11,0x11,0x11,
  // Tile 7 : bottom edge  (row 7 white)
  0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x11,0x11,0x11,0x11,
  // Tile 8 : bottom-right corner  (row 7 white, col 7 white)
  0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10,
  0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x00,0x00,0x00,0x10, 0x11,0x11,0x11,0x11,
]);

const WINDOW_FRAME_PAL = new Uint16Array([
  0x7FFF, // 0: white (transparent in 4bpp)
  0x7FFF, // 1: white border
  0x4210, // 2: dark gray shadow
  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
]);

export function LoadMainMenuWindowFrameTiles(bgId: number, tileOffset: number): void {
  LoadBgTiles(bgId, WINDOW_FRAME_TILES, WINDOW_FRAME_TILES.length, tileOffset);
  LoadPalette(WINDOW_FRAME_PAL, BG_PLTT_ID(2), PLTT_SIZE_4BPP);
}
