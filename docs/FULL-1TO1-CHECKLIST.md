...
- **STRICT** (fn présente dans NOTRE fichier homonyme propre) : **~53 %** ← la vraie jauge miroir.
- LARGE (fn implémentée n'importe où, même dispersée/mal nommée) : ~56 %.
...
- Axe D — `graphics/` : 3850 png (5748 fichiers) côté décomp · 4402 png sous `public/decomp/` chez nous (structures différentes → proxy, pas une couverture 1:1) → **import systématique en masse (Phase 2)**.
...
|---|---|---|---|---|---|
| Overworld/Field | 84 | 37 | 31 | 15 | 117446 |
| Combat | 75 | 29 | 30 | 15 | 147341 |
| Pokémon/Party | 32 | 21 | 6 | 5 | 61271 |
| UI/Menu/Gfx | 34 | 14 | 12 | 4 | 36036 |
| Item/Bag | 10 | 4 | 5 | 1 | 8806 |
| Save/RTC | 17 | 5 | 3 | 8 | 5676 |
| Système/GBA | 17 | 7 | 5 | 4 | 8645 |
| Son (harness) | 5 | 3 | 0 | 1 | 3551 |
| Link/IO (N-A) | 29 | 2 | 2 | 23 | 30115 |
| Autre | 7 | 2 | 1 | 3 | 3233 |
...
| `frontier_util.c` | 2639 | 93 | `frontier_util.ts` | 2/93 (2%) | 5/93 (5%) | 🔴 manquant |
...
| `trainer_hill.c` | 1091 | 60 | `trainer_hill.ts` | 9/60 (15%) | 9/60 (15%) | 🟡 amorce |
...
| `event_object_movement.c` | 8984 | 733 | `event_object_movement.ts` | 207/733 (28%) | 212/733 (29%) | 🟡 amorce |
...
| `field_screen_effect.c` | 1267 | 77 | `field_screen_effect.ts` | 24/77 (31%) | 28/77 (36%) | 🟡 amorce |
| `overworld.c` | 3227 | 227 | `overworld.ts` | 67/227 (30%) | 85/227 (37%) | 🟡 amorce |
| `field_specials.c` | 4281 | 191 | `field_specials.ts` | 69/191 (36%) | 72/191 (38%) | 🟡 amorce |
...
| `trainer_pokemon_sprites.c` | 396 | 23 | `trainer_pokemon_sprites.ts` | 9/23 (39%) | 10/23 (43%) | 🟡 amorce |
| `field_effect.c` | 3919 | 247 | `field_effect.ts` | 8/247 (3%) | 129/247 (52%) | 🟡 amorce |
| `player_pc.c` | 1511 | 85 | `player_pc.ts` | 44/85 (52%) | 44/85 (52%) | 🟡 partiel |
| `script_pokemon_util.c` | 229 | 13 | `script_pokemon_util.ts` | 6/13 (46%) | 7/13 (54%) | 🟡 partiel |
...
| `script.c` | 471 | 39 | `script.ts` | 30/39 (77%) | 31/39 (79%) | 🟡 partiel |
...
| `field_player_avatar.c` | 2227 | 177 | `field_player_avatar.ts` | 152/177 (86%) | 152/177 (86%) | ✅ miroir |
...
| `easy_chat.c` | 5876 | 248 | `easy_chat.ts` | 222/248 (90%) | 223/248 (90%) | ✅ miroir |
...
| `scrcmd.c` | 2308 | 231 | `scrcmd.ts` | 221/231 (96%) | 222/231 (96%) | ✅ miroir |
...
| `decoration.c` | 2749 | 135 | `decoration.ts` | 133/135 (99%) | 133/135 (99%) | ✅ miroir |
| `tv.c` | 6829 | 207 | `tv.ts` | 207/207 (100%) | 207/207 (100%) | ✅ miroir |
| `match_call.c` | 2113 | 56 | `match_call.ts` | 56/56 (100%) | 56/56 (100%) | ✅ miroir |
| `secret_base.c` | 2076 | 99 | `secret_base.ts` | 99/99 (100%) | 99/99 (100%) | ✅ miroir |
| `region_map.c` | 2028 | 60 | `region_map.ts` | 60/60 (100%) | 60/60 (100%) | ✅ miroir |
| `metatile_behavior.c` | 1403 | 144 | `metatile_behavior.ts` | 144/144 (100%) | 144/144 (100%) | ✅ miroir |
| `tileset_anims.c` | 1189 | 84 | `tileset_anims.ts` | 84/84 (100%) | 84/84 (100%) | ✅ miroir |
...
| `walda_phrase.c` | 279 | 14 | `walda_phrase.ts` | 14/14 (100%) | 14/14 (100%) | ✅ miroir |
...
| `battle_factory_screen.c` | 4316 | 119 | `battle_factory.ts` _(nom≠)_ | 2/119 (2%) | 3/119 (3%) | 🔴 manquant |
| `contest.c` | 6126 | 205 | `contest.ts` | 3/205 (1%) | 9/205 (4%) | 🔴 manquant |
| `battle_pyramid_bag.c` | 1609 | 81 | `item_menu.ts` _(nom≠)_ | 4/81 (5%) | 5/81 (6%) | 🔴 manquant |
| `battle_controller_safari.c` | 692 | 73 | `battle_controller_player.ts` _(nom≠)_ | 5/73 (7%) | 6/73 (8%) | 🔴 manquant |
| `battle_records.c` | 525 | 31 | `battle_records.ts` | 3/31 (10%) | 3/31 (10%) | 🔴 manquant |
| `battle_controller_wally.c` | 1571 | 82 | `battle_controller_player.ts` _(nom≠)_ | 8/82 (10%) | 9/82 (11%) | 🔴 manquant |
| `battle_arena.c` | 821 | 19 | — **manquant** | 0/19 (0%) | 2/19 (11%) | 🔴 manquant |
| `battle_pyramid.c` | 1985 | 52 | `battle_pyramid.ts` | 5/52 (10%) | 7/52 (13%) | 🔴 manquant |
| `battle_tower.c` | 3598 | 84 | `battle_tower.ts` | 5/84 (6%) | 13/84 (15%) | 🟡 amorce |
| `battle_controller_recorded_player.c` | 1813 | 87 | `battle_controller_player_partner.ts` _(nom≠)_ | 18/87 (21%) | 18/87 (21%) | 🟡 amorce |
| `battle_controller_link_opponent.c` | 1856 | 88 | `battle_controller_player_partner.ts` _(nom≠)_ | 15/88 (17%) | 19/88 (22%) | 🟡 amorce |
| `battle_controller_recorded_opponent.c` | 1789 | 88 | `battle_controller_player_partner.ts` _(nom≠)_ | 15/88 (17%) | 19/88 (22%) | 🟡 amorce |
| `battle_controller_link_partner.c` | 1698 | 86 | `battle_controller_player_partner.ts` _(nom≠)_ | 20/86 (23%) | 20/86 (23%) | 🟡 amorce |
| `recorded_battle.c` | 867 | 42 | `battle_main.ts` _(nom≠)_ | 11/42 (26%) | 13/42 (31%) | 🟡 amorce |
| `battle_anim_smokescreen.c` | 232 | 3 | `battle_anim_smokescreen.ts` | 1/3 (33%) | 1/3 (33%) | 🟡 amorce |
| `battle_transition.c` | 4777 | 210 | `battle_transition.ts` | 97/210 (46%) | 97/210 (46%) | 🟡 partiel |
| `pokeball.c` | 1345 | 37 | `pokeball.ts` | 15/37 (41%) | 19/37 (51%) | 🟡 partiel |
| `battle_bg.c` | 1418 | 12 | `battle_bg.ts` | 2/12 (17%) | 7/12 (58%) | 🟡 amorce |
| `battle_interface.c` | 2605 | 53 | `battle_interface.ts` | 31/53 (58%) | 32/53 (60%) | 🟡 partiel |
...
| `battle_anim_normal.c` | 1116 | 36 | `battle_anim_normal.ts` | 22/36 (61%) | 25/36 (69%) | 🟡 partiel |
| `battle_message.c` | 3156 | 10 | `battle_message.ts` | 3/10 (30%) | 7/10 (70%) | 🟠 dispersé |
| `battle_controllers.c` | 1585 | 68 | `battle_controllers.ts` | 43/68 (63%) | 48/68 (71%) | 🟡 partiel |
| `battle_setup.c` | 1890 | 102 | `battle_setup.ts` | 72/102 (71%) | 73/102 (72%) | 🟡 partiel |
| `battle_anim_dark.c` | 1002 | 25 | `battle_anim_dark.ts` | 17/25 (68%) | 19/25 (76%) | 🟡 partiel |
| `battle_anim_mons.c` | 2555 | 128 | `battle_anim_mons.ts` | 72/128 (56%) | 102/128 (80%) | 🟡 partiel |
| `battle_gfx_sfx_util.c` | 1349 | 53 | `battle_gfx_sfx_util.ts` | 36/53 (68%) | 43/53 (81%) | 🟡 partiel |
| `battle_util.c` | 4016 | 52 | `battle_util.ts` | 37/52 (71%) | 43/52 (83%) | 🟡 partiel |
...
| `battle_controller_player.c` | 3148 | 124 | `battle_controller_player.ts` | 103/124 (83%) | 108/124 (87%) | 🟡 partiel |
...
| `battle_controller_player_partner.c` | 1936 | 93 | `battle_controller_player_partner.ts` | 85/93 (91%) | 85/93 (91%) | ✅ miroir |
...
| `battle_main.c` | 5271 | 108 | `battle_main.ts` | 99/108 (92%) | 100/108 (93%) | ✅ miroir |
| `battle_anim_utility_funcs.c` | 1102 | 42 | `battle_anim_utility_funcs.ts` | 39/42 (93%) | 39/42 (93%) | ✅ miroir |
| `battle_script_commands.c` | 10332 | 287 | `battle_script_commands.ts` | 260/287 (91%) | 271/287 (94%) | ✅ miroir |
| `battle_controller_opponent.c` | 2028 | 88 | `battle_controller_opponent.ts` | 73/88 (83%) | 83/88 (94%) | 🟡 partiel |
...
| `battle_anim_fight.c` | 1036 | 31 | `battle_anim_fight.ts` | 30/31 (97%) | 30/31 (97%) | ✅ miroir |
| `pokemon_animation.c` | 5545 | 241 | `pokemon_animation.ts` | 237/241 (98%) | 237/241 (98%) | ✅ miroir |
| `rayquaza_scene.c` | 3191 | 72 | `rayquaza_scene.ts` | 72/72 (100%) | 72/72 (100%) | ✅ miroir |
| `battle_ai_script_commands.c` | 2297 | 115 | `battle_ai_script_commands.ts` | 115/115 (100%) | 115/115 (100%) | ✅ miroir |
| `battle_pike.c` | 1657 | 56 | `battle_pike.ts` | 56/56 (100%) | 56/56 (100%) | ✅ miroir |
| `battle_tv.c` | 1605 | 12 | `battle_tv.ts` | 12/12 (100%) | 12/12 (100%) | ✅ miroir |
| `contest_effect.c` | 1094 | 51 | `contest_effect.ts` | 51/51 (100%) | 51/51 (100%) | ✅ miroir |
...
| `battle_factory.c` | 920 | 27 | `battle_factory.ts` | 27/27 (100%) | 27/27 (100%) | ✅ miroir |
...
| `battle_tent.c` | 429 | 32 | `battle_tent.ts` | 32/32 (100%) | 32/32 (100%) | ✅ miroir |
...
| `battle_palace.c` | 213 | 12 | `battle_palace.ts` | 12/12 (100%) | 12/12 (100%) | ✅ miroir |
...
| `party_menu.c` | 6431 | 354 | `party_menu.ts` | 115/354 (32%) | 136/354 (38%) | 🟡 amorce |
| `pokemon.c` | 7157 | 160 | `pokemon.ts` | 70/160 (44%) | 88/160 (55%) | 🟡 partiel |
...
| `pokenav.c` | 591 | 28 | `pokenav.ts` | 13/28 (46%) | 26/28 (93%) | 🟡 partiel |
| `pokedex.c` | 5606 | 140 | `pokedex.ts` | 131/140 (94%) | 131/140 (94%) | ✅ miroir |
...
| `mon_markings.c` | 617 | 15 | `mon_markings.ts` | 15/15 (100%) | 15/15 (100%) | ✅ miroir |
...
| `start_menu.c` | 1440 | 80 | `start_menu.ts` | 0/80 (0%) | 3/80 (4%) | 🔴 manquant |
| `gpu_regs.c` | 196 | 12 | `gpu_regs.ts` | 2/12 (17%) | 2/12 (17%) | 🟡 amorce |
| `diploma.c` | 210 | 10 | `option_menu.ts` _(nom≠)_ | 2/10 (20%) | 2/10 (20%) | 🟡 amorce |
| `script_menu.c` | 766 | 31 | `script_menu.ts` | 7/31 (23%) | 7/31 (23%) | 🟡 amorce |
| `text.c` | 1905 | 53 | `text.ts` | 29/53 (55%) | 29/53 (55%) | 🟡 partiel |
| `palette.c` | 1043 | 40 | `palette.ts` | 20/40 (50%) | 22/40 (55%) | 🟡 partiel |
| `bg.c` | 1248 | 52 | `window.ts` _(nom≠)_ | 27/52 (52%) | 29/52 (56%) | 🟡 amorce |
| `menu_specialized.c` | 1637 | 57 | `menu_specialized.ts` | 34/57 (60%) | 34/57 (60%) | 🟡 partiel |
| `sprite.c` | 1760 | 102 | `sprite.ts` | 52/102 (51%) | 64/102 (63%) | 🟡 partiel |
| `menu.c` | 2148 | 123 | `menu.ts` | 76/123 (62%) | 87/123 (71%) | 🟡 partiel |
| `window.c` | 715 | 30 | `window.ts` | 21/30 (70%) | 22/30 (73%) | 🟡 partiel |
| `hall_of_fame.c` | 1535 | 45 | `hall_of_fame.ts` | 36/45 (80%) | 36/45 (80%) | 🟡 partiel |
| `naming_screen.c` | 2595 | 117 | `naming_screen.ts` | 100/117 (85%) | 100/117 (85%) | ✅ miroir |
...
| `menu_helpers.c` | 454 | 25 | `menu_helpers.ts` | 21/25 (84%) | 24/25 (96%) | 🟡 partiel |
| `main_menu.c` | 2308 | 82 | `main_menu.ts` | 82/82 (100%) | 82/82 (100%) | ✅ miroir |
| `strings.c` | 1830 | 0 | `strings.ts` | 0/0 (100%) | 0/0 (100%) | ⚪ vide/data |
| `graphics.c` | 1639 | 0 | — **manquant** | 0/0 (100%) | 0/0 (100%) | ⚪ vide/data |
| `image_processing_effects.c` | 1229 | 38 | `image_processing_effects.ts` | 38/38 (100%) | 38/38 (100%) | ✅ miroir |
...
| `blit.c` | 210 | 5 | `blit.ts` | 5/5 (100%) | 5/5 (100%) | ✅ miroir |
...
| `shop.c` | 1270 | 57 | `shop.ts` | 10/57 (18%) | 10/57 (18%) | 🟡 amorce |
| `item_use.c` | 1140 | 74 | `item_use.ts` | 15/74 (20%) | 23/74 (31%) | 🟡 amorce |
| `item_icon.c` | 169 | 6 | `item_icon.ts` | 2/6 (33%) | 2/6 (33%) | 🟡 amorce |
| `item.c` | 950 | 52 | `item.ts` | 22/52 (42%) | 30/52 (58%) | 🟡 partiel |
| `item_menu_icons.c` | 663 | 21 | `item_menu_icons.ts` | 12/21 (57%) | 15/21 (71%) | 🟡 partiel |
| `item_menu.c` | 2610 | 122 | `item_menu.ts` | 105/122 (86%) | 105/122 (86%) | ✅ miroir |
...
| `save.c` | 1053 | 35 | `save.ts` | 7/35 (20%) | 10/35 (29%) | 🟡 amorce |
...
| `decompress.c` | 412 | 21 | `rayquaza_scene.ts` _(nom≠)_ | 2/21 (10%) | 3/21 (14%) | 🔴 manquant |
| `main.c` | 437 | 29 | `main.ts` | 5/29 (17%) | 7/29 (24%) | 🟡 amorce |
| `malloc.c` | 225 | 12 | — **manquant** | 0/12 (0%) | 3/12 (25%) | 🟡 amorce |
| `util.c` | 280 | 11 | `util.ts` | 6/11 (55%) | 7/11 (64%) | 🟡 partiel |
| `task.c` | 205 | 14 | `task.ts` | 6/14 (43%) | 10/14 (71%) | 🟡 partiel |
...
| `confetti_util.c` | 182 | 8 | `confetti_util.ts` | 8/8 (100%) | 8/8 (100%) | ✅ miroir |
...
| `m4a.c` | 1782 | 72 | `m4a.ts` | 70/72 (97%) | 70/72 (97%) | ✅ miroir |
| `sound.c` | 632 | 47 | `sound.ts` | 47/47 (100%) | 47/47 (100%) | ✅ miroir |
| `pokedex_cry_screen.c` | 581 | 14 | `pokedex_cry_screen.ts` | 14/14 (100%) | 14/14 (100%) | ✅ miroir |
| `m4a_tables.c` | 308 | 0 | `m4a_tables.ts` | 0/0 (100%) | 0/0 (100%) | ⚪ vide/data |
...
| `ereader_helpers.c` | 876 | 26 | `ereader_helpers.ts` | 26/26 (100%) | 26/26 (100%) | ✅ miroir |
| `mystery_event_script.c` | 401 | 30 | `mystery_event_script.ts` | 30/30 (100%) | 30/30 (100%) | ✅ miroir |
...
| `trader.c` | 216 | 13 | `trader.ts` | 2/13 (15%) | 3/13 (23%) | 🟡 amorce |
| `data.c` | 329 | 0 | — **manquant** | 0/0 (100%) | 0/0 (100%) | ⚪ vide/data |
| `mail_data.c` | 206 | 12 | `mail_data.ts` | 12/12 (100%) | 12/12 (100%) | ✅ miroir |
| `dma3_manager.c` | 184 | 5 | `dma3_manager.ts` | 5/5 (100%) | 5/5 (100%) | ✅ miroir |
