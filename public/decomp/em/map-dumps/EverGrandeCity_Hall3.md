...
## Warps (4)
- #0 (5,12) → `MAP_EVER_GRANDE_CITY_GLACIAS_ROOM` warp #1
- #1 (5,2) → `MAP_EVER_GRANDE_CITY_DRAKES_ROOM` warp #0
- #2 (4,12) → `MAP_EVER_GRANDE_CITY_GLACIAS_ROOM` warp #1
- #3 (6,12) → `MAP_EVER_GRANDE_CITY_GLACIAS_ROOM` warp #1
