...
|---|---|---|---|---|---|
| `LOCALID_CONTEST_MC` | `OBJ_EVENT_GFX_WOMAN_3` | 6,4 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTEST_JUDGE` | `OBJ_EVENT_GFX_CONTEST_JUDGE` | 7,4 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTESTANT_1` | `OBJ_EVENT_GFX_VAR_0` | 4,7 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_CONTESTANT_2` | `OBJ_EVENT_GFX_VAR_1` | 6,7 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_CONTESTANT_3` | `OBJ_EVENT_GFX_VAR_2` | 8,7 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_1` | `OBJ_EVENT_GFX_VAR_4` | 2,6 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_3` | `OBJ_EVENT_GFX_VAR_6` | 4,2 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_4` | `OBJ_EVENT_GFX_VAR_7` | 5,2 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_5` | `OBJ_EVENT_GFX_VAR_8` | 9,2 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_6` | `OBJ_EVENT_GFX_VAR_9` | 10,2 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_7` | `OBJ_EVENT_GFX_VAR_A` | 12,5 | `MOVEMENT_TYPE_FACE_LEFT` | `0x0` | `0` |
| `LOCALID_CONTEST_AUDIENCE_2` | `OBJ_EVENT_GFX_VAR_5` | 2,5 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
| `LOCALID_CONTEST_POKEBALL` | `OBJ_EVENT_GFX_ITEM_BALL` | 7,5 | `MOVEMENT_TYPE_LOOK_AROUND` | `0x0` | `FLAG_HIDE_CONTEST_POKE_BALL` |
| `LOCALID_CONTESTANT_4` | `OBJ_EVENT_GFX_VAR_3` | 10,7 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_CONTEST_ARTIST` | `OBJ_EVENT_GFX_ARTIST` | 12,6 | `MOVEMENT_TYPE_FACE_LEFT` | `0x0` | `0` |
