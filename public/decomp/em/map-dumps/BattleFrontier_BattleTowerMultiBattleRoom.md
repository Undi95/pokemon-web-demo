...
|---|---|---|---|---|---|
| `LOCALID_TOWER_MULTI_BATTLE_OPPONENT_1` | `OBJ_EVENT_GFX_VAR_0` | 5,1 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `FLAG_HIDE_BATTLE_TOWER_OPPONENT` |
| `LOCALID_TOWER_MULTI_BATTLE_ATTENDANT_1` | `OBJ_EVENT_GFX_TEALA` | 1,4 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
| `LOCALID_TOWER_MULTI_BATTLE_ATTENDANT_2` | `OBJ_EVENT_GFX_TEALA` | 1,5 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
| `LOCALID_TOWER_MULTI_BATTLE_OPPONENT_2` | `OBJ_EVENT_GFX_VAR_1` | 4,1 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `FLAG_HIDE_BATTLE_TOWER_OPPONENT` |
| `LOCALID_TOWER_MULTI_BATTLE_PLAYER` | `OBJ_EVENT_GFX_VAR_F` | 4,8 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_TOWER_MULTI_BATTLE_PARTNER` | `OBJ_EVENT_GFX_VAR_E` | 5,8 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
...
```
Votre partenaire a arrêté.\pVotre défi dans la SALLE DE\nCOMBAT va être annulé.$
```
