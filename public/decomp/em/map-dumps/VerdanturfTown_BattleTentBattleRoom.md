...
|---|---|---|---|---|---|
| `LOCALID_VERDANTURF_TENT_BATTLE_PLAYER` | `OBJ_EVENT_GFX_VAR_1` | 2,8 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_VERDANTURF_TENT_BATTLE_OPPONENT` | `OBJ_EVENT_GFX_VAR_0` | 11,1 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_VERDANTURF_TENT_BATTLE_ATTENDANT` | `OBJ_EVENT_GFX_EXPERT_M` | 2,4 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
