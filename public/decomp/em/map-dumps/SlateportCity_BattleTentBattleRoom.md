...
|---|---|---|---|---|---|
| `` | `OBJ_EVENT_GFX_SCIENTIST_1` | 1,4 | `MOVEMENT_TYPE_FACE_RIGHT` | `0x0` | `0` |
| `LOCALID_SLATEPORT_TENT_BATTLE_OPPONENT` | `OBJ_EVENT_GFX_VAR_0` | 5,1 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_SLATEPORT_TENT_BATTLE_PLAYER` | `OBJ_EVENT_GFX_VAR_1` | 4,8 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
