...
|---|---|---|---|---|---|
| `LOCALID_BIRTH_ISLAND_EXTERIOR_ROCK` | `OBJ_EVENT_GFX_DEOXYS_TRIANGLE` | 15,12 | `MOVEMENT_TYPE_FACE_DOWN` | `BirthIsland_Exterior_EventScript_Triangle` | `FLAG_HIDE_BIRTH_ISLAND_DEOXYS_TRIANGLE` |
| `LOCALID_BIRTH_ISLAND_DEOXYS` | `OBJ_EVENT_GFX_DEOXYS` | 15,3 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `FLAG_HIDE_DEOXYS` |

## Warps (1)
- #0 (15,24) → `MAP_BIRTH_ISLAND_HARBOR` warp #0
