...
## Connexions
- left (offset 0) → `MAP_ROUTE107`
- right (offset -40) → `MAP_ROUTE109`

## Object events (7 NPCs)
| local_id | gfx | x,y | mvmt | script | flag |
|---|---|---|---|---|---|
| `` | `OBJ_EVENT_GFX_SWIMMER_M` | 52,13 | `MOVEMENT_TYPE_WALK_SEQUENCE_UP_LEFT_DOWN_RIGHT` | `Route108_EventScript_Jerome` | `0` |
| `` | `OBJ_EVENT_GFX_SWIMMER_F` | 35,12 | `MOVEMENT_TYPE_FACE_DOWN_AND_UP` | `Route108_EventScript_Tara` | `0` |
| `` | `OBJ_EVENT_GFX_SWIMMER_M` | 13,13 | `MOVEMENT_TYPE_ROTATE_CLOCKWISE` | `Route108_EventScript_Matthew` | `0` |
| `` | `OBJ_EVENT_GFX_SWIMMER_F` | 8,7 | `MOVEMENT_TYPE_FACE_DOWN_UP_AND_RIGHT` | `Route108_EventScript_Missy` | `0` |
| `` | `OBJ_EVENT_GFX_WOMAN_5` | 41,5 | `MOVEMENT_TYPE_FACE_RIGHT` | `Route108_EventScript_Carolina` | `0` |
| `` | `OBJ_EVENT_GFX_SAILOR` | 43,5 | `MOVEMENT_TYPE_FACE_LEFT` | `Route108_EventScript_Cory` | `0` |
| `` | `OBJ_EVENT_GFX_ITEM_BALL` | 42,4 | `MOVEMENT_TYPE_LOOK_AROUND` | `Route108_EventScript_ItemStarPiece` | `FLAG_ITEM_ROUTE_108_STAR_PIECE` |

## Warps (1)
- #0 (29,6) → `MAP_ABANDONED_SHIP_DECK` warp #0
