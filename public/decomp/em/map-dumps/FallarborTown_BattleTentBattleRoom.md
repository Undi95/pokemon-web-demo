...
|---|---|---|---|---|---|
| `LOCALID_FALLARBOR_TENT_BATTLE_PLAYER` | `OBJ_EVENT_GFX_VAR_1` | 4,8 | `MOVEMENT_TYPE_FACE_UP` | `0x0` | `0` |
| `LOCALID_FALLARBOR_TENT_BATTLE_ATTENDANT` | `OBJ_EVENT_GFX_BLACK_BELT` | 3,2 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
| `LOCALID_FALLARBOR_TENT_BATTLE_OPPONENT` | `OBJ_EVENT_GFX_VAR_0` | 5,1 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `0` |
