...
|---|---|---|---|---|---|
| `` | `OBJ_EVENT_GFX_TEALA` | 0,5 | `MOVEMENT_TYPE_FACE_DOWN` | `LilycoveCity_DepartmentStoreElevator_EventScript_Attendant` | `0` |

## Warps (2)
- #0 (1,5) → `MAP_DYNAMIC` warp #WARP_ID_DYNAMIC
- #1 (2,5) → `MAP_DYNAMIC` warp #WARP_ID_DYNAMIC
