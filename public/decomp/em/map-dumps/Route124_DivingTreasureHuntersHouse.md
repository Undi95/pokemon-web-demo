...
|---|---|---|---|---|---|
| `` | `OBJ_EVENT_GFX_MAN_5` | 5,4 | `MOVEMENT_TYPE_FACE_LEFT` | `Route124_DivingTreasureHuntersHouse_EventScript_TreasureHunter` | `0` |

## Warps (2)
- #0 (3,8) → `MAP_ROUTE124` warp #0
- #1 (4,8) → `MAP_ROUTE124` warp #0

## BG events / signs (1)
- (7,1) [sign] → `Route124_DivingTreasureHuntersHouse_EventScript_ShardTradeBoard`
...
```
{CLEAR_TO 2}Objet recherché{CLEAR_TO 112}Objet proposé\n{CLEAR_TO 10}TESSON ROUGE{CLEAR_TO 89}{LEFT_ARROW}{RIGHT_ARROW}{CLEAR_TO 120}PIERRE FEU{CLEAR_TO 200}\p{CLEAR_TO 2}Objet recherché{CLEAR_TO 112}Objet proposé\n{CLEAR_TO 9}TESSON JAUNE{CLEAR_TO 89}{LEFT_ARROW}{RIGHT_ARROW}{CLEAR_TO 113}PIERREFOUDRE{CLEAR_TO 200}\p{CLEAR_TO 2}Objet recherché{CLEAR_TO 112}Objet proposé\n{CLEAR_TO 12}TESSON BLEU{CLEAR_TO 89}{LEFT_ARROW}{RIGHT_ARROW}{CLEAR_TO 120}PIERRE EAU{CLEAR_TO 200}\p{CLEAR_TO 2}Objet recherché{CLEAR_TO 112}Objet proposé\n{CLEAR_TO 12}TESSON VERT{CLEAR_TO 89}{LEFT_ARROW}{RIGHT_ARROW}{CLEAR_TO 113}PIERREPLANTE$
```
