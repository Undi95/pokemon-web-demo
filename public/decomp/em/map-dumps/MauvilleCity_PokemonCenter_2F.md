...
| `` | `OBJ_EVENT_GFX_YOUNGSTER` | 8,8 | `MOVEMENT_TYPE_FACE_UP` | `MauvilleCity_PokemonCenter_2F_EventScript_Youngster` | `0` |

## Warps (3)
- #0 (1,6) → `MAP_MAUVILLE_CITY_POKEMON_CENTER_1F` warp #2
...
```
Tu savais que tu pouvais faire des\ncombats en link au COLISEE?\pIls affichent tes résultats au mur pour\nque tout le monde puisse les voir.\pC'est embêtant quand tu cumules plus\nde défaites que de victoires…$
```
