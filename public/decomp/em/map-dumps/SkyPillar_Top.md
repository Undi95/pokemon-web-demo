...
|---|---|---|---|---|---|
| `LOCALID_RAYQUAZA_SLEEPING` | `OBJ_EVENT_GFX_RAYQUAZA` | 14,7 | `MOVEMENT_TYPE_FACE_DOWN` | `0x0` | `FLAG_HIDE_SKY_PILLAR_TOP_RAYQUAZA` |
| `` | `OBJ_EVENT_GFX_RAYQUAZA_STILL` | 14,6 | `MOVEMENT_TYPE_FACE_DOWN` | `SkyPillar_Top_EventScript_Rayquaza` | `FLAG_HIDE_SKY_PILLAR_TOP_RAYQUAZA_STILL` |

## Warps (1)
- #0 (16,14) → `MAP_SKY_PILLAR_5F` warp #1

## Coord events / triggers (1)
- (14,9) → `SkyPillar_Top_EventScript_AwakenRayquaza` (si `VAR_SKY_PILLAR_RAYQUAZA_CRY_DONE` == `0`)
...
```
Le RAYQUAZA réveillé s'est envolé…$
```
