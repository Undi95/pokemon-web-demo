...
|---|---|---|---|---|---|
| `LOCALID_MECHADOLL_1` | `OBJ_EVENT_GFX_MAN_1` | 6,17 | `MOVEMENT_TYPE_FACE_LEFT` | `Route110_TrickHousePuzzle5_EventScript_Mechadoll1` | `0` |
| `LOCALID_MECHADOLL_2` | `OBJ_EVENT_GFX_MAN_1` | 0,7 | `MOVEMENT_TYPE_FACE_RIGHT` | `Route110_TrickHousePuzzle5_EventScript_Mechadoll2` | `0` |
| `LOCALID_MECHADOLL_3` | `OBJ_EVENT_GFX_MAN_1` | 14,10 | `MOVEMENT_TYPE_FACE_LEFT` | `Route110_TrickHousePuzzle5_EventScript_Mechadoll3` | `0` |
| `LOCALID_MECHADOLL_4` | `OBJ_EVENT_GFX_MAN_1` | 14,19 | `MOVEMENT_TYPE_FACE_LEFT` | `Route110_TrickHousePuzzle5_EventScript_Mechadoll4` | `0` |
| `LOCALID_MECHADOLL_5` | `OBJ_EVENT_GFX_MAN_1` | 10,4 | `MOVEMENT_TYPE_FACE_RIGHT` | `Route110_TrickHousePuzzle5_EventScript_Mechadoll5` | `0` |
...
## Coord events / triggers (22)
- (5,17) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll1Trigger0` (si `VAR_TEMP_1` == `0`)
- (4,17) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll1Trigger1` (si `VAR_TEMP_1` == `0`)
- (3,17) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll1Trigger2` (si `VAR_TEMP_1` == `0`)
- (2,17) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll1Trigger3` (si `VAR_TEMP_1` == `0`)
- (1,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger0` (si `VAR_TEMP_2` == `0`)
- (2,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger1` (si `VAR_TEMP_2` == `0`)
- (13,10) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll3Trigger0` (si `VAR_TEMP_3` == `0`)
- (12,10) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll3Trigger1` (si `VAR_TEMP_3` == `0`)
- (11,10) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll3Trigger2` (si `VAR_TEMP_3` == `0`)
- (13,19) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll4Trigger0` (si `VAR_TEMP_4` == `0`)
- (12,19) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll4Trigger1` (si `VAR_TEMP_4` == `0`)
- (11,4) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll5Trigger0` (si `VAR_TEMP_5` == `0`)
- (1,17) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll1Trigger4` (si `VAR_TEMP_1` == `0`)
- (3,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger2` (si `VAR_TEMP_2` == `0`)
- (4,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger3` (si `VAR_TEMP_2` == `0`)
- (5,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger4` (si `VAR_TEMP_2` == `0`)
- (6,7) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll2Trigger5` (si `VAR_TEMP_2` == `0`)
- (10,10) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll3Trigger3` (si `VAR_TEMP_3` == `0`)
- (9,10) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll3Trigger4` (si `VAR_TEMP_3` == `0`)
- (11,19) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll4Trigger2` (si `VAR_TEMP_4` == `0`)
- (10,19) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll4Trigger3` (si `VAR_TEMP_4` == `0`)
- (9,19) → `Route110_TrickHousePuzzle5_EventScript_Mechadoll4Trigger4` (si `VAR_TEMP_4` == `0`)

## BG events / signs (1)
- (11,21) [sign] → `Route110_TrickHousePuzzle5_EventScript_Scroll`
...
```
{PLAYER} écrit le code secret\nsur la porte.\p“Le MAITRE DES PIEGES est un génie.”\n… … … … … … … …\pLa porte s'ouvre!$
```
### Route110_TrickHousePuzzle5_Text_Mechadoll1Intro
```
CLINK-CLIC-CLANK-CLAC…\nMECAPOUPEE 1 JE SUIS!\pSI TU REPONDS CORRECTEMENT A CES\nQUESTIONS, TU POURRAS PARLER A\lMECAPOUPEE 5 ET AVOIR LE CODE SECRET.$
```
### Route110_TrickHousePuzzle5_Text_Mechado