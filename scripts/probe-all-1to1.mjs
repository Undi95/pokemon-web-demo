...
export async function runAll() {
  ...
  const SPEC = [
    ...
    ['probe-randdmg-1to1', 'runRandDmgOracle', { dc }],   // idem self-import
    ...
    ['probe-ppbonus-1to1', 'runPpBonusOracle', { dc }],   // idem self-import
    ['probe-type-physical-split-1to1', 'runTypePhysicalSplitOracle', { dc }],   // idem self-import
