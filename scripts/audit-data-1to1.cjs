...
const ORACLES = [
  ...
  'audit-heal-locations.cjs', 'audit-field-move-enum.cjs', 'audit-flags-vars.cjs', 'audit-doors.cjs', 'audit-maps.cjs', 'audit-map-script-references.cjs', 'audit-movement-action-funcs.cjs', 'audit-movement-action-ids.cjs', 'audit-movement-name-to-action.cjs',
