...
const ORACLES = [
  ...
  'audit-battle-stat-tables.cjs', 'audit-pokemon-constants.cjs', 'audit-battle-status-bits.cjs', 'audit-battle-flags.cjs', 'audit-effect-hold-constants.cjs', 'audit-ability-type-constants.cjs', 'audit-id-constants.cjs', 'audit-inline-battle-constants.cjs', 'audit-commented-constants.cjs',
