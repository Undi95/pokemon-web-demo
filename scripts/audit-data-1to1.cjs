...
const ORACLES = [
  ...
  'audit-heal-locations.cjs', 'audit-field-move-enum.cjs', 'audit-flags-vars.cjs', 'audit-doors.cjs', 'audit-maps.cjs', 'audit-movement-action-funcs.cjs', 'audit-movement-action-ids.cjs', 'audit-movement-name-to-action.cjs',
  ...
  'audit-battle-stat-tables.cjs', 'audit-pokemon-constants.cjs', 'audit-battle-status-bits.cjs', 'audit-battle-flags.cjs', 'audit-effect-hold-constants.cjs', 'audit-ability-type-constants.cjs', 'audit-id-constants.cjs', 'audit-inline-battle-constants.cjs', 'audit-commented-constants.cjs', 'audit-battle-opcode-table.cjs', 'audit-battle-ai-cmd-table.cjs', 'audit-scrcmd-opcode-completeness.cjs', 'audit-specials-registration.cjs',
